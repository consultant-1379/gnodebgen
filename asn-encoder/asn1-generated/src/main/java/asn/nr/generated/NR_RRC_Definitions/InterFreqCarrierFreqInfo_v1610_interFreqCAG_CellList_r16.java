...
public class InterFreqCarrierFreqInfo_v1610_interFreqCAG_CellList_r16 extends Asn1SeqOf {
   ...
   public InterFreqCAG_CellListPerPLMN_r16[] elements;

   public InterFreqCarrierFreqInfo_v1610_interFreqCAG_CellList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqInfo_v1610_interFreqCAG_CellList_r16 (int numRecords) {
      elements = new InterFreqCAG_CellListPerPLMN_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqInfo_v1610_interFreqCAG_CellList_r16 (InterFreqCAG_CellListPerPLMN_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqCAG_CellListPerPLMN_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqCAG_CellListPerPLMN_r16();
