...
public class CodebookVariantsList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CodebookVariantsList-r16";
   }

   public SupportedCSI_RS_Resource[] elements;

   public CodebookVariantsList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CodebookVariantsList_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public CodebookVariantsList_r16 (SupportedCSI_RS_Resource[] elements_) {
      elements = elements_;
   }
