...
public class SL_MeasIdToRemoveList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-MeasIdToRemoveList-r16";
   }

   public SL_MeasId_r16[] elements;

   public SL_MeasIdToRemoveList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_MeasIdToRemoveList_r16 (int numRecords) {
      elements = new SL_MeasId_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_MeasIdToRemoveList_r16 (SL_MeasId_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_MeasId_r16 [numElements];
