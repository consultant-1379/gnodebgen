...
public class CSI_RS_ResourceConfigMobility extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // encode csi_RS_CellList_Mobility

      if (csi_RS_CellList_Mobility != null) {
         buffer.getContext().eventDispatcher.startElement("csi_RS_CellList_Mobility", -1);

         csi_RS_CellList_Mobility.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("csi_RS_CellList_Mobility", -1);
      }
      else throw new Asn1MissingRequiredException ("csi_RS_CellList_Mobility");
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((refServCellIndex != null), "optbit");
            if (refServCellIndex != null) {
               refServCellIndex.encode (buffer);
            }
