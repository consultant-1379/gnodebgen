...
public class PUCCH_ResourceGroup_r16_resourcePerGroupList_r16 extends Asn1SeqOf {
   ...
   public PUCCH_ResourceId[] elements;

   public PUCCH_ResourceGroup_r16_resourcePerGroupList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_ResourceGroup_r16_resourcePerGroupList_r16 (int numRecords) {
      elements = new PUCCH_ResourceId [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_ResourceGroup_r16_resourcePerGroupList_r16 (PUCCH_ResourceId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUCCH_ResourceId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUCCH_ResourceId();
