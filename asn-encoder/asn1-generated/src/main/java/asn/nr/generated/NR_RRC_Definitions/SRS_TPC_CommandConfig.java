...
public class SRS_TPC_CommandConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((startingBitOfFormat2_3 != null), null);
      buffer.encodeBit ((fieldTypeFormat2_3 != null), null);

      // encode startingBitOfFormat2_3

      if (startingBitOfFormat2_3 != null) {
         buffer.getContext().eventDispatcher.startElement("startingBitOfFormat2_3", -1);

         startingBitOfFormat2_3.encode (buffer, 1, 31);

         buffer.getContext().eventDispatcher.endElement("startingBitOfFormat2_3", -1);
      }

      // encode fieldTypeFormat2_3

      if (fieldTypeFormat2_3 != null) {
         buffer.getContext().eventDispatcher.startElement("fieldTypeFormat2_3", -1);

         fieldTypeFormat2_3.encode (buffer, 0, 1);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((startingBitOfFormat2_3SUL != null), "optbit");
            if (startingBitOfFormat2_3SUL != null) {
               startingBitOfFormat2_3SUL.encode (buffer, 1, 31);
            }
