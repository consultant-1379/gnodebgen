...
public class CSI_MeasConfig_nzp_CSI_RS_ResourceToReleaseList extends Asn1SeqOf {
   ...
   public NZP_CSI_RS_ResourceId[] elements;

   public CSI_MeasConfig_nzp_CSI_RS_ResourceToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_nzp_CSI_RS_ResourceToReleaseList (int numRecords) {
      elements = new NZP_CSI_RS_ResourceId [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_MeasConfig_nzp_CSI_RS_ResourceToReleaseList (NZP_CSI_RS_ResourceId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 192);
      int numElements = (int) buffer.decodeLength();

      elements = new NZP_CSI_RS_ResourceId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NZP_CSI_RS_ResourceId();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 192);
