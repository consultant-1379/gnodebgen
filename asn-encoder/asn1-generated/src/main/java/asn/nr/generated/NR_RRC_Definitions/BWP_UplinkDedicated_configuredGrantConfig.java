...
public class BWP_UplinkDedicated_configuredGrantConfig extends Asn1Choice {
   ...
   public BWP_UplinkDedicated_configuredGrantConfig () {
      super();
   }

   public BWP_UplinkDedicated_configuredGrantConfig (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (ConfiguredGrantConfig value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 1: { 
            ...
            element = setup = new ConfiguredGrantConfig();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            ConfiguredGrantConfig setup = (ConfiguredGrantConfig) element;
            setup.encode (buffer);
            break;
