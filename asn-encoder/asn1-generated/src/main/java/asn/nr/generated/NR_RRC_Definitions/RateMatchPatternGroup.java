...
public class RateMatchPatternGroup extends Asn1SeqOf {
   ...
   public RateMatchPatternGroup_element[] elements;

   public RateMatchPatternGroup () {
      elements = null;
   }
    ...
    * populated.
    */
   public RateMatchPatternGroup (int numRecords) {
      elements = new RateMatchPatternGroup_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RateMatchPatternGroup (RateMatchPatternGroup_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RateMatchPatternGroup_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RateMatchPatternGroup_element();
