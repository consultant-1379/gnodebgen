...
public class ULInformationTransferMRDC_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((ul_DCCH_MessageNR != null), null);
      buffer.encodeBit ((ul_DCCH_MessageEUTRA != null), null);
      buffer.encodeBit ((lateNonCriticalExtension != null), null);
      buffer.encodeBit ((nonCriticalExtension != null), null);

      // encode ul_DCCH_MessageNR

      if (ul_DCCH_MessageNR != null) {
         buffer.getContext().eventDispatcher.startElement("ul_DCCH_MessageNR", -1);

         ul_DCCH_MessageNR.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ul_DCCH_MessageNR", -1);
      }

      // encode ul_DCCH_MessageEUTRA

      if (ul_DCCH_MessageEUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("ul_DCCH_MessageEUTRA", -1);

         ul_DCCH_MessageEUTRA.encode (buffer);
