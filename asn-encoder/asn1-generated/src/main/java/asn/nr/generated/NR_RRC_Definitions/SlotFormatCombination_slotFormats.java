...
public class SlotFormatCombination_slotFormats extends Asn1SeqOf {
   ...
   public SlotFormatCombination_slotFormats () {
      elements = null;
   }
    ...
    * populated.
    */
   public SlotFormatCombination_slotFormats (int numRecords) {
    ...
    * given the array.  
    */
   public SlotFormatCombination_slotFormats (Asn1Integer[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i].decode (buffer, 0, 255);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i].encode (buffer, 0, 255);
