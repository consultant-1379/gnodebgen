...
public class AccessStratumRelease extends Asn1Enumerated {
   ...
   public static final int _REL15 = 0;
   public static final int _REL16 = 1;
   ...
   protected static final AccessStratumRelease _rel15 = new AccessStratumRelease(0);
   protected static final AccessStratumRelease _rel16 = new AccessStratumRelease(1);
   protected static final AccessStratumRelease _spare6 = new AccessStratumRelease(2);
   protected static final AccessStratumRelease _spare5 = new AccessStratumRelease(3);
   protected static final AccessStratumRelease _spare4 = new AccessStratumRelease(4);
   protected static final AccessStratumRelease _spare3 = new AccessStratumRelease(5);
   protected static final AccessStratumRelease _spare2 = new AccessStratumRelease(6);
   protected static final AccessStratumRelease _spare1 = new AccessStratumRelease(7);
    ...
    */
   public static AccessStratumRelease rel16() {
      return _rel16;
   }
    ...
    */
   public static AccessStratumRelease spare6() {
      return _spare6;
   }
    ...
    */
   public static AccessStratumRelease spare5() {
      return _spare5;
   }
    ...
    */
   public static AccessStratumRelease spare4() {
      return _spare4;
   }
    ...
    */
   public static AccessStratumRelease spare3() {
      return _spare3;
   }
    ...
    */
   public static AccessStratumRelease spare2() {
      return _spare2;
   }
    ...
    */
   public static AccessStratumRelease spare1() {
      return _spare1;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch ((int)value) {
         case 0: ui = 0; /* rel15 */break;
         case 1: ui = 1; /* rel16 */break;
