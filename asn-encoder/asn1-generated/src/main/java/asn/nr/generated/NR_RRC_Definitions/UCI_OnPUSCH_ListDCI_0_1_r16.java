...
public class UCI_OnPUSCH_ListDCI_0_1_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "UCI-OnPUSCH-ListDCI-0-1-r16";
   }

   public UCI_OnPUSCH[] elements;

   public UCI_OnPUSCH_ListDCI_0_1_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UCI_OnPUSCH_ListDCI_0_1_r16 (int numRecords) {
      elements = new UCI_OnPUSCH [numRecords];
   }
    ...
    * given the array.  
    */
   public UCI_OnPUSCH_ListDCI_0_1_r16 (UCI_OnPUSCH[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UCI_OnPUSCH [numElements];
