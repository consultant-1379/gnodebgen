...
public class SlotFormatCombination extends Asn1Seq {
   ...
   public void encode (Asn1PerEncodeBuffer buffer)
      throws Asn1Exception, java.io.IOException
   {
      // encode slotFormatCombinationId

      if (slotFormatCombinationId != null) {
         buffer.getContext().eventDispatcher.startElement("slotFormatCombinationId", -1);

         slotFormatCombinationId.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("slotFormatCombinationId", -1);
      }
      else throw new Asn1MissingRequiredException ("slotFormatCombinationId");
      ...
      if (slotFormats != null) {
         ...
         slotFormats.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("slotFormats", -1);
      }
      else throw new Asn1MissingRequiredException ("slotFormats");
