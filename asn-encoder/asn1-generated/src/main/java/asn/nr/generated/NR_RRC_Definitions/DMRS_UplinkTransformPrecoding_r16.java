...
public class DMRS_UplinkTransformPrecoding_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((pi2BPSK_ScramblingID0 != null), null);
      buffer.encodeBit ((pi2BPSK_ScramblingID1 != null), null);

      // encode pi2BPSK_ScramblingID0

      if (pi2BPSK_ScramblingID0 != null) {
         buffer.getContext().eventDispatcher.startElement("pi2BPSK_ScramblingID0", -1);

         pi2BPSK_ScramblingID0.encode (buffer, 0, 65535);

         buffer.getContext().eventDispatcher.endElement("pi2BPSK_ScramblingID0", -1);
      }

      // encode pi2BPSK_ScramblingID1

      if (pi2BPSK_ScramblingID1 != null) {
         buffer.getContext().eventDispatcher.startElement("pi2BPSK_ScramblingID1", -1);

         pi2BPSK_ScramblingID1.encode (buffer, 0, 65535);
