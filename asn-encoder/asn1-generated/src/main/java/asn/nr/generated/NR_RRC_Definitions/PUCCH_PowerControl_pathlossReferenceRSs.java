...
public class PUCCH_PowerControl_pathlossReferenceRSs extends Asn1SeqOf {
   ...
   public PUCCH_PathlossReferenceRS[] elements;

   public PUCCH_PowerControl_pathlossReferenceRSs () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_PowerControl_pathlossReferenceRSs (int numRecords) {
      elements = new PUCCH_PathlossReferenceRS [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_PowerControl_pathlossReferenceRSs (PUCCH_PathlossReferenceRS[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUCCH_PathlossReferenceRS [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUCCH_PathlossReferenceRS();
