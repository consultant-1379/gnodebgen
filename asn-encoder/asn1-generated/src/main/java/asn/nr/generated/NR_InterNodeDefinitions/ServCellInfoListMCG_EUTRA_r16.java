...
public class ServCellInfoListMCG_EUTRA_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServCellInfoListMCG-EUTRA-r16";
   }

   public ServCellInfoXCG_EUTRA_r16[] elements;

   public ServCellInfoListMCG_EUTRA_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServCellInfoListMCG_EUTRA_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public ServCellInfoListMCG_EUTRA_r16 (ServCellInfoXCG_EUTRA_r16[] elements_) {
      elements = elements_;
   }
