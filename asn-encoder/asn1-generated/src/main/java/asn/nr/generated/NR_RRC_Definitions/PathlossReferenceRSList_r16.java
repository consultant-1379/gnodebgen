...
public class PathlossReferenceRSList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PathlossReferenceRSList-r16";
   }

   public PathlossReferenceRS_r16[] elements;

   public PathlossReferenceRSList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PathlossReferenceRSList_r16 (int numRecords) {
      elements = new PathlossReferenceRS_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PathlossReferenceRSList_r16 (PathlossReferenceRS_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PathlossReferenceRS_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PathlossReferenceRS_r16();
