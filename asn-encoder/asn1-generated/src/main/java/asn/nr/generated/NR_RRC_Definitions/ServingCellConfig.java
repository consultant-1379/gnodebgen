...
public class ServingCellConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((tdd_UL_DL_ConfigurationDedicated != null), null);
      buffer.encodeBit ((initialDownlinkBWP != null), null);
      buffer.encodeBit ((downlinkBWP_ToReleaseList != null), null);
      buffer.encodeBit ((downlinkBWP_ToAddModList != null), null);
      buffer.encodeBit ((firstActiveDownlinkBWP_Id != null), null);
      buffer.encodeBit ((bwp_InactivityTimer != null), null);
      buffer.encodeBit ((defaultDownlinkBWP_Id != null), null);
      buffer.encodeBit ((uplinkConfig != null), null);
      buffer.encodeBit ((supplementaryUplink != null), null);
      buffer.encodeBit ((pdcch_ServingCellConfig != null), null);
      buffer.encodeBit ((pdsch_ServingCellConfig != null), null);
      buffer.encodeBit ((csi_MeasConfig != null), null);
      buffer.encodeBit ((sCellDeactivationTimer != null), null);
      buffer.encodeBit ((crossCarrierSchedulingConfig != null), null);
      buffer.encodeBit ((dummy1 != null), null);
      buffer.encodeBit ((pathlossReferenceLinking != null), null);
      buffer.encodeBit ((servingCellMO != null), null);

      // encode tdd_UL_DL_ConfigurationDedicated

      if (tdd_UL_DL_ConfigurationDedicated != null) {
         buffer.getContext().eventDispatcher.startElement("tdd_UL_DL_ConfigurationDedicated", -1);

         tdd_UL_DL_ConfigurationDedicated.encode (buffer);
      ...
      // encode downlinkBWP_ToReleaseList

      if (downlinkBWP_ToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("downlinkBWP_ToReleaseList", -1);

         downlinkBWP_ToReleaseList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("downlinkBWP_ToReleaseList", -1);
      }

      // encode downlinkBWP_ToAddModList

      if (downlinkBWP_ToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("downlinkBWP_ToAddModList", -1);

         downlinkBWP_ToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("downlinkBWP_ToAddModList", -1);
      }

      // encode firstActiveDownlinkBWP_Id

      if (firstActiveDownlinkBWP_Id != null) {
         buffer.getContext().eventDispatcher.startElement("firstActiveDownlinkBWP_Id", -1);

         firstActiveDownlinkBWP_Id.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("firstActiveDownlinkBWP_Id", -1);
      }

      // encode bwp_InactivityTimer

      if (bwp_InactivityTimer != null) {
         buffer.getContext().eventDispatcher.startElement("bwp_InactivityTimer", -1);

         bwp_InactivityTimer.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("bwp_InactivityTimer", -1);
      }

      // encode defaultDownlinkBWP_Id

      if (defaultDownlinkBWP_Id != null) {
         buffer.getContext().eventDispatcher.startElement("defaultDownlinkBWP_Id", -1);

         defaultDownlinkBWP_Id.encode (buffer);
      ...
      if (uplinkConfig != null) {
         ...
         uplinkConfig.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("uplinkConfig", -1);
      }

      // encode supplementaryUplink

      if (supplementaryUplink != null) {
         buffer.getContext().eventDispatcher.startElement("supplementaryUplink", -1);

         supplementaryUplink.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("supplementaryUplink", -1);
      }

      // encode pdcch_ServingCellConfig

      if (pdcch_ServingCellConfig != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_ServingCellConfig", -1);

         pdcch_ServingCellConfig.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pdcch_ServingCellConfig", -1);
      }

      // encode pdsch_ServingCellConfig

      if (pdsch_ServingCellConfig != null) {
         buffer.getContext().eventDispatcher.startElement("pdsch_ServingCellConfig", -1);

         pdsch_ServingCellConfig.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pdsch_ServingCellConfig", -1);
      }

      // encode csi_MeasConfig

      if (csi_MeasConfig != null) {
         buffer.getContext().eventDispatcher.startElement("csi_MeasConfig", -1);

         csi_MeasConfig.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("csi_MeasConfig", -1);
      }

      // encode sCellDeactivationTimer

      if (sCellDeactivationTimer != null) {
         buffer.getContext().eventDispatcher.startElement("sCellDeactivationTimer", -1);

         sCellDeactivationTimer.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sCellDeactivationTimer", -1);
      }

      // encode crossCarrierSchedulingConfig

      if (crossCarrierSchedulingConfig != null) {
         buffer.getContext().eventDispatcher.startElement("crossCarrierSchedulingConfig", -1);

         crossCarrierSchedulingConfig.encode (buffer);
      ...
      // encode pathlossReferenceLinking

      if (pathlossReferenceLinking != null) {
         buffer.getContext().eventDispatcher.startElement("pathlossReferenceLinking", -1);

         pathlossReferenceLinking.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pathlossReferenceLinking", -1);
      }

      // encode servingCellMO

      if (servingCellMO != null) {
         buffer.getContext().eventDispatcher.startElement("servingCellMO", -1);

         servingCellMO.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((lte_CRS_ToMatchAround != null), "optbit");
            buffer.encodeBit ((rateMatchPatternToAddModList != null), "optbit");
            buffer.encodeBit ((rateMatchPatternToReleaseList != null), "optbit");
            buffer.encodeBit ((downlinkChannelBW_PerSCS_List != null), "optbit");
            ...
            if (downlinkChannelBW_PerSCS_List != null) {
               downlinkChannelBW_PerSCS_List.encode (buffer);
            }
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((supplementaryUplinkRelease_r16 != null), "optbit");
            buffer.encodeBit ((tdd_UL_DL_ConfigurationDedicated_IAB_MT_r16 != null), "optbit");
            buffer.encodeBit ((dormantBWP_Config_r16 != null), "optbit");
            buffer.encodeBit ((ca_SlotOffset_r16 != null), "optbit");
            buffer.encodeBit ((dummy2 != null), "optbit");
            buffer.encodeBit ((intraCellGuardBandsDL_List_r16 != null), "optbit");
            buffer.encodeBit ((intraCellGuardBandsUL_List_r16 != null), "optbit");
            buffer.encodeBit ((csi_RS_ValidationWithDCI_r16 != null), "optbit");
            buffer.encodeBit ((lte_CRS_PatternList1_r16 != null), "optbit");
            buffer.encodeBit ((lte_CRS_PatternList2_r16 != null), "optbit");
            buffer.encodeBit ((crs_RateMatch_PerCORESETPoolIndex_r16 != null), "optbit");
            buffer.encodeBit ((enableTwoDefaultTCI_States_r16 != null), "optbit");
            buffer.encodeBit ((enableDefaultTCI_StatePerCoresetPoolIndex_r16 != null), "optbit");
            buffer.encodeBit ((enableBeamSwitchTiming_r16 != null), "optbit");
            buffer.encodeBit ((cbg_TxDiffTBsProcessingType1_r16 != null), "optbit");
            buffer.encodeBit ((cbg_TxDiffTBsProcessingType2_r16 != null), "optbit");
            if (supplementaryUplinkRelease_r16 != null) {
               supplementaryUplinkRelease_r16.encode (buffer);
            }
            if (tdd_UL_DL_ConfigurationDedicated_IAB_MT_r16 != null) {
               tdd_UL_DL_ConfigurationDedicated_IAB_MT_r16.encode (buffer);
            }
            if (dormantBWP_Config_r16 != null) {
               dormantBWP_Config_r16.encode (buffer);
            }
            if (ca_SlotOffset_r16 != null) {
               ca_SlotOffset_r16.encode (buffer);
            }
            if (dummy2 != null) {
               dummy2.encode (buffer);
            }
            if (intraCellGuardBandsDL_List_r16 != null) {
               intraCellGuardBandsDL_List_r16.encode (buffer);
            }
            if (intraCellGuardBandsUL_List_r16 != null) {
               intraCellGuardBandsUL_List_r16.encode (buffer);
            }
            if (csi_RS_ValidationWithDCI_r16 != null) {
               csi_RS_ValidationWithDCI_r16.encode (buffer);
            }
            if (lte_CRS_PatternList1_r16 != null) {
               lte_CRS_PatternList1_r16.encode (buffer);
            }
            if (lte_CRS_PatternList2_r16 != null) {
               lte_CRS_PatternList2_r16.encode (buffer);
            }
            if (crs_RateMatch_PerCORESETPoolIndex_r16 != null) {
               crs_RateMatch_PerCORESETPoolIndex_r16.encode (buffer);
            }
            if (enableTwoDefaultTCI_States_r16 != null) {
               enableTwoDefaultTCI_States_r16.encode (buffer);
            }
            if (enableDefaultTCI_StatePerCoresetPoolIndex_r16 != null) {
               enableDefaultTCI_StatePerCoresetPoolIndex_r16.encode (buffer);
            }
            if (enableBeamSwitchTiming_r16 != null) {
               enableBeamSwitchTiming_r16.encode (buffer);
            }
            if (cbg_TxDiffTBsProcessingType1_r16 != null) {
               cbg_TxDiffTBsProcessingType1_r16.encode (buffer);
            }
            if (cbg_TxDiffTBsProcessingType2_r16 != null) {
               cbg_TxDiffTBsProcessingType2_r16.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
         ...
         if (mV4ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((directionalCollisionHandling_r16 != null), "optbit");
            buffer.encodeBit ((channelAccessConfig_r16 != null), "optbit");
            if (directionalCollisionHandling_r16 != null) {
               directionalCollisionHandling_r16.encode (buffer);
            }
            if (channelAccessConfig_r16 != null) {
               channelAccessConfig_r16.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
