...
public class MAC_CellGroupConfig_drx_Config extends Asn1Choice {
   ...
   public MAC_CellGroupConfig_drx_Config () {
      super();
   }

   public MAC_CellGroupConfig_drx_Config (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (DRX_Config value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            DRX_Config setup = (DRX_Config) element;
            setup.encode (buffer);
            break;
