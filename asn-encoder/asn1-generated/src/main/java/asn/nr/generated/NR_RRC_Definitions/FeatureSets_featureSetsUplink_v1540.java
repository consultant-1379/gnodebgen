...
public class FeatureSets_featureSetsUplink_v1540 extends Asn1SeqOf {
   ...
   public FeatureSetUplink_v1540[] elements;

   public FeatureSets_featureSetsUplink_v1540 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSets_featureSetsUplink_v1540 (int numRecords) {
      elements = new FeatureSetUplink_v1540 [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSets_featureSetsUplink_v1540 (FeatureSetUplink_v1540[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetUplink_v1540 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetUplink_v1540();
