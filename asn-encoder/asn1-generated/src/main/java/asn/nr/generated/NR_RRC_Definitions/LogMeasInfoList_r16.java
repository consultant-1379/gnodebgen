...
public class LogMeasInfoList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "LogMeasInfoList-r16";
   }

   public LogMeasInfo_r16[] elements;

   public LogMeasInfoList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public LogMeasInfoList_r16 (int numRecords) {
      elements = new LogMeasInfo_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public LogMeasInfoList_r16 (LogMeasInfo_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 520);
      int numElements = (int) buffer.decodeLength();

      elements = new LogMeasInfo_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LogMeasInfo_r16();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 520);
