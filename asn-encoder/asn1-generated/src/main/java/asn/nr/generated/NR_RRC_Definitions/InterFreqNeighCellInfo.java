...
public class InterFreqNeighCellInfo extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((q_RxLevMinOffsetCellSUL != null), null);
      ...
      if (q_OffsetCell != null) {
         buffer.getContext().eventDispatcher.startElement("q_OffsetCell", -1);

         q_OffsetCell.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("q_OffsetCell", -1);
      }
      else throw new Asn1MissingRequiredException ("q_OffsetCell");
      ...
      // encode q_RxLevMinOffsetCellSUL

      if (q_RxLevMinOffsetCellSUL != null) {
         buffer.getContext().eventDispatcher.startElement("q_RxLevMinOffsetCellSUL", -1);

         q_RxLevMinOffsetCellSUL.encode (buffer, 1, 8);
