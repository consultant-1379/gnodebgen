...
public class RadioLinkMonitoringConfig_failureDetectionResourcesToAddModList extends Asn1SeqOf {
   ...
   public RadioLinkMonitoringRS[] elements;

   public RadioLinkMonitoringConfig_failureDetectionResourcesToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public RadioLinkMonitoringConfig_failureDetectionResourcesToAddModList (int numRecords) {
      elements = new RadioLinkMonitoringRS [numRecords];
   }
    ...
    * given the array.  
    */
   public RadioLinkMonitoringConfig_failureDetectionResourcesToAddModList (RadioLinkMonitoringRS[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RadioLinkMonitoringRS [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RadioLinkMonitoringRS();
