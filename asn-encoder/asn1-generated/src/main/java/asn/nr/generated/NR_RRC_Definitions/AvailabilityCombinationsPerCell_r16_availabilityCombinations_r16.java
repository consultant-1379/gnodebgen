...
public class AvailabilityCombinationsPerCell_r16_availabilityCombinations_r16 extends Asn1SeqOf {
   ...
   public AvailabilityCombination_r16[] elements;

   public AvailabilityCombinationsPerCell_r16_availabilityCombinations_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AvailabilityCombinationsPerCell_r16_availabilityCombinations_r16 (int numRecords) {
      elements = new AvailabilityCombination_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public AvailabilityCombinationsPerCell_r16_availabilityCombinations_r16 (AvailabilityCombination_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AvailabilityCombination_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AvailabilityCombination_r16();
