...
public class ServingCellConfig_csi_MeasConfig extends Asn1Choice {
   ...
   public ServingCellConfig_csi_MeasConfig () {
      super();
   }

   public ServingCellConfig_csi_MeasConfig (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (CSI_MeasConfig value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            CSI_MeasConfig setup;
            element = setup = new CSI_MeasConfig();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            CSI_MeasConfig setup = (CSI_MeasConfig) element;
            setup.encode (buffer);
            break;
