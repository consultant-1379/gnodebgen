...
public class FeatureSets_featureSetsUplink extends Asn1SeqOf {
   ...
   public FeatureSetUplink[] elements;

   public FeatureSets_featureSetsUplink () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSets_featureSetsUplink (int numRecords) {
      elements = new FeatureSetUplink [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSets_featureSetsUplink (FeatureSetUplink[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetUplink [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetUplink();
