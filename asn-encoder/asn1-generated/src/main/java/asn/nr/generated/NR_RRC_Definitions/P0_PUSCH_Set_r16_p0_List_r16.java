...
public class P0_PUSCH_Set_r16_p0_List_r16 extends Asn1SeqOf {
   ...
   public P0_PUSCH_r16[] elements;

   public P0_PUSCH_Set_r16_p0_List_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public P0_PUSCH_Set_r16_p0_List_r16 (int numRecords) {
      elements = new P0_PUSCH_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public P0_PUSCH_Set_r16_p0_List_r16 (P0_PUSCH_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new P0_PUSCH_r16 [numElements];
