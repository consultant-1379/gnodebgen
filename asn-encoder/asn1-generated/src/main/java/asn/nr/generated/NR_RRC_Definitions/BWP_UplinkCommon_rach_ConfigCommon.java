...
public class BWP_UplinkCommon_rach_ConfigCommon extends Asn1Choice {
   ...
   public BWP_UplinkCommon_rach_ConfigCommon () {
      super();
   }

   public BWP_UplinkCommon_rach_ConfigCommon (byte choiceId_, Asn1Type element_) {
      super();
