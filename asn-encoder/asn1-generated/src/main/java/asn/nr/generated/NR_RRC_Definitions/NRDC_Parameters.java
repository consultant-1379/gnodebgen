...
public class NRDC_Parameters extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((measAndMobParametersNRDC != null), null);
      buffer.encodeBit ((generalParametersNRDC != null), null);
      buffer.encodeBit ((fdd_Add_UE_NRDC_Capabilities != null), null);
      buffer.encodeBit ((tdd_Add_UE_NRDC_Capabilities != null), null);
      buffer.encodeBit ((fr1_Add_UE_NRDC_Capabilities != null), null);
      buffer.encodeBit ((fr2_Add_UE_NRDC_Capabilities != null), null);
      buffer.encodeBit ((dummy2 != null), null);
      buffer.encodeBit ((dummy != null), null);

      // encode measAndMobParametersNRDC

      if (measAndMobParametersNRDC != null) {
         buffer.getContext().eventDispatcher.startElement("measAndMobParametersNRDC", -1);

         measAndMobParametersNRDC.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("measAndMobParametersNRDC", -1);
      }

      // encode generalParametersNRDC

      if (generalParametersNRDC != null) {
         buffer.getContext().eventDispatcher.startElement("generalParametersNRDC", -1);

         generalParametersNRDC.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("generalParametersNRDC", -1);
      }

      // encode fdd_Add_UE_NRDC_Capabilities

      if (fdd_Add_UE_NRDC_Capabilities != null) {
         buffer.getContext().eventDispatcher.startElement("fdd_Add_UE_NRDC_Capabilities", -1);

         fdd_Add_UE_NRDC_Capabilities.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("fdd_Add_UE_NRDC_Capabilities", -1);
      }

      // encode tdd_Add_UE_NRDC_Capabilities

      if (tdd_Add_UE_NRDC_Capabilities != null) {
         buffer.getContext().eventDispatcher.startElement("tdd_Add_UE_NRDC_Capabilities", -1);

         tdd_Add_UE_NRDC_Capabilities.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("tdd_Add_UE_NRDC_Capabilities", -1);
      }

      // encode fr1_Add_UE_NRDC_Capabilities

      if (fr1_Add_UE_NRDC_Capabilities != null) {
         buffer.getContext().eventDispatcher.startElement("fr1_Add_UE_NRDC_Capabilities", -1);

         fr1_Add_UE_NRDC_Capabilities.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("fr1_Add_UE_NRDC_Capabilities", -1);
      }

      // encode fr2_Add_UE_NRDC_Capabilities

      if (fr2_Add_UE_NRDC_Capabilities != null) {
         buffer.getContext().eventDispatcher.startElement("fr2_Add_UE_NRDC_Capabilities", -1);

         fr2_Add_UE_NRDC_Capabilities.encode (buffer);
