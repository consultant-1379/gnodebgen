...
public class BandCombination_UplinkTxSwitch_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((bandCombination_v1540 != null), null);
      buffer.encodeBit ((bandCombination_v1560 != null), null);
      buffer.encodeBit ((bandCombination_v1570 != null), null);
      buffer.encodeBit ((bandCombination_v1580 != null), null);
      buffer.encodeBit ((bandCombination_v1590 != null), null);
      buffer.encodeBit ((bandCombination_v1610 != null), null);
      buffer.encodeBit ((uplinkTxSwitching_OptionSupport_r16 != null), null);
      buffer.encodeBit ((uplinkTxSwitching_PowerBoosting_r16 != null), null);

      // encode bandCombination_r16

      if (bandCombination_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("bandCombination_r16", -1);

         bandCombination_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("bandCombination_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("bandCombination_r16");

      // encode bandCombination_v1540

      if (bandCombination_v1540 != null) {
         buffer.getContext().eventDispatcher.startElement("bandCombination_v1540", -1);

         bandCombination_v1540.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("bandCombination_v1540", -1);
      }

      // encode bandCombination_v1560

      if (bandCombination_v1560 != null) {
         buffer.getContext().eventDispatcher.startElement("bandCombination_v1560", -1);

         bandCombination_v1560.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("bandCombination_v1560", -1);
      }

      // encode bandCombination_v1570

      if (bandCombination_v1570 != null) {
         buffer.getContext().eventDispatcher.startElement("bandCombination_v1570", -1);

         bandCombination_v1570.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("bandCombination_v1570", -1);
      }

      // encode bandCombination_v1580

      if (bandCombination_v1580 != null) {
         buffer.getContext().eventDispatcher.startElement("bandCombination_v1580", -1);

         bandCombination_v1580.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("bandCombination_v1580", -1);
      }

      // encode bandCombination_v1590

      if (bandCombination_v1590 != null) {
         buffer.getContext().eventDispatcher.startElement("bandCombination_v1590", -1);

         bandCombination_v1590.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("bandCombination_v1590", -1);
      }

      // encode bandCombination_v1610

      if (bandCombination_v1610 != null) {
         buffer.getContext().eventDispatcher.startElement("bandCombination_v1610", -1);

         bandCombination_v1610.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("bandCombination_v1610", -1);
      }

      // encode supportedBandPairListNR_r16

      if (supportedBandPairListNR_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("supportedBandPairListNR_r16", -1);

         supportedBandPairListNR_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("supportedBandPairListNR_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("supportedBandPairListNR_r16");

      // encode uplinkTxSwitching_OptionSupport_r16

      if (uplinkTxSwitching_OptionSupport_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("uplinkTxSwitching_OptionSupport_r16", -1);

         uplinkTxSwitching_OptionSupport_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("uplinkTxSwitching_OptionSupport_r16", -1);
      }

      // encode uplinkTxSwitching_PowerBoosting_r16

      if (uplinkTxSwitching_PowerBoosting_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("uplinkTxSwitching_PowerBoosting_r16", -1);

         uplinkTxSwitching_PowerBoosting_r16.encode (buffer);
