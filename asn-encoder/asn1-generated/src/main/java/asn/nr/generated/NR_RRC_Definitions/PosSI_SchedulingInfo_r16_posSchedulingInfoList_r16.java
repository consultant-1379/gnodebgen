...
public class PosSI_SchedulingInfo_r16_posSchedulingInfoList_r16 extends Asn1SeqOf {
   ...
   public PosSchedulingInfo_r16[] elements;

   public PosSI_SchedulingInfo_r16_posSchedulingInfoList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PosSI_SchedulingInfo_r16_posSchedulingInfoList_r16 (int numRecords) {
      elements = new PosSchedulingInfo_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PosSI_SchedulingInfo_r16_posSchedulingInfoList_r16 (PosSchedulingInfo_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PosSchedulingInfo_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PosSchedulingInfo_r16();
