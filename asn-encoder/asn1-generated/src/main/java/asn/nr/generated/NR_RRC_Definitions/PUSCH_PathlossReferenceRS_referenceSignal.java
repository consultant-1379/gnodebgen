...
public class PUSCH_PathlossReferenceRS_referenceSignal extends Asn1Choice {
   ...
   public PUSCH_PathlossReferenceRS_referenceSignal () {
      super();
   }

   public PUSCH_PathlossReferenceRS_referenceSignal (byte choiceId_, Asn1Type element_) {
      super();
