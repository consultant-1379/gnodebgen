...
public class RF_Parameters_supportedBandListNR extends Asn1SeqOf {
   ...
   public BandNR[] elements;

   public RF_Parameters_supportedBandListNR () {
      elements = null;
   }
    ...
    * populated.
    */
   public RF_Parameters_supportedBandListNR (int numRecords) {
      elements = new BandNR [numRecords];
   }
    ...
    * given the array.  
    */
   public RF_Parameters_supportedBandListNR (BandNR[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandNR [numElements];
