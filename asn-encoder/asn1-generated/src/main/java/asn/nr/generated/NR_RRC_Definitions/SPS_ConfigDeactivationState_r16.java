...
public class SPS_ConfigDeactivationState_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPS-ConfigDeactivationState-r16";
   }

   public SPS_ConfigIndex_r16[] elements;

   public SPS_ConfigDeactivationState_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPS_ConfigDeactivationState_r16 (int numRecords) {
      elements = new SPS_ConfigIndex_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SPS_ConfigDeactivationState_r16 (SPS_ConfigIndex_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SPS_ConfigIndex_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SPS_ConfigIndex_r16();
