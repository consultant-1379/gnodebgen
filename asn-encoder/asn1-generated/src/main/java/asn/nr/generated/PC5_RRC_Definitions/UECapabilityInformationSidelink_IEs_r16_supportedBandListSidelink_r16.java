...
public class UECapabilityInformationSidelink_IEs_r16_supportedBandListSidelink_r16 extends Asn1SeqOf {
   ...
   public BandSidelinkPC5_r16[] elements;

   public UECapabilityInformationSidelink_IEs_r16_supportedBandListSidelink_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UECapabilityInformationSidelink_IEs_r16_supportedBandListSidelink_r16 (int numRecords) {
      elements = new BandSidelinkPC5_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public UECapabilityInformationSidelink_IEs_r16_supportedBandListSidelink_r16 (BandSidelinkPC5_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 1024);
      int numElements = (int) buffer.decodeLength();

      elements = new BandSidelinkPC5_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandSidelinkPC5_r16();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 1024);
