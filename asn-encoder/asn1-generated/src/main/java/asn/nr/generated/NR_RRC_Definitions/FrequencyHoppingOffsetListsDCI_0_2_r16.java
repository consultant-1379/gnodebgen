...
public class FrequencyHoppingOffsetListsDCI_0_2_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "FrequencyHoppingOffsetListsDCI-0-2-r16";
   }

   public Asn1Integer[] elements;

   public FrequencyHoppingOffsetListsDCI_0_2_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FrequencyHoppingOffsetListsDCI_0_2_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public FrequencyHoppingOffsetListsDCI_0_2_r16 (Asn1Integer[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i].decode (buffer, 1, 274);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i].encode (buffer, 1, 274);
