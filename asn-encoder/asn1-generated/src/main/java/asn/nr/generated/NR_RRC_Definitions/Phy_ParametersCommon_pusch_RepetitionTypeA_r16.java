...
public class Phy_ParametersCommon_pusch_RepetitionTypeA_r16 extends Asn1Seq {
   ...
   public Phy_ParametersCommon_pusch_RepetitionTypeA_r16_sharedSpectrumChAccess_r16 sharedSpectrumChAccess_r16 = null;  // optional
   public Phy_ParametersCommon_pusch_RepetitionTypeA_r16_non_SharedSpectrumChAccess_r16 non_SharedSpectrumChAccess_r16 = null;  // optional

   public Phy_ParametersCommon_pusch_RepetitionTypeA_r16 () {
      super();
      init();
   }
    ...
    */
   public Phy_ParametersCommon_pusch_RepetitionTypeA_r16 (
      Phy_ParametersCommon_pusch_RepetitionTypeA_r16_sharedSpectrumChAccess_r16 sharedSpectrumChAccess_r16_,
      Phy_ParametersCommon_pusch_RepetitionTypeA_r16_non_SharedSpectrumChAccess_r16 non_SharedSpectrumChAccess_r16_
   ) {
      super();
   ...
   public Object getElementValue(int index){
      switch(index)  {
         case 0: return sharedSpectrumChAccess_r16;
         case 1: return non_SharedSpectrumChAccess_r16;
         default: return null;
      }
   }
   ...
   public String getElementName(int index){
      switch(index)  {
         case 0: return "sharedSpectrumChAccess-r16";
         case 1: return "non-SharedSpectrumChAccess-r16";
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (sharedSpectrumChAccess_r16Present) {
         ...
         int tval = Phy_ParametersCommon_pusch_RepetitionTypeA_r16_sharedSpectrumChAccess_r16.decodeEnumValue (buffer);
         sharedSpectrumChAccess_r16 = Phy_ParametersCommon_pusch_RepetitionTypeA_r16_sharedSpectrumChAccess_r16.valueOf (tval);
      ...
      if (non_SharedSpectrumChAccess_r16Present) {
         ...
         int tval = Phy_ParametersCommon_pusch_RepetitionTypeA_r16_non_SharedSpectrumChAccess_r16.decodeEnumValue (buffer);
         non_SharedSpectrumChAccess_r16 = Phy_ParametersCommon_pusch_RepetitionTypeA_r16_non_SharedSpectrumChAccess_r16.valueOf (tval);
