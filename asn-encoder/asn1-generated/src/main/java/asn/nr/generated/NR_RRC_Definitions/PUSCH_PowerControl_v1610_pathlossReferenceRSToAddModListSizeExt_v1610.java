...
public class PUSCH_PowerControl_v1610_pathlossReferenceRSToAddModListSizeExt_v1610 extends Asn1SeqOf {
   ...
   public PUSCH_PathlossReferenceRS_r16[] elements;

   public PUSCH_PowerControl_v1610_pathlossReferenceRSToAddModListSizeExt_v1610 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUSCH_PowerControl_v1610_pathlossReferenceRSToAddModListSizeExt_v1610 (int numRecords) {
      elements = new PUSCH_PathlossReferenceRS_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PUSCH_PowerControl_v1610_pathlossReferenceRSToAddModListSizeExt_v1610 (PUSCH_PathlossReferenceRS_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUSCH_PathlossReferenceRS_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUSCH_PathlossReferenceRS_r16();
