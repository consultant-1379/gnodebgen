...
public class PathlossReferenceRSs_v1610 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PathlossReferenceRSs-v1610";
   }

   public PUCCH_PathlossReferenceRS_r16[] elements;

   public PathlossReferenceRSs_v1610 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PathlossReferenceRSs_v1610 (int numRecords) {
      elements = new PUCCH_PathlossReferenceRS_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PathlossReferenceRSs_v1610 (PUCCH_PathlossReferenceRS_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUCCH_PathlossReferenceRS_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUCCH_PathlossReferenceRS_r16();
