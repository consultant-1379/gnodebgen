...
public class MeasResultListLoggingNR_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultListLoggingNR-r16";
   }

   public MeasResultLoggingNR_r16[] elements;

   public MeasResultListLoggingNR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListLoggingNR_r16 (int numRecords) {
      elements = new MeasResultLoggingNR_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListLoggingNR_r16 (MeasResultLoggingNR_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultLoggingNR_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultLoggingNR_r16();
