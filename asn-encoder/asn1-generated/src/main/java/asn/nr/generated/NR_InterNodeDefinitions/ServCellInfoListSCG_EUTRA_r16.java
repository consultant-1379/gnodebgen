...
public class ServCellInfoListSCG_EUTRA_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServCellInfoListSCG-EUTRA-r16";
   }

   public ServCellInfoXCG_EUTRA_r16[] elements;

   public ServCellInfoListSCG_EUTRA_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServCellInfoListSCG_EUTRA_r16 (int numRecords) {
      elements = new ServCellInfoXCG_EUTRA_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public ServCellInfoListSCG_EUTRA_r16 (ServCellInfoXCG_EUTRA_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServCellInfoXCG_EUTRA_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServCellInfoXCG_EUTRA_r16();
