...
public class RateMatchPattern_patternType_bitmaps extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((periodicityAndPattern != null), null);

      // encode resourceBlocks

      if (resourceBlocks != null) {
         buffer.getContext().eventDispatcher.startElement("resourceBlocks", -1);

         resourceBlocks.encode (buffer, 275, 275);

         buffer.getContext().eventDispatcher.endElement("resourceBlocks", -1);
      }
      else throw new Asn1MissingRequiredException ("resourceBlocks");

      // encode symbolsInResourceBlock

      if (symbolsInResourceBlock != null) {
         buffer.getContext().eventDispatcher.startElement("symbolsInResourceBlock", -1);

         symbolsInResourceBlock.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("symbolsInResourceBlock", -1);
      }
      else throw new Asn1MissingRequiredException ("symbolsInResourceBlock");

      // encode periodicityAndPattern

      if (periodicityAndPattern != null) {
         buffer.getContext().eventDispatcher.startElement("periodicityAndPattern", -1);

         periodicityAndPattern.encode (buffer);
