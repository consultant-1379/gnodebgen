...
public class RRCReconfiguration_v1530_IEs_dedicatedNAS_MessageList extends Asn1SeqOf {
   ...
   public DedicatedNAS_Message[] elements;

   public RRCReconfiguration_v1530_IEs_dedicatedNAS_MessageList () {
      elements = null;
   }
    ...
    * populated.
    */
   public RRCReconfiguration_v1530_IEs_dedicatedNAS_MessageList (int numRecords) {
      elements = new DedicatedNAS_Message [numRecords];
   }
    ...
    * given the array.  
    */
   public RRCReconfiguration_v1530_IEs_dedicatedNAS_MessageList (DedicatedNAS_Message[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 29);
      int numElements = (int) buffer.decodeLength();

      elements = new DedicatedNAS_Message [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DedicatedNAS_Message();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 29);
