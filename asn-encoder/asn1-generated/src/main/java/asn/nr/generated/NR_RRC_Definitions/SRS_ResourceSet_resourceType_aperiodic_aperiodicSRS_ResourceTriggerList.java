...
public class SRS_ResourceSet_resourceType_aperiodic_aperiodicSRS_ResourceTriggerList extends Asn1SeqOf {
   ...
   public SRS_ResourceSet_resourceType_aperiodic_aperiodicSRS_ResourceTriggerList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRS_ResourceSet_resourceType_aperiodic_aperiodicSRS_ResourceTriggerList (int numRecords) {
    ...
    * given the array.  
    */
   public SRS_ResourceSet_resourceType_aperiodic_aperiodicSRS_ResourceTriggerList (Asn1Integer[] elements_) {
      elements = elements_;
   }
