...
public class SL_PQI_r16 extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // sl_StandardizedPQI_r16
         case _SL_STANDARDIZEDPQI_R16:
            Asn1Integer sl_StandardizedPQI_r16 = (Asn1Integer) element;
            sl_StandardizedPQI_r16.encode (buffer, 0, 255);
            break;

         // sl_Non_StandardizedPQI_r16
         case _SL_NON_STANDARDIZEDPQI_R16:
            SL_PQI_r16_sl_Non_StandardizedPQI_r16 sl_Non_StandardizedPQI_r16 = (SL_PQI_r16_sl_Non_StandardizedPQI_r16) element;
            sl_Non_StandardizedPQI_r16.encode (buffer);
            break;
