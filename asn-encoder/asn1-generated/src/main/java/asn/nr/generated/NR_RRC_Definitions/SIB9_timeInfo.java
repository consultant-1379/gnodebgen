...
public class SIB9_timeInfo extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((dayLightSavingTime != null), null);
      buffer.encodeBit ((leapSeconds != null), null);
      buffer.encodeBit ((localTimeOffset != null), null);
      ...
      if (timeInfoUTC != null) {
         ...
         timeInfoUTC.encode (buffer, 0, 549755813887L);

         buffer.getContext().eventDispatcher.endElement("timeInfoUTC", -1);
      }
      else throw new Asn1MissingRequiredException ("timeInfoUTC");

      // encode dayLightSavingTime

      if (dayLightSavingTime != null) {
         buffer.getContext().eventDispatcher.startElement("dayLightSavingTime", -1);

         dayLightSavingTime.encode (buffer, 2, 2);
      ...
      if (leapSeconds != null) {
         ...
         leapSeconds.encode (buffer, -127, 128);

         buffer.getContext().eventDispatcher.endElement("leapSeconds", -1);
      }

      // encode localTimeOffset

      if (localTimeOffset != null) {
         buffer.getContext().eventDispatcher.startElement("localTimeOffset", -1);

         localTimeOffset.encode (buffer, -63, 64);
