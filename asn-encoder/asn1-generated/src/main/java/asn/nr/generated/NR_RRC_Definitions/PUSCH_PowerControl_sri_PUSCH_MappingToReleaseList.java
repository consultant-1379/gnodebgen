...
public class PUSCH_PowerControl_sri_PUSCH_MappingToReleaseList extends Asn1SeqOf {
   ...
   public SRI_PUSCH_PowerControlId[] elements;

   public PUSCH_PowerControl_sri_PUSCH_MappingToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUSCH_PowerControl_sri_PUSCH_MappingToReleaseList (int numRecords) {
      elements = new SRI_PUSCH_PowerControlId [numRecords];
   }
    ...
    * given the array.  
    */
   public PUSCH_PowerControl_sri_PUSCH_MappingToReleaseList (SRI_PUSCH_PowerControlId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRI_PUSCH_PowerControlId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRI_PUSCH_PowerControlId();
