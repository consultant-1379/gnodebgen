...
public class UCI_OnPUSCH_betaOffsets_dynamic extends Asn1SeqOf {
   ...
   public UCI_OnPUSCH_betaOffsets_dynamic () {
      elements = null;
   }
    ...
    * populated.
    */
   public UCI_OnPUSCH_betaOffsets_dynamic (int numRecords) {
    ...
    * given the array.  
    */
   public UCI_OnPUSCH_betaOffsets_dynamic (BetaOffsets[] elements_) {
      elements = elements_;
   }
