...
public class WLAN_Name_r16 extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "WLAN-Name-r16";
   }

   public WLAN_Name_r16 () {
      super();
   }
    ...
    *              in binary form.
    */
   public WLAN_Name_r16 (byte[] data) {
      super (data);
   }
    ...
    */
   public WLAN_Name_r16 (byte[] data, int offset, int nbytes) {
    ...
    */
   public WLAN_Name_r16 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
