...
public class CG_Config_v1590_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((scellFrequenciesSN_NR != null), null);
      buffer.encodeBit ((scellFrequenciesSN_EUTRA != null), null);
      buffer.encodeBit ((nonCriticalExtension != null), null);

      // encode scellFrequenciesSN_NR

      if (scellFrequenciesSN_NR != null) {
         buffer.getContext().eventDispatcher.startElement("scellFrequenciesSN_NR", -1);

         scellFrequenciesSN_NR.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("scellFrequenciesSN_NR", -1);
      }

      // encode scellFrequenciesSN_EUTRA

      if (scellFrequenciesSN_EUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("scellFrequenciesSN_EUTRA", -1);

         scellFrequenciesSN_EUTRA.encode (buffer);
