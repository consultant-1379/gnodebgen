...
public class ReconfigurationWithSync extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((spCellConfigCommon != null), null);
      buffer.encodeBit ((rach_ConfigDedicated != null), null);

      // encode spCellConfigCommon

      if (spCellConfigCommon != null) {
         buffer.getContext().eventDispatcher.startElement("spCellConfigCommon", -1);

         spCellConfigCommon.encode (buffer);
      ...
      if (newUE_Identity != null) {
         buffer.getContext().eventDispatcher.startElement("newUE_Identity", -1);

         newUE_Identity.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("newUE_Identity", -1);
      }
      else throw new Asn1MissingRequiredException ("newUE_Identity");
      ...
      else throw new Asn1MissingRequiredException ("t304");

      // encode rach_ConfigDedicated

      if (rach_ConfigDedicated != null) {
         buffer.getContext().eventDispatcher.startElement("rach_ConfigDedicated", -1);

         rach_ConfigDedicated.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((daps_UplinkPowerConfig_r16 != null), "optbit");
            if (daps_UplinkPowerConfig_r16 != null) {
               daps_UplinkPowerConfig_r16.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
