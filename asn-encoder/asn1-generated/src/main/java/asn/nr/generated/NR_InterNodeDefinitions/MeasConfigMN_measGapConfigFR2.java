...
import asn.nr.generated.NR_RRC_Definitions.GapConfig;

public class MeasConfigMN_measGapConfigFR2 extends Asn1Choice {
   ...
   public MeasConfigMN_measGapConfigFR2 () {
      super();
   }

   public MeasConfigMN_measGapConfigFR2 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (GapConfig value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            GapConfig setup = (GapConfig) element;
            setup.encode (buffer);
            break;
