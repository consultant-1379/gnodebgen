...
public class PhysicalCellGroupConfig_dcp_Config_r16 extends Asn1Choice {
   ...
   public PhysicalCellGroupConfig_dcp_Config_r16 () {
      super();
   }

   public PhysicalCellGroupConfig_dcp_Config_r16 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (DCP_Config_r16 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            DCP_Config_r16 setup;
            element = setup = new DCP_Config_r16();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            DCP_Config_r16 setup = (DCP_Config_r16) element;
            setup.encode (buffer);
            break;
