...
public class I_RNTI_Value extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public I_RNTI_Value (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public I_RNTI_Value (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public I_RNTI_Value (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public I_RNTI_Value (java.util.BitSet bitSet) {
      super (bitSet);
   }
