...
public class RA_InformationCommon_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((msg1_FrequencyStart_r16 != null), null);
      buffer.encodeBit ((msg1_FrequencyStartCFRA_r16 != null), null);
      buffer.encodeBit ((msg1_SubcarrierSpacing_r16 != null), null);
      buffer.encodeBit ((msg1_SubcarrierSpacingCFRA_r16 != null), null);
      buffer.encodeBit ((msg1_FDM_r16 != null), null);
      buffer.encodeBit ((msg1_FDMCFRA_r16 != null), null);

      // encode absoluteFrequencyPointA_r16

      if (absoluteFrequencyPointA_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("absoluteFrequencyPointA_r16", -1);

         absoluteFrequencyPointA_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("absoluteFrequencyPointA_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("absoluteFrequencyPointA_r16");

      // encode locationAndBandwidth_r16

      if (locationAndBandwidth_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("locationAndBandwidth_r16", -1);

         locationAndBandwidth_r16.encode (buffer, 0, 37949);

         buffer.getContext().eventDispatcher.endElement("locationAndBandwidth_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("locationAndBandwidth_r16");
      ...
      // encode msg1_FrequencyStart_r16

      if (msg1_FrequencyStart_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("msg1_FrequencyStart_r16", -1);

         msg1_FrequencyStart_r16.encode (buffer, 0, 274);

         buffer.getContext().eventDispatcher.endElement("msg1_FrequencyStart_r16", -1);
      }

      // encode msg1_FrequencyStartCFRA_r16

      if (msg1_FrequencyStartCFRA_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("msg1_FrequencyStartCFRA_r16", -1);

         msg1_FrequencyStartCFRA_r16.encode (buffer, 0, 274);

         buffer.getContext().eventDispatcher.endElement("msg1_FrequencyStartCFRA_r16", -1);
      }

      // encode msg1_SubcarrierSpacing_r16

      if (msg1_SubcarrierSpacing_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("msg1_SubcarrierSpacing_r16", -1);

         msg1_SubcarrierSpacing_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("msg1_SubcarrierSpacing_r16", -1);
      }

      // encode msg1_SubcarrierSpacingCFRA_r16

      if (msg1_SubcarrierSpacingCFRA_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("msg1_SubcarrierSpacingCFRA_r16", -1);

         msg1_SubcarrierSpacingCFRA_r16.encode (buffer);
      ...
      if (msg1_FDM_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("msg1_FDM_r16", -1);

         msg1_FDM_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("msg1_FDM_r16", -1);
      }

      // encode msg1_FDMCFRA_r16

      if (msg1_FDMCFRA_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("msg1_FDMCFRA_r16", -1);

         msg1_FDMCFRA_r16.encode (buffer);
