...
public class CG_Config_v1560_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((pSCellFrequencyEUTRA != null), null);
      buffer.encodeBit ((scg_CellGroupConfigEUTRA != null), null);
      buffer.encodeBit ((candidateCellInfoListSN_EUTRA != null), null);
      buffer.encodeBit ((candidateServingFreqListEUTRA != null), null);
      buffer.encodeBit ((needForGaps != null), null);
      buffer.encodeBit ((drx_ConfigSCG != null), null);
      buffer.encodeBit ((reportCGI_RequestEUTRA != null), null);
      buffer.encodeBit ((nonCriticalExtension != null), null);

      // encode pSCellFrequencyEUTRA

      if (pSCellFrequencyEUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("pSCellFrequencyEUTRA", -1);

         pSCellFrequencyEUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pSCellFrequencyEUTRA", -1);
      }

      // encode scg_CellGroupConfigEUTRA

      if (scg_CellGroupConfigEUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("scg_CellGroupConfigEUTRA", -1);

         scg_CellGroupConfigEUTRA.encode (buffer);
      ...
      // encode candidateServingFreqListEUTRA

      if (candidateServingFreqListEUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("candidateServingFreqListEUTRA", -1);

         candidateServingFreqListEUTRA.encode (buffer);
      ...
      if (needForGaps != null) {
         ...
         needForGaps.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("needForGaps", -1);
      }

      // encode drx_ConfigSCG

      if (drx_ConfigSCG != null) {
         buffer.getContext().eventDispatcher.startElement("drx_ConfigSCG", -1);

         drx_ConfigSCG.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("drx_ConfigSCG", -1);
      }

      // encode reportCGI_RequestEUTRA

      if (reportCGI_RequestEUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("reportCGI_RequestEUTRA", -1);

         reportCGI_RequestEUTRA.encode (buffer);
