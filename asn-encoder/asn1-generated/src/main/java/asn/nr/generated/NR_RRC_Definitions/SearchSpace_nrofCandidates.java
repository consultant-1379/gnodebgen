...
public class SearchSpace_nrofCandidates extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      else throw new Asn1MissingRequiredException ("aggregationLevel1");
      ...
      else throw new Asn1MissingRequiredException ("aggregationLevel2");
      ...
      else throw new Asn1MissingRequiredException ("aggregationLevel4");
      ...
      else throw new Asn1MissingRequiredException ("aggregationLevel8");
      ...
      else throw new Asn1MissingRequiredException ("aggregationLevel16");
