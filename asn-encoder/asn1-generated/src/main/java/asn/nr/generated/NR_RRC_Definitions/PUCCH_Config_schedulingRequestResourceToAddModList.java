...
public class PUCCH_Config_schedulingRequestResourceToAddModList extends Asn1SeqOf {
   ...
   public SchedulingRequestResourceConfig[] elements;

   public PUCCH_Config_schedulingRequestResourceToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_schedulingRequestResourceToAddModList (int numRecords) {
      elements = new SchedulingRequestResourceConfig [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_Config_schedulingRequestResourceToAddModList (SchedulingRequestResourceConfig[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SchedulingRequestResourceConfig [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SchedulingRequestResourceConfig();
