...
public class CGI_InfoEUTRA_cgi_info_5GC extends Asn1SeqOf {
   ...
   public CellAccessRelatedInfo_EUTRA_5GC[] elements;

   public CGI_InfoEUTRA_cgi_info_5GC () {
      elements = null;
   }
    ...
    * populated.
    */
   public CGI_InfoEUTRA_cgi_info_5GC (int numRecords) {
      elements = new CellAccessRelatedInfo_EUTRA_5GC [numRecords];
   }
    ...
    * given the array.  
    */
   public CGI_InfoEUTRA_cgi_info_5GC (CellAccessRelatedInfo_EUTRA_5GC[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellAccessRelatedInfo_EUTRA_5GC [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellAccessRelatedInfo_EUTRA_5GC();
