...
public class CSI_MeasConfig_csi_ResourceConfigToAddModList extends Asn1SeqOf {
   ...
   public CSI_ResourceConfig[] elements;

   public CSI_MeasConfig_csi_ResourceConfigToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_csi_ResourceConfigToAddModList (int numRecords) {
      elements = new CSI_ResourceConfig [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_MeasConfig_csi_ResourceConfigToAddModList (CSI_ResourceConfig[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_ResourceConfig [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_ResourceConfig();
