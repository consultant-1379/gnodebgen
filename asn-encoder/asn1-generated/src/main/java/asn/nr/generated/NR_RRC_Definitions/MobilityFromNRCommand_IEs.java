...
public class MobilityFromNRCommand_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((nas_SecurityParamFromNR != null), null);
      buffer.encodeBit ((lateNonCriticalExtension != null), null);
      buffer.encodeBit ((nonCriticalExtension != null), null);

      // encode targetRAT_Type

      if (targetRAT_Type != null) {
         buffer.getContext().eventDispatcher.startElement("targetRAT_Type", -1);

         targetRAT_Type.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("targetRAT_Type", -1);
      }
      else throw new Asn1MissingRequiredException ("targetRAT_Type");

      // encode targetRAT_MessageContainer

      if (targetRAT_MessageContainer != null) {
         buffer.getContext().eventDispatcher.startElement("targetRAT_MessageContainer", -1);

         targetRAT_MessageContainer.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("targetRAT_MessageContainer", -1);
      }
      else throw new Asn1MissingRequiredException ("targetRAT_MessageContainer");

      // encode nas_SecurityParamFromNR

      if (nas_SecurityParamFromNR != null) {
         buffer.getContext().eventDispatcher.startElement("nas_SecurityParamFromNR", -1);

         nas_SecurityParamFromNR.encode (buffer);
