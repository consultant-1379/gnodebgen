...
public class ShortI_RNTI_Value extends Asn1BitString {
    ...
    */
   public ShortI_RNTI_Value (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public ShortI_RNTI_Value (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public ShortI_RNTI_Value (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public ShortI_RNTI_Value (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public ShortI_RNTI_Value (java.util.BitSet bitSet) {
      super (bitSet);
   }
