...
public class FreqBandInformationNR extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((maxBandwidthRequestedDL != null), null);
      buffer.encodeBit ((maxBandwidthRequestedUL != null), null);
      buffer.encodeBit ((maxCarriersRequestedDL != null), null);
      buffer.encodeBit ((maxCarriersRequestedUL != null), null);
      ...
      // encode maxBandwidthRequestedDL

      if (maxBandwidthRequestedDL != null) {
         buffer.getContext().eventDispatcher.startElement("maxBandwidthRequestedDL", -1);

         maxBandwidthRequestedDL.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("maxBandwidthRequestedDL", -1);
      }

      // encode maxBandwidthRequestedUL

      if (maxBandwidthRequestedUL != null) {
         buffer.getContext().eventDispatcher.startElement("maxBandwidthRequestedUL", -1);

         maxBandwidthRequestedUL.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("maxBandwidthRequestedUL", -1);
      }

      // encode maxCarriersRequestedDL

      if (maxCarriersRequestedDL != null) {
         buffer.getContext().eventDispatcher.startElement("maxCarriersRequestedDL", -1);

         maxCarriersRequestedDL.encode (buffer, 1, 32);

         buffer.getContext().eventDispatcher.endElement("maxCarriersRequestedDL", -1);
      }

      // encode maxCarriersRequestedUL

      if (maxCarriersRequestedUL != null) {
         buffer.getContext().eventDispatcher.startElement("maxCarriersRequestedUL", -1);

         maxCarriersRequestedUL.encode (buffer, 1, 32);
