...
public class CodebookParameters_type2_PortSelection_supportedCSI_RS_ResourceList extends Asn1SeqOf {
   ...
   public SupportedCSI_RS_Resource[] elements;

   public CodebookParameters_type2_PortSelection_supportedCSI_RS_ResourceList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CodebookParameters_type2_PortSelection_supportedCSI_RS_ResourceList (int numRecords) {
      elements = new SupportedCSI_RS_Resource [numRecords];
   }
    ...
    * given the array.  
    */
   public CodebookParameters_type2_PortSelection_supportedCSI_RS_ResourceList (SupportedCSI_RS_Resource[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 7);
      int numElements = (int) buffer.decodeLength();

      elements = new SupportedCSI_RS_Resource [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedCSI_RS_Resource();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 7);
