...
public class RateMatchPattern extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((subcarrierSpacing != null), null);

      // encode rateMatchPatternId

      if (rateMatchPatternId != null) {
         buffer.getContext().eventDispatcher.startElement("rateMatchPatternId", -1);

         rateMatchPatternId.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("rateMatchPatternId", -1);
      }
      else throw new Asn1MissingRequiredException ("rateMatchPatternId");
      ...
      if (patternType != null) {
         ...
         patternType.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("patternType", -1);
      }
      else throw new Asn1MissingRequiredException ("patternType");
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((controlResourceSet_r16 != null), "optbit");
            if (controlResourceSet_r16 != null) {
               controlResourceSet_r16.encode (buffer);
            }
