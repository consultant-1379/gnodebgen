...
public class PUCCH_ConfigurationList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PUCCH-ConfigurationList-r16";
   }

   public PUCCH_Config[] elements;

   public PUCCH_ConfigurationList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_ConfigurationList_r16 (int numRecords) {
      elements = new PUCCH_Config [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_ConfigurationList_r16 (PUCCH_Config[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUCCH_Config [numElements];
