...
public class PUSCH_PowerControl_pathlossReferenceRSToReleaseList extends Asn1SeqOf {
   ...
   public PUSCH_PathlossReferenceRS_Id[] elements;

   public PUSCH_PowerControl_pathlossReferenceRSToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUSCH_PowerControl_pathlossReferenceRSToReleaseList (int numRecords) {
      elements = new PUSCH_PathlossReferenceRS_Id [numRecords];
   }
    ...
    * given the array.  
    */
   public PUSCH_PowerControl_pathlossReferenceRSToReleaseList (PUSCH_PathlossReferenceRS_Id[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUSCH_PathlossReferenceRS_Id [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUSCH_PathlossReferenceRS_Id();
