...
public class PCI_RangeIndexList extends Asn1SeqOf {
   ...
   public PCI_RangeIndex[] elements;

   public PCI_RangeIndexList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PCI_RangeIndexList (int numRecords) {
      elements = new PCI_RangeIndex [numRecords];
   }
    ...
    * given the array.  
    */
   public PCI_RangeIndexList (PCI_RangeIndex[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PCI_RangeIndex [numElements];
