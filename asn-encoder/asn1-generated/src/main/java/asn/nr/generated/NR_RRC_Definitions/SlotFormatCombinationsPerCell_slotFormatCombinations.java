...
public class SlotFormatCombinationsPerCell_slotFormatCombinations extends Asn1SeqOf {
   ...
   public SlotFormatCombination[] elements;

   public SlotFormatCombinationsPerCell_slotFormatCombinations () {
      elements = null;
   }
    ...
    * populated.
    */
   public SlotFormatCombinationsPerCell_slotFormatCombinations (int numRecords) {
      elements = new SlotFormatCombination [numRecords];
   }
    ...
    * given the array.  
    */
   public SlotFormatCombinationsPerCell_slotFormatCombinations (SlotFormatCombination[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SlotFormatCombination [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SlotFormatCombination();
