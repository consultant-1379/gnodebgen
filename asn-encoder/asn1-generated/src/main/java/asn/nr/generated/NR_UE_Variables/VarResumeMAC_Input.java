...
import asn.nr.generated.NR_RRC_Definitions.RNTI_Value;

public class VarResumeMAC_Input extends Asn1Seq {
    ...
    * the given objects 
    */
   public VarResumeMAC_Input (long sourcePhysCellId_,
      CellIdentity targetCellIdentity_,
      long source_c_RNTI_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (sourcePhysCellId != null) {
         ...
         sourcePhysCellId.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sourcePhysCellId", -1);
      }
      else throw new Asn1MissingRequiredException ("sourcePhysCellId");

      // encode targetCellIdentity

      if (targetCellIdentity != null) {
         buffer.getContext().eventDispatcher.startElement("targetCellIdentity", -1);

         targetCellIdentity.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("targetCellIdentity", -1);
      }
      else throw new Asn1MissingRequiredException ("targetCellIdentity");

      // encode source_c_RNTI

      if (source_c_RNTI != null) {
         buffer.getContext().eventDispatcher.startElement("source_c_RNTI", -1);

         source_c_RNTI.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("source_c_RNTI", -1);
      }
      else throw new Asn1MissingRequiredException ("source_c_RNTI");
