...
public class MeasObjectNR extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((ssbFrequency != null), null);
      buffer.encodeBit ((ssbSubcarrierSpacing != null), null);
      buffer.encodeBit ((smtc1 != null), null);
      buffer.encodeBit ((smtc2 != null), null);
      buffer.encodeBit ((refFreqCSI_RS != null), null);
      buffer.encodeBit ((absThreshSS_BlocksConsolidation != null), null);
      buffer.encodeBit ((absThreshCSI_RS_Consolidation != null), null);
      buffer.encodeBit ((nrofSS_BlocksToAverage != null), null);
      buffer.encodeBit ((nrofCSI_RS_ResourcesToAverage != null), null);
      buffer.encodeBit ((cellsToRemoveList != null), null);
      buffer.encodeBit ((cellsToAddModList != null), null);
      buffer.encodeBit ((blackCellsToRemoveList != null), null);
      buffer.encodeBit ((blackCellsToAddModList != null), null);
      buffer.encodeBit ((whiteCellsToRemoveList != null), null);
      buffer.encodeBit ((whiteCellsToAddModList != null), null);
      ...
      // encode refFreqCSI_RS

      if (refFreqCSI_RS != null) {
         buffer.getContext().eventDispatcher.startElement("refFreqCSI_RS", -1);

         refFreqCSI_RS.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("refFreqCSI_RS", -1);
      }

      // encode referenceSignalConfig

      if (referenceSignalConfig != null) {
         buffer.getContext().eventDispatcher.startElement("referenceSignalConfig", -1);

         referenceSignalConfig.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("referenceSignalConfig", -1);
      }
      else throw new Asn1MissingRequiredException ("referenceSignalConfig");
      ...
      // encode absThreshCSI_RS_Consolidation

      if (absThreshCSI_RS_Consolidation != null) {
         buffer.getContext().eventDispatcher.startElement("absThreshCSI_RS_Consolidation", -1);

         absThreshCSI_RS_Consolidation.encode (buffer);
      ...
      // encode nrofCSI_RS_ResourcesToAverage

      if (nrofCSI_RS_ResourcesToAverage != null) {
         buffer.getContext().eventDispatcher.startElement("nrofCSI_RS_ResourcesToAverage", -1);

         nrofCSI_RS_ResourcesToAverage.encode (buffer, 2, 16);

         buffer.getContext().eventDispatcher.endElement("nrofCSI_RS_ResourcesToAverage", -1);
      }

      // encode quantityConfigIndex

      if (quantityConfigIndex != null) {
         buffer.getContext().eventDispatcher.startElement("quantityConfigIndex", -1);

         quantityConfigIndex.encode (buffer, 1, 2);

         buffer.getContext().eventDispatcher.endElement("quantityConfigIndex", -1);
      }
      else throw new Asn1MissingRequiredException ("quantityConfigIndex");
      ...
      if (offsetMO != null) {
         ...
         offsetMO.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("offsetMO", -1);
      }
      else throw new Asn1MissingRequiredException ("offsetMO");
      ...
      if (cellsToRemoveList != null) {
         ...
         cellsToRemoveList.encode (buffer);
      ...
      if (cellsToAddModList != null) {
         ...
         cellsToAddModList.encode (buffer);
      ...
      if (blackCellsToRemoveList != null) {
         ...
         blackCellsToRemoveList.encode (buffer);
      ...
      if (blackCellsToAddModList != null) {
         ...
         blackCellsToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("blackCellsToAddModList", -1);
      }

      // encode whiteCellsToRemoveList

      if (whiteCellsToRemoveList != null) {
         buffer.getContext().eventDispatcher.startElement("whiteCellsToRemoveList", -1);

         whiteCellsToRemoveList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("whiteCellsToRemoveList", -1);
      }

      // encode whiteCellsToAddModList

      if (whiteCellsToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("whiteCellsToAddModList", -1);

         whiteCellsToAddModList.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((freqBandIndicatorNR != null), "optbit");
            buffer.encodeBit ((measCycleSCell != null), "optbit");
            if (freqBandIndicatorNR != null) {
               freqBandIndicatorNR.encode (buffer);
            }
            if (measCycleSCell != null) {
               measCycleSCell.encode (buffer);
            }
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((smtc3list_r16 != null), "optbit");
            buffer.encodeBit ((rmtc_Config_r16 != null), "optbit");
            buffer.encodeBit ((t312_r16 != null), "optbit");
            if (smtc3list_r16 != null) {
               smtc3list_r16.encode (buffer);
            }
            if (rmtc_Config_r16 != null) {
               rmtc_Config_r16.encode (buffer);
            }
            if (t312_r16 != null) {
               t312_r16.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
