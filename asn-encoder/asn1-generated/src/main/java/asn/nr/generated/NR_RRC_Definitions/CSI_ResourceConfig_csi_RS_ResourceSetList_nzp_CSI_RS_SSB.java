...
public class CSI_ResourceConfig_csi_RS_ResourceSetList_nzp_CSI_RS_SSB extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((nzp_CSI_RS_ResourceSetList != null), null);
      buffer.encodeBit ((csi_SSB_ResourceSetList != null), null);

      // encode nzp_CSI_RS_ResourceSetList

      if (nzp_CSI_RS_ResourceSetList != null) {
         buffer.getContext().eventDispatcher.startElement("nzp_CSI_RS_ResourceSetList", -1);

         nzp_CSI_RS_ResourceSetList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("nzp_CSI_RS_ResourceSetList", -1);
      }

      // encode csi_SSB_ResourceSetList

      if (csi_SSB_ResourceSetList != null) {
         buffer.getContext().eventDispatcher.startElement("csi_SSB_ResourceSetList", -1);

         csi_SSB_ResourceSetList.encode (buffer);
