...
public class SL_MeasConfig_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((sl_MeasObjectToRemoveList_r16 != null), null);
      buffer.encodeBit ((sl_MeasObjectToAddModList_r16 != null), null);
      buffer.encodeBit ((sl_ReportConfigToRemoveList_r16 != null), null);
      buffer.encodeBit ((sl_ReportConfigToAddModList_r16 != null), null);
      buffer.encodeBit ((sl_MeasIdToRemoveList_r16 != null), null);
      buffer.encodeBit ((sl_MeasIdToAddModList_r16 != null), null);
      buffer.encodeBit ((sl_QuantityConfig_r16 != null), null);

      // encode sl_MeasObjectToRemoveList_r16

      if (sl_MeasObjectToRemoveList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_MeasObjectToRemoveList_r16", -1);

         sl_MeasObjectToRemoveList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_MeasObjectToRemoveList_r16", -1);
      }

      // encode sl_MeasObjectToAddModList_r16

      if (sl_MeasObjectToAddModList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_MeasObjectToAddModList_r16", -1);

         sl_MeasObjectToAddModList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_MeasObjectToAddModList_r16", -1);
      }

      // encode sl_ReportConfigToRemoveList_r16

      if (sl_ReportConfigToRemoveList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_ReportConfigToRemoveList_r16", -1);

         sl_ReportConfigToRemoveList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_ReportConfigToRemoveList_r16", -1);
      }

      // encode sl_ReportConfigToAddModList_r16

      if (sl_ReportConfigToAddModList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_ReportConfigToAddModList_r16", -1);

         sl_ReportConfigToAddModList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_ReportConfigToAddModList_r16", -1);
      }

      // encode sl_MeasIdToRemoveList_r16

      if (sl_MeasIdToRemoveList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_MeasIdToRemoveList_r16", -1);

         sl_MeasIdToRemoveList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_MeasIdToRemoveList_r16", -1);
      }

      // encode sl_MeasIdToAddModList_r16

      if (sl_MeasIdToAddModList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_MeasIdToAddModList_r16", -1);

         sl_MeasIdToAddModList_r16.encode (buffer);
