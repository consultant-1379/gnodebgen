      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         case _SCGFAILUREINFORMATIONEUTRA:
            SCGFailureInformationEUTRA_IEs scgFailureInformationEUTRA = (SCGFailureInformationEUTRA_IEs) element;
            scgFailureInformationEUTRA.encode (buffer);
            break;

         // criticalExtensionsFuture
         case _CRITICALEXTENSIONSFUTURE:
            SCGFailureInformationEUTRA_criticalExtensions_criticalExtensionsFuture criticalExtensionsFuture = (SCGFailureInformationEUTRA_criticalExtensions_criticalExtensionsFuture) element;
