...
public class LogicalChannelConfig_ul_SpecificParameters extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      boolean extbit = ((bitRateQueryProhibitTimer != null) ||
      mV3ExtPresent ||
      ...
      buffer.encodeBit ((allowedServingCells != null), null);
      buffer.encodeBit ((allowedSCS_List != null), null);
      buffer.encodeBit ((maxPUSCH_Duration != null), null);
      buffer.encodeBit ((configuredGrantType1Allowed != null), null);
      buffer.encodeBit ((logicalChannelGroup != null), null);
      buffer.encodeBit ((schedulingRequestID != null), null);
      ...
      if (priority != null) {
         ...
         priority.encode (buffer, 1, 16);

         buffer.getContext().eventDispatcher.endElement("priority", -1);
      }
      else throw new Asn1MissingRequiredException ("priority");
      ...
      if (prioritisedBitRate != null) {
         ...
         prioritisedBitRate.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("prioritisedBitRate", -1);
      }
      else throw new Asn1MissingRequiredException ("prioritisedBitRate");
      ...
      if (bucketSizeDuration != null) {
         ...
         bucketSizeDuration.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("bucketSizeDuration", -1);
      }
      else throw new Asn1MissingRequiredException ("bucketSizeDuration");

      // encode allowedServingCells

      if (allowedServingCells != null) {
         buffer.getContext().eventDispatcher.startElement("allowedServingCells", -1);

         allowedServingCells.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("allowedServingCells", -1);
      }

      // encode allowedSCS_List

      if (allowedSCS_List != null) {
         buffer.getContext().eventDispatcher.startElement("allowedSCS_List", -1);

         allowedSCS_List.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("allowedSCS_List", -1);
      }

      // encode maxPUSCH_Duration

      if (maxPUSCH_Duration != null) {
         buffer.getContext().eventDispatcher.startElement("maxPUSCH_Duration", -1);

         maxPUSCH_Duration.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("maxPUSCH_Duration", -1);
      }

      // encode configuredGrantType1Allowed

      if (configuredGrantType1Allowed != null) {
         buffer.getContext().eventDispatcher.startElement("configuredGrantType1Allowed", -1);

         configuredGrantType1Allowed.encode (buffer);
      ...
      if (logicalChannelGroup != null) {
         ...
         logicalChannelGroup.encode (buffer, 0, 7);

         buffer.getContext().eventDispatcher.endElement("logicalChannelGroup", -1);
      }

      // encode schedulingRequestID

      if (schedulingRequestID != null) {
         buffer.getContext().eventDispatcher.startElement("schedulingRequestID", -1);

         schedulingRequestID.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("schedulingRequestID", -1);
      }

      // encode logicalChannelSR_Mask

      if (logicalChannelSR_Mask != null) {
         buffer.getContext().eventDispatcher.startElement("logicalChannelSR_Mask", -1);

         logicalChannelSR_Mask.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("logicalChannelSR_Mask", -1);
      }
      else throw new Asn1MissingRequiredException ("logicalChannelSR_Mask");

      // encode logicalChannelSR_DelayTimerApplied

      if (logicalChannelSR_DelayTimerApplied != null) {
         buffer.getContext().eventDispatcher.startElement("logicalChannelSR_DelayTimerApplied", -1);

         logicalChannelSR_DelayTimerApplied.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("logicalChannelSR_DelayTimerApplied", -1);
      }
      else throw new Asn1MissingRequiredException ("logicalChannelSR_DelayTimerApplied");
      ...
      if (extbit) {
         ...
         buffer.encodeBit ((bitRateQueryProhibitTimer != null), null);
         ...
         if (bitRateQueryProhibitTimer != null) {
            buffer.reset();
            bitRateQueryProhibitTimer.encode (buffer);
            buffer.getContext().eventDispatcher.startElement("bitRateQueryProhibitTimer", -1);
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((allowedCG_List_r16 != null), "optbit");
            buffer.encodeBit ((allowedPHY_PriorityIndex_r16 != null), "optbit");
            if (allowedCG_List_r16 != null) {
               allowedCG_List_r16.encode (buffer);
            }
            if (allowedPHY_PriorityIndex_r16 != null) {
               allowedPHY_PriorityIndex_r16.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
