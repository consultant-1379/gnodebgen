...
public class CI_ConfigurationPerServingCell_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((positionInDCI_ForSUL_r16 != null), null);
      buffer.encodeBit ((uplinkCancellationPriority_v1610 != null), null);
      ...
      else throw new Asn1MissingRequiredException ("servingCellId");
      ...
      if (positionInDCI_r16 != null) {
         ...
         positionInDCI_r16.encode (buffer, 0, 125);

         buffer.getContext().eventDispatcher.endElement("positionInDCI_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("positionInDCI_r16");

      // encode positionInDCI_ForSUL_r16

      if (positionInDCI_ForSUL_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("positionInDCI_ForSUL_r16", -1);

         positionInDCI_ForSUL_r16.encode (buffer, 0, 125);

         buffer.getContext().eventDispatcher.endElement("positionInDCI_ForSUL_r16", -1);
      }

      // encode ci_PayloadSize_r16

      if (ci_PayloadSize_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ci_PayloadSize_r16", -1);

         ci_PayloadSize_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ci_PayloadSize_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("ci_PayloadSize_r16");

      // encode timeFrequencyRegion_r16

      if (timeFrequencyRegion_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("timeFrequencyRegion_r16", -1);

         timeFrequencyRegion_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("timeFrequencyRegion_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("timeFrequencyRegion_r16");

      // encode uplinkCancellationPriority_v1610

      if (uplinkCancellationPriority_v1610 != null) {
         buffer.getContext().eventDispatcher.startElement("uplinkCancellationPriority_v1610", -1);

         uplinkCancellationPriority_v1610.encode (buffer);
