...
public class DedicatedSIBRequest_r16_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((onDemandSIB_RequestList_r16 != null), null);
      buffer.encodeBit ((lateNonCriticalExtension != null), null);
      buffer.encodeBit ((nonCriticalExtension != null), null);

      // encode onDemandSIB_RequestList_r16

      if (onDemandSIB_RequestList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("onDemandSIB_RequestList_r16", -1);

         onDemandSIB_RequestList_r16.encode (buffer);
