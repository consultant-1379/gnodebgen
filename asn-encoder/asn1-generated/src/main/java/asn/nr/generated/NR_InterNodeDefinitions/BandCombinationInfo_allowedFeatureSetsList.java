...
public class BandCombinationInfo_allowedFeatureSetsList extends Asn1SeqOf {
   ...
   public FeatureSetEntryIndex[] elements;

   public BandCombinationInfo_allowedFeatureSetsList () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationInfo_allowedFeatureSetsList (int numRecords) {
      elements = new FeatureSetEntryIndex [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationInfo_allowedFeatureSetsList (FeatureSetEntryIndex[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetEntryIndex [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetEntryIndex();
