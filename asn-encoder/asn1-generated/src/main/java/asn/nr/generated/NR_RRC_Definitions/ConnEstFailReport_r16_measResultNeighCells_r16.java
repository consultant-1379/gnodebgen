...
public class ConnEstFailReport_r16_measResultNeighCells_r16 extends Asn1Seq {
   ...
   public MeasResultList2NR_r16 measResultNeighCellListNR;  // optional
   public MeasResultList2EUTRA_r16 measResultNeighCellListEUTRA;  // optional

   public ConnEstFailReport_r16_measResultNeighCells_r16 () {
      super();
      init();
   }
    ...
    */
   public ConnEstFailReport_r16_measResultNeighCells_r16 (
      MeasResultList2NR_r16 measResultNeighCellListNR_,
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (measResultNeighCellListNRPresent) {
         ...
         measResultNeighCellListNR = new MeasResultList2NR_r16();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((measResultNeighCellListNR != null), null);
      buffer.encodeBit ((measResultNeighCellListEUTRA != null), null);

      // encode measResultNeighCellListNR

      if (measResultNeighCellListNR != null) {
         buffer.getContext().eventDispatcher.startElement("measResultNeighCellListNR", -1);

         measResultNeighCellListNR.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("measResultNeighCellListNR", -1);
      }

      // encode measResultNeighCellListEUTRA

      if (measResultNeighCellListEUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("measResultNeighCellListEUTRA", -1);

         measResultNeighCellListEUTRA.encode (buffer);
