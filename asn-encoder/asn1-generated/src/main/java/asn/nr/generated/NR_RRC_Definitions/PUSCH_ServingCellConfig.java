...
public class PUSCH_ServingCellConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((rateMatching != null), null);
      ...
      if (rateMatching != null) {
         buffer.getContext().eventDispatcher.startElement("rateMatching", -1);

         rateMatching.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            ...
            if (maxMIMO_Layers != null) {
               maxMIMO_Layers.encode (buffer, 1, 4);
            }
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((maxMIMO_LayersDCI_0_2_r16 != null), "optbit");
            if (maxMIMO_LayersDCI_0_2_r16 != null) {
               maxMIMO_LayersDCI_0_2_r16.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
