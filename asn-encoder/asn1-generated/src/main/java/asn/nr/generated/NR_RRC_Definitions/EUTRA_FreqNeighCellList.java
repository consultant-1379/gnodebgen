...
public class EUTRA_FreqNeighCellList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EUTRA-FreqNeighCellList";
   }

   public EUTRA_FreqNeighCellInfo[] elements;

   public EUTRA_FreqNeighCellList () {
      elements = null;
   }
    ...
    * populated.
    */
   public EUTRA_FreqNeighCellList (int numRecords) {
      elements = new EUTRA_FreqNeighCellInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public EUTRA_FreqNeighCellList (EUTRA_FreqNeighCellInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EUTRA_FreqNeighCellInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EUTRA_FreqNeighCellInfo();
