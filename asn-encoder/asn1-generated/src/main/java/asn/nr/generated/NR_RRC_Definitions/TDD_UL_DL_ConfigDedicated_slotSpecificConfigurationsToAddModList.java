...
public class TDD_UL_DL_ConfigDedicated_slotSpecificConfigurationsToAddModList extends Asn1SeqOf {
   ...
   public TDD_UL_DL_SlotConfig[] elements;

   public TDD_UL_DL_ConfigDedicated_slotSpecificConfigurationsToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public TDD_UL_DL_ConfigDedicated_slotSpecificConfigurationsToAddModList (int numRecords) {
      elements = new TDD_UL_DL_SlotConfig [numRecords];
   }
    ...
    * given the array.  
    */
   public TDD_UL_DL_ConfigDedicated_slotSpecificConfigurationsToAddModList (TDD_UL_DL_SlotConfig[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TDD_UL_DL_SlotConfig [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TDD_UL_DL_SlotConfig();
