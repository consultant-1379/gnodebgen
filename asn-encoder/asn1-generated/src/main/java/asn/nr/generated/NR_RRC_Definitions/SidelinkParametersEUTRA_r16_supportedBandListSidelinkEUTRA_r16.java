...
public class SidelinkParametersEUTRA_r16_supportedBandListSidelinkEUTRA_r16 extends Asn1SeqOf {
   ...
   public BandSidelinkEUTRA_r16[] elements;

   public SidelinkParametersEUTRA_r16_supportedBandListSidelinkEUTRA_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SidelinkParametersEUTRA_r16_supportedBandListSidelinkEUTRA_r16 (int numRecords) {
      elements = new BandSidelinkEUTRA_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SidelinkParametersEUTRA_r16_supportedBandListSidelinkEUTRA_r16 (BandSidelinkEUTRA_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandSidelinkEUTRA_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandSidelinkEUTRA_r16();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 256);
