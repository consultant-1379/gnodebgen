...
public class PDSCH_Config_sp_ZP_CSI_RS_ResourceSetsToAddModList extends Asn1SeqOf {
   ...
   public PDSCH_Config_sp_ZP_CSI_RS_ResourceSetsToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDSCH_Config_sp_ZP_CSI_RS_ResourceSetsToAddModList (int numRecords) {
    ...
    * given the array.  
    */
   public PDSCH_Config_sp_ZP_CSI_RS_ResourceSetsToAddModList (ZP_CSI_RS_ResourceSet[] elements_) {
      elements = elements_;
   }
