...
public class CSI_AssociatedReportConfigInfo_resourcesForChannel extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // nzp_CSI_RS
         case _NZP_CSI_RS:
            CSI_AssociatedReportConfigInfo_resourcesForChannel_nzp_CSI_RS nzp_CSI_RS = (CSI_AssociatedReportConfigInfo_resourcesForChannel_nzp_CSI_RS) element;
            nzp_CSI_RS.encode (buffer);
            break;

         // csi_SSB_ResourceSet
         case _CSI_SSB_RESOURCESET:
            Asn1Integer csi_SSB_ResourceSet = (Asn1Integer) element;
            csi_SSB_ResourceSet.encode (buffer, 1, 1);
            break;
