...
public class MeasResultsPerCarrierIdleNR_r16_measResultsPerCellListIdleNR_r16 extends Asn1SeqOf {
   ...
   public MeasResultsPerCellIdleNR_r16[] elements;

   public MeasResultsPerCarrierIdleNR_r16_measResultsPerCellListIdleNR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultsPerCarrierIdleNR_r16_measResultsPerCellListIdleNR_r16 (int numRecords) {
      elements = new MeasResultsPerCellIdleNR_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultsPerCarrierIdleNR_r16_measResultsPerCellListIdleNR_r16 (MeasResultsPerCellIdleNR_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultsPerCellIdleNR_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultsPerCellIdleNR_r16();
