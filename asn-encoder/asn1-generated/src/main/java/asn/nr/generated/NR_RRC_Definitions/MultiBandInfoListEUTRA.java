...
public class MultiBandInfoListEUTRA extends Asn1SeqOf {
    ...
    * populated.
    */
   public MultiBandInfoListEUTRA (int numRecords) {
    ...
    * given the array.  
    */
   public MultiBandInfoListEUTRA (FreqBandIndicatorEUTRA[] elements_) {
      elements = elements_;
   }
