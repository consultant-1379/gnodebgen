...
public class RLC_BearerConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((servedRadioBearer != null), null);
      buffer.encodeBit ((reestablishRLC != null), null);
      buffer.encodeBit ((rlc_Config != null), null);
      buffer.encodeBit ((mac_LogicalChannelConfig != null), null);
      ...
      if (logicalChannelIdentity != null) {
         ...
         logicalChannelIdentity.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("logicalChannelIdentity", -1);
      }
      else throw new Asn1MissingRequiredException ("logicalChannelIdentity");

      // encode servedRadioBearer

      if (servedRadioBearer != null) {
         buffer.getContext().eventDispatcher.startElement("servedRadioBearer", -1);

         servedRadioBearer.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("servedRadioBearer", -1);
      }

      // encode reestablishRLC

      if (reestablishRLC != null) {
         buffer.getContext().eventDispatcher.startElement("reestablishRLC", -1);

         reestablishRLC.encode (buffer);
      ...
      if (rlc_Config != null) {
         ...
         rlc_Config.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("rlc_Config", -1);
      }

      // encode mac_LogicalChannelConfig

      if (mac_LogicalChannelConfig != null) {
         buffer.getContext().eventDispatcher.startElement("mac_LogicalChannelConfig", -1);

         mac_LogicalChannelConfig.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((rlc_Config_v1610 != null), "optbit");
            if (rlc_Config_v1610 != null) {
               rlc_Config_v1610.encode (buffer);
            }
