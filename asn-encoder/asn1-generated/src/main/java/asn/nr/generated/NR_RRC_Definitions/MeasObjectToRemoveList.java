...
public class MeasObjectToRemoveList extends Asn1SeqOf {
    ...
    * populated.
    */
   public MeasObjectToRemoveList (int numRecords) {
    ...
    * given the array.  
    */
   public MeasObjectToRemoveList (MeasObjectId[] elements_) {
      elements = elements_;
   }
