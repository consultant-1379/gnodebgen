...
public class MAC_CellGroupConfig_phr_Config extends Asn1Choice {
   ...
   public MAC_CellGroupConfig_phr_Config () {
      super();
   }

   public MAC_CellGroupConfig_phr_Config (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (PHR_Config value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            PHR_Config setup = (PHR_Config) element;
            setup.encode (buffer);
            break;
