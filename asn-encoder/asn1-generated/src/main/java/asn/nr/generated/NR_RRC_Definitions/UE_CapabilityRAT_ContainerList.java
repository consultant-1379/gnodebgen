...
public class UE_CapabilityRAT_ContainerList extends Asn1SeqOf {
   ...
   public UE_CapabilityRAT_Container[] elements;

   public UE_CapabilityRAT_ContainerList () {
      elements = null;
   }
    ...
    * populated.
    */
   public UE_CapabilityRAT_ContainerList (int numRecords) {
      elements = new UE_CapabilityRAT_Container [numRecords];
   }
    ...
    * given the array.  
    */
   public UE_CapabilityRAT_ContainerList (UE_CapabilityRAT_Container[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (0, 8);
      int numElements = (int) buffer.decodeLength();

      elements = new UE_CapabilityRAT_Container [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UE_CapabilityRAT_Container();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 0, 8);
