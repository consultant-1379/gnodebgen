...
public class PHR_Config extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // encode phr_PeriodicTimer

      if (phr_PeriodicTimer != null) {
         buffer.getContext().eventDispatcher.startElement("phr_PeriodicTimer", -1);

         phr_PeriodicTimer.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("phr_PeriodicTimer", -1);
      }
      else throw new Asn1MissingRequiredException ("phr_PeriodicTimer");

      // encode phr_ProhibitTimer

      if (phr_ProhibitTimer != null) {
         buffer.getContext().eventDispatcher.startElement("phr_ProhibitTimer", -1);

         phr_ProhibitTimer.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("phr_ProhibitTimer", -1);
      }
      else throw new Asn1MissingRequiredException ("phr_ProhibitTimer");

      // encode phr_Tx_PowerFactorChange

      if (phr_Tx_PowerFactorChange != null) {
         buffer.getContext().eventDispatcher.startElement("phr_Tx_PowerFactorChange", -1);

         phr_Tx_PowerFactorChange.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("phr_Tx_PowerFactorChange", -1);
      }
      else throw new Asn1MissingRequiredException ("phr_Tx_PowerFactorChange");
      ...
      if (multiplePHR != null) {
         ...
         multiplePHR.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("multiplePHR", -1);
      }
      else throw new Asn1MissingRequiredException ("multiplePHR");
      ...
      // encode phr_Type2OtherCell

      if (phr_Type2OtherCell != null) {
         buffer.getContext().eventDispatcher.startElement("phr_Type2OtherCell", -1);

         phr_Type2OtherCell.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("phr_Type2OtherCell", -1);
      }
      else throw new Asn1MissingRequiredException ("phr_Type2OtherCell");

      // encode phr_ModeOtherCG

      if (phr_ModeOtherCG != null) {
         buffer.getContext().eventDispatcher.startElement("phr_ModeOtherCG", -1);

         phr_ModeOtherCG.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("phr_ModeOtherCG", -1);
      }
      else throw new Asn1MissingRequiredException ("phr_ModeOtherCG");
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((mpe_Reporting_FR2_r16 != null), "optbit");
            if (mpe_Reporting_FR2_r16 != null) {
               mpe_Reporting_FR2_r16.encode (buffer);
            }
