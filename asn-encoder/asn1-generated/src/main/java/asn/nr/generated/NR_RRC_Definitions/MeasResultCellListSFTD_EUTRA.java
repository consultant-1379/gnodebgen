...
public class MeasResultCellListSFTD_EUTRA extends Asn1SeqOf {
   ...
   public MeasResultSFTD_EUTRA[] elements;

   public MeasResultCellListSFTD_EUTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultCellListSFTD_EUTRA (int numRecords) {
      elements = new MeasResultSFTD_EUTRA [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultCellListSFTD_EUTRA (MeasResultSFTD_EUTRA[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultSFTD_EUTRA [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultSFTD_EUTRA();
