...
public class NPN_IdentityInfo_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((ranac_r16 != null), null);
      buffer.encodeBit ((iab_Support_r16 != null), null);

      // encode npn_IdentityList_r16

      if (npn_IdentityList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("npn_IdentityList_r16", -1);

         npn_IdentityList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("npn_IdentityList_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("npn_IdentityList_r16");

      // encode trackingAreaCode_r16

      if (trackingAreaCode_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("trackingAreaCode_r16", -1);

         trackingAreaCode_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("trackingAreaCode_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("trackingAreaCode_r16");
      ...
      if (ranac_r16 != null) {
         ...
         ranac_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ranac_r16", -1);
      }

      // encode cellIdentity_r16

      if (cellIdentity_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("cellIdentity_r16", -1);

         cellIdentity_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("cellIdentity_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("cellIdentity_r16");

      // encode cellReservedForOperatorUse_r16

      if (cellReservedForOperatorUse_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("cellReservedForOperatorUse_r16", -1);

         cellReservedForOperatorUse_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("cellReservedForOperatorUse_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("cellReservedForOperatorUse_r16");

      // encode iab_Support_r16
