...
public class DRB_CountMSB_InfoList extends Asn1SeqOf {
   ...
   public DRB_CountMSB_Info[] elements;

   public DRB_CountMSB_InfoList () {
      elements = null;
   }
    ...
    * populated.
    */
   public DRB_CountMSB_InfoList (int numRecords) {
      elements = new DRB_CountMSB_Info [numRecords];
   }
    ...
    * given the array.  
    */
   public DRB_CountMSB_InfoList (DRB_CountMSB_Info[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DRB_CountMSB_Info [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DRB_CountMSB_Info();
