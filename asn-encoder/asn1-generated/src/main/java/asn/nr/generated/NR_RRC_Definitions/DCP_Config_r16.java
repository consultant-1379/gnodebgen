...
public class DCP_Config_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((ps_WakeUp_r16 != null), null);
      buffer.encodeBit ((ps_TransmitPeriodicL1_RSRP_r16 != null), null);
      buffer.encodeBit ((ps_TransmitOtherPeriodicCSI_r16 != null), null);
      ...
      if (ps_RNTI_r16 != null) {
         ...
         ps_RNTI_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ps_RNTI_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("ps_RNTI_r16");

      // encode ps_Offset_r16

      if (ps_Offset_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ps_Offset_r16", -1);

         ps_Offset_r16.encode (buffer, 1, 120);

         buffer.getContext().eventDispatcher.endElement("ps_Offset_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("ps_Offset_r16");

      // encode sizeDCI_2_6_r16

      if (sizeDCI_2_6_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sizeDCI_2_6_r16", -1);

         sizeDCI_2_6_r16.encode (buffer, 1, 140);

         buffer.getContext().eventDispatcher.endElement("sizeDCI_2_6_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("sizeDCI_2_6_r16");

      // encode ps_PositionDCI_2_6_r16

      if (ps_PositionDCI_2_6_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ps_PositionDCI_2_6_r16", -1);

         ps_PositionDCI_2_6_r16.encode (buffer, 0, 139);

         buffer.getContext().eventDispatcher.endElement("ps_PositionDCI_2_6_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("ps_PositionDCI_2_6_r16");

      // encode ps_WakeUp_r16

      if (ps_WakeUp_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ps_WakeUp_r16", -1);

         ps_WakeUp_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ps_WakeUp_r16", -1);
      }

      // encode ps_TransmitPeriodicL1_RSRP_r16

      if (ps_TransmitPeriodicL1_RSRP_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ps_TransmitPeriodicL1_RSRP_r16", -1);

         ps_TransmitPeriodicL1_RSRP_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ps_TransmitPeriodicL1_RSRP_r16", -1);
      }

      // encode ps_TransmitOtherPeriodicCSI_r16

      if (ps_TransmitOtherPeriodicCSI_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ps_TransmitOtherPeriodicCSI_r16", -1);

         ps_TransmitOtherPeriodicCSI_r16.encode (buffer);
