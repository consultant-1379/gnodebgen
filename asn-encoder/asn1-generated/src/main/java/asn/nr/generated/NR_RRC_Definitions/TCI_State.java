...
public class TCI_State extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((qcl_Type2 != null), null);
      ...
      if (tci_StateId != null) {
         ...
         tci_StateId.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("tci_StateId", -1);
      }
      else throw new Asn1MissingRequiredException ("tci_StateId");
      ...
      if (qcl_Type1 != null) {
         ...
         qcl_Type1.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("qcl_Type1", -1);
      }
      else throw new Asn1MissingRequiredException ("qcl_Type1");
