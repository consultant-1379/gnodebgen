      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (!extbit) {
         ...
         switch (choiceID) {
            // eventB1
            case _EVENTB1:
               EventTriggerConfigInterRAT_eventId_eventB1 eventB1 = (EventTriggerConfigInterRAT_eventId_eventB1) element;
               eventB1.encode (buffer);
               break;

            // eventB2
            case _EVENTB2:
               EventTriggerConfigInterRAT_eventId_eventB2 eventB2 = (EventTriggerConfigInterRAT_eventId_eventB2) element;
               eventB2.encode (buffer);
               break;
         ...
         switch (choiceID) {
            // eventB1_UTRA_FDD_r16
            case _EVENTB1_UTRA_FDD_R16:
               EventTriggerConfigInterRAT_eventId_eventB1_UTRA_FDD_r16 eventB1_UTRA_FDD_r16 = (EventTriggerConfigInterRAT_eventId_eventB1_UTRA_FDD_r16) element;
               eventB1_UTRA_FDD_r16.encode (buffer);
               openType = new Asn1OpenType 
                  (buffer.getBuffer(), 0, buffer.getMsgByteCnt());
               break;

            // eventB2_UTRA_FDD_r16
            case _EVENTB2_UTRA_FDD_R16:
               EventTriggerConfigInterRAT_eventId_eventB2_UTRA_FDD_r16 eventB2_UTRA_FDD_r16 = (EventTriggerConfigInterRAT_eventId_eventB2_UTRA_FDD_r16) element;
               eventB2_UTRA_FDD_r16.encode (buffer);
               openType = new Asn1OpenType 
                  (buffer.getBuffer(), 0, buffer.getMsgByteCnt());
               break;
