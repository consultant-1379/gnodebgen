...
public class MeasObjectNR_blackCellsToAddModList extends Asn1SeqOf {
   ...
   public PCI_RangeElement[] elements;

   public MeasObjectNR_blackCellsToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasObjectNR_blackCellsToAddModList (int numRecords) {
      elements = new PCI_RangeElement [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasObjectNR_blackCellsToAddModList (PCI_RangeElement[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PCI_RangeElement [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PCI_RangeElement();
