...
public class CG_Config_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _CG_CONFIG = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public CG_Config_criticalExtensions_c1 () {
      super();
   }

   public CG_Config_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _CG_CONFIG: return "cg_Config";
   ...
   public void set_cg_Config (CG_Config_IEs value) {
      setElement (_CG_CONFIG, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         // cg_Config
         case 0: { 
            CG_Config_IEs cg_Config;
            element = cg_Config = new CG_Config_IEs();
            cg_Config.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // cg_Config
         case _CG_CONFIG:
            CG_Config_IEs cg_Config = (CG_Config_IEs) element;
            cg_Config.encode (buffer);
            break;
