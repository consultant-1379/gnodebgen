...
public class PCCH_Config_firstPDCCH_MonitoringOccasionOfPO_sCS120KHZoneSixteenthT extends Asn1SeqOf {
   ...
   public PCCH_Config_firstPDCCH_MonitoringOccasionOfPO_sCS120KHZoneSixteenthT () {
      elements = null;
   }
    ...
    * populated.
    */
   public PCCH_Config_firstPDCCH_MonitoringOccasionOfPO_sCS120KHZoneSixteenthT (int numRecords) {
    ...
    * given the array.  
    */
   public PCCH_Config_firstPDCCH_MonitoringOccasionOfPO_sCS120KHZoneSixteenthT (Asn1Integer[] elements_) {
      elements = elements_;
   }
