...
public class AffectedCarrierFreqCombEUTRA extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AffectedCarrierFreqCombEUTRA";
   }

   public ARFCN_ValueEUTRA[] elements;

   public AffectedCarrierFreqCombEUTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public AffectedCarrierFreqCombEUTRA (int numRecords) {
    ...
    * given the array.  
    */
   public AffectedCarrierFreqCombEUTRA (ARFCN_ValueEUTRA[] elements_) {
      elements = elements_;
   }
