...
public class ControlResourceSet_cce_REG_MappingType_interleaved extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((shiftIndex != null), null);

      // encode reg_BundleSize

      if (reg_BundleSize != null) {
         buffer.getContext().eventDispatcher.startElement("reg_BundleSize", -1);

         reg_BundleSize.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("reg_BundleSize", -1);
      }
      else throw new Asn1MissingRequiredException ("reg_BundleSize");

      // encode interleaverSize

      if (interleaverSize != null) {
         buffer.getContext().eventDispatcher.startElement("interleaverSize", -1);

         interleaverSize.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("interleaverSize", -1);
      }
      else throw new Asn1MissingRequiredException ("interleaverSize");
      ...
      if (shiftIndex != null) {
         ...
         shiftIndex.encode (buffer, 0, 274);
