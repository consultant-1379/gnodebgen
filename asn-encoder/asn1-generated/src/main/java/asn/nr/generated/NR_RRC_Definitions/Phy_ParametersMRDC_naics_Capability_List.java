...
public class Phy_ParametersMRDC_naics_Capability_List extends Asn1SeqOf {
   ...
   public NAICS_Capability_Entry[] elements;

   public Phy_ParametersMRDC_naics_Capability_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public Phy_ParametersMRDC_naics_Capability_List (int numRecords) {
      elements = new NAICS_Capability_Entry [numRecords];
   }
    ...
    * given the array.  
    */
   public Phy_ParametersMRDC_naics_Capability_List (NAICS_Capability_Entry[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NAICS_Capability_Entry [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NAICS_Capability_Entry();
