...
import asn.nr.generated.NR_RRC_Definitions.PhysCellIdUTRA_FDD_r16;
...
public class CellsTriggeredList_element extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // physCellId
         case _PHYSCELLID:
            PhysCellId physCellId = (PhysCellId) element;
            physCellId.encode (buffer);
            break;

         // physCellIdEUTRA
         case _PHYSCELLIDEUTRA:
            EUTRA_PhysCellId physCellIdEUTRA = (EUTRA_PhysCellId) element;
            physCellIdEUTRA.encode (buffer);
            break;

         // physCellIdUTRA_FDD_r16
         case _PHYSCELLIDUTRA_FDD_R16:
            PhysCellIdUTRA_FDD_r16 physCellIdUTRA_FDD_r16 = (PhysCellIdUTRA_FDD_r16) element;
            physCellIdUTRA_FDD_r16.encode (buffer);
            break;
