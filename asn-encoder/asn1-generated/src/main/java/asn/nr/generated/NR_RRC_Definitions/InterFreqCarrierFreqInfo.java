...
public class InterFreqCarrierFreqInfo extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((frequencyBandListSUL != null), null);
      ...
      buffer.encodeBit ((ssb_ToMeasure != null), null);
      ...
      buffer.encodeBit ((p_Max != null), null);
      buffer.encodeBit ((t_ReselectionNR_SF != null), null);
      ...
      buffer.encodeBit ((!q_OffsetFreq.equals (Q_OffsetRange.dB0())), null);
      buffer.encodeBit ((interFreqNeighCellList != null), null);
      buffer.encodeBit ((interFreqBlackCellList != null), null);

      // encode dl_CarrierFreq

      if (dl_CarrierFreq != null) {
         buffer.getContext().eventDispatcher.startElement("dl_CarrierFreq", -1);

         dl_CarrierFreq.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("dl_CarrierFreq", -1);
      }
      else throw new Asn1MissingRequiredException ("dl_CarrierFreq");
      ...
      // encode frequencyBandListSUL

      if (frequencyBandListSUL != null) {
         buffer.getContext().eventDispatcher.startElement("frequencyBandListSUL", -1);

         frequencyBandListSUL.encode (buffer);
      ...
      // encode deriveSSB_IndexFromCell

      if (deriveSSB_IndexFromCell != null) {
         buffer.getContext().eventDispatcher.startElement("deriveSSB_IndexFromCell", -1);

         deriveSSB_IndexFromCell.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("deriveSSB_IndexFromCell", -1);
      }
      else throw new Asn1MissingRequiredException ("deriveSSB_IndexFromCell");
      ...
      // encode t_ReselectionNR

      if (t_ReselectionNR != null) {
         buffer.getContext().eventDispatcher.startElement("t_ReselectionNR", -1);

         t_ReselectionNR.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("t_ReselectionNR", -1);
      }
      else throw new Asn1MissingRequiredException ("t_ReselectionNR");

      // encode t_ReselectionNR_SF

      if (t_ReselectionNR_SF != null) {
         buffer.getContext().eventDispatcher.startElement("t_ReselectionNR_SF", -1);

         t_ReselectionNR_SF.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("t_ReselectionNR_SF", -1);
      }

      // encode threshX_HighP

      if (threshX_HighP != null) {
         buffer.getContext().eventDispatcher.startElement("threshX_HighP", -1);

         threshX_HighP.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("threshX_HighP", -1);
      }
      else throw new Asn1MissingRequiredException ("threshX_HighP");

      // encode threshX_LowP

      if (threshX_LowP != null) {
         buffer.getContext().eventDispatcher.startElement("threshX_LowP", -1);

         threshX_LowP.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("threshX_LowP", -1);
      }
      else throw new Asn1MissingRequiredException ("threshX_LowP");
      ...
      if (q_OffsetFreq != null) {
         if (!q_OffsetFreq.equals (Q_OffsetRange.dB0())) {
            buffer.getContext().eventDispatcher.startElement("q_OffsetFreq", -1);

            q_OffsetFreq.encode (buffer);
      ...
      if (interFreqNeighCellList != null) {
         buffer.getContext().eventDispatcher.startElement("interFreqNeighCellList", -1);

         interFreqNeighCellList.encode (buffer);
      ...
      if (interFreqBlackCellList != null) {
         buffer.getContext().eventDispatcher.startElement("interFreqBlackCellList", -1);

         interFreqBlackCellList.encode (buffer);
