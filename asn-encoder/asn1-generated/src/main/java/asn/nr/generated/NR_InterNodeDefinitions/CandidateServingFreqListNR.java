...
public class CandidateServingFreqListNR extends Asn1SeqOf {
   ...
   public CandidateServingFreqListNR () {
      elements = null;
   }
    ...
    * populated.
    */
   public CandidateServingFreqListNR (int numRecords) {
    ...
    * given the array.  
    */
   public CandidateServingFreqListNR (ARFCN_ValueNR[] elements_) {
      elements = elements_;
   }
