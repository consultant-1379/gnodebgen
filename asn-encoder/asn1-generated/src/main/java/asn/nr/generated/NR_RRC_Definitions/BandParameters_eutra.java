...
public class BandParameters_eutra extends Asn1Seq {
    ...
    * the given objects 
    */
   public BandParameters_eutra (long bandEUTRA_,
      CA_BandwidthClassEUTRA ca_BandwidthClassDL_EUTRA_,
      CA_BandwidthClassEUTRA ca_BandwidthClassUL_EUTRA_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((ca_BandwidthClassDL_EUTRA != null), null);
      buffer.encodeBit ((ca_BandwidthClassUL_EUTRA != null), null);
      ...
      if (bandEUTRA != null) {
         ...
         bandEUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("bandEUTRA", -1);
      }
      else throw new Asn1MissingRequiredException ("bandEUTRA");

      // encode ca_BandwidthClassDL_EUTRA

      if (ca_BandwidthClassDL_EUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("ca_BandwidthClassDL_EUTRA", -1);

         ca_BandwidthClassDL_EUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ca_BandwidthClassDL_EUTRA", -1);
      }

      // encode ca_BandwidthClassUL_EUTRA

      if (ca_BandwidthClassUL_EUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("ca_BandwidthClassUL_EUTRA", -1);

         ca_BandwidthClassUL_EUTRA.encode (buffer);
