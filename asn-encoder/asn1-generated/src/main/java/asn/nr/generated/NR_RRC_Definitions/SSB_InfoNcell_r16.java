...
public class SSB_InfoNcell_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((ssb_IndexNcell_r16 != null), null);
      buffer.encodeBit ((ssb_Configuration_r16 != null), null);

      // encode physicalCellId_r16

      if (physicalCellId_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("physicalCellId_r16", -1);

         physicalCellId_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("physicalCellId_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("physicalCellId_r16");

      // encode ssb_IndexNcell_r16

      if (ssb_IndexNcell_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ssb_IndexNcell_r16", -1);

         ssb_IndexNcell_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ssb_IndexNcell_r16", -1);
      }

      // encode ssb_Configuration_r16

      if (ssb_Configuration_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ssb_Configuration_r16", -1);

         ssb_Configuration_r16.encode (buffer);
