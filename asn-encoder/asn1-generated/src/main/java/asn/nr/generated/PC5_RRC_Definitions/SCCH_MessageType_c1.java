...
public class SCCH_MessageType_c1 extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // measurementReportSidelink
         case _MEASUREMENTREPORTSIDELINK:
            MeasurementReportSidelink measurementReportSidelink = (MeasurementReportSidelink) element;
            measurementReportSidelink.encode (buffer);
            break;

         // rrcReconfigurationSidelink
         case _RRCRECONFIGURATIONSIDELINK:
            RRCReconfigurationSidelink rrcReconfigurationSidelink = (RRCReconfigurationSidelink) element;
            rrcReconfigurationSidelink.encode (buffer);
            break;

         // rrcReconfigurationCompleteSidelink
         case _RRCRECONFIGURATIONCOMPLETESIDELINK:
            RRCReconfigurationCompleteSidelink rrcReconfigurationCompleteSidelink = (RRCReconfigurationCompleteSidelink) element;
            rrcReconfigurationCompleteSidelink.encode (buffer);
            break;

         // rrcReconfigurationFailureSidelink
         case _RRCRECONFIGURATIONFAILURESIDELINK:
            RRCReconfigurationFailureSidelink rrcReconfigurationFailureSidelink = (RRCReconfigurationFailureSidelink) element;
            rrcReconfigurationFailureSidelink.encode (buffer);
            break;

         // ueCapabilityEnquirySidelink
         case _UECAPABILITYENQUIRYSIDELINK:
            UECapabilityEnquirySidelink ueCapabilityEnquirySidelink = (UECapabilityEnquirySidelink) element;
            ueCapabilityEnquirySidelink.encode (buffer);
            break;

         // ueCapabilityInformationSidelink
         case _UECAPABILITYINFORMATIONSIDELINK:
            UECapabilityInformationSidelink ueCapabilityInformationSidelink = (UECapabilityInformationSidelink) element;
            ueCapabilityInformationSidelink.encode (buffer);
            break;
