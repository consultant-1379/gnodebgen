...
public class MeasResultList2UTRA extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultList2UTRA";
   }

   public MeasResult2UTRA_FDD_r16[] elements;

   public MeasResultList2UTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultList2UTRA (int numRecords) {
      elements = new MeasResult2UTRA_FDD_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultList2UTRA (MeasResult2UTRA_FDD_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResult2UTRA_FDD_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResult2UTRA_FDD_r16();
