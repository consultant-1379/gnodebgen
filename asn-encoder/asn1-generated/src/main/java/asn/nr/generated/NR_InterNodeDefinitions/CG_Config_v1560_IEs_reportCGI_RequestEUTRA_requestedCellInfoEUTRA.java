...
import asn.nr.generated.NR_RRC_Definitions.EUTRA_PhysCellId;
...
public class CG_Config_v1560_IEs_reportCGI_RequestEUTRA_requestedCellInfoEUTRA extends Asn1Seq {
   ...
   public void encode (Asn1PerEncodeBuffer buffer)
      throws Asn1Exception, java.io.IOException
   {
      // encode eutraFrequency

      if (eutraFrequency != null) {
         buffer.getContext().eventDispatcher.startElement("eutraFrequency", -1);

         eutraFrequency.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("eutraFrequency", -1);
      }
      else throw new Asn1MissingRequiredException ("eutraFrequency");

      // encode cellForWhichToReportCGI_EUTRA

      if (cellForWhichToReportCGI_EUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("cellForWhichToReportCGI_EUTRA", -1);

         cellForWhichToReportCGI_EUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("cellForWhichToReportCGI_EUTRA", -1);
      }
      else throw new Asn1MissingRequiredException ("cellForWhichToReportCGI_EUTRA");
