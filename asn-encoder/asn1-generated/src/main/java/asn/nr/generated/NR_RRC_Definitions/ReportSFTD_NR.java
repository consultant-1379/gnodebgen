...
public class ReportSFTD_NR extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((reportSFTD_NeighMeas != null), "optbit");
            buffer.encodeBit ((drx_SFTD_NeighMeas != null), "optbit");
            buffer.encodeBit ((cellsForWhichToReportSFTD != null), "optbit");
            if (reportSFTD_NeighMeas != null) {
               reportSFTD_NeighMeas.encode (buffer);
            }
            if (drx_SFTD_NeighMeas != null) {
               drx_SFTD_NeighMeas.encode (buffer);
            }
            if (cellsForWhichToReportSFTD != null) {
               cellsForWhichToReportSFTD.encode (buffer);
            }
