...
public class MIMO_ParametersPerBand_srs_AssocCSI_RS extends Asn1SeqOf {
   ...
   public MIMO_ParametersPerBand_srs_AssocCSI_RS () {
      elements = null;
   }
    ...
    * populated.
    */
   public MIMO_ParametersPerBand_srs_AssocCSI_RS (int numRecords) {
    ...
    * given the array.  
    */
   public MIMO_ParametersPerBand_srs_AssocCSI_RS (SupportedCSI_RS_Resource[] elements_) {
      elements = elements_;
   }
