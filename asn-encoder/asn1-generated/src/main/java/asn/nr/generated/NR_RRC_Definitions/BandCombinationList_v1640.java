...
public class BandCombinationList_v1640 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandCombinationList-v1640";
   }

   public BandCombination_v1640[] elements;

   public BandCombinationList_v1640 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationList_v1640 (int numRecords) {
      elements = new BandCombination_v1640 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationList_v1640 (BandCombination_v1640[] elements_) {
      elements = elements_;
   }
   ...
   {
      int fraglen = 0;
      java.util.LinkedList<BandCombination_v1640> tmplist = 
         new java.util.LinkedList<BandCombination_v1640>();
      BandCombination_v1640 value;
      ...
      for (;;) {
         ...
         for (int i = 0; i < fraglen; i++) {
            ...
            value = new BandCombination_v1640();
            value.decode (buffer);
      ...
      elements = new BandCombination_v1640 [tmplist.size()];
