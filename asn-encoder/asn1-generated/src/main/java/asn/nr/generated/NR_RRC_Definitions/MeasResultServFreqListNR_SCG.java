...
public class MeasResultServFreqListNR_SCG extends Asn1SeqOf {
   ...
   public MeasResult2NR[] elements;

   public MeasResultServFreqListNR_SCG () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultServFreqListNR_SCG (int numRecords) {
      elements = new MeasResult2NR [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultServFreqListNR_SCG (MeasResult2NR[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResult2NR [numElements];
