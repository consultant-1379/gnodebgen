...
public class PLMN_IdentityList_EUTRA_EPC extends Asn1SeqOf {
   ...
   public PLMN_IdentityList_EUTRA_EPC () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_IdentityList_EUTRA_EPC (int numRecords) {
    ...
    * given the array.  
    */
   public PLMN_IdentityList_EUTRA_EPC (PLMN_Identity[] elements_) {
      elements = elements_;
   }
