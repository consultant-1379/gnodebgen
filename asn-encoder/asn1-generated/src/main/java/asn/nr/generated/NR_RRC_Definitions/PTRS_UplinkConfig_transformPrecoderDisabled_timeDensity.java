...
public class PTRS_UplinkConfig_transformPrecoderDisabled_timeDensity extends Asn1SeqOf {
   ...
   public PTRS_UplinkConfig_transformPrecoderDisabled_timeDensity () {
      elements = null;
   }
    ...
    * populated.
    */
   public PTRS_UplinkConfig_transformPrecoderDisabled_timeDensity (int numRecords) {
    ...
    * given the array.  
    */
   public PTRS_UplinkConfig_transformPrecoderDisabled_timeDensity (Asn1Integer[] elements_) {
      elements = elements_;
   }
