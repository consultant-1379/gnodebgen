...
public class RRCReconfigurationSidelink_IEs_r16_slrb_ConfigToAddModList_r16 extends Asn1SeqOf {
   ...
   public SLRB_Config_r16[] elements;

   public RRCReconfigurationSidelink_IEs_r16_slrb_ConfigToAddModList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RRCReconfigurationSidelink_IEs_r16_slrb_ConfigToAddModList_r16 (int numRecords) {
      elements = new SLRB_Config_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public RRCReconfigurationSidelink_IEs_r16_slrb_ConfigToAddModList_r16 (SLRB_Config_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SLRB_Config_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SLRB_Config_r16();
