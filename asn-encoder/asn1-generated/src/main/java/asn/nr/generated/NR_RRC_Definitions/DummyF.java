...
public class DummyF extends Asn1Seq {
   ...
   public void encode (Asn1PerEncodeBuffer buffer)
      throws Asn1Exception, java.io.IOException
   {
      // encode maxNumberPeriodicCSI_ReportPerBWP

      if (maxNumberPeriodicCSI_ReportPerBWP != null) {
         buffer.getContext().eventDispatcher.startElement("maxNumberPeriodicCSI_ReportPerBWP", -1);

         maxNumberPeriodicCSI_ReportPerBWP.encode (buffer, 1, 4);

         buffer.getContext().eventDispatcher.endElement("maxNumberPeriodicCSI_ReportPerBWP", -1);
      }
      else throw new Asn1MissingRequiredException ("maxNumberPeriodicCSI_ReportPerBWP");

      // encode maxNumberAperiodicCSI_ReportPerBWP

      if (maxNumberAperiodicCSI_ReportPerBWP != null) {
         buffer.getContext().eventDispatcher.startElement("maxNumberAperiodicCSI_ReportPerBWP", -1);

         maxNumberAperiodicCSI_ReportPerBWP.encode (buffer, 1, 4);

         buffer.getContext().eventDispatcher.endElement("maxNumberAperiodicCSI_ReportPerBWP", -1);
      }
      else throw new Asn1MissingRequiredException ("maxNumberAperiodicCSI_ReportPerBWP");

      // encode maxNumberSemiPersistentCSI_ReportPerBWP

      if (maxNumberSemiPersistentCSI_ReportPerBWP != null) {
         buffer.getContext().eventDispatcher.startElement("maxNumberSemiPersistentCSI_ReportPerBWP", -1);

         maxNumberSemiPersistentCSI_ReportPerBWP.encode (buffer, 0, 4);

         buffer.getContext().eventDispatcher.endElement("maxNumberSemiPersistentCSI_ReportPerBWP", -1);
      }
      else throw new Asn1MissingRequiredException ("maxNumberSemiPersistentCSI_ReportPerBWP");

      // encode simultaneousCSI_ReportsAllCC

      if (simultaneousCSI_ReportsAllCC != null) {
         buffer.getContext().eventDispatcher.startElement("simultaneousCSI_ReportsAllCC", -1);

         simultaneousCSI_ReportsAllCC.encode (buffer, 5, 32);

         buffer.getContext().eventDispatcher.endElement("simultaneousCSI_ReportsAllCC", -1);
      }
      else throw new Asn1MissingRequiredException ("simultaneousCSI_ReportsAllCC");
