...
public class RepetitionSchemeConfig_r16_slotBased_r16 extends Asn1Choice {
   ...
   public RepetitionSchemeConfig_r16_slotBased_r16 () {
      super();
   }

   public RepetitionSchemeConfig_r16_slotBased_r16 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SlotBased_r16 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 1: { 
            SlotBased_r16 setup;
            element = setup = new SlotBased_r16();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            SlotBased_r16 setup = (SlotBased_r16) element;
            setup.encode (buffer);
            break;
