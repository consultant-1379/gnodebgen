...
public class PTRS_DensityRecommendationUL extends Asn1Seq {
   ...
   public void encode (Asn1PerEncodeBuffer buffer)
      throws Asn1Exception, java.io.IOException
   {
      // encode frequencyDensity1

      if (frequencyDensity1 != null) {
         buffer.getContext().eventDispatcher.startElement("frequencyDensity1", -1);

         frequencyDensity1.encode (buffer, 1, 276);

         buffer.getContext().eventDispatcher.endElement("frequencyDensity1", -1);
      }
      else throw new Asn1MissingRequiredException ("frequencyDensity1");

      // encode frequencyDensity2

      if (frequencyDensity2 != null) {
         buffer.getContext().eventDispatcher.startElement("frequencyDensity2", -1);

         frequencyDensity2.encode (buffer, 1, 276);

         buffer.getContext().eventDispatcher.endElement("frequencyDensity2", -1);
      }
      else throw new Asn1MissingRequiredException ("frequencyDensity2");
      ...
      if (timeDensity1 != null) {
         ...
         timeDensity1.encode (buffer, 0, 29);

         buffer.getContext().eventDispatcher.endElement("timeDensity1", -1);
      }
      else throw new Asn1MissingRequiredException ("timeDensity1");
      ...
      if (timeDensity2 != null) {
         ...
         timeDensity2.encode (buffer, 0, 29);

         buffer.getContext().eventDispatcher.endElement("timeDensity2", -1);
      }
      else throw new Asn1MissingRequiredException ("timeDensity2");
      ...
      if (timeDensity3 != null) {
         ...
         timeDensity3.encode (buffer, 0, 29);

         buffer.getContext().eventDispatcher.endElement("timeDensity3", -1);
      }
      else throw new Asn1MissingRequiredException ("timeDensity3");

      // encode sampleDensity1

      if (sampleDensity1 != null) {
         buffer.getContext().eventDispatcher.startElement("sampleDensity1", -1);

         sampleDensity1.encode (buffer, 1, 276);

         buffer.getContext().eventDispatcher.endElement("sampleDensity1", -1);
      }
      else throw new Asn1MissingRequiredException ("sampleDensity1");

      // encode sampleDensity2

      if (sampleDensity2 != null) {
         buffer.getContext().eventDispatcher.startElement("sampleDensity2", -1);

         sampleDensity2.encode (buffer, 1, 276);

         buffer.getContext().eventDispatcher.endElement("sampleDensity2", -1);
      }
      else throw new Asn1MissingRequiredException ("sampleDensity2");

      // encode sampleDensity3

      if (sampleDensity3 != null) {
         buffer.getContext().eventDispatcher.startElement("sampleDensity3", -1);

         sampleDensity3.encode (buffer, 1, 276);

         buffer.getContext().eventDispatcher.endElement("sampleDensity3", -1);
      }
      else throw new Asn1MissingRequiredException ("sampleDensity3");

      // encode sampleDensity4

      if (sampleDensity4 != null) {
         buffer.getContext().eventDispatcher.startElement("sampleDensity4", -1);

         sampleDensity4.encode (buffer, 1, 276);

         buffer.getContext().eventDispatcher.endElement("sampleDensity4", -1);
      }
      else throw new Asn1MissingRequiredException ("sampleDensity4");

      // encode sampleDensity5

      if (sampleDensity5 != null) {
         buffer.getContext().eventDispatcher.startElement("sampleDensity5", -1);

         sampleDensity5.encode (buffer, 1, 276);

         buffer.getContext().eventDispatcher.endElement("sampleDensity5", -1);
      }
      else throw new Asn1MissingRequiredException ("sampleDensity5");
