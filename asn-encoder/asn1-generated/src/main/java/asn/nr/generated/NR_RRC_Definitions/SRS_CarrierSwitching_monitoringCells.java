...
public class SRS_CarrierSwitching_monitoringCells extends Asn1SeqOf {
   ...
   public SRS_CarrierSwitching_monitoringCells () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRS_CarrierSwitching_monitoringCells (int numRecords) {
    ...
    * given the array.  
    */
   public SRS_CarrierSwitching_monitoringCells (ServCellIndex[] elements_) {
      elements = elements_;
   }
