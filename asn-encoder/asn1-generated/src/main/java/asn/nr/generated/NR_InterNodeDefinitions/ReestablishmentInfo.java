...
public class ReestablishmentInfo extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((additionalReestabInfoList != null), null);
      ...
      if (targetCellShortMAC_I != null) {
         buffer.getContext().eventDispatcher.startElement("targetCellShortMAC_I", -1);

         targetCellShortMAC_I.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("targetCellShortMAC_I", -1);
      }
      else throw new Asn1MissingRequiredException ("targetCellShortMAC_I");
      ...
      if (additionalReestabInfoList != null) {
         ...
         additionalReestabInfoList.encode (buffer);
