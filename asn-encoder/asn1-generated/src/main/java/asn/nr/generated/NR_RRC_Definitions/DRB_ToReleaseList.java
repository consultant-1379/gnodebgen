...
public class DRB_ToReleaseList extends Asn1SeqOf {
    ...
    * populated.
    */
   public DRB_ToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public DRB_ToReleaseList (DRB_Identity[] elements_) {
      elements = elements_;
   }
