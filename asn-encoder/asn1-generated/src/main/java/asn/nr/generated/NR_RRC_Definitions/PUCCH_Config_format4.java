...
public class PUCCH_Config_format4 extends Asn1Choice {
   ...
   public PUCCH_Config_format4 () {
      super();
   }

   public PUCCH_Config_format4 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (PUCCH_FormatConfig value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            PUCCH_FormatConfig setup;
            element = setup = new PUCCH_FormatConfig();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            PUCCH_FormatConfig setup = (PUCCH_FormatConfig) element;
            setup.encode (buffer);
            break;
