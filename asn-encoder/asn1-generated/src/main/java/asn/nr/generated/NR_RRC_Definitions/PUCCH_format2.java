...
public class PUCCH_format2 extends Asn1Seq {
    ...
    * the given objects 
    */
   public PUCCH_format2 (long nrofPRBs_,
      long nrofSymbols_,
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (startingSymbolIndex != null) {
         ...
         startingSymbolIndex.encode (buffer, 0, 13);
