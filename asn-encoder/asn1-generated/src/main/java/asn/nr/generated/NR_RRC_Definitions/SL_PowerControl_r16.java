...
public class SL_PowerControl_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((sl_Alpha_PSSCH_PSCCH_r16 != null), null);
      buffer.encodeBit ((dl_Alpha_PSSCH_PSCCH_r16 != null), null);
      buffer.encodeBit ((sl_P0_PSSCH_PSCCH_r16 != null), null);
      buffer.encodeBit ((dl_P0_PSSCH_PSCCH_r16 != null), null);
      buffer.encodeBit ((dl_Alpha_PSFCH_r16 != null), null);
      buffer.encodeBit ((dl_P0_PSFCH_r16 != null), null);

      // encode sl_MaxTransPower_r16

      if (sl_MaxTransPower_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_MaxTransPower_r16", -1);

         sl_MaxTransPower_r16.encode (buffer, -30, 33);

         buffer.getContext().eventDispatcher.endElement("sl_MaxTransPower_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("sl_MaxTransPower_r16");

      // encode sl_Alpha_PSSCH_PSCCH_r16

      if (sl_Alpha_PSSCH_PSCCH_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_Alpha_PSSCH_PSCCH_r16", -1);

         sl_Alpha_PSSCH_PSCCH_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_Alpha_PSSCH_PSCCH_r16", -1);
      }

      // encode dl_Alpha_PSSCH_PSCCH_r16

      if (dl_Alpha_PSSCH_PSCCH_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("dl_Alpha_PSSCH_PSCCH_r16", -1);

         dl_Alpha_PSSCH_PSCCH_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("dl_Alpha_PSSCH_PSCCH_r16", -1);
      }

      // encode sl_P0_PSSCH_PSCCH_r16

      if (sl_P0_PSSCH_PSCCH_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_P0_PSSCH_PSCCH_r16", -1);

         sl_P0_PSSCH_PSCCH_r16.encode (buffer, -16, 15);

         buffer.getContext().eventDispatcher.endElement("sl_P0_PSSCH_PSCCH_r16", -1);
      }

      // encode dl_P0_PSSCH_PSCCH_r16

      if (dl_P0_PSSCH_PSCCH_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("dl_P0_PSSCH_PSCCH_r16", -1);

         dl_P0_PSSCH_PSCCH_r16.encode (buffer, -16, 15);

         buffer.getContext().eventDispatcher.endElement("dl_P0_PSSCH_PSCCH_r16", -1);
      }

      // encode dl_Alpha_PSFCH_r16

      if (dl_Alpha_PSFCH_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("dl_Alpha_PSFCH_r16", -1);

         dl_Alpha_PSFCH_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("dl_Alpha_PSFCH_r16", -1);
      }

      // encode dl_P0_PSFCH_r16

      if (dl_P0_PSFCH_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("dl_P0_PSFCH_r16", -1);

         dl_P0_PSFCH_r16.encode (buffer, -16, 15);
