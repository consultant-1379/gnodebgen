...
public class PDSCH_Config_zp_CSI_RS_ResourceToReleaseList extends Asn1SeqOf {
   ...
   public PDSCH_Config_zp_CSI_RS_ResourceToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDSCH_Config_zp_CSI_RS_ResourceToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public PDSCH_Config_zp_CSI_RS_ResourceToReleaseList (ZP_CSI_RS_ResourceId[] elements_) {
      elements = elements_;
   }
