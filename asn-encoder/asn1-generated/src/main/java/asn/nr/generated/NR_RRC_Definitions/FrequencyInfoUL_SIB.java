...
public class FrequencyInfoUL_SIB extends Asn1Seq {
   ...
   public FrequencyInfoUL_SIB_scs_SpecificCarrierList scs_SpecificCarrierList;
   public P_Max p_Max;  // optional
   public FrequencyInfoUL_SIB_frequencyShift7p5khz frequencyShift7p5khz = null;  // optional
   public Asn1OpenExt extElem1;

   public FrequencyInfoUL_SIB () {
      super();
      init();
   }
   ...
   public FrequencyInfoUL_SIB (
      ...
      FrequencyInfoUL_SIB_scs_SpecificCarrierList scs_SpecificCarrierList_,
      P_Max p_Max_,
      FrequencyInfoUL_SIB_frequencyShift7p5khz frequencyShift7p5khz_
   ) {
      super();
    ...
    * the given objects 
    */
   public FrequencyInfoUL_SIB (MultiFrequencyBandListNR_SIB frequencyBandList_,
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 3: return p_Max;
         case 4: return frequencyShift7p5khz;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      scs_SpecificCarrierList = new FrequencyInfoUL_SIB_scs_SpecificCarrierList();
      ...
      if (frequencyShift7p5khzPresent) {
         ...
         int tval = FrequencyInfoUL_SIB_frequencyShift7p5khz.decodeEnumValue (buffer);
         frequencyShift7p5khz = FrequencyInfoUL_SIB_frequencyShift7p5khz.valueOf (tval);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((absoluteFrequencyPointA != null), null);
      buffer.encodeBit ((p_Max != null), null);
      buffer.encodeBit ((frequencyShift7p5khz != null), null);
      ...
      if (frequencyShift7p5khz != null) {
         ...
         frequencyShift7p5khz.encode (buffer);
