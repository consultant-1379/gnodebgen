...
public class SL_SSB_TimeAllocation_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((sl_NumSSB_WithinPeriod_r16 != null), null);
      buffer.encodeBit ((sl_TimeOffsetSSB_r16 != null), null);
      buffer.encodeBit ((sl_TimeInterval_r16 != null), null);

      // encode sl_NumSSB_WithinPeriod_r16

      if (sl_NumSSB_WithinPeriod_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_NumSSB_WithinPeriod_r16", -1);

         sl_NumSSB_WithinPeriod_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_NumSSB_WithinPeriod_r16", -1);
      }

      // encode sl_TimeOffsetSSB_r16

      if (sl_TimeOffsetSSB_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_TimeOffsetSSB_r16", -1);

         sl_TimeOffsetSSB_r16.encode (buffer, 0, 1279);

         buffer.getContext().eventDispatcher.endElement("sl_TimeOffsetSSB_r16", -1);
      }

      // encode sl_TimeInterval_r16

      if (sl_TimeInterval_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_TimeInterval_r16", -1);

         sl_TimeInterval_r16.encode (buffer, 0, 639);
