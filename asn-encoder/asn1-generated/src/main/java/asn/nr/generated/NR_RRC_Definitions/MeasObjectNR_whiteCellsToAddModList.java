...
public class MeasObjectNR_whiteCellsToAddModList extends Asn1SeqOf {
   ...
   public MeasObjectNR_whiteCellsToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasObjectNR_whiteCellsToAddModList (int numRecords) {
    ...
    * given the array.  
    */
   public MeasObjectNR_whiteCellsToAddModList (PCI_RangeElement[] elements_) {
      elements = elements_;
   }
