...
public class MIMO_ParametersPerBand_singleDCI_SDM_scheme_Parameters_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((supportNewDMRS_Port_r16 != null), null);
      buffer.encodeBit ((supportTwoPortDL_PTRS_r16 != null), null);

      // encode supportNewDMRS_Port_r16

      if (supportNewDMRS_Port_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("supportNewDMRS_Port_r16", -1);

         supportNewDMRS_Port_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("supportNewDMRS_Port_r16", -1);
      }

      // encode supportTwoPortDL_PTRS_r16

      if (supportTwoPortDL_PTRS_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("supportTwoPortDL_PTRS_r16", -1);

         supportTwoPortDL_PTRS_r16.encode (buffer);
