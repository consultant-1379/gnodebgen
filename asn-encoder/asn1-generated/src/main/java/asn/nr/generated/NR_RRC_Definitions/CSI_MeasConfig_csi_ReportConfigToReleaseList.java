...
public class CSI_MeasConfig_csi_ReportConfigToReleaseList extends Asn1SeqOf {
   ...
   public CSI_ReportConfigId[] elements;

   public CSI_MeasConfig_csi_ReportConfigToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_csi_ReportConfigToReleaseList (int numRecords) {
      elements = new CSI_ReportConfigId [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_MeasConfig_csi_ReportConfigToReleaseList (CSI_ReportConfigId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_ReportConfigId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_ReportConfigId();
