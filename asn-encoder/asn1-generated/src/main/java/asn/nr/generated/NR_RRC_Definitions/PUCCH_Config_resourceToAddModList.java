...
public class PUCCH_Config_resourceToAddModList extends Asn1SeqOf {
   ...
   public PUCCH_Resource[] elements;

   public PUCCH_Config_resourceToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_resourceToAddModList (int numRecords) {
      elements = new PUCCH_Resource [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_Config_resourceToAddModList (PUCCH_Resource[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUCCH_Resource [numElements];
