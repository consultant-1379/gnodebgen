...
public class CSI_RS_ResourceConfigMobility_csi_RS_CellList_Mobility extends Asn1SeqOf {
   ...
   public CSI_RS_CellMobility[] elements;

   public CSI_RS_ResourceConfigMobility_csi_RS_CellList_Mobility () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_ResourceConfigMobility_csi_RS_CellList_Mobility (int numRecords) {
      elements = new CSI_RS_CellMobility [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_RS_ResourceConfigMobility_csi_RS_CellList_Mobility (CSI_RS_CellMobility[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_RS_CellMobility [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_RS_CellMobility();
