...
public class CA_ParametersNRDC extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((ca_ParametersNR_ForDC != null), null);
      buffer.encodeBit ((ca_ParametersNR_ForDC_v1540 != null), null);
      buffer.encodeBit ((ca_ParametersNR_ForDC_v1550 != null), null);
      buffer.encodeBit ((ca_ParametersNR_ForDC_v1560 != null), null);
      buffer.encodeBit ((featureSetCombinationDC != null), null);

      // encode ca_ParametersNR_ForDC

      if (ca_ParametersNR_ForDC != null) {
         buffer.getContext().eventDispatcher.startElement("ca_ParametersNR_ForDC", -1);

         ca_ParametersNR_ForDC.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ca_ParametersNR_ForDC", -1);
      }

      // encode ca_ParametersNR_ForDC_v1540

      if (ca_ParametersNR_ForDC_v1540 != null) {
         buffer.getContext().eventDispatcher.startElement("ca_ParametersNR_ForDC_v1540", -1);

         ca_ParametersNR_ForDC_v1540.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ca_ParametersNR_ForDC_v1540", -1);
      }

      // encode ca_ParametersNR_ForDC_v1550

      if (ca_ParametersNR_ForDC_v1550 != null) {
         buffer.getContext().eventDispatcher.startElement("ca_ParametersNR_ForDC_v1550", -1);

         ca_ParametersNR_ForDC_v1550.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ca_ParametersNR_ForDC_v1550", -1);
      }

      // encode ca_ParametersNR_ForDC_v1560

      if (ca_ParametersNR_ForDC_v1560 != null) {
         buffer.getContext().eventDispatcher.startElement("ca_ParametersNR_ForDC_v1560", -1);

         ca_ParametersNR_ForDC_v1560.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ca_ParametersNR_ForDC_v1560", -1);
      }

      // encode featureSetCombinationDC

      if (featureSetCombinationDC != null) {
         buffer.getContext().eventDispatcher.startElement("featureSetCombinationDC", -1);

         featureSetCombinationDC.encode (buffer);
