...
public class ReportConfigToRemoveList extends Asn1SeqOf {
   ...
   public ReportConfigId[] elements;

   public ReportConfigToRemoveList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ReportConfigToRemoveList (int numRecords) {
      elements = new ReportConfigId [numRecords];
   }
    ...
    * given the array.  
    */
   public ReportConfigToRemoveList (ReportConfigId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ReportConfigId [numElements];
