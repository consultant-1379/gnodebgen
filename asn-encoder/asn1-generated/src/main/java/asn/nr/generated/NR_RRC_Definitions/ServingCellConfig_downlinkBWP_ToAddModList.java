...
public class ServingCellConfig_downlinkBWP_ToAddModList extends Asn1SeqOf {
   ...
   public BWP_Downlink[] elements;

   public ServingCellConfig_downlinkBWP_ToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServingCellConfig_downlinkBWP_ToAddModList (int numRecords) {
      elements = new BWP_Downlink [numRecords];
   }
    ...
    * given the array.  
    */
   public ServingCellConfig_downlinkBWP_ToAddModList (BWP_Downlink[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BWP_Downlink [numElements];
