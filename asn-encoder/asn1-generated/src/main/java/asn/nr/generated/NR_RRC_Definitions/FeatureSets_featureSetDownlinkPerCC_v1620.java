...
public class FeatureSets_featureSetDownlinkPerCC_v1620 extends Asn1SeqOf {
   ...
   public FeatureSetDownlinkPerCC_v1620[] elements;

   public FeatureSets_featureSetDownlinkPerCC_v1620 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSets_featureSetDownlinkPerCC_v1620 (int numRecords) {
      elements = new FeatureSetDownlinkPerCC_v1620 [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSets_featureSetDownlinkPerCC_v1620 (FeatureSetDownlinkPerCC_v1620[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetDownlinkPerCC_v1620 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetDownlinkPerCC_v1620();
