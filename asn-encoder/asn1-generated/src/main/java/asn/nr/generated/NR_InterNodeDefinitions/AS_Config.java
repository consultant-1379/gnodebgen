...
public class AS_Config extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (rrcReconfiguration != null) {
         ...
         Asn1OctetString rrcReconfiguration_outer;
         {
            Asn1PerEncodeBuffer savedBuffer = buffer;
            buffer = new Asn1PerEncodeBuffer(buffer.isAligned());
            rrcReconfiguration.encode (buffer);
            rrcReconfiguration_outer = new Asn1OctetString(buffer.getMsgCopy() );
            buffer = savedBuffer;
         }
         rrcReconfiguration_outer.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("rrcReconfiguration", -1);
      }
      else throw new Asn1MissingRequiredException ("rrcReconfiguration");
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((sourceRB_SN_Config != null), "optbit");
            buffer.encodeBit ((sourceSCG_NR_Config != null), "optbit");
            buffer.encodeBit ((sourceSCG_EUTRA_Config != null), "optbit");
            if (sourceRB_SN_Config != null) {
               Asn1OctetString sourceRB_SN_Config_outer;
               {
                  Asn1PerEncodeBuffer savedBuffer = buffer;
                  buffer = new Asn1PerEncodeBuffer(buffer.isAligned());
                  sourceRB_SN_Config.encode (buffer);
                  sourceRB_SN_Config_outer = new Asn1OctetString(buffer.getMsgCopy() );
                  buffer = savedBuffer;
               }
               sourceRB_SN_Config_outer.encode (buffer);
            }
            if (sourceSCG_NR_Config != null) {
               Asn1OctetString sourceSCG_NR_Config_outer;
               {
                  Asn1PerEncodeBuffer savedBuffer = buffer;
                  buffer = new Asn1PerEncodeBuffer(buffer.isAligned());
                  sourceSCG_NR_Config.encode (buffer);
                  sourceSCG_NR_Config_outer = new Asn1OctetString(buffer.getMsgCopy() );
                  buffer = savedBuffer;
               }
               sourceSCG_NR_Config_outer.encode (buffer);
            }
            if (sourceSCG_EUTRA_Config != null) {
               sourceSCG_EUTRA_Config.encode (buffer);
            }
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((sourceSCG_Configured != null), "optbit");
            if (sourceSCG_Configured != null) {
               sourceSCG_Configured.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
