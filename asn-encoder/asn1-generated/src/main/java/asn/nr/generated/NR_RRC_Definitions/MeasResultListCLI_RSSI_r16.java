...
public class MeasResultListCLI_RSSI_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultListCLI-RSSI-r16";
   }

   public MeasResultCLI_RSSI_r16[] elements;

   public MeasResultListCLI_RSSI_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListCLI_RSSI_r16 (int numRecords) {
      elements = new MeasResultCLI_RSSI_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListCLI_RSSI_r16 (MeasResultCLI_RSSI_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultCLI_RSSI_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultCLI_RSSI_r16();
