...
public class ControlResourceSet_tci_StatesPDCCH_ToReleaseList extends Asn1SeqOf {
   ...
   public ControlResourceSet_tci_StatesPDCCH_ToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ControlResourceSet_tci_StatesPDCCH_ToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public ControlResourceSet_tci_StatesPDCCH_ToReleaseList (TCI_StateId[] elements_) {
      elements = elements_;
   }
