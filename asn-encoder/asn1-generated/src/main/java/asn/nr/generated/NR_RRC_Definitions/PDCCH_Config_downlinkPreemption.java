...
public class PDCCH_Config_downlinkPreemption extends Asn1Choice {
   ...
   public PDCCH_Config_downlinkPreemption () {
      super();
   }

   public PDCCH_Config_downlinkPreemption (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (DownlinkPreemption value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 1: { 
            ...
            element = setup = new DownlinkPreemption();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            DownlinkPreemption setup = (DownlinkPreemption) element;
            setup.encode (buffer);
            break;
