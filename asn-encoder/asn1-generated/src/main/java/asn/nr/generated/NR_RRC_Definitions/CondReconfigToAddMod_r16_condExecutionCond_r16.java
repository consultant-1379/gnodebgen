...
public class CondReconfigToAddMod_r16_condExecutionCond_r16 extends Asn1SeqOf {
   ...
   public MeasId[] elements;

   public CondReconfigToAddMod_r16_condExecutionCond_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CondReconfigToAddMod_r16_condExecutionCond_r16 (int numRecords) {
      elements = new MeasId [numRecords];
   }
    ...
    * given the array.  
    */
   public CondReconfigToAddMod_r16_condExecutionCond_r16 (MeasId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasId [numElements];
