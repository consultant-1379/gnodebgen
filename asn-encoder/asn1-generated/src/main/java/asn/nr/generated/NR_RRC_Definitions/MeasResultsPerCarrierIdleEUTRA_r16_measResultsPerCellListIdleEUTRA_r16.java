...
public class MeasResultsPerCarrierIdleEUTRA_r16_measResultsPerCellListIdleEUTRA_r16 extends Asn1SeqOf {
   ...
   public MeasResultsPerCellIdleEUTRA_r16[] elements;

   public MeasResultsPerCarrierIdleEUTRA_r16_measResultsPerCellListIdleEUTRA_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultsPerCarrierIdleEUTRA_r16_measResultsPerCellListIdleEUTRA_r16 (int numRecords) {
      elements = new MeasResultsPerCellIdleEUTRA_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultsPerCarrierIdleEUTRA_r16_measResultsPerCellListIdleEUTRA_r16 (MeasResultsPerCellIdleEUTRA_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultsPerCellIdleEUTRA_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultsPerCellIdleEUTRA_r16();
