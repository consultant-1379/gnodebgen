...
public class MeasurementTimingConfiguration_criticalExtensions extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // c1
         case _C1:
            MeasurementTimingConfiguration_criticalExtensions_c1 c1 = (MeasurementTimingConfiguration_criticalExtensions_c1) element;
            c1.encode (buffer);
            break;

         // criticalExtensionsFuture
         case _CRITICALEXTENSIONSFUTURE:
            MeasurementTimingConfiguration_criticalExtensions_criticalExtensionsFuture criticalExtensionsFuture = (MeasurementTimingConfiguration_criticalExtensions_criticalExtensionsFuture) element;
