...
public class PH_InfoSCG extends Asn1Seq {
   ...
   public PH_UplinkCarrierSCG ph_Uplink;
   public PH_UplinkCarrierSCG ph_SupplementaryUplink;  // optional
   ...
   public PH_InfoSCG (
      ...
      PH_UplinkCarrierSCG ph_Uplink_,
      PH_UplinkCarrierSCG ph_SupplementaryUplink_
   ) {
      super();
      servCellIndex = servCellIndex_;
    ...
    * the given objects 
    */
   public PH_InfoSCG (long servCellIndex_,
      PH_UplinkCarrierSCG ph_Uplink_,
      PH_UplinkCarrierSCG ph_SupplementaryUplink_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      ph_Uplink = new PH_UplinkCarrierSCG();
      ...
      if (ph_SupplementaryUplinkPresent) {
         ...
         ph_SupplementaryUplink = new PH_UplinkCarrierSCG();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((ph_SupplementaryUplink != null), null);
      ...
      if (ph_Uplink != null) {
         ...
         ph_Uplink.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ph_Uplink", -1);
      }
      else throw new Asn1MissingRequiredException ("ph_Uplink");

      // encode ph_SupplementaryUplink

      if (ph_SupplementaryUplink != null) {
         buffer.getContext().eventDispatcher.startElement("ph_SupplementaryUplink", -1);

         ph_SupplementaryUplink.encode (buffer);
