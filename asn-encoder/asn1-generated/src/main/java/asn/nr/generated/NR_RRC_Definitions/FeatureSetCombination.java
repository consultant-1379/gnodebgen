...
public class FeatureSetCombination extends Asn1SeqOf {
   ...
   public FeatureSetsPerBand[] elements;

   public FeatureSetCombination () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSetCombination (int numRecords) {
      elements = new FeatureSetsPerBand [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSetCombination (FeatureSetsPerBand[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetsPerBand [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetsPerBand();
