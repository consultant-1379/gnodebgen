...
public class BWP_DownlinkDedicated_pdsch_Config extends Asn1Choice {
   ...
   public BWP_DownlinkDedicated_pdsch_Config () {
      super();
   }

   public BWP_DownlinkDedicated_pdsch_Config (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (PDSCH_Config value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 1: { 
            PDSCH_Config setup;
            element = setup = new PDSCH_Config();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            PDSCH_Config setup = (PDSCH_Config) element;
            setup.encode (buffer);
            break;
