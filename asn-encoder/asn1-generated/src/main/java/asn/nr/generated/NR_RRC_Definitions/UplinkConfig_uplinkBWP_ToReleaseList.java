...
public class UplinkConfig_uplinkBWP_ToReleaseList extends Asn1SeqOf {
   ...
   public UplinkConfig_uplinkBWP_ToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public UplinkConfig_uplinkBWP_ToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public UplinkConfig_uplinkBWP_ToReleaseList (BWP_Id[] elements_) {
      elements = elements_;
   }
