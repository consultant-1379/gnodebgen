...
public class CSI_RS_CellMobility_csi_rs_ResourceList_Mobility extends Asn1SeqOf {
   ...
   public CSI_RS_Resource_Mobility[] elements;

   public CSI_RS_CellMobility_csi_rs_ResourceList_Mobility () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_CellMobility_csi_rs_ResourceList_Mobility (int numRecords) {
      elements = new CSI_RS_Resource_Mobility [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_RS_CellMobility_csi_rs_ResourceList_Mobility (CSI_RS_Resource_Mobility[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 96);
      int numElements = (int) buffer.decodeLength();

      elements = new CSI_RS_Resource_Mobility [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_RS_Resource_Mobility();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 96);
