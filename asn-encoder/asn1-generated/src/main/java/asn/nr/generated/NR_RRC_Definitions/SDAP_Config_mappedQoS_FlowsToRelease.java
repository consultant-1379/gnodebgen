...
public class SDAP_Config_mappedQoS_FlowsToRelease extends Asn1SeqOf {
   ...
   public SDAP_Config_mappedQoS_FlowsToRelease () {
      elements = null;
   }
    ...
    * populated.
    */
   public SDAP_Config_mappedQoS_FlowsToRelease (int numRecords) {
      elements = new QFI [numRecords];
   }
    ...
    * given the array.  
    */
   public SDAP_Config_mappedQoS_FlowsToRelease (QFI[] elements_) {
      elements = elements_;
   }
