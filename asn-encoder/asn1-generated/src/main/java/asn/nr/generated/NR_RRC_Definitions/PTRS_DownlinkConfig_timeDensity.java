...
public class PTRS_DownlinkConfig_timeDensity extends Asn1SeqOf {
   ...
   public PTRS_DownlinkConfig_timeDensity () {
      elements = null;
   }
    ...
    * populated.
    */
   public PTRS_DownlinkConfig_timeDensity (int numRecords) {
    ...
    * given the array.  
    */
   public PTRS_DownlinkConfig_timeDensity (Asn1Integer[] elements_) {
      elements = elements_;
   }
