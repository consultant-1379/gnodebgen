...
public class RateMatchPatternLTE_CRS extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((mbsfn_SubframeConfigList != null), null);

      // encode carrierFreqDL

      if (carrierFreqDL != null) {
         buffer.getContext().eventDispatcher.startElement("carrierFreqDL", -1);

         carrierFreqDL.encode (buffer, 0, 16383);

         buffer.getContext().eventDispatcher.endElement("carrierFreqDL", -1);
      }
      else throw new Asn1MissingRequiredException ("carrierFreqDL");

      // encode carrierBandwidthDL

      if (carrierBandwidthDL != null) {
         buffer.getContext().eventDispatcher.startElement("carrierBandwidthDL", -1);

         carrierBandwidthDL.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("carrierBandwidthDL", -1);
      }
      else throw new Asn1MissingRequiredException ("carrierBandwidthDL");
      ...
      if (mbsfn_SubframeConfigList != null) {
         ...
         mbsfn_SubframeConfigList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("mbsfn_SubframeConfigList", -1);
      }

      // encode nrofCRS_Ports

      if (nrofCRS_Ports != null) {
         buffer.getContext().eventDispatcher.startElement("nrofCRS_Ports", -1);

         nrofCRS_Ports.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("nrofCRS_Ports", -1);
      }
      else throw new Asn1MissingRequiredException ("nrofCRS_Ports");
      ...
      if (v_Shift != null) {
         ...
         v_Shift.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("v_Shift", -1);
      }
      else throw new Asn1MissingRequiredException ("v_Shift");
