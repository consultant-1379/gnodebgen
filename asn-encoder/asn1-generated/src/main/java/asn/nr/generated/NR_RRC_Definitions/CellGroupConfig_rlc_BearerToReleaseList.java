...
public class CellGroupConfig_rlc_BearerToReleaseList extends Asn1SeqOf {
   ...
   public LogicalChannelIdentity[] elements;

   public CellGroupConfig_rlc_BearerToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellGroupConfig_rlc_BearerToReleaseList (int numRecords) {
      elements = new LogicalChannelIdentity [numRecords];
   }
    ...
    * given the array.  
    */
   public CellGroupConfig_rlc_BearerToReleaseList (LogicalChannelIdentity[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LogicalChannelIdentity [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LogicalChannelIdentity();
