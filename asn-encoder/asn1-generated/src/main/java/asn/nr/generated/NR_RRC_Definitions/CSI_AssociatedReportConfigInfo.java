...
public class CSI_AssociatedReportConfigInfo extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // encode resourcesForChannel

      if (resourcesForChannel != null) {
         buffer.getContext().eventDispatcher.startElement("resourcesForChannel", -1);

         resourcesForChannel.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("resourcesForChannel", -1);
      }
      else throw new Asn1MissingRequiredException ("resourcesForChannel");
      ...
      if (csi_IM_ResourcesForInterference != null) {
         ...
         csi_IM_ResourcesForInterference.encode (buffer, 1, 16);
      ...
      if (nzp_CSI_RS_ResourcesForInterference != null) {
         ...
         nzp_CSI_RS_ResourcesForInterference.encode (buffer, 1, 16);
