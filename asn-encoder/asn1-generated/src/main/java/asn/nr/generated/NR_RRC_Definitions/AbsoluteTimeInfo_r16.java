...
public class AbsoluteTimeInfo_r16 extends Asn1BitString {
    ...
    */
   public AbsoluteTimeInfo_r16 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public AbsoluteTimeInfo_r16 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public AbsoluteTimeInfo_r16 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public AbsoluteTimeInfo_r16 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public AbsoluteTimeInfo_r16 (java.util.BitSet bitSet) {
      super (bitSet);
   }
