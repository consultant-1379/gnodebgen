...
public class BandCombinationListSidelinkEUTRA_NR_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandCombinationListSidelinkEUTRA-NR-r16";
   }

   public BandCombinationParametersSidelinkEUTRA_NR_r16[] elements;

   public BandCombinationListSidelinkEUTRA_NR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationListSidelinkEUTRA_NR_r16 (int numRecords) {
      elements = new BandCombinationParametersSidelinkEUTRA_NR_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationListSidelinkEUTRA_NR_r16 (BandCombinationParametersSidelinkEUTRA_NR_r16[] elements_) {
      elements = elements_;
   }
   ...
   {
      int fraglen = 0;
      java.util.LinkedList<BandCombinationParametersSidelinkEUTRA_NR_r16> tmplist = 
         new java.util.LinkedList<BandCombinationParametersSidelinkEUTRA_NR_r16>();
      BandCombinationParametersSidelinkEUTRA_NR_r16 value;
      ...
      for (;;) {
         ...
         for (int i = 0; i < fraglen; i++) {
            ...
            value = new BandCombinationParametersSidelinkEUTRA_NR_r16();
            value.decode (buffer);
      ...
      elements = new BandCombinationParametersSidelinkEUTRA_NR_r16 [tmplist.size()];
