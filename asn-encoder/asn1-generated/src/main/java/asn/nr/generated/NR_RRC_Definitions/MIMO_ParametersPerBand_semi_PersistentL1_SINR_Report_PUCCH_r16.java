...
public class MIMO_ParametersPerBand_semi_PersistentL1_SINR_Report_PUCCH_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((supportReportFormat1_2OFDM_syms_r16 != null), null);
      buffer.encodeBit ((supportReportFormat4_14OFDM_syms_r16 != null), null);

      // encode supportReportFormat1_2OFDM_syms_r16

      if (supportReportFormat1_2OFDM_syms_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("supportReportFormat1_2OFDM_syms_r16", -1);

         supportReportFormat1_2OFDM_syms_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("supportReportFormat1_2OFDM_syms_r16", -1);
      }

      // encode supportReportFormat4_14OFDM_syms_r16

      if (supportReportFormat4_14OFDM_syms_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("supportReportFormat4_14OFDM_syms_r16", -1);

         supportReportFormat4_14OFDM_syms_r16.encode (buffer);
