...
public class VictimSystemType_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((gps_r16 != null), null);
      buffer.encodeBit ((glonass_r16 != null), null);
      buffer.encodeBit ((bds_r16 != null), null);
      buffer.encodeBit ((galileo_r16 != null), null);
      buffer.encodeBit ((navIC_r16 != null), null);
      buffer.encodeBit ((wlan_r16 != null), null);
      buffer.encodeBit ((bluetooth_r16 != null), null);
      ...
      if (wlan_r16 != null) {
         ...
         wlan_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("wlan_r16", -1);
      }

      // encode bluetooth_r16

      if (bluetooth_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("bluetooth_r16", -1);

         bluetooth_r16.encode (buffer);
