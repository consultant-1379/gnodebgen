...
public class CSI_RS_CellMobility extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((density != null), null);
      ...
      // encode csi_rs_MeasurementBW

      if (csi_rs_MeasurementBW != null) {
         buffer.getContext().eventDispatcher.startElement("csi_rs_MeasurementBW", -1);

         csi_rs_MeasurementBW.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("csi_rs_MeasurementBW", -1);
      }
      else throw new Asn1MissingRequiredException ("csi_rs_MeasurementBW");
      ...
      // encode csi_rs_ResourceList_Mobility

      if (csi_rs_ResourceList_Mobility != null) {
         buffer.getContext().eventDispatcher.startElement("csi_rs_ResourceList_Mobility", -1);

         csi_rs_ResourceList_Mobility.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("csi_rs_ResourceList_Mobility", -1);
      }
      else throw new Asn1MissingRequiredException ("csi_rs_ResourceList_Mobility");
