...
public class PDSCH_Config_aperiodicZP_CSI_RS_ResourceSetsToAddModListDCI_1_2_r16 extends Asn1SeqOf {
   ...
   public ZP_CSI_RS_ResourceSet[] elements;

   public PDSCH_Config_aperiodicZP_CSI_RS_ResourceSetsToAddModListDCI_1_2_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDSCH_Config_aperiodicZP_CSI_RS_ResourceSetsToAddModListDCI_1_2_r16 (int numRecords) {
      elements = new ZP_CSI_RS_ResourceSet [numRecords];
   }
    ...
    * given the array.  
    */
   public PDSCH_Config_aperiodicZP_CSI_RS_ResourceSetsToAddModListDCI_1_2_r16 (ZP_CSI_RS_ResourceSet[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ZP_CSI_RS_ResourceSet [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ZP_CSI_RS_ResourceSet();
