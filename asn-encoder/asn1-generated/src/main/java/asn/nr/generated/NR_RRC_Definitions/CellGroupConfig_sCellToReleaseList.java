...
public class CellGroupConfig_sCellToReleaseList extends Asn1SeqOf {
   ...
   public SCellIndex[] elements;

   public CellGroupConfig_sCellToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellGroupConfig_sCellToReleaseList (int numRecords) {
      elements = new SCellIndex [numRecords];
   }
    ...
    * given the array.  
    */
   public CellGroupConfig_sCellToReleaseList (SCellIndex[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCellIndex [numElements];
