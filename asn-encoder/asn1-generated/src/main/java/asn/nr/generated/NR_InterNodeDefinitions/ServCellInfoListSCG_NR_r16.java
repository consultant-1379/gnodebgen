...
public class ServCellInfoListSCG_NR_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServCellInfoListSCG-NR-r16";
   }

   public ServCellInfoXCG_NR_r16[] elements;

   public ServCellInfoListSCG_NR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServCellInfoListSCG_NR_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public ServCellInfoListSCG_NR_r16 (ServCellInfoXCG_NR_r16[] elements_) {
      elements = elements_;
   }
