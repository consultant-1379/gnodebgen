...
import asn.nr.generated.NR_RRC_Definitions.MeasResultCellListSFTD_NR;
...
public class CG_ConfigInfo_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((ue_CapabilityInfo != null), null);
      buffer.encodeBit ((candidateCellInfoListMN != null), null);
      buffer.encodeBit ((candidateCellInfoListSN != null), null);
      buffer.encodeBit ((measResultCellListSFTD_NR != null), null);
      buffer.encodeBit ((scgFailureInfo != null), null);
      buffer.encodeBit ((configRestrictInfo != null), null);
      buffer.encodeBit ((drx_InfoMCG != null), null);
      buffer.encodeBit ((measConfigMN != null), null);
      buffer.encodeBit ((sourceConfigSCG != null), null);
      buffer.encodeBit ((scg_RB_Config != null), null);
      buffer.encodeBit ((mcg_RB_Config != null), null);
      buffer.encodeBit ((mrdc_AssistanceInfo != null), null);
      buffer.encodeBit ((nonCriticalExtension != null), null);

      // encode ue_CapabilityInfo

      if (ue_CapabilityInfo != null) {
         buffer.getContext().eventDispatcher.startElement("ue_CapabilityInfo", -1);

         Asn1OctetString ue_CapabilityInfo_outer;
         {
            Asn1PerEncodeBuffer savedBuffer = buffer;
            buffer = new Asn1PerEncodeBuffer(buffer.isAligned());
            ue_CapabilityInfo.encode (buffer);
            ue_CapabilityInfo_outer = new Asn1OctetString(buffer.getMsgCopy() );
            buffer = savedBuffer;
         }
         ue_CapabilityInfo_outer.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ue_CapabilityInfo", -1);
      }

      // encode candidateCellInfoListMN

      if (candidateCellInfoListMN != null) {
         buffer.getContext().eventDispatcher.startElement("candidateCellInfoListMN", -1);

         candidateCellInfoListMN.encode (buffer);
      ...
      // encode measResultCellListSFTD_NR

      if (measResultCellListSFTD_NR != null) {
         buffer.getContext().eventDispatcher.startElement("measResultCellListSFTD_NR", -1);

         measResultCellListSFTD_NR.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("measResultCellListSFTD_NR", -1);
      }

      // encode scgFailureInfo

      if (scgFailureInfo != null) {
         buffer.getContext().eventDispatcher.startElement("scgFailureInfo", -1);

         scgFailureInfo.encode (buffer);
      ...
      if (measConfigMN != null) {
         ...
         measConfigMN.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("measConfigMN", -1);
      }

      // encode sourceConfigSCG

      if (sourceConfigSCG != null) {
         buffer.getContext().eventDispatcher.startElement("sourceConfigSCG", -1);

         Asn1OctetString sourceConfigSCG_outer;
         {
            Asn1PerEncodeBuffer savedBuffer = buffer;
            buffer = new Asn1PerEncodeBuffer(buffer.isAligned());
            sourceConfigSCG.encode (buffer);
            sourceConfigSCG_outer = new Asn1OctetString(buffer.getMsgCopy() );
            buffer = savedBuffer;
         }
         sourceConfigSCG_outer.encode (buffer);
      ...
      // encode mcg_RB_Config

      if (mcg_RB_Config != null) {
         buffer.getContext().eventDispatcher.startElement("mcg_RB_Config", -1);

         Asn1OctetString mcg_RB_Config_outer;
         {
            Asn1PerEncodeBuffer savedBuffer = buffer;
            buffer = new Asn1PerEncodeBuffer(buffer.isAligned());
            mcg_RB_Config.encode (buffer);
            mcg_RB_Config_outer = new Asn1OctetString(buffer.getMsgCopy() );
            buffer = savedBuffer;
         }
         mcg_RB_Config_outer.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("mcg_RB_Config", -1);
      }

      // encode mrdc_AssistanceInfo

      if (mrdc_AssistanceInfo != null) {
         buffer.getContext().eventDispatcher.startElement("mrdc_AssistanceInfo", -1);

         mrdc_AssistanceInfo.encode (buffer);
