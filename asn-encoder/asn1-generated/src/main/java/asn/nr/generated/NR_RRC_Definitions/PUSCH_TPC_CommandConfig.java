...
public class PUSCH_TPC_CommandConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((tpc_Index != null), null);
      buffer.encodeBit ((tpc_IndexSUL != null), null);
      buffer.encodeBit ((targetCell != null), null);
      ...
      if (tpc_IndexSUL != null) {
         buffer.getContext().eventDispatcher.startElement("tpc_IndexSUL", -1);

         tpc_IndexSUL.encode (buffer, 1, 15);
