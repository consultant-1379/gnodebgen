...
import asn.nr.generated.NR_RRC_Definitions.MeasResultIdleNR_r16;
import asn.nr.generated.NR_RRC_Definitions.MeasResultIdleEUTRA_r16;
...
public class VarMeasIdleReport_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((measReportIdleNR_r16 != null), null);
      buffer.encodeBit ((measReportIdleEUTRA_r16 != null), null);

      // encode measReportIdleNR_r16

      if (measReportIdleNR_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("measReportIdleNR_r16", -1);

         measReportIdleNR_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("measReportIdleNR_r16", -1);
      }

      // encode measReportIdleEUTRA_r16

      if (measReportIdleEUTRA_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("measReportIdleEUTRA_r16", -1);

         measReportIdleEUTRA_r16.encode (buffer);
