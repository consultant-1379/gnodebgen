...
public class HRNN_List_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "HRNN-List-r16";
   }

   public HRNN_r16[] elements;

   public HRNN_List_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public HRNN_List_r16 (int numRecords) {
      elements = new HRNN_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public HRNN_List_r16 (HRNN_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HRNN_r16 [numElements];
