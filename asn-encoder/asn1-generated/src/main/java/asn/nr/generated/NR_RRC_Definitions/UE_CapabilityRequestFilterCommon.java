...
public class UE_CapabilityRequestFilterCommon extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((mrdc_Request != null), null);

      // encode mrdc_Request

      if (mrdc_Request != null) {
         buffer.getContext().eventDispatcher.startElement("mrdc_Request", -1);

         mrdc_Request.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((codebookTypeRequest_r16 != null), "optbit");
            buffer.encodeBit ((uplinkTxSwitchRequest_r16 != null), "optbit");
            if (codebookTypeRequest_r16 != null) {
               codebookTypeRequest_r16.encode (buffer);
            }
            if (uplinkTxSwitchRequest_r16 != null) {
               uplinkTxSwitchRequest_r16.encode (buffer);
            }
