...
public class HandoverCommand_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (handoverCommandMessage != null) {
         buffer.getContext().eventDispatcher.startElement("handoverCommandMessage", -1);

         Asn1OctetString handoverCommandMessage_outer;
         {
            Asn1PerEncodeBuffer savedBuffer = buffer;
            buffer = new Asn1PerEncodeBuffer(buffer.isAligned());
            handoverCommandMessage.encode (buffer);
            handoverCommandMessage_outer = new Asn1OctetString(buffer.getMsgCopy() );
            buffer = savedBuffer;
         }
         handoverCommandMessage_outer.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("handoverCommandMessage", -1);
      }
      else throw new Asn1MissingRequiredException ("handoverCommandMessage");
