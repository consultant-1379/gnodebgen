...
public class SRS_SpatialRelationInfo_referenceSignal extends Asn1Choice {
   ...
   public SRS_SpatialRelationInfo_referenceSignal () {
      super();
   }

   public SRS_SpatialRelationInfo_referenceSignal (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_srs (SRS_SpatialRelationInfo_referenceSignal_srs value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // srs
         case 2: { 
            SRS_SpatialRelationInfo_referenceSignal_srs srs;
            element = srs = new SRS_SpatialRelationInfo_referenceSignal_srs();
            srs.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // srs
         case _SRS:
            SRS_SpatialRelationInfo_referenceSignal_srs srs = (SRS_SpatialRelationInfo_referenceSignal_srs) element;
            srs.encode (buffer);
            break;
