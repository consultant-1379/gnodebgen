...
public class FrequencyInfoDL_SIB_scs_SpecificCarrierList extends Asn1SeqOf {
   ...
   public FrequencyInfoDL_SIB_scs_SpecificCarrierList () {
      elements = null;
   }
    ...
    * populated.
    */
   public FrequencyInfoDL_SIB_scs_SpecificCarrierList (int numRecords) {
    ...
    * given the array.  
    */
   public FrequencyInfoDL_SIB_scs_SpecificCarrierList (SCS_SpecificCarrier[] elements_) {
      elements = elements_;
   }
