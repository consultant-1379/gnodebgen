...
public class PUCCH_ResourceSet extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((maxPayloadSize != null), null);

      // encode pucch_ResourceSetId

      if (pucch_ResourceSetId != null) {
         buffer.getContext().eventDispatcher.startElement("pucch_ResourceSetId", -1);

         pucch_ResourceSetId.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pucch_ResourceSetId", -1);
      }
      else throw new Asn1MissingRequiredException ("pucch_ResourceSetId");
      ...
      if (resourceList != null) {
         ...
         resourceList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("resourceList", -1);
      }
      else throw new Asn1MissingRequiredException ("resourceList");

      // encode maxPayloadSize

      if (maxPayloadSize != null) {
         buffer.getContext().eventDispatcher.startElement("maxPayloadSize", -1);

         maxPayloadSize.encode (buffer, 4, 256);
