...
public class InterFreqCAG_CellListPerPLMN_r16_cag_CellList_r16 extends Asn1SeqOf {
   ...
   public PCI_Range[] elements;

   public InterFreqCAG_CellListPerPLMN_r16_cag_CellList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCAG_CellListPerPLMN_r16_cag_CellList_r16 (int numRecords) {
      elements = new PCI_Range [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqCAG_CellListPerPLMN_r16_cag_CellList_r16 (PCI_Range[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PCI_Range [numElements];
