...
public class SL_ScheduledConfig_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((mac_MainConfigSL_r16 != null), null);
      buffer.encodeBit ((sl_CS_RNTI_r16 != null), null);
      buffer.encodeBit ((sl_PSFCH_ToPUCCH_r16 != null), null);
      buffer.encodeBit ((sl_ConfiguredGrantConfigList_r16 != null), null);
      ...
      if (sl_RNTI_r16 != null) {
         ...
         sl_RNTI_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_RNTI_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("sl_RNTI_r16");

      // encode mac_MainConfigSL_r16

      if (mac_MainConfigSL_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("mac_MainConfigSL_r16", -1);

         mac_MainConfigSL_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("mac_MainConfigSL_r16", -1);
      }

      // encode sl_CS_RNTI_r16

      if (sl_CS_RNTI_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_CS_RNTI_r16", -1);

         sl_CS_RNTI_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_CS_RNTI_r16", -1);
      }

      // encode sl_PSFCH_ToPUCCH_r16

      if (sl_PSFCH_ToPUCCH_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_PSFCH_ToPUCCH_r16", -1);

         sl_PSFCH_ToPUCCH_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_PSFCH_ToPUCCH_r16", -1);
      }

      // encode sl_ConfiguredGrantConfigList_r16

      if (sl_ConfiguredGrantConfigList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_ConfiguredGrantConfigList_r16", -1);

         sl_ConfiguredGrantConfigList_r16.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((sl_DCI_ToSL_Trans_r16 != null), "optbit");
            if (sl_DCI_ToSL_Trans_r16 != null) {
               sl_DCI_ToSL_Trans_r16.encode (buffer);
            }
