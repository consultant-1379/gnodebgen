...
public class MeasAndMobParametersMRDC_Common_v1610 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((condPSCellChangeParametersCommon_r16 != null), null);
      buffer.encodeBit ((pscellT312_r16 != null), null);

      // encode condPSCellChangeParametersCommon_r16

      if (condPSCellChangeParametersCommon_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("condPSCellChangeParametersCommon_r16", -1);

         condPSCellChangeParametersCommon_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("condPSCellChangeParametersCommon_r16", -1);
      }

      // encode pscellT312_r16

      if (pscellT312_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("pscellT312_r16", -1);

         pscellT312_r16.encode (buffer);
