...
public class CA_ParametersNR_v1610_pdcch_BlindDetectionSCG_UE_Mixed_r16 extends Asn1Seq {
   ...
   public void encode (Asn1PerEncodeBuffer buffer)
      throws Asn1Exception, java.io.IOException
   {
      // encode pdcch_BlindDetectionSCG_UE1_r16

      if (pdcch_BlindDetectionSCG_UE1_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_BlindDetectionSCG_UE1_r16", -1);

         pdcch_BlindDetectionSCG_UE1_r16.encode (buffer, 0, 15);

         buffer.getContext().eventDispatcher.endElement("pdcch_BlindDetectionSCG_UE1_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("pdcch_BlindDetectionSCG_UE1_r16");

      // encode pdcch_BlindDetectionSCG_UE2_r16

      if (pdcch_BlindDetectionSCG_UE2_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_BlindDetectionSCG_UE2_r16", -1);

         pdcch_BlindDetectionSCG_UE2_r16.encode (buffer, 0, 15);

         buffer.getContext().eventDispatcher.endElement("pdcch_BlindDetectionSCG_UE2_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("pdcch_BlindDetectionSCG_UE2_r16");
