...
public class PLMN_RAN_AreaCellList extends Asn1SeqOf {
   ...
   public PLMN_RAN_AreaCell[] elements;

   public PLMN_RAN_AreaCellList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_RAN_AreaCellList (int numRecords) {
      elements = new PLMN_RAN_AreaCell [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMN_RAN_AreaCellList (PLMN_RAN_AreaCell[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PLMN_RAN_AreaCell [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PLMN_RAN_AreaCell();
