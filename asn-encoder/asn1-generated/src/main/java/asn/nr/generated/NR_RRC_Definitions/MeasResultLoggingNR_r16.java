...
public class MeasResultLoggingNR_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((numberOfGoodSSB_r16 != null), null);
      ...
      else throw new Asn1MissingRequiredException ("resultsSSB_Cell_r16");

      // encode numberOfGoodSSB_r16

      if (numberOfGoodSSB_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("numberOfGoodSSB_r16", -1);

         numberOfGoodSSB_r16.encode (buffer, 1, 64);
