...
public class FeatureSets_featureSetsDownlink_v15a0 extends Asn1SeqOf {
   ...
   public FeatureSetDownlink_v15a0[] elements;

   public FeatureSets_featureSetsDownlink_v15a0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSets_featureSetsDownlink_v15a0 (int numRecords) {
      elements = new FeatureSetDownlink_v15a0 [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSets_featureSetsDownlink_v15a0 (FeatureSetDownlink_v15a0[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetDownlink_v15a0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetDownlink_v15a0();
