...
public class EUTRA_MultiBandInfoList extends Asn1SeqOf {
   ...
   public EUTRA_MultiBandInfo[] elements;

   public EUTRA_MultiBandInfoList () {
      elements = null;
   }
    ...
    * populated.
    */
   public EUTRA_MultiBandInfoList (int numRecords) {
      elements = new EUTRA_MultiBandInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public EUTRA_MultiBandInfoList (EUTRA_MultiBandInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EUTRA_MultiBandInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EUTRA_MultiBandInfo();
