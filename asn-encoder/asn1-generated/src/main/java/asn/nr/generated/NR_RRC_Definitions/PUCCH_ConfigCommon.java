...
public class PUCCH_ConfigCommon extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((pucch_ResourceCommon != null), null);
      buffer.encodeBit ((hoppingId != null), null);
      buffer.encodeBit ((p0_nominal != null), null);

      // encode pucch_ResourceCommon

      if (pucch_ResourceCommon != null) {
         buffer.getContext().eventDispatcher.startElement("pucch_ResourceCommon", -1);

         pucch_ResourceCommon.encode (buffer, 0, 15);

         buffer.getContext().eventDispatcher.endElement("pucch_ResourceCommon", -1);
      }

      // encode pucch_GroupHopping

      if (pucch_GroupHopping != null) {
         buffer.getContext().eventDispatcher.startElement("pucch_GroupHopping", -1);

         pucch_GroupHopping.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pucch_GroupHopping", -1);
      }
      else throw new Asn1MissingRequiredException ("pucch_GroupHopping");
      ...
      if (hoppingId != null) {
         ...
         hoppingId.encode (buffer, 0, 1023);
      ...
      if (p0_nominal != null) {
         ...
         p0_nominal.encode (buffer, -202, 24);
