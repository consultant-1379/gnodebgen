...
public class SL_MappedQoS_FlowsListDedicated_r16_sl_MappedQoS_FlowsToReleaseList_16 extends Asn1SeqOf {
   ...
   public SL_QoS_FlowIdentity_r16[] elements;

   public SL_MappedQoS_FlowsListDedicated_r16_sl_MappedQoS_FlowsToReleaseList_16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_MappedQoS_FlowsListDedicated_r16_sl_MappedQoS_FlowsToReleaseList_16 (int numRecords) {
      elements = new SL_QoS_FlowIdentity_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_MappedQoS_FlowsListDedicated_r16_sl_MappedQoS_FlowsToReleaseList_16 (SL_QoS_FlowIdentity_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 2048);
      int numElements = (int) buffer.decodeLength();

      elements = new SL_QoS_FlowIdentity_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_QoS_FlowIdentity_r16();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 2048);
