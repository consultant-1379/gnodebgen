...
public class FreqBandList extends Asn1SeqOf {
   ...
   public FreqBandInformation[] elements;
    ...
    * populated.
    */
   public FreqBandList (int numRecords) {
      elements = new FreqBandInformation [numRecords];
   }
    ...
    * given the array.  
    */
   public FreqBandList (FreqBandInformation[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 1280);
      int numElements = (int) buffer.decodeLength();

      elements = new FreqBandInformation [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqBandInformation();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 1280);
