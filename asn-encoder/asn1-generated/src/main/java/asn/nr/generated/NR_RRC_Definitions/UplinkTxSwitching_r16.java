...
public class UplinkTxSwitching_r16 extends Asn1Seq {
   ...
   public void encode (Asn1PerEncodeBuffer buffer)
      throws Asn1Exception, java.io.IOException
   {
      // encode uplinkTxSwitchingPeriodLocation_r16

      if (uplinkTxSwitchingPeriodLocation_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("uplinkTxSwitchingPeriodLocation_r16", -1);

         uplinkTxSwitchingPeriodLocation_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("uplinkTxSwitchingPeriodLocation_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("uplinkTxSwitchingPeriodLocation_r16");

      // encode uplinkTxSwitchingCarrier_r16

      if (uplinkTxSwitchingCarrier_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("uplinkTxSwitchingCarrier_r16", -1);

         uplinkTxSwitchingCarrier_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("uplinkTxSwitchingCarrier_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("uplinkTxSwitchingCarrier_r16");
