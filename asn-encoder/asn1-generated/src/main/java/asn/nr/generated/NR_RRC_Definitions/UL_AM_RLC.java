...
public class UL_AM_RLC extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (t_PollRetransmit != null) {
         buffer.getContext().eventDispatcher.startElement("t_PollRetransmit", -1);

         t_PollRetransmit.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("t_PollRetransmit", -1);
      }
      else throw new Asn1MissingRequiredException ("t_PollRetransmit");
      ...
      if (pollPDU != null) {
         ...
         pollPDU.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pollPDU", -1);
      }
      else throw new Asn1MissingRequiredException ("pollPDU");
      ...
      if (pollByte != null) {
         ...
         pollByte.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pollByte", -1);
      }
      else throw new Asn1MissingRequiredException ("pollByte");
      ...
      if (maxRetxThreshold != null) {
         ...
         maxRetxThreshold.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("maxRetxThreshold", -1);
      }
      else throw new Asn1MissingRequiredException ("maxRetxThreshold");
