...
public class SchedulingRequestResourceConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((resource != null), null);

      // encode schedulingRequestResourceId

      if (schedulingRequestResourceId != null) {
         buffer.getContext().eventDispatcher.startElement("schedulingRequestResourceId", -1);

         schedulingRequestResourceId.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("schedulingRequestResourceId", -1);
      }
      else throw new Asn1MissingRequiredException ("schedulingRequestResourceId");
      ...
      else throw new Asn1MissingRequiredException ("schedulingRequestID");
