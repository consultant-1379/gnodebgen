...
public class PerRAInfoList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PerRAInfoList-r16";
   }

   public PerRAInfo_r16[] elements;

   public PerRAInfoList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PerRAInfoList_r16 (int numRecords) {
      elements = new PerRAInfo_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PerRAInfoList_r16 (PerRAInfo_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PerRAInfo_r16 [numElements];
