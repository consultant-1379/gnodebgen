...
public class MeasObjectNR_rmtc_Config_r16 extends Asn1Choice {
   ...
   public MeasObjectNR_rmtc_Config_r16 () {
      super();
   }

   public MeasObjectNR_rmtc_Config_r16 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (RMTC_Config_r16 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            RMTC_Config_r16 setup;
            element = setup = new RMTC_Config_r16();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            RMTC_Config_r16 setup = (RMTC_Config_r16) element;
            setup.encode (buffer);
            break;
