...
public class CodebookConfig_r16_codebookType_type2_subType_typeII_r16_n1_n2_codebookSubsetRestriction_r16 extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // two_one
         case _TWO_ONE:
            Asn1BitString two_one = (Asn1BitString) element;
            two_one.encode (buffer, 16, 16);
            break;

         // two_two
         case _TWO_TWO:
            Asn1BitString two_two = (Asn1BitString) element;
            two_two.encode (buffer, 43, 43);
            break;

         // four_one
         case _FOUR_ONE:
            Asn1BitString four_one = (Asn1BitString) element;
            four_one.encode (buffer, 32, 32);
            break;

         // three_two
         case _THREE_TWO:
            Asn1BitString three_two = (Asn1BitString) element;
            three_two.encode (buffer, 59, 59);
            break;

         // six_one
         case _SIX_ONE:
            Asn1BitString six_one = (Asn1BitString) element;
            six_one.encode (buffer, 48, 48);
            break;

         // four_two
         case _FOUR_TWO:
            Asn1BitString four_two = (Asn1BitString) element;
            four_two.encode (buffer, 75, 75);
            break;

         // eight_one
         case _EIGHT_ONE:
            Asn1BitString eight_one = (Asn1BitString) element;
            eight_one.encode (buffer, 64, 64);
            break;

         // four_three
         case _FOUR_THREE:
            Asn1BitString four_three = (Asn1BitString) element;
            four_three.encode (buffer, 107, 107);
            break;

         // six_two
         case _SIX_TWO:
            Asn1BitString six_two = (Asn1BitString) element;
            six_two.encode (buffer, 107, 107);
            break;

         // twelve_one
         case _TWELVE_ONE:
            Asn1BitString twelve_one = (Asn1BitString) element;
            twelve_one.encode (buffer, 96, 96);
            break;

         // four_four
         case _FOUR_FOUR:
            Asn1BitString four_four = (Asn1BitString) element;
            four_four.encode (buffer, 139, 139);
            break;

         // eight_two
         case _EIGHT_TWO:
            Asn1BitString eight_two = (Asn1BitString) element;
            eight_two.encode (buffer, 139, 139);
            break;

         // sixteen_one
         case _SIXTEEN_ONE:
            Asn1BitString sixteen_one = (Asn1BitString) element;
            sixteen_one.encode (buffer, 128, 128);
            break;
