...
public class PUCCH_Config_resourceToReleaseList extends Asn1SeqOf {
   ...
   public PUCCH_Config_resourceToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_resourceToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public PUCCH_Config_resourceToReleaseList (PUCCH_ResourceId[] elements_) {
      elements = elements_;
   }
