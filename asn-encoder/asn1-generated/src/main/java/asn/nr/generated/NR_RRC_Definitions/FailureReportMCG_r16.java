...
public class FailureReportMCG_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((failureType_r16 != null), null);
      buffer.encodeBit ((measResultFreqList_r16 != null), null);
      buffer.encodeBit ((measResultFreqListEUTRA_r16 != null), null);
      buffer.encodeBit ((measResultSCG_r16 != null), null);
      buffer.encodeBit ((measResultSCG_EUTRA_r16 != null), null);
      buffer.encodeBit ((measResultFreqListUTRA_FDD_r16 != null), null);
      ...
      // encode measResultFreqList_r16

      if (measResultFreqList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("measResultFreqList_r16", -1);

         measResultFreqList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("measResultFreqList_r16", -1);
      }

      // encode measResultFreqListEUTRA_r16

      if (measResultFreqListEUTRA_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("measResultFreqListEUTRA_r16", -1);

         measResultFreqListEUTRA_r16.encode (buffer);
      ...
      // encode measResultFreqListUTRA_FDD_r16

      if (measResultFreqListUTRA_FDD_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("measResultFreqListUTRA_FDD_r16", -1);

         measResultFreqListUTRA_FDD_r16.encode (buffer);
