...
public class UE_MRDC_Capability_v1560 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((measAndMobParametersMRDC_v1560 != null), null);
      buffer.encodeBit ((fdd_Add_UE_MRDC_Capabilities_v1560 != null), null);
      buffer.encodeBit ((tdd_Add_UE_MRDC_Capabilities_v1560 != null), null);
      ...
      // encode measAndMobParametersMRDC_v1560

      if (measAndMobParametersMRDC_v1560 != null) {
         buffer.getContext().eventDispatcher.startElement("measAndMobParametersMRDC_v1560", -1);

         measAndMobParametersMRDC_v1560.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("measAndMobParametersMRDC_v1560", -1);
      }

      // encode fdd_Add_UE_MRDC_Capabilities_v1560

      if (fdd_Add_UE_MRDC_Capabilities_v1560 != null) {
         buffer.getContext().eventDispatcher.startElement("fdd_Add_UE_MRDC_Capabilities_v1560", -1);

         fdd_Add_UE_MRDC_Capabilities_v1560.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("fdd_Add_UE_MRDC_Capabilities_v1560", -1);
      }

      // encode tdd_Add_UE_MRDC_Capabilities_v1560

      if (tdd_Add_UE_MRDC_Capabilities_v1560 != null) {
         buffer.getContext().eventDispatcher.startElement("tdd_Add_UE_MRDC_Capabilities_v1560", -1);

         tdd_Add_UE_MRDC_Capabilities_v1560.encode (buffer);
