...
public class TDD_UL_DL_Pattern extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // encode dl_UL_TransmissionPeriodicity

      if (dl_UL_TransmissionPeriodicity != null) {
         buffer.getContext().eventDispatcher.startElement("dl_UL_TransmissionPeriodicity", -1);

         dl_UL_TransmissionPeriodicity.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("dl_UL_TransmissionPeriodicity", -1);
      }
      else throw new Asn1MissingRequiredException ("dl_UL_TransmissionPeriodicity");

      // encode nrofDownlinkSlots

      if (nrofDownlinkSlots != null) {
         buffer.getContext().eventDispatcher.startElement("nrofDownlinkSlots", -1);

         nrofDownlinkSlots.encode (buffer, 0, 320);

         buffer.getContext().eventDispatcher.endElement("nrofDownlinkSlots", -1);
      }
      else throw new Asn1MissingRequiredException ("nrofDownlinkSlots");
      ...
      if (nrofDownlinkSymbols != null) {
         ...
         nrofDownlinkSymbols.encode (buffer, 0, 13);

         buffer.getContext().eventDispatcher.endElement("nrofDownlinkSymbols", -1);
      }
      else throw new Asn1MissingRequiredException ("nrofDownlinkSymbols");

      // encode nrofUplinkSlots

      if (nrofUplinkSlots != null) {
         buffer.getContext().eventDispatcher.startElement("nrofUplinkSlots", -1);

         nrofUplinkSlots.encode (buffer, 0, 320);

         buffer.getContext().eventDispatcher.endElement("nrofUplinkSlots", -1);
      }
      else throw new Asn1MissingRequiredException ("nrofUplinkSlots");
      ...
      if (nrofUplinkSymbols != null) {
         ...
         nrofUplinkSymbols.encode (buffer, 0, 13);

         buffer.getContext().eventDispatcher.endElement("nrofUplinkSymbols", -1);
      }
      else throw new Asn1MissingRequiredException ("nrofUplinkSymbols");
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((dl_UL_TransmissionPeriodicity_v1530 != null), "optbit");
            if (dl_UL_TransmissionPeriodicity_v1530 != null) {
               dl_UL_TransmissionPeriodicity_v1530.encode (buffer);
            }
