...
public class PhysicalCellGroupConfig_cs_RNTI extends Asn1Choice {
   ...
   public PhysicalCellGroupConfig_cs_RNTI () {
      super();
   }

   public PhysicalCellGroupConfig_cs_RNTI (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (RNTI_Value value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            RNTI_Value setup = (RNTI_Value) element;
            setup.encode (buffer);
            break;
