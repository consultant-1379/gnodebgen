...
public class HandoverPreparationInformation_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _HANDOVERPREPARATIONINFORMATION = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public HandoverPreparationInformation_criticalExtensions_c1 () {
      super();
   }

   public HandoverPreparationInformation_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _HANDOVERPREPARATIONINFORMATION: return "handoverPreparationInformation";
   ...
   public void set_handoverPreparationInformation (HandoverPreparationInformation_IEs value) {
      setElement (_HANDOVERPREPARATIONINFORMATION, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            HandoverPreparationInformation_IEs handoverPreparationInformation;
            element = handoverPreparationInformation = new HandoverPreparationInformation_IEs();
            handoverPreparationInformation.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // handoverPreparationInformation
         case _HANDOVERPREPARATIONINFORMATION:
            HandoverPreparationInformation_IEs handoverPreparationInformation = (HandoverPreparationInformation_IEs) element;
            handoverPreparationInformation.encode (buffer);
            break;
