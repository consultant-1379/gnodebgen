...
public class SRS_PeriodicityAndOffset extends Asn1Choice {
   ...
   public SRS_PeriodicityAndOffset () {
      super();
   }

   public SRS_PeriodicityAndOffset (byte choiceId_, Asn1Type element_) {
      super();
