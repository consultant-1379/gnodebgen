...
public class CA_ParametersNRDC_v1630 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((ca_ParametersNR_ForDC_v1610 != null), null);
      buffer.encodeBit ((ca_ParametersNR_ForDC_v1630 != null), null);

      // encode ca_ParametersNR_ForDC_v1610

      if (ca_ParametersNR_ForDC_v1610 != null) {
         buffer.getContext().eventDispatcher.startElement("ca_ParametersNR_ForDC_v1610", -1);

         ca_ParametersNR_ForDC_v1610.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ca_ParametersNR_ForDC_v1610", -1);
      }

      // encode ca_ParametersNR_ForDC_v1630

      if (ca_ParametersNR_ForDC_v1630 != null) {
         buffer.getContext().eventDispatcher.startElement("ca_ParametersNR_ForDC_v1630", -1);

         ca_ParametersNR_ForDC_v1630.encode (buffer);
