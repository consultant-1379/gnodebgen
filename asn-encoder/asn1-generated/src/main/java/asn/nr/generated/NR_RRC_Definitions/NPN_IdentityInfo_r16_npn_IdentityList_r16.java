...
public class NPN_IdentityInfo_r16_npn_IdentityList_r16 extends Asn1SeqOf {
   ...
   public NPN_Identity_r16[] elements;

   public NPN_IdentityInfo_r16_npn_IdentityList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NPN_IdentityInfo_r16_npn_IdentityList_r16 (int numRecords) {
      elements = new NPN_Identity_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public NPN_IdentityInfo_r16_npn_IdentityList_r16 (NPN_Identity_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NPN_Identity_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NPN_Identity_r16();
