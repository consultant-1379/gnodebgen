...
public class SRS_ResourceSet_resourceType extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // aperiodic
         case _APERIODIC:
            SRS_ResourceSet_resourceType_aperiodic aperiodic = (SRS_ResourceSet_resourceType_aperiodic) element;
            aperiodic.encode (buffer);
            break;

         // semi_persistent
         case _SEMI_PERSISTENT:
            SRS_ResourceSet_resourceType_semi_persistent semi_persistent = (SRS_ResourceSet_resourceType_semi_persistent) element;
            semi_persistent.encode (buffer);
            break;

         // periodic
         case _PERIODIC:
            SRS_ResourceSet_resourceType_periodic periodic = (SRS_ResourceSet_resourceType_periodic) element;
