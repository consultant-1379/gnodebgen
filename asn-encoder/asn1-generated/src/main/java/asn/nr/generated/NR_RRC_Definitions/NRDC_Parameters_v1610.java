...
public class NRDC_Parameters_v1610 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((measAndMobParametersNRDC_v1610 != null), null);

      // encode measAndMobParametersNRDC_v1610

      if (measAndMobParametersNRDC_v1610 != null) {
         buffer.getContext().eventDispatcher.startElement("measAndMobParametersNRDC_v1610", -1);

         measAndMobParametersNRDC_v1610.encode (buffer);
