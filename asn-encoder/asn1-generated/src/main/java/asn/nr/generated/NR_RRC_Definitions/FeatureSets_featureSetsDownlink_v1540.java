...
public class FeatureSets_featureSetsDownlink_v1540 extends Asn1SeqOf {
   ...
   public FeatureSetDownlink_v1540[] elements;

   public FeatureSets_featureSetsDownlink_v1540 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSets_featureSetsDownlink_v1540 (int numRecords) {
      elements = new FeatureSetDownlink_v1540 [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSets_featureSetsDownlink_v1540 (FeatureSetDownlink_v1540[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetDownlink_v1540 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetDownlink_v1540();
