...
public class FreqPriorityListNR extends Asn1SeqOf {
   ...
   public FreqPriorityNR[] elements;

   public FreqPriorityListNR () {
      elements = null;
   }
    ...
    * populated.
    */
   public FreqPriorityListNR (int numRecords) {
      elements = new FreqPriorityNR [numRecords];
   }
    ...
    * given the array.  
    */
   public FreqPriorityListNR (FreqPriorityNR[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqPriorityNR [numElements];
