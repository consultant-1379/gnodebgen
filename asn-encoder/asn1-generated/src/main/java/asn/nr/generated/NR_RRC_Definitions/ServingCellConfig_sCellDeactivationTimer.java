...
public class ServingCellConfig_sCellDeactivationTimer extends Asn1Enumerated {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch ((int)value) {
         ...
         case 4: ui = 4; /* ms200 */break;
         case 5: ui = 5; /* ms240 */break;
         case 6: ui = 6; /* ms320 */break;
         case 7: ui = 7; /* ms400 */break;
         case 8: ui = 8; /* ms480 */break;
         case 9: ui = 9; /* ms520 */break;
         case 10: ui = 10; /* ms640 */break;
         case 11: ui = 11; /* ms720 */break;
         case 12: ui = 12; /* ms840 */break;
