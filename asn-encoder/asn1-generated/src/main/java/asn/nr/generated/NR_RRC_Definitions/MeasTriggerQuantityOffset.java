...
public class MeasTriggerQuantityOffset extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // rsrp
         case _RSRP:
            Asn1Integer rsrp = (Asn1Integer) element;
            rsrp.encode (buffer, -30, 30);
            break;

         // rsrq
         case _RSRQ:
            Asn1Integer rsrq = (Asn1Integer) element;
            rsrq.encode (buffer, -30, 30);
            break;

         // sinr
         case _SINR:
            Asn1Integer sinr = (Asn1Integer) element;
            sinr.encode (buffer, -30, 30);
            break;
