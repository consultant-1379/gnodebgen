...
public class SchedulingRequestResourceConfig_periodicityAndOffset extends Asn1Choice {
   ...
   public final static byte _SYM2 = 1;
   public final static byte _SYM6OR7 = 2;
   public final static byte _SL1 = 3;
   public final static byte _SL2 = 4;
   public final static byte _SL4 = 5;
   public final static byte _SL5 = 6;
   public final static byte _SL8 = 7;
   public final static byte _SL10 = 8;
   public final static byte _SL16 = 9;
   public final static byte _SL20 = 10;
   public final static byte _SL40 = 11;
   ...
   public SchedulingRequestResourceConfig_periodicityAndOffset () {
      super();
   }

   public SchedulingRequestResourceConfig_periodicityAndOffset (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _SYM2: return "sym2";
      case _SYM6OR7: return "sym6or7";
   ...
   public void set_sym2 () {
      setElement (_SYM2, Asn1Null.NULL_VALUE);
   }

   public void set_sym6or7 () {
      setElement (_SYM6OR7, Asn1Null.NULL_VALUE);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            Asn1Null sym2;
            element = sym2 = Asn1Null.NULL_VALUE;
            sym2.decode (buffer);

            buffer.invokeCharacters(sym2.toString());
            break;
         }
         ...
         case 1: { 
            Asn1Null sym6or7;
            element = sym6or7 = Asn1Null.NULL_VALUE;
            sym6or7.decode (buffer);

            buffer.invokeCharacters(sym6or7.toString());
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // sym2
         case _SYM2:
            Asn1Null sym2 = (Asn1Null) element;
            sym2.encode (buffer);
            break;

         // sym6or7
         case _SYM6OR7:
            Asn1Null sym6or7 = (Asn1Null) element;
            sym6or7.encode (buffer);
            break;
