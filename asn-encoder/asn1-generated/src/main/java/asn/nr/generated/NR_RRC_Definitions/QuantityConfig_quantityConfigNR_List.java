...
public class QuantityConfig_quantityConfigNR_List extends Asn1SeqOf {
   ...
   public QuantityConfigNR[] elements;

   public QuantityConfig_quantityConfigNR_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public QuantityConfig_quantityConfigNR_List (int numRecords) {
      elements = new QuantityConfigNR [numRecords];
   }
    ...
    * given the array.  
    */
   public QuantityConfig_quantityConfigNR_List (QuantityConfigNR[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new QuantityConfigNR [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new QuantityConfigNR();
