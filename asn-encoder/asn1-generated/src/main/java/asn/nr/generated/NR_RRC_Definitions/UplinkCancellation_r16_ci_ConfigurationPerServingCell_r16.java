...
public class UplinkCancellation_r16_ci_ConfigurationPerServingCell_r16 extends Asn1SeqOf {
   ...
   public CI_ConfigurationPerServingCell_r16[] elements;

   public UplinkCancellation_r16_ci_ConfigurationPerServingCell_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UplinkCancellation_r16_ci_ConfigurationPerServingCell_r16 (int numRecords) {
      elements = new CI_ConfigurationPerServingCell_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public UplinkCancellation_r16_ci_ConfigurationPerServingCell_r16 (CI_ConfigurationPerServingCell_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CI_ConfigurationPerServingCell_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CI_ConfigurationPerServingCell_r16();
