...
public class LogicalChannelConfig_ul_SpecificParameters_allowedServingCells extends Asn1SeqOf {
   ...
   public LogicalChannelConfig_ul_SpecificParameters_allowedServingCells () {
      elements = null;
   }
    ...
    * populated.
    */
   public LogicalChannelConfig_ul_SpecificParameters_allowedServingCells (int numRecords) {
    ...
    * given the array.  
    */
   public LogicalChannelConfig_ul_SpecificParameters_allowedServingCells (ServCellIndex[] elements_) {
      elements = elements_;
   }
