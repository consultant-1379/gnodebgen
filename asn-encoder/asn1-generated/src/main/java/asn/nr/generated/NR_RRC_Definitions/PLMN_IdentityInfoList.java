...
public class PLMN_IdentityInfoList extends Asn1SeqOf {
   ...
   public PLMN_IdentityInfo[] elements;

   public PLMN_IdentityInfoList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_IdentityInfoList (int numRecords) {
      elements = new PLMN_IdentityInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMN_IdentityInfoList (PLMN_IdentityInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PLMN_IdentityInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PLMN_IdentityInfo();
