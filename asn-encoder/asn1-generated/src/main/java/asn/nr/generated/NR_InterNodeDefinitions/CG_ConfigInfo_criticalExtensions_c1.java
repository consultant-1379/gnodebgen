...
public class CG_ConfigInfo_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _CG_CONFIGINFO = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public CG_ConfigInfo_criticalExtensions_c1 () {
      super();
   }

   public CG_ConfigInfo_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _CG_CONFIGINFO: return "cg_ConfigInfo";
   ...
   public void set_cg_ConfigInfo (CG_ConfigInfo_IEs value) {
      setElement (_CG_CONFIGINFO, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         // cg_ConfigInfo
         case 0: { 
            CG_ConfigInfo_IEs cg_ConfigInfo;
            element = cg_ConfigInfo = new CG_ConfigInfo_IEs();
            cg_ConfigInfo.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // cg_ConfigInfo
         case _CG_CONFIGINFO:
            CG_ConfigInfo_IEs cg_ConfigInfo = (CG_ConfigInfo_IEs) element;
            cg_ConfigInfo.encode (buffer);
            break;
