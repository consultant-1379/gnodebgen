...
public class PTRS_DownlinkConfig_frequencyDensity extends Asn1SeqOf {
   ...
   public PTRS_DownlinkConfig_frequencyDensity () {
      elements = null;
   }
    ...
    * populated.
    */
   public PTRS_DownlinkConfig_frequencyDensity (int numRecords) {
    ...
    * given the array.  
    */
   public PTRS_DownlinkConfig_frequencyDensity (Asn1Integer[] elements_) {
      elements = elements_;
   }
