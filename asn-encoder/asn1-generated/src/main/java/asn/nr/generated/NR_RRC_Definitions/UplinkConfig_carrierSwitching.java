...
public class UplinkConfig_carrierSwitching extends Asn1Choice {
   ...
   public UplinkConfig_carrierSwitching () {
      super();
   }

   public UplinkConfig_carrierSwitching (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SRS_CarrierSwitching value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            SRS_CarrierSwitching setup;
            element = setup = new SRS_CarrierSwitching();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            SRS_CarrierSwitching setup = (SRS_CarrierSwitching) element;
            setup.encode (buffer);
            break;
