...
public class UL_CCCH1_MessageType_c1 extends Asn1Choice {
   ...
   public final static byte _RRCRESUMEREQUEST1 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public UL_CCCH1_MessageType_c1 () {
      super();
   }

   public UL_CCCH1_MessageType_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _RRCRESUMEREQUEST1: return "rrcResumeRequest1";
   ...
   public void set_rrcResumeRequest1 (RRCResumeRequest1 value) {
      setElement (_RRCRESUMEREQUEST1, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            element = rrcResumeRequest1 = new RRCResumeRequest1();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // rrcResumeRequest1
         case _RRCRESUMEREQUEST1:
            RRCResumeRequest1 rrcResumeRequest1 = (RRCResumeRequest1) element;
