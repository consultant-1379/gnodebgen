...
public class SIB2_cellReselectionServingFreqInfo extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((s_NonIntraSearchP != null), null);
      buffer.encodeBit ((s_NonIntraSearchQ != null), null);
      buffer.encodeBit ((threshServingLowQ != null), null);
      buffer.encodeBit ((cellReselectionSubPriority != null), null);

      // encode s_NonIntraSearchP

      if (s_NonIntraSearchP != null) {
         buffer.getContext().eventDispatcher.startElement("s_NonIntraSearchP", -1);

         s_NonIntraSearchP.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("s_NonIntraSearchP", -1);
      }

      // encode s_NonIntraSearchQ

      if (s_NonIntraSearchQ != null) {
         buffer.getContext().eventDispatcher.startElement("s_NonIntraSearchQ", -1);

         s_NonIntraSearchQ.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("s_NonIntraSearchQ", -1);
      }

      // encode threshServingLowP

      if (threshServingLowP != null) {
         buffer.getContext().eventDispatcher.startElement("threshServingLowP", -1);

         threshServingLowP.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("threshServingLowP", -1);
      }
      else throw new Asn1MissingRequiredException ("threshServingLowP");

      // encode threshServingLowQ

      if (threshServingLowQ != null) {
         buffer.getContext().eventDispatcher.startElement("threshServingLowQ", -1);

         threshServingLowQ.encode (buffer);
      ...
      else throw new Asn1MissingRequiredException ("cellReselectionPriority");
