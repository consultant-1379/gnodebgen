...
public class FeatureSetsPerBand extends Asn1SeqOf {
   ...
   public FeatureSet[] elements;

   public FeatureSetsPerBand () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSetsPerBand (int numRecords) {
      elements = new FeatureSet [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSetsPerBand (FeatureSet[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSet [numElements];
