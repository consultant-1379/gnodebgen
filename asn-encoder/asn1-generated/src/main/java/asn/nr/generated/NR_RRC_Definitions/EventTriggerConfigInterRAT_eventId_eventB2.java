...
public class EventTriggerConfigInterRAT_eventId_eventB2 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (b2_Threshold1 != null) {
         buffer.getContext().eventDispatcher.startElement("b2_Threshold1", -1);

         b2_Threshold1.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("b2_Threshold1", -1);
      }
      else throw new Asn1MissingRequiredException ("b2_Threshold1");

      // encode b2_Threshold2EUTRA

      if (b2_Threshold2EUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("b2_Threshold2EUTRA", -1);

         b2_Threshold2EUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("b2_Threshold2EUTRA", -1);
      }
      else throw new Asn1MissingRequiredException ("b2_Threshold2EUTRA");
