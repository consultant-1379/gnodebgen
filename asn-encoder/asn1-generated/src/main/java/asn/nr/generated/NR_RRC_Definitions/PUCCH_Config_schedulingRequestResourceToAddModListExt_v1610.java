...
public class PUCCH_Config_schedulingRequestResourceToAddModListExt_v1610 extends Asn1SeqOf {
   ...
   public SchedulingRequestResourceConfigExt_v1610[] elements;

   public PUCCH_Config_schedulingRequestResourceToAddModListExt_v1610 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_schedulingRequestResourceToAddModListExt_v1610 (int numRecords) {
      elements = new SchedulingRequestResourceConfigExt_v1610 [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_Config_schedulingRequestResourceToAddModListExt_v1610 (SchedulingRequestResourceConfigExt_v1610[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SchedulingRequestResourceConfigExt_v1610 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SchedulingRequestResourceConfigExt_v1610();
