...
public class PUCCH_MaxCodeRate extends Asn1Enumerated {
      ...
      throws Asn1Exception, java.io.IOException
   {
      int ui;  // enum index
      switch ((int)value) {
         case 0: ui = 0; /* zeroDot08 */break;
         case 1: ui = 1; /* zeroDot15 */break;
         case 2: ui = 2; /* zeroDot25 */break;
         case 3: ui = 3; /* zeroDot35 */break;
         case 4: ui = 4; /* zeroDot45 */break;
         case 5: ui = 5; /* zeroDot60 */break;
         case 6: ui = 6; /* zeroDot80 */break;
         default:
