...
public class PUSCH_Config_frequencyHoppingOffsetLists extends Asn1SeqOf {
   ...
   public PUSCH_Config_frequencyHoppingOffsetLists () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUSCH_Config_frequencyHoppingOffsetLists (int numRecords) {
    ...
    * given the array.  
    */
   public PUSCH_Config_frequencyHoppingOffsetLists (Asn1Integer[] elements_) {
      elements = elements_;
   }
