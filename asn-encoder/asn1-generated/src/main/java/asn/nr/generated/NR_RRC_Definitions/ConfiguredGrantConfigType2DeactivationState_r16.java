...
public class ConfiguredGrantConfigType2DeactivationState_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ConfiguredGrantConfigType2DeactivationState-r16";
   }

   public ConfiguredGrantConfigIndex_r16[] elements;

   public ConfiguredGrantConfigType2DeactivationState_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ConfiguredGrantConfigType2DeactivationState_r16 (int numRecords) {
      elements = new ConfiguredGrantConfigIndex_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public ConfiguredGrantConfigType2DeactivationState_r16 (ConfiguredGrantConfigIndex_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 12);
      int numElements = (int) buffer.decodeLength();

      elements = new ConfiguredGrantConfigIndex_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ConfiguredGrantConfigIndex_r16();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 12);
