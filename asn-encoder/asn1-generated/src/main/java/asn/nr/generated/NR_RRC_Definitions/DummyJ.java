...
public class DummyJ extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // encode maxEnergyDetectionThreshold_r16

      if (maxEnergyDetectionThreshold_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("maxEnergyDetectionThreshold_r16", -1);
      ...
      else throw new Asn1MissingRequiredException ("maxEnergyDetectionThreshold_r16");

      // encode energyDetectionThresholdOffset_r16

      if (energyDetectionThresholdOffset_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("energyDetectionThresholdOffset_r16", -1);

         energyDetectionThresholdOffset_r16.encode (buffer, -20, -13);

         buffer.getContext().eventDispatcher.endElement("energyDetectionThresholdOffset_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("energyDetectionThresholdOffset_r16");
