...
public class SlotFormatCombinationsPerCell extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((subcarrierSpacing2 != null), null);
      buffer.encodeBit ((slotFormatCombinations != null), null);
      buffer.encodeBit ((positionInDCI != null), null);
      ...
      // encode subcarrierSpacing

      if (subcarrierSpacing != null) {
         buffer.getContext().eventDispatcher.startElement("subcarrierSpacing", -1);

         subcarrierSpacing.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("subcarrierSpacing", -1);
      }
      else throw new Asn1MissingRequiredException ("subcarrierSpacing");

      // encode subcarrierSpacing2

      if (subcarrierSpacing2 != null) {
         buffer.getContext().eventDispatcher.startElement("subcarrierSpacing2", -1);

         subcarrierSpacing2.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("subcarrierSpacing2", -1);
      }

      // encode slotFormatCombinations

      if (slotFormatCombinations != null) {
         buffer.getContext().eventDispatcher.startElement("slotFormatCombinations", -1);

         slotFormatCombinations.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("slotFormatCombinations", -1);
      }

      // encode positionInDCI

      if (positionInDCI != null) {
         buffer.getContext().eventDispatcher.startElement("positionInDCI", -1);

         positionInDCI.encode (buffer, 0, 127);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((enableConfiguredUL_r16 != null), "optbit");
            if (enableConfiguredUL_r16 != null) {
               enableConfiguredUL_r16.encode (buffer);
            }
