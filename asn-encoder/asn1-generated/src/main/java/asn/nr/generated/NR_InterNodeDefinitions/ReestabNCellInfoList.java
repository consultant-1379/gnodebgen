...
public class ReestabNCellInfoList extends Asn1SeqOf {
   ...
   public ReestabNCellInfo[] elements;

   public ReestabNCellInfoList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ReestabNCellInfoList (int numRecords) {
      elements = new ReestabNCellInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public ReestabNCellInfoList (ReestabNCellInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ReestabNCellInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ReestabNCellInfo();
