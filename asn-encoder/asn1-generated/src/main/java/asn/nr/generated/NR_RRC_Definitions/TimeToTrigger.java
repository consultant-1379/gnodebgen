...
public class TimeToTrigger extends Asn1Enumerated {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch ((int)value) {
         ...
         case 2: ui = 2; /* ms64 */break;
         case 3: ui = 3; /* ms80 */break;
         case 4: ui = 4; /* ms100 */break;
         case 5: ui = 5; /* ms128 */break;
         case 6: ui = 6; /* ms160 */break;
         case 7: ui = 7; /* ms256 */break;
         case 8: ui = 8; /* ms320 */break;
         case 9: ui = 9; /* ms480 */break;
         case 10: ui = 10; /* ms512 */break;
         case 11: ui = 11; /* ms640 */break;
         case 12: ui = 12; /* ms1024 */break;
         case 13: ui = 13; /* ms1280 */break;
         case 14: ui = 14; /* ms2560 */break;
         case 15: ui = 15; /* ms5120 */break;
         default:
