...
public class SupportedCSI_RS_Resource extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // encode maxNumberResourcesPerBand

      if (maxNumberResourcesPerBand != null) {
         buffer.getContext().eventDispatcher.startElement("maxNumberResourcesPerBand", -1);

         maxNumberResourcesPerBand.encode (buffer, 1, 64);

         buffer.getContext().eventDispatcher.endElement("maxNumberResourcesPerBand", -1);
      }
      else throw new Asn1MissingRequiredException ("maxNumberResourcesPerBand");

      // encode totalNumberTxPortsPerBand

      if (totalNumberTxPortsPerBand != null) {
         buffer.getContext().eventDispatcher.startElement("totalNumberTxPortsPerBand", -1);

         totalNumberTxPortsPerBand.encode (buffer, 2, 256);

         buffer.getContext().eventDispatcher.endElement("totalNumberTxPortsPerBand", -1);
      }
      else throw new Asn1MissingRequiredException ("totalNumberTxPortsPerBand");
