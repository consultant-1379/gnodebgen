...
public class MeasResultCLI_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((measResultListSRS_RSRP_r16 != null), null);
      buffer.encodeBit ((measResultListCLI_RSSI_r16 != null), null);

      // encode measResultListSRS_RSRP_r16

      if (measResultListSRS_RSRP_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("measResultListSRS_RSRP_r16", -1);

         measResultListSRS_RSRP_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("measResultListSRS_RSRP_r16", -1);
      }

      // encode measResultListCLI_RSSI_r16

      if (measResultListCLI_RSSI_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("measResultListCLI_RSSI_r16", -1);

         measResultListCLI_RSSI_r16.encode (buffer);
