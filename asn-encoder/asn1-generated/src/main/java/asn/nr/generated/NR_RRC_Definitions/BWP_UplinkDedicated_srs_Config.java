...
public class BWP_UplinkDedicated_srs_Config extends Asn1Choice {
   ...
   public BWP_UplinkDedicated_srs_Config () {
      super();
   }

   public BWP_UplinkDedicated_srs_Config (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SRS_Config value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            SRS_Config setup = (SRS_Config) element;
            setup.encode (buffer);
            break;
