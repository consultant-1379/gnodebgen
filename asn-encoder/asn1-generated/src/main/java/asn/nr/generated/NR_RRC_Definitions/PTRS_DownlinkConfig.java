...
public class PTRS_DownlinkConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((epre_Ratio != null), null);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((maxNrofPorts_r16 != null), "optbit");
            if (maxNrofPorts_r16 != null) {
               maxNrofPorts_r16.encode (buffer);
            }
