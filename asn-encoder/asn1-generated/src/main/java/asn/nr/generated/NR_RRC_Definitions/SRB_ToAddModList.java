...
public class SRB_ToAddModList extends Asn1SeqOf {
    ...
    * populated.
    */
   public SRB_ToAddModList (int numRecords) {
    ...
    * given the array.  
    */
   public SRB_ToAddModList (SRB_ToAddMod[] elements_) {
      elements = elements_;
   }
