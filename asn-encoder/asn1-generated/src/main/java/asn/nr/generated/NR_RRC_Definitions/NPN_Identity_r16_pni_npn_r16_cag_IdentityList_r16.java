...
public class NPN_Identity_r16_pni_npn_r16_cag_IdentityList_r16 extends Asn1SeqOf {
   ...
   public CAG_IdentityInfo_r16[] elements;

   public NPN_Identity_r16_pni_npn_r16_cag_IdentityList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NPN_Identity_r16_pni_npn_r16_cag_IdentityList_r16 (int numRecords) {
      elements = new CAG_IdentityInfo_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public NPN_Identity_r16_pni_npn_r16_cag_IdentityList_r16 (CAG_IdentityInfo_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CAG_IdentityInfo_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CAG_IdentityInfo_r16();
