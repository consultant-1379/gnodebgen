...
public class SearchSpace extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((controlResourceSetId != null), null);
      buffer.encodeBit ((monitoringSlotPeriodicityAndOffset != null), null);
      buffer.encodeBit ((duration != null), null);
      buffer.encodeBit ((monitoringSymbolsWithinSlot != null), null);
      buffer.encodeBit ((nrofCandidates != null), null);
      buffer.encodeBit ((searchSpaceType != null), null);

      // encode searchSpaceId

      if (searchSpaceId != null) {
         buffer.getContext().eventDispatcher.startElement("searchSpaceId", -1);

         searchSpaceId.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("searchSpaceId", -1);
      }
      else throw new Asn1MissingRequiredException ("searchSpaceId");
      ...
      // encode monitoringSlotPeriodicityAndOffset

      if (monitoringSlotPeriodicityAndOffset != null) {
         buffer.getContext().eventDispatcher.startElement("monitoringSlotPeriodicityAndOffset", -1);

         monitoringSlotPeriodicityAndOffset.encode (buffer);
      ...
      if (duration != null) {
         ...
         duration.encode (buffer, 2, 2559);

         buffer.getContext().eventDispatcher.endElement("duration", -1);
      }

      // encode monitoringSymbolsWithinSlot

      if (monitoringSymbolsWithinSlot != null) {
         buffer.getContext().eventDispatcher.startElement("monitoringSymbolsWithinSlot", -1);

         monitoringSymbolsWithinSlot.encode (buffer, 14, 14);

         buffer.getContext().eventDispatcher.endElement("monitoringSymbolsWithinSlot", -1);
      }

      // encode nrofCandidates

      if (nrofCandidates != null) {
         buffer.getContext().eventDispatcher.startElement("nrofCandidates", -1);

         nrofCandidates.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("nrofCandidates", -1);
      }

      // encode searchSpaceType

      if (searchSpaceType != null) {
         buffer.getContext().eventDispatcher.startElement("searchSpaceType", -1);

         searchSpaceType.encode (buffer);
