...
public class SRS_ResourceSet_resourceType_semi_persistent extends Asn1Seq {
   ...
   public SRS_ResourceSet_resourceType_semi_persistent () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SRS_ResourceSet_resourceType_semi_persistent (long associatedCSI_RS_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((associatedCSI_RS != null), null);

      // encode associatedCSI_RS

      if (associatedCSI_RS != null) {
         buffer.getContext().eventDispatcher.startElement("associatedCSI_RS", -1);

         associatedCSI_RS.encode (buffer);
