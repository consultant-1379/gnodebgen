...
public class CA_ParametersNR_v1540 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((simultaneousSRS_AssocCSI_RS_AllCC != null), null);
      buffer.encodeBit ((csi_RS_IM_ReceptionForFeedbackPerBandComb != null), null);
      buffer.encodeBit ((simultaneousCSI_ReportsAllCC != null), null);
      buffer.encodeBit ((dualPA_Architecture != null), null);

      // encode simultaneousSRS_AssocCSI_RS_AllCC

      if (simultaneousSRS_AssocCSI_RS_AllCC != null) {
         buffer.getContext().eventDispatcher.startElement("simultaneousSRS_AssocCSI_RS_AllCC", -1);

         simultaneousSRS_AssocCSI_RS_AllCC.encode (buffer, 5, 32);

         buffer.getContext().eventDispatcher.endElement("simultaneousSRS_AssocCSI_RS_AllCC", -1);
      }

      // encode csi_RS_IM_ReceptionForFeedbackPerBandComb

      if (csi_RS_IM_ReceptionForFeedbackPerBandComb != null) {
         buffer.getContext().eventDispatcher.startElement("csi_RS_IM_ReceptionForFeedbackPerBandComb", -1);

         csi_RS_IM_ReceptionForFeedbackPerBandComb.encode (buffer);
