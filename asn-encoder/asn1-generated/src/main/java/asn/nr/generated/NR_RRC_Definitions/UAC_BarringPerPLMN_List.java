...
public class UAC_BarringPerPLMN_List extends Asn1SeqOf {
   ...
   public UAC_BarringPerPLMN[] elements;

   public UAC_BarringPerPLMN_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public UAC_BarringPerPLMN_List (int numRecords) {
      elements = new UAC_BarringPerPLMN [numRecords];
   }
    ...
    * given the array.  
    */
   public UAC_BarringPerPLMN_List (UAC_BarringPerPLMN[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UAC_BarringPerPLMN [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UAC_BarringPerPLMN();
