...
import asn.nr.generated.NR_RRC_Definitions.MeasResultServFreqListEUTRA_SCG;
...
public class RRM_Config extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((ue_InactiveTime != null), null);
      buffer.encodeBit ((candidateCellInfoList != null), null);

      // encode ue_InactiveTime

      if (ue_InactiveTime != null) {
         buffer.getContext().eventDispatcher.startElement("ue_InactiveTime", -1);

         ue_InactiveTime.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ue_InactiveTime", -1);
      }

      // encode candidateCellInfoList

      if (candidateCellInfoList != null) {
         buffer.getContext().eventDispatcher.startElement("candidateCellInfoList", -1);

         candidateCellInfoList.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((candidateCellInfoListSN_EUTRA != null), "optbit");
