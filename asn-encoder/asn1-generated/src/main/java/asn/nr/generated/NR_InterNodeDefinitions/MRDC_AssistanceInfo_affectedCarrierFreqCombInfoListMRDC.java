...
public class MRDC_AssistanceInfo_affectedCarrierFreqCombInfoListMRDC extends Asn1SeqOf {
   ...
   public AffectedCarrierFreqCombInfoMRDC[] elements;

   public MRDC_AssistanceInfo_affectedCarrierFreqCombInfoListMRDC () {
      elements = null;
   }
    ...
    * populated.
    */
   public MRDC_AssistanceInfo_affectedCarrierFreqCombInfoListMRDC (int numRecords) {
      elements = new AffectedCarrierFreqCombInfoMRDC [numRecords];
   }
    ...
    * given the array.  
    */
   public MRDC_AssistanceInfo_affectedCarrierFreqCombInfoListMRDC (AffectedCarrierFreqCombInfoMRDC[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AffectedCarrierFreqCombInfoMRDC [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AffectedCarrierFreqCombInfoMRDC();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 128);
