...
public class FeatureSets_featureSetsUplink_v1640 extends Asn1SeqOf {
   ...
   public FeatureSetUplink_v1640[] elements;

   public FeatureSets_featureSetsUplink_v1640 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSets_featureSetsUplink_v1640 (int numRecords) {
      elements = new FeatureSetUplink_v1640 [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSets_featureSetsUplink_v1640 (FeatureSetUplink_v1640[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetUplink_v1640 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetUplink_v1640();
