...
public class ReportConfigToAddModList extends Asn1SeqOf {
   ...
   public ReportConfigToAddMod[] elements;

   public ReportConfigToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ReportConfigToAddModList (int numRecords) {
      elements = new ReportConfigToAddMod [numRecords];
   }
    ...
    * given the array.  
    */
   public ReportConfigToAddModList (ReportConfigToAddMod[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ReportConfigToAddMod [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ReportConfigToAddMod();
