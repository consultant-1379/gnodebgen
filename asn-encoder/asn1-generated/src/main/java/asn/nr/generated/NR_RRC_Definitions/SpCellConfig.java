...
public class SpCellConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((servCellIndex != null), null);
      buffer.encodeBit ((reconfigurationWithSync != null), null);
      buffer.encodeBit ((rlf_TimersAndConstants != null), null);
      buffer.encodeBit ((rlmInSyncOutOfSyncThreshold != null), null);
      buffer.encodeBit ((spCellConfigDedicated != null), null);
      ...
      // encode reconfigurationWithSync

      if (reconfigurationWithSync != null) {
         buffer.getContext().eventDispatcher.startElement("reconfigurationWithSync", -1);

         reconfigurationWithSync.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("reconfigurationWithSync", -1);
      }

      // encode rlf_TimersAndConstants

      if (rlf_TimersAndConstants != null) {
         buffer.getContext().eventDispatcher.startElement("rlf_TimersAndConstants", -1);

         rlf_TimersAndConstants.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("rlf_TimersAndConstants", -1);
      }

      // encode rlmInSyncOutOfSyncThreshold

      if (rlmInSyncOutOfSyncThreshold != null) {
         buffer.getContext().eventDispatcher.startElement("rlmInSyncOutOfSyncThreshold", -1);

         rlmInSyncOutOfSyncThreshold.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("rlmInSyncOutOfSyncThreshold", -1);
      }

      // encode spCellConfigDedicated

      if (spCellConfigDedicated != null) {
         buffer.getContext().eventDispatcher.startElement("spCellConfigDedicated", -1);

         spCellConfigDedicated.encode (buffer);
