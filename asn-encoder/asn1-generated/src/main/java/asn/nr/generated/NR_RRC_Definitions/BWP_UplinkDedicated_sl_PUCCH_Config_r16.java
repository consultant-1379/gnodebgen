...
public class BWP_UplinkDedicated_sl_PUCCH_Config_r16 extends Asn1Choice {
   ...
   public BWP_UplinkDedicated_sl_PUCCH_Config_r16 () {
      super();
   }

   public BWP_UplinkDedicated_sl_PUCCH_Config_r16 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (PUCCH_Config value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 1: { 
            PUCCH_Config setup;
            element = setup = new PUCCH_Config();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            PUCCH_Config setup = (PUCCH_Config) element;
            setup.encode (buffer);
            break;
