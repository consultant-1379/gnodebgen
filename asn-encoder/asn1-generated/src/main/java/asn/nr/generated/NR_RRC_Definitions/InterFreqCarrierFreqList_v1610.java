...
public class InterFreqCarrierFreqList_v1610 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqList-v1610";
   }

   public InterFreqCarrierFreqInfo_v1610[] elements;

   public InterFreqCarrierFreqList_v1610 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqList_v1610 (int numRecords) {
      elements = new InterFreqCarrierFreqInfo_v1610 [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqList_v1610 (InterFreqCarrierFreqInfo_v1610[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqCarrierFreqInfo_v1610 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqCarrierFreqInfo_v1610();
