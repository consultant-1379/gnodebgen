...
public class MeasConfigMN extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((measuredFrequenciesMN != null), null);
      buffer.encodeBit ((measGapConfig != null), null);
      buffer.encodeBit ((gapPurpose != null), null);

      // encode measuredFrequenciesMN

      if (measuredFrequenciesMN != null) {
         buffer.getContext().eventDispatcher.startElement("measuredFrequenciesMN", -1);

         measuredFrequenciesMN.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((measGapConfigFR2 != null), "optbit");
            if (measGapConfigFR2 != null) {
               measGapConfigFR2.encode (buffer);
            }
