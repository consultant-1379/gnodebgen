...
public class RepetitionSchemeConfig_r16_fdm_TDM_r16 extends Asn1Choice {
   ...
   public RepetitionSchemeConfig_r16_fdm_TDM_r16 () {
      super();
   }

   public RepetitionSchemeConfig_r16_fdm_TDM_r16 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (FDM_TDM_r16 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            FDM_TDM_r16 setup = (FDM_TDM_r16) element;
            setup.encode (buffer);
            break;
