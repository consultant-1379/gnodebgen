...
public class TAG_Config_tag_ToAddModList extends Asn1SeqOf {
   ...
   public TAG_Config_tag_ToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public TAG_Config_tag_ToAddModList (int numRecords) {
      elements = new TAG [numRecords];
   }
    ...
    * given the array.  
    */
   public TAG_Config_tag_ToAddModList (TAG[] elements_) {
      elements = elements_;
   }
