...
public class SchedulingRequestToAddMod extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((sr_ProhibitTimer != null), null);
      ...
      // encode sr_ProhibitTimer

      if (sr_ProhibitTimer != null) {
         buffer.getContext().eventDispatcher.startElement("sr_ProhibitTimer", -1);

         sr_ProhibitTimer.encode (buffer);
      ...
      if (sr_TransMax != null) {
         ...
         sr_TransMax.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sr_TransMax", -1);
      }
      else throw new Asn1MissingRequiredException ("sr_TransMax");
