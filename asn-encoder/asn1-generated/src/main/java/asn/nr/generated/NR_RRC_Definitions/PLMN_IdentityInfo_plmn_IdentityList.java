...
public class PLMN_IdentityInfo_plmn_IdentityList extends Asn1SeqOf {
   ...
   public PLMN_IdentityInfo_plmn_IdentityList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_IdentityInfo_plmn_IdentityList (int numRecords) {
    ...
    * given the array.  
    */
   public PLMN_IdentityInfo_plmn_IdentityList (PLMN_Identity[] elements_) {
      elements = elements_;
   }
