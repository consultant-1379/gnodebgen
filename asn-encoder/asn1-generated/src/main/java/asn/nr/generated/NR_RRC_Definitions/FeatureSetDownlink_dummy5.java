...
public class FeatureSetDownlink_dummy5 extends Asn1SeqOf {
   ...
   public DummyC[] elements;

   public FeatureSetDownlink_dummy5 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSetDownlink_dummy5 (int numRecords) {
      elements = new DummyC [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSetDownlink_dummy5 (DummyC[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DummyC [numElements];
