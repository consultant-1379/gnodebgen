...
public class RadioLinkMonitoringConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((failureDetectionResourcesToAddModList != null), null);
      buffer.encodeBit ((failureDetectionResourcesToReleaseList != null), null);
      buffer.encodeBit ((beamFailureInstanceMaxCount != null), null);
      buffer.encodeBit ((beamFailureDetectionTimer != null), null);

      // encode failureDetectionResourcesToAddModList

      if (failureDetectionResourcesToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("failureDetectionResourcesToAddModList", -1);

         failureDetectionResourcesToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("failureDetectionResourcesToAddModList", -1);
      }

      // encode failureDetectionResourcesToReleaseList

      if (failureDetectionResourcesToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("failureDetectionResourcesToReleaseList", -1);

         failureDetectionResourcesToReleaseList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("failureDetectionResourcesToReleaseList", -1);
      }

      // encode beamFailureInstanceMaxCount

      if (beamFailureInstanceMaxCount != null) {
         buffer.getContext().eventDispatcher.startElement("beamFailureInstanceMaxCount", -1);

         beamFailureInstanceMaxCount.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("beamFailureInstanceMaxCount", -1);
      }

      // encode beamFailureDetectionTimer

      if (beamFailureDetectionTimer != null) {
         buffer.getContext().eventDispatcher.startElement("beamFailureDetectionTimer", -1);

         beamFailureDetectionTimer.encode (buffer);
