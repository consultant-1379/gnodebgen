...
public class SCellConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((sCellConfigCommon != null), null);
      buffer.encodeBit ((sCellConfigDedicated != null), null);
      ...
      if (sCellIndex != null) {
         ...
         sCellIndex.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sCellIndex", -1);
      }
      else throw new Asn1MissingRequiredException ("sCellIndex");

      // encode sCellConfigCommon

      if (sCellConfigCommon != null) {
         buffer.getContext().eventDispatcher.startElement("sCellConfigCommon", -1);

         sCellConfigCommon.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sCellConfigCommon", -1);
      }

      // encode sCellConfigDedicated

      if (sCellConfigDedicated != null) {
         buffer.getContext().eventDispatcher.startElement("sCellConfigDedicated", -1);

         sCellConfigDedicated.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((smtc != null), "optbit");
            if (smtc != null) {
               smtc.encode (buffer);
            }
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((sCellState_r16 != null), "optbit");
            buffer.encodeBit ((secondaryDRX_GroupConfig_r16 != null), "optbit");
            if (sCellState_r16 != null) {
               sCellState_r16.encode (buffer);
            }
            if (secondaryDRX_GroupConfig_r16 != null) {
               secondaryDRX_GroupConfig_r16.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
