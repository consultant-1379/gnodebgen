...
public class EUTRA_Parameters_supportedBandListEUTRA extends Asn1SeqOf {
   ...
   public FreqBandIndicatorEUTRA[] elements;

   public EUTRA_Parameters_supportedBandListEUTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public EUTRA_Parameters_supportedBandListEUTRA (int numRecords) {
      elements = new FreqBandIndicatorEUTRA [numRecords];
   }
    ...
    * given the array.  
    */
   public EUTRA_Parameters_supportedBandListEUTRA (FreqBandIndicatorEUTRA[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqBandIndicatorEUTRA [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqBandIndicatorEUTRA();
