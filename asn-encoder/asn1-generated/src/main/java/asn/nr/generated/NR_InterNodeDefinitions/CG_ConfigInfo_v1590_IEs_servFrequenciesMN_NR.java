...
public class CG_ConfigInfo_v1590_IEs_servFrequenciesMN_NR extends Asn1SeqOf {
   ...
   public CG_ConfigInfo_v1590_IEs_servFrequenciesMN_NR () {
      elements = null;
   }
    ...
    * populated.
    */
   public CG_ConfigInfo_v1590_IEs_servFrequenciesMN_NR (int numRecords) {
    ...
    * given the array.  
    */
   public CG_ConfigInfo_v1590_IEs_servFrequenciesMN_NR (ARFCN_ValueNR[] elements_) {
      elements = elements_;
   }
