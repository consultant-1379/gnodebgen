...
public class MeasTimingList extends Asn1SeqOf {
   ...
   public MeasTiming[] elements;

   public MeasTimingList () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasTimingList (int numRecords) {
      elements = new MeasTiming [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasTimingList (MeasTiming[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasTiming [numElements];
