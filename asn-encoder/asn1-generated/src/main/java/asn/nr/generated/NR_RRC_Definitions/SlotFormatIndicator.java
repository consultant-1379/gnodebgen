...
public class SlotFormatIndicator extends Asn1Seq {
   ...
   public SlotFormatIndicator_availableRB_SetsToReleaseList_r16 availableRB_SetsToReleaseList_r16;  // optional
   ...
   public SlotFormatIndicator (
      ...
      SlotFormatIndicator_availableRB_SetsToReleaseList_r16 availableRB_SetsToReleaseList_r16_,
      ...
      availableRB_SetsToReleaseList_r16 = availableRB_SetsToReleaseList_r16_;
   ...
   public void init () {
      ...
      availableRB_SetsToReleaseList_r16 = null;
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 5: return availableRB_SetsToReleaseList_r16;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 5: return "availableRB-SetsToReleaseList-r16";
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (extbit) {
         ...
         if (i < bitcnt && bitmap[i++]) {
            ...
            boolean availableRB_SetsToReleaseList_r16Present = buffer.decodeBit ("availableRB_SetsToReleaseList_r16Present");
            ...
            // decode availableRB_SetsToReleaseList_r16

            if (availableRB_SetsToReleaseList_r16Present) {
               buffer.getContext().eventDispatcher.startElement("availableRB_SetsToReleaseList_r16", -1);

               availableRB_SetsToReleaseList_r16 = new SlotFormatIndicator_availableRB_SetsToReleaseList_r16();
               availableRB_SetsToReleaseList_r16.decode (buffer);
               buffer.getContext().eventDispatcher.endElement("availableRB_SetsToReleaseList_r16", -1);
            }
            else {
               availableRB_SetsToReleaseList_r16 = null;
            }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((slotFormatCombToAddModList != null), null);
      buffer.encodeBit ((slotFormatCombToReleaseList != null), null);
      ...
      if (sfi_RNTI != null) {
         ...
         sfi_RNTI.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sfi_RNTI", -1);
      }
      else throw new Asn1MissingRequiredException ("sfi_RNTI");

      // encode dci_PayloadSize

      if (dci_PayloadSize != null) {
         buffer.getContext().eventDispatcher.startElement("dci_PayloadSize", -1);

         dci_PayloadSize.encode (buffer, 1, 128);

         buffer.getContext().eventDispatcher.endElement("dci_PayloadSize", -1);
      }
      else throw new Asn1MissingRequiredException ("dci_PayloadSize");

      // encode slotFormatCombToAddModList

      if (slotFormatCombToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("slotFormatCombToAddModList", -1);

         slotFormatCombToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("slotFormatCombToAddModList", -1);
      }

      // encode slotFormatCombToReleaseList

      if (slotFormatCombToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("slotFormatCombToReleaseList", -1);

         slotFormatCombToReleaseList.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((availableRB_SetsToAddModList_r16 != null), "optbit");
            buffer.encodeBit ((availableRB_SetsToReleaseList_r16 != null), "optbit");
            buffer.encodeBit ((switchTriggerToAddModList_r16 != null), "optbit");
            buffer.encodeBit ((switchTriggerToReleaseList_r16 != null), "optbit");
            buffer.encodeBit ((co_DurationsPerCellToAddModList_r16 != null), "optbit");
            buffer.encodeBit ((co_DurationsPerCellToReleaseList_r16 != null), "optbit");
            if (availableRB_SetsToAddModList_r16 != null) {
               availableRB_SetsToAddModList_r16.encode (buffer);
            }
            if (availableRB_SetsToReleaseList_r16 != null) {
               availableRB_SetsToReleaseList_r16.encode (buffer);
            }
            if (switchTriggerToAddModList_r16 != null) {
               switchTriggerToAddModList_r16.encode (buffer);
            }
            if (switchTriggerToReleaseList_r16 != null) {
               switchTriggerToReleaseList_r16.encode (buffer);
            }
            if (co_DurationsPerCellToAddModList_r16 != null) {
               co_DurationsPerCellToAddModList_r16.encode (buffer);
            }
            if (co_DurationsPerCellToReleaseList_r16 != null) {
               co_DurationsPerCellToReleaseList_r16.encode (buffer);
            }
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (availableRB_SetsToReleaseList_r16 != null) availableRB_SetsToReleaseList_r16.print (_sb, "availableRB_SetsToReleaseList_r16", _level+1);
