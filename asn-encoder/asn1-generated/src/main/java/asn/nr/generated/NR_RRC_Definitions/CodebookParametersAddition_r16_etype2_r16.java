...
public class CodebookParametersAddition_r16_etype2_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((paramComb7_8_r16 != null), null);
      buffer.encodeBit ((rank3_4_r16 != null), null);
      buffer.encodeBit ((amplitudeSubsetRestriction_r16 != null), null);
      ...
      else throw new Asn1MissingRequiredException ("etype2R1_r16");
      ...
      // encode paramComb7_8_r16

      if (paramComb7_8_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("paramComb7_8_r16", -1);

         paramComb7_8_r16.encode (buffer);
      ...
      // encode amplitudeSubsetRestriction_r16

      if (amplitudeSubsetRestriction_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("amplitudeSubsetRestriction_r16", -1);

         amplitudeSubsetRestriction_r16.encode (buffer);
