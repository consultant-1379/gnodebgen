...
public class SIB5 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((carrierFreqListEUTRA != null), null);
      buffer.encodeBit ((t_ReselectionEUTRA_SF != null), null);
      buffer.encodeBit ((lateNonCriticalExtension != null), null);

      // encode carrierFreqListEUTRA

      if (carrierFreqListEUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("carrierFreqListEUTRA", -1);

         carrierFreqListEUTRA.encode (buffer);
      ...
      if (t_ReselectionEUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("t_ReselectionEUTRA", -1);

         t_ReselectionEUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("t_ReselectionEUTRA", -1);
      }
      else throw new Asn1MissingRequiredException ("t_ReselectionEUTRA");

      // encode t_ReselectionEUTRA_SF

      if (t_ReselectionEUTRA_SF != null) {
         buffer.getContext().eventDispatcher.startElement("t_ReselectionEUTRA_SF", -1);

         t_ReselectionEUTRA_SF.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((carrierFreqListEUTRA_v1610 != null), "optbit");
            if (carrierFreqListEUTRA_v1610 != null) {
               carrierFreqListEUTRA_v1610.encode (buffer);
            }
