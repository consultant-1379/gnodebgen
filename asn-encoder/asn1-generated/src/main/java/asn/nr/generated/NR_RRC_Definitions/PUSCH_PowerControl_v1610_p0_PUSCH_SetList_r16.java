...
public class PUSCH_PowerControl_v1610_p0_PUSCH_SetList_r16 extends Asn1SeqOf {
   ...
   public P0_PUSCH_Set_r16[] elements;

   public PUSCH_PowerControl_v1610_p0_PUSCH_SetList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUSCH_PowerControl_v1610_p0_PUSCH_SetList_r16 (int numRecords) {
      elements = new P0_PUSCH_Set_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PUSCH_PowerControl_v1610_p0_PUSCH_SetList_r16 (P0_PUSCH_Set_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new P0_PUSCH_Set_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new P0_PUSCH_Set_r16();
