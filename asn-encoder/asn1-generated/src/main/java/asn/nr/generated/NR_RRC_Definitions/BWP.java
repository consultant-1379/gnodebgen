...
public class BWP extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((cyclicPrefix != null), null);

      // encode locationAndBandwidth

      if (locationAndBandwidth != null) {
         buffer.getContext().eventDispatcher.startElement("locationAndBandwidth", -1);

         locationAndBandwidth.encode (buffer, 0, 37949);

         buffer.getContext().eventDispatcher.endElement("locationAndBandwidth", -1);
      }
      else throw new Asn1MissingRequiredException ("locationAndBandwidth");
      ...
      if (cyclicPrefix != null) {
         buffer.getContext().eventDispatcher.startElement("cyclicPrefix", -1);

         cyclicPrefix.encode (buffer);
