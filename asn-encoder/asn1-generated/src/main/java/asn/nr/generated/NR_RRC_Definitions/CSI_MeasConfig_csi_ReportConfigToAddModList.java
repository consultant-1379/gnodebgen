...
public class CSI_MeasConfig_csi_ReportConfigToAddModList extends Asn1SeqOf {
   ...
   public CSI_ReportConfig[] elements;

   public CSI_MeasConfig_csi_ReportConfigToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_csi_ReportConfigToAddModList (int numRecords) {
      elements = new CSI_ReportConfig [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_MeasConfig_csi_ReportConfigToAddModList (CSI_ReportConfig[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_ReportConfig [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_ReportConfig();
