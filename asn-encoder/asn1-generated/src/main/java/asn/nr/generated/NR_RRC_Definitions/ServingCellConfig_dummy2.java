...
public class ServingCellConfig_dummy2 extends Asn1Choice {
   ...
   public ServingCellConfig_dummy2 () {
      super();
   }

   public ServingCellConfig_dummy2 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (DummyJ value) {
