...
public class SL_InterestedFreqList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-InterestedFreqList-r16";
   }

   public Asn1Integer[] elements;

   public SL_InterestedFreqList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_InterestedFreqList_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public SL_InterestedFreqList_r16 (Asn1Integer[] elements_) {
      elements = elements_;
   }
