...
public class ReportSFTD_NR_cellsForWhichToReportSFTD extends Asn1SeqOf {
   ...
   public PhysCellId[] elements;

   public ReportSFTD_NR_cellsForWhichToReportSFTD () {
      elements = null;
   }
    ...
    * populated.
    */
   public ReportSFTD_NR_cellsForWhichToReportSFTD (int numRecords) {
      elements = new PhysCellId [numRecords];
   }
    ...
    * given the array.  
    */
   public ReportSFTD_NR_cellsForWhichToReportSFTD (PhysCellId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PhysCellId [numElements];
