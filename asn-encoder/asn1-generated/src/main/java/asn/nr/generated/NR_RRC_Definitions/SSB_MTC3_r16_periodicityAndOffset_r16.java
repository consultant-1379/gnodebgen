...
public class SSB_MTC3_r16_periodicityAndOffset_r16 extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeConsWholeNumber (choiceID - 1, 9, "index");
      ...
      switch (choiceID) {
         // sf5_r16
         case _SF5_R16:
            Asn1Integer sf5_r16 = (Asn1Integer) element;
            sf5_r16.encode (buffer, 0, 4);
            break;

         // sf10_r16
         case _SF10_R16:
            Asn1Integer sf10_r16 = (Asn1Integer) element;
            sf10_r16.encode (buffer, 0, 9);
            break;

         // sf20_r16
         case _SF20_R16:
            Asn1Integer sf20_r16 = (Asn1Integer) element;
            sf20_r16.encode (buffer, 0, 19);
            break;

         // sf40_r16
         case _SF40_R16:
            Asn1Integer sf40_r16 = (Asn1Integer) element;
            sf40_r16.encode (buffer, 0, 39);
            break;

         // sf80_r16
         case _SF80_R16:
            Asn1Integer sf80_r16 = (Asn1Integer) element;
            sf80_r16.encode (buffer, 0, 79);
            break;

         // sf160_r16
         case _SF160_R16:
            Asn1Integer sf160_r16 = (Asn1Integer) element;
            sf160_r16.encode (buffer, 0, 159);
            break;

         // sf320_r16
         case _SF320_R16:
            Asn1Integer sf320_r16 = (Asn1Integer) element;
            sf320_r16.encode (buffer, 0, 319);
            break;

         // sf640_r16
         case _SF640_R16:
            Asn1Integer sf640_r16 = (Asn1Integer) element;
            sf640_r16.encode (buffer, 0, 639);
            break;

         // sf1280_r16
         case _SF1280_R16:
            Asn1Integer sf1280_r16 = (Asn1Integer) element;
            sf1280_r16.encode (buffer, 0, 1279);
            break;
