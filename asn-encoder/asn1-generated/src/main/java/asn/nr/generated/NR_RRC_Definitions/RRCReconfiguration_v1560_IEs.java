...
public class RRCReconfiguration_v1560_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((mrdc_SecondaryCellGroupConfig != null), null);
      ...
      // encode mrdc_SecondaryCellGroupConfig

      if (mrdc_SecondaryCellGroupConfig != null) {
         buffer.getContext().eventDispatcher.startElement("mrdc_SecondaryCellGroupConfig", -1);

         mrdc_SecondaryCellGroupConfig.encode (buffer);
