...
public class SL_ConfigCommonNR_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((sl_FreqInfoList_r16 != null), null);
      buffer.encodeBit ((sl_UE_SelectedConfig_r16 != null), null);
      buffer.encodeBit ((sl_NR_AnchorCarrierFreqList_r16 != null), null);
      buffer.encodeBit ((sl_EUTRA_AnchorCarrierFreqList_r16 != null), null);
      buffer.encodeBit ((sl_RadioBearerConfigList_r16 != null), null);
      buffer.encodeBit ((sl_RLC_BearerConfigList_r16 != null), null);
      buffer.encodeBit ((sl_MeasConfigCommon_r16 != null), null);
      ...
      // encode sl_FreqInfoList_r16

      if (sl_FreqInfoList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_FreqInfoList_r16", -1);

         sl_FreqInfoList_r16.encode (buffer);
      ...
      // encode sl_NR_AnchorCarrierFreqList_r16

      if (sl_NR_AnchorCarrierFreqList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_NR_AnchorCarrierFreqList_r16", -1);

         sl_NR_AnchorCarrierFreqList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_NR_AnchorCarrierFreqList_r16", -1);
      }

      // encode sl_EUTRA_AnchorCarrierFreqList_r16

      if (sl_EUTRA_AnchorCarrierFreqList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_EUTRA_AnchorCarrierFreqList_r16", -1);

         sl_EUTRA_AnchorCarrierFreqList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_EUTRA_AnchorCarrierFreqList_r16", -1);
      }

      // encode sl_RadioBearerConfigList_r16

      if (sl_RadioBearerConfigList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_RadioBearerConfigList_r16", -1);

         sl_RadioBearerConfigList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_RadioBearerConfigList_r16", -1);
      }

      // encode sl_RLC_BearerConfigList_r16

      if (sl_RLC_BearerConfigList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_RLC_BearerConfigList_r16", -1);

         sl_RLC_BearerConfigList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_RLC_BearerConfigList_r16", -1);
      }

      // encode sl_MeasConfigCommon_r16

      if (sl_MeasConfigCommon_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_MeasConfigCommon_r16", -1);

         sl_MeasConfigCommon_r16.encode (buffer);
