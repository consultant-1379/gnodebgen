...
public class SelectedBandEntriesMN extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SelectedBandEntriesMN";
   }

   public BandEntryIndex[] elements;

   public SelectedBandEntriesMN () {
      elements = null;
   }
    ...
    * populated.
    */
   public SelectedBandEntriesMN (int numRecords) {
    ...
    * given the array.  
    */
   public SelectedBandEntriesMN (BandEntryIndex[] elements_) {
      elements = elements_;
   }
