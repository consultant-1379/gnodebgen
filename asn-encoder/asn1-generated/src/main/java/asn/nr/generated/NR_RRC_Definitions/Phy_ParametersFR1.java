...
public class Phy_ParametersFR1 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((pdcch_MonitoringSingleOccasion != null), null);
      buffer.encodeBit ((scs_60kHz != null), null);
      buffer.encodeBit ((pdsch_256QAM_FR1 != null), null);
      buffer.encodeBit ((pdsch_RE_MappingFR1_PerSymbol != null), null);

      // encode pdcch_MonitoringSingleOccasion

      if (pdcch_MonitoringSingleOccasion != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_MonitoringSingleOccasion", -1);

         pdcch_MonitoringSingleOccasion.encode (buffer);
      ...
      // encode pdsch_256QAM_FR1

      if (pdsch_256QAM_FR1 != null) {
         buffer.getContext().eventDispatcher.startElement("pdsch_256QAM_FR1", -1);

         pdsch_256QAM_FR1.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pdsch_256QAM_FR1", -1);
      }

      // encode pdsch_RE_MappingFR1_PerSymbol

      if (pdsch_RE_MappingFR1_PerSymbol != null) {
         buffer.getContext().eventDispatcher.startElement("pdsch_RE_MappingFR1_PerSymbol", -1);

         pdsch_RE_MappingFR1_PerSymbol.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((pdsch_RE_MappingFR1_PerSlot != null), "optbit");
            if (pdsch_RE_MappingFR1_PerSlot != null) {
               pdsch_RE_MappingFR1_PerSlot.encode (buffer);
            }
