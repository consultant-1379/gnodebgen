...
public class SlotFormatIndicator_slotFormatCombToAddModList extends Asn1SeqOf {
   ...
   public SlotFormatCombinationsPerCell[] elements;

   public SlotFormatIndicator_slotFormatCombToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SlotFormatIndicator_slotFormatCombToAddModList (int numRecords) {
      elements = new SlotFormatCombinationsPerCell [numRecords];
   }
    ...
    * given the array.  
    */
   public SlotFormatIndicator_slotFormatCombToAddModList (SlotFormatCombinationsPerCell[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SlotFormatCombinationsPerCell [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SlotFormatCombinationsPerCell();
