...
public class ServingCellConfig_rateMatchPatternToReleaseList extends Asn1SeqOf {
   ...
   public ServingCellConfig_rateMatchPatternToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServingCellConfig_rateMatchPatternToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public ServingCellConfig_rateMatchPatternToReleaseList (RateMatchPatternId[] elements_) {
      elements = elements_;
   }
