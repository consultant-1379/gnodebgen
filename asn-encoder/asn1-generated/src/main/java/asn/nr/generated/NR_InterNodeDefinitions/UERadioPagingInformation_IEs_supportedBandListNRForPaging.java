...
public class UERadioPagingInformation_IEs_supportedBandListNRForPaging extends Asn1SeqOf {
   ...
   public FreqBandIndicatorNR[] elements;

   public UERadioPagingInformation_IEs_supportedBandListNRForPaging () {
      elements = null;
   }
    ...
    * populated.
    */
   public UERadioPagingInformation_IEs_supportedBandListNRForPaging (int numRecords) {
      elements = new FreqBandIndicatorNR [numRecords];
   }
    ...
    * given the array.  
    */
   public UERadioPagingInformation_IEs_supportedBandListNRForPaging (FreqBandIndicatorNR[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqBandIndicatorNR [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqBandIndicatorNR();
