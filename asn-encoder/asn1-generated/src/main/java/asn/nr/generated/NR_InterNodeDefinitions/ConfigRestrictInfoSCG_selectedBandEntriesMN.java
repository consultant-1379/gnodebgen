...
public class ConfigRestrictInfoSCG_selectedBandEntriesMN extends Asn1SeqOf {
   ...
   public BandEntryIndex[] elements;

   public ConfigRestrictInfoSCG_selectedBandEntriesMN () {
      elements = null;
   }
    ...
    * populated.
    */
   public ConfigRestrictInfoSCG_selectedBandEntriesMN (int numRecords) {
      elements = new BandEntryIndex [numRecords];
   }
    ...
    * given the array.  
    */
   public ConfigRestrictInfoSCG_selectedBandEntriesMN (BandEntryIndex[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandEntryIndex [numElements];
