...
public class SSB_Configuration_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((ssb_Periodicity_r16 != null), null);
      buffer.encodeBit ((sfn0_Offset_r16 != null), null);
      buffer.encodeBit ((ss_PBCH_BlockPower_r16 != null), null);

      // encode ssb_Freq_r16

      if (ssb_Freq_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ssb_Freq_r16", -1);

         ssb_Freq_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ssb_Freq_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("ssb_Freq_r16");
      ...
      if (halfFrameIndex_r16 != null) {
         ...
         halfFrameIndex_r16.encode (buffer);
      ...
      // encode sfn0_Offset_r16

      if (sfn0_Offset_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sfn0_Offset_r16", -1);

         sfn0_Offset_r16.encode (buffer);
