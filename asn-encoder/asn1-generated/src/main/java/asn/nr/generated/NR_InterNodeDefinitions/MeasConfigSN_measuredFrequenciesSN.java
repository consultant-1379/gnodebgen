...
public class MeasConfigSN_measuredFrequenciesSN extends Asn1SeqOf {
   ...
   public MeasConfigSN_measuredFrequenciesSN () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasConfigSN_measuredFrequenciesSN (int numRecords) {
    ...
    * given the array.  
    */
   public MeasConfigSN_measuredFrequenciesSN (NR_FreqInfo[] elements_) {
      elements = elements_;
   }
