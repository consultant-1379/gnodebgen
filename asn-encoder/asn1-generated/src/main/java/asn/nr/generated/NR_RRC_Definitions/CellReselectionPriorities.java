...
public class CellReselectionPriorities extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((freqPriorityListEUTRA != null), null);
      buffer.encodeBit ((freqPriorityListNR != null), null);
      buffer.encodeBit ((t320 != null), null);

      // encode freqPriorityListEUTRA

      if (freqPriorityListEUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("freqPriorityListEUTRA", -1);

         freqPriorityListEUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("freqPriorityListEUTRA", -1);
      }

      // encode freqPriorityListNR

      if (freqPriorityListNR != null) {
         buffer.getContext().eventDispatcher.startElement("freqPriorityListNR", -1);

         freqPriorityListNR.encode (buffer);
