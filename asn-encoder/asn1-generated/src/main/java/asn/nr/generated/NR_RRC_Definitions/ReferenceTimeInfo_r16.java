...
public class ReferenceTimeInfo_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((uncertainty_r16 != null), null);
      buffer.encodeBit ((timeInfoType_r16 != null), null);
      buffer.encodeBit ((referenceSFN_r16 != null), null);
      ...
      if (time_r16 != null) {
         ...
         time_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("time_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("time_r16");

      // encode uncertainty_r16

      if (uncertainty_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("uncertainty_r16", -1);

         uncertainty_r16.encode (buffer, 0, 32767);

         buffer.getContext().eventDispatcher.endElement("uncertainty_r16", -1);
      }

      // encode timeInfoType_r16

      if (timeInfoType_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("timeInfoType_r16", -1);

         timeInfoType_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("timeInfoType_r16", -1);
      }

      // encode referenceSFN_r16

      if (referenceSFN_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("referenceSFN_r16", -1);

         referenceSFN_r16.encode (buffer, 0, 1023);
