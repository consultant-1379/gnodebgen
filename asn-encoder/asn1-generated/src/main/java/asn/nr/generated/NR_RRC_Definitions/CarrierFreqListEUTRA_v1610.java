...
public class CarrierFreqListEUTRA_v1610 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CarrierFreqListEUTRA-v1610";
   }

   public CarrierFreqEUTRA_v1610[] elements;

   public CarrierFreqListEUTRA_v1610 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CarrierFreqListEUTRA_v1610 (int numRecords) {
      elements = new CarrierFreqEUTRA_v1610 [numRecords];
   }
    ...
    * given the array.  
    */
   public CarrierFreqListEUTRA_v1610 (CarrierFreqEUTRA_v1610[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CarrierFreqEUTRA_v1610 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CarrierFreqEUTRA_v1610();
