...
public class SRS_PosResourceSet_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((srs_PosResourceIdList_r16 != null), null);
      buffer.encodeBit ((alpha_r16 != null), null);
      buffer.encodeBit ((p0_r16 != null), null);
      buffer.encodeBit ((pathlossReferenceRS_Pos_r16 != null), null);

      // encode srs_PosResourceSetId_r16

      if (srs_PosResourceSetId_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("srs_PosResourceSetId_r16", -1);

         srs_PosResourceSetId_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("srs_PosResourceSetId_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("srs_PosResourceSetId_r16");

      // encode srs_PosResourceIdList_r16

      if (srs_PosResourceIdList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("srs_PosResourceIdList_r16", -1);

         srs_PosResourceIdList_r16.encode (buffer);
      ...
      if (p0_r16 != null) {
         ...
         p0_r16.encode (buffer, -202, 24);

         buffer.getContext().eventDispatcher.endElement("p0_r16", -1);
      }

      // encode pathlossReferenceRS_Pos_r16

      if (pathlossReferenceRS_Pos_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("pathlossReferenceRS_Pos_r16", -1);

         pathlossReferenceRS_Pos_r16.encode (buffer);
