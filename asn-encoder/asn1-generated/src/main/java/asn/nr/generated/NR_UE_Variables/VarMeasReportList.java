...
public class VarMeasReportList extends Asn1SeqOf {
    ...
    * populated.
    */
   public VarMeasReportList (int numRecords) {
    ...
    * given the array.  
    */
   public VarMeasReportList (VarMeasReport[] elements_) {
      elements = elements_;
   }
