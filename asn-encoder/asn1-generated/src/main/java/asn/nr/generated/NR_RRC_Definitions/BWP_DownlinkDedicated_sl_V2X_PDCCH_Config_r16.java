...
public class BWP_DownlinkDedicated_sl_V2X_PDCCH_Config_r16 extends Asn1Choice {
   ...
   public BWP_DownlinkDedicated_sl_V2X_PDCCH_Config_r16 () {
      super();
   }

   public BWP_DownlinkDedicated_sl_V2X_PDCCH_Config_r16 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (PDCCH_Config value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 1: { 
            PDCCH_Config setup;
            element = setup = new PDCCH_Config();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            PDCCH_Config setup = (PDCCH_Config) element;
            setup.encode (buffer);
            break;
