...
public class NeedForGapsBandlistNR_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NeedForGapsBandlistNR-r16";
   }

   public NeedForGapsNR_r16[] elements;

   public NeedForGapsBandlistNR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NeedForGapsBandlistNR_r16 (int numRecords) {
      elements = new NeedForGapsNR_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public NeedForGapsBandlistNR_r16 (NeedForGapsNR_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NeedForGapsNR_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NeedForGapsNR_r16();
