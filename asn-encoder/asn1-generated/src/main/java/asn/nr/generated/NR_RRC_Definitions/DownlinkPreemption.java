...
public class DownlinkPreemption extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (int_RNTI != null) {
         ...
         int_RNTI.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("int_RNTI", -1);
      }
      else throw new Asn1MissingRequiredException ("int_RNTI");

      // encode timeFrequencySet

      if (timeFrequencySet != null) {
         buffer.getContext().eventDispatcher.startElement("timeFrequencySet", -1);

         timeFrequencySet.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("timeFrequencySet", -1);
      }
      else throw new Asn1MissingRequiredException ("timeFrequencySet");
      ...
      if (dci_PayloadSize != null) {
         ...
         dci_PayloadSize.encode (buffer, 0, 126);

         buffer.getContext().eventDispatcher.endElement("dci_PayloadSize", -1);
      }
      else throw new Asn1MissingRequiredException ("dci_PayloadSize");

      // encode int_ConfigurationPerServingCell

      if (int_ConfigurationPerServingCell != null) {
         buffer.getContext().eventDispatcher.startElement("int_ConfigurationPerServingCell", -1);

         int_ConfigurationPerServingCell.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("int_ConfigurationPerServingCell", -1);
      }
      else throw new Asn1MissingRequiredException ("int_ConfigurationPerServingCell");
