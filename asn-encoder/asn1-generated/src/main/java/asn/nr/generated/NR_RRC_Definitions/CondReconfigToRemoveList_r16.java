...
public class CondReconfigToRemoveList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CondReconfigToRemoveList-r16";
   }

   public CondReconfigId_r16[] elements;

   public CondReconfigToRemoveList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CondReconfigToRemoveList_r16 (int numRecords) {
      elements = new CondReconfigId_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public CondReconfigToRemoveList_r16 (CondReconfigId_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CondReconfigId_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CondReconfigId_r16();
