...
public class ConfiguredGrantConfig_rrc_ConfiguredUplinkGrant extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((dmrs_SeqInitialization != null), null);
      buffer.encodeBit ((srs_ResourceIndicator != null), null);
      buffer.encodeBit ((frequencyHoppingOffset != null), null);

      // encode timeDomainOffset

      if (timeDomainOffset != null) {
         buffer.getContext().eventDispatcher.startElement("timeDomainOffset", -1);

         timeDomainOffset.encode (buffer, 0, 5119);

         buffer.getContext().eventDispatcher.endElement("timeDomainOffset", -1);
      }
      else throw new Asn1MissingRequiredException ("timeDomainOffset");

      // encode timeDomainAllocation

      if (timeDomainAllocation != null) {
         buffer.getContext().eventDispatcher.startElement("timeDomainAllocation", -1);

         timeDomainAllocation.encode (buffer, 0, 15);

         buffer.getContext().eventDispatcher.endElement("timeDomainAllocation", -1);
      }
      else throw new Asn1MissingRequiredException ("timeDomainAllocation");
      ...
      if (frequencyDomainAllocation != null) {
         ...
         frequencyDomainAllocation.encode (buffer, 18, 18);
      ...
      if (antennaPort != null) {
         ...
         antennaPort.encode (buffer, 0, 31);

         buffer.getContext().eventDispatcher.endElement("antennaPort", -1);
      }
      else throw new Asn1MissingRequiredException ("antennaPort");

      // encode dmrs_SeqInitialization

      if (dmrs_SeqInitialization != null) {
         buffer.getContext().eventDispatcher.startElement("dmrs_SeqInitialization", -1);

         dmrs_SeqInitialization.encode (buffer, 0, 1);

         buffer.getContext().eventDispatcher.endElement("dmrs_SeqInitialization", -1);
      }

      // encode precodingAndNumberOfLayers

      if (precodingAndNumberOfLayers != null) {
         buffer.getContext().eventDispatcher.startElement("precodingAndNumberOfLayers", -1);

         precodingAndNumberOfLayers.encode (buffer, 0, 63);

         buffer.getContext().eventDispatcher.endElement("precodingAndNumberOfLayers", -1);
      }
      else throw new Asn1MissingRequiredException ("precodingAndNumberOfLayers");

      // encode srs_ResourceIndicator

      if (srs_ResourceIndicator != null) {
         buffer.getContext().eventDispatcher.startElement("srs_ResourceIndicator", -1);

         srs_ResourceIndicator.encode (buffer, 0, 15);
      ...
      if (mcsAndTBS != null) {
         ...
         mcsAndTBS.encode (buffer, 0, 31);

         buffer.getContext().eventDispatcher.endElement("mcsAndTBS", -1);
      }
      else throw new Asn1MissingRequiredException ("mcsAndTBS");

      // encode frequencyHoppingOffset

      if (frequencyHoppingOffset != null) {
         buffer.getContext().eventDispatcher.startElement("frequencyHoppingOffset", -1);

         frequencyHoppingOffset.encode (buffer, 1, 274);

         buffer.getContext().eventDispatcher.endElement("frequencyHoppingOffset", -1);
      }

      // encode pathlossReferenceIndex

      if (pathlossReferenceIndex != null) {
         buffer.getContext().eventDispatcher.startElement("pathlossReferenceIndex", -1);

         pathlossReferenceIndex.encode (buffer, 0, 3);

         buffer.getContext().eventDispatcher.endElement("pathlossReferenceIndex", -1);
      }
      else throw new Asn1MissingRequiredException ("pathlossReferenceIndex");
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((pusch_RepTypeIndicator_r16 != null), "optbit");
            buffer.encodeBit ((frequencyHoppingPUSCH_RepTypeB_r16 != null), "optbit");
            buffer.encodeBit ((timeReferenceSFN_r16 != null), "optbit");
            if (pusch_RepTypeIndicator_r16 != null) {
               pusch_RepTypeIndicator_r16.encode (buffer);
            }
            if (frequencyHoppingPUSCH_RepTypeB_r16 != null) {
               frequencyHoppingPUSCH_RepTypeB_r16.encode (buffer);
            }
            if (timeReferenceSFN_r16 != null) {
               timeReferenceSFN_r16.encode (buffer);
            }
