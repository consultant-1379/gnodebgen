...
public class SL_PSSCH_TxParameters_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((sl_MaxTxPower_r16 != null), null);
      ...
      // encode sl_MinSubChannelNumPSSCH_r16

      if (sl_MinSubChannelNumPSSCH_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_MinSubChannelNumPSSCH_r16", -1);

         sl_MinSubChannelNumPSSCH_r16.encode (buffer, 1, 27);

         buffer.getContext().eventDispatcher.endElement("sl_MinSubChannelNumPSSCH_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("sl_MinSubChannelNumPSSCH_r16");

      // encode sl_MaxSubchannelNumPSSCH_r16

      if (sl_MaxSubchannelNumPSSCH_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_MaxSubchannelNumPSSCH_r16", -1);

         sl_MaxSubchannelNumPSSCH_r16.encode (buffer, 1, 27);

         buffer.getContext().eventDispatcher.endElement("sl_MaxSubchannelNumPSSCH_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("sl_MaxSubchannelNumPSSCH_r16");

      // encode sl_MaxTxTransNumPSSCH_r16

      if (sl_MaxTxTransNumPSSCH_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_MaxTxTransNumPSSCH_r16", -1);

         sl_MaxTxTransNumPSSCH_r16.encode (buffer, 1, 32);

         buffer.getContext().eventDispatcher.endElement("sl_MaxTxTransNumPSSCH_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("sl_MaxTxTransNumPSSCH_r16");

      // encode sl_MaxTxPower_r16

      if (sl_MaxTxPower_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_MaxTxPower_r16", -1);

         sl_MaxTxPower_r16.encode (buffer);
