...
public class BWP_UplinkDedicated_pusch_Config extends Asn1Choice {
   ...
   public BWP_UplinkDedicated_pusch_Config () {
      super();
   }

   public BWP_UplinkDedicated_pusch_Config (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (PUSCH_Config value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 1: { 
            PUSCH_Config setup;
            element = setup = new PUSCH_Config();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            PUSCH_Config setup = (PUSCH_Config) element;
            setup.encode (buffer);
            break;
