...
public class UL_DCCH_MessageType extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // c1
         case _C1:
            UL_DCCH_MessageType_c1 c1 = (UL_DCCH_MessageType_c1) element;
            c1.encode (buffer);
            break;

         // messageClassExtension
         case _MESSAGECLASSEXTENSION:
            UL_DCCH_MessageType_messageClassExtension messageClassExtension = (UL_DCCH_MessageType_messageClassExtension) element;
