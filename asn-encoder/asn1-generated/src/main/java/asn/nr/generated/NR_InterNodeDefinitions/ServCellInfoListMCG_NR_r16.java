...
public class ServCellInfoListMCG_NR_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServCellInfoListMCG-NR-r16";
   }

   public ServCellInfoXCG_NR_r16[] elements;

   public ServCellInfoListMCG_NR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServCellInfoListMCG_NR_r16 (int numRecords) {
      elements = new ServCellInfoXCG_NR_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public ServCellInfoListMCG_NR_r16 (ServCellInfoXCG_NR_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServCellInfoXCG_NR_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServCellInfoXCG_NR_r16();
