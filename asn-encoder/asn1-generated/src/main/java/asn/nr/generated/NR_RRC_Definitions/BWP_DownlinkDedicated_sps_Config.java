...
public class BWP_DownlinkDedicated_sps_Config extends Asn1Choice {
   ...
   public BWP_DownlinkDedicated_sps_Config () {
      super();
   }

   public BWP_DownlinkDedicated_sps_Config (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SPS_Config value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            SPS_Config setup = (SPS_Config) element;
            setup.encode (buffer);
            break;
