...
public class PDSCH_Config_tci_StatesToAddModList extends Asn1SeqOf {
   ...
   public TCI_State[] elements;

   public PDSCH_Config_tci_StatesToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDSCH_Config_tci_StatesToAddModList (int numRecords) {
      elements = new TCI_State [numRecords];
   }
    ...
    * given the array.  
    */
   public PDSCH_Config_tci_StatesToAddModList (TCI_State[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TCI_State [numElements];
