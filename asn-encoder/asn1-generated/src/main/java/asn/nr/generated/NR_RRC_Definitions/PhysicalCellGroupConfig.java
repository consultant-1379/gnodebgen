...
public class PhysicalCellGroupConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((harq_ACK_SpatialBundlingPUCCH != null), null);
      buffer.encodeBit ((harq_ACK_SpatialBundlingPUSCH != null), null);
      buffer.encodeBit ((p_NR_FR1 != null), null);
      ...
      buffer.encodeBit ((sp_CSI_RNTI != null), null);
      buffer.encodeBit ((cs_RNTI != null), null);

      // encode harq_ACK_SpatialBundlingPUCCH

      if (harq_ACK_SpatialBundlingPUCCH != null) {
         buffer.getContext().eventDispatcher.startElement("harq_ACK_SpatialBundlingPUCCH", -1);

         harq_ACK_SpatialBundlingPUCCH.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("harq_ACK_SpatialBundlingPUCCH", -1);
      }

      // encode harq_ACK_SpatialBundlingPUSCH

      if (harq_ACK_SpatialBundlingPUSCH != null) {
         buffer.getContext().eventDispatcher.startElement("harq_ACK_SpatialBundlingPUSCH", -1);

         harq_ACK_SpatialBundlingPUSCH.encode (buffer);
      ...
      if (p_NR_FR1 != null) {
         ...
         p_NR_FR1.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("p_NR_FR1", -1);
      }

      // encode pdsch_HARQ_ACK_Codebook

      if (pdsch_HARQ_ACK_Codebook != null) {
         buffer.getContext().eventDispatcher.startElement("pdsch_HARQ_ACK_Codebook", -1);

         pdsch_HARQ_ACK_Codebook.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pdsch_HARQ_ACK_Codebook", -1);
      }
      else throw new Asn1MissingRequiredException ("pdsch_HARQ_ACK_Codebook");
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((mcs_C_RNTI != null), "optbit");
            buffer.encodeBit ((p_UE_FR1 != null), "optbit");
            if (mcs_C_RNTI != null) {
               mcs_C_RNTI.encode (buffer);
            }
            if (p_UE_FR1 != null) {
               p_UE_FR1.encode (buffer);
            }
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((xScale != null), "optbit");
            if (xScale != null) {
               xScale.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
         ...
         if (mV4ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((pdcch_BlindDetection != null), "optbit");
            if (pdcch_BlindDetection != null) {
               pdcch_BlindDetection.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
         ...
         if (mV5ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((dcp_Config_r16 != null), "optbit");
            buffer.encodeBit ((harq_ACK_SpatialBundlingPUCCH_secondaryPUCCHgroup_r16 != null), "optbit");
            buffer.encodeBit ((harq_ACK_SpatialBundlingPUSCH_secondaryPUCCHgroup_r16 != null), "optbit");
            buffer.encodeBit ((pdsch_HARQ_ACK_Codebook_secondaryPUCCHgroup_r16 != null), "optbit");
            buffer.encodeBit ((p_NR_FR2_r16 != null), "optbit");
            buffer.encodeBit ((p_UE_FR2_r16 != null), "optbit");
            buffer.encodeBit ((nrdc_PCmode_FR1_r16 != null), "optbit");
            buffer.encodeBit ((nrdc_PCmode_FR2_r16 != null), "optbit");
            buffer.encodeBit ((pdsch_HARQ_ACK_Codebook_r16 != null), "optbit");
            buffer.encodeBit ((nfi_TotalDAI_Included_r16 != null), "optbit");
            buffer.encodeBit ((ul_TotalDAI_Included_r16 != null), "optbit");
            buffer.encodeBit ((pdsch_HARQ_ACK_OneShotFeedback_r16 != null), "optbit");
            buffer.encodeBit ((pdsch_HARQ_ACK_OneShotFeedbackNDI_r16 != null), "optbit");
            buffer.encodeBit ((pdsch_HARQ_ACK_OneShotFeedbackCBG_r16 != null), "optbit");
            buffer.encodeBit ((downlinkAssignmentIndexDCI_0_2_r16 != null), "optbit");
            buffer.encodeBit ((downlinkAssignmentIndexDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((pdsch_HARQ_ACK_CodebookList_r16 != null), "optbit");
            buffer.encodeBit ((ackNackFeedbackMode_r16 != null), "optbit");
            buffer.encodeBit ((pdcch_BlindDetectionCA_CombIndicator_r16 != null), "optbit");
            buffer.encodeBit ((pdcch_BlindDetection2_r16 != null), "optbit");
            buffer.encodeBit ((pdcch_BlindDetection3_r16 != null), "optbit");
            buffer.encodeBit ((bdFactorR_r16 != null), "optbit");
            if (dcp_Config_r16 != null) {
               dcp_Config_r16.encode (buffer);
            }
            if (harq_ACK_SpatialBundlingPUCCH_secondaryPUCCHgroup_r16 != null) {
               harq_ACK_SpatialBundlingPUCCH_secondaryPUCCHgroup_r16.encode (buffer);
            }
            if (harq_ACK_SpatialBundlingPUSCH_secondaryPUCCHgroup_r16 != null) {
               harq_ACK_SpatialBundlingPUSCH_secondaryPUCCHgroup_r16.encode (buffer);
            }
            if (pdsch_HARQ_ACK_Codebook_secondaryPUCCHgroup_r16 != null) {
               pdsch_HARQ_ACK_Codebook_secondaryPUCCHgroup_r16.encode (buffer);
            }
            if (p_NR_FR2_r16 != null) {
               p_NR_FR2_r16.encode (buffer);
            }
            if (p_UE_FR2_r16 != null) {
               p_UE_FR2_r16.encode (buffer);
            }
            if (nrdc_PCmode_FR1_r16 != null) {
               nrdc_PCmode_FR1_r16.encode (buffer);
            }
            if (nrdc_PCmode_FR2_r16 != null) {
               nrdc_PCmode_FR2_r16.encode (buffer);
            }
            if (pdsch_HARQ_ACK_Codebook_r16 != null) {
               pdsch_HARQ_ACK_Codebook_r16.encode (buffer);
            }
            if (nfi_TotalDAI_Included_r16 != null) {
               nfi_TotalDAI_Included_r16.encode (buffer);
            }
            if (ul_TotalDAI_Included_r16 != null) {
               ul_TotalDAI_Included_r16.encode (buffer);
            }
            if (pdsch_HARQ_ACK_OneShotFeedback_r16 != null) {
               pdsch_HARQ_ACK_OneShotFeedback_r16.encode (buffer);
            }
            if (pdsch_HARQ_ACK_OneShotFeedbackNDI_r16 != null) {
               pdsch_HARQ_ACK_OneShotFeedbackNDI_r16.encode (buffer);
            }
            if (pdsch_HARQ_ACK_OneShotFeedbackCBG_r16 != null) {
               pdsch_HARQ_ACK_OneShotFeedbackCBG_r16.encode (buffer);
            }
            if (downlinkAssignmentIndexDCI_0_2_r16 != null) {
               downlinkAssignmentIndexDCI_0_2_r16.encode (buffer);
            }
            if (downlinkAssignmentIndexDCI_1_2_r16 != null) {
               downlinkAssignmentIndexDCI_1_2_r16.encode (buffer);
            }
            if (pdsch_HARQ_ACK_CodebookList_r16 != null) {
               pdsch_HARQ_ACK_CodebookList_r16.encode (buffer);
            }
            if (ackNackFeedbackMode_r16 != null) {
               ackNackFeedbackMode_r16.encode (buffer);
            }
            if (pdcch_BlindDetectionCA_CombIndicator_r16 != null) {
               pdcch_BlindDetectionCA_CombIndicator_r16.encode (buffer);
            }
            if (pdcch_BlindDetection2_r16 != null) {
               pdcch_BlindDetection2_r16.encode (buffer);
            }
            if (pdcch_BlindDetection3_r16 != null) {
               pdcch_BlindDetection3_r16.encode (buffer);
            }
            if (bdFactorR_r16 != null) {
               bdFactorR_r16.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
