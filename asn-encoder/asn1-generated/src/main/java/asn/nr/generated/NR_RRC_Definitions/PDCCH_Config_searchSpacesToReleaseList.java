...
public class PDCCH_Config_searchSpacesToReleaseList extends Asn1SeqOf {
   ...
   public SearchSpaceId[] elements;

   public PDCCH_Config_searchSpacesToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDCCH_Config_searchSpacesToReleaseList (int numRecords) {
      elements = new SearchSpaceId [numRecords];
   }
    ...
    * given the array.  
    */
   public PDCCH_Config_searchSpacesToReleaseList (SearchSpaceId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SearchSpaceId [numElements];
