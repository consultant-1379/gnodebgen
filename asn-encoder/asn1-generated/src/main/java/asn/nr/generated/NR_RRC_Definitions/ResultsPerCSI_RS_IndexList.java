...
public class ResultsPerCSI_RS_IndexList extends Asn1SeqOf {
   ...
   public ResultsPerCSI_RS_Index[] elements;

   public ResultsPerCSI_RS_IndexList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResultsPerCSI_RS_IndexList (int numRecords) {
      elements = new ResultsPerCSI_RS_Index [numRecords];
   }
    ...
    * given the array.  
    */
   public ResultsPerCSI_RS_IndexList (ResultsPerCSI_RS_Index[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResultsPerCSI_RS_Index [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResultsPerCSI_RS_Index();
