...
public class UAC_BarringPerCatList extends Asn1SeqOf {
   ...
   public UAC_BarringPerCat[] elements;

   public UAC_BarringPerCatList () {
      elements = null;
   }
    ...
    * populated.
    */
   public UAC_BarringPerCatList (int numRecords) {
      elements = new UAC_BarringPerCat [numRecords];
   }
    ...
    * given the array.  
    */
   public UAC_BarringPerCatList (UAC_BarringPerCat[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UAC_BarringPerCat [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UAC_BarringPerCat();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 63);
