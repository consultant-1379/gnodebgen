...
public class SRS_CC_SetIndex extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((cc_SetIndex != null), null);
      buffer.encodeBit ((cc_IndexInOneCC_Set != null), null);
      ...
      if (cc_SetIndex != null) {
         ...
         cc_SetIndex.encode (buffer, 0, 3);

         buffer.getContext().eventDispatcher.endElement("cc_SetIndex", -1);
      }

      // encode cc_IndexInOneCC_Set

      if (cc_IndexInOneCC_Set != null) {
         buffer.getContext().eventDispatcher.startElement("cc_IndexInOneCC_Set", -1);

         cc_IndexInOneCC_Set.encode (buffer, 0, 7);
