...
public class FeatureSetDownlink_dummy4 extends Asn1SeqOf {
   ...
   public DummyB[] elements;

   public FeatureSetDownlink_dummy4 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSetDownlink_dummy4 (int numRecords) {
      elements = new DummyB [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSetDownlink_dummy4 (DummyB[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DummyB [numElements];
