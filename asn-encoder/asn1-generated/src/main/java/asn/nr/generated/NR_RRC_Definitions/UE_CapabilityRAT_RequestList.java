...
public class UE_CapabilityRAT_RequestList extends Asn1SeqOf {
   ...
   public UE_CapabilityRAT_Request[] elements;

   public UE_CapabilityRAT_RequestList () {
      elements = null;
   }
    ...
    * populated.
    */
   public UE_CapabilityRAT_RequestList (int numRecords) {
      elements = new UE_CapabilityRAT_Request [numRecords];
   }
    ...
    * given the array.  
    */
   public UE_CapabilityRAT_RequestList (UE_CapabilityRAT_Request[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UE_CapabilityRAT_Request [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UE_CapabilityRAT_Request();
