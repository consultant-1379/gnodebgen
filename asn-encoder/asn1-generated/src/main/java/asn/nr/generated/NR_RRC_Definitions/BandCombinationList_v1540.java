...
public class BandCombinationList_v1540 extends Asn1SeqOf {
   ...
   public BandCombination_v1540[] elements;

   public BandCombinationList_v1540 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationList_v1540 (int numRecords) {
      elements = new BandCombination_v1540 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationList_v1540 (BandCombination_v1540[] elements_) {
      elements = elements_;
   }
   ...
   {
      int fraglen = 0;
      java.util.LinkedList<BandCombination_v1540> tmplist = 
         new java.util.LinkedList<BandCombination_v1540>();
      BandCombination_v1540 value;
      ...
      for (;;) {
         ...
         for (int i = 0; i < fraglen; i++) {
            ...
            value = new BandCombination_v1540();
            value.decode (buffer);
      ...
      elements = new BandCombination_v1540 [tmplist.size()];
