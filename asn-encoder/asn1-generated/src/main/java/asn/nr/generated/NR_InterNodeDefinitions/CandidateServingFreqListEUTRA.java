...
public class CandidateServingFreqListEUTRA extends Asn1SeqOf {
   ...
   public CandidateServingFreqListEUTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public CandidateServingFreqListEUTRA (int numRecords) {
    ...
    * given the array.  
    */
   public CandidateServingFreqListEUTRA (ARFCN_ValueEUTRA[] elements_) {
      elements = elements_;
   }
