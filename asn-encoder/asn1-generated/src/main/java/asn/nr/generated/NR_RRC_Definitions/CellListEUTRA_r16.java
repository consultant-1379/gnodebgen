...
public class CellListEUTRA_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellListEUTRA-r16";
   }

   public EUTRA_PhysCellIdRange[] elements;

   public CellListEUTRA_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellListEUTRA_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public CellListEUTRA_r16 (EUTRA_PhysCellIdRange[] elements_) {
      elements = elements_;
   }
