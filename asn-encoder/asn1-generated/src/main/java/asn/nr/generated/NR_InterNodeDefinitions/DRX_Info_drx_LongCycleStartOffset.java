...
public class DRX_Info_drx_LongCycleStartOffset extends Asn1Choice {
   ...
   public DRX_Info_drx_LongCycleStartOffset () {
      super();
   }

   public DRX_Info_drx_LongCycleStartOffset (byte choiceId_, Asn1Type element_) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeConsWholeNumber (choiceID - 1, 20, "index");
      ...
      switch (choiceID) {
         // ms10
         case _MS10:
            Asn1Integer ms10 = (Asn1Integer) element;
            ms10.encode (buffer, 0, 9);
            break;

         // ms20
         case _MS20:
            Asn1Integer ms20 = (Asn1Integer) element;
            ms20.encode (buffer, 0, 19);
            break;

         // ms32
         case _MS32:
            Asn1Integer ms32 = (Asn1Integer) element;
            ms32.encode (buffer, 0, 31);
            break;

         // ms40
         case _MS40:
            Asn1Integer ms40 = (Asn1Integer) element;
            ms40.encode (buffer, 0, 39);
            break;

         // ms60
         case _MS60:
            Asn1Integer ms60 = (Asn1Integer) element;
            ms60.encode (buffer, 0, 59);
            break;

         // ms64
         case _MS64:
            Asn1Integer ms64 = (Asn1Integer) element;
            ms64.encode (buffer, 0, 63);
            break;

         // ms70
         case _MS70:
            Asn1Integer ms70 = (Asn1Integer) element;
            ms70.encode (buffer, 0, 69);
            break;

         // ms80
         case _MS80:
            Asn1Integer ms80 = (Asn1Integer) element;
            ms80.encode (buffer, 0, 79);
            break;

         // ms128
         case _MS128:
            Asn1Integer ms128 = (Asn1Integer) element;
            ms128.encode (buffer, 0, 127);
            break;

         // ms160
         case _MS160:
            Asn1Integer ms160 = (Asn1Integer) element;
            ms160.encode (buffer, 0, 159);
            break;

         // ms256
         case _MS256:
            Asn1Integer ms256 = (Asn1Integer) element;
            ms256.encode (buffer, 0, 255);
            break;

         // ms320
         case _MS320:
            Asn1Integer ms320 = (Asn1Integer) element;
            ms320.encode (buffer, 0, 319);
            break;

         // ms512
         case _MS512:
            Asn1Integer ms512 = (Asn1Integer) element;
            ms512.encode (buffer, 0, 511);
            break;

         // ms640
         case _MS640:
            Asn1Integer ms640 = (Asn1Integer) element;
            ms640.encode (buffer, 0, 639);
            break;

         // ms1024
         case _MS1024:
            Asn1Integer ms1024 = (Asn1Integer) element;
            ms1024.encode (buffer, 0, 1023);
            break;

         // ms1280
         case _MS1280:
            Asn1Integer ms1280 = (Asn1Integer) element;
            ms1280.encode (buffer, 0, 1279);
            break;

         // ms2048
         case _MS2048:
            Asn1Integer ms2048 = (Asn1Integer) element;
            ms2048.encode (buffer, 0, 2047);
            break;

         // ms2560
         case _MS2560:
            Asn1Integer ms2560 = (Asn1Integer) element;
            ms2560.encode (buffer, 0, 2559);
            break;

         // ms5120
         case _MS5120:
            Asn1Integer ms5120 = (Asn1Integer) element;
            ms5120.encode (buffer, 0, 5119);
            break;

         // ms10240
         case _MS10240:
            Asn1Integer ms10240 = (Asn1Integer) element;
            ms10240.encode (buffer, 0, 10239);
            break;
