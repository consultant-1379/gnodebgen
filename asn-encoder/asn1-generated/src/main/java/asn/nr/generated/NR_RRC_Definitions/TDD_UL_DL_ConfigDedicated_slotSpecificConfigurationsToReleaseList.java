...
public class TDD_UL_DL_ConfigDedicated_slotSpecificConfigurationsToReleaseList extends Asn1SeqOf {
   ...
   public TDD_UL_DL_ConfigDedicated_slotSpecificConfigurationsToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public TDD_UL_DL_ConfigDedicated_slotSpecificConfigurationsToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public TDD_UL_DL_ConfigDedicated_slotSpecificConfigurationsToReleaseList (TDD_UL_DL_SlotIndex[] elements_) {
      elements = elements_;
   }
