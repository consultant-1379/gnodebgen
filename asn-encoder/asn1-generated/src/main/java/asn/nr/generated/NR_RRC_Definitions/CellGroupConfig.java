...
public class CellGroupConfig extends Asn1Seq {
   ...
   public CellGroupConfig_reportUplinkTxDirectCurrentTwoCarrier_r16 reportUplinkTxDirectCurrentTwoCarrier_r16 = null;  // optional
   ...
   public CellGroupConfig (
      ...
      CellGroupConfig_reportUplinkTxDirectCurrentTwoCarrier_r16 reportUplinkTxDirectCurrentTwoCarrier_r16_
   ) {
      super();
      cellGroupId = cellGroupId_;
      ...
      reportUplinkTxDirectCurrentTwoCarrier_r16 = reportUplinkTxDirectCurrentTwoCarrier_r16_;
   }
   ...
   public void init () {
      ...
      reportUplinkTxDirectCurrentTwoCarrier_r16 = null;
      extElem1 = null;
   }
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 19: return reportUplinkTxDirectCurrentTwoCarrier_r16;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 19: return "reportUplinkTxDirectCurrentTwoCarrier-r16";
         case 20: return null;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (extbit) {
         ...
         if (i < bitcnt && bitmap[i++]) {
            ...
            boolean reportUplinkTxDirectCurrentTwoCarrier_r16Present = buffer.decodeBit ("reportUplinkTxDirectCurrentTwoCarrier_r16Present");

            // decode reportUplinkTxDirectCurrentTwoCarrier_r16

            if (reportUplinkTxDirectCurrentTwoCarrier_r16Present) {
               buffer.getContext().eventDispatcher.startElement("reportUplinkTxDirectCurrentTwoCarrier_r16", -1);

               int tval = CellGroupConfig_reportUplinkTxDirectCurrentTwoCarrier_r16.decodeEnumValue (buffer);
               reportUplinkTxDirectCurrentTwoCarrier_r16 = CellGroupConfig_reportUplinkTxDirectCurrentTwoCarrier_r16.valueOf (tval);
               buffer.getContext().eventDispatcher.endElement("reportUplinkTxDirectCurrentTwoCarrier_r16", -1);
            }
            else {
               reportUplinkTxDirectCurrentTwoCarrier_r16 = null;
            }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((rlc_BearerToAddModList != null), null);
      buffer.encodeBit ((rlc_BearerToReleaseList != null), null);
      buffer.encodeBit ((mac_CellGroupConfig != null), null);
      buffer.encodeBit ((physicalCellGroupConfig != null), null);
      buffer.encodeBit ((spCellConfig != null), null);
      buffer.encodeBit ((sCellToAddModList != null), null);
      buffer.encodeBit ((sCellToReleaseList != null), null);
      ...
      if (cellGroupId != null) {
         ...
         cellGroupId.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("cellGroupId", -1);
      }
      else throw new Asn1MissingRequiredException ("cellGroupId");

      // encode rlc_BearerToAddModList

      if (rlc_BearerToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("rlc_BearerToAddModList", -1);

         rlc_BearerToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("rlc_BearerToAddModList", -1);
      }

      // encode rlc_BearerToReleaseList

      if (rlc_BearerToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("rlc_BearerToReleaseList", -1);

         rlc_BearerToReleaseList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("rlc_BearerToReleaseList", -1);
      }

      // encode mac_CellGroupConfig

      if (mac_CellGroupConfig != null) {
         buffer.getContext().eventDispatcher.startElement("mac_CellGroupConfig", -1);

         mac_CellGroupConfig.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("mac_CellGroupConfig", -1);
      }

      // encode physicalCellGroupConfig

      if (physicalCellGroupConfig != null) {
         buffer.getContext().eventDispatcher.startElement("physicalCellGroupConfig", -1);

         physicalCellGroupConfig.encode (buffer);
      ...
      if (spCellConfig != null) {
         ...
         spCellConfig.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("spCellConfig", -1);
      }

      // encode sCellToAddModList

      if (sCellToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("sCellToAddModList", -1);

         sCellToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sCellToAddModList", -1);
      }

      // encode sCellToReleaseList

      if (sCellToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("sCellToReleaseList", -1);

         sCellToReleaseList.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((reportUplinkTxDirectCurrent != null), "optbit");
            if (reportUplinkTxDirectCurrent != null) {
               reportUplinkTxDirectCurrent.encode (buffer);
            }
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((bap_Address_r16 != null), "optbit");
            buffer.encodeBit ((bh_RLC_ChannelToAddModList_r16 != null), "optbit");
            buffer.encodeBit ((bh_RLC_ChannelToReleaseList_r16 != null), "optbit");
            buffer.encodeBit ((f1c_TransferPath_r16 != null), "optbit");
            buffer.encodeBit ((simultaneousTCI_UpdateList1_r16 != null), "optbit");
            buffer.encodeBit ((simultaneousTCI_UpdateList2_r16 != null), "optbit");
            buffer.encodeBit ((simultaneousSpatial_UpdatedList1_r16 != null), "optbit");
            buffer.encodeBit ((simultaneousSpatial_UpdatedList2_r16 != null), "optbit");
            buffer.encodeBit ((uplinkTxSwitchingOption_r16 != null), "optbit");
            buffer.encodeBit ((uplinkTxSwitchingPowerBoosting_r16 != null), "optbit");
            if (bap_Address_r16 != null) {
               bap_Address_r16.encode (buffer, 10, 10);
            }
            if (bh_RLC_ChannelToAddModList_r16 != null) {
               bh_RLC_ChannelToAddModList_r16.encode (buffer);
            }
            if (bh_RLC_ChannelToReleaseList_r16 != null) {
               bh_RLC_ChannelToReleaseList_r16.encode (buffer);
            }
            if (f1c_TransferPath_r16 != null) {
               f1c_TransferPath_r16.encode (buffer);
            }
            if (simultaneousTCI_UpdateList1_r16 != null) {
               simultaneousTCI_UpdateList1_r16.encode (buffer);
            }
            if (simultaneousTCI_UpdateList2_r16 != null) {
               simultaneousTCI_UpdateList2_r16.encode (buffer);
            }
            if (simultaneousSpatial_UpdatedList1_r16 != null) {
               simultaneousSpatial_UpdatedList1_r16.encode (buffer);
            }
            if (simultaneousSpatial_UpdatedList2_r16 != null) {
               simultaneousSpatial_UpdatedList2_r16.encode (buffer);
            }
            if (uplinkTxSwitchingOption_r16 != null) {
               uplinkTxSwitchingOption_r16.encode (buffer);
            }
            if (uplinkTxSwitchingPowerBoosting_r16 != null) {
               uplinkTxSwitchingPowerBoosting_r16.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
         ...
         if (mV4ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((reportUplinkTxDirectCurrentTwoCarrier_r16 != null), "optbit");
            if (reportUplinkTxDirectCurrentTwoCarrier_r16 != null) {
               reportUplinkTxDirectCurrentTwoCarrier_r16.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (reportUplinkTxDirectCurrentTwoCarrier_r16 != null) reportUplinkTxDirectCurrentTwoCarrier_r16.print (_sb, "reportUplinkTxDirectCurrentTwoCarrier_r16", _level+1);
