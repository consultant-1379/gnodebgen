...
public class SlotBased_r16 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SlotBased-r16";
   }

   public SlotBased_r16_tciMapping_r16 tciMapping_r16 = null;
   public Asn1Integer sequenceOffsetForRV_r16;

   public SlotBased_r16 () {
      super();
      init();
   }
    ...
    */
   public SlotBased_r16 (
      SlotBased_r16_tciMapping_r16 tciMapping_r16_,
    ...
    * the given objects 
    */
   public SlotBased_r16 (SlotBased_r16_tciMapping_r16 tciMapping_r16_,
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      {
         int tval = SlotBased_r16_tciMapping_r16.decodeEnumValue (buffer);
         tciMapping_r16 = SlotBased_r16_tciMapping_r16.valueOf (tval);
      }
      ...
      sequenceOffsetForRV_r16.decode (buffer, 1, 3);
   ...
   public void encode (Asn1PerEncodeBuffer buffer)
      throws Asn1Exception, java.io.IOException
   {
      // encode tciMapping_r16

      if (tciMapping_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("tciMapping_r16", -1);

         tciMapping_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("tciMapping_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("tciMapping_r16");

      // encode sequenceOffsetForRV_r16

      if (sequenceOffsetForRV_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sequenceOffsetForRV_r16", -1);

         sequenceOffsetForRV_r16.encode (buffer, 1, 3);

         buffer.getContext().eventDispatcher.endElement("sequenceOffsetForRV_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("sequenceOffsetForRV_r16");
