...
public class ProcessingParameters extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((differentTB_PerSlot != null), null);
      ...
      if (fallback != null) {
         ...
         fallback.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("fallback", -1);
      }
      else throw new Asn1MissingRequiredException ("fallback");

      // encode differentTB_PerSlot

      if (differentTB_PerSlot != null) {
         buffer.getContext().eventDispatcher.startElement("differentTB_PerSlot", -1);

         differentTB_PerSlot.encode (buffer);
