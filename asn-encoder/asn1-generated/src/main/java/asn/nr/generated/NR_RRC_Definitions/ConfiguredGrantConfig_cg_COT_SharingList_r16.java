...
public class ConfiguredGrantConfig_cg_COT_SharingList_r16 extends Asn1SeqOf {
   ...
   public CG_COT_Sharing_r16[] elements;

   public ConfiguredGrantConfig_cg_COT_SharingList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ConfiguredGrantConfig_cg_COT_SharingList_r16 (int numRecords) {
      elements = new CG_COT_Sharing_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public ConfiguredGrantConfig_cg_COT_SharingList_r16 (CG_COT_Sharing_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 1709);
      int numElements = (int) buffer.decodeLength();

      elements = new CG_COT_Sharing_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CG_COT_Sharing_r16();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 1709);
