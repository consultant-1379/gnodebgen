...
public class PortIndexFor8Ranks_portIndex8_rank6_8 extends Asn1SeqOf {
   ...
   public PortIndexFor8Ranks_portIndex8_rank6_8 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PortIndexFor8Ranks_portIndex8_rank6_8 (int numRecords) {
    ...
    * given the array.  
    */
   public PortIndexFor8Ranks_portIndex8_rank6_8 (PortIndex8[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 6, 6);
