...
public class RRCReconfigurationSidelink_IEs_r16_sl_CSI_RS_Config_r16 extends Asn1Choice {
   ...
   public RRCReconfigurationSidelink_IEs_r16_sl_CSI_RS_Config_r16 () {
      super();
   }

   public RRCReconfigurationSidelink_IEs_r16_sl_CSI_RS_Config_r16 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SL_CSI_RS_Config_r16 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            SL_CSI_RS_Config_r16 setup;
            element = setup = new SL_CSI_RS_Config_r16();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            SL_CSI_RS_Config_r16 setup = (SL_CSI_RS_Config_r16) element;
            setup.encode (buffer);
            break;
