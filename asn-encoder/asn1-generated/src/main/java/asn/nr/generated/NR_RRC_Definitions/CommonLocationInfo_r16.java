...
public class CommonLocationInfo_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((gnss_TOD_msec_r16 != null), null);
      buffer.encodeBit ((locationTimestamp_r16 != null), null);
      buffer.encodeBit ((locationCoordinate_r16 != null), null);
      buffer.encodeBit ((locationError_r16 != null), null);
      buffer.encodeBit ((locationSource_r16 != null), null);
      buffer.encodeBit ((velocityEstimate_r16 != null), null);

      // encode gnss_TOD_msec_r16

      if (gnss_TOD_msec_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("gnss_TOD_msec_r16", -1);

         gnss_TOD_msec_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("gnss_TOD_msec_r16", -1);
      }

      // encode locationTimestamp_r16

      if (locationTimestamp_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("locationTimestamp_r16", -1);

         locationTimestamp_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("locationTimestamp_r16", -1);
      }

      // encode locationCoordinate_r16

      if (locationCoordinate_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("locationCoordinate_r16", -1);

         locationCoordinate_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("locationCoordinate_r16", -1);
      }

      // encode locationError_r16

      if (locationError_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("locationError_r16", -1);

         locationError_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("locationError_r16", -1);
      }

      // encode locationSource_r16

      if (locationSource_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("locationSource_r16", -1);

         locationSource_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("locationSource_r16", -1);
      }

      // encode velocityEstimate_r16

      if (velocityEstimate_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("velocityEstimate_r16", -1);

         velocityEstimate_r16.encode (buffer);
