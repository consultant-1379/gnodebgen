...
public class ConfiguredGrantConfigToAddModList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ConfiguredGrantConfigToAddModList-r16";
   }

   public ConfiguredGrantConfig[] elements;

   public ConfiguredGrantConfigToAddModList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ConfiguredGrantConfigToAddModList_r16 (int numRecords) {
      elements = new ConfiguredGrantConfig [numRecords];
   }
    ...
    * given the array.  
    */
   public ConfiguredGrantConfigToAddModList_r16 (ConfiguredGrantConfig[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ConfiguredGrantConfig [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ConfiguredGrantConfig();
