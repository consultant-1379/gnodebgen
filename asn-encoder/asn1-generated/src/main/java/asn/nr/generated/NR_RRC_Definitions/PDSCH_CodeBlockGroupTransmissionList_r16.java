...
public class PDSCH_CodeBlockGroupTransmissionList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PDSCH-CodeBlockGroupTransmissionList-r16";
   }

   public PDSCH_CodeBlockGroupTransmission[] elements;

   public PDSCH_CodeBlockGroupTransmissionList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDSCH_CodeBlockGroupTransmissionList_r16 (int numRecords) {
      elements = new PDSCH_CodeBlockGroupTransmission [numRecords];
   }
    ...
    * given the array.  
    */
   public PDSCH_CodeBlockGroupTransmissionList_r16 (PDSCH_CodeBlockGroupTransmission[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PDSCH_CodeBlockGroupTransmission [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PDSCH_CodeBlockGroupTransmission();
