...
public class CodebookParameters_type2_supportedCSI_RS_ResourceList extends Asn1SeqOf {
   ...
   public CodebookParameters_type2_supportedCSI_RS_ResourceList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CodebookParameters_type2_supportedCSI_RS_ResourceList (int numRecords) {
    ...
    * given the array.  
    */
   public CodebookParameters_type2_supportedCSI_RS_ResourceList (SupportedCSI_RS_Resource[] elements_) {
      elements = elements_;
   }
