...
public class ReestabUE_Identity extends Asn1Seq {
    ...
    * the given objects 
    */
   public ReestabUE_Identity (long c_RNTI_,
      long physCellId_,
      ShortMAC_I shortMAC_I_
   ) {
      super();
      c_RNTI = new RNTI_Value (c_RNTI_);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (c_RNTI != null) {
         ...
         c_RNTI.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("c_RNTI", -1);
      }
      else throw new Asn1MissingRequiredException ("c_RNTI");
