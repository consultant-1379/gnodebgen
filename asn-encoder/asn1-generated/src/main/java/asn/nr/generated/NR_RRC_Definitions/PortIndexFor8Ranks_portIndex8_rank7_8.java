...
public class PortIndexFor8Ranks_portIndex8_rank7_8 extends Asn1SeqOf {
   ...
   public PortIndexFor8Ranks_portIndex8_rank7_8 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PortIndexFor8Ranks_portIndex8_rank7_8 (int numRecords) {
    ...
    * given the array.  
    */
   public PortIndexFor8Ranks_portIndex8_rank7_8 (PortIndex8[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 7, 7);
