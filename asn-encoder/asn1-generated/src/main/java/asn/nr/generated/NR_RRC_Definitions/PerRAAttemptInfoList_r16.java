...
public class PerRAAttemptInfoList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PerRAAttemptInfoList-r16";
   }

   public PerRAAttemptInfo_r16[] elements;

   public PerRAAttemptInfoList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PerRAAttemptInfoList_r16 (int numRecords) {
      elements = new PerRAAttemptInfo_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PerRAAttemptInfoList_r16 (PerRAAttemptInfo_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 200);
      int numElements = (int) buffer.decodeLength();

      elements = new PerRAAttemptInfo_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PerRAAttemptInfo_r16();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 200);
