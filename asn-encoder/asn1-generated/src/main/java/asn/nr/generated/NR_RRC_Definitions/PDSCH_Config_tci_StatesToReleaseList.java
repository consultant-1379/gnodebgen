...
public class PDSCH_Config_tci_StatesToReleaseList extends Asn1SeqOf {
   ...
   public PDSCH_Config_tci_StatesToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDSCH_Config_tci_StatesToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public PDSCH_Config_tci_StatesToReleaseList (TCI_StateId[] elements_) {
      elements = elements_;
   }
