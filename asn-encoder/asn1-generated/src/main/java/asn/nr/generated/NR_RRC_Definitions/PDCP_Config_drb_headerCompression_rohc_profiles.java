...
public class PDCP_Config_drb_headerCompression_rohc_profiles extends Asn1Seq {
   ...
   public PDCP_Config_drb_headerCompression_rohc_profiles () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public PDCP_Config_drb_headerCompression_rohc_profiles (boolean profile0x0001_,
   ...
   public Object getElementValue(int index){
      switch(index)  {
         case 0: return profile0x0001;
         case 1: return profile0x0002;
         case 2: return profile0x0003;
         case 3: return profile0x0004;
         case 4: return profile0x0006;
         case 5: return profile0x0101;
         case 6: return profile0x0102;
         case 7: return profile0x0103;
         case 8: return profile0x0104;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (profile0x0001 != null) {
         ...
         profile0x0001.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("profile0x0001", -1);
      }
      else throw new Asn1MissingRequiredException ("profile0x0001");
      ...
      if (profile0x0002 != null) {
         ...
         profile0x0002.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("profile0x0002", -1);
      }
      else throw new Asn1MissingRequiredException ("profile0x0002");
      ...
      if (profile0x0003 != null) {
         ...
         profile0x0003.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("profile0x0003", -1);
      }
      else throw new Asn1MissingRequiredException ("profile0x0003");
      ...
      if (profile0x0004 != null) {
         ...
         profile0x0004.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("profile0x0004", -1);
      }
      else throw new Asn1MissingRequiredException ("profile0x0004");
      ...
      if (profile0x0006 != null) {
         ...
         profile0x0006.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("profile0x0006", -1);
      }
      else throw new Asn1MissingRequiredException ("profile0x0006");
      ...
      if (profile0x0101 != null) {
         ...
         profile0x0101.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("profile0x0101", -1);
      }
      else throw new Asn1MissingRequiredException ("profile0x0101");
      ...
      if (profile0x0102 != null) {
         ...
         profile0x0102.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("profile0x0102", -1);
      }
      else throw new Asn1MissingRequiredException ("profile0x0102");
      ...
      if (profile0x0103 != null) {
         ...
         profile0x0103.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("profile0x0103", -1);
      }
      else throw new Asn1MissingRequiredException ("profile0x0103");
      ...
      if (profile0x0104 != null) {
         ...
         profile0x0104.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("profile0x0104", -1);
      }
      else throw new Asn1MissingRequiredException ("profile0x0104");
