...
public class SI_RequestConfig_si_RequestResources extends Asn1SeqOf {
   ...
   public SI_RequestResources[] elements;

   public SI_RequestConfig_si_RequestResources () {
      elements = null;
   }
    ...
    * populated.
    */
   public SI_RequestConfig_si_RequestResources (int numRecords) {
      elements = new SI_RequestResources [numRecords];
   }
    ...
    * given the array.  
    */
   public SI_RequestConfig_si_RequestResources (SI_RequestResources[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SI_RequestResources [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SI_RequestResources();
