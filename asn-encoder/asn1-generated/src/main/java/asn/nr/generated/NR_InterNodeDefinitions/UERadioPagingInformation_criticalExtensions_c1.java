...
public class UERadioPagingInformation_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _UERADIOPAGINGINFORMATION = 1;
   ...
   public UERadioPagingInformation_criticalExtensions_c1 () {
      super();
   }

   public UERadioPagingInformation_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _UERADIOPAGINGINFORMATION: return "ueRadioPagingInformation";
   ...
   public void set_ueRadioPagingInformation (UERadioPagingInformation_IEs value) {
      setElement (_UERADIOPAGINGINFORMATION, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            UERadioPagingInformation_IEs ueRadioPagingInformation;
            element = ueRadioPagingInformation = new UERadioPagingInformation_IEs();
            ueRadioPagingInformation.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // ueRadioPagingInformation
         case _UERADIOPAGINGINFORMATION:
            UERadioPagingInformation_IEs ueRadioPagingInformation = (UERadioPagingInformation_IEs) element;
            ueRadioPagingInformation.encode (buffer);
            break;
