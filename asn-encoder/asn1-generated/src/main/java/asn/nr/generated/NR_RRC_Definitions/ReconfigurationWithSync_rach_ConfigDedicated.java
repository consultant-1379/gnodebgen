...
public class ReconfigurationWithSync_rach_ConfigDedicated extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // uplink
         case _UPLINK:
            RACH_ConfigDedicated uplink = (RACH_ConfigDedicated) element;
            uplink.encode (buffer);
            break;

         // supplementaryUplink
         case _SUPPLEMENTARYUPLINK:
            RACH_ConfigDedicated supplementaryUplink = (RACH_ConfigDedicated) element;
