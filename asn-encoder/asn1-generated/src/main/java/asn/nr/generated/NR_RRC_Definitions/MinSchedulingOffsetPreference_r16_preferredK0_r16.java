...
public class MinSchedulingOffsetPreference_r16_preferredK0_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((preferredK0_SCS_15kHz_r16 != null), null);
      buffer.encodeBit ((preferredK0_SCS_30kHz_r16 != null), null);
      buffer.encodeBit ((preferredK0_SCS_60kHz_r16 != null), null);
      buffer.encodeBit ((preferredK0_SCS_120kHz_r16 != null), null);

      // encode preferredK0_SCS_15kHz_r16

      if (preferredK0_SCS_15kHz_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("preferredK0_SCS_15kHz_r16", -1);

         preferredK0_SCS_15kHz_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("preferredK0_SCS_15kHz_r16", -1);
      }

      // encode preferredK0_SCS_30kHz_r16

      if (preferredK0_SCS_30kHz_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("preferredK0_SCS_30kHz_r16", -1);

         preferredK0_SCS_30kHz_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("preferredK0_SCS_30kHz_r16", -1);
      }

      // encode preferredK0_SCS_60kHz_r16

      if (preferredK0_SCS_60kHz_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("preferredK0_SCS_60kHz_r16", -1);

         preferredK0_SCS_60kHz_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("preferredK0_SCS_60kHz_r16", -1);
      }

      // encode preferredK0_SCS_120kHz_r16

      if (preferredK0_SCS_120kHz_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("preferredK0_SCS_120kHz_r16", -1);

         preferredK0_SCS_120kHz_r16.encode (buffer);
