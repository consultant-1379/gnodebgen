...
public class UE_NR_Capability_featureSetCombinations extends Asn1SeqOf {
   ...
   public UE_NR_Capability_featureSetCombinations () {
      elements = null;
   }
    ...
    * populated.
    */
   public UE_NR_Capability_featureSetCombinations (int numRecords) {
    ...
    * given the array.  
    */
   public UE_NR_Capability_featureSetCombinations (FeatureSetCombination[] elements_) {
      elements = elements_;
   }
