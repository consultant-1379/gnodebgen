...
public class SPS_Config extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((n1PUCCH_AN != null), null);
      ...
      if (nrofHARQ_Processes != null) {
         ...
         nrofHARQ_Processes.encode (buffer, 1, 8);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((sps_ConfigIndex_r16 != null), "optbit");
            buffer.encodeBit ((harq_ProcID_Offset_r16 != null), "optbit");
            buffer.encodeBit ((periodicityExt_r16 != null), "optbit");
            buffer.encodeBit ((harq_CodebookID_r16 != null), "optbit");
            buffer.encodeBit ((pdsch_AggregationFactor_r16 != null), "optbit");
            if (sps_ConfigIndex_r16 != null) {
               sps_ConfigIndex_r16.encode (buffer);
            }
            ...
            if (harq_CodebookID_r16 != null) {
               harq_CodebookID_r16.encode (buffer, 1, 2);
            }
            if (pdsch_AggregationFactor_r16 != null) {
               pdsch_AggregationFactor_r16.encode (buffer);
            }
