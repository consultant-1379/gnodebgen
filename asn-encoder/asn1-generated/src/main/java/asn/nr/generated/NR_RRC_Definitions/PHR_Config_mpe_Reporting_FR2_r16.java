...
public class PHR_Config_mpe_Reporting_FR2_r16 extends Asn1Choice {
   ...
   public PHR_Config_mpe_Reporting_FR2_r16 () {
      super();
   }

   public PHR_Config_mpe_Reporting_FR2_r16 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (MPE_Config_FR2_r16 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            MPE_Config_FR2_r16 setup;
            element = setup = new MPE_Config_FR2_r16();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            MPE_Config_FR2_r16 setup = (MPE_Config_FR2_r16) element;
            setup.encode (buffer);
            break;
