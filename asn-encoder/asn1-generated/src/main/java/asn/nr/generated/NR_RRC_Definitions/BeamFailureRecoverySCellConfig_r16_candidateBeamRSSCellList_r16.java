...
public class BeamFailureRecoverySCellConfig_r16_candidateBeamRSSCellList_r16 extends Asn1SeqOf {
   ...
   public CandidateBeamRS_r16[] elements;

   public BeamFailureRecoverySCellConfig_r16_candidateBeamRSSCellList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BeamFailureRecoverySCellConfig_r16_candidateBeamRSSCellList_r16 (int numRecords) {
      elements = new CandidateBeamRS_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public BeamFailureRecoverySCellConfig_r16_candidateBeamRSSCellList_r16 (CandidateBeamRS_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CandidateBeamRS_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CandidateBeamRS_r16();
