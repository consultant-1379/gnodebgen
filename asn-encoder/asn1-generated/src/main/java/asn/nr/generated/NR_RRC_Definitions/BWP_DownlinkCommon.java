...
public class BWP_DownlinkCommon extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((pdcch_ConfigCommon != null), null);
      buffer.encodeBit ((pdsch_ConfigCommon != null), null);
      ...
      // encode pdcch_ConfigCommon

      if (pdcch_ConfigCommon != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_ConfigCommon", -1);

         pdcch_ConfigCommon.encode (buffer);
      ...
      if (pdsch_ConfigCommon != null) {
         buffer.getContext().eventDispatcher.startElement("pdsch_ConfigCommon", -1);

         pdsch_ConfigCommon.encode (buffer);
