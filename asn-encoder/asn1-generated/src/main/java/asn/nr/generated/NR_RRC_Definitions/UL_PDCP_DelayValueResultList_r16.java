...
public class UL_PDCP_DelayValueResultList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "UL-PDCP-DelayValueResultList-r16";
   }

   public UL_PDCP_DelayValueResult_r16[] elements;

   public UL_PDCP_DelayValueResultList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UL_PDCP_DelayValueResultList_r16 (int numRecords) {
      elements = new UL_PDCP_DelayValueResult_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public UL_PDCP_DelayValueResultList_r16 (UL_PDCP_DelayValueResult_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UL_PDCP_DelayValueResult_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UL_PDCP_DelayValueResult_r16();
