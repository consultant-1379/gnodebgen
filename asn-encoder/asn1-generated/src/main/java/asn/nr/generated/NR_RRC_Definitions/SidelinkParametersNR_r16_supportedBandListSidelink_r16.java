...
public class SidelinkParametersNR_r16_supportedBandListSidelink_r16 extends Asn1SeqOf {
   ...
   public BandSidelink_r16[] elements;

   public SidelinkParametersNR_r16_supportedBandListSidelink_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SidelinkParametersNR_r16_supportedBandListSidelink_r16 (int numRecords) {
      elements = new BandSidelink_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SidelinkParametersNR_r16_supportedBandListSidelink_r16 (BandSidelink_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandSidelink_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandSidelink_r16();
