...
public class LogMeasInfo_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((servCellIdentity_r16 != null), null);
      buffer.encodeBit ((measResultServingCell_r16 != null), null);
      buffer.encodeBit ((anyCellSelectionDetected_r16 != null), null);
      ...
      // encode relativeTimeStamp_r16

      if (relativeTimeStamp_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("relativeTimeStamp_r16", -1);

         relativeTimeStamp_r16.encode (buffer, 0, 7200);

         buffer.getContext().eventDispatcher.endElement("relativeTimeStamp_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("relativeTimeStamp_r16");

      // encode servCellIdentity_r16

      if (servCellIdentity_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("servCellIdentity_r16", -1);

         servCellIdentity_r16.encode (buffer);
      ...
      // encode anyCellSelectionDetected_r16

      if (anyCellSelectionDetected_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("anyCellSelectionDetected_r16", -1);

         anyCellSelectionDetected_r16.encode (buffer);
