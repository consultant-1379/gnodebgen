...
public class PUCCH_Config_spatialRelationInfoToReleaseListSizeExt_v1610 extends Asn1SeqOf {
   ...
   public PUCCH_SpatialRelationInfoId[] elements;

   public PUCCH_Config_spatialRelationInfoToReleaseListSizeExt_v1610 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_spatialRelationInfoToReleaseListSizeExt_v1610 (int numRecords) {
      elements = new PUCCH_SpatialRelationInfoId [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_Config_spatialRelationInfoToReleaseListSizeExt_v1610 (PUCCH_SpatialRelationInfoId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 56);
      int numElements = (int) buffer.decodeLength();

      elements = new PUCCH_SpatialRelationInfoId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUCCH_SpatialRelationInfoId();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 56);
