      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (!extbit) {
         ...
         switch (choiceID) {
            // sib2
            case _SIB2:
               SIB2 sib2 = (SIB2) element;
               sib2.encode (buffer);
               break;

            // sib3
            case _SIB3:
               SIB3 sib3 = (SIB3) element;
               sib3.encode (buffer);
               break;

            // sib4
            case _SIB4:
               SIB4 sib4 = (SIB4) element;
               sib4.encode (buffer);
               break;

            // sib5
            case _SIB5:
               SIB5 sib5 = (SIB5) element;
               sib5.encode (buffer);
               break;

            // sib6
            case _SIB6:
               SIB6 sib6 = (SIB6) element;
               sib6.encode (buffer);
               break;

            // sib7
            case _SIB7:
               SIB7 sib7 = (SIB7) element;
               sib7.encode (buffer);
               break;

            // sib8
            case _SIB8:
               SIB8 sib8 = (SIB8) element;
               sib8.encode (buffer);
               break;

            // sib9
            case _SIB9:
               SIB9 sib9 = (SIB9) element;
               sib9.encode (buffer);
               break;
         ...
         switch (choiceID) {
            // sib10_v1610
            case _SIB10_V1610:
               SIB10_r16 sib10_v1610 = (SIB10_r16) element;
               sib10_v1610.encode (buffer);
            ...
            // sib11_v1610
            case _SIB11_V1610:
               SIB11_r16 sib11_v1610 = (SIB11_r16) element;
               sib11_v1610.encode (buffer);
               openType = new Asn1OpenType 
                  (buffer.getBuffer(), 0, buffer.getMsgByteCnt());
               break;
            ...
            // sib12_v1610
            case _SIB12_V1610:
               SIB12_r16 sib12_v1610 = (SIB12_r16) element;
               sib12_v1610.encode (buffer);
               openType = new Asn1OpenType 
                  (buffer.getBuffer(), 0, buffer.getMsgByteCnt());
               break;
            ...
            // sib13_v1610
            case _SIB13_V1610:
               SIB13_r16 sib13_v1610 = (SIB13_r16) element;
               sib13_v1610.encode (buffer);
               openType = new Asn1OpenType 
                  (buffer.getBuffer(), 0, buffer.getMsgByteCnt());
               break;
            ...
            // sib14_v1610
            case _SIB14_V1610:
               SIB14_r16 sib14_v1610 = (SIB14_r16) element;
               sib14_v1610.encode (buffer);
               openType = new Asn1OpenType 
                  (buffer.getBuffer(), 0, buffer.getMsgByteCnt());
               break;
