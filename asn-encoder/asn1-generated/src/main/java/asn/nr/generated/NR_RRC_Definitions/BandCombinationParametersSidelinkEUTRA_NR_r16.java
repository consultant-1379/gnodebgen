...
public class BandCombinationParametersSidelinkEUTRA_NR_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandCombinationParametersSidelinkEUTRA-NR-r16";
   }

   public BandParametersSidelinkEUTRA_NR_r16[] elements;

   public BandCombinationParametersSidelinkEUTRA_NR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParametersSidelinkEUTRA_NR_r16 (int numRecords) {
      elements = new BandParametersSidelinkEUTRA_NR_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParametersSidelinkEUTRA_NR_r16 (BandParametersSidelinkEUTRA_NR_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParametersSidelinkEUTRA_NR_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParametersSidelinkEUTRA_NR_r16();
