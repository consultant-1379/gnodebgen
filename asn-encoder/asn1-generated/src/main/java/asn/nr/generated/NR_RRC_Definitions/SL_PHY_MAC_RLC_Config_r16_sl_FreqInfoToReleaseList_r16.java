...
public class SL_PHY_MAC_RLC_Config_r16_sl_FreqInfoToReleaseList_r16 extends Asn1SeqOf {
   ...
   public SL_Freq_Id_r16[] elements;

   public SL_PHY_MAC_RLC_Config_r16_sl_FreqInfoToReleaseList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_PHY_MAC_RLC_Config_r16_sl_FreqInfoToReleaseList_r16 (int numRecords) {
      elements = new SL_Freq_Id_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_PHY_MAC_RLC_Config_r16_sl_FreqInfoToReleaseList_r16 (SL_Freq_Id_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_Freq_Id_r16 [numElements];
