...
public class UCI_OnPUSCH_betaOffsets extends Asn1Choice {
   ...
   public UCI_OnPUSCH_betaOffsets () {
      super();
   }

   public UCI_OnPUSCH_betaOffsets (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_dynamic (UCI_OnPUSCH_betaOffsets_dynamic value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         // dynamic
         case 0: { 
            UCI_OnPUSCH_betaOffsets_dynamic dynamic;
            element = dynamic = new UCI_OnPUSCH_betaOffsets_dynamic();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // dynamic
         case _DYNAMIC:
            UCI_OnPUSCH_betaOffsets_dynamic dynamic = (UCI_OnPUSCH_betaOffsets_dynamic) element;
