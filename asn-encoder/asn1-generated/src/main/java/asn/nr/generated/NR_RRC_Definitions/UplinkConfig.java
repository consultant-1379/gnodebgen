...
public class UplinkConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((uplinkBWP_ToReleaseList != null), null);
      buffer.encodeBit ((uplinkBWP_ToAddModList != null), null);
      buffer.encodeBit ((firstActiveUplinkBWP_Id != null), null);
      buffer.encodeBit ((pusch_ServingCellConfig != null), null);
      buffer.encodeBit ((carrierSwitching != null), null);
      ...
      // encode uplinkBWP_ToReleaseList

      if (uplinkBWP_ToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("uplinkBWP_ToReleaseList", -1);

         uplinkBWP_ToReleaseList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("uplinkBWP_ToReleaseList", -1);
      }

      // encode uplinkBWP_ToAddModList

      if (uplinkBWP_ToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("uplinkBWP_ToAddModList", -1);

         uplinkBWP_ToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("uplinkBWP_ToAddModList", -1);
      }

      // encode firstActiveUplinkBWP_Id

      if (firstActiveUplinkBWP_Id != null) {
         buffer.getContext().eventDispatcher.startElement("firstActiveUplinkBWP_Id", -1);

         firstActiveUplinkBWP_Id.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("firstActiveUplinkBWP_Id", -1);
      }

      // encode pusch_ServingCellConfig

      if (pusch_ServingCellConfig != null) {
         buffer.getContext().eventDispatcher.startElement("pusch_ServingCellConfig", -1);

         pusch_ServingCellConfig.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pusch_ServingCellConfig", -1);
      }

      // encode carrierSwitching

      if (carrierSwitching != null) {
         buffer.getContext().eventDispatcher.startElement("carrierSwitching", -1);

         carrierSwitching.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((powerBoostPi2BPSK != null), "optbit");
            buffer.encodeBit ((uplinkChannelBW_PerSCS_List != null), "optbit");
            if (powerBoostPi2BPSK != null) {
               powerBoostPi2BPSK.encode (buffer);
            }
            if (uplinkChannelBW_PerSCS_List != null) {
               uplinkChannelBW_PerSCS_List.encode (buffer);
            }
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((enablePL_RS_UpdateForPUSCH_SRS_r16 != null), "optbit");
            buffer.encodeBit ((enableDefaultBeamPL_ForPUSCH0_0_r16 != null), "optbit");
            buffer.encodeBit ((enableDefaultBeamPL_ForPUCCH_r16 != null), "optbit");
            buffer.encodeBit ((enableDefaultBeamPL_ForSRS_r16 != null), "optbit");
            buffer.encodeBit ((uplinkTxSwitching_r16 != null), "optbit");
            buffer.encodeBit ((mpr_PowerBoost_FR2_r16 != null), "optbit");
            if (enablePL_RS_UpdateForPUSCH_SRS_r16 != null) {
               enablePL_RS_UpdateForPUSCH_SRS_r16.encode (buffer);
            }
            if (enableDefaultBeamPL_ForPUSCH0_0_r16 != null) {
               enableDefaultBeamPL_ForPUSCH0_0_r16.encode (buffer);
            }
            if (enableDefaultBeamPL_ForPUCCH_r16 != null) {
               enableDefaultBeamPL_ForPUCCH_r16.encode (buffer);
            }
            if (enableDefaultBeamPL_ForSRS_r16 != null) {
               enableDefaultBeamPL_ForSRS_r16.encode (buffer);
            }
            if (uplinkTxSwitching_r16 != null) {
               uplinkTxSwitching_r16.encode (buffer);
            }
