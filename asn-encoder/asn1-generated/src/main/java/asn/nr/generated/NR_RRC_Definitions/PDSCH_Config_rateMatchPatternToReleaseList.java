...
public class PDSCH_Config_rateMatchPatternToReleaseList extends Asn1SeqOf {
   ...
   public PDSCH_Config_rateMatchPatternToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDSCH_Config_rateMatchPatternToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public PDSCH_Config_rateMatchPatternToReleaseList (RateMatchPatternId[] elements_) {
      elements = elements_;
   }
