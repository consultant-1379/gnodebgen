...
public class SL_PSSCH_Config_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((sl_PSSCH_DMRS_TimePatternList_r16 != null), null);
      buffer.encodeBit ((sl_BetaOffsets2ndSCI_r16 != null), null);
      buffer.encodeBit ((sl_Scaling_r16 != null), null);

      // encode sl_PSSCH_DMRS_TimePatternList_r16

      if (sl_PSSCH_DMRS_TimePatternList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_PSSCH_DMRS_TimePatternList_r16", -1);

         sl_PSSCH_DMRS_TimePatternList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_PSSCH_DMRS_TimePatternList_r16", -1);
      }

      // encode sl_BetaOffsets2ndSCI_r16

      if (sl_BetaOffsets2ndSCI_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_BetaOffsets2ndSCI_r16", -1);

         sl_BetaOffsets2ndSCI_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_BetaOffsets2ndSCI_r16", -1);
      }

      // encode sl_Scaling_r16

      if (sl_Scaling_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_Scaling_r16", -1);

         sl_Scaling_r16.encode (buffer);
