...
public class PDCP_Config extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((drb != null), null);
      buffer.encodeBit ((moreThanOneRLC != null), null);
      buffer.encodeBit ((t_Reordering != null), null);
      ...
      // encode moreThanOneRLC

      if (moreThanOneRLC != null) {
         buffer.getContext().eventDispatcher.startElement("moreThanOneRLC", -1);

         moreThanOneRLC.encode (buffer);
      ...
      if (t_Reordering != null) {
         buffer.getContext().eventDispatcher.startElement("t_Reordering", -1);

         t_Reordering.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((cipheringDisabled != null), "optbit");
            if (cipheringDisabled != null) {
               cipheringDisabled.encode (buffer);
            }
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((discardTimerExt_r16 != null), "optbit");
            buffer.encodeBit ((moreThanTwoRLC_DRB_r16 != null), "optbit");
            buffer.encodeBit ((ethernetHeaderCompression_r16 != null), "optbit");
            if (discardTimerExt_r16 != null) {
               discardTimerExt_r16.encode (buffer);
            }
            if (moreThanTwoRLC_DRB_r16 != null) {
               moreThanTwoRLC_DRB_r16.encode (buffer);
            }
            if (ethernetHeaderCompression_r16 != null) {
               ethernetHeaderCompression_r16.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
