...
public class SRS_ResourceListConfigCLI_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SRS-ResourceListConfigCLI-r16";
   }

   public SRS_ResourceConfigCLI_r16[] elements;

   public SRS_ResourceListConfigCLI_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRS_ResourceListConfigCLI_r16 (int numRecords) {
      elements = new SRS_ResourceConfigCLI_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SRS_ResourceListConfigCLI_r16 (SRS_ResourceConfigCLI_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRS_ResourceConfigCLI_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRS_ResourceConfigCLI_r16();
