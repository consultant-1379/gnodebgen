...
public class PUSCH_PowerControl extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((msg3_Alpha != null), null);
      buffer.encodeBit ((p0_NominalWithoutGrant != null), null);
      buffer.encodeBit ((p0_AlphaSets != null), null);
      buffer.encodeBit ((pathlossReferenceRSToAddModList != null), null);
      buffer.encodeBit ((pathlossReferenceRSToReleaseList != null), null);
      buffer.encodeBit ((twoPUSCH_PC_AdjustmentStates != null), null);
      buffer.encodeBit ((deltaMCS != null), null);
      buffer.encodeBit ((sri_PUSCH_MappingToAddModList != null), null);
      buffer.encodeBit ((sri_PUSCH_MappingToReleaseList != null), null);
      ...
      if (msg3_Alpha != null) {
         ...
         msg3_Alpha.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("msg3_Alpha", -1);
      }

      // encode p0_NominalWithoutGrant

      if (p0_NominalWithoutGrant != null) {
         buffer.getContext().eventDispatcher.startElement("p0_NominalWithoutGrant", -1);

         p0_NominalWithoutGrant.encode (buffer, -202, 24);
      ...
      if (p0_AlphaSets != null) {
         buffer.getContext().eventDispatcher.startElement("p0_AlphaSets", -1);

         p0_AlphaSets.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("p0_AlphaSets", -1);
      }

      // encode pathlossReferenceRSToAddModList

      if (pathlossReferenceRSToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("pathlossReferenceRSToAddModList", -1);

         pathlossReferenceRSToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pathlossReferenceRSToAddModList", -1);
      }

      // encode pathlossReferenceRSToReleaseList

      if (pathlossReferenceRSToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("pathlossReferenceRSToReleaseList", -1);

         pathlossReferenceRSToReleaseList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pathlossReferenceRSToReleaseList", -1);
      }

      // encode twoPUSCH_PC_AdjustmentStates

      if (twoPUSCH_PC_AdjustmentStates != null) {
         buffer.getContext().eventDispatcher.startElement("twoPUSCH_PC_AdjustmentStates", -1);

         twoPUSCH_PC_AdjustmentStates.encode (buffer);
      ...
      if (deltaMCS != null) {
         ...
         deltaMCS.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("deltaMCS", -1);
      }

      // encode sri_PUSCH_MappingToAddModList

      if (sri_PUSCH_MappingToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("sri_PUSCH_MappingToAddModList", -1);

         sri_PUSCH_MappingToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sri_PUSCH_MappingToAddModList", -1);
      }

      // encode sri_PUSCH_MappingToReleaseList

      if (sri_PUSCH_MappingToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("sri_PUSCH_MappingToReleaseList", -1);

         sri_PUSCH_MappingToReleaseList.encode (buffer);
