...
public class RRCReconfiguration_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((secondaryCellGroup != null), null);
      ...
      // encode secondaryCellGroup

      if (secondaryCellGroup != null) {
         buffer.getContext().eventDispatcher.startElement("secondaryCellGroup", -1);

         Asn1OctetString secondaryCellGroup_outer;
         {
            Asn1PerEncodeBuffer savedBuffer = buffer;
            buffer = new Asn1PerEncodeBuffer(buffer.isAligned());
            secondaryCellGroup.encode (buffer);
            secondaryCellGroup_outer = new Asn1OctetString(buffer.getMsgCopy() );
            buffer = savedBuffer;
         }
         secondaryCellGroup_outer.encode (buffer);
