...
public class PDCCH_Config_tpc_PUSCH extends Asn1Choice {
   ...
   public PDCCH_Config_tpc_PUSCH () {
      super();
   }

   public PDCCH_Config_tpc_PUSCH (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (PUSCH_TPC_CommandConfig value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            PUSCH_TPC_CommandConfig setup;
            element = setup = new PUSCH_TPC_CommandConfig();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            PUSCH_TPC_CommandConfig setup = (PUSCH_TPC_CommandConfig) element;
            setup.encode (buffer);
            break;
