...
public class SIB1_v1610_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((idleModeMeasurementsEUTRA_r16 != null), null);
      buffer.encodeBit ((idleModeMeasurementsNR_r16 != null), null);
      buffer.encodeBit ((posSI_SchedulingInfo_r16 != null), null);
      buffer.encodeBit ((nonCriticalExtension != null), null);

      // encode idleModeMeasurementsEUTRA_r16

      if (idleModeMeasurementsEUTRA_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("idleModeMeasurementsEUTRA_r16", -1);

         idleModeMeasurementsEUTRA_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("idleModeMeasurementsEUTRA_r16", -1);
      }

      // encode idleModeMeasurementsNR_r16

      if (idleModeMeasurementsNR_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("idleModeMeasurementsNR_r16", -1);

         idleModeMeasurementsNR_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("idleModeMeasurementsNR_r16", -1);
      }

      // encode posSI_SchedulingInfo_r16

      if (posSI_SchedulingInfo_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("posSI_SchedulingInfo_r16", -1);

         posSI_SchedulingInfo_r16.encode (buffer);
