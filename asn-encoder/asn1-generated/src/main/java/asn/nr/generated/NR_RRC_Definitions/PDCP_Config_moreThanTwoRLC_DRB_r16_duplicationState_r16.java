...
public class PDCP_Config_moreThanTwoRLC_DRB_r16_duplicationState_r16 extends Asn1SeqOf {
   ...
   public Asn1Boolean[] elements;

   public PDCP_Config_moreThanTwoRLC_DRB_r16_duplicationState_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDCP_Config_moreThanTwoRLC_DRB_r16_duplicationState_r16 (int numRecords) {
      elements = new Asn1Boolean [numRecords];
   }
    ...
    * given the array.  
    */
   public PDCP_Config_moreThanTwoRLC_DRB_r16_duplicationState_r16 (Asn1Boolean[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (3, 3);
      int numElements = (int) buffer.decodeLength();

      elements = new Asn1Boolean [numElements];
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 3, 3);
