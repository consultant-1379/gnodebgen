...
public class MeasObjectNR_t312_r16 extends Asn1Choice {
   ...
   public MeasObjectNR_t312_r16 () {
      super();
   }

   public MeasObjectNR_t312_r16 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (T312_r16 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 1: { 
            T312_r16 setup;
            int tval = T312_r16.decodeEnumValue (buffer);
            element = setup = T312_r16.valueOf (tval);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            T312_r16 setup = (T312_r16) element;
            setup.encode (buffer);
            break;
