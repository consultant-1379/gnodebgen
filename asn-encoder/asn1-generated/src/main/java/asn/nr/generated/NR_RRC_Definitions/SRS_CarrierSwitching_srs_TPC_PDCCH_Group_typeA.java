...
public class SRS_CarrierSwitching_srs_TPC_PDCCH_Group_typeA extends Asn1SeqOf {
   ...
   public SRS_TPC_PDCCH_Config[] elements;

   public SRS_CarrierSwitching_srs_TPC_PDCCH_Group_typeA () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRS_CarrierSwitching_srs_TPC_PDCCH_Group_typeA (int numRecords) {
      elements = new SRS_TPC_PDCCH_Config [numRecords];
   }
    ...
    * given the array.  
    */
   public SRS_CarrierSwitching_srs_TPC_PDCCH_Group_typeA (SRS_TPC_PDCCH_Config[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRS_TPC_PDCCH_Config [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRS_TPC_PDCCH_Config();
