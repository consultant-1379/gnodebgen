...
public class CSI_ResourceConfig_csi_RS_ResourceSetList_csi_IM_ResourceSetList extends Asn1SeqOf {
   ...
   public CSI_IM_ResourceSetId[] elements;

   public CSI_ResourceConfig_csi_RS_ResourceSetList_csi_IM_ResourceSetList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_ResourceConfig_csi_RS_ResourceSetList_csi_IM_ResourceSetList (int numRecords) {
      elements = new CSI_IM_ResourceSetId [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_ResourceConfig_csi_RS_ResourceSetList_csi_IM_ResourceSetList (CSI_IM_ResourceSetId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_IM_ResourceSetId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_IM_ResourceSetId();
