...
public class CSI_MeasConfig_csi_IM_ResourceToAddModList extends Asn1SeqOf {
   ...
   public CSI_IM_Resource[] elements;

   public CSI_MeasConfig_csi_IM_ResourceToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_csi_IM_ResourceToAddModList (int numRecords) {
      elements = new CSI_IM_Resource [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_MeasConfig_csi_IM_ResourceToAddModList (CSI_IM_Resource[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_IM_Resource [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_IM_Resource();
