...
public class FeatureSets_featureSetsUplinkPerCC extends Asn1SeqOf {
   ...
   public FeatureSetUplinkPerCC[] elements;

   public FeatureSets_featureSetsUplinkPerCC () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSets_featureSetsUplinkPerCC (int numRecords) {
      elements = new FeatureSetUplinkPerCC [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSets_featureSetsUplinkPerCC (FeatureSetUplinkPerCC[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetUplinkPerCC [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetUplinkPerCC();
