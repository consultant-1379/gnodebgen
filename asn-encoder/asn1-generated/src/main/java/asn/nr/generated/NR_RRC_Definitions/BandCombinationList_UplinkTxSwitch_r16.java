...
public class BandCombinationList_UplinkTxSwitch_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandCombinationList-UplinkTxSwitch-r16";
   }

   public BandCombination_UplinkTxSwitch_r16[] elements;

   public BandCombinationList_UplinkTxSwitch_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationList_UplinkTxSwitch_r16 (int numRecords) {
      elements = new BandCombination_UplinkTxSwitch_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationList_UplinkTxSwitch_r16 (BandCombination_UplinkTxSwitch_r16[] elements_) {
      elements = elements_;
   }
   ...
   {
      int fraglen = 0;
      java.util.LinkedList<BandCombination_UplinkTxSwitch_r16> tmplist = 
         new java.util.LinkedList<BandCombination_UplinkTxSwitch_r16>();
      BandCombination_UplinkTxSwitch_r16 value;
      ...
      for (;;) {
         ...
         for (int i = 0; i < fraglen; i++) {
            ...
            value = new BandCombination_UplinkTxSwitch_r16();
            value.decode (buffer);
      ...
      elements = new BandCombination_UplinkTxSwitch_r16 [tmplist.size()];
