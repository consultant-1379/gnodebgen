...
public class UL_DelayValueConfig_r16_delay_DRBlist extends Asn1SeqOf {
   ...
   public UL_DelayValueConfig_r16_delay_DRBlist () {
      elements = null;
   }
    ...
    * populated.
    */
   public UL_DelayValueConfig_r16_delay_DRBlist (int numRecords) {
    ...
    * given the array.  
    */
   public UL_DelayValueConfig_r16_delay_DRBlist (DRB_Identity[] elements_) {
      elements = elements_;
   }
