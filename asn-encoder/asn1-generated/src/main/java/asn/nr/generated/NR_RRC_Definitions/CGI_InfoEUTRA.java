...
public class CGI_InfoEUTRA extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((cgi_info_EPC != null), null);
      buffer.encodeBit ((cgi_info_5GC != null), null);
      buffer.encodeBit ((multiBandInfoList != null), null);
      buffer.encodeBit ((freqBandIndicatorPriority != null), null);

      // encode cgi_info_EPC

      if (cgi_info_EPC != null) {
         buffer.getContext().eventDispatcher.startElement("cgi_info_EPC", -1);

         cgi_info_EPC.encode (buffer);
      ...
      if (cgi_info_5GC != null) {
         buffer.getContext().eventDispatcher.startElement("cgi_info_5GC", -1);

         cgi_info_5GC.encode (buffer);
      ...
      if (freqBandIndicator != null) {
         buffer.getContext().eventDispatcher.startElement("freqBandIndicator", -1);

         freqBandIndicator.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("freqBandIndicator", -1);
      }
      else throw new Asn1MissingRequiredException ("freqBandIndicator");

      // encode multiBandInfoList

      if (multiBandInfoList != null) {
         buffer.getContext().eventDispatcher.startElement("multiBandInfoList", -1);

         multiBandInfoList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("multiBandInfoList", -1);
      }

      // encode freqBandIndicatorPriority

      if (freqBandIndicatorPriority != null) {
         buffer.getContext().eventDispatcher.startElement("freqBandIndicatorPriority", -1);

         freqBandIndicatorPriority.encode (buffer);
