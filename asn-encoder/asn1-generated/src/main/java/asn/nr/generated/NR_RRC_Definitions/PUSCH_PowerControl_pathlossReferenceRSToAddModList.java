...
public class PUSCH_PowerControl_pathlossReferenceRSToAddModList extends Asn1SeqOf {
   ...
   public PUSCH_PathlossReferenceRS[] elements;

   public PUSCH_PowerControl_pathlossReferenceRSToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUSCH_PowerControl_pathlossReferenceRSToAddModList (int numRecords) {
      elements = new PUSCH_PathlossReferenceRS [numRecords];
   }
    ...
    * given the array.  
    */
   public PUSCH_PowerControl_pathlossReferenceRSToAddModList (PUSCH_PathlossReferenceRS[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUSCH_PathlossReferenceRS [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUSCH_PathlossReferenceRS();
