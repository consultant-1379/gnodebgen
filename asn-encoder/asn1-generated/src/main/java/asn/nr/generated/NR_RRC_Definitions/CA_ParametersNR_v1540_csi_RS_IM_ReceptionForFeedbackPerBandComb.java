...
public class CA_ParametersNR_v1540_csi_RS_IM_ReceptionForFeedbackPerBandComb extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((maxNumberSimultaneousNZP_CSI_RS_ActBWP_AllCC != null), null);
      buffer.encodeBit ((totalNumberPortsSimultaneousNZP_CSI_RS_ActBWP_AllCC != null), null);

      // encode maxNumberSimultaneousNZP_CSI_RS_ActBWP_AllCC

      if (maxNumberSimultaneousNZP_CSI_RS_ActBWP_AllCC != null) {
         buffer.getContext().eventDispatcher.startElement("maxNumberSimultaneousNZP_CSI_RS_ActBWP_AllCC", -1);

         maxNumberSimultaneousNZP_CSI_RS_ActBWP_AllCC.encode (buffer, 1, 64);

         buffer.getContext().eventDispatcher.endElement("maxNumberSimultaneousNZP_CSI_RS_ActBWP_AllCC", -1);
      }

      // encode totalNumberPortsSimultaneousNZP_CSI_RS_ActBWP_AllCC

      if (totalNumberPortsSimultaneousNZP_CSI_RS_ActBWP_AllCC != null) {
         buffer.getContext().eventDispatcher.startElement("totalNumberPortsSimultaneousNZP_CSI_RS_ActBWP_AllCC", -1);

         totalNumberPortsSimultaneousNZP_CSI_RS_ActBWP_AllCC.encode (buffer, 2, 256);
