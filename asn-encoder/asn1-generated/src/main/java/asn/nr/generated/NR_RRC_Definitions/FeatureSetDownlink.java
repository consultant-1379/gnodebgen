...
public class FeatureSetDownlink extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((intraBandFreqSeparationDL != null), null);
      buffer.encodeBit ((scalingFactor != null), null);
      buffer.encodeBit ((dummy8 != null), null);
      buffer.encodeBit ((scellWithoutSSB != null), null);
      buffer.encodeBit ((csi_RS_MeasSCellWithoutSSB != null), null);
      buffer.encodeBit ((dummy1 != null), null);
      buffer.encodeBit ((type1_3_CSS != null), null);
      buffer.encodeBit ((pdcch_MonitoringAnyOccasions != null), null);
      buffer.encodeBit ((dummy2 != null), null);
      buffer.encodeBit ((ue_SpecificUL_DL_Assignment != null), null);
      buffer.encodeBit ((searchSpaceSharingCA_DL != null), null);
      buffer.encodeBit ((timeDurationForQCL != null), null);
      buffer.encodeBit ((pdsch_ProcessingType1_DifferentTB_PerSlot != null), null);
      buffer.encodeBit ((dummy3 != null), null);
      buffer.encodeBit ((dummy4 != null), null);
      buffer.encodeBit ((dummy5 != null), null);
      buffer.encodeBit ((dummy6 != null), null);
      buffer.encodeBit ((dummy7 != null), null);

      // encode featureSetListPerDownlinkCC

      if (featureSetListPerDownlinkCC != null) {
         buffer.getContext().eventDispatcher.startElement("featureSetListPerDownlinkCC", -1);

         featureSetListPerDownlinkCC.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("featureSetListPerDownlinkCC", -1);
      }
      else throw new Asn1MissingRequiredException ("featureSetListPerDownlinkCC");

      // encode intraBandFreqSeparationDL

      if (intraBandFreqSeparationDL != null) {
         buffer.getContext().eventDispatcher.startElement("intraBandFreqSeparationDL", -1);

         intraBandFreqSeparationDL.encode (buffer);
      ...
      if (dummy8 != null) {
         ...
         dummy8.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("dummy8", -1);
      }

      // encode scellWithoutSSB

      if (scellWithoutSSB != null) {
         buffer.getContext().eventDispatcher.startElement("scellWithoutSSB", -1);

         scellWithoutSSB.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("scellWithoutSSB", -1);
      }

      // encode csi_RS_MeasSCellWithoutSSB

      if (csi_RS_MeasSCellWithoutSSB != null) {
         buffer.getContext().eventDispatcher.startElement("csi_RS_MeasSCellWithoutSSB", -1);

         csi_RS_MeasSCellWithoutSSB.encode (buffer);
      ...
      if (type1_3_CSS != null) {
         ...
         type1_3_CSS.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("type1_3_CSS", -1);
      }

      // encode pdcch_MonitoringAnyOccasions

      if (pdcch_MonitoringAnyOccasions != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_MonitoringAnyOccasions", -1);

         pdcch_MonitoringAnyOccasions.encode (buffer);
      ...
      // encode ue_SpecificUL_DL_Assignment

      if (ue_SpecificUL_DL_Assignment != null) {
         buffer.getContext().eventDispatcher.startElement("ue_SpecificUL_DL_Assignment", -1);

         ue_SpecificUL_DL_Assignment.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ue_SpecificUL_DL_Assignment", -1);
      }

      // encode searchSpaceSharingCA_DL

      if (searchSpaceSharingCA_DL != null) {
         buffer.getContext().eventDispatcher.startElement("searchSpaceSharingCA_DL", -1);

         searchSpaceSharingCA_DL.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("searchSpaceSharingCA_DL", -1);
      }

      // encode timeDurationForQCL

      if (timeDurationForQCL != null) {
         buffer.getContext().eventDispatcher.startElement("timeDurationForQCL", -1);

         timeDurationForQCL.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("timeDurationForQCL", -1);
      }

      // encode pdsch_ProcessingType1_DifferentTB_PerSlot

      if (pdsch_ProcessingType1_DifferentTB_PerSlot != null) {
         buffer.getContext().eventDispatcher.startElement("pdsch_ProcessingType1_DifferentTB_PerSlot", -1);

         pdsch_ProcessingType1_DifferentTB_PerSlot.encode (buffer);
