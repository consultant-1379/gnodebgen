...
public class PerRAAttemptInfo_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((contentionDetected_r16 != null), null);
      buffer.encodeBit ((dlRSRPAboveThreshold_r16 != null), null);

      // encode contentionDetected_r16

      if (contentionDetected_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("contentionDetected_r16", -1);

         contentionDetected_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("contentionDetected_r16", -1);
      }

      // encode dlRSRPAboveThreshold_r16

      if (dlRSRPAboveThreshold_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("dlRSRPAboveThreshold_r16", -1);

         dlRSRPAboveThreshold_r16.encode (buffer);
