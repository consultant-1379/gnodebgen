...
public class MeasConfigMN_measGapConfig extends Asn1Choice {
   ...
   public MeasConfigMN_measGapConfig () {
      super();
   }

   public MeasConfigMN_measGapConfig (byte choiceId_, Asn1Type element_) {
      super();
