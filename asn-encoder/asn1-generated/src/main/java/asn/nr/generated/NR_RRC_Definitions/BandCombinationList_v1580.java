...
public class BandCombinationList_v1580 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandCombinationList-v1580";
   }

   public BandCombination_v1580[] elements;

   public BandCombinationList_v1580 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationList_v1580 (int numRecords) {
      elements = new BandCombination_v1580 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationList_v1580 (BandCombination_v1580[] elements_) {
      elements = elements_;
   }
   ...
   {
      int fraglen = 0;
      java.util.LinkedList<BandCombination_v1580> tmplist = 
         new java.util.LinkedList<BandCombination_v1580>();
      BandCombination_v1580 value;
      ...
      for (;;) {
         ...
         for (int i = 0; i < fraglen; i++) {
            ...
            value = new BandCombination_v1580();
            value.decode (buffer);
      ...
      elements = new BandCombination_v1580 [tmplist.size()];
