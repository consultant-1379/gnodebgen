...
public class PUCCH_Config_dl_DataToUL_ACK extends Asn1SeqOf {
   ...
   public PUCCH_Config_dl_DataToUL_ACK () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_dl_DataToUL_ACK (int numRecords) {
    ...
    * given the array.  
    */
   public PUCCH_Config_dl_DataToUL_ACK (Asn1Integer[] elements_) {
      elements = elements_;
   }
