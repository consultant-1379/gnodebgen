...
public class PUSCH_ConfigCommon extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((groupHoppingEnabledTransformPrecoding != null), null);
      buffer.encodeBit ((pusch_TimeDomainAllocationList != null), null);
      buffer.encodeBit ((msg3_DeltaPreamble != null), null);
      buffer.encodeBit ((p0_NominalWithGrant != null), null);

      // encode groupHoppingEnabledTransformPrecoding

      if (groupHoppingEnabledTransformPrecoding != null) {
         buffer.getContext().eventDispatcher.startElement("groupHoppingEnabledTransformPrecoding", -1);

         groupHoppingEnabledTransformPrecoding.encode (buffer);
      ...
      // encode msg3_DeltaPreamble

      if (msg3_DeltaPreamble != null) {
         buffer.getContext().eventDispatcher.startElement("msg3_DeltaPreamble", -1);

         msg3_DeltaPreamble.encode (buffer, -1, 6);

         buffer.getContext().eventDispatcher.endElement("msg3_DeltaPreamble", -1);
      }

      // encode p0_NominalWithGrant

      if (p0_NominalWithGrant != null) {
         buffer.getContext().eventDispatcher.startElement("p0_NominalWithGrant", -1);

         p0_NominalWithGrant.encode (buffer, -202, 24);
