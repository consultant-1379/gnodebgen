...
public class BeamFailureRecoveryConfig extends Asn1Seq {
   ...
   public BeamFailureRecoveryConfig_spCell_BFR_CBRA_r16 spCell_BFR_CBRA_r16 = null;  // optional
   ...
   public BeamFailureRecoveryConfig (
      ...
      BeamFailureRecoveryConfig_spCell_BFR_CBRA_r16 spCell_BFR_CBRA_r16_
   ) {
      super();
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 12: return spCell_BFR_CBRA_r16;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 12: return "spCell-BFR-CBRA-r16";
         case 13: return null;
         default: return null;
      }
   }
      ...
      if (extbit) {
         ...
         if (i < bitcnt && bitmap[i++]) {
            ...
            if (spCell_BFR_CBRA_r16Present) {
               ...
               int tval = BeamFailureRecoveryConfig_spCell_BFR_CBRA_r16.decodeEnumValue (buffer);
               spCell_BFR_CBRA_r16 = BeamFailureRecoveryConfig_spCell_BFR_CBRA_r16.valueOf (tval);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((rootSequenceIndex_BFR != null), null);
      buffer.encodeBit ((rach_ConfigBFR != null), null);
      buffer.encodeBit ((rsrp_ThresholdSSB != null), null);
      buffer.encodeBit ((candidateBeamRSList != null), null);
      buffer.encodeBit ((ssb_perRACH_Occasion != null), null);
      buffer.encodeBit ((ra_ssb_OccasionMaskIndex != null), null);
      buffer.encodeBit ((recoverySearchSpaceId != null), null);
      buffer.encodeBit ((ra_Prioritization != null), null);
      buffer.encodeBit ((beamFailureRecoveryTimer != null), null);

      // encode rootSequenceIndex_BFR

      if (rootSequenceIndex_BFR != null) {
         buffer.getContext().eventDispatcher.startElement("rootSequenceIndex_BFR", -1);

         rootSequenceIndex_BFR.encode (buffer, 0, 137);

         buffer.getContext().eventDispatcher.endElement("rootSequenceIndex_BFR", -1);
      }

      // encode rach_ConfigBFR

      if (rach_ConfigBFR != null) {
         buffer.getContext().eventDispatcher.startElement("rach_ConfigBFR", -1);

         rach_ConfigBFR.encode (buffer);
      ...
      // encode candidateBeamRSList

      if (candidateBeamRSList != null) {
         buffer.getContext().eventDispatcher.startElement("candidateBeamRSList", -1);

         candidateBeamRSList.encode (buffer);
      ...
      // encode recoverySearchSpaceId

      if (recoverySearchSpaceId != null) {
         buffer.getContext().eventDispatcher.startElement("recoverySearchSpaceId", -1);

         recoverySearchSpaceId.encode (buffer);
      ...
      // encode beamFailureRecoveryTimer

      if (beamFailureRecoveryTimer != null) {
         buffer.getContext().eventDispatcher.startElement("beamFailureRecoveryTimer", -1);

         beamFailureRecoveryTimer.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((msg1_SubcarrierSpacing != null), "optbit");
         ...
         if (mV3ExtPresent) {
            ...
            buffer.encodeBit ((candidateBeamRSListExt_v1610 != null), "optbit");
            if (ra_PrioritizationTwoStep_r16 != null) {
               ra_PrioritizationTwoStep_r16.encode (buffer);
            }
            if (candidateBeamRSListExt_v1610 != null) {
               candidateBeamRSListExt_v1610.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
