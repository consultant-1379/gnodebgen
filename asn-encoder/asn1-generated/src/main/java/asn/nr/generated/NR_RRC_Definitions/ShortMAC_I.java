...
public class ShortMAC_I extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public ShortMAC_I (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public ShortMAC_I (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public ShortMAC_I (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public ShortMAC_I (java.util.BitSet bitSet) {
      super (bitSet);
   }
