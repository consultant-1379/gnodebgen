...
public class CGI_InfoEUTRA_cgi_info_EPC_cgi_info_EPC_list extends Asn1SeqOf {
   ...
   public CellAccessRelatedInfo_EUTRA_EPC[] elements;

   public CGI_InfoEUTRA_cgi_info_EPC_cgi_info_EPC_list () {
      elements = null;
   }
    ...
    * populated.
    */
   public CGI_InfoEUTRA_cgi_info_EPC_cgi_info_EPC_list (int numRecords) {
      elements = new CellAccessRelatedInfo_EUTRA_EPC [numRecords];
   }
    ...
    * given the array.  
    */
   public CGI_InfoEUTRA_cgi_info_EPC_cgi_info_EPC_list (CellAccessRelatedInfo_EUTRA_EPC[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellAccessRelatedInfo_EUTRA_EPC [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellAccessRelatedInfo_EUTRA_EPC();
