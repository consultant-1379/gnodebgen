...
public class SL_CBR_PriorityTxConfigList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-CBR-PriorityTxConfigList-r16";
   }

   public SL_PriorityTxConfigIndex_r16[] elements;

   public SL_CBR_PriorityTxConfigList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_CBR_PriorityTxConfigList_r16 (int numRecords) {
      elements = new SL_PriorityTxConfigIndex_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_CBR_PriorityTxConfigList_r16 (SL_PriorityTxConfigIndex_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_PriorityTxConfigIndex_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_PriorityTxConfigIndex_r16();
