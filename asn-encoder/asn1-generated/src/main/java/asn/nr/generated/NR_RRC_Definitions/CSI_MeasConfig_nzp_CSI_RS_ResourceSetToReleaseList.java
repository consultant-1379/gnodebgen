...
public class CSI_MeasConfig_nzp_CSI_RS_ResourceSetToReleaseList extends Asn1SeqOf {
   ...
   public CSI_MeasConfig_nzp_CSI_RS_ResourceSetToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_nzp_CSI_RS_ResourceSetToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public CSI_MeasConfig_nzp_CSI_RS_ResourceSetToReleaseList (NZP_CSI_RS_ResourceSetId[] elements_) {
      elements = elements_;
   }
