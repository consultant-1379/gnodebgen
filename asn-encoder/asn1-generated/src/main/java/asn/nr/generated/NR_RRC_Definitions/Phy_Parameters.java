...
public class Phy_Parameters extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((phy_ParametersCommon != null), null);
      buffer.encodeBit ((phy_ParametersXDD_Diff != null), null);
      buffer.encodeBit ((phy_ParametersFRX_Diff != null), null);
      buffer.encodeBit ((phy_ParametersFR1 != null), null);
      buffer.encodeBit ((phy_ParametersFR2 != null), null);

      // encode phy_ParametersCommon

      if (phy_ParametersCommon != null) {
         buffer.getContext().eventDispatcher.startElement("phy_ParametersCommon", -1);

         phy_ParametersCommon.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("phy_ParametersCommon", -1);
      }

      // encode phy_ParametersXDD_Diff

      if (phy_ParametersXDD_Diff != null) {
         buffer.getContext().eventDispatcher.startElement("phy_ParametersXDD_Diff", -1);

         phy_ParametersXDD_Diff.encode (buffer);
      ...
      // encode phy_ParametersFR1

      if (phy_ParametersFR1 != null) {
         buffer.getContext().eventDispatcher.startElement("phy_ParametersFR1", -1);

         phy_ParametersFR1.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("phy_ParametersFR1", -1);
      }

      // encode phy_ParametersFR2

      if (phy_ParametersFR2 != null) {
         buffer.getContext().eventDispatcher.startElement("phy_ParametersFR2", -1);

         phy_ParametersFR2.encode (buffer);
