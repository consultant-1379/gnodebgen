...
public class ServingCellConfig_ca_SlotOffset_r16 extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // refSCS15kHz
         case _REFSCS15KHZ:
            Asn1Integer refSCS15kHz = (Asn1Integer) element;
            refSCS15kHz.encode (buffer, -2, 2);
            break;

         // refSCS30KHz
         case _REFSCS30KHZ:
            Asn1Integer refSCS30KHz = (Asn1Integer) element;
            refSCS30KHz.encode (buffer, -5, 5);
            break;

         // refSCS60KHz
         case _REFSCS60KHZ:
            Asn1Integer refSCS60KHz = (Asn1Integer) element;
            refSCS60KHz.encode (buffer, -10, 10);
            break;

         // refSCS120KHz
         case _REFSCS120KHZ:
            Asn1Integer refSCS120KHz = (Asn1Integer) element;
            refSCS120KHz.encode (buffer, -20, 20);
            break;
