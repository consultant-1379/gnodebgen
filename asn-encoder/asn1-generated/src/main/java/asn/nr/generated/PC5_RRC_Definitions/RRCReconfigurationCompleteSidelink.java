...
public class RRCReconfigurationCompleteSidelink extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCReconfigurationCompleteSidelink";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier_r16;
   public RRCReconfigurationCompleteSidelink_criticalExtensions criticalExtensions;

   public RRCReconfigurationCompleteSidelink () {
      super();
      init();
   }
   ...
   public RRCReconfigurationCompleteSidelink (
      ...
      RRCReconfigurationCompleteSidelink_criticalExtensions criticalExtensions_
   ) {
      super();
    ...
    * the given objects 
    */
   public RRCReconfigurationCompleteSidelink (long rrc_TransactionIdentifier_r16_,
      RRCReconfigurationCompleteSidelink_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCReconfigurationCompleteSidelink_criticalExtensions();
   ...
   public void encode (Asn1PerEncodeBuffer buffer)
      throws Asn1Exception, java.io.IOException
   {
      // encode rrc_TransactionIdentifier_r16

      if (rrc_TransactionIdentifier_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("rrc_TransactionIdentifier_r16", -1);

         rrc_TransactionIdentifier_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("rrc_TransactionIdentifier_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("rrc_TransactionIdentifier_r16");
