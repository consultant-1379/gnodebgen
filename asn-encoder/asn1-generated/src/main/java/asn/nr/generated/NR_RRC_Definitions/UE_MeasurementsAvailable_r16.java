...
public class UE_MeasurementsAvailable_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((logMeasAvailable_r16 != null), null);
      buffer.encodeBit ((logMeasAvailableBT_r16 != null), null);
      buffer.encodeBit ((logMeasAvailableWLAN_r16 != null), null);
      buffer.encodeBit ((connEstFailInfoAvailable_r16 != null), null);
      buffer.encodeBit ((rlf_InfoAvailable_r16 != null), null);

      // encode logMeasAvailable_r16

      if (logMeasAvailable_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("logMeasAvailable_r16", -1);

         logMeasAvailable_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("logMeasAvailable_r16", -1);
      }

      // encode logMeasAvailableBT_r16

      if (logMeasAvailableBT_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("logMeasAvailableBT_r16", -1);

         logMeasAvailableBT_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("logMeasAvailableBT_r16", -1);
      }

      // encode logMeasAvailableWLAN_r16

      if (logMeasAvailableWLAN_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("logMeasAvailableWLAN_r16", -1);

         logMeasAvailableWLAN_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("logMeasAvailableWLAN_r16", -1);
      }

      // encode connEstFailInfoAvailable_r16

      if (connEstFailInfoAvailable_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("connEstFailInfoAvailable_r16", -1);

         connEstFailInfoAvailable_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("connEstFailInfoAvailable_r16", -1);
      }

      // encode rlf_InfoAvailable_r16

      if (rlf_InfoAvailable_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("rlf_InfoAvailable_r16", -1);

         rlf_InfoAvailable_r16.encode (buffer);
