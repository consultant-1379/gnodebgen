...
public class CarrierFreqListEUTRA extends Asn1SeqOf {
   ...
   public CarrierFreqEUTRA[] elements;

   public CarrierFreqListEUTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public CarrierFreqListEUTRA (int numRecords) {
      elements = new CarrierFreqEUTRA [numRecords];
   }
    ...
    * given the array.  
    */
   public CarrierFreqListEUTRA (CarrierFreqEUTRA[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CarrierFreqEUTRA [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CarrierFreqEUTRA();
