...
public class AMF_Identifier extends Asn1BitString {
    ...
    */
   public AMF_Identifier (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public AMF_Identifier (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public AMF_Identifier (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public AMF_Identifier (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public AMF_Identifier (java.util.BitSet bitSet) {
      super (bitSet);
   }
