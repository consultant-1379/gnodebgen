...
public class CellGroupConfig_sCellToAddModList extends Asn1SeqOf {
   ...
   public SCellConfig[] elements;

   public CellGroupConfig_sCellToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellGroupConfig_sCellToAddModList (int numRecords) {
      elements = new SCellConfig [numRecords];
   }
    ...
    * given the array.  
    */
   public CellGroupConfig_sCellToAddModList (SCellConfig[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCellConfig [numElements];
