...
public class PDCP_Config_moreThanTwoRLC_DRB_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((splitSecondaryPath_r16 != null), null);
      buffer.encodeBit ((duplicationState_r16 != null), null);

      // encode splitSecondaryPath_r16

      if (splitSecondaryPath_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("splitSecondaryPath_r16", -1);

         splitSecondaryPath_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("splitSecondaryPath_r16", -1);
      }

      // encode duplicationState_r16

      if (duplicationState_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("duplicationState_r16", -1);

         duplicationState_r16.encode (buffer);
