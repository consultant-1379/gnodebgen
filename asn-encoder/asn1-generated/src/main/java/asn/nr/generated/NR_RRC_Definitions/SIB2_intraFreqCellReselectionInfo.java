...
public class SIB2_intraFreqCellReselectionInfo extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((s_IntraSearchQ != null), null);
      ...
      // encode s_IntraSearchP

      if (s_IntraSearchP != null) {
         buffer.getContext().eventDispatcher.startElement("s_IntraSearchP", -1);

         s_IntraSearchP.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("s_IntraSearchP", -1);
      }
      else throw new Asn1MissingRequiredException ("s_IntraSearchP");

      // encode s_IntraSearchQ

      if (s_IntraSearchQ != null) {
         buffer.getContext().eventDispatcher.startElement("s_IntraSearchQ", -1);

         s_IntraSearchQ.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((t_ReselectionNR_SF != null), "optbit");
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((smtc2_LP_r16 != null), "optbit");
            buffer.encodeBit ((ssb_PositionQCL_Common_r16 != null), "optbit");
