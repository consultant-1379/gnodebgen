...
public class DRB_CountInfoList extends Asn1SeqOf {
   ...
   public DRB_CountInfo[] elements;

   public DRB_CountInfoList () {
      elements = null;
   }
    ...
    * populated.
    */
   public DRB_CountInfoList (int numRecords) {
      elements = new DRB_CountInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public DRB_CountInfoList (DRB_CountInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DRB_CountInfo [numElements];
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 0, 29);
