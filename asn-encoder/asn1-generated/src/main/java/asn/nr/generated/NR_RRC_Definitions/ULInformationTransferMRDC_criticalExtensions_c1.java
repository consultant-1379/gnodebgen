...
public class ULInformationTransferMRDC_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _ULINFORMATIONTRANSFERMRDC = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public ULInformationTransferMRDC_criticalExtensions_c1 () {
      super();
   }

   public ULInformationTransferMRDC_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_ulInformationTransferMRDC (ULInformationTransferMRDC_IEs value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ULInformationTransferMRDC_IEs ulInformationTransferMRDC;
            element = ulInformationTransferMRDC = new ULInformationTransferMRDC_IEs();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         case _ULINFORMATIONTRANSFERMRDC:
            ULInformationTransferMRDC_IEs ulInformationTransferMRDC = (ULInformationTransferMRDC_IEs) element;
