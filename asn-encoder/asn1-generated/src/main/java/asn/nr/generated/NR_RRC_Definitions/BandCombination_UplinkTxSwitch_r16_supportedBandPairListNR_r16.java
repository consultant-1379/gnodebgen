...
public class BandCombination_UplinkTxSwitch_r16_supportedBandPairListNR_r16 extends Asn1SeqOf {
   ...
   public ULTxSwitchingBandPair_r16[] elements;

   public BandCombination_UplinkTxSwitch_r16_supportedBandPairListNR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombination_UplinkTxSwitch_r16_supportedBandPairListNR_r16 (int numRecords) {
      elements = new ULTxSwitchingBandPair_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombination_UplinkTxSwitch_r16_supportedBandPairListNR_r16 (ULTxSwitchingBandPair_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ULTxSwitchingBandPair_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ULTxSwitchingBandPair_r16();
