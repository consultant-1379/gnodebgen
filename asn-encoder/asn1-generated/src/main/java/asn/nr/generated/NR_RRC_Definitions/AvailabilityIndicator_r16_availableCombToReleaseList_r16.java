...
public class AvailabilityIndicator_r16_availableCombToReleaseList_r16 extends Asn1SeqOf {
   ...
   public AvailabilityCombinationsPerCellIndex_r16[] elements;

   public AvailabilityIndicator_r16_availableCombToReleaseList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AvailabilityIndicator_r16_availableCombToReleaseList_r16 (int numRecords) {
      elements = new AvailabilityCombinationsPerCellIndex_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public AvailabilityIndicator_r16_availableCombToReleaseList_r16 (AvailabilityCombinationsPerCellIndex_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AvailabilityCombinationsPerCellIndex_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AvailabilityCombinationsPerCellIndex_r16();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 512);
