...
public class SRS_SwitchingTimeNR extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SRS-SwitchingTimeNR";
   }

   public SRS_SwitchingTimeNR_switchingTimeDL switchingTimeDL = null;  // optional
   public SRS_SwitchingTimeNR_switchingTimeUL switchingTimeUL = null;  // optional

   public SRS_SwitchingTimeNR () {
      super();
      init();
   }
    ...
    */
   public SRS_SwitchingTimeNR (
      SRS_SwitchingTimeNR_switchingTimeDL switchingTimeDL_,
      SRS_SwitchingTimeNR_switchingTimeUL switchingTimeUL_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (switchingTimeDLPresent) {
         ...
         int tval = SRS_SwitchingTimeNR_switchingTimeDL.decodeEnumValue (buffer);
         switchingTimeDL = SRS_SwitchingTimeNR_switchingTimeDL.valueOf (tval);
      ...
      if (switchingTimeULPresent) {
         ...
         int tval = SRS_SwitchingTimeNR_switchingTimeUL.decodeEnumValue (buffer);
         switchingTimeUL = SRS_SwitchingTimeNR_switchingTimeUL.valueOf (tval);
