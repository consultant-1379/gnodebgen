...
public class LogicalChannelConfig_ul_SpecificParameters_allowedCG_List_r16 extends Asn1SeqOf {
   ...
   public ConfiguredGrantConfigIndexMAC_r16[] elements;

   public LogicalChannelConfig_ul_SpecificParameters_allowedCG_List_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public LogicalChannelConfig_ul_SpecificParameters_allowedCG_List_r16 (int numRecords) {
      elements = new ConfiguredGrantConfigIndexMAC_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public LogicalChannelConfig_ul_SpecificParameters_allowedCG_List_r16 (ConfiguredGrantConfigIndexMAC_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (0, 31);
      int numElements = (int) buffer.decodeLength();

      elements = new ConfiguredGrantConfigIndexMAC_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ConfiguredGrantConfigIndexMAC_r16();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 0, 31);
