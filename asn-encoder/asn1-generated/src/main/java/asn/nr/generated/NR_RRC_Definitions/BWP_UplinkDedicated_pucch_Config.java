...
public class BWP_UplinkDedicated_pucch_Config extends Asn1Choice {
   ...
   public BWP_UplinkDedicated_pucch_Config () {
      super();
   }

   public BWP_UplinkDedicated_pucch_Config (byte choiceId_, Asn1Type element_) {
      super();
