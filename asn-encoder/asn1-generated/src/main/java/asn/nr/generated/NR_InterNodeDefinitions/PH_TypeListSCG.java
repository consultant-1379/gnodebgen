...
public class PH_TypeListSCG extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PH-TypeListSCG";
   }

   public PH_InfoSCG[] elements;

   public PH_TypeListSCG () {
      elements = null;
   }
    ...
    * populated.
    */
   public PH_TypeListSCG (int numRecords) {
      elements = new PH_InfoSCG [numRecords];
   }
    ...
    * given the array.  
    */
   public PH_TypeListSCG (PH_InfoSCG[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PH_InfoSCG [numElements];
