...
public class PUSCH_PowerControl_p0_AlphaSets extends Asn1SeqOf {
   ...
   public P0_PUSCH_AlphaSet[] elements;

   public PUSCH_PowerControl_p0_AlphaSets () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUSCH_PowerControl_p0_AlphaSets (int numRecords) {
      elements = new P0_PUSCH_AlphaSet [numRecords];
   }
    ...
    * given the array.  
    */
   public PUSCH_PowerControl_p0_AlphaSets (P0_PUSCH_AlphaSet[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 30);
      int numElements = (int) buffer.decodeLength();

      elements = new P0_PUSCH_AlphaSet [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new P0_PUSCH_AlphaSet();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 30);
