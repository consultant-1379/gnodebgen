...
public class MeasObjectEUTRA_blackCellsToAddModListEUTRAN extends Asn1SeqOf {
   ...
   public EUTRA_BlackCell[] elements;

   public MeasObjectEUTRA_blackCellsToAddModListEUTRAN () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasObjectEUTRA_blackCellsToAddModListEUTRAN (int numRecords) {
      elements = new EUTRA_BlackCell [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasObjectEUTRA_blackCellsToAddModListEUTRAN (EUTRA_BlackCell[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EUTRA_BlackCell [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EUTRA_BlackCell();
