...
public class NZP_CSI_RS_ResourceSet_nzp_CSI_RS_Resources extends Asn1SeqOf {
   ...
   public NZP_CSI_RS_ResourceSet_nzp_CSI_RS_Resources () {
      elements = null;
   }
    ...
    * populated.
    */
   public NZP_CSI_RS_ResourceSet_nzp_CSI_RS_Resources (int numRecords) {
    ...
    * given the array.  
    */
   public NZP_CSI_RS_ResourceSet_nzp_CSI_RS_Resources (NZP_CSI_RS_ResourceId[] elements_) {
      elements = elements_;
   }
