...
public class BandParametersSidelinkEUTRA_NR_r16_eutra extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((bandParametersSidelinkEUTRA1_r16 != null), null);
      buffer.encodeBit ((bandParametersSidelinkEUTRA2_r16 != null), null);

      // encode bandParametersSidelinkEUTRA1_r16

      if (bandParametersSidelinkEUTRA1_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("bandParametersSidelinkEUTRA1_r16", -1);

         bandParametersSidelinkEUTRA1_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("bandParametersSidelinkEUTRA1_r16", -1);
      }

      // encode bandParametersSidelinkEUTRA2_r16

      if (bandParametersSidelinkEUTRA2_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("bandParametersSidelinkEUTRA2_r16", -1);

         bandParametersSidelinkEUTRA2_r16.encode (buffer);
