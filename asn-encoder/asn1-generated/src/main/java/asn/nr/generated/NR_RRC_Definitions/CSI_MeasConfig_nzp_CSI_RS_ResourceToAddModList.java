...
public class CSI_MeasConfig_nzp_CSI_RS_ResourceToAddModList extends Asn1SeqOf {
   ...
   public NZP_CSI_RS_Resource[] elements;

   public CSI_MeasConfig_nzp_CSI_RS_ResourceToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_nzp_CSI_RS_ResourceToAddModList (int numRecords) {
      elements = new NZP_CSI_RS_Resource [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_MeasConfig_nzp_CSI_RS_ResourceToAddModList (NZP_CSI_RS_Resource[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NZP_CSI_RS_Resource [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NZP_CSI_RS_Resource();
