...
public class DRB_ToAddModList extends Asn1SeqOf {
    ...
    * populated.
    */
   public DRB_ToAddModList (int numRecords) {
    ...
    * given the array.  
    */
   public DRB_ToAddModList (DRB_ToAddMod[] elements_) {
      elements = elements_;
   }
