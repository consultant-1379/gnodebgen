...
public class CodebookParameters_v1610 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((supportedCSI_RS_ResourceListAlt_r16 != null), null);

      // encode supportedCSI_RS_ResourceListAlt_r16

      if (supportedCSI_RS_ResourceListAlt_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("supportedCSI_RS_ResourceListAlt_r16", -1);

         supportedCSI_RS_ResourceListAlt_r16.encode (buffer);
