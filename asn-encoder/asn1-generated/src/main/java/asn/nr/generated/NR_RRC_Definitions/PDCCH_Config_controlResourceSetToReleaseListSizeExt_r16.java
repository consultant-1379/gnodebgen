...
public class PDCCH_Config_controlResourceSetToReleaseListSizeExt_r16 extends Asn1SeqOf {
   ...
   public ControlResourceSetId_r16[] elements;

   public PDCCH_Config_controlResourceSetToReleaseListSizeExt_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDCCH_Config_controlResourceSetToReleaseListSizeExt_r16 (int numRecords) {
      elements = new ControlResourceSetId_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PDCCH_Config_controlResourceSetToReleaseListSizeExt_r16 (ControlResourceSetId_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ControlResourceSetId_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ControlResourceSetId_r16();
