...
public class PUCCH_SpatialRelationInfo_referenceSignal_srs extends Asn1Seq {
   ...
   public PUCCH_SpatialRelationInfo_referenceSignal_srs () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public PUCCH_SpatialRelationInfo_referenceSignal_srs (long resource_,
      long uplinkBWP_
   ) {
      super();
