...
public class PCCH_Config_firstPDCCH_MonitoringOccasionOfPO_sCS30KHZoneT_SCS15KHZhalfT extends Asn1SeqOf {
   ...
   public PCCH_Config_firstPDCCH_MonitoringOccasionOfPO_sCS30KHZoneT_SCS15KHZhalfT () {
      elements = null;
   }
    ...
    * populated.
    */
   public PCCH_Config_firstPDCCH_MonitoringOccasionOfPO_sCS30KHZoneT_SCS15KHZhalfT (int numRecords) {
    ...
    * given the array.  
    */
   public PCCH_Config_firstPDCCH_MonitoringOccasionOfPO_sCS30KHZoneT_SCS15KHZhalfT (Asn1Integer[] elements_) {
      elements = elements_;
   }
