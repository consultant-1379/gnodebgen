...
public class MeasQuantityResults extends Asn1Seq {
   ...
   public RSRP_Range rsrp;  // optional
   public RSRQ_Range rsrq;  // optional
   public SINR_Range sinr;  // optional

   public MeasQuantityResults () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MeasQuantityResults (long rsrp_,
      long rsrq_,
      long sinr_
   ) {
      super();
      rsrp = new RSRP_Range (rsrp_);
      rsrq = new RSRQ_Range (rsrq_);
      sinr = new SINR_Range (sinr_);
   }
