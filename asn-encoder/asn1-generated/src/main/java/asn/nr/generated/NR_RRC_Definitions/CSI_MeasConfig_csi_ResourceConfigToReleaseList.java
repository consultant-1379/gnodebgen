...
public class CSI_MeasConfig_csi_ResourceConfigToReleaseList extends Asn1SeqOf {
   ...
   public CSI_ResourceConfigId[] elements;

   public CSI_MeasConfig_csi_ResourceConfigToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_csi_ResourceConfigToReleaseList (int numRecords) {
      elements = new CSI_ResourceConfigId [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_MeasConfig_csi_ResourceConfigToReleaseList (CSI_ResourceConfigId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 112);
      int numElements = (int) buffer.decodeLength();

      elements = new CSI_ResourceConfigId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_ResourceConfigId();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 112);
