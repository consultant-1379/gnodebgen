...
public class EUTRA_NS_PmaxList extends Asn1SeqOf {
   ...
   public EUTRA_NS_PmaxValue[] elements;

   public EUTRA_NS_PmaxList () {
      elements = null;
   }
    ...
    * populated.
    */
   public EUTRA_NS_PmaxList (int numRecords) {
      elements = new EUTRA_NS_PmaxValue [numRecords];
   }
    ...
    * given the array.  
    */
   public EUTRA_NS_PmaxList (EUTRA_NS_PmaxValue[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EUTRA_NS_PmaxValue [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EUTRA_NS_PmaxValue();
