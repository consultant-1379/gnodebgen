...
public class TrackingAreaCodeList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "TrackingAreaCodeList-r16";
   }

   public TrackingAreaCode[] elements;

   public TrackingAreaCodeList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public TrackingAreaCodeList_r16 (int numRecords) {
      elements = new TrackingAreaCode [numRecords];
   }
    ...
    * given the array.  
    */
   public TrackingAreaCodeList_r16 (TrackingAreaCode[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TrackingAreaCode [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TrackingAreaCode();
