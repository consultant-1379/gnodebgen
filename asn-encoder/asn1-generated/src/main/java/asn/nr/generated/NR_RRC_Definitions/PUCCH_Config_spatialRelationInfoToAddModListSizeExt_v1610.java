...
public class PUCCH_Config_spatialRelationInfoToAddModListSizeExt_v1610 extends Asn1SeqOf {
   ...
   public PUCCH_SpatialRelationInfo[] elements;

   public PUCCH_Config_spatialRelationInfoToAddModListSizeExt_v1610 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_spatialRelationInfoToAddModListSizeExt_v1610 (int numRecords) {
      elements = new PUCCH_SpatialRelationInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_Config_spatialRelationInfoToAddModListSizeExt_v1610 (PUCCH_SpatialRelationInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUCCH_SpatialRelationInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUCCH_SpatialRelationInfo();
