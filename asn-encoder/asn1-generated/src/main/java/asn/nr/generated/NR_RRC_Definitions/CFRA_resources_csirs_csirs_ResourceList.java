...
public class CFRA_resources_csirs_csirs_ResourceList extends Asn1SeqOf {
   ...
   public CFRA_CSIRS_Resource[] elements;

   public CFRA_resources_csirs_csirs_ResourceList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CFRA_resources_csirs_csirs_ResourceList (int numRecords) {
      elements = new CFRA_CSIRS_Resource [numRecords];
   }
    ...
    * given the array.  
    */
   public CFRA_resources_csirs_csirs_ResourceList (CFRA_CSIRS_Resource[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CFRA_CSIRS_Resource [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CFRA_CSIRS_Resource();
