...
public class FeatureSetDownlink_v1610 extends Asn1Seq {
   ...
   public FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16 cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16;  // optional
   public FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16 cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16;  // optional
    ...
    */
   public FeatureSetDownlink_v1610 (
      FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16 cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16_,
      FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16 cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16_,
      ...
      super();
      cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16 = cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16_;
      cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16 = cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16_;
   ...
   public void init () {
      cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16 = null;
      cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16 = null;
   ...
   public Object getElementValue(int index){
      switch(index)  {
         case 0: return cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16;
         case 1: return cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16;
   ...
   public String getElementName(int index){
      switch(index)  {
         case 0: return "cbgPDSCH-ProcessingType1-DifferentTB-PerSlot-r16";
         case 1: return "cbgPDSCH-ProcessingType2-DifferentTB-PerSlot-r16";
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      boolean cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16Present = buffer.decodeBit ("cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16Present");
      boolean cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16Present = buffer.decodeBit ("cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16Present");
      ...
      // decode cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16

      if (cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16Present) {
         buffer.getContext().eventDispatcher.startElement("cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16", -1);

         cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16 = new FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16();
         cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16.decode (buffer);
         buffer.getContext().eventDispatcher.endElement("cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16", -1);
      }
      else {
         cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16 = null;
      }

      // decode cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16

      if (cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16Present) {
         buffer.getContext().eventDispatcher.startElement("cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16", -1);

         cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16 = new FeatureSetDownlink_v1610_cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16();
         cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16.decode (buffer);
         buffer.getContext().eventDispatcher.endElement("cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16", -1);
      }
      else {
         cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16 = null;
      }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16 != null), null);
      buffer.encodeBit ((cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16 != null), null);
      buffer.encodeBit ((intraFreqDAPS_r16 != null), null);
      buffer.encodeBit ((intraBandFreqSeparationDL_v1620 != null), null);
      buffer.encodeBit ((intraBandFreqSeparationDL_Only_r16 != null), null);
      buffer.encodeBit ((pdcch_Monitoring_r16 != null), null);
      buffer.encodeBit ((pdcch_MonitoringMixed_r16 != null), null);
      buffer.encodeBit ((crossCarrierSchedulingProcessing_DiffSCS_r16 != null), null);
      buffer.encodeBit ((singleDCI_SDM_scheme_r16 != null), null);

      // encode cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16

      if (cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16", -1);

         cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16", -1);
      }

      // encode cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16

      if (cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16", -1);

         cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16", -1);
      }

      // encode intraFreqDAPS_r16

      if (intraFreqDAPS_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("intraFreqDAPS_r16", -1);

         intraFreqDAPS_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("intraFreqDAPS_r16", -1);
      }

      // encode intraBandFreqSeparationDL_v1620

      if (intraBandFreqSeparationDL_v1620 != null) {
         buffer.getContext().eventDispatcher.startElement("intraBandFreqSeparationDL_v1620", -1);

         intraBandFreqSeparationDL_v1620.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("intraBandFreqSeparationDL_v1620", -1);
      }

      // encode intraBandFreqSeparationDL_Only_r16

      if (intraBandFreqSeparationDL_Only_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("intraBandFreqSeparationDL_Only_r16", -1);

         intraBandFreqSeparationDL_Only_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("intraBandFreqSeparationDL_Only_r16", -1);
      }

      // encode pdcch_Monitoring_r16

      if (pdcch_Monitoring_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_Monitoring_r16", -1);

         pdcch_Monitoring_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pdcch_Monitoring_r16", -1);
      }

      // encode pdcch_MonitoringMixed_r16

      if (pdcch_MonitoringMixed_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_MonitoringMixed_r16", -1);

         pdcch_MonitoringMixed_r16.encode (buffer);
      ...
      // encode singleDCI_SDM_scheme_r16

      if (singleDCI_SDM_scheme_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("singleDCI_SDM_scheme_r16", -1);

         singleDCI_SDM_scheme_r16.encode (buffer);
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16 != null) cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16.print (_sb, "cbgPDSCH_ProcessingType1_DifferentTB_PerSlot_r16", _level+1);
      if (cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16 != null) cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16.print (_sb, "cbgPDSCH_ProcessingType2_DifferentTB_PerSlot_r16", _level+1);
