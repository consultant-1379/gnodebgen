...
public class MeasIdleCarrierNR_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((measCellListNR_r16 != null), null);
      buffer.encodeBit ((qualityThreshold_r16 != null), null);
      buffer.encodeBit ((ssb_MeasConfig_r16 != null), null);
      buffer.encodeBit ((beamMeasConfigIdle_r16 != null), null);
      ...
      // encode ssbSubcarrierSpacing_r16

      if (ssbSubcarrierSpacing_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ssbSubcarrierSpacing_r16", -1);

         ssbSubcarrierSpacing_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ssbSubcarrierSpacing_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("ssbSubcarrierSpacing_r16");
      ...
      // encode measCellListNR_r16

      if (measCellListNR_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("measCellListNR_r16", -1);

         measCellListNR_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("measCellListNR_r16", -1);
      }

      // encode reportQuantities_r16

      if (reportQuantities_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("reportQuantities_r16", -1);

         reportQuantities_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("reportQuantities_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("reportQuantities_r16");

      // encode qualityThreshold_r16

      if (qualityThreshold_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("qualityThreshold_r16", -1);

         qualityThreshold_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("qualityThreshold_r16", -1);
      }

      // encode ssb_MeasConfig_r16

      if (ssb_MeasConfig_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ssb_MeasConfig_r16", -1);

         ssb_MeasConfig_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ssb_MeasConfig_r16", -1);
      }

      // encode beamMeasConfigIdle_r16

      if (beamMeasConfigIdle_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("beamMeasConfigIdle_r16", -1);

         beamMeasConfigIdle_r16.encode (buffer);
