...
public class PLMN_IdentityList_EUTRA_5GC extends Asn1SeqOf {
   ...
   public PLMN_Identity_EUTRA_5GC[] elements;

   public PLMN_IdentityList_EUTRA_5GC () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_IdentityList_EUTRA_5GC (int numRecords) {
      elements = new PLMN_Identity_EUTRA_5GC [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMN_IdentityList_EUTRA_5GC (PLMN_Identity_EUTRA_5GC[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PLMN_Identity_EUTRA_5GC [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PLMN_Identity_EUTRA_5GC();
