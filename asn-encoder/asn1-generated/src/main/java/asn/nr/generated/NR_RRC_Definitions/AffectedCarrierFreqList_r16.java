...
public class AffectedCarrierFreqList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AffectedCarrierFreqList-r16";
   }

   public AffectedCarrierFreq_r16[] elements;

   public AffectedCarrierFreqList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AffectedCarrierFreqList_r16 (int numRecords) {
      elements = new AffectedCarrierFreq_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public AffectedCarrierFreqList_r16 (AffectedCarrierFreq_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AffectedCarrierFreq_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AffectedCarrierFreq_r16();
