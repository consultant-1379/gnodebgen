...
public class UplinkTxDirectCurrentTwoCarrierList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "UplinkTxDirectCurrentTwoCarrierList-r16";
   }

   public UplinkTxDirectCurrentTwoCarrier_r16[] elements;

   public UplinkTxDirectCurrentTwoCarrierList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UplinkTxDirectCurrentTwoCarrierList_r16 (int numRecords) {
      elements = new UplinkTxDirectCurrentTwoCarrier_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public UplinkTxDirectCurrentTwoCarrierList_r16 (UplinkTxDirectCurrentTwoCarrier_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UplinkTxDirectCurrentTwoCarrier_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UplinkTxDirectCurrentTwoCarrier_r16();
