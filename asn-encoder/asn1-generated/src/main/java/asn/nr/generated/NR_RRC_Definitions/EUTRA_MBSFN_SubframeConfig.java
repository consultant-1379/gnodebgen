...
public class EUTRA_MBSFN_SubframeConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((subframeAllocation2 != null), null);
      ...
      if (radioframeAllocationPeriod != null) {
         ...
         radioframeAllocationPeriod.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("radioframeAllocationPeriod", -1);
      }
      else throw new Asn1MissingRequiredException ("radioframeAllocationPeriod");
      ...
      if (radioframeAllocationOffset != null) {
         ...
         radioframeAllocationOffset.encode (buffer, 0, 7);

         buffer.getContext().eventDispatcher.endElement("radioframeAllocationOffset", -1);
      }
      else throw new Asn1MissingRequiredException ("radioframeAllocationOffset");

      // encode subframeAllocation1

      if (subframeAllocation1 != null) {
         buffer.getContext().eventDispatcher.startElement("subframeAllocation1", -1);

         subframeAllocation1.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("subframeAllocation1", -1);
      }
      else throw new Asn1MissingRequiredException ("subframeAllocation1");

      // encode subframeAllocation2

      if (subframeAllocation2 != null) {
         buffer.getContext().eventDispatcher.startElement("subframeAllocation2", -1);

         subframeAllocation2.encode (buffer);
