...
public class UplinkTxDirectCurrentCell_uplinkDirectCurrentBWP_SUL extends Asn1SeqOf {
   ...
   public UplinkTxDirectCurrentBWP[] elements;

   public UplinkTxDirectCurrentCell_uplinkDirectCurrentBWP_SUL () {
      elements = null;
   }
    ...
    * populated.
    */
   public UplinkTxDirectCurrentCell_uplinkDirectCurrentBWP_SUL (int numRecords) {
      elements = new UplinkTxDirectCurrentBWP [numRecords];
   }
    ...
    * given the array.  
    */
   public UplinkTxDirectCurrentCell_uplinkDirectCurrentBWP_SUL (UplinkTxDirectCurrentBWP[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UplinkTxDirectCurrentBWP [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UplinkTxDirectCurrentBWP();
