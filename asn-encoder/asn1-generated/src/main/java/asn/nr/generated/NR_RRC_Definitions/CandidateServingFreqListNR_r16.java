...
public class CandidateServingFreqListNR_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CandidateServingFreqListNR-r16";
   }

   public ARFCN_ValueNR[] elements;

   public CandidateServingFreqListNR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CandidateServingFreqListNR_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public CandidateServingFreqListNR_r16 (ARFCN_ValueNR[] elements_) {
      elements = elements_;
   }
