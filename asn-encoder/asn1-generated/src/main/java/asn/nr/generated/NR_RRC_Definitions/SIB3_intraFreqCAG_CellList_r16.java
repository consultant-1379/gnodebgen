...
public class SIB3_intraFreqCAG_CellList_r16 extends Asn1SeqOf {
   ...
   public IntraFreqCAG_CellListPerPLMN_r16[] elements;

   public SIB3_intraFreqCAG_CellList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SIB3_intraFreqCAG_CellList_r16 (int numRecords) {
      elements = new IntraFreqCAG_CellListPerPLMN_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SIB3_intraFreqCAG_CellList_r16 (IntraFreqCAG_CellListPerPLMN_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new IntraFreqCAG_CellListPerPLMN_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new IntraFreqCAG_CellListPerPLMN_r16();
