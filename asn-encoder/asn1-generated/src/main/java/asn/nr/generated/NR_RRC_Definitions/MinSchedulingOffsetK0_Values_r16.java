...
public class MinSchedulingOffsetK0_Values_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MinSchedulingOffsetK0-Values-r16";
   }

   public Asn1Integer[] elements;

   public MinSchedulingOffsetK0_Values_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MinSchedulingOffsetK0_Values_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public MinSchedulingOffsetK0_Values_r16 (Asn1Integer[] elements_) {
      elements = elements_;
   }
