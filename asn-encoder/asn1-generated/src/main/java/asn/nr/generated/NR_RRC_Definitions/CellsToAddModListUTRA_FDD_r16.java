...
public class CellsToAddModListUTRA_FDD_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellsToAddModListUTRA-FDD-r16";
   }

   public CellsToAddModUTRA_FDD_r16[] elements;

   public CellsToAddModListUTRA_FDD_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellsToAddModListUTRA_FDD_r16 (int numRecords) {
      elements = new CellsToAddModUTRA_FDD_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public CellsToAddModListUTRA_FDD_r16 (CellsToAddModUTRA_FDD_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellsToAddModUTRA_FDD_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellsToAddModUTRA_FDD_r16();
