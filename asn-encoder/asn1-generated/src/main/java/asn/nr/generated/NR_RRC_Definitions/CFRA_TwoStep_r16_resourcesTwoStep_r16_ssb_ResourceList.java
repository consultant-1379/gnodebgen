...
public class CFRA_TwoStep_r16_resourcesTwoStep_r16_ssb_ResourceList extends Asn1SeqOf {
   ...
   public CFRA_SSB_Resource[] elements;

   public CFRA_TwoStep_r16_resourcesTwoStep_r16_ssb_ResourceList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CFRA_TwoStep_r16_resourcesTwoStep_r16_ssb_ResourceList (int numRecords) {
      elements = new CFRA_SSB_Resource [numRecords];
   }
    ...
    * given the array.  
    */
   public CFRA_TwoStep_r16_resourcesTwoStep_r16_ssb_ResourceList (CFRA_SSB_Resource[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CFRA_SSB_Resource [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CFRA_SSB_Resource();
