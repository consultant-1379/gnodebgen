...
public class PUCCH_Config_multi_CSI_PUCCH_ResourceList extends Asn1SeqOf {
   ...
   public PUCCH_Config_multi_CSI_PUCCH_ResourceList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_multi_CSI_PUCCH_ResourceList (int numRecords) {
    ...
    * given the array.  
    */
   public PUCCH_Config_multi_CSI_PUCCH_ResourceList (PUCCH_ResourceId[] elements_) {
      elements = elements_;
   }
