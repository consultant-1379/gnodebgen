...
public class PUCCH_format4 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (occ_Length != null) {
         ...
         occ_Length.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("occ_Length", -1);
      }
      else throw new Asn1MissingRequiredException ("occ_Length");
      ...
      if (occ_Index != null) {
         ...
         occ_Index.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("occ_Index", -1);
      }
      else throw new Asn1MissingRequiredException ("occ_Index");
