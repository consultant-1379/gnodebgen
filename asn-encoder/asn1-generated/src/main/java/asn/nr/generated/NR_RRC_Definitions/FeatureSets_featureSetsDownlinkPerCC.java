...
public class FeatureSets_featureSetsDownlinkPerCC extends Asn1SeqOf {
   ...
   public FeatureSetDownlinkPerCC[] elements;

   public FeatureSets_featureSetsDownlinkPerCC () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSets_featureSetsDownlinkPerCC (int numRecords) {
      elements = new FeatureSetDownlinkPerCC [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSets_featureSetsDownlinkPerCC (FeatureSetDownlinkPerCC[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetDownlinkPerCC [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetDownlinkPerCC();
