...
public class BWP_DownlinkDedicated_pdcch_Config extends Asn1Choice {
   ...
   public BWP_DownlinkDedicated_pdcch_Config () {
      super();
   }

   public BWP_DownlinkDedicated_pdcch_Config (byte choiceId_, Asn1Type element_) {
      super();
