...
public class MeasResultListSRS_RSRP_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultListSRS-RSRP-r16";
   }

   public MeasResultSRS_RSRP_r16[] elements;

   public MeasResultListSRS_RSRP_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListSRS_RSRP_r16 (int numRecords) {
      elements = new MeasResultSRS_RSRP_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListSRS_RSRP_r16 (MeasResultSRS_RSRP_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultSRS_RSRP_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultSRS_RSRP_r16();
