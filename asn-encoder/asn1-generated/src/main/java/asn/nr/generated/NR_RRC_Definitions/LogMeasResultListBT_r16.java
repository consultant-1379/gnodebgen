...
public class LogMeasResultListBT_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "LogMeasResultListBT-r16";
   }

   public LogMeasResultBT_r16[] elements;

   public LogMeasResultListBT_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public LogMeasResultListBT_r16 (int numRecords) {
      elements = new LogMeasResultBT_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public LogMeasResultListBT_r16 (LogMeasResultBT_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LogMeasResultBT_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LogMeasResultBT_r16();
