...
public class PDSCH_TimeDomainResourceAllocationList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PDSCH-TimeDomainResourceAllocationList-r16";
   }

   public PDSCH_TimeDomainResourceAllocation_r16[] elements;

   public PDSCH_TimeDomainResourceAllocationList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDSCH_TimeDomainResourceAllocationList_r16 (int numRecords) {
      elements = new PDSCH_TimeDomainResourceAllocation_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PDSCH_TimeDomainResourceAllocationList_r16 (PDSCH_TimeDomainResourceAllocation_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PDSCH_TimeDomainResourceAllocation_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PDSCH_TimeDomainResourceAllocation_r16();
