...
public class ValidityCellList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ValidityCellList";
   }

   public PCI_Range[] elements;

   public ValidityCellList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ValidityCellList (int numRecords) {
    ...
    * given the array.  
    */
   public ValidityCellList (PCI_Range[] elements_) {
      elements = elements_;
   }
