...
public class MeasAndMobParametersMRDC extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((measAndMobParametersMRDC_Common != null), null);
      buffer.encodeBit ((measAndMobParametersMRDC_XDD_Diff != null), null);
      buffer.encodeBit ((measAndMobParametersMRDC_FRX_Diff != null), null);

      // encode measAndMobParametersMRDC_Common

      if (measAndMobParametersMRDC_Common != null) {
         buffer.getContext().eventDispatcher.startElement("measAndMobParametersMRDC_Common", -1);

         measAndMobParametersMRDC_Common.encode (buffer);
