...
public class RRCReconfigurationSidelink_IEs_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((slrb_ConfigToAddModList_r16 != null), null);
      buffer.encodeBit ((slrb_ConfigToReleaseList_r16 != null), null);
      buffer.encodeBit ((sl_MeasConfig_r16 != null), null);
      buffer.encodeBit ((sl_CSI_RS_Config_r16 != null), null);
      buffer.encodeBit ((sl_ResetConfig_r16 != null), null);
      buffer.encodeBit ((sl_LatencyBoundCSI_Report_r16 != null), null);
      buffer.encodeBit ((lateNonCriticalExtension != null), null);
      buffer.encodeBit ((nonCriticalExtension != null), null);

      // encode slrb_ConfigToAddModList_r16

      if (slrb_ConfigToAddModList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("slrb_ConfigToAddModList_r16", -1);

         slrb_ConfigToAddModList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("slrb_ConfigToAddModList_r16", -1);
      }

      // encode slrb_ConfigToReleaseList_r16

      if (slrb_ConfigToReleaseList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("slrb_ConfigToReleaseList_r16", -1);

         slrb_ConfigToReleaseList_r16.encode (buffer);
      ...
      // encode sl_CSI_RS_Config_r16

      if (sl_CSI_RS_Config_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_CSI_RS_Config_r16", -1);

         sl_CSI_RS_Config_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_CSI_RS_Config_r16", -1);
      }

      // encode sl_ResetConfig_r16

      if (sl_ResetConfig_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_ResetConfig_r16", -1);

         sl_ResetConfig_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_ResetConfig_r16", -1);
      }

      // encode sl_LatencyBoundCSI_Report_r16

      if (sl_LatencyBoundCSI_Report_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_LatencyBoundCSI_Report_r16", -1);

         sl_LatencyBoundCSI_Report_r16.encode (buffer, 3, 160);
