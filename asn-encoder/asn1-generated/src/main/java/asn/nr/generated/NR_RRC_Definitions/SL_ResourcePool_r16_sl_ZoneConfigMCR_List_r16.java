...
public class SL_ResourcePool_r16_sl_ZoneConfigMCR_List_r16 extends Asn1SeqOf {
   ...
   public SL_ZoneConfigMCR_r16[] elements;

   public SL_ResourcePool_r16_sl_ZoneConfigMCR_List_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_ResourcePool_r16_sl_ZoneConfigMCR_List_r16 (int numRecords) {
      elements = new SL_ZoneConfigMCR_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_ResourcePool_r16_sl_ZoneConfigMCR_List_r16 (SL_ZoneConfigMCR_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (16, 16);
      int numElements = (int) buffer.decodeLength();

      elements = new SL_ZoneConfigMCR_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_ZoneConfigMCR_r16();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 16, 16);
