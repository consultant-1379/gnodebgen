...
public class ConfiguredGrantConfig_uci_OnPUSCH extends Asn1Choice {
   ...
   public ConfiguredGrantConfig_uci_OnPUSCH () {
      super();
   }

   public ConfiguredGrantConfig_uci_OnPUSCH (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (CG_UCI_OnPUSCH value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            CG_UCI_OnPUSCH setup;
            element = setup = new CG_UCI_OnPUSCH();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            CG_UCI_OnPUSCH setup = (CG_UCI_OnPUSCH) element;
            setup.encode (buffer);
            break;
