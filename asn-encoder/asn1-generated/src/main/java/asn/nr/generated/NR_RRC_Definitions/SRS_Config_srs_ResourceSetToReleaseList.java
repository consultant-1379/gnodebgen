...
public class SRS_Config_srs_ResourceSetToReleaseList extends Asn1SeqOf {
   ...
   public SRS_Config_srs_ResourceSetToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRS_Config_srs_ResourceSetToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public SRS_Config_srs_ResourceSetToReleaseList (SRS_ResourceSetId[] elements_) {
      elements = elements_;
   }
