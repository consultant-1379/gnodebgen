...
public class CSI_ReportConfig_semiPersistentOnPUSCH_v1610 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((reportSlotOffsetListDCI_0_2_r16 != null), null);
      buffer.encodeBit ((reportSlotOffsetListDCI_0_1_r16 != null), null);

      // encode reportSlotOffsetListDCI_0_2_r16

      if (reportSlotOffsetListDCI_0_2_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("reportSlotOffsetListDCI_0_2_r16", -1);

         reportSlotOffsetListDCI_0_2_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("reportSlotOffsetListDCI_0_2_r16", -1);
      }

      // encode reportSlotOffsetListDCI_0_1_r16

      if (reportSlotOffsetListDCI_0_1_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("reportSlotOffsetListDCI_0_1_r16", -1);

         reportSlotOffsetListDCI_0_1_r16.encode (buffer);
