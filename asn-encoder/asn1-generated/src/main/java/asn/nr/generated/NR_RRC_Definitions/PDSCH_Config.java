...
public class PDSCH_Config extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((dataScramblingIdentityPDSCH != null), null);
      buffer.encodeBit ((dmrs_DownlinkForPDSCH_MappingTypeA != null), null);
      buffer.encodeBit ((dmrs_DownlinkForPDSCH_MappingTypeB != null), null);
      buffer.encodeBit ((tci_StatesToAddModList != null), null);
      buffer.encodeBit ((tci_StatesToReleaseList != null), null);
      buffer.encodeBit ((vrb_ToPRB_Interleaver != null), null);
      buffer.encodeBit ((pdsch_TimeDomainAllocationList != null), null);
      buffer.encodeBit ((pdsch_AggregationFactor != null), null);
      buffer.encodeBit ((rateMatchPatternToAddModList != null), null);
      buffer.encodeBit ((rateMatchPatternToReleaseList != null), null);
      buffer.encodeBit ((rateMatchPatternGroup1 != null), null);
      buffer.encodeBit ((rateMatchPatternGroup2 != null), null);
      buffer.encodeBit ((mcs_Table != null), null);
      buffer.encodeBit ((maxNrofCodeWordsScheduledByDCI != null), null);
      buffer.encodeBit ((zp_CSI_RS_ResourceToAddModList != null), null);
      buffer.encodeBit ((zp_CSI_RS_ResourceToReleaseList != null), null);
      buffer.encodeBit ((aperiodic_ZP_CSI_RS_ResourceSetsToAddModList != null), null);
      buffer.encodeBit ((aperiodic_ZP_CSI_RS_ResourceSetsToReleaseList != null), null);
      buffer.encodeBit ((sp_ZP_CSI_RS_ResourceSetsToAddModList != null), null);
      buffer.encodeBit ((sp_ZP_CSI_RS_ResourceSetsToReleaseList != null), null);
      buffer.encodeBit ((p_ZP_CSI_RS_ResourceSet != null), null);

      // encode dataScramblingIdentityPDSCH

      if (dataScramblingIdentityPDSCH != null) {
         buffer.getContext().eventDispatcher.startElement("dataScramblingIdentityPDSCH", -1);

         dataScramblingIdentityPDSCH.encode (buffer, 0, 1023);

         buffer.getContext().eventDispatcher.endElement("dataScramblingIdentityPDSCH", -1);
      }

      // encode dmrs_DownlinkForPDSCH_MappingTypeA

      if (dmrs_DownlinkForPDSCH_MappingTypeA != null) {
         buffer.getContext().eventDispatcher.startElement("dmrs_DownlinkForPDSCH_MappingTypeA", -1);

         dmrs_DownlinkForPDSCH_MappingTypeA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("dmrs_DownlinkForPDSCH_MappingTypeA", -1);
      }

      // encode dmrs_DownlinkForPDSCH_MappingTypeB

      if (dmrs_DownlinkForPDSCH_MappingTypeB != null) {
         buffer.getContext().eventDispatcher.startElement("dmrs_DownlinkForPDSCH_MappingTypeB", -1);

         dmrs_DownlinkForPDSCH_MappingTypeB.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("dmrs_DownlinkForPDSCH_MappingTypeB", -1);
      }

      // encode tci_StatesToAddModList

      if (tci_StatesToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("tci_StatesToAddModList", -1);

         tci_StatesToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("tci_StatesToAddModList", -1);
      }

      // encode tci_StatesToReleaseList

      if (tci_StatesToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("tci_StatesToReleaseList", -1);

         tci_StatesToReleaseList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("tci_StatesToReleaseList", -1);
      }

      // encode vrb_ToPRB_Interleaver

      if (vrb_ToPRB_Interleaver != null) {
         buffer.getContext().eventDispatcher.startElement("vrb_ToPRB_Interleaver", -1);

         vrb_ToPRB_Interleaver.encode (buffer);
      ...
      // encode pdsch_AggregationFactor

      if (pdsch_AggregationFactor != null) {
         buffer.getContext().eventDispatcher.startElement("pdsch_AggregationFactor", -1);

         pdsch_AggregationFactor.encode (buffer);
      ...
      // encode rateMatchPatternGroup1

      if (rateMatchPatternGroup1 != null) {
         buffer.getContext().eventDispatcher.startElement("rateMatchPatternGroup1", -1);

         rateMatchPatternGroup1.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("rateMatchPatternGroup1", -1);
      }

      // encode rateMatchPatternGroup2

      if (rateMatchPatternGroup2 != null) {
         buffer.getContext().eventDispatcher.startElement("rateMatchPatternGroup2", -1);

         rateMatchPatternGroup2.encode (buffer);
      ...
      else throw new Asn1MissingRequiredException ("rbg_Size");
      ...
      // encode maxNrofCodeWordsScheduledByDCI

      if (maxNrofCodeWordsScheduledByDCI != null) {
         buffer.getContext().eventDispatcher.startElement("maxNrofCodeWordsScheduledByDCI", -1);

         maxNrofCodeWordsScheduledByDCI.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("maxNrofCodeWordsScheduledByDCI", -1);
      }

      // encode prb_BundlingType

      if (prb_BundlingType != null) {
         buffer.getContext().eventDispatcher.startElement("prb_BundlingType", -1);

         prb_BundlingType.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("prb_BundlingType", -1);
      }
      else throw new Asn1MissingRequiredException ("prb_BundlingType");

      // encode zp_CSI_RS_ResourceToAddModList

      if (zp_CSI_RS_ResourceToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("zp_CSI_RS_ResourceToAddModList", -1);

         zp_CSI_RS_ResourceToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("zp_CSI_RS_ResourceToAddModList", -1);
      }

      // encode zp_CSI_RS_ResourceToReleaseList

      if (zp_CSI_RS_ResourceToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("zp_CSI_RS_ResourceToReleaseList", -1);

         zp_CSI_RS_ResourceToReleaseList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("zp_CSI_RS_ResourceToReleaseList", -1);
      }

      // encode aperiodic_ZP_CSI_RS_ResourceSetsToAddModList

      if (aperiodic_ZP_CSI_RS_ResourceSetsToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("aperiodic_ZP_CSI_RS_ResourceSetsToAddModList", -1);

         aperiodic_ZP_CSI_RS_ResourceSetsToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("aperiodic_ZP_CSI_RS_ResourceSetsToAddModList", -1);
      }

      // encode aperiodic_ZP_CSI_RS_ResourceSetsToReleaseList

      if (aperiodic_ZP_CSI_RS_ResourceSetsToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("aperiodic_ZP_CSI_RS_ResourceSetsToReleaseList", -1);

         aperiodic_ZP_CSI_RS_ResourceSetsToReleaseList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("aperiodic_ZP_CSI_RS_ResourceSetsToReleaseList", -1);
      }

      // encode sp_ZP_CSI_RS_ResourceSetsToAddModList

      if (sp_ZP_CSI_RS_ResourceSetsToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("sp_ZP_CSI_RS_ResourceSetsToAddModList", -1);

         sp_ZP_CSI_RS_ResourceSetsToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sp_ZP_CSI_RS_ResourceSetsToAddModList", -1);
      }

      // encode sp_ZP_CSI_RS_ResourceSetsToReleaseList

      if (sp_ZP_CSI_RS_ResourceSetsToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("sp_ZP_CSI_RS_ResourceSetsToReleaseList", -1);

         sp_ZP_CSI_RS_ResourceSetsToReleaseList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sp_ZP_CSI_RS_ResourceSetsToReleaseList", -1);
      }

      // encode p_ZP_CSI_RS_ResourceSet

      if (p_ZP_CSI_RS_ResourceSet != null) {
         buffer.getContext().eventDispatcher.startElement("p_ZP_CSI_RS_ResourceSet", -1);

         p_ZP_CSI_RS_ResourceSet.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((maxMIMO_Layers_r16 != null), "optbit");
            buffer.encodeBit ((minimumSchedulingOffsetK0_r16 != null), "optbit");
            buffer.encodeBit ((antennaPortsFieldPresenceDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((aperiodicZP_CSI_RS_ResourceSetsToAddModListDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((aperiodicZP_CSI_RS_ResourceSetsToReleaseListDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((dmrs_DownlinkForPDSCH_MappingTypeA_DCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((dmrs_DownlinkForPDSCH_MappingTypeB_DCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((dmrs_SequenceInitializationDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((harq_ProcessNumberSizeDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((mcs_TableDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((numberOfBitsForRV_DCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((pdsch_TimeDomainAllocationListDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((prb_BundlingTypeDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((priorityIndicatorDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((rateMatchPatternGroup1DCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((rateMatchPatternGroup2DCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((resourceAllocationType1GranularityDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((vrb_ToPRB_InterleaverDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((referenceOfSLIVDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((resourceAllocationDCI_1_2_r16 != null), "optbit");
            buffer.encodeBit ((priorityIndicatorDCI_1_1_r16 != null), "optbit");
            buffer.encodeBit ((dataScramblingIdentityPDSCH2_r16 != null), "optbit");
            buffer.encodeBit ((pdsch_TimeDomainAllocationList_r16 != null), "optbit");
            buffer.encodeBit ((repetitionSchemeConfig_r16 != null), "optbit");
            if (maxMIMO_Layers_r16 != null) {
               maxMIMO_Layers_r16.encode (buffer);
            }
            if (minimumSchedulingOffsetK0_r16 != null) {
               minimumSchedulingOffsetK0_r16.encode (buffer);
            }
            if (antennaPortsFieldPresenceDCI_1_2_r16 != null) {
               antennaPortsFieldPresenceDCI_1_2_r16.encode (buffer);
            }
            if (aperiodicZP_CSI_RS_ResourceSetsToAddModListDCI_1_2_r16 != null) {
               aperiodicZP_CSI_RS_ResourceSetsToAddModListDCI_1_2_r16.encode (buffer);
            }
            if (aperiodicZP_CSI_RS_ResourceSetsToReleaseListDCI_1_2_r16 != null) {
               aperiodicZP_CSI_RS_ResourceSetsToReleaseListDCI_1_2_r16.encode (buffer);
            }
            if (dmrs_DownlinkForPDSCH_MappingTypeA_DCI_1_2_r16 != null) {
               dmrs_DownlinkForPDSCH_MappingTypeA_DCI_1_2_r16.encode (buffer);
            }
            if (dmrs_DownlinkForPDSCH_MappingTypeB_DCI_1_2_r16 != null) {
               dmrs_DownlinkForPDSCH_MappingTypeB_DCI_1_2_r16.encode (buffer);
            }
            if (dmrs_SequenceInitializationDCI_1_2_r16 != null) {
               dmrs_SequenceInitializationDCI_1_2_r16.encode (buffer);
            }
            if (harq_ProcessNumberSizeDCI_1_2_r16 != null) {
               harq_ProcessNumberSizeDCI_1_2_r16.encode (buffer, 0, 4);
            }
            if (mcs_TableDCI_1_2_r16 != null) {
               mcs_TableDCI_1_2_r16.encode (buffer);
            }
            if (numberOfBitsForRV_DCI_1_2_r16 != null) {
               numberOfBitsForRV_DCI_1_2_r16.encode (buffer, 0, 2);
            }
            if (pdsch_TimeDomainAllocationListDCI_1_2_r16 != null) {
               pdsch_TimeDomainAllocationListDCI_1_2_r16.encode (buffer);
            }
            if (prb_BundlingTypeDCI_1_2_r16 != null) {
               prb_BundlingTypeDCI_1_2_r16.encode (buffer);
            }
            if (priorityIndicatorDCI_1_2_r16 != null) {
               priorityIndicatorDCI_1_2_r16.encode (buffer);
            }
            if (rateMatchPatternGroup1DCI_1_2_r16 != null) {
               rateMatchPatternGroup1DCI_1_2_r16.encode (buffer);
            }
            if (rateMatchPatternGroup2DCI_1_2_r16 != null) {
               rateMatchPatternGroup2DCI_1_2_r16.encode (buffer);
            }
            if (resourceAllocationType1GranularityDCI_1_2_r16 != null) {
               resourceAllocationType1GranularityDCI_1_2_r16.encode (buffer);
            }
            if (vrb_ToPRB_InterleaverDCI_1_2_r16 != null) {
               vrb_ToPRB_InterleaverDCI_1_2_r16.encode (buffer);
            }
            if (referenceOfSLIVDCI_1_2_r16 != null) {
               referenceOfSLIVDCI_1_2_r16.encode (buffer);
            }
            if (resourceAllocationDCI_1_2_r16 != null) {
               resourceAllocationDCI_1_2_r16.encode (buffer);
            }
            if (priorityIndicatorDCI_1_1_r16 != null) {
               priorityIndicatorDCI_1_1_r16.encode (buffer);
            }
            if (dataScramblingIdentityPDSCH2_r16 != null) {
               dataScramblingIdentityPDSCH2_r16.encode (buffer, 0, 1023);
            }
            if (pdsch_TimeDomainAllocationList_r16 != null) {
               pdsch_TimeDomainAllocationList_r16.encode (buffer);
            }
            if (repetitionSchemeConfig_r16 != null) {
               repetitionSchemeConfig_r16.encode (buffer);
            }
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((repetitionSchemeConfig_v1630 != null), "optbit");
            if (repetitionSchemeConfig_v1630 != null) {
               repetitionSchemeConfig_v1630.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
