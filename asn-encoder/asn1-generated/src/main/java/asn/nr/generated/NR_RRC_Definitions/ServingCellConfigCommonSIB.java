...
public class ServingCellConfigCommonSIB extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      else throw new Asn1MissingRequiredException ("downlinkConfigCommon");
      ...
      else throw new Asn1MissingRequiredException ("ssb_PositionsInBurst");
      ...
      else throw new Asn1MissingRequiredException ("ssb_PeriodicityServingCell");
