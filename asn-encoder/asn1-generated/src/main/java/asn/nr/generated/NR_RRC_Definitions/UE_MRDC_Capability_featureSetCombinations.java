...
public class UE_MRDC_Capability_featureSetCombinations extends Asn1SeqOf {
   ...
   public FeatureSetCombination[] elements;

   public UE_MRDC_Capability_featureSetCombinations () {
      elements = null;
   }
    ...
    * populated.
    */
   public UE_MRDC_Capability_featureSetCombinations (int numRecords) {
      elements = new FeatureSetCombination [numRecords];
   }
    ...
    * given the array.  
    */
   public UE_MRDC_Capability_featureSetCombinations (FeatureSetCombination[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetCombination [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetCombination();
