...
public class MIMO_ParametersPerBand_ptrs_DensityRecommendationSetDL extends Asn1Seq {
   ...
   public PTRS_DensityRecommendationDL scs_15kHz;  // optional
   public PTRS_DensityRecommendationDL scs_30kHz;  // optional
   public PTRS_DensityRecommendationDL scs_60kHz;  // optional
   public PTRS_DensityRecommendationDL scs_120kHz;  // optional

   public MIMO_ParametersPerBand_ptrs_DensityRecommendationSetDL () {
      super();
      init();
   }
    ...
    */
   public MIMO_ParametersPerBand_ptrs_DensityRecommendationSetDL (
      PTRS_DensityRecommendationDL scs_15kHz_,
      PTRS_DensityRecommendationDL scs_30kHz_,
      PTRS_DensityRecommendationDL scs_60kHz_,
      PTRS_DensityRecommendationDL scs_120kHz_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (scs_15kHzPresent) {
         ...
         scs_15kHz = new PTRS_DensityRecommendationDL();
      ...
      if (scs_30kHzPresent) {
         ...
         scs_30kHz = new PTRS_DensityRecommendationDL();
      ...
      if (scs_60kHzPresent) {
         ...
         scs_60kHz = new PTRS_DensityRecommendationDL();
      ...
      if (scs_120kHzPresent) {
         ...
         scs_120kHz = new PTRS_DensityRecommendationDL();
