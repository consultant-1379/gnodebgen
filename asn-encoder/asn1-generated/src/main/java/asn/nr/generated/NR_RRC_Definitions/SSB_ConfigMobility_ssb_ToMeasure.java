...
public class SSB_ConfigMobility_ssb_ToMeasure extends Asn1Choice {
   ...
   public SSB_ConfigMobility_ssb_ToMeasure () {
      super();
   }

   public SSB_ConfigMobility_ssb_ToMeasure (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SSB_ToMeasure value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 1: { 
            SSB_ToMeasure setup;
            element = setup = new SSB_ToMeasure();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            SSB_ToMeasure setup = (SSB_ToMeasure) element;
            setup.encode (buffer);
            break;
