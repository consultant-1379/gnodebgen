...
public class ServingCellConfig_downlinkChannelBW_PerSCS_List extends Asn1SeqOf {
   ...
   public ServingCellConfig_downlinkChannelBW_PerSCS_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServingCellConfig_downlinkChannelBW_PerSCS_List (int numRecords) {
    ...
    * given the array.  
    */
   public ServingCellConfig_downlinkChannelBW_PerSCS_List (SCS_SpecificCarrier[] elements_) {
      elements = elements_;
   }
