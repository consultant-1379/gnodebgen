...
public class MeasResults_measResultNeighCells extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (!extbit) {
         ...
         switch (choiceID) {
            // measResultListNR
            case _MEASRESULTLISTNR:
               MeasResultListNR measResultListNR = (MeasResultListNR) element;
               measResultListNR.encode (buffer);
               break;
         ...
         switch (choiceID) {
            // measResultListEUTRA
            case _MEASRESULTLISTEUTRA:
               MeasResultListEUTRA measResultListEUTRA = (MeasResultListEUTRA) element;
            ...
            // measResultListUTRA_FDD_r16
            case _MEASRESULTLISTUTRA_FDD_R16:
               MeasResultListUTRA_FDD_r16 measResultListUTRA_FDD_r16 = (MeasResultListUTRA_FDD_r16) element;
               measResultListUTRA_FDD_r16.encode (buffer);
               openType = new Asn1OpenType 
                  (buffer.getBuffer(), 0, buffer.getMsgByteCnt());
               break;
