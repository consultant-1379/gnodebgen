...
public class CSI_RS_Resource_Mobility extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((associatedSSB != null), null);
      ...
      if (slotConfig != null) {
         ...
         slotConfig.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("slotConfig", -1);
      }
      else throw new Asn1MissingRequiredException ("slotConfig");

      // encode associatedSSB

      if (associatedSSB != null) {
         buffer.getContext().eventDispatcher.startElement("associatedSSB", -1);

         associatedSSB.encode (buffer);
      ...
      // encode sequenceGenerationConfig

      if (sequenceGenerationConfig != null) {
         buffer.getContext().eventDispatcher.startElement("sequenceGenerationConfig", -1);

         sequenceGenerationConfig.encode (buffer, 0, 1023);

         buffer.getContext().eventDispatcher.endElement("sequenceGenerationConfig", -1);
      }
      else throw new Asn1MissingRequiredException ("sequenceGenerationConfig");
