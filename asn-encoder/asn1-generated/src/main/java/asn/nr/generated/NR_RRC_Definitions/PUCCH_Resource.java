...
public class PUCCH_Resource extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((intraSlotFrequencyHopping != null), null);
      buffer.encodeBit ((secondHopPRB != null), null);

      // encode pucch_ResourceId

      if (pucch_ResourceId != null) {
         buffer.getContext().eventDispatcher.startElement("pucch_ResourceId", -1);

         pucch_ResourceId.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pucch_ResourceId", -1);
      }
      else throw new Asn1MissingRequiredException ("pucch_ResourceId");
      ...
      if (startingPRB != null) {
         ...
         startingPRB.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("startingPRB", -1);
      }
      else throw new Asn1MissingRequiredException ("startingPRB");

      // encode intraSlotFrequencyHopping

      if (intraSlotFrequencyHopping != null) {
         buffer.getContext().eventDispatcher.startElement("intraSlotFrequencyHopping", -1);

         intraSlotFrequencyHopping.encode (buffer);
      ...
      else throw new Asn1MissingRequiredException ("format");
