...
public class FeatureSets_featureSetsUplink_v1630 extends Asn1SeqOf {
   ...
   public FeatureSetUplink_v1630[] elements;

   public FeatureSets_featureSetsUplink_v1630 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSets_featureSetsUplink_v1630 (int numRecords) {
      elements = new FeatureSetUplink_v1630 [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSets_featureSetsUplink_v1630 (FeatureSetUplink_v1630[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetUplink_v1630 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetUplink_v1630();
