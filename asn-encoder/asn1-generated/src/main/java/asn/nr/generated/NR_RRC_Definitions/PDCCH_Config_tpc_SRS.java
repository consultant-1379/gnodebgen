...
public class PDCCH_Config_tpc_SRS extends Asn1Choice {
   ...
   public PDCCH_Config_tpc_SRS () {
      super();
   }

   public PDCCH_Config_tpc_SRS (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SRS_TPC_CommandConfig value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            SRS_TPC_CommandConfig setup;
            element = setup = new SRS_TPC_CommandConfig();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            SRS_TPC_CommandConfig setup = (SRS_TPC_CommandConfig) element;
            setup.encode (buffer);
            break;
