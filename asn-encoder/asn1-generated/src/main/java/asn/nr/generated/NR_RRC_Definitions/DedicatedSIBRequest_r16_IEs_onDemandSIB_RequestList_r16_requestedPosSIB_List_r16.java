...
public class DedicatedSIBRequest_r16_IEs_onDemandSIB_RequestList_r16_requestedPosSIB_List_r16 extends Asn1SeqOf {
   ...
   public PosSIB_ReqInfo_r16[] elements;

   public DedicatedSIBRequest_r16_IEs_onDemandSIB_RequestList_r16_requestedPosSIB_List_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public DedicatedSIBRequest_r16_IEs_onDemandSIB_RequestList_r16_requestedPosSIB_List_r16 (int numRecords) {
      elements = new PosSIB_ReqInfo_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public DedicatedSIBRequest_r16_IEs_onDemandSIB_RequestList_r16_requestedPosSIB_List_r16 (PosSIB_ReqInfo_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PosSIB_ReqInfo_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PosSIB_ReqInfo_r16();
