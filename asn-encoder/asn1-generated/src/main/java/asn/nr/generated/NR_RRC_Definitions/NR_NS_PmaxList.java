...
public class NR_NS_PmaxList extends Asn1SeqOf {
   ...
   public NR_NS_PmaxValue[] elements;

   public NR_NS_PmaxList () {
      elements = null;
   }
    ...
    * populated.
    */
   public NR_NS_PmaxList (int numRecords) {
      elements = new NR_NS_PmaxValue [numRecords];
   }
    ...
    * given the array.  
    */
   public NR_NS_PmaxList (NR_NS_PmaxValue[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NR_NS_PmaxValue [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NR_NS_PmaxValue();
