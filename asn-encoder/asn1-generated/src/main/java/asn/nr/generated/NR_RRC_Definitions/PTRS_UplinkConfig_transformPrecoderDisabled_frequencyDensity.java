...
public class PTRS_UplinkConfig_transformPrecoderDisabled_frequencyDensity extends Asn1SeqOf {
   ...
   public PTRS_UplinkConfig_transformPrecoderDisabled_frequencyDensity () {
      elements = null;
   }
    ...
    * populated.
    */
   public PTRS_UplinkConfig_transformPrecoderDisabled_frequencyDensity (int numRecords) {
    ...
    * given the array.  
    */
   public PTRS_UplinkConfig_transformPrecoderDisabled_frequencyDensity (Asn1Integer[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i].decode (buffer, 1, 276);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i].encode (buffer, 1, 276);
