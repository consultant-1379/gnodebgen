...
public class UEInformationRequest_r16_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((logMeasReportReq_r16 != null), null);
      buffer.encodeBit ((connEstFailReportReq_r16 != null), null);
      buffer.encodeBit ((ra_ReportReq_r16 != null), null);
      buffer.encodeBit ((rlf_ReportReq_r16 != null), null);
      buffer.encodeBit ((mobilityHistoryReportReq_r16 != null), null);
      ...
      // encode logMeasReportReq_r16

      if (logMeasReportReq_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("logMeasReportReq_r16", -1);

         logMeasReportReq_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("logMeasReportReq_r16", -1);
      }

      // encode connEstFailReportReq_r16

      if (connEstFailReportReq_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("connEstFailReportReq_r16", -1);

         connEstFailReportReq_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("connEstFailReportReq_r16", -1);
      }

      // encode ra_ReportReq_r16

      if (ra_ReportReq_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("ra_ReportReq_r16", -1);

         ra_ReportReq_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("ra_ReportReq_r16", -1);
      }

      // encode rlf_ReportReq_r16

      if (rlf_ReportReq_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("rlf_ReportReq_r16", -1);

         rlf_ReportReq_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("rlf_ReportReq_r16", -1);
      }

      // encode mobilityHistoryReportReq_r16

      if (mobilityHistoryReportReq_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("mobilityHistoryReportReq_r16", -1);

         mobilityHistoryReportReq_r16.encode (buffer);
