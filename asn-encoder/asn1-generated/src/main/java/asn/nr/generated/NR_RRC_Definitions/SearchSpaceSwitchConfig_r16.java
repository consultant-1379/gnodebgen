...
public class SearchSpaceSwitchConfig_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((cellGroupsForSwitchList_r16 != null), null);
      buffer.encodeBit ((searchSpaceSwitchDelay_r16 != null), null);

      // encode cellGroupsForSwitchList_r16

      if (cellGroupsForSwitchList_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("cellGroupsForSwitchList_r16", -1);

         cellGroupsForSwitchList_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("cellGroupsForSwitchList_r16", -1);
      }

      // encode searchSpaceSwitchDelay_r16

      if (searchSpaceSwitchDelay_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("searchSpaceSwitchDelay_r16", -1);

         searchSpaceSwitchDelay_r16.encode (buffer, 10, 52);
