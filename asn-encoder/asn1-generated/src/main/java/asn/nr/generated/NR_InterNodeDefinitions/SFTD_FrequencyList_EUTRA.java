...
public class SFTD_FrequencyList_EUTRA extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SFTD-FrequencyList-EUTRA";
   }

   public ARFCN_ValueEUTRA[] elements;

   public SFTD_FrequencyList_EUTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public SFTD_FrequencyList_EUTRA (int numRecords) {
    ...
    * given the array.  
    */
   public SFTD_FrequencyList_EUTRA (ARFCN_ValueEUTRA[] elements_) {
      elements = elements_;
   }
