...
public class UplinkConfig_uplinkChannelBW_PerSCS_List extends Asn1SeqOf {
   ...
   public UplinkConfig_uplinkChannelBW_PerSCS_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public UplinkConfig_uplinkChannelBW_PerSCS_List (int numRecords) {
    ...
    * given the array.  
    */
   public UplinkConfig_uplinkChannelBW_PerSCS_List (SCS_SpecificCarrier[] elements_) {
      elements = elements_;
   }
