...
public class RA_Report_r16_raPurpose_r16 extends Asn1Enumerated {
      ...
      throws Asn1Exception, java.io.IOException
   {
      int ui;  // enum index
      switch ((int)value) {
         case 0: ui = 0; /* accessRelated */break;
         case 1: ui = 1; /* beamFailureRecovery */break;
         case 2: ui = 2; /* reconfigurationWithSync */break;
         case 3: ui = 3; /* ulUnSynchronized */break;
         case 4: ui = 4; /* schedulingRequestFailure */break;
         case 5: ui = 5; /* noPUCCHResourceAvailable */break;
         case 6: ui = 6; /* requestForOtherSI */break;
         case 7: ui = 7; /* spare9 */break;
         case 8: ui = 8; /* spare8 */break;
