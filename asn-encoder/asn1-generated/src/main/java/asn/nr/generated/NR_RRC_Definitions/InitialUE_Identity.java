...
public class InitialUE_Identity extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // ng_5G_S_TMSI_Part1
         case _NG_5G_S_TMSI_PART1:
            Asn1BitString ng_5G_S_TMSI_Part1 = (Asn1BitString) element;
            ng_5G_S_TMSI_Part1.encode (buffer, 39, 39);
            break;

         // randomValue
         case _RANDOMVALUE:
            Asn1BitString randomValue = (Asn1BitString) element;
            randomValue.encode (buffer, 39, 39);
            break;
