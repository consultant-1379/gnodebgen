...
public class EventTriggerConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((reportAddNeighMeas != null), null);
      ...
      // encode reportAddNeighMeas

      if (reportAddNeighMeas != null) {
         buffer.getContext().eventDispatcher.startElement("reportAddNeighMeas", -1);

         reportAddNeighMeas.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            ...
            buffer.encodeBit ((useT312_r16 != null), "optbit");
