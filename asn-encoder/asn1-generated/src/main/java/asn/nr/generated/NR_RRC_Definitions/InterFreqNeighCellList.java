...
public class InterFreqNeighCellList extends Asn1SeqOf {
   ...
   public InterFreqNeighCellInfo[] elements;

   public InterFreqNeighCellList () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqNeighCellList (int numRecords) {
      elements = new InterFreqNeighCellInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqNeighCellList (InterFreqNeighCellInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqNeighCellInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqNeighCellInfo();
