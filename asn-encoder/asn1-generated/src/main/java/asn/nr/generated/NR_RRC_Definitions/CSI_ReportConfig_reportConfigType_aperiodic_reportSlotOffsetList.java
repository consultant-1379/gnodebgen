...
public class CSI_ReportConfig_reportConfigType_aperiodic_reportSlotOffsetList extends Asn1SeqOf {
   ...
   public CSI_ReportConfig_reportConfigType_aperiodic_reportSlotOffsetList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_ReportConfig_reportConfigType_aperiodic_reportSlotOffsetList (int numRecords) {
    ...
    * given the array.  
    */
   public CSI_ReportConfig_reportConfigType_aperiodic_reportSlotOffsetList (Asn1Integer[] elements_) {
      elements = elements_;
   }
