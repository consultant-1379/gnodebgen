...
public class PDCCH_Config_tpc_PUCCH extends Asn1Choice {
   ...
   public PDCCH_Config_tpc_PUCCH () {
      super();
   }

   public PDCCH_Config_tpc_PUCCH (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (PUCCH_TPC_CommandConfig value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            PUCCH_TPC_CommandConfig setup;
            element = setup = new PUCCH_TPC_CommandConfig();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            PUCCH_TPC_CommandConfig setup = (PUCCH_TPC_CommandConfig) element;
            setup.encode (buffer);
            break;
