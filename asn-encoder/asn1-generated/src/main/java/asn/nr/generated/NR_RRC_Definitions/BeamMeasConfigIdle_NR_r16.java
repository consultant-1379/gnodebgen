...
public class BeamMeasConfigIdle_NR_r16 extends Asn1Seq {
   ...
   public void encode (Asn1PerEncodeBuffer buffer)
      throws Asn1Exception, java.io.IOException
   {
      // encode reportQuantityRS_Indexes_r16

      if (reportQuantityRS_Indexes_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("reportQuantityRS_Indexes_r16", -1);

         reportQuantityRS_Indexes_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("reportQuantityRS_Indexes_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("reportQuantityRS_Indexes_r16");

      // encode maxNrofRS_IndexesToReport_r16

      if (maxNrofRS_IndexesToReport_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("maxNrofRS_IndexesToReport_r16", -1);

         maxNrofRS_IndexesToReport_r16.encode (buffer, 1, 32);

         buffer.getContext().eventDispatcher.endElement("maxNrofRS_IndexesToReport_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("maxNrofRS_IndexesToReport_r16");

      // encode includeBeamMeasurements_r16

      if (includeBeamMeasurements_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("includeBeamMeasurements_r16", -1);

         includeBeamMeasurements_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("includeBeamMeasurements_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("includeBeamMeasurements_r16");
