...
public class BandCombination_bandList extends Asn1SeqOf {
   ...
   public BandParameters[] elements;

   public BandCombination_bandList () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombination_bandList (int numRecords) {
      elements = new BandParameters [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombination_bandList (BandParameters[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters [numElements];
