...
public class CellGlobalIdList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellGlobalIdList-r16";
   }

   public CGI_Info_Logging_r16[] elements;

   public CellGlobalIdList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellGlobalIdList_r16 (int numRecords) {
      elements = new CGI_Info_Logging_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public CellGlobalIdList_r16 (CGI_Info_Logging_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CGI_Info_Logging_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CGI_Info_Logging_r16();
