...
public class AffectedCarrierFreqCombList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AffectedCarrierFreqCombList-r16";
   }

   public AffectedCarrierFreqComb_r16[] elements;

   public AffectedCarrierFreqCombList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AffectedCarrierFreqCombList_r16 (int numRecords) {
      elements = new AffectedCarrierFreqComb_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public AffectedCarrierFreqCombList_r16 (AffectedCarrierFreqComb_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AffectedCarrierFreqComb_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AffectedCarrierFreqComb_r16();
