...
public class DL_DataToUL_ACK_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "DL-DataToUL-ACK-r16";
   }

   public Asn1Integer[] elements;

   public DL_DataToUL_ACK_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public DL_DataToUL_ACK_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public DL_DataToUL_ACK_r16 (Asn1Integer[] elements_) {
      elements = elements_;
   }
