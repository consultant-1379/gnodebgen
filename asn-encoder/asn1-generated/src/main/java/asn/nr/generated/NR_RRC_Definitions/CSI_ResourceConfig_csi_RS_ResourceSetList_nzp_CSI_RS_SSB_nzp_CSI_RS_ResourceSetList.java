...
public class CSI_ResourceConfig_csi_RS_ResourceSetList_nzp_CSI_RS_SSB_nzp_CSI_RS_ResourceSetList extends Asn1SeqOf {
   ...
   public NZP_CSI_RS_ResourceSetId[] elements;

   public CSI_ResourceConfig_csi_RS_ResourceSetList_nzp_CSI_RS_SSB_nzp_CSI_RS_ResourceSetList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_ResourceConfig_csi_RS_ResourceSetList_nzp_CSI_RS_SSB_nzp_CSI_RS_ResourceSetList (int numRecords) {
      elements = new NZP_CSI_RS_ResourceSetId [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_ResourceConfig_csi_RS_ResourceSetList_nzp_CSI_RS_SSB_nzp_CSI_RS_ResourceSetList (NZP_CSI_RS_ResourceSetId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NZP_CSI_RS_ResourceSetId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NZP_CSI_RS_ResourceSetId();
