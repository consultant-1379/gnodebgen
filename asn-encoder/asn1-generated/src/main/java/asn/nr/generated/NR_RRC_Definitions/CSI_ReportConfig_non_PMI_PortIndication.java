...
public class CSI_ReportConfig_non_PMI_PortIndication extends Asn1SeqOf {
   ...
   public PortIndexFor8Ranks[] elements;

   public CSI_ReportConfig_non_PMI_PortIndication () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_ReportConfig_non_PMI_PortIndication (int numRecords) {
      elements = new PortIndexFor8Ranks [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_ReportConfig_non_PMI_PortIndication (PortIndexFor8Ranks[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PortIndexFor8Ranks [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PortIndexFor8Ranks();
