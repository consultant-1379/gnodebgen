...
public class CSI_AperiodicTriggerStateList extends Asn1SeqOf {
   ...
   public CSI_AperiodicTriggerState[] elements;

   public CSI_AperiodicTriggerStateList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_AperiodicTriggerStateList (int numRecords) {
      elements = new CSI_AperiodicTriggerState [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_AperiodicTriggerStateList (CSI_AperiodicTriggerState[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_AperiodicTriggerState [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_AperiodicTriggerState();
