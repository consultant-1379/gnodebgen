...
public class SL_TxPoolDedicated_r16_sl_PoolToReleaseList_r16 extends Asn1SeqOf {
   ...
   public SL_ResourcePoolID_r16[] elements;

   public SL_TxPoolDedicated_r16_sl_PoolToReleaseList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_TxPoolDedicated_r16_sl_PoolToReleaseList_r16 (int numRecords) {
      elements = new SL_ResourcePoolID_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_TxPoolDedicated_r16_sl_PoolToReleaseList_r16 (SL_ResourcePoolID_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_ResourcePoolID_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_ResourcePoolID_r16();
