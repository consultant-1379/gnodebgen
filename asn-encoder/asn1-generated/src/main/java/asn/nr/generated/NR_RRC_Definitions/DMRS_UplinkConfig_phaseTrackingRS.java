...
public class DMRS_UplinkConfig_phaseTrackingRS extends Asn1Choice {
   ...
   public DMRS_UplinkConfig_phaseTrackingRS () {
      super();
   }

   public DMRS_UplinkConfig_phaseTrackingRS (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (PTRS_UplinkConfig value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            PTRS_UplinkConfig setup;
            element = setup = new PTRS_UplinkConfig();
            setup.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            PTRS_UplinkConfig setup = (PTRS_UplinkConfig) element;
            setup.encode (buffer);
            break;
