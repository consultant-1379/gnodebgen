...
public class CodebookConfig_r16_codebookType_type2 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // encode numberOfPMI_SubbandsPerCQI_Subband_r16

      if (numberOfPMI_SubbandsPerCQI_Subband_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("numberOfPMI_SubbandsPerCQI_Subband_r16", -1);

         numberOfPMI_SubbandsPerCQI_Subband_r16.encode (buffer, 1, 2);

         buffer.getContext().eventDispatcher.endElement("numberOfPMI_SubbandsPerCQI_Subband_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("numberOfPMI_SubbandsPerCQI_Subband_r16");

      // encode paramCombination_r16

      if (paramCombination_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("paramCombination_r16", -1);

         paramCombination_r16.encode (buffer, 1, 8);

         buffer.getContext().eventDispatcher.endElement("paramCombination_r16", -1);
      }
      else throw new Asn1MissingRequiredException ("paramCombination_r16");
