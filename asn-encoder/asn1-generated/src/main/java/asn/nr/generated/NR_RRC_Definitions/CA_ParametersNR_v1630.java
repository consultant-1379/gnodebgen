...
public class CA_ParametersNR_v1630 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((simulTX_SRS_AntSwitchingInterBandUL_CA_r16 != null), null);
      buffer.encodeBit ((beamManagementType_r16 != null), null);
      buffer.encodeBit ((intraBandFreqSeparationUL_AggBW_GapBW_r16 != null), null);
      buffer.encodeBit ((interCA_NonAlignedFrame_B_r16 != null), null);

      // encode simulTX_SRS_AntSwitchingInterBandUL_CA_r16

      if (simulTX_SRS_AntSwitchingInterBandUL_CA_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("simulTX_SRS_AntSwitchingInterBandUL_CA_r16", -1);

         simulTX_SRS_AntSwitchingInterBandUL_CA_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("simulTX_SRS_AntSwitchingInterBandUL_CA_r16", -1);
      }

      // encode beamManagementType_r16

      if (beamManagementType_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("beamManagementType_r16", -1);

         beamManagementType_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("beamManagementType_r16", -1);
      }

      // encode intraBandFreqSeparationUL_AggBW_GapBW_r16

      if (intraBandFreqSeparationUL_AggBW_GapBW_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("intraBandFreqSeparationUL_AggBW_GapBW_r16", -1);

         intraBandFreqSeparationUL_AggBW_GapBW_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("intraBandFreqSeparationUL_AggBW_GapBW_r16", -1);
      }

      // encode interCA_NonAlignedFrame_B_r16

      if (interCA_NonAlignedFrame_B_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("interCA_NonAlignedFrame_B_r16", -1);

         interCA_NonAlignedFrame_B_r16.encode (buffer);
