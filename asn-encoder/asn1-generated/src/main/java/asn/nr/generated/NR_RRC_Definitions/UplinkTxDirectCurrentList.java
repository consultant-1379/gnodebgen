...
public class UplinkTxDirectCurrentList extends Asn1SeqOf {
   ...
   public UplinkTxDirectCurrentCell[] elements;

   public UplinkTxDirectCurrentList () {
      elements = null;
   }
    ...
    * populated.
    */
   public UplinkTxDirectCurrentList (int numRecords) {
      elements = new UplinkTxDirectCurrentCell [numRecords];
   }
    ...
    * given the array.  
    */
   public UplinkTxDirectCurrentList (UplinkTxDirectCurrentCell[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UplinkTxDirectCurrentCell [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UplinkTxDirectCurrentCell();
