      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         case _RRCREESTABLISHMENT:
            RRCReestablishment_IEs rrcReestablishment = (RRCReestablishment_IEs) element;
            rrcReestablishment.encode (buffer);
            break;

         // criticalExtensionsFuture
         case _CRITICALEXTENSIONSFUTURE:
            RRCReestablishment_criticalExtensions_criticalExtensionsFuture criticalExtensionsFuture = (RRCReestablishment_criticalExtensions_criticalExtensionsFuture) element;
