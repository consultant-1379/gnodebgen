...
public class MeasResults extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((measResultNeighCells != null), null);
      ...
      // encode measResultServingMOList

      if (measResultServingMOList != null) {
         buffer.getContext().eventDispatcher.startElement("measResultServingMOList", -1);

         measResultServingMOList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("measResultServingMOList", -1);
      }
      else throw new Asn1MissingRequiredException ("measResultServingMOList");
      ...
      if (measResultNeighCells != null) {
         ...
         measResultNeighCells.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((measResultServFreqListEUTRA_SCG != null), "optbit");
            buffer.encodeBit ((measResultServFreqListNR_SCG != null), "optbit");
            buffer.encodeBit ((measResultSFTD_EUTRA != null), "optbit");
            buffer.encodeBit ((measResultSFTD_NR != null), "optbit");
            if (measResultServFreqListEUTRA_SCG != null) {
               measResultServFreqListEUTRA_SCG.encode (buffer);
            }
            if (measResultServFreqListNR_SCG != null) {
               measResultServFreqListNR_SCG.encode (buffer);
            }
            if (measResultSFTD_EUTRA != null) {
               measResultSFTD_EUTRA.encode (buffer);
            }
            if (measResultSFTD_NR != null) {
               measResultSFTD_NR.encode (buffer);
            }
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((measResultCellListSFTD_NR != null), "optbit");
         ...
         if (mV4ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((measResultForRSSI_r16 != null), "optbit");
            buffer.encodeBit ((locationInfo_r16 != null), "optbit");
            buffer.encodeBit ((ul_PDCP_DelayValueResultList_r16 != null), "optbit");
            buffer.encodeBit ((measResultsSL_r16 != null), "optbit");
            buffer.encodeBit ((measResultCLI_r16 != null), "optbit");
            if (measResultForRSSI_r16 != null) {
               measResultForRSSI_r16.encode (buffer);
            }
            if (locationInfo_r16 != null) {
               locationInfo_r16.encode (buffer);
            }
            if (ul_PDCP_DelayValueResultList_r16 != null) {
               ul_PDCP_DelayValueResultList_r16.encode (buffer);
            }
            if (measResultsSL_r16 != null) {
               measResultsSL_r16.encode (buffer);
            }
            if (measResultCLI_r16 != null) {
               measResultCLI_r16.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
