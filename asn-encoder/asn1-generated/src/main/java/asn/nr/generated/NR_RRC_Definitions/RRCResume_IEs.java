...
public class RRCResume_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((radioBearerConfig != null), null);
      buffer.encodeBit ((masterCellGroup != null), null);
      buffer.encodeBit ((measConfig != null), null);
      ...
      // encode radioBearerConfig

      if (radioBearerConfig != null) {
         buffer.getContext().eventDispatcher.startElement("radioBearerConfig", -1);

         radioBearerConfig.encode (buffer);
