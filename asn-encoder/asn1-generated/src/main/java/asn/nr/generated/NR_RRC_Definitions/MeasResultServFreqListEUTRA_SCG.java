...
public class MeasResultServFreqListEUTRA_SCG extends Asn1SeqOf {
   ...
   public MeasResult2EUTRA[] elements;

   public MeasResultServFreqListEUTRA_SCG () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultServFreqListEUTRA_SCG (int numRecords) {
      elements = new MeasResult2EUTRA [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultServFreqListEUTRA_SCG (MeasResult2EUTRA[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResult2EUTRA [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResult2EUTRA();
