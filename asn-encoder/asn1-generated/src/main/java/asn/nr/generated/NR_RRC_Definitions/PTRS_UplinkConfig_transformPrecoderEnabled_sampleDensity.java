...
public class PTRS_UplinkConfig_transformPrecoderEnabled_sampleDensity extends Asn1SeqOf {
   ...
   public PTRS_UplinkConfig_transformPrecoderEnabled_sampleDensity () {
      elements = null;
   }
    ...
    * populated.
    */
   public PTRS_UplinkConfig_transformPrecoderEnabled_sampleDensity (int numRecords) {
    ...
    * given the array.  
    */
   public PTRS_UplinkConfig_transformPrecoderEnabled_sampleDensity (Asn1Integer[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 5, 5);
