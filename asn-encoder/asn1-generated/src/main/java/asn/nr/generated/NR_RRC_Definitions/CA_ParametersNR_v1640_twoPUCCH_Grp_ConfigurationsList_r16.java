...
public class CA_ParametersNR_v1640_twoPUCCH_Grp_ConfigurationsList_r16 extends Asn1SeqOf {
   ...
   public TwoPUCCH_Grp_Configurations_r16[] elements;

   public CA_ParametersNR_v1640_twoPUCCH_Grp_ConfigurationsList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CA_ParametersNR_v1640_twoPUCCH_Grp_ConfigurationsList_r16 (int numRecords) {
      elements = new TwoPUCCH_Grp_Configurations_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public CA_ParametersNR_v1640_twoPUCCH_Grp_ConfigurationsList_r16 (TwoPUCCH_Grp_Configurations_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TwoPUCCH_Grp_Configurations_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TwoPUCCH_Grp_Configurations_r16();
