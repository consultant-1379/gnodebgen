...
public class BWP_Downlink extends Asn1Seq {
   ...
   public BWP_DownlinkCommon bwp_Common;  // optional
   public BWP_DownlinkDedicated bwp_Dedicated;  // optional
   ...
   public BWP_Downlink (
      BWP_Id bwp_Id_,
      BWP_DownlinkCommon bwp_Common_,
      BWP_DownlinkDedicated bwp_Dedicated_
   ) {
      super();
      bwp_Id = bwp_Id_;
    ...
    * the given objects 
    */
   public BWP_Downlink (long bwp_Id_,
      BWP_DownlinkCommon bwp_Common_,
      BWP_DownlinkDedicated bwp_Dedicated_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (bwp_CommonPresent) {
         ...
         bwp_Common = new BWP_DownlinkCommon();
      ...
      if (bwp_DedicatedPresent) {
         ...
         bwp_Dedicated = new BWP_DownlinkDedicated();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((bwp_Common != null), null);
      buffer.encodeBit ((bwp_Dedicated != null), null);
      ...
      if (bwp_Common != null) {
         ...
         bwp_Common.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("bwp_Common", -1);
      }

      // encode bwp_Dedicated

      if (bwp_Dedicated != null) {
         buffer.getContext().eventDispatcher.startElement("bwp_Dedicated", -1);

         bwp_Dedicated.encode (buffer);
