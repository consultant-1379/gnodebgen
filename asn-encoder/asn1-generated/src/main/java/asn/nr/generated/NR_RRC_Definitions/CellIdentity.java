...
public class CellIdentity extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public CellIdentity (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public CellIdentity (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public CellIdentity (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public CellIdentity (java.util.BitSet bitSet) {
      super (bitSet);
   }
