...
public class BandSidelink_r16_sl_TransmissionMode1_r16_scs_CP_PatternTxSidelinkModeOne_r16_fr1_r16 extends Asn1Seq {
   ...
   public BandSidelink_r16_sl_TransmissionMode1_r16_scs_CP_PatternTxSidelinkModeOne_r16_fr1_r16 () {
      super();
      init();
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (scs_15kHz_r16 != null) {
         ...
         scs_15kHz_r16.encode (buffer, 16, 16);
      ...
      if (scs_30kHz_r16 != null) {
         ...
         scs_30kHz_r16.encode (buffer, 16, 16);
