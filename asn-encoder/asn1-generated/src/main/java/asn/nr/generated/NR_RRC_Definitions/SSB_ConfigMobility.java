      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            ...
            buffer.encodeBit ((ssb_PositionQCL_CellsToAddModList_r16 != null), "optbit");
            buffer.encodeBit ((ssb_PositionQCL_CellsToRemoveList_r16 != null), "optbit");
            if (ssb_PositionQCL_Common_r16 != null) {
               ssb_PositionQCL_Common_r16.encode (buffer);
            }
            if (ssb_PositionQCL_CellsToAddModList_r16 != null) {
               ssb_PositionQCL_CellsToAddModList_r16.encode (buffer);
            }
            if (ssb_PositionQCL_CellsToRemoveList_r16 != null) {
               ssb_PositionQCL_CellsToRemoveList_r16.encode (buffer);
            }
