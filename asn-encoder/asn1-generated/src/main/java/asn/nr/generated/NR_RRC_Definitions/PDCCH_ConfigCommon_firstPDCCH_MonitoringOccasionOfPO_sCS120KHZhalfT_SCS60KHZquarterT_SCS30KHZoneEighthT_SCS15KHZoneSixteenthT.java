...
public class PDCCH_ConfigCommon_firstPDCCH_MonitoringOccasionOfPO_sCS120KHZhalfT_SCS60KHZquarterT_SCS30KHZoneEighthT_SCS15KHZoneSixteenthT extends Asn1SeqOf {
   ...
   public PDCCH_ConfigCommon_firstPDCCH_MonitoringOccasionOfPO_sCS120KHZhalfT_SCS60KHZquarterT_SCS30KHZoneEighthT_SCS15KHZoneSixteenthT () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDCCH_ConfigCommon_firstPDCCH_MonitoringOccasionOfPO_sCS120KHZhalfT_SCS60KHZquarterT_SCS30KHZoneEighthT_SCS15KHZoneSixteenthT (int numRecords) {
    ...
    * given the array.  
    */
   public PDCCH_ConfigCommon_firstPDCCH_MonitoringOccasionOfPO_sCS120KHZhalfT_SCS60KHZquarterT_SCS30KHZoneEighthT_SCS15KHZoneSixteenthT (Asn1Integer[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i].decode (buffer, 0, 2239);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i].encode (buffer, 0, 2239);
