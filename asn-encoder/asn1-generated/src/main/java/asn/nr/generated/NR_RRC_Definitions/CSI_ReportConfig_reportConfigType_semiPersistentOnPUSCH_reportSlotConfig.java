...
public class CSI_ReportConfig_reportConfigType_semiPersistentOnPUSCH_reportSlotConfig extends Asn1Enumerated {
      ...
      throws Asn1Exception, java.io.IOException
   {
      int ui;  // enum index
      switch ((int)value) {
         case 0: ui = 0; /* sl5 */break;
         case 1: ui = 1; /* sl10 */break;
         case 2: ui = 2; /* sl20 */break;
         case 3: ui = 3; /* sl40 */break;
         case 4: ui = 4; /* sl80 */break;
         case 5: ui = 5; /* sl160 */break;
         case 6: ui = 6; /* sl320 */break;
         default:
