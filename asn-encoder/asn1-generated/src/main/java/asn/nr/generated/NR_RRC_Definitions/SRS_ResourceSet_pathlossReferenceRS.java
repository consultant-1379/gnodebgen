...
public class SRS_ResourceSet_pathlossReferenceRS extends Asn1Choice {
   ...
   public SRS_ResourceSet_pathlossReferenceRS () {
      super();
   }

   public SRS_ResourceSet_pathlossReferenceRS (byte choiceId_, Asn1Type element_) {
      super();
