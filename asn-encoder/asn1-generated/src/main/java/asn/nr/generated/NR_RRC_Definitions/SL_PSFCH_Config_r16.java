...
public class SL_PSFCH_Config_r16 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((sl_PSFCH_Period_r16 != null), null);
      buffer.encodeBit ((sl_PSFCH_RB_Set_r16 != null), null);
      buffer.encodeBit ((sl_NumMuxCS_Pair_r16 != null), null);
      buffer.encodeBit ((sl_MinTimeGapPSFCH_r16 != null), null);
      buffer.encodeBit ((sl_PSFCH_HopID_r16 != null), null);
      buffer.encodeBit ((sl_PSFCH_CandidateResourceType_r16 != null), null);

      // encode sl_PSFCH_Period_r16

      if (sl_PSFCH_Period_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_PSFCH_Period_r16", -1);

         sl_PSFCH_Period_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_PSFCH_Period_r16", -1);
      }

      // encode sl_PSFCH_RB_Set_r16

      if (sl_PSFCH_RB_Set_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_PSFCH_RB_Set_r16", -1);

         sl_PSFCH_RB_Set_r16.encode (buffer, 10, 275);

         buffer.getContext().eventDispatcher.endElement("sl_PSFCH_RB_Set_r16", -1);
      }

      // encode sl_NumMuxCS_Pair_r16

      if (sl_NumMuxCS_Pair_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_NumMuxCS_Pair_r16", -1);

         sl_NumMuxCS_Pair_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_NumMuxCS_Pair_r16", -1);
      }

      // encode sl_MinTimeGapPSFCH_r16

      if (sl_MinTimeGapPSFCH_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_MinTimeGapPSFCH_r16", -1);

         sl_MinTimeGapPSFCH_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sl_MinTimeGapPSFCH_r16", -1);
      }

      // encode sl_PSFCH_HopID_r16

      if (sl_PSFCH_HopID_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_PSFCH_HopID_r16", -1);

         sl_PSFCH_HopID_r16.encode (buffer, 0, 1023);

         buffer.getContext().eventDispatcher.endElement("sl_PSFCH_HopID_r16", -1);
      }

      // encode sl_PSFCH_CandidateResourceType_r16

      if (sl_PSFCH_CandidateResourceType_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("sl_PSFCH_CandidateResourceType_r16", -1);

         sl_PSFCH_CandidateResourceType_r16.encode (buffer);
