...
public class CSI_MeasConfig_csi_SSB_ResourceSetToReleaseList extends Asn1SeqOf {
   ...
   public CSI_MeasConfig_csi_SSB_ResourceSetToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_csi_SSB_ResourceSetToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public CSI_MeasConfig_csi_SSB_ResourceSetToReleaseList (CSI_SSB_ResourceSetId[] elements_) {
      elements = elements_;
   }
