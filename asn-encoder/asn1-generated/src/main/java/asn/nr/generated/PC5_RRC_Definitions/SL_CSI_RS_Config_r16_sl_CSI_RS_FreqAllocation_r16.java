...
public class SL_CSI_RS_Config_r16_sl_CSI_RS_FreqAllocation_r16 extends Asn1Choice {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // sl_OneAntennaPort_r16
         case _SL_ONEANTENNAPORT_R16:
            Asn1BitString sl_OneAntennaPort_r16 = (Asn1BitString) element;
            sl_OneAntennaPort_r16.encode (buffer, 12, 12);
            break;

         // sl_TwoAntennaPort_r16
         case _SL_TWOANTENNAPORT_R16:
            Asn1BitString sl_TwoAntennaPort_r16 = (Asn1BitString) element;
            sl_TwoAntennaPort_r16.encode (buffer, 6, 6);
            break;
