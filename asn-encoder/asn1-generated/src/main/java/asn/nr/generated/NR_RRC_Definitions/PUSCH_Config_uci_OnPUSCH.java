...
public class PUSCH_Config_uci_OnPUSCH extends Asn1Choice {
   ...
   public PUSCH_Config_uci_OnPUSCH () {
      super();
   }

   public PUSCH_Config_uci_OnPUSCH (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (UCI_OnPUSCH value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         ...
         // setup
         case _SETUP:
            UCI_OnPUSCH setup = (UCI_OnPUSCH) element;
            setup.encode (buffer);
            break;
