...
public class SecurityConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((securityAlgorithmConfig != null), null);
      buffer.encodeBit ((keyToUse != null), null);

      // encode securityAlgorithmConfig

      if (securityAlgorithmConfig != null) {
         buffer.getContext().eventDispatcher.startElement("securityAlgorithmConfig", -1);

         securityAlgorithmConfig.encode (buffer);
