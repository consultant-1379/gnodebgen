...
public class FeatureSets_featureSetsDownlink extends Asn1SeqOf {
   ...
   public FeatureSetDownlink[] elements;

   public FeatureSets_featureSetsDownlink () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSets_featureSetsDownlink (int numRecords) {
      elements = new FeatureSetDownlink [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSets_featureSetsDownlink (FeatureSetDownlink[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetDownlink [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetDownlink();
