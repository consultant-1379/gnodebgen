...
public class AffectedCarrierFreqComb_r16_affectedCarrierFreqComb_r16 extends Asn1SeqOf {
   ...
   public AffectedCarrierFreqComb_r16_affectedCarrierFreqComb_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AffectedCarrierFreqComb_r16_affectedCarrierFreqComb_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public AffectedCarrierFreqComb_r16_affectedCarrierFreqComb_r16 (ARFCN_ValueNR[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 2, 32);
