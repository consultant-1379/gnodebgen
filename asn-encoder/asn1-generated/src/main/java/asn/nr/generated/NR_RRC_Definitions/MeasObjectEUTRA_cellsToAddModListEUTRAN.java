...
public class MeasObjectEUTRA_cellsToAddModListEUTRAN extends Asn1SeqOf {
   ...
   public EUTRA_Cell[] elements;

   public MeasObjectEUTRA_cellsToAddModListEUTRAN () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasObjectEUTRA_cellsToAddModListEUTRAN (int numRecords) {
      elements = new EUTRA_Cell [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasObjectEUTRA_cellsToAddModListEUTRAN (EUTRA_Cell[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EUTRA_Cell [numElements];
