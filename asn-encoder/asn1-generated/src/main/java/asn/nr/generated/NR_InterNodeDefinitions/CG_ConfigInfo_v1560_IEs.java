...
import asn.nr.generated.NR_RRC_Definitions.DRX_Config;
import asn.nr.generated.NR_RRC_Definitions.MeasResultCellListSFTD_EUTRA;
...
public class CG_ConfigInfo_v1560_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((candidateCellInfoListMN_EUTRA != null), null);
      buffer.encodeBit ((candidateCellInfoListSN_EUTRA != null), null);
      buffer.encodeBit ((sourceConfigSCG_EUTRA != null), null);
      buffer.encodeBit ((scgFailureInfoEUTRA != null), null);
      buffer.encodeBit ((drx_ConfigMCG != null), null);
      buffer.encodeBit ((measResultReportCGI_EUTRA != null), null);
      buffer.encodeBit ((measResultCellListSFTD_EUTRA != null), null);
      buffer.encodeBit ((fr_InfoListMCG != null), null);
      buffer.encodeBit ((nonCriticalExtension != null), null);

      // encode candidateCellInfoListMN_EUTRA

      if (candidateCellInfoListMN_EUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("candidateCellInfoListMN_EUTRA", -1);

         candidateCellInfoListMN_EUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("candidateCellInfoListMN_EUTRA", -1);
      }

      // encode candidateCellInfoListSN_EUTRA

      if (candidateCellInfoListSN_EUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("candidateCellInfoListSN_EUTRA", -1);

         candidateCellInfoListSN_EUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("candidateCellInfoListSN_EUTRA", -1);
      }

      // encode sourceConfigSCG_EUTRA

      if (sourceConfigSCG_EUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("sourceConfigSCG_EUTRA", -1);

         sourceConfigSCG_EUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("sourceConfigSCG_EUTRA", -1);
      }

      // encode scgFailureInfoEUTRA

      if (scgFailureInfoEUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("scgFailureInfoEUTRA", -1);

         scgFailureInfoEUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("scgFailureInfoEUTRA", -1);
      }

      // encode drx_ConfigMCG

      if (drx_ConfigMCG != null) {
         buffer.getContext().eventDispatcher.startElement("drx_ConfigMCG", -1);

         drx_ConfigMCG.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("drx_ConfigMCG", -1);
      }

      // encode measResultReportCGI_EUTRA

      if (measResultReportCGI_EUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("measResultReportCGI_EUTRA", -1);

         measResultReportCGI_EUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("measResultReportCGI_EUTRA", -1);
      }

      // encode measResultCellListSFTD_EUTRA

      if (measResultCellListSFTD_EUTRA != null) {
         buffer.getContext().eventDispatcher.startElement("measResultCellListSFTD_EUTRA", -1);

         measResultCellListSFTD_EUTRA.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("measResultCellListSFTD_EUTRA", -1);
      }

      // encode fr_InfoListMCG

      if (fr_InfoListMCG != null) {
         buffer.getContext().eventDispatcher.startElement("fr_InfoListMCG", -1);

         fr_InfoListMCG.encode (buffer);
