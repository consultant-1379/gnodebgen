...
public class FeatureSetDownlink_timeDurationForQCL extends Asn1Seq {
   ...
   public FeatureSetDownlink_timeDurationForQCL_scs_60kHz scs_60kHz = null;  // optional
   public FeatureSetDownlink_timeDurationForQCL_scs_120kHz scs_120kHz = null;  // optional

   public FeatureSetDownlink_timeDurationForQCL () {
      super();
      init();
   }
    ...
    */
   public FeatureSetDownlink_timeDurationForQCL (
      FeatureSetDownlink_timeDurationForQCL_scs_60kHz scs_60kHz_,
      FeatureSetDownlink_timeDurationForQCL_scs_120kHz scs_120kHz_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (scs_60kHzPresent) {
         ...
         int tval = FeatureSetDownlink_timeDurationForQCL_scs_60kHz.decodeEnumValue (buffer);
         scs_60kHz = FeatureSetDownlink_timeDurationForQCL_scs_60kHz.valueOf (tval);
      ...
      if (scs_120kHzPresent) {
         ...
         int tval = FeatureSetDownlink_timeDurationForQCL_scs_120kHz.decodeEnumValue (buffer);
         scs_120kHz = FeatureSetDownlink_timeDurationForQCL_scs_120kHz.valueOf (tval);
