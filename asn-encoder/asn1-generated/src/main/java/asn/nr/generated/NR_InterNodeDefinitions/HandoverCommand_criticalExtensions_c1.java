...
public class HandoverCommand_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _HANDOVERCOMMAND = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public HandoverCommand_criticalExtensions_c1 () {
      super();
   }

   public HandoverCommand_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _HANDOVERCOMMAND: return "handoverCommand";
   ...
   public void set_handoverCommand (HandoverCommand_IEs value) {
      setElement (_HANDOVERCOMMAND, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         // handoverCommand
         case 0: { 
            HandoverCommand_IEs handoverCommand;
            element = handoverCommand = new HandoverCommand_IEs();
            handoverCommand.decode (buffer);
            break;
         }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (choiceID) {
         // handoverCommand
         case _HANDOVERCOMMAND:
            HandoverCommand_IEs handoverCommand = (HandoverCommand_IEs) element;
            handoverCommand.encode (buffer);
            break;
