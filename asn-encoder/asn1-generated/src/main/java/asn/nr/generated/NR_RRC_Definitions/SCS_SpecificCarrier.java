...
public class SCS_SpecificCarrier extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // encode offsetToCarrier

      if (offsetToCarrier != null) {
         buffer.getContext().eventDispatcher.startElement("offsetToCarrier", -1);

         offsetToCarrier.encode (buffer, 0, 2199);

         buffer.getContext().eventDispatcher.endElement("offsetToCarrier", -1);
      }
      else throw new Asn1MissingRequiredException ("offsetToCarrier");
      ...
      if (carrierBandwidth != null) {
         ...
         carrierBandwidth.encode (buffer, 1, 275);

         buffer.getContext().eventDispatcher.endElement("carrierBandwidth", -1);
      }
      else throw new Asn1MissingRequiredException ("carrierBandwidth");
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((txDirectCurrentLocation != null), "optbit");
            if (txDirectCurrentLocation != null) {
               txDirectCurrentLocation.encode (buffer, 0, 4095);
            }
