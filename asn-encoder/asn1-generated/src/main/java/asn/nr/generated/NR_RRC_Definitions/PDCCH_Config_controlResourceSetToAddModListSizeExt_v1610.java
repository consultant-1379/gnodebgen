...
public class PDCCH_Config_controlResourceSetToAddModListSizeExt_v1610 extends Asn1SeqOf {
   ...
   public ControlResourceSet[] elements;

   public PDCCH_Config_controlResourceSetToAddModListSizeExt_v1610 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDCCH_Config_controlResourceSetToAddModListSizeExt_v1610 (int numRecords) {
      elements = new ControlResourceSet [numRecords];
   }
    ...
    * given the array.  
    */
   public PDCCH_Config_controlResourceSetToAddModListSizeExt_v1610 (ControlResourceSet[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ControlResourceSet [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ControlResourceSet();
