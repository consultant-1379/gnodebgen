...
public class CandidateBeamRSListExt_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CandidateBeamRSListExt-r16";
   }

   public PRACH_ResourceDedicatedBFR[] elements;

   public CandidateBeamRSListExt_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CandidateBeamRSListExt_r16 (int numRecords) {
      elements = new PRACH_ResourceDedicatedBFR [numRecords];
   }
    ...
    * given the array.  
    */
   public CandidateBeamRSListExt_r16 (PRACH_ResourceDedicatedBFR[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 48);
      int numElements = (int) buffer.decodeLength();

      elements = new PRACH_ResourceDedicatedBFR [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PRACH_ResourceDedicatedBFR();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 1, 48);
