...
public class PUCCH_Config_spatialRelationInfoToReleaseList extends Asn1SeqOf {
   ...
   public PUCCH_Config_spatialRelationInfoToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_spatialRelationInfoToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public PUCCH_Config_spatialRelationInfoToReleaseList (PUCCH_SpatialRelationInfoId[] elements_) {
      elements = elements_;
   }
