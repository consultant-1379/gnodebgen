...
import asn.nr.generated.NR_RRC_Definitions.RAN_NotificationAreaInfo;
import asn.nr.generated.NR_RRC_Definitions.UEAssistanceInformation;
import asn.nr.generated.NR_RRC_Definitions.NeedForGapsInfoNR_r16;
...
public class AS_Context extends Asn1Seq {
   ...
   public ConfigRestrictInfoDAPS_v1640 configRestrictInfoDAPS_v1640;  // optional
   ...
   public AS_Context (
      ...
      ConfigRestrictInfoDAPS_v1640 configRestrictInfoDAPS_v1640_
   ) {
      super();
      reestablishmentInfo = reestablishmentInfo_;
   ...
   public void init () {
      ...
      configRestrictInfoDAPS_v1640 = null;
      extElem1 = null;
   }
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 11: return configRestrictInfoDAPS_v1640;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 11: return "configRestrictInfoDAPS-v1640";
         case 12: return null;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (extbit) {
         ...
         if (i < bitcnt && bitmap[i++]) {
            ...
            boolean configRestrictInfoDAPS_v1640Present = buffer.decodeBit ("configRestrictInfoDAPS_v1640Present");

            // decode configRestrictInfoDAPS_v1640

            if (configRestrictInfoDAPS_v1640Present) {
               buffer.getContext().eventDispatcher.startElement("configRestrictInfoDAPS_v1640", -1);

               configRestrictInfoDAPS_v1640 = new ConfigRestrictInfoDAPS_v1640();
               configRestrictInfoDAPS_v1640.decode (buffer);
               buffer.getContext().eventDispatcher.endElement("configRestrictInfoDAPS_v1640", -1);
            }
            else {
               configRestrictInfoDAPS_v1640 = null;
            }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((reestablishmentInfo != null), null);
      buffer.encodeBit ((configRestrictInfo != null), null);
      ...
      if (reestablishmentInfo != null) {
         ...
         reestablishmentInfo.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("reestablishmentInfo", -1);
      }

      // encode configRestrictInfo

      if (configRestrictInfo != null) {
         buffer.getContext().eventDispatcher.startElement("configRestrictInfo", -1);

         configRestrictInfo.encode (buffer);
      ...
      if (extbit) {
         ...
         if (mV2ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((ran_NotificationAreaInfo != null), "optbit");
         ...
         if (mV3ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((ueAssistanceInformation != null), "optbit");
            if (ueAssistanceInformation != null) {
               Asn1OctetString ueAssistanceInformation_outer;
               {
                  Asn1PerEncodeBuffer savedBuffer = buffer;
                  buffer = new Asn1PerEncodeBuffer(buffer.isAligned());
                  ueAssistanceInformation.encode (buffer);
                  ueAssistanceInformation_outer = new Asn1OctetString(buffer.getMsgCopy() );
                  buffer = savedBuffer;
               }
               ueAssistanceInformation_outer.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
         ...
         if (mV4ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((selectedBandCombinationSN != null), "optbit");
            if (selectedBandCombinationSN != null) {
               selectedBandCombinationSN.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
         ...
         if (mV5ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((configRestrictInfoDAPS_r16 != null), "optbit");
            buffer.encodeBit ((sidelinkUEInformationNR_r16 != null), "optbit");
            buffer.encodeBit ((sidelinkUEInformationEUTRA_r16 != null), "optbit");
            buffer.encodeBit ((ueAssistanceInformationEUTRA_r16 != null), "optbit");
            buffer.encodeBit ((ueAssistanceInformationSCG_r16 != null), "optbit");
            buffer.encodeBit ((needForGapsInfoNR_r16 != null), "optbit");
            if (configRestrictInfoDAPS_r16 != null) {
               configRestrictInfoDAPS_r16.encode (buffer);
            }
            ...
            if (ueAssistanceInformationEUTRA_r16 != null) {
               ueAssistanceInformationEUTRA_r16.encode (buffer);
            }
            if (ueAssistanceInformationSCG_r16 != null) {
               Asn1OctetString ueAssistanceInformationSCG_r16_outer;
               {
                  Asn1PerEncodeBuffer savedBuffer = buffer;
                  buffer = new Asn1PerEncodeBuffer(buffer.isAligned());
                  ueAssistanceInformationSCG_r16.encode (buffer);
                  ueAssistanceInformationSCG_r16_outer = new Asn1OctetString(buffer.getMsgCopy() );
                  buffer = savedBuffer;
               }
               ueAssistanceInformationSCG_r16_outer.encode (buffer);
            }
         ...
         if (mV6ExtPresent) {
            buffer.reset();
            buffer.encodeBit ((configRestrictInfoDAPS_v1640 != null), "optbit");
            if (configRestrictInfoDAPS_v1640 != null) {
               configRestrictInfoDAPS_v1640.encode (buffer);
            }
            mainBuffer.encodeOpenType (buffer, null);
         }
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (configRestrictInfoDAPS_v1640 != null) configRestrictInfoDAPS_v1640.print (_sb, "configRestrictInfoDAPS_v1640", _level+1);
