...
public class SchedulingRequestConfig extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((schedulingRequestToAddModList != null), null);
      buffer.encodeBit ((schedulingRequestToReleaseList != null), null);

      // encode schedulingRequestToAddModList

      if (schedulingRequestToAddModList != null) {
         buffer.getContext().eventDispatcher.startElement("schedulingRequestToAddModList", -1);

         schedulingRequestToAddModList.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("schedulingRequestToAddModList", -1);
      }

      // encode schedulingRequestToReleaseList

      if (schedulingRequestToReleaseList != null) {
         buffer.getContext().eventDispatcher.startElement("schedulingRequestToReleaseList", -1);

         schedulingRequestToReleaseList.encode (buffer);
