...
public class BandNR_channelBW_DL_IAB_r16_fr2_200mhz extends Asn1Seq {
   ...
   public BandNR_channelBW_DL_IAB_r16_fr2_200mhz_scs_60kHz scs_60kHz = null;  // optional
   public BandNR_channelBW_DL_IAB_r16_fr2_200mhz_scs_120kHz scs_120kHz = null;  // optional

   public BandNR_channelBW_DL_IAB_r16_fr2_200mhz () {
      super();
      init();
   }
    ...
    */
   public BandNR_channelBW_DL_IAB_r16_fr2_200mhz (
      BandNR_channelBW_DL_IAB_r16_fr2_200mhz_scs_60kHz scs_60kHz_,
      BandNR_channelBW_DL_IAB_r16_fr2_200mhz_scs_120kHz scs_120kHz_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (scs_60kHzPresent) {
         ...
         int tval = BandNR_channelBW_DL_IAB_r16_fr2_200mhz_scs_60kHz.decodeEnumValue (buffer);
         scs_60kHz = BandNR_channelBW_DL_IAB_r16_fr2_200mhz_scs_60kHz.valueOf (tval);
      ...
      if (scs_120kHzPresent) {
         ...
         int tval = BandNR_channelBW_DL_IAB_r16_fr2_200mhz_scs_120kHz.decodeEnumValue (buffer);
         scs_120kHz = BandNR_channelBW_DL_IAB_r16_fr2_200mhz_scs_120kHz.valueOf (tval);
