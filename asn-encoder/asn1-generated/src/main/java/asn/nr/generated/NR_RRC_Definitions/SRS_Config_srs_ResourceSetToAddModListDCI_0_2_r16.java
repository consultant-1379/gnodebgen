...
public class SRS_Config_srs_ResourceSetToAddModListDCI_0_2_r16 extends Asn1SeqOf {
   ...
   public SRS_ResourceSet[] elements;

   public SRS_Config_srs_ResourceSetToAddModListDCI_0_2_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRS_Config_srs_ResourceSetToAddModListDCI_0_2_r16 (int numRecords) {
      elements = new SRS_ResourceSet [numRecords];
   }
    ...
    * given the array.  
    */
   public SRS_Config_srs_ResourceSetToAddModListDCI_0_2_r16 (SRS_ResourceSet[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRS_ResourceSet [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRS_ResourceSet();
