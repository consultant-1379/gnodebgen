...
public class CG_Config_v1590_IEs_scellFrequenciesSN_EUTRA extends Asn1SeqOf {
   ...
   public CG_Config_v1590_IEs_scellFrequenciesSN_EUTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public CG_Config_v1590_IEs_scellFrequenciesSN_EUTRA (int numRecords) {
    ...
    * given the array.  
    */
   public CG_Config_v1590_IEs_scellFrequenciesSN_EUTRA (ARFCN_ValueEUTRA[] elements_) {
      elements = elements_;
   }
