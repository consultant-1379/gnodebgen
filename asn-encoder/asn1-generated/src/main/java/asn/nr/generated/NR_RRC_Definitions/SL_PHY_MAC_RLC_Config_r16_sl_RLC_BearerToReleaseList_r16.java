...
public class SL_PHY_MAC_RLC_Config_r16_sl_RLC_BearerToReleaseList_r16 extends Asn1SeqOf {
   ...
   public SL_RLC_BearerConfigIndex_r16[] elements;

   public SL_PHY_MAC_RLC_Config_r16_sl_RLC_BearerToReleaseList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_PHY_MAC_RLC_Config_r16_sl_RLC_BearerToReleaseList_r16 (int numRecords) {
      elements = new SL_RLC_BearerConfigIndex_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_PHY_MAC_RLC_Config_r16_sl_RLC_BearerToReleaseList_r16 (SL_RLC_BearerConfigIndex_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_RLC_BearerConfigIndex_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_RLC_BearerConfigIndex_r16();
