...
public class SRS_Config_srs_ResourceSetToAddModList extends Asn1SeqOf {
   ...
   public SRS_Config_srs_ResourceSetToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRS_Config_srs_ResourceSetToAddModList (int numRecords) {
    ...
    * given the array.  
    */
   public SRS_Config_srs_ResourceSetToAddModList (SRS_ResourceSet[] elements_) {
      elements = elements_;
   }
