...
public class CFRA_CSIRS_Resource_ra_OccasionList extends Asn1SeqOf {
   ...
   public CFRA_CSIRS_Resource_ra_OccasionList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CFRA_CSIRS_Resource_ra_OccasionList (int numRecords) {
    ...
    * given the array.  
    */
   public CFRA_CSIRS_Resource_ra_OccasionList (Asn1Integer[] elements_) {
      elements = elements_;
   }
