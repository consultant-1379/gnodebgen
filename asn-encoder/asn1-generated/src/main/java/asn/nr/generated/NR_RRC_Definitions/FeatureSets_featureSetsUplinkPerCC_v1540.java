...
public class FeatureSets_featureSetsUplinkPerCC_v1540 extends Asn1SeqOf {
   ...
   public FeatureSetUplinkPerCC_v1540[] elements;

   public FeatureSets_featureSetsUplinkPerCC_v1540 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSets_featureSetsUplinkPerCC_v1540 (int numRecords) {
      elements = new FeatureSetUplinkPerCC_v1540 [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSets_featureSetsUplinkPerCC_v1540 (FeatureSetUplinkPerCC_v1540[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetUplinkPerCC_v1540 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetUplinkPerCC_v1540();
