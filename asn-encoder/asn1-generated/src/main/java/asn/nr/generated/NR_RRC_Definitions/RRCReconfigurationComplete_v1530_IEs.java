...
public class RRCReconfigurationComplete_v1530_IEs extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((uplinkTxDirectCurrentList != null), null);
      buffer.encodeBit ((nonCriticalExtension != null), null);

      // encode uplinkTxDirectCurrentList

      if (uplinkTxDirectCurrentList != null) {
         buffer.getContext().eventDispatcher.startElement("uplinkTxDirectCurrentList", -1);

         uplinkTxDirectCurrentList.encode (buffer);
