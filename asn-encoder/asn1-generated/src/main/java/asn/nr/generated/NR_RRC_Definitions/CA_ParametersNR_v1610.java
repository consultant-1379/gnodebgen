...
public class CA_ParametersNR_v1610 extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeBit ((parallelTxMsgA_SRS_PUCCH_PUSCH_r16 != null), null);
      buffer.encodeBit ((msgA_SUL_r16 != null), null);
      buffer.encodeBit ((jointSearchSpaceGroupSwitchingAcrossCells_r16 != null), null);
      buffer.encodeBit ((half_DuplexTDD_CA_SameSCS_r16 != null), null);
      buffer.encodeBit ((scellDormancyWithinActiveTime_r16 != null), null);
      buffer.encodeBit ((scellDormancyOutsideActiveTime_r16 != null), null);
      buffer.encodeBit ((crossCarrierA_CSI_trigDiffSCS_r16 != null), null);
      buffer.encodeBit ((defaultQCL_CrossCarrierA_CSI_Trig_r16 != null), null);
      buffer.encodeBit ((interCA_NonAlignedFrame_r16 != null), null);
      buffer.encodeBit ((simul_SRS_Trans_BC_r16 != null), null);
      buffer.encodeBit ((interFreqDAPS_r16 != null), null);
      buffer.encodeBit ((codebookParametersPerBC_r16 != null), null);
      buffer.encodeBit ((blindDetectFactor_r16 != null), null);
      buffer.encodeBit ((pdcch_MonitoringCA_r16 != null), null);
      buffer.encodeBit ((pdcch_BlindDetectionCA_Mixed_r16 != null), null);
      buffer.encodeBit ((pdcch_BlindDetectionMCG_UE_r16 != null), null);
      buffer.encodeBit ((pdcch_BlindDetectionSCG_UE_r16 != null), null);
      buffer.encodeBit ((pdcch_BlindDetectionMCG_UE_Mixed_r16 != null), null);
      buffer.encodeBit ((pdcch_BlindDetectionSCG_UE_Mixed_r16 != null), null);
      buffer.encodeBit ((crossCarrierSchedulingDL_DiffSCS_r16 != null), null);
      buffer.encodeBit ((crossCarrierSchedulingDefaultQCL_r16 != null), null);
      buffer.encodeBit ((crossCarrierSchedulingUL_DiffSCS_r16 != null), null);
      buffer.encodeBit ((simul_SRS_MIMO_Trans_BC_r16 != null), null);
      buffer.encodeBit ((codebookParametersAdditionPerBC_r16 != null), null);
      buffer.encodeBit ((codebookComboParametersAdditionPerBC_r16 != null), null);

      // encode parallelTxMsgA_SRS_PUCCH_PUSCH_r16

      if (parallelTxMsgA_SRS_PUCCH_PUSCH_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("parallelTxMsgA_SRS_PUCCH_PUSCH_r16", -1);

         parallelTxMsgA_SRS_PUCCH_PUSCH_r16.encode (buffer);
      ...
      if (msgA_SUL_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("msgA_SUL_r16", -1);

         msgA_SUL_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("msgA_SUL_r16", -1);
      }

      // encode jointSearchSpaceGroupSwitchingAcrossCells_r16

      if (jointSearchSpaceGroupSwitchingAcrossCells_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("jointSearchSpaceGroupSwitchingAcrossCells_r16", -1);

         jointSearchSpaceGroupSwitchingAcrossCells_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("jointSearchSpaceGroupSwitchingAcrossCells_r16", -1);
      }

      // encode half_DuplexTDD_CA_SameSCS_r16

      if (half_DuplexTDD_CA_SameSCS_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("half_DuplexTDD_CA_SameSCS_r16", -1);

         half_DuplexTDD_CA_SameSCS_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("half_DuplexTDD_CA_SameSCS_r16", -1);
      }

      // encode scellDormancyWithinActiveTime_r16

      if (scellDormancyWithinActiveTime_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("scellDormancyWithinActiveTime_r16", -1);

         scellDormancyWithinActiveTime_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("scellDormancyWithinActiveTime_r16", -1);
      }

      // encode scellDormancyOutsideActiveTime_r16

      if (scellDormancyOutsideActiveTime_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("scellDormancyOutsideActiveTime_r16", -1);

         scellDormancyOutsideActiveTime_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("scellDormancyOutsideActiveTime_r16", -1);
      }

      // encode crossCarrierA_CSI_trigDiffSCS_r16

      if (crossCarrierA_CSI_trigDiffSCS_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("crossCarrierA_CSI_trigDiffSCS_r16", -1);

         crossCarrierA_CSI_trigDiffSCS_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("crossCarrierA_CSI_trigDiffSCS_r16", -1);
      }

      // encode defaultQCL_CrossCarrierA_CSI_Trig_r16

      if (defaultQCL_CrossCarrierA_CSI_Trig_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("defaultQCL_CrossCarrierA_CSI_Trig_r16", -1);

         defaultQCL_CrossCarrierA_CSI_Trig_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("defaultQCL_CrossCarrierA_CSI_Trig_r16", -1);
      }

      // encode interCA_NonAlignedFrame_r16

      if (interCA_NonAlignedFrame_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("interCA_NonAlignedFrame_r16", -1);

         interCA_NonAlignedFrame_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("interCA_NonAlignedFrame_r16", -1);
      }

      // encode simul_SRS_Trans_BC_r16

      if (simul_SRS_Trans_BC_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("simul_SRS_Trans_BC_r16", -1);

         simul_SRS_Trans_BC_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("simul_SRS_Trans_BC_r16", -1);
      }

      // encode interFreqDAPS_r16

      if (interFreqDAPS_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("interFreqDAPS_r16", -1);

         interFreqDAPS_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("interFreqDAPS_r16", -1);
      }

      // encode codebookParametersPerBC_r16

      if (codebookParametersPerBC_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("codebookParametersPerBC_r16", -1);

         codebookParametersPerBC_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("codebookParametersPerBC_r16", -1);
      }

      // encode blindDetectFactor_r16

      if (blindDetectFactor_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("blindDetectFactor_r16", -1);

         blindDetectFactor_r16.encode (buffer, 1, 2);

         buffer.getContext().eventDispatcher.endElement("blindDetectFactor_r16", -1);
      }

      // encode pdcch_MonitoringCA_r16

      if (pdcch_MonitoringCA_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_MonitoringCA_r16", -1);

         pdcch_MonitoringCA_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pdcch_MonitoringCA_r16", -1);
      }

      // encode pdcch_BlindDetectionCA_Mixed_r16

      if (pdcch_BlindDetectionCA_Mixed_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_BlindDetectionCA_Mixed_r16", -1);

         pdcch_BlindDetectionCA_Mixed_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pdcch_BlindDetectionCA_Mixed_r16", -1);
      }

      // encode pdcch_BlindDetectionMCG_UE_r16

      if (pdcch_BlindDetectionMCG_UE_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_BlindDetectionMCG_UE_r16", -1);

         pdcch_BlindDetectionMCG_UE_r16.encode (buffer, 1, 14);

         buffer.getContext().eventDispatcher.endElement("pdcch_BlindDetectionMCG_UE_r16", -1);
      }

      // encode pdcch_BlindDetectionSCG_UE_r16

      if (pdcch_BlindDetectionSCG_UE_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_BlindDetectionSCG_UE_r16", -1);

         pdcch_BlindDetectionSCG_UE_r16.encode (buffer, 1, 14);

         buffer.getContext().eventDispatcher.endElement("pdcch_BlindDetectionSCG_UE_r16", -1);
      }

      // encode pdcch_BlindDetectionMCG_UE_Mixed_r16

      if (pdcch_BlindDetectionMCG_UE_Mixed_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_BlindDetectionMCG_UE_Mixed_r16", -1);

         pdcch_BlindDetectionMCG_UE_Mixed_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pdcch_BlindDetectionMCG_UE_Mixed_r16", -1);
      }

      // encode pdcch_BlindDetectionSCG_UE_Mixed_r16

      if (pdcch_BlindDetectionSCG_UE_Mixed_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("pdcch_BlindDetectionSCG_UE_Mixed_r16", -1);

         pdcch_BlindDetectionSCG_UE_Mixed_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("pdcch_BlindDetectionSCG_UE_Mixed_r16", -1);
      }

      // encode crossCarrierSchedulingDL_DiffSCS_r16

      if (crossCarrierSchedulingDL_DiffSCS_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("crossCarrierSchedulingDL_DiffSCS_r16", -1);

         crossCarrierSchedulingDL_DiffSCS_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("crossCarrierSchedulingDL_DiffSCS_r16", -1);
      }

      // encode crossCarrierSchedulingDefaultQCL_r16

      if (crossCarrierSchedulingDefaultQCL_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("crossCarrierSchedulingDefaultQCL_r16", -1);

         crossCarrierSchedulingDefaultQCL_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("crossCarrierSchedulingDefaultQCL_r16", -1);
      }

      // encode crossCarrierSchedulingUL_DiffSCS_r16

      if (crossCarrierSchedulingUL_DiffSCS_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("crossCarrierSchedulingUL_DiffSCS_r16", -1);

         crossCarrierSchedulingUL_DiffSCS_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("crossCarrierSchedulingUL_DiffSCS_r16", -1);
      }

      // encode simul_SRS_MIMO_Trans_BC_r16

      if (simul_SRS_MIMO_Trans_BC_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("simul_SRS_MIMO_Trans_BC_r16", -1);

         simul_SRS_MIMO_Trans_BC_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("simul_SRS_MIMO_Trans_BC_r16", -1);
      }

      // encode codebookParametersAdditionPerBC_r16

      if (codebookParametersAdditionPerBC_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("codebookParametersAdditionPerBC_r16", -1);

         codebookParametersAdditionPerBC_r16.encode (buffer);

         buffer.getContext().eventDispatcher.endElement("codebookParametersAdditionPerBC_r16", -1);
      }

      // encode codebookComboParametersAdditionPerBC_r16

      if (codebookComboParametersAdditionPerBC_r16 != null) {
         buffer.getContext().eventDispatcher.startElement("codebookComboParametersAdditionPerBC_r16", -1);

         codebookComboParametersAdditionPerBC_r16.encode (buffer);
