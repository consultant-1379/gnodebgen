...
public class FrequencyInfoDL_scs_SpecificCarrierList extends Asn1SeqOf {
   ...
   public FrequencyInfoDL_scs_SpecificCarrierList () {
      elements = null;
   }
    ...
    * populated.
    */
   public FrequencyInfoDL_scs_SpecificCarrierList (int numRecords) {
    ...
    * given the array.  
    */
   public FrequencyInfoDL_scs_SpecificCarrierList (SCS_SpecificCarrier[] elements_) {
      elements = elements_;
   }
