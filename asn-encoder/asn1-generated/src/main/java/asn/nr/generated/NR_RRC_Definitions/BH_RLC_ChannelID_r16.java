...
public class BH_RLC_ChannelID_r16 extends Asn1BitString {
    ...
    */
   public BH_RLC_ChannelID_r16 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public BH_RLC_ChannelID_r16 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public BH_RLC_ChannelID_r16 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public BH_RLC_ChannelID_r16 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public BH_RLC_ChannelID_r16 (java.util.BitSet bitSet) {
      super (bitSet);
   }
