...
public class SL_BWP_PoolConfigCommon_r16_sl_TxPoolSelectedNormal_r16 extends Asn1SeqOf {
   ...
   public SL_ResourcePoolConfig_r16[] elements;

   public SL_BWP_PoolConfigCommon_r16_sl_TxPoolSelectedNormal_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_BWP_PoolConfigCommon_r16_sl_TxPoolSelectedNormal_r16 (int numRecords) {
      elements = new SL_ResourcePoolConfig_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_BWP_PoolConfigCommon_r16_sl_TxPoolSelectedNormal_r16 (SL_ResourcePoolConfig_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_ResourcePoolConfig_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_ResourcePoolConfig_r16();
