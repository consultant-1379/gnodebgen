...
public class ConfiguredGrantConfigType2DeactivationStateList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ConfiguredGrantConfigType2DeactivationStateList-r16";
   }

   public ConfiguredGrantConfigType2DeactivationState_r16[] elements;

   public ConfiguredGrantConfigType2DeactivationStateList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ConfiguredGrantConfigType2DeactivationStateList_r16 (int numRecords) {
      elements = new ConfiguredGrantConfigType2DeactivationState_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public ConfiguredGrantConfigType2DeactivationStateList_r16 (ConfiguredGrantConfigType2DeactivationState_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ConfiguredGrantConfigType2DeactivationState_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ConfiguredGrantConfigType2DeactivationState_r16();
