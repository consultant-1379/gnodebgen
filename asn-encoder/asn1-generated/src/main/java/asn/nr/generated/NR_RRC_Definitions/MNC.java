...
public class MNC extends Asn1SeqOf {
    ...
    * given the array.  
    */
   public MNC (MCC_MNC_Digit[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.encodeLength (elements.length, 2, 3);
