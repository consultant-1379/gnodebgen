...
public class FeatureSetUplinkPerCC_v1540_mimo_NonCB_PUSCH extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (maxNumberSRS_ResourcePerSet != null) {
         ...
         maxNumberSRS_ResourcePerSet.encode (buffer, 1, 4);

         buffer.getContext().eventDispatcher.endElement("maxNumberSRS_ResourcePerSet", -1);
      }
      else throw new Asn1MissingRequiredException ("maxNumberSRS_ResourcePerSet");

      // encode maxNumberSimultaneousSRS_ResourceTx

      if (maxNumberSimultaneousSRS_ResourceTx != null) {
         buffer.getContext().eventDispatcher.startElement("maxNumberSimultaneousSRS_ResourceTx", -1);

         maxNumberSimultaneousSRS_ResourceTx.encode (buffer, 1, 4);

         buffer.getContext().eventDispatcher.endElement("maxNumberSimultaneousSRS_ResourceTx", -1);
      }
      else throw new Asn1MissingRequiredException ("maxNumberSimultaneousSRS_ResourceTx");
