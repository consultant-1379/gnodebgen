...
public class PLMN_IdentityList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PLMN-IdentityList-r16";
   }

   public PLMN_Identity[] elements;

   public PLMN_IdentityList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_IdentityList_r16 (int numRecords) {
      elements = new PLMN_Identity [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMN_IdentityList_r16 (PLMN_Identity[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PLMN_Identity [numElements];
