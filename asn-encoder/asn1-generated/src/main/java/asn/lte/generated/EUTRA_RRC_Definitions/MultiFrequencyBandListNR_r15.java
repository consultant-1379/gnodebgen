...
public class MultiFrequencyBandListNR_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MultiFrequencyBandListNR-r15";
   }

   public FreqBandIndicatorNR_r15[] elements;

   public MultiFrequencyBandListNR_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MultiFrequencyBandListNR_r15 (int numRecords) {
      elements = new FreqBandIndicatorNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public MultiFrequencyBandListNR_r15 (FreqBandIndicatorNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqBandIndicatorNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqBandIndicatorNR_r15();
