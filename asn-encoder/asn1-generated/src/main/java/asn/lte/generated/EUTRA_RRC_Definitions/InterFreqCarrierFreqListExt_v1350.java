...
public class InterFreqCarrierFreqListExt_v1350 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqListExt-v1350";
   }

   public InterFreqCarrierFreqInfo_v1350[] elements;

   public InterFreqCarrierFreqListExt_v1350 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqListExt_v1350 (int numRecords) {
      elements = new InterFreqCarrierFreqInfo_v1350 [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqListExt_v1350 (InterFreqCarrierFreqInfo_v1350[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqCarrierFreqInfo_v1350 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqCarrierFreqInfo_v1350();
