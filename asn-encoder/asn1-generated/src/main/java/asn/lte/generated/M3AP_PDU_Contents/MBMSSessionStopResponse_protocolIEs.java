...
public class MBMSSessionStopResponse_protocolIEs extends Asn1SeqOf {
   ...
   public MBMSSessionStopResponse_protocolIEs_element[] elements;

   public MBMSSessionStopResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMSSessionStopResponse_protocolIEs (int numRecords) {
      elements = new MBMSSessionStopResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMSSessionStopResponse_protocolIEs (MBMSSessionStopResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMSSessionStopResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMSSessionStopResponse_protocolIEs_element();
