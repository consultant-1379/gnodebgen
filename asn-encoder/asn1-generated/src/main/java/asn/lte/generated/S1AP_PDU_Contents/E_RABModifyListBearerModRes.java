...
public class E_RABModifyListBearerModRes extends Asn1SeqOf {
   ...
   public E_RABModifyListBearerModRes_element[] elements;

   public E_RABModifyListBearerModRes () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABModifyListBearerModRes (int numRecords) {
      elements = new E_RABModifyListBearerModRes_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABModifyListBearerModRes (E_RABModifyListBearerModRes_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABModifyListBearerModRes_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABModifyListBearerModRes_element();
