...
public class SgNBModificationRequest_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBModificationRequest_protocolIEs_element[] elements;

   public SgNBModificationRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBModificationRequest_protocolIEs (int numRecords) {
      elements = new SgNBModificationRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBModificationRequest_protocolIEs (SgNBModificationRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBModificationRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBModificationRequest_protocolIEs_element();
