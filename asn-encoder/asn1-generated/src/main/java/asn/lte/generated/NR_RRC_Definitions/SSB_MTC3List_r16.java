...
public class SSB_MTC3List_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SSB-MTC3List-r16";
   }

   public SSB_MTC3_r16[] elements;

   public SSB_MTC3List_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SSB_MTC3List_r16 (int numRecords) {
      elements = new SSB_MTC3_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SSB_MTC3List_r16 (SSB_MTC3_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SSB_MTC3_r16 [numElements];
