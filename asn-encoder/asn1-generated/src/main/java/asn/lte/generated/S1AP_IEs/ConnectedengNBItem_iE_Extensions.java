...
public class ConnectedengNBItem_iE_Extensions extends Asn1SeqOf {
   ...
   public ConnectedengNBItem_iE_Extensions_element[] elements;

   public ConnectedengNBItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ConnectedengNBItem_iE_Extensions (int numRecords) {
      elements = new ConnectedengNBItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ConnectedengNBItem_iE_Extensions (ConnectedengNBItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ConnectedengNBItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ConnectedengNBItem_iE_Extensions_element();
