...
import asn.lte.generated.EUTRA_RRC_Definitions.SL_CBR_Levels_Config_r14;

public class SL_CBR_PreconfigTxConfigList_r14_cbr_RangeCommonConfigList_r14 extends Asn1SeqOf {
   ...
   public SL_CBR_Levels_Config_r14[] elements;

   public SL_CBR_PreconfigTxConfigList_r14_cbr_RangeCommonConfigList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_CBR_PreconfigTxConfigList_r14_cbr_RangeCommonConfigList_r14 (int numRecords) {
      elements = new SL_CBR_Levels_Config_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_CBR_PreconfigTxConfigList_r14_cbr_RangeCommonConfigList_r14 (SL_CBR_Levels_Config_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_CBR_Levels_Config_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_CBR_Levels_Config_r14();
