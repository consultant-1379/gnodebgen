...
public class LogMeasInfoList_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "LogMeasInfoList-r10";
   }

   public LogMeasInfo_r10[] elements;

   public LogMeasInfoList_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public LogMeasInfoList_r10 (int numRecords) {
    ...
    * given the array.  
    */
   public LogMeasInfoList_r10 (LogMeasInfo_r10[] elements_) {
      elements = elements_;
   }
