...
public class LoggedMBSFNMDT_iE_Extensions extends Asn1SeqOf {
   ...
   public LoggedMBSFNMDT_iE_Extensions_element[] elements;

   public LoggedMBSFNMDT_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public LoggedMBSFNMDT_iE_Extensions (int numRecords) {
      elements = new LoggedMBSFNMDT_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public LoggedMBSFNMDT_iE_Extensions (LoggedMBSFNMDT_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LoggedMBSFNMDT_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LoggedMBSFNMDT_iE_Extensions_element();
