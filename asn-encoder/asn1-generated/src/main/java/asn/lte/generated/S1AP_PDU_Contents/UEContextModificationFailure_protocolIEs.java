...
public class UEContextModificationFailure_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextModificationFailure_protocolIEs_element[] elements;

   public UEContextModificationFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextModificationFailure_protocolIEs (int numRecords) {
      elements = new UEContextModificationFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextModificationFailure_protocolIEs (UEContextModificationFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextModificationFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextModificationFailure_protocolIEs_element();
