...
public class NS_PmaxList_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NS-PmaxList-r10";
   }

   public NS_PmaxValue_r10[] elements;

   public NS_PmaxList_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NS_PmaxList_r10 (int numRecords) {
      elements = new NS_PmaxValue_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public NS_PmaxList_r10 (NS_PmaxValue_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NS_PmaxValue_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NS_PmaxValue_r10();
