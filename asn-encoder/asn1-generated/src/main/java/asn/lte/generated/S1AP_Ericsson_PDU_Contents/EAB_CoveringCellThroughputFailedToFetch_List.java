...
public class EAB_CoveringCellThroughputFailedToFetch_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-CoveringCellThroughputFailedToFetch-List";
   }

   public EAB_CoveringCellThroughputFailedToFetch_Item[] elements;

   public EAB_CoveringCellThroughputFailedToFetch_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_CoveringCellThroughputFailedToFetch_List (int numRecords) {
      elements = new EAB_CoveringCellThroughputFailedToFetch_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_CoveringCellThroughputFailedToFetch_List (EAB_CoveringCellThroughputFailedToFetch_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_CoveringCellThroughputFailedToFetch_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_CoveringCellThroughputFailedToFetch_Item();
