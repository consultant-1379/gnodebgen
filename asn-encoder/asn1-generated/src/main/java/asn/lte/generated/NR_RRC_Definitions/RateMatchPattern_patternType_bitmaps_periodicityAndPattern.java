...
public class RateMatchPattern_patternType_bitmaps_periodicityAndPattern extends Asn1Choice {
   ...
   public RateMatchPattern_patternType_bitmaps_periodicityAndPattern () {
      super();
   }

   public RateMatchPattern_patternType_bitmaps_periodicityAndPattern (byte choiceId_, Asn1Type element_) {
      super();
