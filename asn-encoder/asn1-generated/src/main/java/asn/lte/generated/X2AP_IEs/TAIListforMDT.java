...
public class TAIListforMDT extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "TAIListforMDT";
   }

   public TAI_Item[] elements;

   public TAIListforMDT () {
      elements = null;
   }
    ...
    * populated.
    */
   public TAIListforMDT (int numRecords) {
    ...
    * given the array.  
    */
   public TAIListforMDT (TAI_Item[] elements_) {
      elements = elements_;
   }
