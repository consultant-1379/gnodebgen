...
public class E_RABLevelQoSParameters_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: Packet-LossRate
    * Java type: Packet_LossRate
    *
   ...
   public E_RABLevelQoSParameters_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABLevelQoSParameters_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-DownlinkPacketLossRate
    */
   public void setUsing_id_DownlinkPacketLossRate(Packet_LossRate extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_DownlinkPacketLossRate);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-UplinkPacketLossRate
    */
   public void setUsing_id_UplinkPacketLossRate(Packet_LossRate extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_UplinkPacketLossRate);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-DownlinkPacketLossRate
    */
   public Packet_LossRate getExtensionValueFor_id_DownlinkPacketLossRate() {
      return (Packet_LossRate) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-UplinkPacketLossRate
    */
   public Packet_LossRate getExtensionValueFor_id_UplinkPacketLossRate() {
      return (Packet_LossRate) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.E_RABQoSParameters_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.E_RABQoSParameters_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.E_RABQoSParameters_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 273) {
         indent (_sb, _level+1);
         _sb.append("id = id-DownlinkPacketLossRate\n");
      }
      else if (id.value == 274) {
         indent (_sb, _level+1);
         _sb.append("id = id-UplinkPacketLossRate\n");
      }
