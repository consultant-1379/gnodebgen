...
public class BandInfo_iE_Extensions extends Asn1SeqOf {
   ...
   public BandInfo_iE_Extensions_element[] elements;

   public BandInfo_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandInfo_iE_Extensions (int numRecords) {
      elements = new BandInfo_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public BandInfo_iE_Extensions (BandInfo_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandInfo_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandInfo_iE_Extensions_element();
