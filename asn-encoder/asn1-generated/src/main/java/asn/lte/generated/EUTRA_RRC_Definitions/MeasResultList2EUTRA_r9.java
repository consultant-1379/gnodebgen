...
public class MeasResultList2EUTRA_r9 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultList2EUTRA-r9";
   }

   public MeasResult2EUTRA_r9[] elements;

   public MeasResultList2EUTRA_r9 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultList2EUTRA_r9 (int numRecords) {
      elements = new MeasResult2EUTRA_r9 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultList2EUTRA_r9 (MeasResult2EUTRA_r9[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResult2EUTRA_r9 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResult2EUTRA_r9();
