...
public class MinimumTimeToMBMSDataTransfer extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "MinimumTimeToMBMSDataTransfer";
   }

   public MinimumTimeToMBMSDataTransfer () {
      super();
   }
    ...
    *              in binary form.
    */
   public MinimumTimeToMBMSDataTransfer (byte[] data) {
      super (data);
   }
    ...
    */
   public MinimumTimeToMBMSDataTransfer (byte[] data, int offset, int nbytes) {
    ...
    */
   public MinimumTimeToMBMSDataTransfer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
