...
public class E_RABReleaseListBearerRelComp_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABReleaseItemBearerRelComp
    * Java type: E_RABReleaseItemBearerRelComp
    */
   public Asn1Type value;

   public E_RABReleaseListBearerRelComp_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABReleaseListBearerRelComp_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABReleaseItemBearerRelComp
    */
   public void setUsing_id_E_RABReleaseItemBearerRelComp(E_RABReleaseItemBearerRelComp value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABReleaseItemBearerRelComp);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABReleaseItemBearerRelComp
    */
   public E_RABReleaseItemBearerRelComp getValueFor_id_E_RABReleaseItemBearerRelComp() {
      return (E_RABReleaseItemBearerRelComp) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABReleaseItemBearerRelCompIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABReleaseItemBearerRelCompIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABReleaseItemBearerRelCompIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 15) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABReleaseItemBearerRelComp\n");
      }
