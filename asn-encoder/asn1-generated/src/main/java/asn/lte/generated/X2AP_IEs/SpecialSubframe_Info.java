...
public class SpecialSubframe_Info extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SpecialSubframe-Info";
   }

   public SpecialSubframePatterns specialSubframePatterns = null;
   public CyclicPrefixDL cyclicPrefixDL = null;
   public CyclicPrefixUL cyclicPrefixUL = null;
   public SpecialSubframe_Info_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public SpecialSubframe_Info () {
      super();
      init();
   }
   ...
   public SpecialSubframe_Info (
      ...
      SpecialSubframe_Info_iE_Extensions iE_Extensions_
   ) {
      super();
      specialSubframePatterns = specialSubframePatterns_;
      cyclicPrefixDL = cyclicPrefixDL_;
   ...
   public Object getElementValue(int index){
      switch(index)  {
         case 0: return specialSubframePatterns;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      {
         int tval = SpecialSubframePatterns.decodeEnumValue (buffer);
         specialSubframePatterns = SpecialSubframePatterns.valueOf (tval);
      }
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new SpecialSubframe_Info_iE_Extensions();
