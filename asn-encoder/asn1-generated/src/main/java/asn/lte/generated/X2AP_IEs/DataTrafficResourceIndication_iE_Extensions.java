...
public class DataTrafficResourceIndication_iE_Extensions extends Asn1SeqOf {
   ...
   public DataTrafficResourceIndication_iE_Extensions_element[] elements;

   public DataTrafficResourceIndication_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public DataTrafficResourceIndication_iE_Extensions (int numRecords) {
      elements = new DataTrafficResourceIndication_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public DataTrafficResourceIndication_iE_Extensions (DataTrafficResourceIndication_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DataTrafficResourceIndication_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DataTrafficResourceIndication_iE_Extensions_element();
