...
public class CSI_AperiodicTriggerState_associatedReportConfigInfoList extends Asn1SeqOf {
   ...
   public CSI_AssociatedReportConfigInfo[] elements;

   public CSI_AperiodicTriggerState_associatedReportConfigInfoList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_AperiodicTriggerState_associatedReportConfigInfoList (int numRecords) {
      elements = new CSI_AssociatedReportConfigInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_AperiodicTriggerState_associatedReportConfigInfoList (CSI_AssociatedReportConfigInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_AssociatedReportConfigInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_AssociatedReportConfigInfo();
