...
public class E_RABReleaseIndication_protocolIEs_element extends Asn1Seq {
   ...
   public E_RABReleaseIndication_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABReleaseIndication_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABReleasedList
    */
   public void setUsing_id_E_RABReleasedList(asn.lte.generated.S1AP_IEs.E_RABList value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABReleasedList);
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABReleasedList
    */
   public asn.lte.generated.S1AP_IEs.E_RABList getValueFor_id_E_RABReleasedList() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABReleaseIndicationIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABReleaseIndicationIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABReleaseIndicationIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABReleasedList\n");
      }
