...
public class TMGI_iE_Extensions extends Asn1SeqOf {
   ...
   public TMGI_iE_Extensions_element[] elements;

   public TMGI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TMGI_iE_Extensions (int numRecords) {
      elements = new TMGI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TMGI_iE_Extensions (TMGI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TMGI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TMGI_iE_Extensions_element();
