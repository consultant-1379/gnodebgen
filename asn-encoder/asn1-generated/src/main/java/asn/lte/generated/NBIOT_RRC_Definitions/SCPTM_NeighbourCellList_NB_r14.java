...
public class SCPTM_NeighbourCellList_NB_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCPTM-NeighbourCellList-NB-r14";
   }

   public PCI_ARFCN_NB_r14[] elements;

   public SCPTM_NeighbourCellList_NB_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCPTM_NeighbourCellList_NB_r14 (int numRecords) {
      elements = new PCI_ARFCN_NB_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCPTM_NeighbourCellList_NB_r14 (PCI_ARFCN_NB_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PCI_ARFCN_NB_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PCI_ARFCN_NB_r14();
