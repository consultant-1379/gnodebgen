...
public class MMEConfigurationTransfer_protocolIEs extends Asn1SeqOf {
   ...
   public MMEConfigurationTransfer_protocolIEs_element[] elements;

   public MMEConfigurationTransfer_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MMEConfigurationTransfer_protocolIEs (int numRecords) {
      elements = new MMEConfigurationTransfer_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MMEConfigurationTransfer_protocolIEs (MMEConfigurationTransfer_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MMEConfigurationTransfer_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MMEConfigurationTransfer_protocolIEs_element();
