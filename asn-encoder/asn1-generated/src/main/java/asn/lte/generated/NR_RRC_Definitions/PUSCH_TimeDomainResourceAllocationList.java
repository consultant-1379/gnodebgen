...
public class PUSCH_TimeDomainResourceAllocationList extends Asn1SeqOf {
   ...
   public PUSCH_TimeDomainResourceAllocation[] elements;

   public PUSCH_TimeDomainResourceAllocationList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUSCH_TimeDomainResourceAllocationList (int numRecords) {
      elements = new PUSCH_TimeDomainResourceAllocation [numRecords];
   }
    ...
    * given the array.  
    */
   public PUSCH_TimeDomainResourceAllocationList (PUSCH_TimeDomainResourceAllocation[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUSCH_TimeDomainResourceAllocation [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUSCH_TimeDomainResourceAllocation();
