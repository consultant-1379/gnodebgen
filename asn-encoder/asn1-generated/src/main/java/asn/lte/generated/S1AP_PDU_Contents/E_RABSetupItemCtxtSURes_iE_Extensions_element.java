...
public class E_RABSetupItemCtxtSURes_iE_Extensions_element extends Asn1Seq {
   ...
   public E_RABSetupItemCtxtSURes_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABSetupItemCtxtSURes_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABSetupItemCtxtSUResExtIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABSetupItemCtxtSUResExtIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABSetupItemCtxtSUResExtIEs[i];
            break;
         }
      }
      if (null == _index) {
