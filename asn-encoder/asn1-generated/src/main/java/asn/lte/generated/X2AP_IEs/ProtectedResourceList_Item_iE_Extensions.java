...
public class ProtectedResourceList_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public ProtectedResourceList_Item_iE_Extensions_element[] elements;

   public ProtectedResourceList_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ProtectedResourceList_Item_iE_Extensions (int numRecords) {
      elements = new ProtectedResourceList_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ProtectedResourceList_Item_iE_Extensions (ProtectedResourceList_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ProtectedResourceList_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ProtectedResourceList_Item_iE_Extensions_element();
