...
public class M3SetupResponse_protocolIEs extends Asn1SeqOf {
   ...
   public M3SetupResponse_protocolIEs_element[] elements;

   public M3SetupResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public M3SetupResponse_protocolIEs (int numRecords) {
      elements = new M3SetupResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public M3SetupResponse_protocolIEs (M3SetupResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new M3SetupResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new M3SetupResponse_protocolIEs_element();
