...
public class CellToReport_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellToReport-List";
   }

   public CellToReport_List_element[] elements;

   public CellToReport_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellToReport_List (int numRecords) {
      elements = new CellToReport_List_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellToReport_List (CellToReport_List_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellToReport_List_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellToReport_List_element();
