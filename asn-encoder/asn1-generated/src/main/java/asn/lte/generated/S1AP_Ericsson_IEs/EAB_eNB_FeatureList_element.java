...
public class EAB_eNB_FeatureList_element extends Asn1Seq {
    ...
    */
   public void setUsing_fid_eNB_UeThroughputBasedMobiltyToWifi() {
      this.fid = new asn.lte.generated.S1AP_Ericsson_CommonDataTypes.EAB_Feature_ID(asn.lte.generated.S1AP_Ericsson_Constants._S1AP_Ericsson_ConstantsValues.fid_eNB_UeThroughputBasedMobiltyToWifi);
      this.criticality = asn.lte.generated.S1AP_Ericsson_CommonDataTypes.EAB_CriticalityIgnore.ignore();
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_Ericsson_IEsValues.EAB_eNB_FeatureAndProperty_List.length; i++) {
         if(_S1AP_Ericsson_IEsValues.EAB_eNB_FeatureAndProperty_List[i].fid.equals(fid)) {
            _index = _S1AP_Ericsson_IEsValues.EAB_eNB_FeatureAndProperty_List[i];
            break;
         }
      }
      if (null == _index) {
