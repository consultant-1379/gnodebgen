...
public class MeasResultSSB_IndexList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultSSB-IndexList-r15";
   }

   public MeasResultSSB_Index_r15[] elements;

   public MeasResultSSB_IndexList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultSSB_IndexList_r15 (int numRecords) {
      elements = new MeasResultSSB_Index_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultSSB_IndexList_r15 (MeasResultSSB_Index_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultSSB_Index_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultSSB_Index_r15();
