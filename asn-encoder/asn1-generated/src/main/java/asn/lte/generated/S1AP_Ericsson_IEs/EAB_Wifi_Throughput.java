...
public class EAB_Wifi_Throughput extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "EAB-Wifi-Throughput";
   }

   public EAB_Wifi_Throughput () {
      super();
   }
    ...
    *              in binary form.
    */
   public EAB_Wifi_Throughput (byte[] data) {
      super (data);
   }
    ...
    */
   public EAB_Wifi_Throughput (byte[] data, int offset, int nbytes) {
    ...
    */
   public EAB_Wifi_Throughput (String value_) throws Asn1ValueParseException {
      super (value_);
   }
