...
public class ULInformationTransferMRDC extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "ULInformationTransferMRDC";
   }

   public ULInformationTransferMRDC_criticalExtensions criticalExtensions;

   public ULInformationTransferMRDC () {
      super();
      init();
   }
    ...
    */
   public ULInformationTransferMRDC (
      ULInformationTransferMRDC_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new ULInformationTransferMRDC_criticalExtensions();
