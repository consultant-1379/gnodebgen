...
public class BandCombinationParameters_r13_bandParameterList_r13 extends Asn1SeqOf {
   ...
   public BandParameters_r13[] elements;

   public BandCombinationParameters_r13_bandParameterList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_r13_bandParameterList_r13 (int numRecords) {
      elements = new BandParameters_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_r13_bandParameterList_r13 (BandParameters_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_r13();
