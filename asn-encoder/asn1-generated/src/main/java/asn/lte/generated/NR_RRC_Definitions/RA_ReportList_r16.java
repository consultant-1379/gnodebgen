...
public class RA_ReportList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RA-ReportList-r16";
   }

   public RA_Report_r16[] elements;

   public RA_ReportList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RA_ReportList_r16 (int numRecords) {
      elements = new RA_Report_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public RA_ReportList_r16 (RA_Report_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RA_Report_r16 [numElements];
