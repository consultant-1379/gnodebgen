...
public class MeasObjectToRemoveListExt_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasObjectToRemoveListExt-r13";
   }

   public MeasObjectId_v1310[] elements;

   public MeasObjectToRemoveListExt_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasObjectToRemoveListExt_r13 (int numRecords) {
      elements = new MeasObjectId_v1310 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasObjectToRemoveListExt_r13 (MeasObjectId_v1310[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasObjectId_v1310 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasObjectId_v1310();
