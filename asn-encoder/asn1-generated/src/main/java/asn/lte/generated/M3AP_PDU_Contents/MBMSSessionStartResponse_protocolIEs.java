...
public class MBMSSessionStartResponse_protocolIEs extends Asn1SeqOf {
   ...
   public MBMSSessionStartResponse_protocolIEs_element[] elements;

   public MBMSSessionStartResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMSSessionStartResponse_protocolIEs (int numRecords) {
      elements = new MBMSSessionStartResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMSSessionStartResponse_protocolIEs (MBMSSessionStartResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMSSessionStartResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMSSessionStartResponse_protocolIEs_element();
