...
import asn.lte.generated.NR_RRC_Definitions.RSSI_ResourceId_r16;

public class CLI_RSSI_TriggeredList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CLI-RSSI-TriggeredList-r16";
   }

   public RSSI_ResourceId_r16[] elements;

   public CLI_RSSI_TriggeredList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CLI_RSSI_TriggeredList_r16 (int numRecords) {
      elements = new RSSI_ResourceId_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public CLI_RSSI_TriggeredList_r16 (RSSI_ResourceId_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RSSI_ResourceId_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RSSI_ResourceId_r16();
