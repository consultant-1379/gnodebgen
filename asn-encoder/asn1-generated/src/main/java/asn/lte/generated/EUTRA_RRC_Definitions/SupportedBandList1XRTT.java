...
public class SupportedBandList1XRTT extends Asn1SeqOf {
   ...
   public BandclassCDMA2000[] elements;

   public SupportedBandList1XRTT () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandList1XRTT (int numRecords) {
      elements = new BandclassCDMA2000 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandList1XRTT (BandclassCDMA2000[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandclassCDMA2000 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
...

         {
            ...
            elements[i] = BandclassCDMA2000.valueOf (tval);
         }
