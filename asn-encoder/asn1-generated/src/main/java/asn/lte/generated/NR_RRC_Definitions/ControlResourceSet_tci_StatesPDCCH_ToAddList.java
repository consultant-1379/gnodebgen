...
public class ControlResourceSet_tci_StatesPDCCH_ToAddList extends Asn1SeqOf {
   ...
   public ControlResourceSet_tci_StatesPDCCH_ToAddList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ControlResourceSet_tci_StatesPDCCH_ToAddList (int numRecords) {
    ...
    * given the array.  
    */
   public ControlResourceSet_tci_StatesPDCCH_ToAddList (TCI_StateId[] elements_) {
      elements = elements_;
   }
