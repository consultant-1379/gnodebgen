...
public class MeasurementFailureCause_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasurementFailureCause-List";
   }

   public MeasurementFailureCause_List_element[] elements;

   public MeasurementFailureCause_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasurementFailureCause_List (int numRecords) {
      elements = new MeasurementFailureCause_List_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasurementFailureCause_List (MeasurementFailureCause_List_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasurementFailureCause_List_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasurementFailureCause_List_element();
