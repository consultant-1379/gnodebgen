...
public class EAB_ENDCX2SetupResponse_ExtConveyor_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: eid-EAB-InitiatingNodeType-EndcX2SetupResponse
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: EAB-InitiatingNodeType-EndcX2SetupResponse
    * Java type: EAB_InitiatingNodeType_EndcX2SetupResponse
    */
   public Asn1Type value;

   public EAB_ENDCX2SetupResponse_ExtConveyor_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_ENDCX2SetupResponse_ExtConveyor_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-EAB-InitiatingNodeType-EndcX2SetupResponse
    */
   public void setUsing_eid_EAB_InitiatingNodeType_EndcX2SetupResponse(EAB_InitiatingNodeType_EndcX2SetupResponse value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_EAB_InitiatingNodeType_EndcX2SetupResponse);
   ...
   /**
    * Get value of value with type set according to information object having key eid-EAB-InitiatingNodeType-EndcX2SetupResponse
    */
   public EAB_InitiatingNodeType_EndcX2SetupResponse getValueFor_eid_EAB_InitiatingNodeType_EndcX2SetupResponse() {
      return (EAB_InitiatingNodeType_EndcX2SetupResponse) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_ENDCX2SetupResponse_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_ENDCX2SetupResponse_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_ENDCX2SetupResponse_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 4191) {
         indent (_sb, _level+1);
         _sb.append("id = eid-EAB-InitiatingNodeType-EndcX2SetupResponse\n");
      }
