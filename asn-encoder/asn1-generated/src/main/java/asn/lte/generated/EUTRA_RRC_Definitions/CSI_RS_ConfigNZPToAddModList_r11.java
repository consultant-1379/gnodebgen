...
public class CSI_RS_ConfigNZPToAddModList_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSI-RS-ConfigNZPToAddModList-r11";
   }

   public CSI_RS_ConfigNZP_r11[] elements;

   public CSI_RS_ConfigNZPToAddModList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_ConfigNZPToAddModList_r11 (int numRecords) {
    ...
    * given the array.  
    */
   public CSI_RS_ConfigNZPToAddModList_r11 (CSI_RS_ConfigNZP_r11[] elements_) {
      elements = elements_;
   }
