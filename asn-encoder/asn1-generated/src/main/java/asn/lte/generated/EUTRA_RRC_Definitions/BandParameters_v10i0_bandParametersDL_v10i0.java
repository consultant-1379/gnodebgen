...
public class BandParameters_v10i0_bandParametersDL_v10i0 extends Asn1SeqOf {
   ...
   public CA_MIMO_ParametersDL_v10i0[] elements;

   public BandParameters_v10i0_bandParametersDL_v10i0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandParameters_v10i0_bandParametersDL_v10i0 (int numRecords) {
      elements = new CA_MIMO_ParametersDL_v10i0 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandParameters_v10i0_bandParametersDL_v10i0 (CA_MIMO_ParametersDL_v10i0[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CA_MIMO_ParametersDL_v10i0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CA_MIMO_ParametersDL_v10i0();
