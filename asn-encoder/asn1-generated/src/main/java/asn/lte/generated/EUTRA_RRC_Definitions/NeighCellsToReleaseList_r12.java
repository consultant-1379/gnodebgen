...
public class NeighCellsToReleaseList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NeighCellsToReleaseList-r12";
   }

   public PhysCellId[] elements;

   public NeighCellsToReleaseList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NeighCellsToReleaseList_r12 (int numRecords) {
    ...
    * given the array.  
    */
   public NeighCellsToReleaseList_r12 (PhysCellId[] elements_) {
      elements = elements_;
   }
