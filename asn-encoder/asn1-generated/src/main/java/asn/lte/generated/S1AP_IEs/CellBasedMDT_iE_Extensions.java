...
public class CellBasedMDT_iE_Extensions extends Asn1SeqOf {
   ...
   public CellBasedMDT_iE_Extensions_element[] elements;

   public CellBasedMDT_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellBasedMDT_iE_Extensions (int numRecords) {
      elements = new CellBasedMDT_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellBasedMDT_iE_Extensions (CellBasedMDT_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellBasedMDT_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellBasedMDT_iE_Extensions_element();
