...
public class WarningSecurityInfo extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public WarningSecurityInfo (byte[] data) {
      super (data);
   }
    ...
    */
   public WarningSecurityInfo (byte[] data, int offset, int nbytes) {
    ...
    */
   public WarningSecurityInfo (String value_) throws Asn1ValueParseException {
      super (value_);
   }
