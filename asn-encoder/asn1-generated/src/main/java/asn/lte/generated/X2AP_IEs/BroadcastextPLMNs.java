...
public class BroadcastextPLMNs extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BroadcastextPLMNs";
   }

   public PLMN_Identity[] elements;

   public BroadcastextPLMNs () {
      elements = null;
   }
    ...
    * populated.
    */
   public BroadcastextPLMNs (int numRecords) {
    ...
    * given the array.  
    */
   public BroadcastextPLMNs (PLMN_Identity[] elements_) {
      elements = elements_;
   }
