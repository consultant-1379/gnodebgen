...
public class MeasurementsToActivate extends Asn1BitString {
    ...
    */
   public MeasurementsToActivate (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public MeasurementsToActivate (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public MeasurementsToActivate (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public MeasurementsToActivate (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public MeasurementsToActivate (java.util.BitSet bitSet) {
      super (bitSet);
   }
