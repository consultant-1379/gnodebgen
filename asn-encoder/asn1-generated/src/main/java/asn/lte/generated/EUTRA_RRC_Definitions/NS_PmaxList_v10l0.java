...
public class NS_PmaxList_v10l0 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NS-PmaxList-v10l0";
   }

   public NS_PmaxValue_v10l0[] elements;

   public NS_PmaxList_v10l0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NS_PmaxList_v10l0 (int numRecords) {
      elements = new NS_PmaxValue_v10l0 [numRecords];
   }
    ...
    * given the array.  
    */
   public NS_PmaxList_v10l0 (NS_PmaxValue_v10l0[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NS_PmaxValue_v10l0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NS_PmaxValue_v10l0();
