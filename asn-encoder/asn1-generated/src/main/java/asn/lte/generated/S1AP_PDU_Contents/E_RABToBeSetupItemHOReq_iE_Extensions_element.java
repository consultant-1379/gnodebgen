...
public class E_RABToBeSetupItemHOReq_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: Data-Forwarding-Not-Possible
    * Java type: Data_Forwarding_Not_Possible
    *
    * id: id-BearerType
   ...
   public E_RABToBeSetupItemHOReq_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABToBeSetupItemHOReq_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-Data-Forwarding-Not-Possible
    */
   public void setUsing_id_Data_Forwarding_Not_Possible(asn.lte.generated.S1AP_IEs.Data_Forwarding_Not_Possible extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_Data_Forwarding_Not_Possible);
   ...
   /**
    * Get value of extensionValue with type set according to information object having key id-Data-Forwarding-Not-Possible
    */
   public asn.lte.generated.S1AP_IEs.Data_Forwarding_Not_Possible getExtensionValueFor_id_Data_Forwarding_Not_Possible() {
      return (asn.lte.generated.S1AP_IEs.Data_Forwarding_Not_Possible) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABToBeSetupItemHOReq_ExtIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABToBeSetupItemHOReq_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABToBeSetupItemHOReq_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 143) {
         indent (_sb, _level+1);
         _sb.append("id = id-Data-Forwarding-Not-Possible\n");
      }
