...
public class ACDC_BarringPerPLMN_List_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ACDC-BarringPerPLMN-List-r13";
   }

   public ACDC_BarringPerPLMN_r13[] elements;

   public ACDC_BarringPerPLMN_List_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ACDC_BarringPerPLMN_List_r13 (int numRecords) {
      elements = new ACDC_BarringPerPLMN_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public ACDC_BarringPerPLMN_List_r13 (ACDC_BarringPerPLMN_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ACDC_BarringPerPLMN_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ACDC_BarringPerPLMN_r13();
