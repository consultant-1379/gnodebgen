...
public class E_RABModifyListBearerModConf extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABModifyListBearerModConf";
   }

   public E_RABModifyListBearerModConf_element[] elements;

   public E_RABModifyListBearerModConf () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABModifyListBearerModConf (int numRecords) {
      elements = new E_RABModifyListBearerModConf_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABModifyListBearerModConf (E_RABModifyListBearerModConf_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABModifyListBearerModConf_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABModifyListBearerModConf_element();
