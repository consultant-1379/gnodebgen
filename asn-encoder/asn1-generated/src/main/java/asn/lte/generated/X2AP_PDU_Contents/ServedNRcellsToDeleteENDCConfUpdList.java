...
public class ServedNRcellsToDeleteENDCConfUpdList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServedNRcellsToDeleteENDCConfUpdList";
   }

   public NRCGI[] elements;

   public ServedNRcellsToDeleteENDCConfUpdList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedNRcellsToDeleteENDCConfUpdList (int numRecords) {
      elements = new NRCGI [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedNRcellsToDeleteENDCConfUpdList (NRCGI[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NRCGI [numElements];
