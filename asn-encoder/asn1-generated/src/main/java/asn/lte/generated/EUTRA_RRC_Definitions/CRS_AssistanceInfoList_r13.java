...
public class CRS_AssistanceInfoList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CRS-AssistanceInfoList-r13";
   }

   public CRS_AssistanceInfo_r13[] elements;

   public CRS_AssistanceInfoList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CRS_AssistanceInfoList_r13 (int numRecords) {
      elements = new CRS_AssistanceInfo_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public CRS_AssistanceInfoList_r13 (CRS_AssistanceInfo_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CRS_AssistanceInfo_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CRS_AssistanceInfo_r13();
