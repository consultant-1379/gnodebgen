...
public class CoMPHypothesisSetItem_iE_Extensions extends Asn1SeqOf {
   ...
   public CoMPHypothesisSetItem_iE_Extensions_element[] elements;

   public CoMPHypothesisSetItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CoMPHypothesisSetItem_iE_Extensions (int numRecords) {
      elements = new CoMPHypothesisSetItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CoMPHypothesisSetItem_iE_Extensions (CoMPHypothesisSetItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CoMPHypothesisSetItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CoMPHypothesisSetItem_iE_Extensions_element();
