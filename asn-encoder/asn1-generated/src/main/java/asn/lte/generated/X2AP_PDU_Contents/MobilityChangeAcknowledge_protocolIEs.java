...
public class MobilityChangeAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public MobilityChangeAcknowledge_protocolIEs_element[] elements;

   public MobilityChangeAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MobilityChangeAcknowledge_protocolIEs (int numRecords) {
      elements = new MobilityChangeAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MobilityChangeAcknowledge_protocolIEs (MobilityChangeAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MobilityChangeAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MobilityChangeAcknowledge_protocolIEs_element();
