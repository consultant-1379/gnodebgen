...
public class ServedNRCellsToAdd extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServedNRCellsToAdd";
   }

   public ServedNRCellsToAdd_Item[] elements;

   public ServedNRCellsToAdd () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedNRCellsToAdd (int numRecords) {
      elements = new ServedNRCellsToAdd_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedNRCellsToAdd (ServedNRCellsToAdd_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedNRCellsToAdd_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedNRCellsToAdd_Item();
