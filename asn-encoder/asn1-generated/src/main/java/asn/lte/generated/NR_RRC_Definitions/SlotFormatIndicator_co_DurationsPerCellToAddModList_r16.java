...
public class SlotFormatIndicator_co_DurationsPerCellToAddModList_r16 extends Asn1SeqOf {
   ...
   public CO_DurationsPerCell_r16[] elements;

   public SlotFormatIndicator_co_DurationsPerCellToAddModList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SlotFormatIndicator_co_DurationsPerCellToAddModList_r16 (int numRecords) {
      elements = new CO_DurationsPerCell_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SlotFormatIndicator_co_DurationsPerCellToAddModList_r16 (CO_DurationsPerCell_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CO_DurationsPerCell_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CO_DurationsPerCell_r16();
