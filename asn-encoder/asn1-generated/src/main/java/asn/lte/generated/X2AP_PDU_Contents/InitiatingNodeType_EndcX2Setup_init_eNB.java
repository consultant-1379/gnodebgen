...
public class InitiatingNodeType_EndcX2Setup_init_eNB extends Asn1SeqOf {
   ...
   public InitiatingNodeType_EndcX2Setup_init_eNB_element[] elements;

   public InitiatingNodeType_EndcX2Setup_init_eNB () {
      elements = null;
   }
    ...
    * populated.
    */
   public InitiatingNodeType_EndcX2Setup_init_eNB (int numRecords) {
      elements = new InitiatingNodeType_EndcX2Setup_init_eNB_element [numRecords];
   }
    ...
    * given the array.  
    */
   public InitiatingNodeType_EndcX2Setup_init_eNB (InitiatingNodeType_EndcX2Setup_init_eNB_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InitiatingNodeType_EndcX2Setup_init_eNB_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InitiatingNodeType_EndcX2Setup_init_eNB_element();
