...
public class MobilityChangeFailure_protocolIEs extends Asn1SeqOf {
   ...
   public MobilityChangeFailure_protocolIEs_element[] elements;

   public MobilityChangeFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MobilityChangeFailure_protocolIEs (int numRecords) {
      elements = new MobilityChangeFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MobilityChangeFailure_protocolIEs (MobilityChangeFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MobilityChangeFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MobilityChangeFailure_protocolIEs_element();
