...
public class CSI_IM_ConfigToAddModListExt_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSI-IM-ConfigToAddModListExt-r13";
   }

   public CSI_IM_ConfigExt_r12[] elements;

   public CSI_IM_ConfigToAddModListExt_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_IM_ConfigToAddModListExt_r13 (int numRecords) {
      elements = new CSI_IM_ConfigExt_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_IM_ConfigToAddModListExt_r13 (CSI_IM_ConfigExt_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_IM_ConfigExt_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_IM_ConfigExt_r12();
