...
public class E_RABToBeSetupListHOReq_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABToBeSetupItemHOReq
    * Java type: E_RABToBeSetupItemHOReq
    */
   public Asn1Type value;

   public E_RABToBeSetupListHOReq_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABToBeSetupListHOReq_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABToBeSetupItemHOReq
    */
   public void setUsing_id_E_RABToBeSetupItemHOReq(E_RABToBeSetupItemHOReq value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABToBeSetupItemHOReq);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABToBeSetupItemHOReq
    */
   public E_RABToBeSetupItemHOReq getValueFor_id_E_RABToBeSetupItemHOReq() {
      return (E_RABToBeSetupItemHOReq) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABToBeSetupItemHOReqIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABToBeSetupItemHOReqIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABToBeSetupItemHOReqIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 27) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABToBeSetupItemHOReq\n");
      }
