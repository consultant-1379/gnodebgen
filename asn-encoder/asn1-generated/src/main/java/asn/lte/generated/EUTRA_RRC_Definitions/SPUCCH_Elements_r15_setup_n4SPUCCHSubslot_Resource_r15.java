...
public class SPUCCH_Elements_r15_setup_n4SPUCCHSubslot_Resource_r15 extends Asn1SeqOf {
   ...
   public N4SPUCCH_Resource_r15[] elements;

   public SPUCCH_Elements_r15_setup_n4SPUCCHSubslot_Resource_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPUCCH_Elements_r15_setup_n4SPUCCHSubslot_Resource_r15 (int numRecords) {
      elements = new N4SPUCCH_Resource_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public SPUCCH_Elements_r15_setup_n4SPUCCHSubslot_Resource_r15 (N4SPUCCH_Resource_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new N4SPUCCH_Resource_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new N4SPUCCH_Resource_r15();
