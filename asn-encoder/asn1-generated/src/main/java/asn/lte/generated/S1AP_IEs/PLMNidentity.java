...
public class PLMNidentity extends TBCD_STRING {
    ...
    */
   public PLMNidentity (byte[] data, int offset, int nbytes) {
    ...
    */
   public PLMNidentity (String value_) throws Asn1ValueParseException {
      super (value_);
   }
