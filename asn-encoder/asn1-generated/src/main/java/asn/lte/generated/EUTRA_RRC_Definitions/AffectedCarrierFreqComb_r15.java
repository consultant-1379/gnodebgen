...
public class AffectedCarrierFreqComb_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AffectedCarrierFreqComb-r15";
   }

   public MeasObjectId_r13[] elements;

   public AffectedCarrierFreqComb_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AffectedCarrierFreqComb_r15 (int numRecords) {
    ...
    * given the array.  
    */
   public AffectedCarrierFreqComb_r15 (MeasObjectId_r13[] elements_) {
      elements = elements_;
   }
