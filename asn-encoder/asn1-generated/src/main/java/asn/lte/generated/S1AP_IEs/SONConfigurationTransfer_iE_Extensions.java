...
public class SONConfigurationTransfer_iE_Extensions extends Asn1SeqOf {
   ...
   public SONConfigurationTransfer_iE_Extensions_element[] elements;

   public SONConfigurationTransfer_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SONConfigurationTransfer_iE_Extensions (int numRecords) {
      elements = new SONConfigurationTransfer_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SONConfigurationTransfer_iE_Extensions (SONConfigurationTransfer_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SONConfigurationTransfer_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SONConfigurationTransfer_iE_Extensions_element();
