...
public class MSClassmark2 extends Asn1OctetString {
    ...
    */
   public MSClassmark2 (byte[] data, int offset, int nbytes) {
    ...
    */
   public MSClassmark2 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
