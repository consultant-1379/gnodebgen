...
public class RLFReportInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public RLFReportInformation_iE_Extensions_element[] elements;

   public RLFReportInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RLFReportInformation_iE_Extensions (int numRecords) {
      elements = new RLFReportInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RLFReportInformation_iE_Extensions (RLFReportInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RLFReportInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RLFReportInformation_iE_Extensions_element();
