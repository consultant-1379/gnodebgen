...
public class S1SetupResponse_protocolIEs extends Asn1SeqOf {
   ...
   public S1SetupResponse_protocolIEs_element[] elements;

   public S1SetupResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public S1SetupResponse_protocolIEs (int numRecords) {
      elements = new S1SetupResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public S1SetupResponse_protocolIEs (S1SetupResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new S1SetupResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new S1SetupResponse_protocolIEs_element();
