...
public class AssistanceDataForPaging_iE_Extensions extends Asn1SeqOf {
   ...
   public AssistanceDataForPaging_iE_Extensions_element[] elements;

   public AssistanceDataForPaging_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public AssistanceDataForPaging_iE_Extensions (int numRecords) {
      elements = new AssistanceDataForPaging_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public AssistanceDataForPaging_iE_Extensions (AssistanceDataForPaging_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AssistanceDataForPaging_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AssistanceDataForPaging_iE_Extensions_element();
