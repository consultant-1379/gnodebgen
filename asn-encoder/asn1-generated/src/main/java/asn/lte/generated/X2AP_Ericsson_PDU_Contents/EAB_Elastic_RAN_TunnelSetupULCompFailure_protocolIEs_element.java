...
public class EAB_Elastic_RAN_TunnelSetupULCompFailure_protocolIEs_element extends Asn1Seq {
   ...
   public EAB_Elastic_RAN_TunnelSetupULCompFailure_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_Elastic_RAN_TunnelSetupULCompFailure_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
    ...
    */
   public void setUsing_eid_Cause(asn.lte.generated.X2AP_Ericsson_IEs.EAB_Cause value) {
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_Cause getValueFor_eid_Cause() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_Cause) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_PDU_ContentsValues.EAB_Elastic_RAN_TunnelSetupULCompFailure_IEs.length; i++) {
         if(_X2AP_Ericsson_PDU_ContentsValues.EAB_Elastic_RAN_TunnelSetupULCompFailure_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_PDU_ContentsValues.EAB_Elastic_RAN_TunnelSetupULCompFailure_IEs[i];
            break;
         }
      }
      if (null == _index) {
