...
public class PMCH_InfoList_r9 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PMCH-InfoList-r9";
   }

   public PMCH_Info_r9[] elements;

   public PMCH_InfoList_r9 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PMCH_InfoList_r9 (int numRecords) {
      elements = new PMCH_Info_r9 [numRecords];
   }
    ...
    * given the array.  
    */
   public PMCH_InfoList_r9 (PMCH_Info_r9[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PMCH_Info_r9 [numElements];
