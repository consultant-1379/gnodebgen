...
public class SBCCH_SL_BCH_Message extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SBCCH-SL-BCH-Message";
   }

   public SBCCH_SL_BCH_MessageType message;

   public SBCCH_SL_BCH_Message () {
      super();
      init();
   }
    ...
    */
   public SBCCH_SL_BCH_Message (
      SBCCH_SL_BCH_MessageType message_
   ) {
      super();
      message = message_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      message = new SBCCH_SL_BCH_MessageType();
