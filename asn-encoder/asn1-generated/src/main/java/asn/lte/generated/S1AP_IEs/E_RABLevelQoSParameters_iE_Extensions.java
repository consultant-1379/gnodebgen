...
public class E_RABLevelQoSParameters_iE_Extensions extends Asn1SeqOf {
   ...
   public E_RABLevelQoSParameters_iE_Extensions_element[] elements;

   public E_RABLevelQoSParameters_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABLevelQoSParameters_iE_Extensions (int numRecords) {
      elements = new E_RABLevelQoSParameters_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABLevelQoSParameters_iE_Extensions (E_RABLevelQoSParameters_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABLevelQoSParameters_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABLevelQoSParameters_iE_Extensions_element();
