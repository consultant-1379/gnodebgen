...
public class E_RABSetupListBearerSURes extends Asn1SeqOf {
   ...
   public E_RABSetupListBearerSURes_element[] elements;

   public E_RABSetupListBearerSURes () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABSetupListBearerSURes (int numRecords) {
      elements = new E_RABSetupListBearerSURes_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABSetupListBearerSURes (E_RABSetupListBearerSURes_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABSetupListBearerSURes_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABSetupListBearerSURes_element();
