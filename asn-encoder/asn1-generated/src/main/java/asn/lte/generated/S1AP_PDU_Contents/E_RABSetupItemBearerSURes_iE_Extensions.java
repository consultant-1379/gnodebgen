...
public class E_RABSetupItemBearerSURes_iE_Extensions extends Asn1SeqOf {
   ...
   public E_RABSetupItemBearerSURes_iE_Extensions_element[] elements;

   public E_RABSetupItemBearerSURes_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABSetupItemBearerSURes_iE_Extensions (int numRecords) {
      elements = new E_RABSetupItemBearerSURes_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABSetupItemBearerSURes_iE_Extensions (E_RABSetupItemBearerSURes_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABSetupItemBearerSURes_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABSetupItemBearerSURes_iE_Extensions_element();
