...
import asn.lte.generated.NR_RRC_Definitions.BandParametersSidelink_r16;

public class BandCombinationParametersSidelinkNR_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandCombinationParametersSidelinkNR-r16";
   }

   public BandParametersSidelink_r16[] elements;

   public BandCombinationParametersSidelinkNR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParametersSidelinkNR_r16 (int numRecords) {
      elements = new BandParametersSidelink_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParametersSidelinkNR_r16 (BandParametersSidelink_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParametersSidelink_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParametersSidelink_r16();
