...
public class MeNBtoSgNBContainer extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "MeNBtoSgNBContainer";
   }

   public MeNBtoSgNBContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public MeNBtoSgNBContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public MeNBtoSgNBContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public MeNBtoSgNBContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
