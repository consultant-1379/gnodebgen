...
public class ULInformationTransferMRDC_r15 extends Asn1Seq {
   ...
   public ULInformationTransferMRDC_r15_criticalExtensions criticalExtensions;

   public ULInformationTransferMRDC_r15 () {
      super();
      init();
   }
    ...
    */
   public ULInformationTransferMRDC_r15 (
      ULInformationTransferMRDC_r15_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new ULInformationTransferMRDC_r15_criticalExtensions();
