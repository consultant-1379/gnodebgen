...
public class UEInformationResponse_r9_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _UEINFORMATIONRESPONSE_R9 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public UEInformationResponse_r9_criticalExtensions_c1 () {
      super();
   }

   public UEInformationResponse_r9_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_ueInformationResponse_r9 (UEInformationResponse_r9_IEs value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            element = ueInformationResponse_r9 = new UEInformationResponse_r9_IEs();
