...
public class AssociatedCell_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public AssociatedCell_Item_iE_Extensions_element[] elements;

   public AssociatedCell_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public AssociatedCell_Item_iE_Extensions (int numRecords) {
      elements = new AssociatedCell_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public AssociatedCell_Item_iE_Extensions (AssociatedCell_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AssociatedCell_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AssociatedCell_Item_iE_Extensions_element();
