...
public class Target_ToSource_TransparentContainer extends Asn1OctetString {
   ...
   public Target_ToSource_TransparentContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public Target_ToSource_TransparentContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public Target_ToSource_TransparentContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public Target_ToSource_TransparentContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
