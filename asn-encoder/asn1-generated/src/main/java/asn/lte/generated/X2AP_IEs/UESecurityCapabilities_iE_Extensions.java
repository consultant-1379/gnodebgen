...
public class UESecurityCapabilities_iE_Extensions extends Asn1SeqOf {
   ...
   public UESecurityCapabilities_iE_Extensions_element[] elements;

   public UESecurityCapabilities_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public UESecurityCapabilities_iE_Extensions (int numRecords) {
      elements = new UESecurityCapabilities_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UESecurityCapabilities_iE_Extensions (UESecurityCapabilities_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UESecurityCapabilities_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UESecurityCapabilities_iE_Extensions_element();
