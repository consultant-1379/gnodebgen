...
public class CSI_MeasConfig_csi_IM_ResourceSetToReleaseList extends Asn1SeqOf {
   ...
   public CSI_MeasConfig_csi_IM_ResourceSetToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_csi_IM_ResourceSetToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public CSI_MeasConfig_csi_IM_ResourceSetToReleaseList (CSI_IM_ResourceSetId[] elements_) {
      elements = elements_;
   }
