...
public class FiveGS_TAC extends Asn1OctetString {
    ...
    */
   public FiveGS_TAC (byte[] data, int offset, int nbytes) {
    ...
    */
   public FiveGS_TAC (String value_) throws Asn1ValueParseException {
      super (value_);
   }
