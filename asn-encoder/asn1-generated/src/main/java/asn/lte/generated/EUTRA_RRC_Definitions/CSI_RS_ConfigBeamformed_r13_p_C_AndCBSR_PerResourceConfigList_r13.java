...
public class CSI_RS_ConfigBeamformed_r13_p_C_AndCBSR_PerResourceConfigList_r13 extends Asn1SeqOf {
   ...
   public P_C_AndCBSR_Pair_r13[] elements;

   public CSI_RS_ConfigBeamformed_r13_p_C_AndCBSR_PerResourceConfigList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_ConfigBeamformed_r13_p_C_AndCBSR_PerResourceConfigList_r13 (int numRecords) {
      elements = new P_C_AndCBSR_Pair_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_RS_ConfigBeamformed_r13_p_C_AndCBSR_PerResourceConfigList_r13 (P_C_AndCBSR_Pair_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new P_C_AndCBSR_Pair_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new P_C_AndCBSR_Pair_r13();
