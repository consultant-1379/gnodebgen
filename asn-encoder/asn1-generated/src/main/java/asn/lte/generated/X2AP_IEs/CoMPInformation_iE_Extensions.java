...
public class CoMPInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public CoMPInformation_iE_Extensions_element[] elements;

   public CoMPInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CoMPInformation_iE_Extensions (int numRecords) {
      elements = new CoMPInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CoMPInformation_iE_Extensions (CoMPInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CoMPInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CoMPInformation_iE_Extensions_element();
