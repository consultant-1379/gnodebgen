...
public class ServedCellsToActivate extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServedCellsToActivate";
   }

   public ServedCellsToActivate_Item[] elements;

   public ServedCellsToActivate () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedCellsToActivate (int numRecords) {
      elements = new ServedCellsToActivate_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedCellsToActivate (ServedCellsToActivate_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedCellsToActivate_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedCellsToActivate_Item();
