...
public class CounterCheckResponse_v8a0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "CounterCheckResponse-v8a0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public CounterCheckResponse_v1530_IEs nonCriticalExtension;  // optional

   public CounterCheckResponse_v8a0_IEs () {
      super();
      init();
   }
   ...
   public CounterCheckResponse_v8a0_IEs (
      ...
      CounterCheckResponse_v1530_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public CounterCheckResponse_v8a0_IEs (byte[] lateNonCriticalExtension_,
      CounterCheckResponse_v1530_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new CounterCheckResponse_v1530_IEs();
