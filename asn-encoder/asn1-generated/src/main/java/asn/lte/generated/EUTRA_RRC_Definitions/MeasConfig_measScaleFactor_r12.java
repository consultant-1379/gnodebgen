...
public class MeasConfig_measScaleFactor_r12 extends Asn1Choice {
   ...
   public MeasConfig_measScaleFactor_r12 () {
      super();
   }

   public MeasConfig_measScaleFactor_r12 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (MeasScaleFactor_r12 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            MeasScaleFactor_r12 setup;
            int tval = MeasScaleFactor_r12.decodeEnumValue (buffer);
            element = setup = MeasScaleFactor_r12.valueOf (tval);
            break;
         }
