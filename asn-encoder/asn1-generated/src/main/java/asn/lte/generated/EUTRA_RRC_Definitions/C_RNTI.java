...
public class C_RNTI extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public C_RNTI (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public C_RNTI (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public C_RNTI (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public C_RNTI (java.util.BitSet bitSet) {
      super (bitSet);
   }
