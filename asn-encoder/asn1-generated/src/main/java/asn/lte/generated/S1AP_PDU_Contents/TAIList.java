...
public class TAIList extends Asn1SeqOf {
   ...
   public TAIList_element[] elements;
    ...
    * populated.
    */
   public TAIList (int numRecords) {
      elements = new TAIList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TAIList (TAIList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TAIList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TAIList_element();
