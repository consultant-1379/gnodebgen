...
public class RRCTransfer_protocolIEs extends Asn1SeqOf {
   ...
   public RRCTransfer_protocolIEs_element[] elements;

   public RRCTransfer_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public RRCTransfer_protocolIEs (int numRecords) {
      elements = new RRCTransfer_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RRCTransfer_protocolIEs (RRCTransfer_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RRCTransfer_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RRCTransfer_protocolIEs_element();
