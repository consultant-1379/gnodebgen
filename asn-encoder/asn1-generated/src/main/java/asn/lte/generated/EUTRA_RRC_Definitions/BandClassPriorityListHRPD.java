...
public class BandClassPriorityListHRPD extends Asn1SeqOf {
   ...
   public BandClassPriorityHRPD[] elements;

   public BandClassPriorityListHRPD () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandClassPriorityListHRPD (int numRecords) {
      elements = new BandClassPriorityHRPD [numRecords];
   }
    ...
    * given the array.  
    */
   public BandClassPriorityListHRPD (BandClassPriorityHRPD[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandClassPriorityHRPD [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandClassPriorityHRPD();
