...
public class ListofNRCellsinNRCoordinationReq extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ListofNRCellsinNRCoordinationReq";
   }

   public NRCGI[] elements;

   public ListofNRCellsinNRCoordinationReq () {
      elements = null;
   }
    ...
    * populated.
    */
   public ListofNRCellsinNRCoordinationReq (int numRecords) {
    ...
    * given the array.  
    */
   public ListofNRCellsinNRCoordinationReq (NRCGI[] elements_) {
      elements = elements_;
   }
