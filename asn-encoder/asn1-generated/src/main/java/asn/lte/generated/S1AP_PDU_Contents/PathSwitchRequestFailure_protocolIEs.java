...
public class PathSwitchRequestFailure_protocolIEs extends Asn1SeqOf {
   ...
   public PathSwitchRequestFailure_protocolIEs_element[] elements;

   public PathSwitchRequestFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public PathSwitchRequestFailure_protocolIEs (int numRecords) {
      elements = new PathSwitchRequestFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PathSwitchRequestFailure_protocolIEs (PathSwitchRequestFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PathSwitchRequestFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PathSwitchRequestFailure_protocolIEs_element();
