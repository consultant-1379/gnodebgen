...
public class PathSwitchRequest_protocolIEs extends Asn1SeqOf {
   ...
   public PathSwitchRequest_protocolIEs_element[] elements;

   public PathSwitchRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public PathSwitchRequest_protocolIEs (int numRecords) {
      elements = new PathSwitchRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PathSwitchRequest_protocolIEs (PathSwitchRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PathSwitchRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PathSwitchRequest_protocolIEs_element();
