...
public class SgNBReleaseRequestAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBReleaseRequestAcknowledge_protocolIEs_element[] elements;

   public SgNBReleaseRequestAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBReleaseRequestAcknowledge_protocolIEs (int numRecords) {
      elements = new SgNBReleaseRequestAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBReleaseRequestAcknowledge_protocolIEs (SgNBReleaseRequestAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBReleaseRequestAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBReleaseRequestAcknowledge_protocolIEs_element();
