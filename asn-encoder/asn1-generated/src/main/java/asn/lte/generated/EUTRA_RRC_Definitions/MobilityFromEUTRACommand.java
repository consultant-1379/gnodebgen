...
public class MobilityFromEUTRACommand extends Asn1Seq {
   ...
   public MobilityFromEUTRACommand_criticalExtensions criticalExtensions;

   public MobilityFromEUTRACommand () {
      super();
      init();
   }
   ...
   public MobilityFromEUTRACommand (
      ...
      MobilityFromEUTRACommand_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public MobilityFromEUTRACommand (long rrc_TransactionIdentifier_,
      MobilityFromEUTRACommand_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new MobilityFromEUTRACommand_criticalExtensions();
