...
public class LoggedMeasurementConfiguration_r10_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _LOGGEDMEASUREMENTCONFIGURATION_R10 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public LoggedMeasurementConfiguration_r10_criticalExtensions_c1 () {
      super();
   }

   public LoggedMeasurementConfiguration_r10_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_loggedMeasurementConfiguration_r10 (LoggedMeasurementConfiguration_r10_IEs value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            LoggedMeasurementConfiguration_r10_IEs loggedMeasurementConfiguration_r10;
            element = loggedMeasurementConfiguration_r10 = new LoggedMeasurementConfiguration_r10_IEs();
