...
public class TargeteNB_ToSourceeNB_TransparentContainer_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: EAB-TargeteNB-ToSourceeNB-TransparentContainer-ExtConveyor
    * Java type: EAB_TargeteNB_ToSourceeNB_TransparentContainer_ExtConveyor
    */
   public Asn1Type extensionValue;

   public TargeteNB_ToSourceeNB_TransparentContainer_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public TargeteNB_ToSourceeNB_TransparentContainer_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.S1AP_Ericsson_IEs.EAB_TargeteNB_ToSourceeNB_TransparentContainer_ExtConveyor extensionValue) {
    ...
    */
   public asn.lte.generated.S1AP_Ericsson_IEs.EAB_TargeteNB_ToSourceeNB_TransparentContainer_ExtConveyor getExtensionValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.S1AP_Ericsson_IEs.EAB_TargeteNB_ToSourceeNB_TransparentContainer_ExtConveyor) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.TargeteNB_ToSourceeNB_TransparentContainer_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.TargeteNB_ToSourceeNB_TransparentContainer_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.TargeteNB_ToSourceeNB_TransparentContainer_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
