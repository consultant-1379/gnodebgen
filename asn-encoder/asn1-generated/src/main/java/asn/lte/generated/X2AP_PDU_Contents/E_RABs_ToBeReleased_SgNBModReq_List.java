...
public class E_RABs_ToBeReleased_SgNBModReq_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeReleased-SgNBModReq-List";
   }

   public E_RABs_ToBeReleased_SgNBModReq_List_element[] elements;

   public E_RABs_ToBeReleased_SgNBModReq_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeReleased_SgNBModReq_List (int numRecords) {
      elements = new E_RABs_ToBeReleased_SgNBModReq_List_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeReleased_SgNBModReq_List (E_RABs_ToBeReleased_SgNBModReq_List_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeReleased_SgNBModReq_List_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeReleased_SgNBModReq_List_element();
