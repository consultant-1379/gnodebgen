...
public class CSIReportList_element_iE_Extensions extends Asn1SeqOf {
   ...
   public CSIReportList_element_iE_Extensions_element[] elements;

   public CSIReportList_element_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSIReportList_element_iE_Extensions (int numRecords) {
      elements = new CSIReportList_element_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CSIReportList_element_iE_Extensions (CSIReportList_element_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSIReportList_element_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSIReportList_element_iE_Extensions_element();
