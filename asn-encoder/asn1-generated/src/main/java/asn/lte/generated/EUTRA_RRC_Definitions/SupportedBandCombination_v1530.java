...
public class SupportedBandCombination_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-v1530";
   }

   public BandCombinationParameters_v1530[] elements;

   public SupportedBandCombination_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_v1530 (int numRecords) {
    ...
    * given the array.  
    */
   public SupportedBandCombination_v1530 (BandCombinationParameters_v1530[] elements_) {
      elements = elements_;
   }
