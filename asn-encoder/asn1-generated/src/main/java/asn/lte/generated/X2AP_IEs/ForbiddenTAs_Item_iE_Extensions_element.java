...
public class ForbiddenTAs_Item_iE_Extensions_element extends Asn1Seq {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.ForbiddenTAs_Item_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.ForbiddenTAs_Item_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.ForbiddenTAs_Item_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
