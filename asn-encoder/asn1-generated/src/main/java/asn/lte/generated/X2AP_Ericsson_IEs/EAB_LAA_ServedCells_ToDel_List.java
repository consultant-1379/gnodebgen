...
public class EAB_LAA_ServedCells_ToDel_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-LAA-ServedCells-ToDel-List";
   }

   public ECGI[] elements;

   public EAB_LAA_ServedCells_ToDel_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_LAA_ServedCells_ToDel_List (int numRecords) {
    ...
    * given the array.  
    */
   public EAB_LAA_ServedCells_ToDel_List (ECGI[] elements_) {
      elements = elements_;
   }
