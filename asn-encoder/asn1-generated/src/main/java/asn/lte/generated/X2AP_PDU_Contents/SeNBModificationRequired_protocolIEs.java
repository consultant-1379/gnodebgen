...
public class SeNBModificationRequired_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBModificationRequired_protocolIEs_element[] elements;

   public SeNBModificationRequired_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBModificationRequired_protocolIEs (int numRecords) {
      elements = new SeNBModificationRequired_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBModificationRequired_protocolIEs (SeNBModificationRequired_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBModificationRequired_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBModificationRequired_protocolIEs_element();
