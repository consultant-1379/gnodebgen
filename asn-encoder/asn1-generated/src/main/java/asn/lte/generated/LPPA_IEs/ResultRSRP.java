...
public class ResultRSRP extends Asn1SeqOf {
   ...
   public ResultRSRP_Item[] elements;
    ...
    * populated.
    */
   public ResultRSRP (int numRecords) {
      elements = new ResultRSRP_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ResultRSRP (ResultRSRP_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResultRSRP_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResultRSRP_Item();
