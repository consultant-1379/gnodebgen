...
public class ULInformationTransfer_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "ULInformationTransfer-NB";
   }

   public ULInformationTransfer_NB_criticalExtensions criticalExtensions;

   public ULInformationTransfer_NB () {
      super();
      init();
   }
    ...
    */
   public ULInformationTransfer_NB (
      ULInformationTransfer_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new ULInformationTransfer_NB_criticalExtensions();
