...
public class DRB_ToReleaseList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "DRB-ToReleaseList-r15";
   }

   public DRB_Identity[] elements;

   public DRB_ToReleaseList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public DRB_ToReleaseList_r15 (int numRecords) {
    ...
    * given the array.  
    */
   public DRB_ToReleaseList_r15 (DRB_Identity[] elements_) {
      elements = elements_;
   }
