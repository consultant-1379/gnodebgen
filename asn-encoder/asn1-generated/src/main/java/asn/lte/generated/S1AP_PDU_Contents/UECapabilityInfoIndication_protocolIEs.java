...
public class UECapabilityInfoIndication_protocolIEs extends Asn1SeqOf {
   ...
   public UECapabilityInfoIndication_protocolIEs_element[] elements;

   public UECapabilityInfoIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UECapabilityInfoIndication_protocolIEs (int numRecords) {
      elements = new UECapabilityInfoIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UECapabilityInfoIndication_protocolIEs (UECapabilityInfoIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UECapabilityInfoIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UECapabilityInfoIndication_protocolIEs_element();
