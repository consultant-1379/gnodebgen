...
public class ProximityIndication_r9_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _PROXIMITYINDICATION_R9 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public ProximityIndication_r9_criticalExtensions_c1 () {
      super();
   }

   public ProximityIndication_r9_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_proximityIndication_r9 (ProximityIndication_r9_IEs value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ProximityIndication_r9_IEs proximityIndication_r9;
            element = proximityIndication_r9 = new ProximityIndication_r9_IEs();
