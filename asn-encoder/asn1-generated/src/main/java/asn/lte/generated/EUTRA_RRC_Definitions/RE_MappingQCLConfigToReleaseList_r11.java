...
public class RE_MappingQCLConfigToReleaseList_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RE-MappingQCLConfigToReleaseList-r11";
   }

   public PDSCH_RE_MappingQCL_ConfigId_r11[] elements;

   public RE_MappingQCLConfigToReleaseList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RE_MappingQCLConfigToReleaseList_r11 (int numRecords) {
      elements = new PDSCH_RE_MappingQCL_ConfigId_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public RE_MappingQCLConfigToReleaseList_r11 (PDSCH_RE_MappingQCL_ConfigId_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PDSCH_RE_MappingQCL_ConfigId_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PDSCH_RE_MappingQCL_ConfigId_r11();
