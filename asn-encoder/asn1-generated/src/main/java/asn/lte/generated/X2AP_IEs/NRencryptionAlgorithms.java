...
public class NRencryptionAlgorithms extends Asn1BitString {
    ...
    */
   public NRencryptionAlgorithms (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public NRencryptionAlgorithms (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public NRencryptionAlgorithms (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public NRencryptionAlgorithms (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public NRencryptionAlgorithms (java.util.BitSet bitSet) {
      super (bitSet);
   }
