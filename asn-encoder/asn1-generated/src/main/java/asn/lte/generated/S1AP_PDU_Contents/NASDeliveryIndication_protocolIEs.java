...
public class NASDeliveryIndication_protocolIEs extends Asn1SeqOf {
   ...
   public NASDeliveryIndication_protocolIEs_element[] elements;

   public NASDeliveryIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public NASDeliveryIndication_protocolIEs (int numRecords) {
      elements = new NASDeliveryIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public NASDeliveryIndication_protocolIEs (NASDeliveryIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NASDeliveryIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NASDeliveryIndication_protocolIEs_element();
