...
public class CellInfoListUTRA_TDD_r9 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellInfoListUTRA-TDD-r9";
   }

   public CellInfoUTRA_TDD_r9[] elements;

   public CellInfoListUTRA_TDD_r9 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellInfoListUTRA_TDD_r9 (int numRecords) {
      elements = new CellInfoUTRA_TDD_r9 [numRecords];
   }
    ...
    * given the array.  
    */
   public CellInfoListUTRA_TDD_r9 (CellInfoUTRA_TDD_r9[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellInfoUTRA_TDD_r9 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellInfoUTRA_TDD_r9();
