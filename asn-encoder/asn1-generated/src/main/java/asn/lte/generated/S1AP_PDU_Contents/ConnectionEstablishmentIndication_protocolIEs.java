...
public class ConnectionEstablishmentIndication_protocolIEs extends Asn1SeqOf {
   ...
   public ConnectionEstablishmentIndication_protocolIEs_element[] elements;

   public ConnectionEstablishmentIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ConnectionEstablishmentIndication_protocolIEs (int numRecords) {
      elements = new ConnectionEstablishmentIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ConnectionEstablishmentIndication_protocolIEs (ConnectionEstablishmentIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ConnectionEstablishmentIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ConnectionEstablishmentIndication_protocolIEs_element();
