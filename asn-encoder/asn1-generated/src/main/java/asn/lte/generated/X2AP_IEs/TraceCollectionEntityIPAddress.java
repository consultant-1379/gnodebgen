...
public class TraceCollectionEntityIPAddress extends Asn1BitString {
    ...
    */
   public TraceCollectionEntityIPAddress () {
      super();
   }
    ...
    */
   public TraceCollectionEntityIPAddress (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public TraceCollectionEntityIPAddress (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public TraceCollectionEntityIPAddress (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public TraceCollectionEntityIPAddress (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public TraceCollectionEntityIPAddress (java.util.BitSet bitSet) {
      super (bitSet);
   }
