...
public class M7Configuration_iE_Extensions_element extends Asn1Seq {
   ...
   public M7Configuration_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public M7Configuration_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.M7Configuration_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.M7Configuration_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.M7Configuration_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
