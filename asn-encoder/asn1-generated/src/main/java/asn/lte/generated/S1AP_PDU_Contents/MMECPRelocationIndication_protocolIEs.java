...
public class MMECPRelocationIndication_protocolIEs extends Asn1SeqOf {
   ...
   public MMECPRelocationIndication_protocolIEs_element[] elements;

   public MMECPRelocationIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MMECPRelocationIndication_protocolIEs (int numRecords) {
      elements = new MMECPRelocationIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MMECPRelocationIndication_protocolIEs (MMECPRelocationIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MMECPRelocationIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MMECPRelocationIndication_protocolIEs_element();
