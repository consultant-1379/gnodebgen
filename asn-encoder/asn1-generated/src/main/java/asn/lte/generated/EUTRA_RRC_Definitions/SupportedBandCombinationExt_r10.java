...
public class SupportedBandCombinationExt_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombinationExt-r10";
   }

   public BandCombinationParametersExt_r10[] elements;

   public SupportedBandCombinationExt_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombinationExt_r10 (int numRecords) {
      elements = new BandCombinationParametersExt_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandCombinationExt_r10 (BandCombinationParametersExt_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandCombinationParametersExt_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandCombinationParametersExt_r10();
