...
public class EAB_CellActivationRequest_ExtConveyor_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: eid-CellActivationReason
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-CellActivationReason
    * Java type: EAB_CellActivationReason
    */
   public Asn1Type value;

   public EAB_CellActivationRequest_ExtConveyor_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_CellActivationRequest_ExtConveyor_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-CellActivationReason
    */
   public void setUsing_eid_CellActivationReason(EAB_CellActivationReason value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_CellActivationReason);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key eid-CellActivationReason
    */
   public EAB_CellActivationReason getValueFor_eid_CellActivationReason() {
      return (EAB_CellActivationReason) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_CellActivationRequest_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_CellActivationRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_CellActivationRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 4142) {
         indent (_sb, _level+1);
         _sb.append("id = eid-CellActivationReason\n");
      }
