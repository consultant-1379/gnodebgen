...
public class RAN_AreaConfig_r15_ran_AreaCodeList_r15 extends Asn1SeqOf {
   ...
   public RAN_AreaCode_r15[] elements;

   public RAN_AreaConfig_r15_ran_AreaCodeList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RAN_AreaConfig_r15_ran_AreaCodeList_r15 (int numRecords) {
      elements = new RAN_AreaCode_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public RAN_AreaConfig_r15_ran_AreaCodeList_r15 (RAN_AreaCode_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RAN_AreaCode_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RAN_AreaCode_r15();
