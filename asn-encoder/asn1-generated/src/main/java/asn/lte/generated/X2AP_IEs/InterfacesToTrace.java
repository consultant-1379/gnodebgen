...
public class InterfacesToTrace extends Asn1BitString {
    ...
    */
   public InterfacesToTrace (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public InterfacesToTrace (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public InterfacesToTrace (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public InterfacesToTrace (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public InterfacesToTrace (java.util.BitSet bitSet) {
      super (bitSet);
   }
