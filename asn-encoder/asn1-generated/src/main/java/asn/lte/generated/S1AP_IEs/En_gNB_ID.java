...
public class En_gNB_ID extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public En_gNB_ID (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public En_gNB_ID (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public En_gNB_ID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public En_gNB_ID (java.util.BitSet bitSet) {
      super (bitSet);
   }
