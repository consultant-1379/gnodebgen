...
public class SupportedTAs extends Asn1SeqOf {
   ...
   public SupportedTAs_Item[] elements;
    ...
    * populated.
    */
   public SupportedTAs (int numRecords) {
      elements = new SupportedTAs_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedTAs (SupportedTAs_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedTAs_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedTAs_Item();
