...
public class SecondaryRATDataUsageReportList extends Asn1SeqOf {
   ...
   public SecondaryRATDataUsageReportList_element[] elements;

   public SecondaryRATDataUsageReportList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SecondaryRATDataUsageReportList (int numRecords) {
      elements = new SecondaryRATDataUsageReportList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SecondaryRATDataUsageReportList (SecondaryRATDataUsageReportList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SecondaryRATDataUsageReportList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SecondaryRATDataUsageReportList_element();
