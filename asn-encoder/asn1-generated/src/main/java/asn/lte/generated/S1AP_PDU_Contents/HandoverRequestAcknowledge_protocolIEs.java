...
public class HandoverRequestAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public HandoverRequestAcknowledge_protocolIEs_element[] elements;

   public HandoverRequestAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public HandoverRequestAcknowledge_protocolIEs (int numRecords) {
      elements = new HandoverRequestAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public HandoverRequestAcknowledge_protocolIEs (HandoverRequestAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HandoverRequestAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new HandoverRequestAcknowledge_protocolIEs_element();
