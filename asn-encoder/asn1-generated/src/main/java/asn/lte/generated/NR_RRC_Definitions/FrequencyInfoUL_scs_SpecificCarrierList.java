...
public class FrequencyInfoUL_scs_SpecificCarrierList extends Asn1SeqOf {
   ...
   public FrequencyInfoUL_scs_SpecificCarrierList () {
      elements = null;
   }
    ...
    * populated.
    */
   public FrequencyInfoUL_scs_SpecificCarrierList (int numRecords) {
    ...
    * given the array.  
    */
   public FrequencyInfoUL_scs_SpecificCarrierList (SCS_SpecificCarrier[] elements_) {
      elements = elements_;
   }
