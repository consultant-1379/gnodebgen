...
public class MBMSSessionStopRequest_protocolIEs extends Asn1SeqOf {
   ...
   public MBMSSessionStopRequest_protocolIEs_element[] elements;

   public MBMSSessionStopRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMSSessionStopRequest_protocolIEs (int numRecords) {
      elements = new MBMSSessionStopRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMSSessionStopRequest_protocolIEs (MBMSSessionStopRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMSSessionStopRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMSSessionStopRequest_protocolIEs_element();
