...
public class DataForwardingAddressIndication_protocolIEs extends Asn1SeqOf {
   ...
   public DataForwardingAddressIndication_protocolIEs_element[] elements;

   public DataForwardingAddressIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public DataForwardingAddressIndication_protocolIEs (int numRecords) {
      elements = new DataForwardingAddressIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public DataForwardingAddressIndication_protocolIEs (DataForwardingAddressIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DataForwardingAddressIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DataForwardingAddressIndication_protocolIEs_element();
