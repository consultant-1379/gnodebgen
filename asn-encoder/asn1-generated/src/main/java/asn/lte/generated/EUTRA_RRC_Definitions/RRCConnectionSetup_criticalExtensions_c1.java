...
public class RRCConnectionSetup_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _RRCCONNECTIONSETUP_R8 = 1;
   ...
   public RRCConnectionSetup_criticalExtensions_c1 () {
      super();
   }

   public RRCConnectionSetup_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _RRCCONNECTIONSETUP_R8: return "rrcConnectionSetup_r8";
   ...
   public void set_rrcConnectionSetup_r8 (RRCConnectionSetup_r8_IEs value) {
      setElement (_RRCCONNECTIONSETUP_R8, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            RRCConnectionSetup_r8_IEs rrcConnectionSetup_r8;
            element = rrcConnectionSetup_r8 = new RRCConnectionSetup_r8_IEs();
            rrcConnectionSetup_r8.decode (buffer);
            break;
         }
