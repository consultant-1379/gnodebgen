...
public class ResetAcknowledge_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: UE-associatedLogicalS1-ConnectionListResAck
    * Java type: UE_associatedLogicalS1_ConnectionListResAck
    *
   ...
   /**
    * Assign fields according to information object having key id-UE-associatedLogicalS1-ConnectionListResAck
    */
   public void setUsing_id_UE_associatedLogicalS1_ConnectionListResAck(UE_associatedLogicalS1_ConnectionListResAck value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_UE_associatedLogicalS1_ConnectionListResAck);
   ...
   /**
    * Get value of value with type set according to information object having key id-UE-associatedLogicalS1-ConnectionListResAck
    */
   public UE_associatedLogicalS1_ConnectionListResAck getValueFor_id_UE_associatedLogicalS1_ConnectionListResAck() {
      return (UE_associatedLogicalS1_ConnectionListResAck) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.ResetAcknowledgeIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.ResetAcknowledgeIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.ResetAcknowledgeIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 93) {
         indent (_sb, _level+1);
         _sb.append("id = id-UE-associatedLogicalS1-ConnectionListResAck\n");
      }
      else if (id.value == 58) {
         indent (_sb, _level+1);
