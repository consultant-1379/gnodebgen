...
public class P_C_AndCBSR_Pair_r13a extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "P-C-AndCBSR-Pair-r13a";
   }

   public P_C_AndCBSR_r11[] elements;

   public P_C_AndCBSR_Pair_r13a () {
      elements = null;
   }
    ...
    * populated.
    */
   public P_C_AndCBSR_Pair_r13a (int numRecords) {
      elements = new P_C_AndCBSR_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public P_C_AndCBSR_Pair_r13a (P_C_AndCBSR_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new P_C_AndCBSR_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new P_C_AndCBSR_r11();
