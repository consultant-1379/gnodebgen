...
public class InterFreqBandList extends Asn1SeqOf {
   ...
   public InterFreqBandInfo[] elements;

   public InterFreqBandList () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqBandList (int numRecords) {
      elements = new InterFreqBandInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqBandList (InterFreqBandInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqBandInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqBandInfo();
