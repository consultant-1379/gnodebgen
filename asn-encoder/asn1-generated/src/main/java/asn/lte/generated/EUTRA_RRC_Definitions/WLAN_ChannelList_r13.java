...
public class WLAN_ChannelList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "WLAN-ChannelList-r13";
   }

   public WLAN_Channel_r13[] elements;

   public WLAN_ChannelList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public WLAN_ChannelList_r13 (int numRecords) {
      elements = new WLAN_Channel_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public WLAN_ChannelList_r13 (WLAN_Channel_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WLAN_Channel_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new WLAN_Channel_r13();
