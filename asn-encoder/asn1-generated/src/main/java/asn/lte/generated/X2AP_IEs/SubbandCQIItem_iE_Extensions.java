...
public class SubbandCQIItem_iE_Extensions extends Asn1SeqOf {
   ...
   public SubbandCQIItem_iE_Extensions_element[] elements;

   public SubbandCQIItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SubbandCQIItem_iE_Extensions (int numRecords) {
      elements = new SubbandCQIItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SubbandCQIItem_iE_Extensions (SubbandCQIItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SubbandCQIItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SubbandCQIItem_iE_Extensions_element();
