...
public class ECGIListForRestart extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ECGIListForRestart";
   }

   public EUTRAN_CGI[] elements;

   public ECGIListForRestart () {
      elements = null;
   }
    ...
    * populated.
    */
   public ECGIListForRestart (int numRecords) {
      elements = new EUTRAN_CGI [numRecords];
   }
    ...
    * given the array.  
    */
   public ECGIListForRestart (EUTRAN_CGI[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EUTRAN_CGI [numElements];
