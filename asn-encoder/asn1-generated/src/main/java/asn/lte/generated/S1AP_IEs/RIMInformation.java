...
public class RIMInformation extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "RIMInformation";
   }

   public RIMInformation () {
      super();
   }
    ...
    *              in binary form.
    */
   public RIMInformation (byte[] data) {
      super (data);
   }
    ...
    */
   public RIMInformation (byte[] data, int offset, int nbytes) {
    ...
    */
   public RIMInformation (String value_) throws Asn1ValueParseException {
      super (value_);
   }
