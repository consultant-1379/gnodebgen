...
public class NPRACH_ParametersList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NPRACH-ParametersList-NB-r13";
   }

   public NPRACH_Parameters_NB_r13[] elements;

   public NPRACH_ParametersList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NPRACH_ParametersList_NB_r13 (int numRecords) {
      elements = new NPRACH_Parameters_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public NPRACH_ParametersList_NB_r13 (NPRACH_Parameters_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NPRACH_Parameters_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NPRACH_Parameters_NB_r13();
