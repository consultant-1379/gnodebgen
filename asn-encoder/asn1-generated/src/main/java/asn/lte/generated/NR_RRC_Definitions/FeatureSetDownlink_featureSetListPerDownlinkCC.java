...
public class FeatureSetDownlink_featureSetListPerDownlinkCC extends Asn1SeqOf {
   ...
   public FeatureSetDownlinkPerCC_Id[] elements;

   public FeatureSetDownlink_featureSetListPerDownlinkCC () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSetDownlink_featureSetListPerDownlinkCC (int numRecords) {
      elements = new FeatureSetDownlinkPerCC_Id [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSetDownlink_featureSetListPerDownlinkCC (FeatureSetDownlinkPerCC_Id[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetDownlinkPerCC_Id [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetDownlinkPerCC_Id();
