...
public class PLMN_Identity extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public PLMN_Identity (byte[] data) {
      super (data);
   }
    ...
    */
   public PLMN_Identity (byte[] data, int offset, int nbytes) {
    ...
    */
   public PLMN_Identity (String value_) throws Asn1ValueParseException {
      super (value_);
   }
