...
public class RRCConnectionReject_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _RRCCONNECTIONREJECT_R8 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public RRCConnectionReject_criticalExtensions_c1 () {
      super();
   }

   public RRCConnectionReject_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _RRCCONNECTIONREJECT_R8: return "rrcConnectionReject_r8";
   ...
   public void set_rrcConnectionReject_r8 (RRCConnectionReject_r8_IEs value) {
      setElement (_RRCCONNECTIONREJECT_R8, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            RRCConnectionReject_r8_IEs rrcConnectionReject_r8;
            element = rrcConnectionReject_r8 = new RRCConnectionReject_r8_IEs();
            rrcConnectionReject_r8.decode (buffer);
            break;
         }
