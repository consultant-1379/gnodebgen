...
public class MBMS_E_RAB_QoS_Parameters_iE_Extensions extends Asn1SeqOf {
   ...
   public MBMS_E_RAB_QoS_Parameters_iE_Extensions_element[] elements;

   public MBMS_E_RAB_QoS_Parameters_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMS_E_RAB_QoS_Parameters_iE_Extensions (int numRecords) {
      elements = new MBMS_E_RAB_QoS_Parameters_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMS_E_RAB_QoS_Parameters_iE_Extensions (MBMS_E_RAB_QoS_Parameters_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMS_E_RAB_QoS_Parameters_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMS_E_RAB_QoS_Parameters_iE_Extensions_element();
