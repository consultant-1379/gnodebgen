...
public class MeasResultListIdle_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultListIdle-r15";
   }

   public MeasResultIdle_r15[] elements;

   public MeasResultListIdle_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListIdle_r15 (int numRecords) {
      elements = new MeasResultIdle_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListIdle_r15 (MeasResultIdle_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultIdle_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultIdle_r15();
