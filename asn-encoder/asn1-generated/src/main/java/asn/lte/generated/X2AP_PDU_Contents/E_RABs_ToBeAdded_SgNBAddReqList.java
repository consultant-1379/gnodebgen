...
public class E_RABs_ToBeAdded_SgNBAddReqList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeAdded-SgNBAddReqList";
   }

   public E_RABs_ToBeAdded_SgNBAddReqList_element[] elements;

   public E_RABs_ToBeAdded_SgNBAddReqList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeAdded_SgNBAddReqList (int numRecords) {
      elements = new E_RABs_ToBeAdded_SgNBAddReqList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeAdded_SgNBAddReqList (E_RABs_ToBeAdded_SgNBAddReqList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeAdded_SgNBAddReqList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeAdded_SgNBAddReqList_element();
