...
public class MeasResultServMOList extends Asn1SeqOf {
   ...
   public MeasResultServMO[] elements;

   public MeasResultServMOList () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultServMOList (int numRecords) {
      elements = new MeasResultServMO [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultServMOList (MeasResultServMO[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultServMO [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultServMO();
