...
public class ENDCConfigurationUpdateFailure_protocolIEs extends Asn1SeqOf {
   ...
   public ENDCConfigurationUpdateFailure_protocolIEs_element[] elements;

   public ENDCConfigurationUpdateFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENDCConfigurationUpdateFailure_protocolIEs (int numRecords) {
      elements = new ENDCConfigurationUpdateFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENDCConfigurationUpdateFailure_protocolIEs (ENDCConfigurationUpdateFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENDCConfigurationUpdateFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENDCConfigurationUpdateFailure_protocolIEs_element();
