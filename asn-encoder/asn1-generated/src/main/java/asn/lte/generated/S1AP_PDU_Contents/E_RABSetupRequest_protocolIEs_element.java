...
public class E_RABSetupRequest_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: E-RABToBeSetupListBearerSUReq
    * Java type: E_RABToBeSetupListBearerSUReq
    */
   public Asn1Type value;

   public E_RABSetupRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABSetupRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABToBeSetupListBearerSUReq
    */
   public void setUsing_id_E_RABToBeSetupListBearerSUReq(E_RABToBeSetupListBearerSUReq value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABToBeSetupListBearerSUReq);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABToBeSetupListBearerSUReq
    */
   public E_RABToBeSetupListBearerSUReq getValueFor_id_E_RABToBeSetupListBearerSUReq() {
      return (E_RABToBeSetupListBearerSUReq) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABSetupRequestIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABSetupRequestIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABSetupRequestIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABToBeSetupListBearerSUReq\n");
      }
