...
public class MultiFrequencyBandListNR_SIB extends Asn1SeqOf {
   ...
   public NR_MultiBandInfo[] elements;

   public MultiFrequencyBandListNR_SIB () {
      elements = null;
   }
    ...
    * populated.
    */
   public MultiFrequencyBandListNR_SIB (int numRecords) {
      elements = new NR_MultiBandInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public MultiFrequencyBandListNR_SIB (NR_MultiBandInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NR_MultiBandInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NR_MultiBandInfo();
