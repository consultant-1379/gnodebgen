...
public class BT_NameList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BT-NameList-r15";
   }

   public BT_Name_r15[] elements;

   public BT_NameList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BT_NameList_r15 (int numRecords) {
      elements = new BT_Name_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public BT_NameList_r15 (BT_Name_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BT_Name_r15 [numElements];
