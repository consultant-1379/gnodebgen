...
public class SONInformationReply_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: TimeSynchronisationInfo
    * Java type: TimeSynchronisationInfo
    *
    * id: id-Muting-Pattern-Information
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: MutingPatternInformation
    * Java type: MutingPatternInformation
    */
   public Asn1Type extensionValue;

   public SONInformationReply_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SONInformationReply_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-Time-Synchronisation-Info
    */
   public void setUsing_id_Time_Synchronisation_Info(TimeSynchronisationInfo extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_Time_Synchronisation_Info);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-Muting-Pattern-Information
    */
   public void setUsing_id_Muting_Pattern_Information(MutingPatternInformation extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_Muting_Pattern_Information);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-Time-Synchronisation-Info
    */
   public TimeSynchronisationInfo getExtensionValueFor_id_Time_Synchronisation_Info() {
      return (TimeSynchronisationInfo) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-Muting-Pattern-Information
    */
   public MutingPatternInformation getExtensionValueFor_id_Muting_Pattern_Information() {
      return (MutingPatternInformation) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.SONInformationReply_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.SONInformationReply_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.SONInformationReply_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 149) {
         indent (_sb, _level+1);
         _sb.append("id = id-Time-Synchronisation-Info\n");
      }
      else if (id.value == 208) {
         indent (_sb, _level+1);
         _sb.append("id = id-Muting-Pattern-Information\n");
      }
