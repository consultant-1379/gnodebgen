...
public class E_RABs_ToBeReleased_List_RelReq extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeReleased-List-RelReq";
   }

   public E_RABs_ToBeReleased_List_RelReq_element[] elements;

   public E_RABs_ToBeReleased_List_RelReq () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeReleased_List_RelReq (int numRecords) {
      elements = new E_RABs_ToBeReleased_List_RelReq_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeReleased_List_RelReq (E_RABs_ToBeReleased_List_RelReq_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeReleased_List_RelReq_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeReleased_List_RelReq_element();
