...
public class UEAppLayerMeasConfig_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: ServiceType
    * Java type: ServiceType
    */
   public Asn1Type extensionValue;

   public UEAppLayerMeasConfig_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UEAppLayerMeasConfig_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-serviceType
    */
   public void setUsing_id_serviceType(ServiceType extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_serviceType);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-serviceType
    */
   public ServiceType getExtensionValueFor_id_serviceType() {
      return (ServiceType) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.UEAppLayerMeasConfig_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.UEAppLayerMeasConfig_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.UEAppLayerMeasConfig_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
