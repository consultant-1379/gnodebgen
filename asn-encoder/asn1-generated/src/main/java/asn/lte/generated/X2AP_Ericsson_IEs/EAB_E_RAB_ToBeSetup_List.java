...
public class EAB_E_RAB_ToBeSetup_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-E-RAB-ToBeSetup-List";
   }

   public EAB_E_RAB_ToBeSetup_List_element[] elements;

   public EAB_E_RAB_ToBeSetup_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_E_RAB_ToBeSetup_List (int numRecords) {
      elements = new EAB_E_RAB_ToBeSetup_List_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_E_RAB_ToBeSetup_List (EAB_E_RAB_ToBeSetup_List_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_E_RAB_ToBeSetup_List_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_E_RAB_ToBeSetup_List_element();
