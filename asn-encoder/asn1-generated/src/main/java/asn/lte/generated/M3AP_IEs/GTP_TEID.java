...
public class GTP_TEID extends Asn1OctetString {
    ...
    */
   public GTP_TEID (byte[] data, int offset, int nbytes) {
    ...
    */
   public GTP_TEID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
