...
public class UERadioAccessCapabilityInformation_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UERadioAccessCapabilityInformation-NB";
   }

   public UERadioAccessCapabilityInformation_NB_criticalExtensions criticalExtensions;

   public UERadioAccessCapabilityInformation_NB () {
      super();
      init();
   }
    ...
    */
   public UERadioAccessCapabilityInformation_NB (
      UERadioAccessCapabilityInformation_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new UERadioAccessCapabilityInformation_NB_criticalExtensions();
