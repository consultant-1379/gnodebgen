...
public class WLANMeasurementConfiguration_iE_Extensions extends Asn1SeqOf {
   ...
   public WLANMeasurementConfiguration_iE_Extensions_element[] elements;

   public WLANMeasurementConfiguration_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public WLANMeasurementConfiguration_iE_Extensions (int numRecords) {
      elements = new WLANMeasurementConfiguration_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public WLANMeasurementConfiguration_iE_Extensions (WLANMeasurementConfiguration_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WLANMeasurementConfiguration_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new WLANMeasurementConfiguration_iE_Extensions_element();
