...
public class V2XServicesAuthorized_iE_Extensions extends Asn1SeqOf {
   ...
   public V2XServicesAuthorized_iE_Extensions_element[] elements;

   public V2XServicesAuthorized_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public V2XServicesAuthorized_iE_Extensions (int numRecords) {
      elements = new V2XServicesAuthorized_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public V2XServicesAuthorized_iE_Extensions (V2XServicesAuthorized_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new V2XServicesAuthorized_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new V2XServicesAuthorized_iE_Extensions_element();
