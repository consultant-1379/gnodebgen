...
public class SONInformation_Extension extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SONInformation-Extension";
   }
   ...
   /**
    * id: id-SON-Information-Report
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: SONInformationReport
    * Java type: SONInformationReport
    */
   public Asn1Type value;

   public SONInformation_Extension () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SONInformation_Extension (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-SON-Information-Report
    */
   public void setUsing_id_SON_Information_Report(SONInformationReport value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_SON_Information_Report);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-SON-Information-Report
    */
   public SONInformationReport getValueFor_id_SON_Information_Report() {
      return (SONInformationReport) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.SONInformation_ExtensionIE.length; i++) {
         if(_S1AP_IEsValues.SONInformation_ExtensionIE[i].id.equals(id)) {
            _index = _S1AP_IEsValues.SONInformation_ExtensionIE[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 206) {
         indent (_sb, _level+1);
         _sb.append("id = id-SON-Information-Report\n");
      }
