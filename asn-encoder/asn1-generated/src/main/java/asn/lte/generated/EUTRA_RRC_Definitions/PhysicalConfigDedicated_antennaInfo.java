...
public class PhysicalConfigDedicated_antennaInfo extends Asn1Choice {
   ...
   public PhysicalConfigDedicated_antennaInfo () {
      super();
   }

   public PhysicalConfigDedicated_antennaInfo (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_explicitValue (AntennaInfoDedicated value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            element = explicitValue = new AntennaInfoDedicated();
