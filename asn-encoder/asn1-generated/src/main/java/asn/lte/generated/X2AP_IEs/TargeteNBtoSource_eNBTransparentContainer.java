...
public class TargeteNBtoSource_eNBTransparentContainer extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "TargeteNBtoSource-eNBTransparentContainer";
   }

   public TargeteNBtoSource_eNBTransparentContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public TargeteNBtoSource_eNBTransparentContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public TargeteNBtoSource_eNBTransparentContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public TargeteNBtoSource_eNBTransparentContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
