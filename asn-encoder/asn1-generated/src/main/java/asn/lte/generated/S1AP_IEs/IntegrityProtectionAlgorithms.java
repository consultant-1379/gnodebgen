...
public class IntegrityProtectionAlgorithms extends Asn1BitString {
    ...
    */
   public IntegrityProtectionAlgorithms () {
      super();
   }
    ...
    */
   public IntegrityProtectionAlgorithms (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public IntegrityProtectionAlgorithms (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public IntegrityProtectionAlgorithms (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public IntegrityProtectionAlgorithms (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public IntegrityProtectionAlgorithms (java.util.BitSet bitSet) {
      super (bitSet);
   }
