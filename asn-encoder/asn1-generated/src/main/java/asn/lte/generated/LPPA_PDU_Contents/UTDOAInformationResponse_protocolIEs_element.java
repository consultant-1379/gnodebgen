...
public class UTDOAInformationResponse_protocolIEs_element extends Asn1Seq {
   ...
   public UTDOAInformationResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UTDOAInformationResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _LPPA_PDU_ContentsValues.UTDOAInformationResponse_IEs.length; i++) {
         if(_LPPA_PDU_ContentsValues.UTDOAInformationResponse_IEs[i].id.equals(id)) {
            _index = _LPPA_PDU_ContentsValues.UTDOAInformationResponse_IEs[i];
            break;
         }
      }
      if (null == _index) {
