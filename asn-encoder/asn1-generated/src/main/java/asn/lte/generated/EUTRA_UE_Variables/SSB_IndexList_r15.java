...
import asn.lte.generated.EUTRA_RRC_Definitions.RS_IndexNR_r15;

public class SSB_IndexList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SSB-IndexList-r15";
   }

   public RS_IndexNR_r15[] elements;

   public SSB_IndexList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SSB_IndexList_r15 (int numRecords) {
      elements = new RS_IndexNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public SSB_IndexList_r15 (RS_IndexNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RS_IndexNR_r15 [numElements];
