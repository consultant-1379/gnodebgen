...
public class ServedMMECs extends Asn1SeqOf {
    ...
    * populated.
    */
   public ServedMMECs (int numRecords) {
      elements = new MME_Code [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedMMECs (MME_Code[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MME_Code [numElements];
