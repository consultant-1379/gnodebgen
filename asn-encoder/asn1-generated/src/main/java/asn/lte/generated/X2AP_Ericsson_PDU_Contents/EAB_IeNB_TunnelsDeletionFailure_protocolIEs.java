...
public class EAB_IeNB_TunnelsDeletionFailure_protocolIEs extends Asn1SeqOf {
   ...
   public EAB_IeNB_TunnelsDeletionFailure_protocolIEs_element[] elements;

   public EAB_IeNB_TunnelsDeletionFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_IeNB_TunnelsDeletionFailure_protocolIEs (int numRecords) {
      elements = new EAB_IeNB_TunnelsDeletionFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_IeNB_TunnelsDeletionFailure_protocolIEs (EAB_IeNB_TunnelsDeletionFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_IeNB_TunnelsDeletionFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_IeNB_TunnelsDeletionFailure_protocolIEs_element();
