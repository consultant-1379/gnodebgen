...
public class OTDOACells_element_iE_Extensions extends Asn1SeqOf {
   ...
   public OTDOACells_element_iE_Extensions_element[] elements;

   public OTDOACells_element_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public OTDOACells_element_iE_Extensions (int numRecords) {
      elements = new OTDOACells_element_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public OTDOACells_element_iE_Extensions (OTDOACells_element_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new OTDOACells_element_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new OTDOACells_element_iE_Extensions_element();
