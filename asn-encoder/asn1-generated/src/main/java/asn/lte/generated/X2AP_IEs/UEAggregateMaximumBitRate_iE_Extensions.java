...
public class UEAggregateMaximumBitRate_iE_Extensions extends Asn1SeqOf {
   ...
   public UEAggregateMaximumBitRate_iE_Extensions_element[] elements;

   public UEAggregateMaximumBitRate_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEAggregateMaximumBitRate_iE_Extensions (int numRecords) {
      elements = new UEAggregateMaximumBitRate_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEAggregateMaximumBitRate_iE_Extensions (UEAggregateMaximumBitRate_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEAggregateMaximumBitRate_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEAggregateMaximumBitRate_iE_Extensions_element();
