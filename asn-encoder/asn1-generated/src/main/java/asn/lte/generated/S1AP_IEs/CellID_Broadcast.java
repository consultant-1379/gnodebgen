...
public class CellID_Broadcast extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellID-Broadcast";
   }

   public CellID_Broadcast_Item[] elements;

   public CellID_Broadcast () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellID_Broadcast (int numRecords) {
      elements = new CellID_Broadcast_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public CellID_Broadcast (CellID_Broadcast_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellID_Broadcast_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellID_Broadcast_Item();
