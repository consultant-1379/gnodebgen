...
public class SeNBModificationRequestReject_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBModificationRequestReject_protocolIEs_element[] elements;

   public SeNBModificationRequestReject_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBModificationRequestReject_protocolIEs (int numRecords) {
      elements = new SeNBModificationRequestReject_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBModificationRequestReject_protocolIEs (SeNBModificationRequestReject_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBModificationRequestReject_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBModificationRequestReject_protocolIEs_element();
