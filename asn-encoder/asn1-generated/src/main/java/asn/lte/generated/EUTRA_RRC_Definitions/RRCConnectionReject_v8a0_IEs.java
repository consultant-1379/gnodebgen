...
public class RRCConnectionReject_v8a0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionReject-v8a0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public RRCConnectionReject_v1020_IEs nonCriticalExtension;  // optional

   public RRCConnectionReject_v8a0_IEs () {
      super();
      init();
   }
   ...
   public RRCConnectionReject_v8a0_IEs (
      ...
      RRCConnectionReject_v1020_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public RRCConnectionReject_v8a0_IEs (byte[] lateNonCriticalExtension_,
      RRCConnectionReject_v1020_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new RRCConnectionReject_v1020_IEs();
