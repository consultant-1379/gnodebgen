...
public class LHN_ID extends Asn1OctetString {
    ...
    */
   public LHN_ID (byte[] data, int offset, int nbytes) {
    ...
    */
   public LHN_ID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
