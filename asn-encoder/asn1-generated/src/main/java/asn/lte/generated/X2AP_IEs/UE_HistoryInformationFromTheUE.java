...
public class UE_HistoryInformationFromTheUE extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "UE-HistoryInformationFromTheUE";
   }

   public UE_HistoryInformationFromTheUE () {
      super();
   }
    ...
    *              in binary form.
    */
   public UE_HistoryInformationFromTheUE (byte[] data) {
      super (data);
   }
    ...
    */
   public UE_HistoryInformationFromTheUE (byte[] data, int offset, int nbytes) {
    ...
    */
   public UE_HistoryInformationFromTheUE (String value_) throws Asn1ValueParseException {
      super (value_);
   }
