...
public class TAI_Cancelled extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "TAI-Cancelled";
   }

   public TAI_Cancelled_Item[] elements;

   public TAI_Cancelled () {
      elements = null;
   }
    ...
    * populated.
    */
   public TAI_Cancelled (int numRecords) {
      elements = new TAI_Cancelled_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public TAI_Cancelled (TAI_Cancelled_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TAI_Cancelled_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TAI_Cancelled_Item();
