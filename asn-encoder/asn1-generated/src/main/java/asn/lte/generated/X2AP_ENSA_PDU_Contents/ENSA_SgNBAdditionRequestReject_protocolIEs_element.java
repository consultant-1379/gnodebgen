...
public class ENSA_SgNBAdditionRequestReject_protocolIEs_element extends Asn1Seq {
   ...
   public ENSA_SgNBAdditionRequestReject_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENSA_SgNBAdditionRequestReject_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
    ...
    */
   public void setUsing_xid_Cause(asn.lte.generated.X2AP_IEs.Cause value) {
    ...
    */
   public asn.lte.generated.X2AP_IEs.Cause getValueFor_xid_Cause() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_ENSA_PDU_ContentsValues.ENSA_SgNBAdditionRequestReject_IEs.length; i++) {
         if(_X2AP_ENSA_PDU_ContentsValues.ENSA_SgNBAdditionRequestReject_IEs[i].id.equals(id)) {
            _index = _X2AP_ENSA_PDU_ContentsValues.ENSA_SgNBAdditionRequestReject_IEs[i];
            break;
         }
      }
      if (null == _index) {
