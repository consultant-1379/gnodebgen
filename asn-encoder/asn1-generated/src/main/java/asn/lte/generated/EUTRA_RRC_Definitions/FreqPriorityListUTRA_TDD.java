...
public class FreqPriorityListUTRA_TDD extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "FreqPriorityListUTRA-TDD";
   }

   public FreqPriorityUTRA_TDD[] elements;

   public FreqPriorityListUTRA_TDD () {
      elements = null;
   }
    ...
    * populated.
    */
   public FreqPriorityListUTRA_TDD (int numRecords) {
      elements = new FreqPriorityUTRA_TDD [numRecords];
   }
    ...
    * given the array.  
    */
   public FreqPriorityListUTRA_TDD (FreqPriorityUTRA_TDD[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqPriorityUTRA_TDD [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqPriorityUTRA_TDD();
