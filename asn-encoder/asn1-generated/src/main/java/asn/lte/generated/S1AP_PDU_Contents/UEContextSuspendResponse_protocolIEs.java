...
public class UEContextSuspendResponse_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextSuspendResponse_protocolIEs_element[] elements;

   public UEContextSuspendResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextSuspendResponse_protocolIEs (int numRecords) {
      elements = new UEContextSuspendResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextSuspendResponse_protocolIEs (UEContextSuspendResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextSuspendResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextSuspendResponse_protocolIEs_element();
