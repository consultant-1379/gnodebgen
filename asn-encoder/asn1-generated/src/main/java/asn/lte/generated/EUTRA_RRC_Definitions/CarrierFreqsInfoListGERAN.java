...
public class CarrierFreqsInfoListGERAN extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CarrierFreqsInfoListGERAN";
   }

   public CarrierFreqsInfoGERAN[] elements;

   public CarrierFreqsInfoListGERAN () {
      elements = null;
   }
    ...
    * populated.
    */
   public CarrierFreqsInfoListGERAN (int numRecords) {
      elements = new CarrierFreqsInfoGERAN [numRecords];
   }
    ...
    * given the array.  
    */
   public CarrierFreqsInfoListGERAN (CarrierFreqsInfoGERAN[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CarrierFreqsInfoGERAN [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CarrierFreqsInfoGERAN();
