...
public class E_RABs_ToBeReleased_SgNBChaConfList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeReleased-SgNBChaConfList";
   }

   public E_RABs_ToBeReleased_SgNBChaConfList_element[] elements;

   public E_RABs_ToBeReleased_SgNBChaConfList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeReleased_SgNBChaConfList (int numRecords) {
      elements = new E_RABs_ToBeReleased_SgNBChaConfList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeReleased_SgNBChaConfList (E_RABs_ToBeReleased_SgNBChaConfList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeReleased_SgNBChaConfList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeReleased_SgNBChaConfList_element();
