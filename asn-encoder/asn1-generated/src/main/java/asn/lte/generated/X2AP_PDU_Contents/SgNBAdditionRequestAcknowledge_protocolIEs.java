...
public class SgNBAdditionRequestAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBAdditionRequestAcknowledge_protocolIEs_element[] elements;

   public SgNBAdditionRequestAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBAdditionRequestAcknowledge_protocolIEs (int numRecords) {
      elements = new SgNBAdditionRequestAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBAdditionRequestAcknowledge_protocolIEs (SgNBAdditionRequestAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBAdditionRequestAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBAdditionRequestAcknowledge_protocolIEs_element();
