...
public class NR_PRS_MeasurementInfoList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NR-PRS-MeasurementInfoList-r16";
   }

   public NR_PRS_MeasurementInfo_r16[] elements;

   public NR_PRS_MeasurementInfoList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NR_PRS_MeasurementInfoList_r16 (int numRecords) {
      elements = new NR_PRS_MeasurementInfo_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public NR_PRS_MeasurementInfoList_r16 (NR_PRS_MeasurementInfo_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NR_PRS_MeasurementInfo_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NR_PRS_MeasurementInfo_r16();
