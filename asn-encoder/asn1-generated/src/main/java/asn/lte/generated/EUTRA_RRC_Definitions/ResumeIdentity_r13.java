...
public class ResumeIdentity_r13 extends Asn1BitString {
    ...
    */
   public ResumeIdentity_r13 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public ResumeIdentity_r13 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public ResumeIdentity_r13 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public ResumeIdentity_r13 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public ResumeIdentity_r13 (java.util.BitSet bitSet) {
      super (bitSet);
   }
