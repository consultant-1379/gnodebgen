...
public class TAIBasedQMC_iE_Extensions extends Asn1SeqOf {
   ...
   public TAIBasedQMC_iE_Extensions_element[] elements;

   public TAIBasedQMC_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TAIBasedQMC_iE_Extensions (int numRecords) {
      elements = new TAIBasedQMC_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TAIBasedQMC_iE_Extensions (TAIBasedQMC_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TAIBasedQMC_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TAIBasedQMC_iE_Extensions_element();
