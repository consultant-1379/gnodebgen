...
public class E_UTRAN_Trace_ID extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public E_UTRAN_Trace_ID (byte[] data) {
      super (data);
   }
    ...
    */
   public E_UTRAN_Trace_ID (byte[] data, int offset, int nbytes) {
    ...
    */
   public E_UTRAN_Trace_ID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
