...
public class CellActivationRequest_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-ServedCellsToActivate
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: ServedCellsToActivate
    * Java type: ServedCellsToActivate
    *
    * id: id-Ericsson-ExtConveyor
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-CellActivationRequest-ExtConveyor
    * Java type: EAB_CellActivationRequest_ExtConveyor
    */
   public Asn1Type value;

   public CellActivationRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public CellActivationRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-ServedCellsToActivate
    */
   public void setUsing_id_ServedCellsToActivate(ServedCellsToActivate value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ServedCellsToActivate);
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_CellActivationRequest_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-ServedCellsToActivate
    */
   public ServedCellsToActivate getValueFor_id_ServedCellsToActivate() {
      return (ServedCellsToActivate) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-Ericsson-ExtConveyor
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_CellActivationRequest_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_CellActivationRequest_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.CellActivationRequest_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.CellActivationRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.CellActivationRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 57) {
         indent (_sb, _level+1);
         _sb.append("id = id-ServedCellsToActivate\n");
      }
