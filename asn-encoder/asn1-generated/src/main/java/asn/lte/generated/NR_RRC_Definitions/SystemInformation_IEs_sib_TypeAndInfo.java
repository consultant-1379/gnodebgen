...
public class SystemInformation_IEs_sib_TypeAndInfo extends Asn1SeqOf {
   ...
   public SystemInformation_IEs_sib_TypeAndInfo_element[] elements;

   public SystemInformation_IEs_sib_TypeAndInfo () {
      elements = null;
   }
    ...
    * populated.
    */
   public SystemInformation_IEs_sib_TypeAndInfo (int numRecords) {
      elements = new SystemInformation_IEs_sib_TypeAndInfo_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SystemInformation_IEs_sib_TypeAndInfo (SystemInformation_IEs_sib_TypeAndInfo_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SystemInformation_IEs_sib_TypeAndInfo_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SystemInformation_IEs_sib_TypeAndInfo_element();
