...
public class UERadioPagingInformation extends Asn1Seq {
   ...
   public UERadioPagingInformation_criticalExtensions criticalExtensions;

   public UERadioPagingInformation () {
      super();
      init();
   }
    ...
    */
   public UERadioPagingInformation (
      UERadioPagingInformation_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new UERadioPagingInformation_criticalExtensions();
