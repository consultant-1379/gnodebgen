...
public class AltTTT_CellsToAddModList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AltTTT-CellsToAddModList-r12";
   }

   public AltTTT_CellsToAddMod_r12[] elements;

   public AltTTT_CellsToAddModList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AltTTT_CellsToAddModList_r12 (int numRecords) {
      elements = new AltTTT_CellsToAddMod_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public AltTTT_CellsToAddModList_r12 (AltTTT_CellsToAddMod_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AltTTT_CellsToAddMod_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AltTTT_CellsToAddMod_r12();
