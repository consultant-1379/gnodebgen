...
public class BandCombinationParameters_v1130_bandParameterList_r11 extends Asn1SeqOf {
   ...
   public BandParameters_v1130[] elements;

   public BandCombinationParameters_v1130_bandParameterList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_v1130_bandParameterList_r11 (int numRecords) {
      elements = new BandParameters_v1130 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_v1130_bandParameterList_r11 (BandParameters_v1130[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_v1130 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_v1130();
