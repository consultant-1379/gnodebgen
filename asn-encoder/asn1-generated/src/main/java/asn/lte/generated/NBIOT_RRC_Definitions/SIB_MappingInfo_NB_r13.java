...
public class SIB_MappingInfo_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SIB-MappingInfo-NB-r13";
   }

   public SIB_Type_NB_r13[] elements;

   public SIB_MappingInfo_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SIB_MappingInfo_NB_r13 (int numRecords) {
      elements = new SIB_Type_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SIB_MappingInfo_NB_r13 (SIB_Type_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SIB_Type_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         {
            int tval = SIB_Type_NB_r13.decodeEnumValue (buffer);
            elements[i] = SIB_Type_NB_r13.valueOf (tval);
         }
