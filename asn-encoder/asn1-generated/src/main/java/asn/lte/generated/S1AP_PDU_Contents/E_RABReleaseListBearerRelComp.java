...
public class E_RABReleaseListBearerRelComp extends Asn1SeqOf {
   ...
   public E_RABReleaseListBearerRelComp_element[] elements;

   public E_RABReleaseListBearerRelComp () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABReleaseListBearerRelComp (int numRecords) {
      elements = new E_RABReleaseListBearerRelComp_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABReleaseListBearerRelComp (E_RABReleaseListBearerRelComp_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABReleaseListBearerRelComp_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABReleaseListBearerRelComp_element();
