...
public class WidebandCQI_iE_Extensions extends Asn1SeqOf {
   ...
   public WidebandCQI_iE_Extensions_element[] elements;

   public WidebandCQI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public WidebandCQI_iE_Extensions (int numRecords) {
      elements = new WidebandCQI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public WidebandCQI_iE_Extensions (WidebandCQI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WidebandCQI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new WidebandCQI_iE_Extensions_element();
