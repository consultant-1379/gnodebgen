...
public class ENDCX2SetupResponse_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-RespondingNodeType-EndcX2Setup
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: RespondingNodeType-EndcX2Setup
    * Java type: RespondingNodeType_EndcX2Setup
    *
    * id: id-Ericsson-ExtConveyor
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-ENDCX2SetupResponse-ExtConveyor
    * Java type: EAB_ENDCX2SetupResponse_ExtConveyor
    */
   public Asn1Type value;

   public ENDCX2SetupResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCX2SetupResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-RespondingNodeType-EndcX2Setup
    */
   public void setUsing_id_RespondingNodeType_EndcX2Setup(RespondingNodeType_EndcX2Setup value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_RespondingNodeType_EndcX2Setup);
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_ENDCX2SetupResponse_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-RespondingNodeType-EndcX2Setup
    */
   public RespondingNodeType_EndcX2Setup getValueFor_id_RespondingNodeType_EndcX2Setup() {
      return (RespondingNodeType_EndcX2Setup) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-Ericsson-ExtConveyor
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_ENDCX2SetupResponse_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_ENDCX2SetupResponse_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCX2SetupResponse_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCX2SetupResponse_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCX2SetupResponse_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 246) {
         indent (_sb, _level+1);
         _sb.append("id = id-RespondingNodeType-EndcX2Setup\n");
      }
