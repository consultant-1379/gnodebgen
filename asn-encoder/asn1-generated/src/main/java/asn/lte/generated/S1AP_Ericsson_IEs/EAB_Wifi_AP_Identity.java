...
public class EAB_Wifi_AP_Identity extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "EAB-Wifi-AP-Identity";
   }

   public EAB_Wifi_AP_Identity () {
      super();
   }
    ...
    *              in binary form.
    */
   public EAB_Wifi_AP_Identity (byte[] data) {
      super (data);
   }
    ...
    */
   public EAB_Wifi_AP_Identity (byte[] data, int offset, int nbytes) {
    ...
    */
   public EAB_Wifi_AP_Identity (String value_) throws Asn1ValueParseException {
      super (value_);
   }
