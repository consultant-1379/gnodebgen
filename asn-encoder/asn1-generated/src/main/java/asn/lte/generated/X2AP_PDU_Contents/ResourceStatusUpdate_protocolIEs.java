...
public class ResourceStatusUpdate_protocolIEs extends Asn1SeqOf {
   ...
   public ResourceStatusUpdate_protocolIEs_element[] elements;

   public ResourceStatusUpdate_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResourceStatusUpdate_protocolIEs (int numRecords) {
      elements = new ResourceStatusUpdate_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ResourceStatusUpdate_protocolIEs (ResourceStatusUpdate_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResourceStatusUpdate_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResourceStatusUpdate_protocolIEs_element();
