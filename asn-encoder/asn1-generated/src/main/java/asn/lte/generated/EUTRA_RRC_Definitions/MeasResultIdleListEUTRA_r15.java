...
public class MeasResultIdleListEUTRA_r15 extends Asn1SeqOf {
   ...
   public MeasResultIdleEUTRA_r15[] elements;

   public MeasResultIdleListEUTRA_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultIdleListEUTRA_r15 (int numRecords) {
      elements = new MeasResultIdleEUTRA_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultIdleListEUTRA_r15 (MeasResultIdleEUTRA_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultIdleEUTRA_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultIdleEUTRA_r15();
