...
public class ResultsPerSSB_IndexList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ResultsPerSSB-IndexList-r16";
   }

   public ResultsPerSSB_IndexIdle_r16[] elements;

   public ResultsPerSSB_IndexList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResultsPerSSB_IndexList_r16 (int numRecords) {
      elements = new ResultsPerSSB_IndexIdle_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public ResultsPerSSB_IndexList_r16 (ResultsPerSSB_IndexIdle_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResultsPerSSB_IndexIdle_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResultsPerSSB_IndexIdle_r16();
