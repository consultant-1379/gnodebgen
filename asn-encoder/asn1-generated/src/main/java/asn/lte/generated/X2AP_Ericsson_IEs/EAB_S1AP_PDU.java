...
public class EAB_S1AP_PDU extends Asn1OctetString {
    ...
    */
   public EAB_S1AP_PDU (byte[] data, int offset, int nbytes) {
    ...
    */
   public EAB_S1AP_PDU (String value_) throws Asn1ValueParseException {
      super (value_);
   }
