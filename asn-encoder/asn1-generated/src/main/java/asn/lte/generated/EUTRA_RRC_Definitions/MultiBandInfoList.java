...
public class MultiBandInfoList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MultiBandInfoList";
   }

   public FreqBandIndicator[] elements;

   public MultiBandInfoList () {
      elements = null;
   }
    ...
    * populated.
    */
   public MultiBandInfoList (int numRecords) {
      elements = new FreqBandIndicator [numRecords];
   }
    ...
    * given the array.  
    */
   public MultiBandInfoList (FreqBandIndicator[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqBandIndicator [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqBandIndicator();
