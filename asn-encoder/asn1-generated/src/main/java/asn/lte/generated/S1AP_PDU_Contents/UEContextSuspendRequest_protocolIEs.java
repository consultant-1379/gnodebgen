...
public class UEContextSuspendRequest_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextSuspendRequest_protocolIEs_element[] elements;

   public UEContextSuspendRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextSuspendRequest_protocolIEs (int numRecords) {
      elements = new UEContextSuspendRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextSuspendRequest_protocolIEs (UEContextSuspendRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextSuspendRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextSuspendRequest_protocolIEs_element();
