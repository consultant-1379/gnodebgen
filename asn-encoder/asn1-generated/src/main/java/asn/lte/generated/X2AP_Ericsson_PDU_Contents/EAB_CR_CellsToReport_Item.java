...
public class EAB_CR_CellsToReport_Item extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "EAB-CR-CellsToReport-Item";
   }

   public ECGI cell_ID;
   public EAB_CR_CellsToReport_Item_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public EAB_CR_CellsToReport_Item () {
      super();
      init();
   }
   ...
   public EAB_CR_CellsToReport_Item (
      ECGI cell_ID_,
      EAB_CR_CellsToReport_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      cell_ID = cell_ID_;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new EAB_CR_CellsToReport_Item_iE_Extensions();
