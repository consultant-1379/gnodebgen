...
public class RSRPMRList extends Asn1SeqOf {
   ...
   public RSRPMRList_element[] elements;
    ...
    * populated.
    */
   public RSRPMRList (int numRecords) {
      elements = new RSRPMRList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RSRPMRList (RSRPMRList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RSRPMRList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RSRPMRList_element();
