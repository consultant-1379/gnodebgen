...
public class EAB_ElasticRAN_ULCoMP_iE_Extensions_element extends Asn1Seq {
   ...
   public EAB_ElasticRAN_ULCoMP_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_ElasticRAN_ULCoMP_iE_Extensions_element (long id_,
      EAB_CriticalityIgnore criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_ElasticRAN_ULCoMP_ExtIEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_ElasticRAN_ULCoMP_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_ElasticRAN_ULCoMP_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
