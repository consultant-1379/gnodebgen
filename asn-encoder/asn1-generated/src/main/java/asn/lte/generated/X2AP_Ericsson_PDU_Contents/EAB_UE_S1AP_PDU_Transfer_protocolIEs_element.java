...
public class EAB_UE_S1AP_PDU_Transfer_protocolIEs_element extends Asn1Seq {
    ...
    * presence: Presence.mandatory
    * ASN.1 type: EAB-S1AP-PDU
    * Java type: EAB_S1AP_PDU
    */
   public Asn1Type value;

   public EAB_UE_S1AP_PDU_Transfer_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_UE_S1AP_PDU_Transfer_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-S1AP-PDU
    */
   public void setUsing_eid_S1AP_PDU(asn.lte.generated.X2AP_Ericsson_IEs.EAB_S1AP_PDU value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_S1AP_PDU);
   ...
   /**
    * Get value of value with type set according to information object having key eid-S1AP-PDU
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_S1AP_PDU getValueFor_eid_S1AP_PDU() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_S1AP_PDU) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_PDU_ContentsValues.EAB_UE_S1AP_PDU_Transfer_IEs.length; i++) {
         if(_X2AP_Ericsson_PDU_ContentsValues.EAB_UE_S1AP_PDU_Transfer_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_PDU_ContentsValues.EAB_UE_S1AP_PDU_Transfer_IEs[i];
            break;
         }
      }
      if (null == _index) {
