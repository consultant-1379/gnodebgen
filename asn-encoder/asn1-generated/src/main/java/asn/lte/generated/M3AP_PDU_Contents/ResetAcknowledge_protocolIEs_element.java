...
public class ResetAcknowledge_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-MBMS-Service-associatedLogicalM3-ConnectionListResAck
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: MBMS-Service-associatedLogicalM3-ConnectionListResAck
    * Java type: MBMS_Service_associatedLogicalM3_ConnectionListResAck
    *
   ...
   public ResetAcknowledge_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ResetAcknowledge_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-MBMS-Service-associatedLogicalM3-ConnectionListResAck
    */
   public void setUsing_id_MBMS_Service_associatedLogicalM3_ConnectionListResAck(MBMS_Service_associatedLogicalM3_ConnectionListResAck value) {
      this.id = new asn.lte.generated.M3AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.M3AP_Constants._M3AP_ConstantsValues.id_MBMS_Service_associatedLogicalM3_ConnectionListResAck);
   ...
   /**
    * Get value of value with type set according to information object having key id-MBMS-Service-associatedLogicalM3-ConnectionListResAck
    */
   public MBMS_Service_associatedLogicalM3_ConnectionListResAck getValueFor_id_MBMS_Service_associatedLogicalM3_ConnectionListResAck() {
      return (MBMS_Service_associatedLogicalM3_ConnectionListResAck) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _M3AP_PDU_ContentsValues.ResetAcknowledgeIEs.length; i++) {
         if(_M3AP_PDU_ContentsValues.ResetAcknowledgeIEs[i].id.equals(id)) {
            _index = _M3AP_PDU_ContentsValues.ResetAcknowledgeIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 15) {
         indent (_sb, _level+1);
         _sb.append("id = id-MBMS-Service-associatedLogicalM3-ConnectionListResAck\n");
      }
      else if (id.value == 8) {
         indent (_sb, _level+1);
