...
public class EAB_ENBConfigurationUpdate_ExtConveyor_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: eid-LAA-ServedCells-ToAdd
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-LAA-ServedCells-ToAdd-List
    * Java type: EAB_LAA_ServedCells_ToAdd_List
    *
    * id: eid-LAA-ServedCells-ToMod
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-LAA-ServedCells-ToMod-List
    * Java type: EAB_LAA_ServedCells_ToMod_List
    *
    * id: eid-LAA-ServedCells-ToDel
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-LAA-ServedCells-ToDel-List
    * Java type: EAB_LAA_ServedCells_ToDel_List
    */
   public Asn1Type value;

   public EAB_ENBConfigurationUpdate_ExtConveyor_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_ENBConfigurationUpdate_ExtConveyor_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-LAA-ServedCells-ToAdd
    */
   public void setUsing_eid_LAA_ServedCells_ToAdd(EAB_LAA_ServedCells_ToAdd_List value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_LAA_ServedCells_ToAdd);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key eid-LAA-ServedCells-ToMod
    */
   public void setUsing_eid_LAA_ServedCells_ToMod(EAB_LAA_ServedCells_ToMod_List value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_LAA_ServedCells_ToMod);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key eid-LAA-ServedCells-ToDel
    */
   public void setUsing_eid_LAA_ServedCells_ToDel(EAB_LAA_ServedCells_ToDel_List value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_LAA_ServedCells_ToDel);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key eid-LAA-ServedCells-ToAdd
    */
   public EAB_LAA_ServedCells_ToAdd_List getValueFor_eid_LAA_ServedCells_ToAdd() {
      return (EAB_LAA_ServedCells_ToAdd_List) this.value;
   }

   /**
    * Get value of value with type set according to information object having key eid-LAA-ServedCells-ToMod
    */
   public EAB_LAA_ServedCells_ToMod_List getValueFor_eid_LAA_ServedCells_ToMod() {
      return (EAB_LAA_ServedCells_ToMod_List) this.value;
   }

   /**
    * Get value of value with type set according to information object having key eid-LAA-ServedCells-ToDel
    */
   public EAB_LAA_ServedCells_ToDel_List getValueFor_eid_LAA_ServedCells_ToDel() {
      return (EAB_LAA_ServedCells_ToDel_List) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_ENBConfigurationUpdate_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_ENBConfigurationUpdate_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_ENBConfigurationUpdate_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 4165) {
         indent (_sb, _level+1);
         _sb.append("id = eid-LAA-ServedCells-ToAdd\n");
      }
      else if (id.value == 4166) {
         indent (_sb, _level+1);
         _sb.append("id = eid-LAA-ServedCells-ToMod\n");
      }
      else if (id.value == 4167) {
         indent (_sb, _level+1);
         _sb.append("id = eid-LAA-ServedCells-ToDel\n");
      }
