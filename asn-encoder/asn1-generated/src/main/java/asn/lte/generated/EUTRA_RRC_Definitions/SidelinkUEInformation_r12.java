...
public class SidelinkUEInformation_r12 extends Asn1Seq {
   ...
   public SidelinkUEInformation_r12_criticalExtensions criticalExtensions;

   public SidelinkUEInformation_r12 () {
      super();
      init();
   }
    ...
    */
   public SidelinkUEInformation_r12 (
      SidelinkUEInformation_r12_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new SidelinkUEInformation_r12_criticalExtensions();
