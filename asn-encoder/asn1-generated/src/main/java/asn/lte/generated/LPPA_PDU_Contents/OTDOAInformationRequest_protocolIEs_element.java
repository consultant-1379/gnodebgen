...
public class OTDOAInformationRequest_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: OTDOA-Information-Type
    * Java type: OTDOA_Information_Type
    */
   public Asn1Type value;

   public OTDOAInformationRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public OTDOAInformationRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-OTDOA-Information-Type-Group
    */
   public void setUsing_id_OTDOA_Information_Type_Group(OTDOA_Information_Type value) {
      this.id = new asn.lte.generated.LPPA_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.LPPA_Constants._LPPA_ConstantsValues.id_OTDOA_Information_Type_Group);
      this.criticality = asn.lte.generated.LPPA_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-OTDOA-Information-Type-Group
    */
   public OTDOA_Information_Type getValueFor_id_OTDOA_Information_Type_Group() {
      return (OTDOA_Information_Type) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _LPPA_PDU_ContentsValues.OTDOAInformationRequest_IEs.length; i++) {
         if(_LPPA_PDU_ContentsValues.OTDOAInformationRequest_IEs[i].id.equals(id)) {
            _index = _LPPA_PDU_ContentsValues.OTDOAInformationRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 9) {
         indent (_sb, _level+1);
         _sb.append("id = id-OTDOA-Information-Type-Group\n");
      }
