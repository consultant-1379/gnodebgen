...
public class CRS_AssistanceInfoList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CRS-AssistanceInfoList-r15";
   }

   public CRS_AssistanceInfo_r15[] elements;

   public CRS_AssistanceInfoList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CRS_AssistanceInfoList_r15 (int numRecords) {
      elements = new CRS_AssistanceInfo_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public CRS_AssistanceInfoList_r15 (CRS_AssistanceInfo_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CRS_AssistanceInfo_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CRS_AssistanceInfo_r15();
