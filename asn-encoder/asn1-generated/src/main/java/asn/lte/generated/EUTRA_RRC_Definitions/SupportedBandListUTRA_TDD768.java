...
public class SupportedBandListUTRA_TDD768 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandListUTRA-TDD768";
   }

   public SupportedBandUTRA_TDD768[] elements;

   public SupportedBandListUTRA_TDD768 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandListUTRA_TDD768 (int numRecords) {
      elements = new SupportedBandUTRA_TDD768 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandListUTRA_TDD768 (SupportedBandUTRA_TDD768[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBandUTRA_TDD768 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         {
            int tval = SupportedBandUTRA_TDD768.decodeEnumValue (buffer);
            elements[i] = SupportedBandUTRA_TDD768.valueOf (tval);
         }
