...
public class TrackingAreaCode extends Asn1BitString {
    ...
    */
   public TrackingAreaCode (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public TrackingAreaCode (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public TrackingAreaCode (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public TrackingAreaCode (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public TrackingAreaCode (java.util.BitSet bitSet) {
      super (bitSet);
   }
