...
public class NRUESecurityCapabilities_iE_Extensions extends Asn1SeqOf {
   ...
   public NRUESecurityCapabilities_iE_Extensions_element[] elements;

   public NRUESecurityCapabilities_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public NRUESecurityCapabilities_iE_Extensions (int numRecords) {
      elements = new NRUESecurityCapabilities_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public NRUESecurityCapabilities_iE_Extensions (NRUESecurityCapabilities_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NRUESecurityCapabilities_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NRUESecurityCapabilities_iE_Extensions_element();
