...
public class Key_eNodeB_Star extends Asn1BitString {
    ...
    */
   public Key_eNodeB_Star (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public Key_eNodeB_Star (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public Key_eNodeB_Star (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public Key_eNodeB_Star (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public Key_eNodeB_Star (java.util.BitSet bitSet) {
      super (bitSet);
   }
