...
public class SL_FailureList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-FailureList-r16";
   }

   public SL_Failure_r16[] elements;

   public SL_FailureList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_FailureList_r16 (int numRecords) {
      elements = new SL_Failure_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_FailureList_r16 (SL_Failure_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_Failure_r16 [numElements];
