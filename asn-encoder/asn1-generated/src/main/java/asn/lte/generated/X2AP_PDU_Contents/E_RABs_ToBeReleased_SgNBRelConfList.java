...
public class E_RABs_ToBeReleased_SgNBRelConfList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeReleased-SgNBRelConfList";
   }

   public E_RABs_ToBeReleased_SgNBRelConfList_element[] elements;

   public E_RABs_ToBeReleased_SgNBRelConfList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeReleased_SgNBRelConfList (int numRecords) {
      elements = new E_RABs_ToBeReleased_SgNBRelConfList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeReleased_SgNBRelConfList (E_RABs_ToBeReleased_SgNBRelConfList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeReleased_SgNBRelConfList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeReleased_SgNBRelConfList_element();
