...
public class E_RABs_ToBeReleased_SgNBRelReqList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeReleased-SgNBRelReqList";
   }

   public E_RABs_ToBeReleased_SgNBRelReqList_element[] elements;

   public E_RABs_ToBeReleased_SgNBRelReqList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeReleased_SgNBRelReqList (int numRecords) {
      elements = new E_RABs_ToBeReleased_SgNBRelReqList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeReleased_SgNBRelReqList (E_RABs_ToBeReleased_SgNBRelReqList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeReleased_SgNBRelReqList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeReleased_SgNBRelReqList_element();
