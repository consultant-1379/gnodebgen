...
public class SystemInformationBlockType6_carrierFreqListUTRA_TDD_v1250 extends Asn1SeqOf {
   ...
   public CarrierFreqInfoUTRA_v1250[] elements;

   public SystemInformationBlockType6_carrierFreqListUTRA_TDD_v1250 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SystemInformationBlockType6_carrierFreqListUTRA_TDD_v1250 (int numRecords) {
      elements = new CarrierFreqInfoUTRA_v1250 [numRecords];
   }
    ...
    * given the array.  
    */
   public SystemInformationBlockType6_carrierFreqListUTRA_TDD_v1250 (CarrierFreqInfoUTRA_v1250[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CarrierFreqInfoUTRA_v1250 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CarrierFreqInfoUTRA_v1250();
