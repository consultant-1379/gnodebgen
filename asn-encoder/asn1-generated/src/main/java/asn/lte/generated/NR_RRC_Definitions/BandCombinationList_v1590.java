...
public class BandCombinationList_v1590 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandCombinationList-v1590";
   }

   public BandCombination_v1590[] elements;

   public BandCombinationList_v1590 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationList_v1590 (int numRecords) {
      elements = new BandCombination_v1590 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationList_v1590 (BandCombination_v1590[] elements_) {
      elements = elements_;
   }
   ...
   {
      int fraglen = 0;
      java.util.LinkedList<BandCombination_v1590> tmplist = 
         new java.util.LinkedList<BandCombination_v1590>();
      BandCombination_v1590 value;
      ...
      for (;;) {
         ...
         for (int i = 0; i < fraglen; i++) {
            ...
            value = new BandCombination_v1590();
            value.decode (buffer);
      ...
      elements = new BandCombination_v1590 [tmplist.size()];
