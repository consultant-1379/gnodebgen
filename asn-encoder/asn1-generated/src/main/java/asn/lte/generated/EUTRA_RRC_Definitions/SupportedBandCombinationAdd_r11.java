...
public class SupportedBandCombinationAdd_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombinationAdd-r11";
   }

   public BandCombinationParameters_r11[] elements;

   public SupportedBandCombinationAdd_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombinationAdd_r11 (int numRecords) {
      elements = new BandCombinationParameters_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandCombinationAdd_r11 (BandCombinationParameters_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandCombinationParameters_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandCombinationParameters_r11();
