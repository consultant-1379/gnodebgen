...
public class RecommendedENBList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RecommendedENBList";
   }

   public RecommendedENBList_element[] elements;

   public RecommendedENBList () {
      elements = null;
   }
    ...
    * populated.
    */
   public RecommendedENBList (int numRecords) {
      elements = new RecommendedENBList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RecommendedENBList (RecommendedENBList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RecommendedENBList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RecommendedENBList_element();
