...
public class HandoverRestrictionList_iE_Extensions extends Asn1SeqOf {
   ...
   public HandoverRestrictionList_iE_Extensions_element[] elements;

   public HandoverRestrictionList_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public HandoverRestrictionList_iE_Extensions (int numRecords) {
      elements = new HandoverRestrictionList_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public HandoverRestrictionList_iE_Extensions (HandoverRestrictionList_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HandoverRestrictionList_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new HandoverRestrictionList_iE_Extensions_element();
