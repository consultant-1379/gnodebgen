...
public class Paging_v890_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "Paging-v890-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public Paging_v920_IEs nonCriticalExtension;  // optional

   public Paging_v890_IEs () {
      super();
      init();
   }
   ...
   public Paging_v890_IEs (
      ...
      Paging_v920_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public Paging_v890_IEs (byte[] lateNonCriticalExtension_,
      Paging_v920_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new Paging_v920_IEs();
