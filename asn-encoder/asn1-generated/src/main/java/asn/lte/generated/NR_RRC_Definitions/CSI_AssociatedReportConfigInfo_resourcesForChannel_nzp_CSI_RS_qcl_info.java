...
public class CSI_AssociatedReportConfigInfo_resourcesForChannel_nzp_CSI_RS_qcl_info extends Asn1SeqOf {
   ...
   public TCI_StateId[] elements;

   public CSI_AssociatedReportConfigInfo_resourcesForChannel_nzp_CSI_RS_qcl_info () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_AssociatedReportConfigInfo_resourcesForChannel_nzp_CSI_RS_qcl_info (int numRecords) {
      elements = new TCI_StateId [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_AssociatedReportConfigInfo_resourcesForChannel_nzp_CSI_RS_qcl_info (TCI_StateId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TCI_StateId [numElements];
