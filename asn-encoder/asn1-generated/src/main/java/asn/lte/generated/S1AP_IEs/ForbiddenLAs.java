...
public class ForbiddenLAs extends Asn1SeqOf {
   ...
   public ForbiddenLAs_Item[] elements;
    ...
    * populated.
    */
   public ForbiddenLAs (int numRecords) {
      elements = new ForbiddenLAs_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ForbiddenLAs (ForbiddenLAs_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ForbiddenLAs_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ForbiddenLAs_Item();
