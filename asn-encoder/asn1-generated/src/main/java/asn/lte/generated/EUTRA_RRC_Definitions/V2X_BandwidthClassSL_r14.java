...
public class V2X_BandwidthClassSL_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "V2X-BandwidthClassSL-r14";
   }

   public V2X_BandwidthClass_r14[] elements;

   public V2X_BandwidthClassSL_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public V2X_BandwidthClassSL_r14 (int numRecords) {
      elements = new V2X_BandwidthClass_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public V2X_BandwidthClassSL_r14 (V2X_BandwidthClass_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new V2X_BandwidthClass_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         {
            int tval = V2X_BandwidthClass_r14.decodeEnumValue (buffer);
            elements[i] = V2X_BandwidthClass_r14.valueOf (tval);
         }
