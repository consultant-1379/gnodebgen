...
public class FeatureSetDL_r15_featureSetPerCC_ListDL_r15 extends Asn1SeqOf {
   ...
   public FeatureSetDL_PerCC_Id_r15[] elements;

   public FeatureSetDL_r15_featureSetPerCC_ListDL_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSetDL_r15_featureSetPerCC_ListDL_r15 (int numRecords) {
      elements = new FeatureSetDL_PerCC_Id_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSetDL_r15_featureSetPerCC_ListDL_r15 (FeatureSetDL_PerCC_Id_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetDL_PerCC_Id_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetDL_PerCC_Id_r15();
