...
public class EUTRA_RSTD_InfoList extends Asn1SeqOf {
   ...
   public EUTRA_RSTD_Info[] elements;

   public EUTRA_RSTD_InfoList () {
      elements = null;
   }
    ...
    * populated.
    */
   public EUTRA_RSTD_InfoList (int numRecords) {
      elements = new EUTRA_RSTD_Info [numRecords];
   }
    ...
    * given the array.  
    */
   public EUTRA_RSTD_InfoList (EUTRA_RSTD_Info[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EUTRA_RSTD_Info [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EUTRA_RSTD_Info();
