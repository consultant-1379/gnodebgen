...
public class MMEC extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public MMEC (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    *
    */
   public MMEC (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public MMEC (java.util.BitSet bitSet) {
      super (bitSet);
   }
