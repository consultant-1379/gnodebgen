...
public class E_RABs_Admitted_ToReleased_SgNBModAck_Item extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-Admitted-ToReleased-SgNBModAck-Item";
   }

   public E_RAB_ID e_RAB_ID;
   public EN_DC_ResourceConfiguration en_DC_ResourceConfiguration;
   public E_RABs_Admitted_ToReleased_SgNBModAck_Item_resource_configuration resource_configuration;
   public E_RABs_Admitted_ToReleased_SgNBModAck_Item_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public E_RABs_Admitted_ToReleased_SgNBModAck_Item () {
      super();
      init();
   }
   ...
   public E_RABs_Admitted_ToReleased_SgNBModAck_Item (
      ...
      E_RABs_Admitted_ToReleased_SgNBModAck_Item_resource_configuration resource_configuration_,
      E_RABs_Admitted_ToReleased_SgNBModAck_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      e_RAB_ID = e_RAB_ID_;
      en_DC_ResourceConfiguration = en_DC_ResourceConfiguration_;
    ...
    * the given objects 
    */
   public E_RABs_Admitted_ToReleased_SgNBModAck_Item (long e_RAB_ID_,
      EN_DC_ResourceConfiguration en_DC_ResourceConfiguration_,
      E_RABs_Admitted_ToReleased_SgNBModAck_Item_resource_configuration resource_configuration_,
      E_RABs_Admitted_ToReleased_SgNBModAck_Item_iE_Extensions iE_Extensions_
   ) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      resource_configuration = new E_RABs_Admitted_ToReleased_SgNBModAck_Item_resource_configuration();
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new E_RABs_Admitted_ToReleased_SgNBModAck_Item_iE_Extensions();
