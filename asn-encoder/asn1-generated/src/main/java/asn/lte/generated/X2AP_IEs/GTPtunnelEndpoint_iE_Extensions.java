...
public class GTPtunnelEndpoint_iE_Extensions extends Asn1SeqOf {
   ...
   public GTPtunnelEndpoint_iE_Extensions_element[] elements;

   public GTPtunnelEndpoint_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public GTPtunnelEndpoint_iE_Extensions (int numRecords) {
      elements = new GTPtunnelEndpoint_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public GTPtunnelEndpoint_iE_Extensions (GTPtunnelEndpoint_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GTPtunnelEndpoint_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GTPtunnelEndpoint_iE_Extensions_element();
