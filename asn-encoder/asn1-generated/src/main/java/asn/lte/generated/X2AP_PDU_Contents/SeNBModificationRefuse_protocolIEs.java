...
public class SeNBModificationRefuse_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBModificationRefuse_protocolIEs_element[] elements;

   public SeNBModificationRefuse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBModificationRefuse_protocolIEs (int numRecords) {
      elements = new SeNBModificationRefuse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBModificationRefuse_protocolIEs (SeNBModificationRefuse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBModificationRefuse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBModificationRefuse_protocolIEs_element();
