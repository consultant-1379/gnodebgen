...
public class E_RABUsageReportList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABUsageReportList";
   }

   public E_RABUsageReportList_element[] elements;

   public E_RABUsageReportList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABUsageReportList (int numRecords) {
      elements = new E_RABUsageReportList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABUsageReportList (E_RABUsageReportList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABUsageReportList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABUsageReportList_element();
