...
public class SCG_Config_v12x0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SCG-Config-v12x0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public SCG_Config_v13c0_IEs nonCriticalExtension;  // optional

   public SCG_Config_v12x0_IEs () {
      super();
      init();
   }
   ...
   public SCG_Config_v12x0_IEs (
      ...
      SCG_Config_v13c0_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public SCG_Config_v12x0_IEs (byte[] lateNonCriticalExtension_,
      SCG_Config_v13c0_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new SCG_Config_v13c0_IEs();
