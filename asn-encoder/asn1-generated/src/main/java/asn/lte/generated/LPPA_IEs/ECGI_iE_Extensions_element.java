...
public class ECGI_iE_Extensions_element extends Asn1Seq {
   ...
   public ECGI_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ECGI_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _LPPA_IEsValues.ECGI_ExtIEs.length; i++) {
         if(_LPPA_IEsValues.ECGI_ExtIEs[i].id.equals(id)) {
            _index = _LPPA_IEsValues.ECGI_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
