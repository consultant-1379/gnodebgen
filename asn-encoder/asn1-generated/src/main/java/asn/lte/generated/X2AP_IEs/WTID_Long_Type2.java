...
public class WTID_Long_Type2 extends Asn1BitString {
    ...
    */
   public WTID_Long_Type2 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public WTID_Long_Type2 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public WTID_Long_Type2 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public WTID_Long_Type2 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public WTID_Long_Type2 (java.util.BitSet bitSet) {
      super (bitSet);
   }
