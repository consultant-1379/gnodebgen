...
public class CoMPHypothesisSet extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CoMPHypothesisSet";
   }

   public CoMPHypothesisSetItem[] elements;

   public CoMPHypothesisSet () {
      elements = null;
   }
    ...
    * populated.
    */
   public CoMPHypothesisSet (int numRecords) {
      elements = new CoMPHypothesisSetItem [numRecords];
   }
    ...
    * given the array.  
    */
   public CoMPHypothesisSet (CoMPHypothesisSetItem[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CoMPHypothesisSetItem [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CoMPHypothesisSetItem();
