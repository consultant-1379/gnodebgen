...
public class CSIReportPerCSIProcessItem extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSIReportPerCSIProcessItem";
   }

   public CSIReportPerCSIProcessItem_element[] elements;

   public CSIReportPerCSIProcessItem () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSIReportPerCSIProcessItem (int numRecords) {
      elements = new CSIReportPerCSIProcessItem_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CSIReportPerCSIProcessItem (CSIReportPerCSIProcessItem_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSIReportPerCSIProcessItem_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSIReportPerCSIProcessItem_element();
