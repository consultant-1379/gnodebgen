...
public class CSI_RS_ConfigNZPToAddModListExt_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSI-RS-ConfigNZPToAddModListExt-r13";
   }

   public CSI_RS_ConfigNZP_r11[] elements;

   public CSI_RS_ConfigNZPToAddModListExt_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_ConfigNZPToAddModListExt_r13 (int numRecords) {
    ...
    * given the array.  
    */
   public CSI_RS_ConfigNZPToAddModListExt_r13 (CSI_RS_ConfigNZP_r11[] elements_) {
      elements = elements_;
   }
