...
public class EAB_eNB_FeatureProperties_Undefined_element extends Asn1Seq {
   ...
   public EAB_eNB_FeatureProperties_Undefined_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_eNB_FeatureProperties_Undefined_element (long id_,
      EAB_CriticalityIgnore criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_CommonDataTypesValues.EAB_eNB_FeatureProperties_Undefined_IEs.length; i++) {
         if(_X2AP_Ericsson_CommonDataTypesValues.EAB_eNB_FeatureProperties_Undefined_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_CommonDataTypesValues.EAB_eNB_FeatureProperties_Undefined_IEs[i];
            break;
         }
      }
      if (null == _index) {
