...
public class E_RAB_Level_QoS_Parameters_iE_Extensions_element extends Asn1Seq {
   ...
   public E_RAB_Level_QoS_Parameters_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RAB_Level_QoS_Parameters_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   public void setUsing_id_DownlinkPacketLossRate(Packet_LossRate extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_DownlinkPacketLossRate);
   ...
   public void setUsing_id_UplinkPacketLossRate(Packet_LossRate extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_UplinkPacketLossRate);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.E_RAB_Level_QoS_Parameters_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.E_RAB_Level_QoS_Parameters_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.E_RAB_Level_QoS_Parameters_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
