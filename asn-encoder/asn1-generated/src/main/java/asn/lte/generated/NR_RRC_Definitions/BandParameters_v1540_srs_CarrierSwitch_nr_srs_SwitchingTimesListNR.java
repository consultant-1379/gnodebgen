...
public class BandParameters_v1540_srs_CarrierSwitch_nr_srs_SwitchingTimesListNR extends Asn1SeqOf {
   ...
   public SRS_SwitchingTimeNR[] elements;

   public BandParameters_v1540_srs_CarrierSwitch_nr_srs_SwitchingTimesListNR () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandParameters_v1540_srs_CarrierSwitch_nr_srs_SwitchingTimesListNR (int numRecords) {
      elements = new SRS_SwitchingTimeNR [numRecords];
   }
    ...
    * given the array.  
    */
   public BandParameters_v1540_srs_CarrierSwitch_nr_srs_SwitchingTimesListNR (SRS_SwitchingTimeNR[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRS_SwitchingTimeNR [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRS_SwitchingTimeNR();
