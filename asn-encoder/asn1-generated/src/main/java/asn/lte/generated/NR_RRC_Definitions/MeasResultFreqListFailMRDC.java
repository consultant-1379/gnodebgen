...
public class MeasResultFreqListFailMRDC extends Asn1SeqOf {
   ...
   public MeasResultFreqListFailMRDC () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultFreqListFailMRDC (int numRecords) {
    ...
    * given the array.  
    */
   public MeasResultFreqListFailMRDC (MeasResult2EUTRA[] elements_) {
      elements = elements_;
   }
