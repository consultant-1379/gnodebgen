...
public class TAG_Config_tag_ToReleaseList extends Asn1SeqOf {
   ...
   public TAG_Id[] elements;

   public TAG_Config_tag_ToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public TAG_Config_tag_ToReleaseList (int numRecords) {
      elements = new TAG_Id [numRecords];
   }
    ...
    * given the array.  
    */
   public TAG_Config_tag_ToReleaseList (TAG_Id[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TAG_Id [numElements];
