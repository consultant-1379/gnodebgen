...
public class E_RABInformationList extends Asn1SeqOf {
   ...
   public E_RABInformationList_element[] elements;

   public E_RABInformationList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABInformationList (int numRecords) {
      elements = new E_RABInformationList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABInformationList (E_RABInformationList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABInformationList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABInformationList_element();
