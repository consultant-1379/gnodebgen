...
public class M4Configuration_iE_Extensions extends Asn1SeqOf {
   ...
   public M4Configuration_iE_Extensions_element[] elements;

   public M4Configuration_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public M4Configuration_iE_Extensions (int numRecords) {
      elements = new M4Configuration_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public M4Configuration_iE_Extensions (M4Configuration_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new M4Configuration_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new M4Configuration_iE_Extensions_element();
