...
public class UEContextReleaseComplete_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: UserLocationInformation
    * Java type: UserLocationInformation
    *
    * id: id-InformationOnRecommendedCellsAndENBsForPaging
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: InformationOnRecommendedCellsAndENBsForPaging
    * Java type: InformationOnRecommendedCellsAndENBsForPaging
    *
    * id: id-CellIdentifierAndCELevelForCECapableUEs
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: CellIdentifierAndCELevelForCECapableUEs
    * Java type: CellIdentifierAndCELevelForCECapableUEs
    *
   ...
   public UEContextReleaseComplete_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UEContextReleaseComplete_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-UserLocationInformation
    */
   public void setUsing_id_UserLocationInformation(asn.lte.generated.S1AP_IEs.UserLocationInformation value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_UserLocationInformation);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-InformationOnRecommendedCellsAndENBsForPaging
    */
   public void setUsing_id_InformationOnRecommendedCellsAndENBsForPaging(asn.lte.generated.S1AP_IEs.InformationOnRecommendedCellsAndENBsForPaging value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_InformationOnRecommendedCellsAndENBsForPaging);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-CellIdentifierAndCELevelForCECapableUEs
    */
   public void setUsing_id_CellIdentifierAndCELevelForCECapableUEs(asn.lte.generated.S1AP_IEs.CellIdentifierAndCELevelForCECapableUEs value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_CellIdentifierAndCELevelForCECapableUEs);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-UserLocationInformation
    */
   public asn.lte.generated.S1AP_IEs.UserLocationInformation getValueFor_id_UserLocationInformation() {
      return (asn.lte.generated.S1AP_IEs.UserLocationInformation) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-InformationOnRecommendedCellsAndENBsForPaging
    */
   public asn.lte.generated.S1AP_IEs.InformationOnRecommendedCellsAndENBsForPaging getValueFor_id_InformationOnRecommendedCellsAndENBsForPaging() {
      return (asn.lte.generated.S1AP_IEs.InformationOnRecommendedCellsAndENBsForPaging) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-CellIdentifierAndCELevelForCECapableUEs
    */
   public asn.lte.generated.S1AP_IEs.CellIdentifierAndCELevelForCECapableUEs getValueFor_id_CellIdentifierAndCELevelForCECapableUEs() {
      return (asn.lte.generated.S1AP_IEs.CellIdentifierAndCELevelForCECapableUEs) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.UEContextReleaseComplete_IEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.UEContextReleaseComplete_IEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.UEContextReleaseComplete_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 189) {
         indent (_sb, _level+1);
         _sb.append("id = id-UserLocationInformation\n");
      }
      else if (id.value == 213) {
         indent (_sb, _level+1);
         _sb.append("id = id-InformationOnRecommendedCellsAndENBsForPaging\n");
      }
      else if (id.value == 212) {
         indent (_sb, _level+1);
         _sb.append("id = id-CellIdentifierAndCELevelForCECapableUEs\n");
      }
