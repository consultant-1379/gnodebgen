...
public class RSRPMeasurementResult_element_iE_Extensions extends Asn1SeqOf {
   ...
   public RSRPMeasurementResult_element_iE_Extensions_element[] elements;

   public RSRPMeasurementResult_element_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RSRPMeasurementResult_element_iE_Extensions (int numRecords) {
      elements = new RSRPMeasurementResult_element_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RSRPMeasurementResult_element_iE_Extensions (RSRPMeasurementResult_element_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RSRPMeasurementResult_element_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RSRPMeasurementResult_element_iE_Extensions_element();
