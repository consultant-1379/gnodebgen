...
public class GNBStatusIndication_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-GNBOverloadInformation
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: GNBOverloadInformation
    * Java type: GNBOverloadInformation
    *
   ...
   public GNBStatusIndication_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public GNBStatusIndication_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-GNBOverloadInformation
    */
   public void setUsing_id_GNBOverloadInformation(asn.lte.generated.X2AP_IEs.GNBOverloadInformation value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_GNBOverloadInformation);
   ...
   /**
    * Get value of value with type set according to information object having key id-GNBOverloadInformation
    */
   public asn.lte.generated.X2AP_IEs.GNBOverloadInformation getValueFor_id_GNBOverloadInformation() {
      return (asn.lte.generated.X2AP_IEs.GNBOverloadInformation) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.GNBStatusIndicationIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.GNBStatusIndicationIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.GNBStatusIndicationIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 310) {
         indent (_sb, _level+1);
         _sb.append("id = id-GNBOverloadInformation\n");
      }
