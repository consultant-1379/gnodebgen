...
public class RRCConnectionResumeRequest_r13 extends Asn1Seq {
   ...
   public RRCConnectionResumeRequest_r13_criticalExtensions criticalExtensions;

   public RRCConnectionResumeRequest_r13 () {
      super();
      init();
   }
    ...
    */
   public RRCConnectionResumeRequest_r13 (
      RRCConnectionResumeRequest_r13_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionResumeRequest_r13_criticalExtensions();
