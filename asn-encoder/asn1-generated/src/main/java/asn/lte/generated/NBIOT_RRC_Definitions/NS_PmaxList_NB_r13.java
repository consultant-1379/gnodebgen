...
public class NS_PmaxList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NS-PmaxList-NB-r13";
   }

   public NS_PmaxValue_NB_r13[] elements;

   public NS_PmaxList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NS_PmaxList_NB_r13 (int numRecords) {
      elements = new NS_PmaxValue_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public NS_PmaxList_NB_r13 (NS_PmaxValue_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NS_PmaxValue_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NS_PmaxValue_NB_r13();
