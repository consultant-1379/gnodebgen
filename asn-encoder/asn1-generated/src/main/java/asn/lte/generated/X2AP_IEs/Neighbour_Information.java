...
public class Neighbour_Information extends Asn1SeqOf {
   ...
   public Neighbour_Information_element[] elements;

   public Neighbour_Information () {
      elements = null;
   }
    ...
    * populated.
    */
   public Neighbour_Information (int numRecords) {
      elements = new Neighbour_Information_element [numRecords];
   }
    ...
    * given the array.  
    */
   public Neighbour_Information (Neighbour_Information_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (0, 512);
      int numElements = (int) buffer.decodeLength();

      elements = new Neighbour_Information_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Neighbour_Information_element();
