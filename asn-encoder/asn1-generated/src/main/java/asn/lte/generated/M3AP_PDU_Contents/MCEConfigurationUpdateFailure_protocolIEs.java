...
public class MCEConfigurationUpdateFailure_protocolIEs extends Asn1SeqOf {
   ...
   public MCEConfigurationUpdateFailure_protocolIEs_element[] elements;

   public MCEConfigurationUpdateFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MCEConfigurationUpdateFailure_protocolIEs (int numRecords) {
      elements = new MCEConfigurationUpdateFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MCEConfigurationUpdateFailure_protocolIEs (MCEConfigurationUpdateFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MCEConfigurationUpdateFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MCEConfigurationUpdateFailure_protocolIEs_element();
