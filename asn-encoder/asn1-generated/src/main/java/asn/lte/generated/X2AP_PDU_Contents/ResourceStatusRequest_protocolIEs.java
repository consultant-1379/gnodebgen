...
public class ResourceStatusRequest_protocolIEs extends Asn1SeqOf {
   ...
   public ResourceStatusRequest_protocolIEs_element[] elements;

   public ResourceStatusRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResourceStatusRequest_protocolIEs (int numRecords) {
      elements = new ResourceStatusRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ResourceStatusRequest_protocolIEs (ResourceStatusRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResourceStatusRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResourceStatusRequest_protocolIEs_element();
