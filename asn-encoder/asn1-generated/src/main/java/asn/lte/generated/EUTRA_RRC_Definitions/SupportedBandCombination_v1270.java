...
public class SupportedBandCombination_v1270 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-v1270";
   }

   public BandCombinationParameters_v1270[] elements;

   public SupportedBandCombination_v1270 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_v1270 (int numRecords) {
    ...
    * given the array.  
    */
   public SupportedBandCombination_v1270 (BandCombinationParameters_v1270[] elements_) {
      elements = elements_;
   }
