...
public class TAIListForRestart extends Asn1SeqOf {
    ...
    * populated.
    */
   public TAIListForRestart (int numRecords) {
      elements = new TAI [numRecords];
   }
    ...
    * given the array.  
    */
   public TAIListForRestart (TAI[] elements_) {
      elements = elements_;
   }
