...
public class ErrorIndication_protocolIEs extends Asn1SeqOf {
   ...
   public ErrorIndication_protocolIEs_element[] elements;

   public ErrorIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ErrorIndication_protocolIEs (int numRecords) {
      elements = new ErrorIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ErrorIndication_protocolIEs (ErrorIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ErrorIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ErrorIndication_protocolIEs_element();
