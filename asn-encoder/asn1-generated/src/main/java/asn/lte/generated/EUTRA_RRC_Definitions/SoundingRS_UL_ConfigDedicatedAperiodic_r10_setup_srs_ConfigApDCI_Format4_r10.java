...
public class SoundingRS_UL_ConfigDedicatedAperiodic_r10_setup_srs_ConfigApDCI_Format4_r10 extends Asn1SeqOf {
   ...
   public SRS_ConfigAp_r10[] elements;

   public SoundingRS_UL_ConfigDedicatedAperiodic_r10_setup_srs_ConfigApDCI_Format4_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SoundingRS_UL_ConfigDedicatedAperiodic_r10_setup_srs_ConfigApDCI_Format4_r10 (int numRecords) {
      elements = new SRS_ConfigAp_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public SoundingRS_UL_ConfigDedicatedAperiodic_r10_setup_srs_ConfigApDCI_Format4_r10 (SRS_ConfigAp_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRS_ConfigAp_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRS_ConfigAp_r10();
