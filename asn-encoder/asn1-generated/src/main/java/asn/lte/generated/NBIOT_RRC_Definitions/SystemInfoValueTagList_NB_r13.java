...
import asn.lte.generated.EUTRA_RRC_Definitions.SystemInfoValueTagSI_r13;

public class SystemInfoValueTagList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SystemInfoValueTagList-NB-r13";
   }

   public SystemInfoValueTagSI_r13[] elements;

   public SystemInfoValueTagList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SystemInfoValueTagList_NB_r13 (int numRecords) {
      elements = new SystemInfoValueTagSI_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SystemInfoValueTagList_NB_r13 (SystemInfoValueTagSI_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SystemInfoValueTagSI_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SystemInfoValueTagSI_r13();
