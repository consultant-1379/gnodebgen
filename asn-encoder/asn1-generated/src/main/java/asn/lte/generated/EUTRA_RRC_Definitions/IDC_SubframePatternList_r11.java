...
public class IDC_SubframePatternList_r11 extends Asn1SeqOf {
   ...
   public IDC_SubframePattern_r11[] elements;

   public IDC_SubframePatternList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public IDC_SubframePatternList_r11 (int numRecords) {
      elements = new IDC_SubframePattern_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public IDC_SubframePatternList_r11 (IDC_SubframePattern_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new IDC_SubframePattern_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new IDC_SubframePattern_r11();
