...
public class PUCCH_PathlossReferenceRS_referenceSignal extends Asn1Choice {
   ...
   public PUCCH_PathlossReferenceRS_referenceSignal () {
      super();
   }

   public PUCCH_PathlossReferenceRS_referenceSignal (byte choiceId_, Asn1Type element_) {
      super();
