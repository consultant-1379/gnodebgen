...
public class CellsToAddModListUTRA_TDD extends Asn1SeqOf {
   ...
   public CellsToAddModUTRA_TDD[] elements;

   public CellsToAddModListUTRA_TDD () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellsToAddModListUTRA_TDD (int numRecords) {
      elements = new CellsToAddModUTRA_TDD [numRecords];
   }
    ...
    * given the array.  
    */
   public CellsToAddModListUTRA_TDD (CellsToAddModUTRA_TDD[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellsToAddModUTRA_TDD [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellsToAddModUTRA_TDD();
