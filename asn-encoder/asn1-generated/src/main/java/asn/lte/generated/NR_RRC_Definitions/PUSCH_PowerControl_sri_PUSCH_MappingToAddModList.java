...
public class PUSCH_PowerControl_sri_PUSCH_MappingToAddModList extends Asn1SeqOf {
   ...
   public SRI_PUSCH_PowerControl[] elements;

   public PUSCH_PowerControl_sri_PUSCH_MappingToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUSCH_PowerControl_sri_PUSCH_MappingToAddModList (int numRecords) {
      elements = new SRI_PUSCH_PowerControl [numRecords];
   }
    ...
    * given the array.  
    */
   public PUSCH_PowerControl_sri_PUSCH_MappingToAddModList (SRI_PUSCH_PowerControl[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRI_PUSCH_PowerControl [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRI_PUSCH_PowerControl();
