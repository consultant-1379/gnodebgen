...
public class MeNBtoSeNBContainer extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "MeNBtoSeNBContainer";
   }

   public MeNBtoSeNBContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public MeNBtoSeNBContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public MeNBtoSeNBContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public MeNBtoSeNBContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
