...
public class AffectedCarrierFreqCombList_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AffectedCarrierFreqCombList-r11";
   }

   public AffectedCarrierFreqComb_r11[] elements;

   public AffectedCarrierFreqCombList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AffectedCarrierFreqCombList_r11 (int numRecords) {
      elements = new AffectedCarrierFreqComb_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public AffectedCarrierFreqCombList_r11 (AffectedCarrierFreqComb_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AffectedCarrierFreqComb_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AffectedCarrierFreqComb_r11();
