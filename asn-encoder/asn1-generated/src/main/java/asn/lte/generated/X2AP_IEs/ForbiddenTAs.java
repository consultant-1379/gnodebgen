...
public class ForbiddenTAs extends Asn1SeqOf {
   ...
   public ForbiddenTAs_Item[] elements;
    ...
    * populated.
    */
   public ForbiddenTAs (int numRecords) {
      elements = new ForbiddenTAs_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ForbiddenTAs (ForbiddenTAs_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ForbiddenTAs_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ForbiddenTAs_Item();
