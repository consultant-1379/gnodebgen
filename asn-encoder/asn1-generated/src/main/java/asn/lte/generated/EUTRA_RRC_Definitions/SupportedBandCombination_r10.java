...
public class SupportedBandCombination_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-r10";
   }

   public BandCombinationParameters_r10[] elements;

   public SupportedBandCombination_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_r10 (int numRecords) {
      elements = new BandCombinationParameters_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandCombination_r10 (BandCombinationParameters_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandCombinationParameters_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandCombinationParameters_r10();
