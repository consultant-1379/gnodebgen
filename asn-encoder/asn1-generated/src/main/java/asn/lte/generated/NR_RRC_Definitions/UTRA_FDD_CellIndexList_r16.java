...
public class UTRA_FDD_CellIndexList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "UTRA-FDD-CellIndexList-r16";
   }

   public UTRA_FDD_CellIndex_r16[] elements;

   public UTRA_FDD_CellIndexList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UTRA_FDD_CellIndexList_r16 (int numRecords) {
      elements = new UTRA_FDD_CellIndex_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public UTRA_FDD_CellIndexList_r16 (UTRA_FDD_CellIndex_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UTRA_FDD_CellIndex_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UTRA_FDD_CellIndex_r16();
