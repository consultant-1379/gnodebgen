...
public class FeatureSetDownlink_dummy7 extends Asn1SeqOf {
   ...
   public DummyE[] elements;

   public FeatureSetDownlink_dummy7 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSetDownlink_dummy7 (int numRecords) {
      elements = new DummyE [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSetDownlink_dummy7 (DummyE[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DummyE [numElements];
