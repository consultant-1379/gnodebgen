...
public class UE_EUTRA_Capability_v940_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UE-EUTRA-Capability-v940-IEs";
   }

   public UE_EUTRA_Capability_v9a0_IEs lateNonCriticalExtension;  // optional
   public UE_EUTRA_Capability_v1020_IEs nonCriticalExtension;  // optional

   public UE_EUTRA_Capability_v940_IEs () {
      super();
      init();
   }
    ...
    */
   public UE_EUTRA_Capability_v940_IEs (
      UE_EUTRA_Capability_v9a0_IEs lateNonCriticalExtension_,
      UE_EUTRA_Capability_v1020_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (lateNonCriticalExtensionPresent) {
         ...
         lateNonCriticalExtension = new UE_EUTRA_Capability_v9a0_IEs();
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new UE_EUTRA_Capability_v1020_IEs();
