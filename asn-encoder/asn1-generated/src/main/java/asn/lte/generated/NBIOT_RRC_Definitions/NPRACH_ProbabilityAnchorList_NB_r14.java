...
public class NPRACH_ProbabilityAnchorList_NB_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NPRACH-ProbabilityAnchorList-NB-r14";
   }

   public NPRACH_ProbabilityAnchor_NB_r14[] elements;

   public NPRACH_ProbabilityAnchorList_NB_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NPRACH_ProbabilityAnchorList_NB_r14 (int numRecords) {
      elements = new NPRACH_ProbabilityAnchor_NB_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public NPRACH_ProbabilityAnchorList_NB_r14 (NPRACH_ProbabilityAnchor_NB_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NPRACH_ProbabilityAnchor_NB_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NPRACH_ProbabilityAnchor_NB_r14();
