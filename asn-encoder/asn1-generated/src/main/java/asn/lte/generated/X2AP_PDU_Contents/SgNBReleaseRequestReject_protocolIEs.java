...
public class SgNBReleaseRequestReject_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBReleaseRequestReject_protocolIEs_element[] elements;

   public SgNBReleaseRequestReject_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBReleaseRequestReject_protocolIEs (int numRecords) {
      elements = new SgNBReleaseRequestReject_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBReleaseRequestReject_protocolIEs (SgNBReleaseRequestReject_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBReleaseRequestReject_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBReleaseRequestReject_protocolIEs_element();
