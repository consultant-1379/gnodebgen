...
public class EnhancedRNTP_iE_Extensions extends Asn1SeqOf {
   ...
   public EnhancedRNTP_iE_Extensions_element[] elements;

   public EnhancedRNTP_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public EnhancedRNTP_iE_Extensions (int numRecords) {
      elements = new EnhancedRNTP_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EnhancedRNTP_iE_Extensions (EnhancedRNTP_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EnhancedRNTP_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EnhancedRNTP_iE_Extensions_element();
