...
public class EAB_CR_CellsToReport_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-CR-CellsToReport-List";
   }

   public EAB_CR_CellsToReport_Item[] elements;

   public EAB_CR_CellsToReport_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_CR_CellsToReport_List (int numRecords) {
      elements = new EAB_CR_CellsToReport_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_CR_CellsToReport_List (EAB_CR_CellsToReport_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_CR_CellsToReport_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_CR_CellsToReport_Item();
