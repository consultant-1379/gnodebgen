...
public class LastVisitedNGRANCellInformation extends Asn1OctetString {
   ...
   public LastVisitedNGRANCellInformation () {
      super();
   }
    ...
    *              in binary form.
    */
   public LastVisitedNGRANCellInformation (byte[] data) {
      super (data);
   }
    ...
    */
   public LastVisitedNGRANCellInformation (byte[] data, int offset, int nbytes) {
    ...
    */
   public LastVisitedNGRANCellInformation (String value_) throws Asn1ValueParseException {
      super (value_);
   }
