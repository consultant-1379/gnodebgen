...
public class UE_Capability_NB_v14x0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UE-Capability-NB-v14x0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public UE_Capability_NB_v1530_IEs nonCriticalExtension;  // optional

   public UE_Capability_NB_v14x0_IEs () {
      super();
      init();
   }
   ...
   public UE_Capability_NB_v14x0_IEs (
      ...
      UE_Capability_NB_v1530_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public UE_Capability_NB_v14x0_IEs (byte[] lateNonCriticalExtension_,
      UE_Capability_NB_v1530_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new UE_Capability_NB_v1530_IEs();
