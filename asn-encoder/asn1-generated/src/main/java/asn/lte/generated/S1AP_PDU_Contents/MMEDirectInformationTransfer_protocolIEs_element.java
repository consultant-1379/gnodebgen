...
public class MMEDirectInformationTransfer_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: Inter-SystemInformationTransferType
    * Java type: Inter_SystemInformationTransferType
    */
   public Asn1Type value;

   public MMEDirectInformationTransfer_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MMEDirectInformationTransfer_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-Inter-SystemInformationTransferTypeMDT
    */
   public void setUsing_id_Inter_SystemInformationTransferTypeMDT(Inter_SystemInformationTransferType value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_Inter_SystemInformationTransferTypeMDT);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-Inter-SystemInformationTransferTypeMDT
    */
   public Inter_SystemInformationTransferType getValueFor_id_Inter_SystemInformationTransferTypeMDT() {
      return (Inter_SystemInformationTransferType) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.MMEDirectInformationTransferIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.MMEDirectInformationTransferIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.MMEDirectInformationTransferIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 122) {
         indent (_sb, _level+1);
         _sb.append("id = id-Inter-SystemInformationTransferTypeMDT\n");
      }
