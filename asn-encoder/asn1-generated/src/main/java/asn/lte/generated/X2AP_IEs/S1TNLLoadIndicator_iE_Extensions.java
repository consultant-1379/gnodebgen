...
public class S1TNLLoadIndicator_iE_Extensions extends Asn1SeqOf {
   ...
   public S1TNLLoadIndicator_iE_Extensions_element[] elements;

   public S1TNLLoadIndicator_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public S1TNLLoadIndicator_iE_Extensions (int numRecords) {
      elements = new S1TNLLoadIndicator_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public S1TNLLoadIndicator_iE_Extensions (S1TNLLoadIndicator_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new S1TNLLoadIndicator_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new S1TNLLoadIndicator_iE_Extensions_element();
