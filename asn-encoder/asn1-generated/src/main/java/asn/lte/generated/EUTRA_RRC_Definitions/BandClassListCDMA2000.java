...
public class BandClassListCDMA2000 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandClassListCDMA2000";
   }

   public BandClassInfoCDMA2000[] elements;

   public BandClassListCDMA2000 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandClassListCDMA2000 (int numRecords) {
      elements = new BandClassInfoCDMA2000 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandClassListCDMA2000 (BandClassInfoCDMA2000[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandClassInfoCDMA2000 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandClassInfoCDMA2000();
