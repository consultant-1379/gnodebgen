...
public class M3SetupFailure_protocolIEs extends Asn1SeqOf {
   ...
   public M3SetupFailure_protocolIEs_element[] elements;

   public M3SetupFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public M3SetupFailure_protocolIEs (int numRecords) {
      elements = new M3SetupFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public M3SetupFailure_protocolIEs (M3SetupFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new M3SetupFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new M3SetupFailure_protocolIEs_element();
