...
public class SupportedBandCombination_v10i0 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-v10i0";
   }

   public BandCombinationParameters_v10i0[] elements;

   public SupportedBandCombination_v10i0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_v10i0 (int numRecords) {
    ...
    * given the array.  
    */
   public SupportedBandCombination_v10i0 (BandCombinationParameters_v10i0[] elements_) {
      elements = elements_;
   }
