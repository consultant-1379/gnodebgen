...
public class MeasurementQuantities extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasurementQuantities";
   }

   public MeasurementQuantities_element[] elements;

   public MeasurementQuantities () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasurementQuantities (int numRecords) {
      elements = new MeasurementQuantities_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasurementQuantities (MeasurementQuantities_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasurementQuantities_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasurementQuantities_element();
