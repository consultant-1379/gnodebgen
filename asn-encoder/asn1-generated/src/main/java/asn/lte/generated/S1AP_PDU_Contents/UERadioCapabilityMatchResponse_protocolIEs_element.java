...
public class UERadioCapabilityMatchResponse_protocolIEs_element extends Asn1Seq {
    ...
    * presence: Presence.mandatory
    * ASN.1 type: VoiceSupportMatchIndicator
    * Java type: VoiceSupportMatchIndicator
    *
   ...
   public UERadioCapabilityMatchResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UERadioCapabilityMatchResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-VoiceSupportMatchIndicator
    */
   public void setUsing_id_VoiceSupportMatchIndicator(asn.lte.generated.S1AP_IEs.VoiceSupportMatchIndicator value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_VoiceSupportMatchIndicator);
   ...
   /**
    * Get value of value with type set according to information object having key id-VoiceSupportMatchIndicator
    */
   public asn.lte.generated.S1AP_IEs.VoiceSupportMatchIndicator getValueFor_id_VoiceSupportMatchIndicator() {
      return (asn.lte.generated.S1AP_IEs.VoiceSupportMatchIndicator) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.UERadioCapabilityMatchResponseIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.UERadioCapabilityMatchResponseIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.UERadioCapabilityMatchResponseIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 169) {
         indent (_sb, _level+1);
         _sb.append("id = id-VoiceSupportMatchIndicator\n");
      }
      else if (id.value == 58) {
         indent (_sb, _level+1);
