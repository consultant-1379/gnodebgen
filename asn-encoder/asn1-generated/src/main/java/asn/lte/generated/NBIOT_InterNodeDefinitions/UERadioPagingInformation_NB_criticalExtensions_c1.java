...
public class UERadioPagingInformation_NB_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _UERADIOPAGINGINFORMATION_R13 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public UERadioPagingInformation_NB_criticalExtensions_c1 () {
      super();
   }

   public UERadioPagingInformation_NB_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _UERADIOPAGINGINFORMATION_R13: return "ueRadioPagingInformation_r13";
   ...
   public void set_ueRadioPagingInformation_r13 (UERadioPagingInformation_NB_IEs value) {
      setElement (_UERADIOPAGINGINFORMATION_R13, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         // ueRadioPagingInformation_r13
         case 0: { 
            UERadioPagingInformation_NB_IEs ueRadioPagingInformation_r13;
            element = ueRadioPagingInformation_r13 = new UERadioPagingInformation_NB_IEs();
            ueRadioPagingInformation_r13.decode (buffer);
            break;
         }
