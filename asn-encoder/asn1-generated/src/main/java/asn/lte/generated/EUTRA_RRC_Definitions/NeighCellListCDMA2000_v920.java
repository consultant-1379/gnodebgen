...
public class NeighCellListCDMA2000_v920 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NeighCellListCDMA2000-v920";
   }

   public NeighCellCDMA2000_v920[] elements;

   public NeighCellListCDMA2000_v920 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NeighCellListCDMA2000_v920 (int numRecords) {
      elements = new NeighCellCDMA2000_v920 [numRecords];
   }
    ...
    * given the array.  
    */
   public NeighCellListCDMA2000_v920 (NeighCellCDMA2000_v920[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NeighCellCDMA2000_v920 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NeighCellCDMA2000_v920();
