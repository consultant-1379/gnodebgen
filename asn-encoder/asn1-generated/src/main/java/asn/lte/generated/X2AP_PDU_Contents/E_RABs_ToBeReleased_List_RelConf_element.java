...
public class E_RABs_ToBeReleased_List_RelConf_element extends Asn1Seq {
   ...
   /**
    * id: id-E-RABs-ToBeReleased-RelConfItem
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABs-ToBeReleased-RelConfItem
    * Java type: E_RABs_ToBeReleased_RelConfItem
    */
   public Asn1Type value;

   public E_RABs_ToBeReleased_List_RelConf_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABs_ToBeReleased_List_RelConf_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-ToBeReleased-RelConfItem
    */
   public void setUsing_id_E_RABs_ToBeReleased_RelConfItem(E_RABs_ToBeReleased_RelConfItem value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_ToBeReleased_RelConfItem);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABs-ToBeReleased-RelConfItem
    */
   public E_RABs_ToBeReleased_RelConfItem getValueFor_id_E_RABs_ToBeReleased_RelConfItem() {
      return (E_RABs_ToBeReleased_RelConfItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.E_RABs_ToBeReleased_RelConfItemIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.E_RABs_ToBeReleased_RelConfItemIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.E_RABs_ToBeReleased_RelConfItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 140) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-ToBeReleased-RelConfItem\n");
      }
