...
public class X2SetupFailure extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "X2SetupFailure";
   }

   public X2SetupFailure_protocolIEs protocolIEs;
   public Asn1OpenExt extElem1;

   public X2SetupFailure () {
      super();
      init();
   }
    ...
    */
   public X2SetupFailure (
      X2SetupFailure_protocolIEs protocolIEs_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      protocolIEs = new X2SetupFailure_protocolIEs();
