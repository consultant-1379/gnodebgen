...
public class ENBX2ExtTLA_iE_Extensions extends Asn1SeqOf {
   ...
   public ENBX2ExtTLA_iE_Extensions_element[] elements;

   public ENBX2ExtTLA_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENBX2ExtTLA_iE_Extensions (int numRecords) {
      elements = new ENBX2ExtTLA_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENBX2ExtTLA_iE_Extensions (ENBX2ExtTLA_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENBX2ExtTLA_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENBX2ExtTLA_iE_Extensions_element();
