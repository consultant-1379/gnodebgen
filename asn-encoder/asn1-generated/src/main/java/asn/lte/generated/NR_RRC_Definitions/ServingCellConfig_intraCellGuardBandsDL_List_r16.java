...
public class ServingCellConfig_intraCellGuardBandsDL_List_r16 extends Asn1SeqOf {
   ...
   public IntraCellGuardBandsPerSCS_r16[] elements;

   public ServingCellConfig_intraCellGuardBandsDL_List_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServingCellConfig_intraCellGuardBandsDL_List_r16 (int numRecords) {
      elements = new IntraCellGuardBandsPerSCS_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public ServingCellConfig_intraCellGuardBandsDL_List_r16 (IntraCellGuardBandsPerSCS_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new IntraCellGuardBandsPerSCS_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new IntraCellGuardBandsPerSCS_r16();
