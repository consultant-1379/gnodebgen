...
public class SONInformationReply_iE_Extensions extends Asn1SeqOf {
   ...
   public SONInformationReply_iE_Extensions_element[] elements;

   public SONInformationReply_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SONInformationReply_iE_Extensions (int numRecords) {
      elements = new SONInformationReply_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SONInformationReply_iE_Extensions (SONInformationReply_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SONInformationReply_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SONInformationReply_iE_Extensions_element();
