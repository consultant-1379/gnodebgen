...
public class RRC_Container extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "RRC-Container";
   }

   public RRC_Container () {
      super();
   }
    ...
    *              in binary form.
    */
   public RRC_Container (byte[] data) {
      super (data);
   }
    ...
    */
   public RRC_Container (byte[] data, int offset, int nbytes) {
    ...
    */
   public RRC_Container (String value_) throws Asn1ValueParseException {
      super (value_);
   }
