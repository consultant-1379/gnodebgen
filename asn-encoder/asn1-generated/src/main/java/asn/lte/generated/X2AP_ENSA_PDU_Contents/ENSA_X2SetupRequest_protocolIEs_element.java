...
public class ENSA_X2SetupRequest_protocolIEs_element extends Asn1Seq {
   ...
   public ENSA_X2SetupRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENSA_X2SetupRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key xid-GlobalENB-ID
    */
   public void setUsing_xid_GlobalENB_ID(asn.lte.generated.X2AP_IEs.GlobalENB_ID value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_ENSA_Constants._X2AP_ENSA_ConstantsValues.xid_GlobalENB_ID);
   ...
   /**
    * Get value of value with type set according to information object having key xid-GlobalENB-ID
    */
   public asn.lte.generated.X2AP_IEs.GlobalENB_ID getValueFor_xid_GlobalENB_ID() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_ENSA_PDU_ContentsValues.ENSA_X2SetupRequest_IEs.length; i++) {
         if(_X2AP_ENSA_PDU_ContentsValues.ENSA_X2SetupRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_ENSA_PDU_ContentsValues.ENSA_X2SetupRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 5122) {
         indent (_sb, _level+1);
         _sb.append("id = xid-GlobalENB-ID\n");
      }
