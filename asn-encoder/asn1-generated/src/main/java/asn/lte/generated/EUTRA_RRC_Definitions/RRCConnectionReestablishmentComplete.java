...
public class RRCConnectionReestablishmentComplete extends Asn1Seq {
   ...
   public RRCConnectionReestablishmentComplete_criticalExtensions criticalExtensions;

   public RRCConnectionReestablishmentComplete () {
      super();
      init();
   }
   ...
   public RRCConnectionReestablishmentComplete (
      ...
      RRCConnectionReestablishmentComplete_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public RRCConnectionReestablishmentComplete (long rrc_TransactionIdentifier_,
      RRCConnectionReestablishmentComplete_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionReestablishmentComplete_criticalExtensions();
