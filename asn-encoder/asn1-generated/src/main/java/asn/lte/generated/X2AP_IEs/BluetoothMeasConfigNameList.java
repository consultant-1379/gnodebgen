...
public class BluetoothMeasConfigNameList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BluetoothMeasConfigNameList";
   }

   public BluetoothName[] elements;

   public BluetoothMeasConfigNameList () {
      elements = null;
   }
    ...
    * populated.
    */
   public BluetoothMeasConfigNameList (int numRecords) {
      elements = new BluetoothName [numRecords];
   }
    ...
    * given the array.  
    */
   public BluetoothMeasConfigNameList (BluetoothName[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BluetoothName [numElements];
