...
public class InterFreqCarrierFreqListExt_v1310 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqListExt-v1310";
   }

   public InterFreqCarrierFreqInfo_v1310[] elements;

   public InterFreqCarrierFreqListExt_v1310 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqListExt_v1310 (int numRecords) {
      elements = new InterFreqCarrierFreqInfo_v1310 [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqListExt_v1310 (InterFreqCarrierFreqInfo_v1310[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqCarrierFreqInfo_v1310 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqCarrierFreqInfo_v1310();
