...
public class BT_NameList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BT-NameList-r16";
   }

   public BT_Name_r16[] elements;

   public BT_NameList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BT_NameList_r16 (int numRecords) {
      elements = new BT_Name_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public BT_NameList_r16 (BT_Name_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BT_Name_r16 [numElements];
