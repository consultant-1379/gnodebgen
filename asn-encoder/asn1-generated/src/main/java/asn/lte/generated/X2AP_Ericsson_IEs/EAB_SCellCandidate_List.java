...
public class EAB_SCellCandidate_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-SCellCandidate-List";
   }

   public EAB_SCellCandidate_Item[] elements;

   public EAB_SCellCandidate_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_SCellCandidate_List (int numRecords) {
      elements = new EAB_SCellCandidate_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_SCellCandidate_List (EAB_SCellCandidate_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_SCellCandidate_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_SCellCandidate_Item();
