...
public class SlotFormatIndicator_slotFormatCombToReleaseList extends Asn1SeqOf {
   ...
   public SlotFormatIndicator_slotFormatCombToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SlotFormatIndicator_slotFormatCombToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public SlotFormatIndicator_slotFormatCombToReleaseList (ServCellIndex[] elements_) {
      elements = elements_;
   }
