...
public class X2AP_Message extends Asn1OctetString {
    ...
    */
   public X2AP_Message (byte[] data, int offset, int nbytes) {
    ...
    */
   public X2AP_Message (String value_) throws Asn1ValueParseException {
      super (value_);
   }
