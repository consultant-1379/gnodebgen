...
public class E_RABs_ToBeSetupRetrieve_Item_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: DL-Forwarding
    * Java type: DL_Forwarding
    */
   public Asn1Type extensionValue;

   public E_RABs_ToBeSetupRetrieve_Item_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABs_ToBeSetupRetrieve_Item_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-uL-GTPtunnelEndpoint
    */
   public void setUsing_id_uL_GTPtunnelEndpoint(asn.lte.generated.X2AP_IEs.GTPtunnelEndpoint extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_uL_GTPtunnelEndpoint);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-dL-Forwarding
    */
   public void setUsing_id_dL_Forwarding(asn.lte.generated.X2AP_IEs.DL_Forwarding extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_dL_Forwarding);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-uL-GTPtunnelEndpoint
    */
   public asn.lte.generated.X2AP_IEs.GTPtunnelEndpoint getExtensionValueFor_id_uL_GTPtunnelEndpoint() {
      return (asn.lte.generated.X2AP_IEs.GTPtunnelEndpoint) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-dL-Forwarding
    */
   public asn.lte.generated.X2AP_IEs.DL_Forwarding getExtensionValueFor_id_dL_Forwarding() {
      return (asn.lte.generated.X2AP_IEs.DL_Forwarding) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.E_RABs_ToBeSetupRetrieve_ItemExtIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.E_RABs_ToBeSetupRetrieve_ItemExtIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.E_RABs_ToBeSetupRetrieve_ItemExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 185) {
         indent (_sb, _level+1);
         _sb.append("id = id-uL-GTPtunnelEndpoint\n");
      }
      else if (id.value == 306) {
         indent (_sb, _level+1);
         _sb.append("id = id-dL-Forwarding\n");
      }
