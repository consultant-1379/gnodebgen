...
public class ServingCellConfig_rateMatchPatternToAddModList extends Asn1SeqOf {
   ...
   public ServingCellConfig_rateMatchPatternToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServingCellConfig_rateMatchPatternToAddModList (int numRecords) {
    ...
    * given the array.  
    */
   public ServingCellConfig_rateMatchPatternToAddModList (RateMatchPattern[] elements_) {
      elements = elements_;
   }
