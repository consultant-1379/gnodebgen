...
public class SPS_ConfigSL_ToAddModList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPS-ConfigSL-ToAddModList-r14";
   }

   public SPS_ConfigSL_r14[] elements;

   public SPS_ConfigSL_ToAddModList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPS_ConfigSL_ToAddModList_r14 (int numRecords) {
      elements = new SPS_ConfigSL_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public SPS_ConfigSL_ToAddModList_r14 (SPS_ConfigSL_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SPS_ConfigSL_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SPS_ConfigSL_r14();
