...
public class BPLMN_ID_Info_NR extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BPLMN-ID-Info-NR";
   }

   public BPLMN_ID_Info_NR_Item[] elements;

   public BPLMN_ID_Info_NR () {
      elements = null;
   }
    ...
    * populated.
    */
   public BPLMN_ID_Info_NR (int numRecords) {
      elements = new BPLMN_ID_Info_NR_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public BPLMN_ID_Info_NR (BPLMN_ID_Info_NR_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BPLMN_ID_Info_NR_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BPLMN_ID_Info_NR_Item();
