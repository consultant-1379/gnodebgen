...
public class MMEConfigurationUpdateFailure_protocolIEs extends Asn1SeqOf {
   ...
   public MMEConfigurationUpdateFailure_protocolIEs_element[] elements;

   public MMEConfigurationUpdateFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MMEConfigurationUpdateFailure_protocolIEs (int numRecords) {
      elements = new MMEConfigurationUpdateFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MMEConfigurationUpdateFailure_protocolIEs (MMEConfigurationUpdateFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MMEConfigurationUpdateFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MMEConfigurationUpdateFailure_protocolIEs_element();
