...
public class LogicalChGroupInfoList_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "LogicalChGroupInfoList-v1530";
   }

   public SL_ReliabilityList_r15[] elements;

   public LogicalChGroupInfoList_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public LogicalChGroupInfoList_v1530 (int numRecords) {
      elements = new SL_ReliabilityList_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public LogicalChGroupInfoList_v1530 (SL_ReliabilityList_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_ReliabilityList_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_ReliabilityList_r15();
