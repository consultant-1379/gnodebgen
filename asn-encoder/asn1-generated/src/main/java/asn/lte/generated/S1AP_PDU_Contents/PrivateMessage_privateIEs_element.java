...
public class PrivateMessage_privateIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-S1AP-Ericsson-Data
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: S1AP-Ericsson-Data
    * Java type: S1AP_Ericsson_Data
    */
   ...
   {
      /* check id */
      asn.lte.generated.S1AP_Containers.S1AP_PRIVATE_IES _index = null;
      for(int i=0; i < _S1AP_PDU_ContentsValues.PrivateMessageIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.PrivateMessageIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.PrivateMessageIEs[i];
            break;
         }
      }
      if (null == _index) {
