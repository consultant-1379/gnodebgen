...
public class TraceStart_protocolIEs_element extends Asn1Seq {
   ...
   public TraceStart_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public TraceStart_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.TraceStartIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.TraceStartIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.TraceStartIEs[i];
            break;
         }
      }
      if (null == _index) {
