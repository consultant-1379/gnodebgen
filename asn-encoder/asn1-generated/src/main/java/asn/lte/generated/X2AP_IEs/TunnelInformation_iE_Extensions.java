...
public class TunnelInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public TunnelInformation_iE_Extensions_element[] elements;

   public TunnelInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TunnelInformation_iE_Extensions (int numRecords) {
      elements = new TunnelInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TunnelInformation_iE_Extensions (TunnelInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TunnelInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TunnelInformation_iE_Extensions_element();
