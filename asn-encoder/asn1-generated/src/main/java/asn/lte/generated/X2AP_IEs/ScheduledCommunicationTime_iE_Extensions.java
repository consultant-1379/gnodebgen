...
public class ScheduledCommunicationTime_iE_Extensions extends Asn1SeqOf {
   ...
   public ScheduledCommunicationTime_iE_Extensions_element[] elements;

   public ScheduledCommunicationTime_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ScheduledCommunicationTime_iE_Extensions (int numRecords) {
      elements = new ScheduledCommunicationTime_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ScheduledCommunicationTime_iE_Extensions (ScheduledCommunicationTime_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ScheduledCommunicationTime_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ScheduledCommunicationTime_iE_Extensions_element();
