...
public class E_RABToBeSetupListCtxtSUReq_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABToBeSetupItemCtxtSUReq
    * Java type: E_RABToBeSetupItemCtxtSUReq
    */
   public Asn1Type value;

   public E_RABToBeSetupListCtxtSUReq_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABToBeSetupListCtxtSUReq_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABToBeSetupItemCtxtSUReq
    */
   public void setUsing_id_E_RABToBeSetupItemCtxtSUReq(E_RABToBeSetupItemCtxtSUReq value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABToBeSetupItemCtxtSUReq);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABToBeSetupItemCtxtSUReq
    */
   public E_RABToBeSetupItemCtxtSUReq getValueFor_id_E_RABToBeSetupItemCtxtSUReq() {
      return (E_RABToBeSetupItemCtxtSUReq) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABToBeSetupItemCtxtSUReqIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABToBeSetupItemCtxtSUReqIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABToBeSetupItemCtxtSUReqIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 52) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABToBeSetupItemCtxtSUReq\n");
      }
