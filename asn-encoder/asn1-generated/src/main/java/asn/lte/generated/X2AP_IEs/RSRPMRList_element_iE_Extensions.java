...
public class RSRPMRList_element_iE_Extensions extends Asn1SeqOf {
   ...
   public RSRPMRList_element_iE_Extensions_element[] elements;

   public RSRPMRList_element_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RSRPMRList_element_iE_Extensions (int numRecords) {
      elements = new RSRPMRList_element_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RSRPMRList_element_iE_Extensions (RSRPMRList_element_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RSRPMRList_element_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RSRPMRList_element_iE_Extensions_element();
