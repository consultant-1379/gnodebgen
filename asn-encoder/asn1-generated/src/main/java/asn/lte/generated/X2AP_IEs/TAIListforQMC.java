...
public class TAIListforQMC extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "TAIListforQMC";
   }

   public TAI_Item[] elements;

   public TAIListforQMC () {
      elements = null;
   }
    ...
    * populated.
    */
   public TAIListforQMC (int numRecords) {
      elements = new TAI_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public TAIListforQMC (TAI_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TAI_Item [numElements];
