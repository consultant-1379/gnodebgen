...
public class SecondaryRATDataUsageReportList_element extends Asn1Seq {
    ...
    * ASN.1 type: SecondaryRATDataUsageReportItem
    * Java type: SecondaryRATDataUsageReportItem
    */
   public Asn1Type value;

   public SecondaryRATDataUsageReportList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SecondaryRATDataUsageReportList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-SecondaryRATDataUsageReportItem
    */
   public void setUsing_id_SecondaryRATDataUsageReportItem(SecondaryRATDataUsageReportItem value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_SecondaryRATDataUsageReportItem);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-SecondaryRATDataUsageReportItem
    */
   public SecondaryRATDataUsageReportItem getValueFor_id_SecondaryRATDataUsageReportItem() {
      return (SecondaryRATDataUsageReportItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.SecondaryRATDataUsageReportItemIEs.length; i++) {
         if(_S1AP_IEsValues.SecondaryRATDataUsageReportItemIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.SecondaryRATDataUsageReportItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 265) {
         indent (_sb, _level+1);
         _sb.append("id = id-SecondaryRATDataUsageReportItem\n");
      }
