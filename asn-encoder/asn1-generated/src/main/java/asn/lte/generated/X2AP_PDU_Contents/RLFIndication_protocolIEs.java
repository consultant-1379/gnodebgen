...
public class RLFIndication_protocolIEs extends Asn1SeqOf {
   ...
   public RLFIndication_protocolIEs_element[] elements;

   public RLFIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public RLFIndication_protocolIEs (int numRecords) {
      elements = new RLFIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RLFIndication_protocolIEs (RLFIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RLFIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RLFIndication_protocolIEs_element();
