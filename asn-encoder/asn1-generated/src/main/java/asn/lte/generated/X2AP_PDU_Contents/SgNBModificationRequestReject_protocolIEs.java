...
public class SgNBModificationRequestReject_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBModificationRequestReject_protocolIEs_element[] elements;

   public SgNBModificationRequestReject_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBModificationRequestReject_protocolIEs (int numRecords) {
      elements = new SgNBModificationRequestReject_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBModificationRequestReject_protocolIEs (SgNBModificationRequestReject_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBModificationRequestReject_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBModificationRequestReject_protocolIEs_element();
