...
public class X2RemovalFailure extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "X2RemovalFailure";
   }

   public X2RemovalFailure_protocolIEs protocolIEs;
   public Asn1OpenExt extElem1;

   public X2RemovalFailure () {
      super();
      init();
   }
    ...
    */
   public X2RemovalFailure (
      X2RemovalFailure_protocolIEs protocolIEs_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      protocolIEs = new X2RemovalFailure_protocolIEs();
