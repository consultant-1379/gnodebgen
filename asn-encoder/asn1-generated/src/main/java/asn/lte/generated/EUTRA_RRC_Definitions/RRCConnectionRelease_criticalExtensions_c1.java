...
public class RRCConnectionRelease_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _RRCCONNECTIONRELEASE_R8 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public RRCConnectionRelease_criticalExtensions_c1 () {
      super();
   }

   public RRCConnectionRelease_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _RRCCONNECTIONRELEASE_R8: return "rrcConnectionRelease_r8";
   ...
   public void set_rrcConnectionRelease_r8 (RRCConnectionRelease_r8_IEs value) {
      setElement (_RRCCONNECTIONRELEASE_R8, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            element = rrcConnectionRelease_r8 = new RRCConnectionRelease_r8_IEs();
            rrcConnectionRelease_r8.decode (buffer);
            break;
         }
