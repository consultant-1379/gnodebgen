...
public class MeasObjectNR_r15_bandNR_r15 extends Asn1Choice {
   ...
   public MeasObjectNR_r15_bandNR_r15 () {
      super();
   }

   public MeasObjectNR_r15_bandNR_r15 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (FreqBandIndicatorNR_r15 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            FreqBandIndicatorNR_r15 setup;
            element = setup = new FreqBandIndicatorNR_r15();
            setup.decode (buffer);
            break;
         }
