...
public class E_RABSetupListCtxtSURes_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABSetupItemCtxtSURes
    * Java type: E_RABSetupItemCtxtSURes
    */
   public Asn1Type value;

   public E_RABSetupListCtxtSURes_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABSetupListCtxtSURes_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABSetupItemCtxtSURes
    */
   public void setUsing_id_E_RABSetupItemCtxtSURes(E_RABSetupItemCtxtSURes value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABSetupItemCtxtSURes);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABSetupItemCtxtSURes
    */
   public E_RABSetupItemCtxtSURes getValueFor_id_E_RABSetupItemCtxtSURes() {
      return (E_RABSetupItemCtxtSURes) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABSetupItemCtxtSUResIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABSetupItemCtxtSUResIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABSetupItemCtxtSUResIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 50) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABSetupItemCtxtSURes\n");
      }
