...
public class InitialContextSetupFailure_protocolIEs extends Asn1SeqOf {
   ...
   public InitialContextSetupFailure_protocolIEs_element[] elements;

   public InitialContextSetupFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public InitialContextSetupFailure_protocolIEs (int numRecords) {
      elements = new InitialContextSetupFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public InitialContextSetupFailure_protocolIEs (InitialContextSetupFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InitialContextSetupFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InitialContextSetupFailure_protocolIEs_element();
