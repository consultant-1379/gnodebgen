...
public class P_C_AndCBSR_Pair_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "P-C-AndCBSR-Pair-r15";
   }

   public P_C_AndCBSR_r15[] elements;

   public P_C_AndCBSR_Pair_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public P_C_AndCBSR_Pair_r15 (int numRecords) {
      elements = new P_C_AndCBSR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public P_C_AndCBSR_Pair_r15 (P_C_AndCBSR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new P_C_AndCBSR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new P_C_AndCBSR_r15();
