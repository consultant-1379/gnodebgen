...
public class Enable256QAM_r14 extends Asn1Choice {
   ...
   public Enable256QAM_r14 () {
      super();
   }

   public Enable256QAM_r14 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (Enable256QAM_r14_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            Enable256QAM_r14_setup setup;
            element = setup = new Enable256QAM_r14_setup();
            setup.decode (buffer);
            break;
         }
