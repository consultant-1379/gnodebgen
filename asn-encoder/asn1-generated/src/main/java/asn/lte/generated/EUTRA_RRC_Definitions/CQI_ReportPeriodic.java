...
public class CQI_ReportPeriodic extends Asn1Choice {
   ...
   public CQI_ReportPeriodic () {
      super();
   }

   public CQI_ReportPeriodic (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (CQI_ReportPeriodic_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            CQI_ReportPeriodic_setup setup;
            element = setup = new CQI_ReportPeriodic_setup();
            setup.decode (buffer);
            break;
         }
