...
public class ERABActivityNotifyItem_iE_Extensions extends Asn1SeqOf {
   ...
   public ERABActivityNotifyItem_iE_Extensions_element[] elements;

   public ERABActivityNotifyItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ERABActivityNotifyItem_iE_Extensions (int numRecords) {
      elements = new ERABActivityNotifyItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ERABActivityNotifyItem_iE_Extensions (ERABActivityNotifyItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ERABActivityNotifyItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ERABActivityNotifyItem_iE_Extensions_element();
