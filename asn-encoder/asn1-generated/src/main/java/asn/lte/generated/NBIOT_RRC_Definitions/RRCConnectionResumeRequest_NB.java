...
public class RRCConnectionResumeRequest_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionResumeRequest-NB";
   }

   public RRCConnectionResumeRequest_NB_criticalExtensions criticalExtensions;

   public RRCConnectionResumeRequest_NB () {
      super();
      init();
   }
    ...
    */
   public RRCConnectionResumeRequest_NB (
      RRCConnectionResumeRequest_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionResumeRequest_NB_criticalExtensions();
