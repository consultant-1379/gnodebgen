...
public class MBMS_E_RAB_QoS_Parameters_iE_Extensions_element extends Asn1Seq {
   ...
   /**
    * id: id-AllocationAndRetentionPriority
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: AllocationAndRetentionPriority
    * Java type: AllocationAndRetentionPriority
    */
   public Asn1Type extensionValue;

   public MBMS_E_RAB_QoS_Parameters_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MBMS_E_RAB_QoS_Parameters_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-AllocationAndRetentionPriority
    */
   public void setUsing_id_AllocationAndRetentionPriority(AllocationAndRetentionPriority extensionValue) {
      this.id = new asn.lte.generated.M3AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.M3AP_Constants._M3AP_ConstantsValues.id_AllocationAndRetentionPriority);
      this.criticality = asn.lte.generated.M3AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-AllocationAndRetentionPriority
    */
   public AllocationAndRetentionPriority getExtensionValueFor_id_AllocationAndRetentionPriority() {
      return (AllocationAndRetentionPriority) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _M3AP_IEsValues.MBMS_E_RAB_QoS_Parameters_ExtIEs.length; i++) {
         if(_M3AP_IEsValues.MBMS_E_RAB_QoS_Parameters_ExtIEs[i].id.equals(id)) {
            _index = _M3AP_IEsValues.MBMS_E_RAB_QoS_Parameters_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 17) {
         indent (_sb, _level+1);
         _sb.append("id = id-AllocationAndRetentionPriority\n");
      }
