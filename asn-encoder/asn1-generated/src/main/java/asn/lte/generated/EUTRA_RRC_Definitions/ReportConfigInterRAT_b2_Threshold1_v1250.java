...
public class ReportConfigInterRAT_b2_Threshold1_v1250 extends Asn1Choice {
   ...
   public ReportConfigInterRAT_b2_Threshold1_v1250 () {
      super();
   }

   public ReportConfigInterRAT_b2_Threshold1_v1250 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (RSRQ_Range_v1250 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            RSRQ_Range_v1250 setup;
            element = setup = new RSRQ_Range_v1250();
            setup.decode (buffer);
            break;
         }
