...
public class CondReconfigToAddModList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CondReconfigToAddModList-r16";
   }

   public CondReconfigToAddMod_r16[] elements;

   public CondReconfigToAddModList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CondReconfigToAddModList_r16 (int numRecords) {
      elements = new CondReconfigToAddMod_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public CondReconfigToAddModList_r16 (CondReconfigToAddMod_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CondReconfigToAddMod_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CondReconfigToAddMod_r16();
