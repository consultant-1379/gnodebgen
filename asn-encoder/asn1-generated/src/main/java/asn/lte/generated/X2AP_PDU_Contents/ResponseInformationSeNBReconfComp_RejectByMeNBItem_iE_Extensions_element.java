...
public class ResponseInformationSeNBReconfComp_RejectByMeNBItem_iE_Extensions_element extends Asn1Seq {
   ...
   public ResponseInformationSeNBReconfComp_RejectByMeNBItem_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ResponseInformationSeNBReconfComp_RejectByMeNBItem_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ResponseInformationSeNBReconfComp_RejectByMeNBItemExtIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ResponseInformationSeNBReconfComp_RejectByMeNBItemExtIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ResponseInformationSeNBReconfComp_RejectByMeNBItemExtIEs[i];
            break;
         }
      }
      if (null == _index) {
