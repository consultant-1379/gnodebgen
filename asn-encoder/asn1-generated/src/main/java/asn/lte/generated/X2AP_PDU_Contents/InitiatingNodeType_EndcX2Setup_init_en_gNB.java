...
public class InitiatingNodeType_EndcX2Setup_init_en_gNB extends Asn1SeqOf {
   ...
   public InitiatingNodeType_EndcX2Setup_init_en_gNB_element[] elements;

   public InitiatingNodeType_EndcX2Setup_init_en_gNB () {
      elements = null;
   }
    ...
    * populated.
    */
   public InitiatingNodeType_EndcX2Setup_init_en_gNB (int numRecords) {
      elements = new InitiatingNodeType_EndcX2Setup_init_en_gNB_element [numRecords];
   }
    ...
    * given the array.  
    */
   public InitiatingNodeType_EndcX2Setup_init_en_gNB (InitiatingNodeType_EndcX2Setup_init_en_gNB_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InitiatingNodeType_EndcX2Setup_init_en_gNB_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InitiatingNodeType_EndcX2Setup_init_en_gNB_element();
