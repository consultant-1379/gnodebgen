...
public class CSI_ReportConfig_reportConfigType_periodic_pucch_CSI_ResourceList extends Asn1SeqOf {
   ...
   public CSI_ReportConfig_reportConfigType_periodic_pucch_CSI_ResourceList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_ReportConfig_reportConfigType_periodic_pucch_CSI_ResourceList (int numRecords) {
    ...
    * given the array.  
    */
   public CSI_ReportConfig_reportConfigType_periodic_pucch_CSI_ResourceList (PUCCH_CSI_Resource[] elements_) {
      elements = elements_;
   }
