...
public class CarrierFreqListNR_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CarrierFreqListNR-r15";
   }

   public CarrierFreqNR_r15[] elements;

   public CarrierFreqListNR_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CarrierFreqListNR_r15 (int numRecords) {
      elements = new CarrierFreqNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public CarrierFreqListNR_r15 (CarrierFreqNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CarrierFreqNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CarrierFreqNR_r15();
