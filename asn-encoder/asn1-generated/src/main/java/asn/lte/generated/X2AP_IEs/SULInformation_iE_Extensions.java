...
public class SULInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public SULInformation_iE_Extensions_element[] elements;

   public SULInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SULInformation_iE_Extensions (int numRecords) {
      elements = new SULInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SULInformation_iE_Extensions (SULInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SULInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SULInformation_iE_Extensions_element();
