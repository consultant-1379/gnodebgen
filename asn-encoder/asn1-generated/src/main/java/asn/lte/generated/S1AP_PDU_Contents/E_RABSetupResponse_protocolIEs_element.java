...
public class E_RABSetupResponse_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABSetupListBearerSURes
    * Java type: E_RABSetupListBearerSURes
    *
   ...
   public E_RABSetupResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABSetupResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABSetupListBearerSURes
    */
   public void setUsing_id_E_RABSetupListBearerSURes(E_RABSetupListBearerSURes value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABSetupListBearerSURes);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-E-RABFailedToSetupListBearerSURes
    */
   public void setUsing_id_E_RABFailedToSetupListBearerSURes(asn.lte.generated.S1AP_IEs.E_RABList value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABFailedToSetupListBearerSURes);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABSetupListBearerSURes
    */
   public E_RABSetupListBearerSURes getValueFor_id_E_RABSetupListBearerSURes() {
      return (E_RABSetupListBearerSURes) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABFailedToSetupListBearerSURes
    */
   public asn.lte.generated.S1AP_IEs.E_RABList getValueFor_id_E_RABFailedToSetupListBearerSURes() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABSetupResponseIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABSetupResponseIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABSetupResponseIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABSetupListBearerSURes\n");
      }
      else if (id.value == 29) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABFailedToSetupListBearerSURes\n");
      }
      else if (id.value == 58) {
         indent (_sb, _level+1);
