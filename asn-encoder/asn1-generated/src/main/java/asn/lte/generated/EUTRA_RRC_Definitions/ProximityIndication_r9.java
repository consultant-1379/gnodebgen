...
public class ProximityIndication_r9 extends Asn1Seq {
   ...
   public ProximityIndication_r9_criticalExtensions criticalExtensions;

   public ProximityIndication_r9 () {
      super();
      init();
   }
    ...
    */
   public ProximityIndication_r9 (
      ProximityIndication_r9_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new ProximityIndication_r9_criticalExtensions();
