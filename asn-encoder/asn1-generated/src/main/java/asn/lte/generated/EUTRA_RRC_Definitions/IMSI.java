...
public class IMSI extends Asn1SeqOf {
    ...
    * populated.
    */
   public IMSI (int numRecords) {
      elements = new IMSI_Digit [numRecords];
   }
    ...
    * given the array.  
    */
   public IMSI (IMSI_Digit[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (6, 21);
      int numElements = (int) buffer.decodeLength();

      elements = new IMSI_Digit [numElements];
