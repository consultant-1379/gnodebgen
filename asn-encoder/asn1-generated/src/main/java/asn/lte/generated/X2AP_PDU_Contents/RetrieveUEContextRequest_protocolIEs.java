...
public class RetrieveUEContextRequest_protocolIEs extends Asn1SeqOf {
   ...
   public RetrieveUEContextRequest_protocolIEs_element[] elements;

   public RetrieveUEContextRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public RetrieveUEContextRequest_protocolIEs (int numRecords) {
      elements = new RetrieveUEContextRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RetrieveUEContextRequest_protocolIEs (RetrieveUEContextRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RetrieveUEContextRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RetrieveUEContextRequest_protocolIEs_element();
