...
public class IntraFreqWhiteCellList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "IntraFreqWhiteCellList-r16";
   }

   public PCI_Range[] elements;

   public IntraFreqWhiteCellList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public IntraFreqWhiteCellList_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public IntraFreqWhiteCellList_r16 (PCI_Range[] elements_) {
      elements = elements_;
   }
