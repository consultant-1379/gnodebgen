...
public class E_RABAdmittedList_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABAdmittedItem
    * Java type: E_RABAdmittedItem
    */
   public Asn1Type value;

   public E_RABAdmittedList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABAdmittedList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABAdmittedItem
    */
   public void setUsing_id_E_RABAdmittedItem(E_RABAdmittedItem value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABAdmittedItem);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABAdmittedItem
    */
   public E_RABAdmittedItem getValueFor_id_E_RABAdmittedItem() {
      return (E_RABAdmittedItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABAdmittedItemIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABAdmittedItemIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABAdmittedItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 20) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABAdmittedItem\n");
      }
