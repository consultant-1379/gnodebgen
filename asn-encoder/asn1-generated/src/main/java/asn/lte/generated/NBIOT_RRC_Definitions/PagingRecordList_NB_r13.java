...
public class PagingRecordList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PagingRecordList-NB-r13";
   }

   public PagingRecord_NB_r13[] elements;

   public PagingRecordList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PagingRecordList_NB_r13 (int numRecords) {
      elements = new PagingRecord_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public PagingRecordList_NB_r13 (PagingRecord_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PagingRecord_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PagingRecord_NB_r13();
