...
public class UERadioCapabilityMatchResponse_protocolIEs extends Asn1SeqOf {
   ...
   public UERadioCapabilityMatchResponse_protocolIEs_element[] elements;

   public UERadioCapabilityMatchResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UERadioCapabilityMatchResponse_protocolIEs (int numRecords) {
      elements = new UERadioCapabilityMatchResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UERadioCapabilityMatchResponse_protocolIEs (UERadioCapabilityMatchResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UERadioCapabilityMatchResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UERadioCapabilityMatchResponse_protocolIEs_element();
