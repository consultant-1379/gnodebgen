...
public class MeasResultIdleNR_r16_measResultsPerCarrierListIdleNR_r16 extends Asn1SeqOf {
   ...
   public MeasResultsPerCarrierIdleNR_r16[] elements;

   public MeasResultIdleNR_r16_measResultsPerCarrierListIdleNR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultIdleNR_r16_measResultsPerCarrierListIdleNR_r16 (int numRecords) {
      elements = new MeasResultsPerCarrierIdleNR_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultIdleNR_r16_measResultsPerCarrierListIdleNR_r16 (MeasResultsPerCarrierIdleNR_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultsPerCarrierIdleNR_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultsPerCarrierIdleNR_r16();
