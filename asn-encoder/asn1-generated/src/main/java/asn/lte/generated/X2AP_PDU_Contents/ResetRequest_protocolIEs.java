...
public class ResetRequest_protocolIEs extends Asn1SeqOf {
   ...
   public ResetRequest_protocolIEs_element[] elements;

   public ResetRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResetRequest_protocolIEs (int numRecords) {
      elements = new ResetRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ResetRequest_protocolIEs (ResetRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResetRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResetRequest_protocolIEs_element();
