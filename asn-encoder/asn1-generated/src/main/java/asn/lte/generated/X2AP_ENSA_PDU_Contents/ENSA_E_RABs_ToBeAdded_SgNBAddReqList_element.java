...
public class ENSA_E_RABs_ToBeAdded_SgNBAddReqList_element extends Asn1Seq {
   ...
   /**
    * id: xid-E-RABs-ToBeAdded-SgNBAddReq-Item
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: ENSA-E-RABs-ToBeAdded-SgNBAddReq-Item
    * Java type: ENSA_E_RABs_ToBeAdded_SgNBAddReq_Item
    */
   public Asn1Type value;

   public ENSA_E_RABs_ToBeAdded_SgNBAddReqList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENSA_E_RABs_ToBeAdded_SgNBAddReqList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key xid-E-RABs-ToBeAdded-SgNBAddReq-Item
    */
   public void setUsing_xid_E_RABs_ToBeAdded_SgNBAddReq_Item(ENSA_E_RABs_ToBeAdded_SgNBAddReq_Item value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_ENSA_Constants._X2AP_ENSA_ConstantsValues.xid_E_RABs_ToBeAdded_SgNBAddReq_Item);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key xid-E-RABs-ToBeAdded-SgNBAddReq-Item
    */
   public ENSA_E_RABs_ToBeAdded_SgNBAddReq_Item getValueFor_xid_E_RABs_ToBeAdded_SgNBAddReq_Item() {
      return (ENSA_E_RABs_ToBeAdded_SgNBAddReq_Item) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_ENSA_PDU_ContentsValues.ENSA_E_RABs_ToBeAdded_SgNBAddReq_ItemIEs.length; i++) {
         if(_X2AP_ENSA_PDU_ContentsValues.ENSA_E_RABs_ToBeAdded_SgNBAddReq_ItemIEs[i].id.equals(id)) {
            _index = _X2AP_ENSA_PDU_ContentsValues.ENSA_E_RABs_ToBeAdded_SgNBAddReq_ItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 5136) {
         indent (_sb, _level+1);
         _sb.append("id = xid-E-RABs-ToBeAdded-SgNBAddReq-Item\n");
      }
