...
public class SupportedBandCombination_v1470 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-v1470";
   }

   public BandCombinationParameters_v1470[] elements;

   public SupportedBandCombination_v1470 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_v1470 (int numRecords) {
    ...
    * given the array.  
    */
   public SupportedBandCombination_v1470 (BandCombinationParameters_v1470[] elements_) {
      elements = elements_;
   }
