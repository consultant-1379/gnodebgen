...
public class UEAppLayerMeasConfig_iE_Extensions extends Asn1SeqOf {
   ...
   public UEAppLayerMeasConfig_iE_Extensions_element[] elements;

   public UEAppLayerMeasConfig_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEAppLayerMeasConfig_iE_Extensions (int numRecords) {
      elements = new UEAppLayerMeasConfig_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEAppLayerMeasConfig_iE_Extensions (UEAppLayerMeasConfig_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEAppLayerMeasConfig_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEAppLayerMeasConfig_iE_Extensions_element();
