...
public class CQI_ReportPeriodicProcExtToAddModList_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CQI-ReportPeriodicProcExtToAddModList-r11";
   }

   public CQI_ReportPeriodicProcExt_r11[] elements;

   public CQI_ReportPeriodicProcExtToAddModList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CQI_ReportPeriodicProcExtToAddModList_r11 (int numRecords) {
      elements = new CQI_ReportPeriodicProcExt_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public CQI_ReportPeriodicProcExtToAddModList_r11 (CQI_ReportPeriodicProcExt_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CQI_ReportPeriodicProcExt_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CQI_ReportPeriodicProcExt_r11();
