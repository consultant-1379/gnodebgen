...
public class HandoverPreparationInformation_NB_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _HANDOVERPREPARATIONINFORMATION_R13 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public HandoverPreparationInformation_NB_criticalExtensions_c1 () {
      super();
   }

   public HandoverPreparationInformation_NB_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _HANDOVERPREPARATIONINFORMATION_R13: return "handoverPreparationInformation_r13";
   ...
   public void set_handoverPreparationInformation_r13 (HandoverPreparationInformation_NB_IEs value) {
      setElement (_HANDOVERPREPARATIONINFORMATION_R13, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         // handoverPreparationInformation_r13
         case 0: { 
            HandoverPreparationInformation_NB_IEs handoverPreparationInformation_r13;
            element = handoverPreparationInformation_r13 = new HandoverPreparationInformation_NB_IEs();
            handoverPreparationInformation_r13.decode (buffer);
            break;
         }
