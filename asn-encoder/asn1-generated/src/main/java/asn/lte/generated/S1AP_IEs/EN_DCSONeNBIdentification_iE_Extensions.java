...
public class EN_DCSONeNBIdentification_iE_Extensions extends Asn1SeqOf {
   ...
   public EN_DCSONeNBIdentification_iE_Extensions_element[] elements;

   public EN_DCSONeNBIdentification_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public EN_DCSONeNBIdentification_iE_Extensions (int numRecords) {
      elements = new EN_DCSONeNBIdentification_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EN_DCSONeNBIdentification_iE_Extensions (EN_DCSONeNBIdentification_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EN_DCSONeNBIdentification_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EN_DCSONeNBIdentification_iE_Extensions_element();
