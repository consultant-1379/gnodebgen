...
public class BlackCellsToAddModList extends Asn1SeqOf {
   ...
   public BlackCellsToAddMod[] elements;
    ...
    * populated.
    */
   public BlackCellsToAddModList (int numRecords) {
      elements = new BlackCellsToAddMod [numRecords];
   }
    ...
    * given the array.  
    */
   public BlackCellsToAddModList (BlackCellsToAddMod[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BlackCellsToAddMod [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BlackCellsToAddMod();
