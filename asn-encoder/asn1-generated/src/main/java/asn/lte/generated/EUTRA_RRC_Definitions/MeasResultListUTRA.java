...
public class MeasResultListUTRA extends Asn1SeqOf {
   ...
   public MeasResultUTRA[] elements;

   public MeasResultListUTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListUTRA (int numRecords) {
      elements = new MeasResultUTRA [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListUTRA (MeasResultUTRA[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultUTRA [numElements];
