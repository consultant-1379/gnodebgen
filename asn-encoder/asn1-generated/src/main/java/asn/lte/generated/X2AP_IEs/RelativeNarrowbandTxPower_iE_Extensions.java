...
public class RelativeNarrowbandTxPower_iE_Extensions extends Asn1SeqOf {
   ...
   public RelativeNarrowbandTxPower_iE_Extensions_element[] elements;

   public RelativeNarrowbandTxPower_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RelativeNarrowbandTxPower_iE_Extensions (int numRecords) {
      elements = new RelativeNarrowbandTxPower_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RelativeNarrowbandTxPower_iE_Extensions (RelativeNarrowbandTxPower_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RelativeNarrowbandTxPower_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RelativeNarrowbandTxPower_iE_Extensions_element();
