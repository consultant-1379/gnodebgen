...
public class ServedCellsToActivate_Item extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "ServedCellsToActivate-Item";
   }

   public ECGI ecgi;
   public ServedCellsToActivate_Item_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public ServedCellsToActivate_Item () {
      super();
      init();
   }
   ...
   public ServedCellsToActivate_Item (
      ECGI ecgi_,
      ServedCellsToActivate_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      ecgi = ecgi_;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new ServedCellsToActivate_Item_iE_Extensions();
