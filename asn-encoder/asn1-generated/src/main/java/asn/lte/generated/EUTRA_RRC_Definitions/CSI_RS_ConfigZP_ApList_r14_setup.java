...
public class CSI_RS_ConfigZP_ApList_r14_setup extends Asn1SeqOf {
   ...
   public CSI_RS_ConfigZP_ApList_r14_setup () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_ConfigZP_ApList_r14_setup (int numRecords) {
    ...
    * given the array.  
    */
   public CSI_RS_ConfigZP_ApList_r14_setup (CSI_RS_ConfigZP_r11[] elements_) {
      elements = elements_;
   }
