...
public class AffectedCarrierFreqComb_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AffectedCarrierFreqComb-r13";
   }

   public MeasObjectId_r13[] elements;

   public AffectedCarrierFreqComb_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AffectedCarrierFreqComb_r13 (int numRecords) {
      elements = new MeasObjectId_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public AffectedCarrierFreqComb_r13 (MeasObjectId_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasObjectId_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasObjectId_r13();
