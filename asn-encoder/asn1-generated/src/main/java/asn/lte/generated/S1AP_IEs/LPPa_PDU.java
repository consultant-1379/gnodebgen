...
public class LPPa_PDU extends Asn1OctetString {
    ...
    */
   public LPPa_PDU (byte[] data, int offset, int nbytes) {
    ...
    */
   public LPPa_PDU (String value_) throws Asn1ValueParseException {
      super (value_);
   }
