...
public class InterFreqBlackCellList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqBlackCellList-NB-r13";
   }

   public PhysCellId[] elements;

   public InterFreqBlackCellList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqBlackCellList_NB_r13 (int numRecords) {
    ...
    * given the array.  
    */
   public InterFreqBlackCellList_NB_r13 (PhysCellId[] elements_) {
      elements = elements_;
   }
