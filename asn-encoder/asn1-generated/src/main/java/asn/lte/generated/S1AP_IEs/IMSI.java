...
public class IMSI extends Asn1OctetString {
    ...
    */
   public IMSI (byte[] data, int offset, int nbytes) {
    ...
    */
   public IMSI (String value_) throws Asn1ValueParseException {
      super (value_);
   }
