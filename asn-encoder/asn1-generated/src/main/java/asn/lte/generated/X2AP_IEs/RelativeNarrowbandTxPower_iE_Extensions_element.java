...
public class RelativeNarrowbandTxPower_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: EnhancedRNTP
    * Java type: EnhancedRNTP
    */
   public Asn1Type extensionValue;

   public RelativeNarrowbandTxPower_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public RelativeNarrowbandTxPower_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-enhancedRNTP
    */
   public void setUsing_id_enhancedRNTP(EnhancedRNTP extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_enhancedRNTP);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-enhancedRNTP
    */
   public EnhancedRNTP getExtensionValueFor_id_enhancedRNTP() {
      return (EnhancedRNTP) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.RelativeNarrowbandTxPower_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.RelativeNarrowbandTxPower_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.RelativeNarrowbandTxPower_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
