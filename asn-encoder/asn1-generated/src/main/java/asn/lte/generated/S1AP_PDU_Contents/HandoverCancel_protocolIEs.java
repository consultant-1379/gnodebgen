...
public class HandoverCancel_protocolIEs extends Asn1SeqOf {
   ...
   public HandoverCancel_protocolIEs_element[] elements;

   public HandoverCancel_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public HandoverCancel_protocolIEs (int numRecords) {
      elements = new HandoverCancel_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public HandoverCancel_protocolIEs (HandoverCancel_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HandoverCancel_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new HandoverCancel_protocolIEs_element();
