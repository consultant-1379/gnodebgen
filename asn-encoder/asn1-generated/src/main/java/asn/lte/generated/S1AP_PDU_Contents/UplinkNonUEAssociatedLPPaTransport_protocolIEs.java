...
public class UplinkNonUEAssociatedLPPaTransport_protocolIEs extends Asn1SeqOf {
   ...
   public UplinkNonUEAssociatedLPPaTransport_protocolIEs_element[] elements;

   public UplinkNonUEAssociatedLPPaTransport_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UplinkNonUEAssociatedLPPaTransport_protocolIEs (int numRecords) {
      elements = new UplinkNonUEAssociatedLPPaTransport_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UplinkNonUEAssociatedLPPaTransport_protocolIEs (UplinkNonUEAssociatedLPPaTransport_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UplinkNonUEAssociatedLPPaTransport_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UplinkNonUEAssociatedLPPaTransport_protocolIEs_element();
