...
public class ECGI_iE_Extensions extends Asn1SeqOf {
   ...
   public ECGI_iE_Extensions_element[] elements;

   public ECGI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ECGI_iE_Extensions (int numRecords) {
      elements = new ECGI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ECGI_iE_Extensions (ECGI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ECGI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ECGI_iE_Extensions_element();
