...
public class RAND_CDMA2000 extends Asn1BitString {
    ...
    */
   public RAND_CDMA2000 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public RAND_CDMA2000 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public RAND_CDMA2000 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public RAND_CDMA2000 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public RAND_CDMA2000 (java.util.BitSet bitSet) {
      super (bitSet);
   }
