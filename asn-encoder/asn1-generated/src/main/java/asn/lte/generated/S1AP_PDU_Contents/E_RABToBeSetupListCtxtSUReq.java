...
public class E_RABToBeSetupListCtxtSUReq extends Asn1SeqOf {
   ...
   public E_RABToBeSetupListCtxtSUReq_element[] elements;

   public E_RABToBeSetupListCtxtSUReq () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABToBeSetupListCtxtSUReq (int numRecords) {
      elements = new E_RABToBeSetupListCtxtSUReq_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABToBeSetupListCtxtSUReq (E_RABToBeSetupListCtxtSUReq_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABToBeSetupListCtxtSUReq_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABToBeSetupListCtxtSUReq_element();
