...
public class SecurityModeFailure_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SecurityModeFailure-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public SecurityModeFailure_IEs_nonCriticalExtension nonCriticalExtension;  // optional

   public SecurityModeFailure_IEs () {
      super();
      init();
   }
   ...
   public SecurityModeFailure_IEs (
      ...
      SecurityModeFailure_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public SecurityModeFailure_IEs (byte[] lateNonCriticalExtension_,
      SecurityModeFailure_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new SecurityModeFailure_IEs_nonCriticalExtension();
