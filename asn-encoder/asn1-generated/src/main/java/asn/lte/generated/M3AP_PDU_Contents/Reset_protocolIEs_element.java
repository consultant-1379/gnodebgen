...
public class Reset_protocolIEs_element extends Asn1Seq {
    ...
    * presence: Presence.mandatory
    * ASN.1 type: ResetType
    * Java type: ResetType
    */
   public Asn1Type value;

   public Reset_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public Reset_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-ResetType
    */
   public void setUsing_id_ResetType(ResetType value) {
      this.id = new asn.lte.generated.M3AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.M3AP_Constants._M3AP_ConstantsValues.id_ResetType);
   ...
   /**
    * Get value of value with type set according to information object having key id-ResetType
    */
   public ResetType getValueFor_id_ResetType() {
      return (ResetType) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _M3AP_PDU_ContentsValues.ResetIEs.length; i++) {
         if(_M3AP_PDU_ContentsValues.ResetIEs[i].id.equals(id)) {
            _index = _M3AP_PDU_ContentsValues.ResetIEs[i];
            break;
         }
      }
      if (null == _index) {
