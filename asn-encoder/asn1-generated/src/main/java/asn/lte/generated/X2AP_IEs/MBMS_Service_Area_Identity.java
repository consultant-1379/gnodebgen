...
public class MBMS_Service_Area_Identity extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "MBMS-Service-Area-Identity";
   }

   public MBMS_Service_Area_Identity () {
      super();
   }
    ...
    *              in binary form.
    */
   public MBMS_Service_Area_Identity (byte[] data) {
      super (data);
   }
    ...
    */
   public MBMS_Service_Area_Identity (byte[] data, int offset, int nbytes) {
    ...
    */
   public MBMS_Service_Area_Identity (String value_) throws Asn1ValueParseException {
      super (value_);
   }
