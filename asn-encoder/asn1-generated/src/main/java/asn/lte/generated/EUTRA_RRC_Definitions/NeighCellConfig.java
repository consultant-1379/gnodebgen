...
public class NeighCellConfig extends Asn1BitString {
    ...
    */
   public NeighCellConfig (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public NeighCellConfig (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public NeighCellConfig (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public NeighCellConfig (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public NeighCellConfig (java.util.BitSet bitSet) {
      super (bitSet);
   }
