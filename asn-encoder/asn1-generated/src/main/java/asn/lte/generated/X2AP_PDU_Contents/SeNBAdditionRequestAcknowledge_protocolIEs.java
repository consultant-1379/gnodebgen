...
public class SeNBAdditionRequestAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBAdditionRequestAcknowledge_protocolIEs_element[] elements;

   public SeNBAdditionRequestAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBAdditionRequestAcknowledge_protocolIEs (int numRecords) {
      elements = new SeNBAdditionRequestAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBAdditionRequestAcknowledge_protocolIEs (SeNBAdditionRequestAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBAdditionRequestAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBAdditionRequestAcknowledge_protocolIEs_element();
