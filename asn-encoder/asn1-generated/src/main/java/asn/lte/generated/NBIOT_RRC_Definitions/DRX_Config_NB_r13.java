...
public class DRX_Config_NB_r13 extends Asn1Choice {
   ...
   public DRX_Config_NB_r13 () {
      super();
   }

   public DRX_Config_NB_r13 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (DRX_Config_NB_r13_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            DRX_Config_NB_r13_setup setup;
            element = setup = new DRX_Config_NB_r13_setup();
            setup.decode (buffer);
            break;
         }
