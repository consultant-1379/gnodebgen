...
public class NRFreqInfo_freqBandListNr extends Asn1SeqOf {
   ...
   public FreqBandNrItem[] elements;

   public NRFreqInfo_freqBandListNr () {
      elements = null;
   }
    ...
    * populated.
    */
   public NRFreqInfo_freqBandListNr (int numRecords) {
      elements = new FreqBandNrItem [numRecords];
   }
    ...
    * given the array.  
    */
   public NRFreqInfo_freqBandListNr (FreqBandNrItem[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqBandNrItem [numElements];
