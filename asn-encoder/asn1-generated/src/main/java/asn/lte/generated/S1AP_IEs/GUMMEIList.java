...
public class GUMMEIList extends Asn1SeqOf {
    ...
    * populated.
    */
   public GUMMEIList (int numRecords) {
      elements = new GUMMEI [numRecords];
   }
    ...
    * given the array.  
    */
   public GUMMEIList (GUMMEI[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GUMMEI [numElements];
