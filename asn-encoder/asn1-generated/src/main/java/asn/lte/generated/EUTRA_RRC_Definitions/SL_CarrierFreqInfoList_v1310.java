...
public class SL_CarrierFreqInfoList_v1310 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-CarrierFreqInfoList-v1310";
   }

   public SL_CarrierFreqInfo_v1310[] elements;

   public SL_CarrierFreqInfoList_v1310 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_CarrierFreqInfoList_v1310 (int numRecords) {
      elements = new SL_CarrierFreqInfo_v1310 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_CarrierFreqInfoList_v1310 (SL_CarrierFreqInfo_v1310[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_CarrierFreqInfo_v1310 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_CarrierFreqInfo_v1310();
