...
public class RetrieveUEContextResponse_protocolIEs extends Asn1SeqOf {
   ...
   public RetrieveUEContextResponse_protocolIEs_element[] elements;

   public RetrieveUEContextResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public RetrieveUEContextResponse_protocolIEs (int numRecords) {
      elements = new RetrieveUEContextResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RetrieveUEContextResponse_protocolIEs (RetrieveUEContextResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RetrieveUEContextResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RetrieveUEContextResponse_protocolIEs_element();
