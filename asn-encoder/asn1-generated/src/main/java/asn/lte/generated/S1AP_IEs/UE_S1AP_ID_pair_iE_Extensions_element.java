...
public class UE_S1AP_ID_pair_iE_Extensions_element extends Asn1Seq {
   ...
   public UE_S1AP_ID_pair_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UE_S1AP_ID_pair_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.UE_S1AP_ID_pair_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.UE_S1AP_ID_pair_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.UE_S1AP_ID_pair_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
