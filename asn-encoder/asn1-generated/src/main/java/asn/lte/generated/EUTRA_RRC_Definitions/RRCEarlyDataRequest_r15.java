...
public class RRCEarlyDataRequest_r15 extends Asn1Seq {
   ...
   public RRCEarlyDataRequest_r15_criticalExtensions criticalExtensions;

   public RRCEarlyDataRequest_r15 () {
      super();
      init();
   }
    ...
    */
   public RRCEarlyDataRequest_r15 (
      RRCEarlyDataRequest_r15_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCEarlyDataRequest_r15_criticalExtensions();
