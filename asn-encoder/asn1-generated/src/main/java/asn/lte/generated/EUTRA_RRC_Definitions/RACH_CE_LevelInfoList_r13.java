...
public class RACH_CE_LevelInfoList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RACH-CE-LevelInfoList-r13";
   }

   public RACH_CE_LevelInfo_r13[] elements;

   public RACH_CE_LevelInfoList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RACH_CE_LevelInfoList_r13 (int numRecords) {
      elements = new RACH_CE_LevelInfo_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public RACH_CE_LevelInfoList_r13 (RACH_CE_LevelInfo_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RACH_CE_LevelInfo_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RACH_CE_LevelInfo_r13();
