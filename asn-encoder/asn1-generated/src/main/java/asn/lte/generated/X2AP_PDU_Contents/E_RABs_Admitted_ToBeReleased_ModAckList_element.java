...
public class E_RABs_Admitted_ToBeReleased_ModAckList_element extends Asn1Seq {
   ...
   /**
    * id: id-E-RABs-Admitted-ToBeReleased-ModAckItem
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABs-Admitted-ToReleased-ModAckItem
    * Java type: E_RABs_Admitted_ToReleased_ModAckItem
    */
   public Asn1Type value;

   public E_RABs_Admitted_ToBeReleased_ModAckList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABs_Admitted_ToBeReleased_ModAckList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-Admitted-ToBeReleased-ModAckItem
    */
   public void setUsing_id_E_RABs_Admitted_ToBeReleased_ModAckItem(E_RABs_Admitted_ToReleased_ModAckItem value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_Admitted_ToBeReleased_ModAckItem);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABs-Admitted-ToBeReleased-ModAckItem
    */
   public E_RABs_Admitted_ToReleased_ModAckItem getValueFor_id_E_RABs_Admitted_ToBeReleased_ModAckItem() {
      return (E_RABs_Admitted_ToReleased_ModAckItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.E_RABs_Admitted_ToBeReleased_ModAckItemIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.E_RABs_Admitted_ToBeReleased_ModAckItemIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.E_RABs_Admitted_ToBeReleased_ModAckItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 133) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-Admitted-ToBeReleased-ModAckItem\n");
      }
