...
public class CellIdentityNR_r15 extends Asn1BitString {
    ...
    */
   public CellIdentityNR_r15 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public CellIdentityNR_r15 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public CellIdentityNR_r15 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public CellIdentityNR_r15 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public CellIdentityNR_r15 (java.util.BitSet bitSet) {
      super (bitSet);
   }
