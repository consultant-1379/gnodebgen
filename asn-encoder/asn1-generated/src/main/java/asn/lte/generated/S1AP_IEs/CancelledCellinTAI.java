...
public class CancelledCellinTAI extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CancelledCellinTAI";
   }

   public CancelledCellinTAI_Item[] elements;

   public CancelledCellinTAI () {
      elements = null;
   }
    ...
    * populated.
    */
   public CancelledCellinTAI (int numRecords) {
      elements = new CancelledCellinTAI_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public CancelledCellinTAI (CancelledCellinTAI_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CancelledCellinTAI_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CancelledCellinTAI_Item();
