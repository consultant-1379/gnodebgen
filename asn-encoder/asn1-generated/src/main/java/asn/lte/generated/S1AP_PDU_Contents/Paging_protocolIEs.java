...
public class Paging_protocolIEs extends Asn1SeqOf {
   ...
   public Paging_protocolIEs_element[] elements;

   public Paging_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public Paging_protocolIEs (int numRecords) {
      elements = new Paging_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public Paging_protocolIEs (Paging_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Paging_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Paging_protocolIEs_element();
