...
public class GlobalGNB_ID_iE_Extensions extends Asn1SeqOf {
   ...
   public GlobalGNB_ID_iE_Extensions_element[] elements;

   public GlobalGNB_ID_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public GlobalGNB_ID_iE_Extensions (int numRecords) {
      elements = new GlobalGNB_ID_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public GlobalGNB_ID_iE_Extensions (GlobalGNB_ID_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GlobalGNB_ID_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GlobalGNB_ID_iE_Extensions_element();
