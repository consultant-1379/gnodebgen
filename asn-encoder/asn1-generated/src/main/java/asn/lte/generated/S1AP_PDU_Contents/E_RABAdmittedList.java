...
public class E_RABAdmittedList extends Asn1SeqOf {
   ...
   public E_RABAdmittedList_element[] elements;

   public E_RABAdmittedList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABAdmittedList (int numRecords) {
      elements = new E_RABAdmittedList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABAdmittedList (E_RABAdmittedList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABAdmittedList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABAdmittedList_element();
