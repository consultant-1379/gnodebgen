...
public class CSI_RS_ConfigNZPToReleaseListExt_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSI-RS-ConfigNZPToReleaseListExt-r13";
   }

   public CSI_RS_ConfigNZPId_v1310[] elements;

   public CSI_RS_ConfigNZPToReleaseListExt_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_ConfigNZPToReleaseListExt_r13 (int numRecords) {
      elements = new CSI_RS_ConfigNZPId_v1310 [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_RS_ConfigNZPToReleaseListExt_r13 (CSI_RS_ConfigNZPId_v1310[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 21);
      int numElements = (int) buffer.decodeLength();

      elements = new CSI_RS_ConfigNZPId_v1310 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_RS_ConfigNZPId_v1310();
