...
public class ServedCell_Information_iE_Extensions extends Asn1SeqOf {
   ...
   public ServedCell_Information_iE_Extensions_element[] elements;

   public ServedCell_Information_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedCell_Information_iE_Extensions (int numRecords) {
      elements = new ServedCell_Information_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedCell_Information_iE_Extensions (ServedCell_Information_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedCell_Information_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedCell_Information_iE_Extensions_element();
