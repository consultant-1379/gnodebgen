...
public class CSGMembershipInfo_iE_Extensions extends Asn1SeqOf {
   ...
   public CSGMembershipInfo_iE_Extensions_element[] elements;

   public CSGMembershipInfo_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSGMembershipInfo_iE_Extensions (int numRecords) {
      elements = new CSGMembershipInfo_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CSGMembershipInfo_iE_Extensions (CSGMembershipInfo_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSGMembershipInfo_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSGMembershipInfo_iE_Extensions_element();
