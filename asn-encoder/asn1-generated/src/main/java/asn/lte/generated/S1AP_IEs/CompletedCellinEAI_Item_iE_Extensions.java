...
public class CompletedCellinEAI_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public CompletedCellinEAI_Item_iE_Extensions_element[] elements;

   public CompletedCellinEAI_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CompletedCellinEAI_Item_iE_Extensions (int numRecords) {
      elements = new CompletedCellinEAI_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CompletedCellinEAI_Item_iE_Extensions (CompletedCellinEAI_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CompletedCellinEAI_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CompletedCellinEAI_Item_iE_Extensions_element();
