...
import asn.lte.generated.LPPA_CommonDataTypes.PrivateIE_ID;
...
public class PrivateMessage_privateIEs_element extends Asn1Seq {
   ...
   {
      /* check id */
      asn.lte.generated.LPPA_Containers.LPPA_PRIVATE_IES _index = null;
      for(int i=0; i < _LPPA_PDU_ContentsValues.PrivateMessage_IEs.length; i++) {
         if(_LPPA_PDU_ContentsValues.PrivateMessage_IEs[i].id.equals(id)) {
            _index = _LPPA_PDU_ContentsValues.PrivateMessage_IEs[i];
            break;
         }
      }
      if (null == _index) {
