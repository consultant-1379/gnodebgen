...
public class ErrorIndication_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * Assign fields according to information object having key id-Old-SgNB-UE-X2AP-ID
    */
   public void setUsing_id_Old_SgNB_UE_X2AP_ID(asn.lte.generated.X2AP_IEs.SgNB_UE_X2AP_ID value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_Old_SgNB_UE_X2AP_ID);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-Old-SgNB-UE-X2AP-ID
    */
   public asn.lte.generated.X2AP_IEs.SgNB_UE_X2AP_ID getValueFor_id_Old_SgNB_UE_X2AP_ID() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ErrorIndication_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ErrorIndication_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ErrorIndication_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 10) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-Old-SgNB-UE-X2AP-ID\n");
      }
