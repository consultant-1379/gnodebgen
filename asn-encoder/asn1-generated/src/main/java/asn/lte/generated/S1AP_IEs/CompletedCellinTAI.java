...
public class CompletedCellinTAI extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CompletedCellinTAI";
   }

   public CompletedCellinTAI_Item[] elements;

   public CompletedCellinTAI () {
      elements = null;
   }
    ...
    * populated.
    */
   public CompletedCellinTAI (int numRecords) {
      elements = new CompletedCellinTAI_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public CompletedCellinTAI (CompletedCellinTAI_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CompletedCellinTAI_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CompletedCellinTAI_Item();
