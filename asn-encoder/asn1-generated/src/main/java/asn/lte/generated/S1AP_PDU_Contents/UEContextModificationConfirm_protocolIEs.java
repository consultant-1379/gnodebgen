...
public class UEContextModificationConfirm_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextModificationConfirm_protocolIEs_element[] elements;

   public UEContextModificationConfirm_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextModificationConfirm_protocolIEs (int numRecords) {
      elements = new UEContextModificationConfirm_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextModificationConfirm_protocolIEs (UEContextModificationConfirm_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextModificationConfirm_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextModificationConfirm_protocolIEs_element();
