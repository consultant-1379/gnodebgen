...
public class SeNBReleaseRequest_protocolIEs_element extends Asn1Seq {
    ...
    * Java type: Cause
    *
    * id: id-E-RABs-ToBeReleased-List-RelReq
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: E-RABs-ToBeReleased-List-RelReq
    * Java type: E_RABs_ToBeReleased_List_RelReq
    *
    ...
    * Java type: UE_X2AP_ID_Extension
    *
    * id: id-MakeBeforeBreakIndicator
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: MakeBeforeBreakIndicator
    * Java type: MakeBeforeBreakIndicator
    */
   public Asn1Type value;

   public SeNBReleaseRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SeNBReleaseRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-ToBeReleased-List-RelReq
    */
   public void setUsing_id_E_RABs_ToBeReleased_List_RelReq(E_RABs_ToBeReleased_List_RelReq value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_ToBeReleased_List_RelReq);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Assign fields according to information object having key id-MakeBeforeBreakIndicator
    */
   public void setUsing_id_MakeBeforeBreakIndicator(asn.lte.generated.X2AP_IEs.MakeBeforeBreakIndicator value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_MakeBeforeBreakIndicator);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-ToBeReleased-List-RelReq
    */
   public E_RABs_ToBeReleased_List_RelReq getValueFor_id_E_RABs_ToBeReleased_List_RelReq() {
      return (E_RABs_ToBeReleased_List_RelReq) this.value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-MakeBeforeBreakIndicator
    */
   public asn.lte.generated.X2AP_IEs.MakeBeforeBreakIndicator getValueFor_id_MakeBeforeBreakIndicator() {
      return (asn.lte.generated.X2AP_IEs.MakeBeforeBreakIndicator) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SeNBReleaseRequest_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SeNBReleaseRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SeNBReleaseRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-ToBeReleased-List-RelReq\n");
      }
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-MakeBeforeBreakIndicator\n");
      }
