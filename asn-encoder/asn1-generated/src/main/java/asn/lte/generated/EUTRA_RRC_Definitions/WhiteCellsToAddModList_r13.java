...
public class WhiteCellsToAddModList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "WhiteCellsToAddModList-r13";
   }

   public WhiteCellsToAddMod_r13[] elements;

   public WhiteCellsToAddModList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public WhiteCellsToAddModList_r13 (int numRecords) {
      elements = new WhiteCellsToAddMod_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public WhiteCellsToAddModList_r13 (WhiteCellsToAddMod_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WhiteCellsToAddMod_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new WhiteCellsToAddMod_r13();
