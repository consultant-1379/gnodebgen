...
public class ActivatedCellList_Item extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "ActivatedCellList-Item";
   }

   public ECGI ecgi;
   public ActivatedCellList_Item_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public ActivatedCellList_Item () {
      super();
      init();
   }
   ...
   public ActivatedCellList_Item (
      ECGI ecgi_,
      ActivatedCellList_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      ecgi = ecgi_;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new ActivatedCellList_Item_iE_Extensions();
