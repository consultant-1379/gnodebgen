...
public class UEAssistanceInformation extends Asn1Seq {
   ...
   public UEAssistanceInformation_criticalExtensions criticalExtensions;

   public UEAssistanceInformation () {
      super();
      init();
   }
    ...
    */
   public UEAssistanceInformation (
      UEAssistanceInformation_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new UEAssistanceInformation_criticalExtensions();
