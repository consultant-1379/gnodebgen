...
public class EAB_CoveringCell_UE_Throughput_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-CoveringCell-UE-Throughput-List";
   }

   public EAB_CoveringCell_UE_Throughput_Item[] elements;

   public EAB_CoveringCell_UE_Throughput_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_CoveringCell_UE_Throughput_List (int numRecords) {
      elements = new EAB_CoveringCell_UE_Throughput_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_CoveringCell_UE_Throughput_List (EAB_CoveringCell_UE_Throughput_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_CoveringCell_UE_Throughput_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_CoveringCell_UE_Throughput_Item();
