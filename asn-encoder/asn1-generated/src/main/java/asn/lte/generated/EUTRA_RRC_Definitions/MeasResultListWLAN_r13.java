...
public class MeasResultListWLAN_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultListWLAN-r13";
   }

   public MeasResultWLAN_r13[] elements;

   public MeasResultListWLAN_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListWLAN_r13 (int numRecords) {
      elements = new MeasResultWLAN_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListWLAN_r13 (MeasResultWLAN_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultWLAN_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultWLAN_r13();
