...
public class SoundingRS_AperiodicSetUpPTsExt_r14_srs_CC_SetIndexList_r14 extends Asn1SeqOf {
   ...
   public SRS_CC_SetIndex_r14[] elements;

   public SoundingRS_AperiodicSetUpPTsExt_r14_srs_CC_SetIndexList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SoundingRS_AperiodicSetUpPTsExt_r14_srs_CC_SetIndexList_r14 (int numRecords) {
      elements = new SRS_CC_SetIndex_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public SoundingRS_AperiodicSetUpPTsExt_r14_srs_CC_SetIndexList_r14 (SRS_CC_SetIndex_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRS_CC_SetIndex_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRS_CC_SetIndex_r14();
