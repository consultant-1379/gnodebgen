...
public class UplinkS1cdma2000tunnelling_protocolIEs extends Asn1SeqOf {
   ...
   public UplinkS1cdma2000tunnelling_protocolIEs_element[] elements;

   public UplinkS1cdma2000tunnelling_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UplinkS1cdma2000tunnelling_protocolIEs (int numRecords) {
      elements = new UplinkS1cdma2000tunnelling_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UplinkS1cdma2000tunnelling_protocolIEs (UplinkS1cdma2000tunnelling_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UplinkS1cdma2000tunnelling_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UplinkS1cdma2000tunnelling_protocolIEs_element();
