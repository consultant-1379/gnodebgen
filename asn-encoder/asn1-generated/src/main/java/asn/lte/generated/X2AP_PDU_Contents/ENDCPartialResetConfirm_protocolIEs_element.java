...
public class ENDCPartialResetConfirm_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-UEs-Admitted-ToBeReset
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: UEsToBeResetList
    * Java type: UEsToBeResetList
    *
   ...
   public ENDCPartialResetConfirm_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCPartialResetConfirm_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-UEs-Admitted-ToBeReset
    */
   public void setUsing_id_UEs_Admitted_ToBeReset(asn.lte.generated.X2AP_IEs.UEsToBeResetList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_UEs_Admitted_ToBeReset);
   ...
   /**
    * Get value of value with type set according to information object having key id-UEs-Admitted-ToBeReset
    */
   public asn.lte.generated.X2AP_IEs.UEsToBeResetList getValueFor_id_UEs_Admitted_ToBeReset() {
      return (asn.lte.generated.X2AP_IEs.UEsToBeResetList) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCPartialResetConfirm_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCPartialResetConfirm_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCPartialResetConfirm_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 271) {
         indent (_sb, _level+1);
         _sb.append("id = id-UEs-Admitted-ToBeReset\n");
      }
