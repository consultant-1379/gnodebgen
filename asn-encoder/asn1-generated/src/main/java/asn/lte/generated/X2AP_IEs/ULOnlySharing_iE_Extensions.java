...
public class ULOnlySharing_iE_Extensions extends Asn1SeqOf {
   ...
   public ULOnlySharing_iE_Extensions_element[] elements;

   public ULOnlySharing_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ULOnlySharing_iE_Extensions (int numRecords) {
      elements = new ULOnlySharing_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ULOnlySharing_iE_Extensions (ULOnlySharing_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ULOnlySharing_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ULOnlySharing_iE_Extensions_element();
