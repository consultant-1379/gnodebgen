...
public class RedistributionNeighCellList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RedistributionNeighCellList-r13";
   }

   public RedistributionNeighCell_r13[] elements;

   public RedistributionNeighCellList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RedistributionNeighCellList_r13 (int numRecords) {
      elements = new RedistributionNeighCell_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public RedistributionNeighCellList_r13 (RedistributionNeighCell_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RedistributionNeighCell_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RedistributionNeighCell_r13();
