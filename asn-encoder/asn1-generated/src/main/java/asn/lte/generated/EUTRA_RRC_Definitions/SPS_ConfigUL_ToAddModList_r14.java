...
public class SPS_ConfigUL_ToAddModList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPS-ConfigUL-ToAddModList-r14";
   }

   public SPS_ConfigUL[] elements;

   public SPS_ConfigUL_ToAddModList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPS_ConfigUL_ToAddModList_r14 (int numRecords) {
    ...
    * given the array.  
    */
   public SPS_ConfigUL_ToAddModList_r14 (SPS_ConfigUL[] elements_) {
      elements = elements_;
   }
