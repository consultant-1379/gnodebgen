...
public class SIB8_PerPLMN_List_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SIB8-PerPLMN-List-r11";
   }

   public SIB8_PerPLMN_r11[] elements;

   public SIB8_PerPLMN_List_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SIB8_PerPLMN_List_r11 (int numRecords) {
      elements = new SIB8_PerPLMN_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public SIB8_PerPLMN_List_r11 (SIB8_PerPLMN_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SIB8_PerPLMN_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SIB8_PerPLMN_r11();
