...
public class RerouteNASRequest_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: Additional-GUTI
    * Java type: Additional_GUTI
    *
    * id: id-UE-Usage-Type
    * criticality: Criticality.ignore
    * presence: Presence.optional
   ...
   public RerouteNASRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public RerouteNASRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-S1-Message
    */
   public void setUsing_id_S1_Message(Asn1OctetString value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_S1_Message);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }
   ...
   /**
    * Assign fields according to information object having key id-Additional-GUTI
    */
   public void setUsing_id_Additional_GUTI(asn.lte.generated.S1AP_IEs.Additional_GUTI value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_Additional_GUTI);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-S1-Message
    */
   public Asn1OctetString getValueFor_id_S1_Message() {
   ...
   /**
    * Get value of value with type set according to information object having key id-Additional-GUTI
    */
   public asn.lte.generated.S1AP_IEs.Additional_GUTI getValueFor_id_Additional_GUTI() {
      return (asn.lte.generated.S1AP_IEs.Additional_GUTI) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.RerouteNASRequest_IEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.RerouteNASRequest_IEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.RerouteNASRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 8) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-S1-Message\n");
      }
      else if (id.value == 223) {
         indent (_sb, _level+1);
         _sb.append("id = id-MME-Group-ID\n");
      }
      else if (id.value == 224) {
         indent (_sb, _level+1);
         _sb.append("id = id-Additional-GUTI\n");
      }
