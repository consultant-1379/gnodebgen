...
public class MeasuredResults extends Asn1SeqOf {
   ...
   public MeasuredResultsValue[] elements;
    ...
    * populated.
    */
   public MeasuredResults (int numRecords) {
      elements = new MeasuredResultsValue [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasuredResults (MeasuredResultsValue[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasuredResultsValue [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasuredResultsValue();
