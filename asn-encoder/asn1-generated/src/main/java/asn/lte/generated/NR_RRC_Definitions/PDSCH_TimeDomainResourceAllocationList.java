...
public class PDSCH_TimeDomainResourceAllocationList extends Asn1SeqOf {
   ...
   public PDSCH_TimeDomainResourceAllocation[] elements;

   public PDSCH_TimeDomainResourceAllocationList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDSCH_TimeDomainResourceAllocationList (int numRecords) {
      elements = new PDSCH_TimeDomainResourceAllocation [numRecords];
   }
    ...
    * given the array.  
    */
   public PDSCH_TimeDomainResourceAllocationList (PDSCH_TimeDomainResourceAllocation[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PDSCH_TimeDomainResourceAllocation [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PDSCH_TimeDomainResourceAllocation();
