...
public class CellBasedQMC_iE_Extensions extends Asn1SeqOf {
   ...
   public CellBasedQMC_iE_Extensions_element[] elements;

   public CellBasedQMC_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellBasedQMC_iE_Extensions (int numRecords) {
      elements = new CellBasedQMC_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellBasedQMC_iE_Extensions (CellBasedQMC_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellBasedQMC_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellBasedQMC_iE_Extensions_element();
