...
public class CRS_AssistanceInfoList_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CRS-AssistanceInfoList-r11";
   }

   public CRS_AssistanceInfo_r11[] elements;

   public CRS_AssistanceInfoList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CRS_AssistanceInfoList_r11 (int numRecords) {
      elements = new CRS_AssistanceInfo_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public CRS_AssistanceInfoList_r11 (CRS_AssistanceInfo_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CRS_AssistanceInfo_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CRS_AssistanceInfo_r11();
