...
public class CRI_ReportConfig_r13 extends Asn1Choice {
   ...
   public CRI_ReportConfig_r13 () {
      super();
   }

   public CRI_ReportConfig_r13 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (CRI_ReportConfig_r13_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            CRI_ReportConfig_r13_setup setup;
            element = setup = new CRI_ReportConfig_r13_setup();
            setup.decode (buffer);
            break;
         }
