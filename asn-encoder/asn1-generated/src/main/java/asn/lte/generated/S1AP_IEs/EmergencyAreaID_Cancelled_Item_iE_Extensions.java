...
public class EmergencyAreaID_Cancelled_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public EmergencyAreaID_Cancelled_Item_iE_Extensions_element[] elements;

   public EmergencyAreaID_Cancelled_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public EmergencyAreaID_Cancelled_Item_iE_Extensions (int numRecords) {
      elements = new EmergencyAreaID_Cancelled_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EmergencyAreaID_Cancelled_Item_iE_Extensions (EmergencyAreaID_Cancelled_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EmergencyAreaID_Cancelled_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EmergencyAreaID_Cancelled_Item_iE_Extensions_element();
