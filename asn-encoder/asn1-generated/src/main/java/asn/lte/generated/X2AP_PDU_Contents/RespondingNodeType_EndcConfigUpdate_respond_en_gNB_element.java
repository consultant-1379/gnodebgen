...
public class RespondingNodeType_EndcConfigUpdate_respond_en_gNB_element extends Asn1Seq {
   ...
   public RespondingNodeType_EndcConfigUpdate_respond_en_gNB_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public RespondingNodeType_EndcConfigUpdate_respond_en_gNB_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.En_gNB_ENDCConfigUpdateAckIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.En_gNB_ENDCConfigUpdateAckIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.En_gNB_ENDCConfigUpdateAckIEs[i];
            break;
         }
      }
      if (null == _index) {
