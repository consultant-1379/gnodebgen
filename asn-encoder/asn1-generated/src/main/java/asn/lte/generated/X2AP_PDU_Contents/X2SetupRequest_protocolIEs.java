...
public class X2SetupRequest_protocolIEs extends Asn1SeqOf {
   ...
   public X2SetupRequest_protocolIEs_element[] elements;

   public X2SetupRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public X2SetupRequest_protocolIEs (int numRecords) {
      elements = new X2SetupRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public X2SetupRequest_protocolIEs (X2SetupRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new X2SetupRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new X2SetupRequest_protocolIEs_element();
