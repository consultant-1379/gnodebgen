...
public class UEAggregateMaximumBitrate_iE_Extensions_element extends Asn1Seq {
   ...
   /**
    * Assign fields according to information object having key id-extended-uEaggregateMaximumBitRateDL
    */
   public void setUsing_id_extended_uEaggregateMaximumBitRateDL(ExtendedBitRate extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_extended_uEaggregateMaximumBitRateDL);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-extended-uEaggregateMaximumBitRateUL
    */
   public void setUsing_id_extended_uEaggregateMaximumBitRateUL(ExtendedBitRate extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_extended_uEaggregateMaximumBitRateUL);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-extended-uEaggregateMaximumBitRateDL
    */
   public ExtendedBitRate getExtensionValueFor_id_extended_uEaggregateMaximumBitRateDL() {
      return (ExtendedBitRate) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-extended-uEaggregateMaximumBitRateUL
    */
   public ExtendedBitRate getExtensionValueFor_id_extended_uEaggregateMaximumBitRateUL() {
      return (ExtendedBitRate) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.UEAggregate_MaximumBitrates_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.UEAggregate_MaximumBitrates_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.UEAggregate_MaximumBitrates_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 259) {
         indent (_sb, _level+1);
         _sb.append("id = id-extended-uEaggregateMaximumBitRateDL\n");
      }
      else if (id.value == 260) {
         indent (_sb, _level+1);
         _sb.append("id = id-extended-uEaggregateMaximumBitRateUL\n");
      }
