...
public class CriticalityDiagnostics_IE_List_element_iE_Extensions_element extends Asn1Seq {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _M3AP_IEsValues.CriticalityDiagnostics_IE_List_ExtIEs.length; i++) {
         if(_M3AP_IEsValues.CriticalityDiagnostics_IE_List_ExtIEs[i].id.equals(id)) {
            _index = _M3AP_IEsValues.CriticalityDiagnostics_IE_List_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
