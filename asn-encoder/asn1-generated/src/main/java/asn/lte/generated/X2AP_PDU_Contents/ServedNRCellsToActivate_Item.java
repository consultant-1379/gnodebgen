...
public class ServedNRCellsToActivate_Item extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "ServedNRCellsToActivate-Item";
   }

   public NRCGI nrCellID;
   public ServedNRCellsToActivate_Item_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public ServedNRCellsToActivate_Item () {
      super();
      init();
   }
   ...
   public ServedNRCellsToActivate_Item (
      NRCGI nrCellID_,
      ServedNRCellsToActivate_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      nrCellID = nrCellID_;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new ServedNRCellsToActivate_Item_iE_Extensions();
