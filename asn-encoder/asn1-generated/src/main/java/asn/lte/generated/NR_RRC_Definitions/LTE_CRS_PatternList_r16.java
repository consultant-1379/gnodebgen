...
public class LTE_CRS_PatternList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "LTE-CRS-PatternList-r16";
   }

   public RateMatchPatternLTE_CRS[] elements;

   public LTE_CRS_PatternList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public LTE_CRS_PatternList_r16 (int numRecords) {
      elements = new RateMatchPatternLTE_CRS [numRecords];
   }
    ...
    * given the array.  
    */
   public LTE_CRS_PatternList_r16 (RateMatchPatternLTE_CRS[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RateMatchPatternLTE_CRS [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RateMatchPatternLTE_CRS();
