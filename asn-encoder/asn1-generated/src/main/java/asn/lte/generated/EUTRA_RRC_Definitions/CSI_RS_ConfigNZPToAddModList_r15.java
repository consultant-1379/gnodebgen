...
public class CSI_RS_ConfigNZPToAddModList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSI-RS-ConfigNZPToAddModList-r15";
   }

   public CSI_RS_ConfigNZP_r11[] elements;

   public CSI_RS_ConfigNZPToAddModList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_ConfigNZPToAddModList_r15 (int numRecords) {
    ...
    * given the array.  
    */
   public CSI_RS_ConfigNZPToAddModList_r15 (CSI_RS_ConfigNZP_r11[] elements_) {
      elements = elements_;
   }
