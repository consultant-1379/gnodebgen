...
public class EAB_S1SetupResponse_ExtConveyor_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: eid-EAB-S1AP-Version
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: EAB-S1AP-Version
    * Java type: EAB_S1AP_Version
    *
    * id: eid-MME-FeatureList
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-MME-FeatureList
    * Java type: EAB_MME_FeatureList
    */
   public Asn1Type value;

   public EAB_S1SetupResponse_ExtConveyor_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_S1SetupResponse_ExtConveyor_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-EAB-S1AP-Version
    */
   public void setUsing_eid_EAB_S1AP_Version(EAB_S1AP_Version value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Ericsson_Constants._S1AP_Ericsson_ConstantsValues.eid_EAB_S1AP_Version);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key eid-MME-FeatureList
    */
   public void setUsing_eid_MME_FeatureList(EAB_MME_FeatureList value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Ericsson_Constants._S1AP_Ericsson_ConstantsValues.eid_MME_FeatureList);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key eid-EAB-S1AP-Version
    */
   public EAB_S1AP_Version getValueFor_eid_EAB_S1AP_Version() {
      return (EAB_S1AP_Version) this.value;
   }

   /**
    * Get value of value with type set according to information object having key eid-MME-FeatureList
    */
   public EAB_MME_FeatureList getValueFor_eid_MME_FeatureList() {
      return (EAB_MME_FeatureList) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_Ericsson_IEsValues.EAB_S1SetupResponse_IEs.length; i++) {
         if(_S1AP_Ericsson_IEsValues.EAB_S1SetupResponse_IEs[i].id.equals(id)) {
            _index = _S1AP_Ericsson_IEsValues.EAB_S1SetupResponse_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 4096) {
         indent (_sb, _level+1);
         _sb.append("id = eid-EAB-S1AP-Version\n");
      }
      else if (id.value == 4097) {
         indent (_sb, _level+1);
         _sb.append("id = eid-MME-FeatureList\n");
      }
