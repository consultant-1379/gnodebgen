...
public class E_RABModifyListBearerModRes_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABModifyItemBearerModRes
    * Java type: E_RABModifyItemBearerModRes
    */
   public Asn1Type value;

   public E_RABModifyListBearerModRes_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABModifyListBearerModRes_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABModifyItemBearerModRes
    */
   public void setUsing_id_E_RABModifyItemBearerModRes(E_RABModifyItemBearerModRes value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABModifyItemBearerModRes);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABModifyItemBearerModRes
    */
   public E_RABModifyItemBearerModRes getValueFor_id_E_RABModifyItemBearerModRes() {
      return (E_RABModifyItemBearerModRes) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABModifyItemBearerModResIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABModifyItemBearerModResIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABModifyItemBearerModResIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 37) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABModifyItemBearerModRes\n");
      }
