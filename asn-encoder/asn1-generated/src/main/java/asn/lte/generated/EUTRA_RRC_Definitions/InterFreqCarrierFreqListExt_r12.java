...
public class InterFreqCarrierFreqListExt_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqListExt-r12";
   }

   public InterFreqCarrierFreqInfo_r12[] elements;

   public InterFreqCarrierFreqListExt_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqListExt_r12 (int numRecords) {
      elements = new InterFreqCarrierFreqInfo_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqListExt_r12 (InterFreqCarrierFreqInfo_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqCarrierFreqInfo_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqCarrierFreqInfo_r12();
