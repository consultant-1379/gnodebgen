...
public class SCellToAddModList_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCellToAddModList-r10";
   }

   public SCellToAddMod_r10[] elements;

   public SCellToAddModList_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCellToAddModList_r10 (int numRecords) {
      elements = new SCellToAddMod_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCellToAddModList_r10 (SCellToAddMod_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCellToAddMod_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SCellToAddMod_r10();
