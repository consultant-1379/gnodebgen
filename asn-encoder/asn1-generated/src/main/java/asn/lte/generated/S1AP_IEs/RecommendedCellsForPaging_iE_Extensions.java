...
public class RecommendedCellsForPaging_iE_Extensions extends Asn1SeqOf {
   ...
   public RecommendedCellsForPaging_iE_Extensions_element[] elements;

   public RecommendedCellsForPaging_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RecommendedCellsForPaging_iE_Extensions (int numRecords) {
      elements = new RecommendedCellsForPaging_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RecommendedCellsForPaging_iE_Extensions (RecommendedCellsForPaging_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RecommendedCellsForPaging_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RecommendedCellsForPaging_iE_Extensions_element();
