...
public class RetrieveUEInformation_protocolIEs extends Asn1SeqOf {
   ...
   public RetrieveUEInformation_protocolIEs_element[] elements;

   public RetrieveUEInformation_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public RetrieveUEInformation_protocolIEs (int numRecords) {
      elements = new RetrieveUEInformation_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RetrieveUEInformation_protocolIEs (RetrieveUEInformation_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RetrieveUEInformation_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RetrieveUEInformation_protocolIEs_element();
