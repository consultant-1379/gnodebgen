...
public class BandCombinationParameters_v1320_bandParameterList_v1320 extends Asn1SeqOf {
   ...
   public BandParameters_v1320[] elements;

   public BandCombinationParameters_v1320_bandParameterList_v1320 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_v1320_bandParameterList_v1320 (int numRecords) {
      elements = new BandParameters_v1320 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_v1320_bandParameterList_v1320 (BandParameters_v1320[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_v1320 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_v1320();
