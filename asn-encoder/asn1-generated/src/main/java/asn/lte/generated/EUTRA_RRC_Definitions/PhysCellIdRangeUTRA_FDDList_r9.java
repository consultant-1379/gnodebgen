...
public class PhysCellIdRangeUTRA_FDDList_r9 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PhysCellIdRangeUTRA-FDDList-r9";
   }

   public PhysCellIdRangeUTRA_FDD_r9[] elements;

   public PhysCellIdRangeUTRA_FDDList_r9 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PhysCellIdRangeUTRA_FDDList_r9 (int numRecords) {
      elements = new PhysCellIdRangeUTRA_FDD_r9 [numRecords];
   }
    ...
    * given the array.  
    */
   public PhysCellIdRangeUTRA_FDDList_r9 (PhysCellIdRangeUTRA_FDD_r9[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PhysCellIdRangeUTRA_FDD_r9 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PhysCellIdRangeUTRA_FDD_r9();
