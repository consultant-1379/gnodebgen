...
public class DownlinkPreemption_int_ConfigurationPerServingCell extends Asn1SeqOf {
   ...
   public INT_ConfigurationPerServingCell[] elements;

   public DownlinkPreemption_int_ConfigurationPerServingCell () {
      elements = null;
   }
    ...
    * populated.
    */
   public DownlinkPreemption_int_ConfigurationPerServingCell (int numRecords) {
      elements = new INT_ConfigurationPerServingCell [numRecords];
   }
    ...
    * given the array.  
    */
   public DownlinkPreemption_int_ConfigurationPerServingCell (INT_ConfigurationPerServingCell[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new INT_ConfigurationPerServingCell [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new INT_ConfigurationPerServingCell();
