...
public class ULandDLSharing_iE_Extensions extends Asn1SeqOf {
   ...
   public ULandDLSharing_iE_Extensions_element[] elements;

   public ULandDLSharing_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ULandDLSharing_iE_Extensions (int numRecords) {
      elements = new ULandDLSharing_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ULandDLSharing_iE_Extensions (ULandDLSharing_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ULandDLSharing_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ULandDLSharing_iE_Extensions_element();
