...
public class EAB_Inter_eNB_BB_CollaborationProperties_element extends Asn1Seq {
   ...
   /**
    * id: eid-IeNB-BB-Collaboration
    * criticality: EAB_CriticalityIgnore.ignore
    * presence: EAB_PresenceOptional.optional
    * ASN.1 type: EAB-IeNB-BB-Collaboration
    * Java type: EAB_IeNB_BB_Collaboration
    */
   public Asn1Type value;

   public EAB_Inter_eNB_BB_CollaborationProperties_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_Inter_eNB_BB_CollaborationProperties_element (long id_,
      EAB_CriticalityIgnore criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-IeNB-BB-Collaboration
    */
   public void setUsing_eid_IeNB_BB_Collaboration(EAB_IeNB_BB_Collaboration value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_IeNB_BB_Collaboration);
      this.criticality = asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_CriticalityIgnore.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key eid-IeNB-BB-Collaboration
    */
   public EAB_IeNB_BB_Collaboration getValueFor_eid_IeNB_BB_Collaboration() {
      return (EAB_IeNB_BB_Collaboration) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_Inter_eNB_BB_CollaborationProperties_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_Inter_eNB_BB_CollaborationProperties_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_Inter_eNB_BB_CollaborationProperties_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 4158) {
         indent (_sb, _level+1);
         _sb.append("id = eid-IeNB-BB-Collaboration\n");
      }
