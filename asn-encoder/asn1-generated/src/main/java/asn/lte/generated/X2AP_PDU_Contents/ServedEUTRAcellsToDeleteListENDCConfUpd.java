...
public class ServedEUTRAcellsToDeleteListENDCConfUpd extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServedEUTRAcellsToDeleteListENDCConfUpd";
   }

   public ECGI[] elements;

   public ServedEUTRAcellsToDeleteListENDCConfUpd () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedEUTRAcellsToDeleteListENDCConfUpd (int numRecords) {
      elements = new ECGI [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedEUTRAcellsToDeleteListENDCConfUpd (ECGI[] elements_) {
      elements = elements_;
   }
