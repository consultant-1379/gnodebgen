...
public class NB_IoT_UEIdentityIndexValue extends Asn1BitString {
   ...
   public String getAsn1TypeName()  {
      return "NB-IoT-UEIdentityIndexValue";
   }
    ...
    */
   public NB_IoT_UEIdentityIndexValue () {
      super();
      value = new byte [2];
   }
    ...
    */
   public NB_IoT_UEIdentityIndexValue (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public NB_IoT_UEIdentityIndexValue (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public NB_IoT_UEIdentityIndexValue (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public NB_IoT_UEIdentityIndexValue (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public NB_IoT_UEIdentityIndexValue (java.util.BitSet bitSet) {
      super (bitSet);
   }
