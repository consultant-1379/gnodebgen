...
public class STAG_ToAddModList_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "STAG-ToAddModList-r11";
   }

   public STAG_ToAddMod_r11[] elements;

   public STAG_ToAddModList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public STAG_ToAddModList_r11 (int numRecords) {
      elements = new STAG_ToAddMod_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public STAG_ToAddModList_r11 (STAG_ToAddMod_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new STAG_ToAddMod_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new STAG_ToAddMod_r11();
