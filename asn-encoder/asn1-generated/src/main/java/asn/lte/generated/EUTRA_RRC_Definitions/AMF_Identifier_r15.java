...
public class AMF_Identifier_r15 extends Asn1BitString {
    ...
    */
   public AMF_Identifier_r15 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public AMF_Identifier_r15 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public AMF_Identifier_r15 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public AMF_Identifier_r15 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public AMF_Identifier_r15 (java.util.BitSet bitSet) {
      super (bitSet);
   }
