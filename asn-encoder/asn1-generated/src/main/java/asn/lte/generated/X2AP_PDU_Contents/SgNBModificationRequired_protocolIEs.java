...
public class SgNBModificationRequired_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBModificationRequired_protocolIEs_element[] elements;

   public SgNBModificationRequired_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBModificationRequired_protocolIEs (int numRecords) {
      elements = new SgNBModificationRequired_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBModificationRequired_protocolIEs (SgNBModificationRequired_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBModificationRequired_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBModificationRequired_protocolIEs_element();
