...
public class PRACH_Config_v1310 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "PRACH-Config-v1310";
   }

   public RSRP_ThresholdsPrachInfoList_r13 rsrp_ThresholdsPrachInfoList_r13;  // optional
   public PRACH_Config_v1310_mpdcch_startSF_CSS_RA_r13 mpdcch_startSF_CSS_RA_r13;  // optional
   public Asn1Integer prach_HoppingOffset_r13;  // optional
   public PRACH_ParametersListCE_r13 prach_ParametersListCE_r13;  // optional
   public Asn1Integer initial_CE_level_r13;  // optional

   public PRACH_Config_v1310 () {
      super();
      init();
   }
   ...
   public PRACH_Config_v1310 (
      ...
      PRACH_Config_v1310_mpdcch_startSF_CSS_RA_r13 mpdcch_startSF_CSS_RA_r13_,
      Asn1Integer prach_HoppingOffset_r13_,
      PRACH_ParametersListCE_r13 prach_ParametersListCE_r13_,
      Asn1Integer initial_CE_level_r13_
   ) {
      super();
      rsrp_ThresholdsPrachInfoList_r13 = rsrp_ThresholdsPrachInfoList_r13_;
      ...
      prach_ParametersListCE_r13 = prach_ParametersListCE_r13_;
      initial_CE_level_r13 = initial_CE_level_r13_;
   }
    ...
    * the given objects 
    */
   public PRACH_Config_v1310 (RSRP_ThresholdsPrachInfoList_r13 rsrp_ThresholdsPrachInfoList_r13_,
      PRACH_Config_v1310_mpdcch_startSF_CSS_RA_r13 mpdcch_startSF_CSS_RA_r13_,
      long prach_HoppingOffset_r13_,
      PRACH_ParametersListCE_r13 prach_ParametersListCE_r13_,
      long initial_CE_level_r13_
   ) {
      super();
      rsrp_ThresholdsPrachInfoList_r13 = rsrp_ThresholdsPrachInfoList_r13_;
      mpdcch_startSF_CSS_RA_r13 = mpdcch_startSF_CSS_RA_r13_;
      ...
      prach_ParametersListCE_r13 = prach_ParametersListCE_r13_;
      initial_CE_level_r13 = new Asn1Integer (initial_CE_level_r13_);
   }
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 4: return initial_CE_level_r13;
         default: return null;
      }
   }
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 4: return "initial-CE-level-r13";
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      boolean prach_ParametersListCE_r13Present = buffer.decodeBit ("prach_ParametersListCE_r13Present");
      boolean initial_CE_level_r13Present = buffer.decodeBit ("initial_CE_level_r13Present");
      ...
      if (mpdcch_startSF_CSS_RA_r13Present) {
         ...
         mpdcch_startSF_CSS_RA_r13 = new PRACH_Config_v1310_mpdcch_startSF_CSS_RA_r13();
      ...
      if (prach_ParametersListCE_r13Present) {
      ...
      // decode initial_CE_level_r13

      if (initial_CE_level_r13Present) {
         buffer.getContext().eventDispatcher.startElement("initial_CE_level_r13", -1);

         initial_CE_level_r13 = new Asn1Integer();
         initial_CE_level_r13.decode (buffer, 0, 3);

         buffer.invokeCharacters(initial_CE_level_r13.toString());
         buffer.getContext().eventDispatcher.endElement("initial_CE_level_r13", -1);
      }
      else {
         initial_CE_level_r13 = null;
      }
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (initial_CE_level_r13 != null) initial_CE_level_r13.print (_sb, "initial_CE_level_r13", _level+1);
      indent (_sb, _level);
      _sb.append ("}\n");
   }
