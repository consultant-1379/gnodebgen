...
public class SFNInitialisationTime extends Asn1BitString {
    ...
    */
   public SFNInitialisationTime (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public SFNInitialisationTime (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public SFNInitialisationTime (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public SFNInitialisationTime (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public SFNInitialisationTime (java.util.BitSet bitSet) {
      super (bitSet);
   }
