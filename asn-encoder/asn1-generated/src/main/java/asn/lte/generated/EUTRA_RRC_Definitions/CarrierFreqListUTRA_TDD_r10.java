...
public class CarrierFreqListUTRA_TDD_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CarrierFreqListUTRA-TDD-r10";
   }

   public ARFCN_ValueUTRA[] elements;

   public CarrierFreqListUTRA_TDD_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CarrierFreqListUTRA_TDD_r10 (int numRecords) {
      elements = new ARFCN_ValueUTRA [numRecords];
   }
    ...
    * given the array.  
    */
   public CarrierFreqListUTRA_TDD_r10 (ARFCN_ValueUTRA[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ARFCN_ValueUTRA [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ARFCN_ValueUTRA();
