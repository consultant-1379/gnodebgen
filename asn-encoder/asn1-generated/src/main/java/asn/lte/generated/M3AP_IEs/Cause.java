...
public class Cause extends Asn1Choice {
   ...
   public final static byte _TRANSPORT = 2;
   public final static byte _NAS = 3;
   public final static byte _PROTOCOL = 4;
   public final static byte _MISC = 5;
   ...
   public String getElemName () {
      ...
      case _TRANSPORT: return "transport";
      case _NAS: return "nAS";
   ...
   public void set_transport (CauseTransport value) {
      setElement (_TRANSPORT, value);
   }

   public void set_nAS (CauseNAS value) {
      setElement (_NAS, value);
   }
      ...
      if (!extbit) {
         ...
         switch (idx) {
            ...
            case 1: { 
               ...
               int tval = CauseTransport.decodeEnumValue (buffer);
               element = transport = CauseTransport.valueOf (tval);
               break;
            }
            ...
            case 2: { 
               CauseNAS nAS;
               int tval = CauseNAS.decodeEnumValue (buffer);
               element = nAS = CauseNAS.valueOf (tval);
               break;
            }
