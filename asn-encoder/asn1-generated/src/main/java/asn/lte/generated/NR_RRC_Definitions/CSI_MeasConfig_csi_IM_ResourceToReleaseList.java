...
public class CSI_MeasConfig_csi_IM_ResourceToReleaseList extends Asn1SeqOf {
   ...
   public CSI_IM_ResourceId[] elements;

   public CSI_MeasConfig_csi_IM_ResourceToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_csi_IM_ResourceToReleaseList (int numRecords) {
      elements = new CSI_IM_ResourceId [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_MeasConfig_csi_IM_ResourceToReleaseList (CSI_IM_ResourceId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_IM_ResourceId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_IM_ResourceId();
