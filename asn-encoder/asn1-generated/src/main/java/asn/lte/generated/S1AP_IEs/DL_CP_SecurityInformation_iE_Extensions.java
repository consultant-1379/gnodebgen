...
public class DL_CP_SecurityInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public DL_CP_SecurityInformation_iE_Extensions_element[] elements;

   public DL_CP_SecurityInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public DL_CP_SecurityInformation_iE_Extensions (int numRecords) {
      elements = new DL_CP_SecurityInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public DL_CP_SecurityInformation_iE_Extensions (DL_CP_SecurityInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DL_CP_SecurityInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DL_CP_SecurityInformation_iE_Extensions_element();
