...
public class KillResponse_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: BroadcastCancelledAreaList
    * Java type: BroadcastCancelledAreaList
    *
   ...
   public KillResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public KillResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-BroadcastCancelledAreaList
    */
   public void setUsing_id_BroadcastCancelledAreaList(asn.lte.generated.S1AP_IEs.BroadcastCancelledAreaList value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_BroadcastCancelledAreaList);
   ...
   /**
    * Get value of value with type set according to information object having key id-BroadcastCancelledAreaList
    */
   public asn.lte.generated.S1AP_IEs.BroadcastCancelledAreaList getValueFor_id_BroadcastCancelledAreaList() {
      return (asn.lte.generated.S1AP_IEs.BroadcastCancelledAreaList) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.KillResponseIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.KillResponseIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.KillResponseIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 141) {
         indent (_sb, _level+1);
         _sb.append("id = id-BroadcastCancelledAreaList\n");
      }
      else if (id.value == 58) {
         indent (_sb, _level+1);
