...
public class TAIItem_iE_Extensions extends Asn1SeqOf {
   ...
   public TAIItem_iE_Extensions_element[] elements;

   public TAIItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TAIItem_iE_Extensions (int numRecords) {
      elements = new TAIItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TAIItem_iE_Extensions (TAIItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TAIItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TAIItem_iE_Extensions_element();
