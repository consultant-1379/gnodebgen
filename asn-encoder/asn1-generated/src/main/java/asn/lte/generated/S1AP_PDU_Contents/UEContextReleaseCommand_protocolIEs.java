...
public class UEContextReleaseCommand_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextReleaseCommand_protocolIEs_element[] elements;

   public UEContextReleaseCommand_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextReleaseCommand_protocolIEs (int numRecords) {
      elements = new UEContextReleaseCommand_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextReleaseCommand_protocolIEs (UEContextReleaseCommand_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextReleaseCommand_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextReleaseCommand_protocolIEs_element();
