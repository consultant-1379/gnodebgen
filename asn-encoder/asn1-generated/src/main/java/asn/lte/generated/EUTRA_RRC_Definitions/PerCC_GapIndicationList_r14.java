...
public class PerCC_GapIndicationList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PerCC-GapIndicationList-r14";
   }

   public PerCC_GapIndication_r14[] elements;

   public PerCC_GapIndicationList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PerCC_GapIndicationList_r14 (int numRecords) {
      elements = new PerCC_GapIndication_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public PerCC_GapIndicationList_r14 (PerCC_GapIndication_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PerCC_GapIndication_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PerCC_GapIndication_r14();
