...
public class ENSA_E6_MGMTService_iE_Extensions_element extends Asn1Seq {
   ...
   public ENSA_E6_MGMTService_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENSA_E6_MGMTService_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_ENSA_IEsValues.ENSA_E6_MGMTService_ExtIEs.length; i++) {
         if(_X2AP_ENSA_IEsValues.ENSA_E6_MGMTService_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_ENSA_IEsValues.ENSA_E6_MGMTService_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
