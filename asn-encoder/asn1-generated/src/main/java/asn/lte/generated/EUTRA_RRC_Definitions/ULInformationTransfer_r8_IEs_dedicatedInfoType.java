...
public class ULInformationTransfer_r8_IEs_dedicatedInfoType extends Asn1Choice {
   ...
   public ULInformationTransfer_r8_IEs_dedicatedInfoType () {
      super();
   }

   public ULInformationTransfer_r8_IEs_dedicatedInfoType (byte choiceId_, Asn1Type element_) {
      super();
