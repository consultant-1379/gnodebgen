...
public class UplinkTxDirectCurrentCell_uplinkDirectCurrentBWP extends Asn1SeqOf {
   ...
   public UplinkTxDirectCurrentCell_uplinkDirectCurrentBWP () {
      elements = null;
   }
    ...
    * populated.
    */
   public UplinkTxDirectCurrentCell_uplinkDirectCurrentBWP (int numRecords) {
    ...
    * given the array.  
    */
   public UplinkTxDirectCurrentCell_uplinkDirectCurrentBWP (UplinkTxDirectCurrentBWP[] elements_) {
      elements = elements_;
   }
