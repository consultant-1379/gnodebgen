...
public class EUTRA_FreqBlackCellList extends Asn1SeqOf {
   ...
   public EUTRA_PhysCellIdRange[] elements;

   public EUTRA_FreqBlackCellList () {
      elements = null;
   }
    ...
    * populated.
    */
   public EUTRA_FreqBlackCellList (int numRecords) {
      elements = new EUTRA_PhysCellIdRange [numRecords];
   }
    ...
    * given the array.  
    */
   public EUTRA_FreqBlackCellList (EUTRA_PhysCellIdRange[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EUTRA_PhysCellIdRange [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EUTRA_PhysCellIdRange();
