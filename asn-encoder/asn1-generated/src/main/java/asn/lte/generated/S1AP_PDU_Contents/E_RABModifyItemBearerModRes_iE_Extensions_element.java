...
public class E_RABModifyItemBearerModRes_iE_Extensions_element extends Asn1Seq {
   ...
   public E_RABModifyItemBearerModRes_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABModifyItemBearerModRes_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABModifyItemBearerModResExtIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABModifyItemBearerModResExtIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABModifyItemBearerModResExtIEs[i];
            break;
         }
      }
      if (null == _index) {
