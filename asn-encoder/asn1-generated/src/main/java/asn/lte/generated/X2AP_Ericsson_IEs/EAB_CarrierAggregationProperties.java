...
public class EAB_CarrierAggregationProperties extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-CarrierAggregationProperties";
   }

   public EAB_CarrierAggregationProperties_element[] elements;

   public EAB_CarrierAggregationProperties () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_CarrierAggregationProperties (int numRecords) {
      elements = new EAB_CarrierAggregationProperties_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_CarrierAggregationProperties (EAB_CarrierAggregationProperties_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_CarrierAggregationProperties_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_CarrierAggregationProperties_element();
