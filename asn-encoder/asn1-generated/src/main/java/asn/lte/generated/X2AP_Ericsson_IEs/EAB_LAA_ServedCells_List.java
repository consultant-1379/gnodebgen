...
public class EAB_LAA_ServedCells_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-LAA-ServedCells-List";
   }

   public EAB_LAA_ServedCellInformation_Item[] elements;

   public EAB_LAA_ServedCells_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_LAA_ServedCells_List (int numRecords) {
    ...
    * given the array.  
    */
   public EAB_LAA_ServedCells_List (EAB_LAA_ServedCellInformation_Item[] elements_) {
      elements = elements_;
   }
