...
public class MeasCSI_RS_ToAddModList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasCSI-RS-ToAddModList-r12";
   }

   public MeasCSI_RS_Config_r12[] elements;

   public MeasCSI_RS_ToAddModList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasCSI_RS_ToAddModList_r12 (int numRecords) {
      elements = new MeasCSI_RS_Config_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasCSI_RS_ToAddModList_r12 (MeasCSI_RS_Config_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasCSI_RS_Config_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasCSI_RS_Config_r12();
