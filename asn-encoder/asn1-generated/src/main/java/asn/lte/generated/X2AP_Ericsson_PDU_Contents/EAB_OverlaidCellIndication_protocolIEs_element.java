...
public class EAB_OverlaidCellIndication_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: eid-eNB1-OverlaidCell-List
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: EAB-eNB1-OverlaidCell-List
    * Java type: EAB_eNB1_OverlaidCell_List
    */
   public Asn1Type value;

   public EAB_OverlaidCellIndication_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_OverlaidCellIndication_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-eNB1-OverlaidCell-List
    */
   public void setUsing_eid_eNB1_OverlaidCell_List(asn.lte.generated.X2AP_Ericsson_IEs.EAB_eNB1_OverlaidCell_List value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_eNB1_OverlaidCell_List);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key eid-eNB1-OverlaidCell-List
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_eNB1_OverlaidCell_List getValueFor_eid_eNB1_OverlaidCell_List() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_eNB1_OverlaidCell_List) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_PDU_ContentsValues.EAB_OverlaidCellIndication_IEs.length; i++) {
         if(_X2AP_Ericsson_PDU_ContentsValues.EAB_OverlaidCellIndication_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_PDU_ContentsValues.EAB_OverlaidCellIndication_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 4100) {
         indent (_sb, _level+1);
         _sb.append("id = eid-eNB1-OverlaidCell-List\n");
      }
