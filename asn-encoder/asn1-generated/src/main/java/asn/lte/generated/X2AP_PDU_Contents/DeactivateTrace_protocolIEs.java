...
public class DeactivateTrace_protocolIEs extends Asn1SeqOf {
   ...
   public DeactivateTrace_protocolIEs_element[] elements;

   public DeactivateTrace_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public DeactivateTrace_protocolIEs (int numRecords) {
      elements = new DeactivateTrace_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public DeactivateTrace_protocolIEs (DeactivateTrace_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DeactivateTrace_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DeactivateTrace_protocolIEs_element();
