...
public class UEInformationTransfer_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABLevelQoSParameters
    * Java type: E_RABLevelQoSParameters
    *
   ...
   public UEInformationTransfer_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UEInformationTransfer_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-UE-Level-QoS-Parameters
    */
   public void setUsing_id_UE_Level_QoS_Parameters(asn.lte.generated.S1AP_IEs.E_RABLevelQoSParameters value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_UE_Level_QoS_Parameters);
   ...
   /**
    * Get value of value with type set according to information object having key id-UE-Level-QoS-Parameters
    */
   public asn.lte.generated.S1AP_IEs.E_RABLevelQoSParameters getValueFor_id_UE_Level_QoS_Parameters() {
      return (asn.lte.generated.S1AP_IEs.E_RABLevelQoSParameters) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.UEInformationTransferIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.UEInformationTransferIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.UEInformationTransferIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 252) {
         indent (_sb, _level+1);
         _sb.append("id = id-UE-Level-QoS-Parameters\n");
      }
      else if (id.value == 74) {
         indent (_sb, _level+1);
