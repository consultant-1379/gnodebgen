...
public class ENDCPartialResetConfirm_protocolIEs extends Asn1SeqOf {
   ...
   public ENDCPartialResetConfirm_protocolIEs_element[] elements;

   public ENDCPartialResetConfirm_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENDCPartialResetConfirm_protocolIEs (int numRecords) {
      elements = new ENDCPartialResetConfirm_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENDCPartialResetConfirm_protocolIEs (ENDCPartialResetConfirm_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENDCPartialResetConfirm_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENDCPartialResetConfirm_protocolIEs_element();
