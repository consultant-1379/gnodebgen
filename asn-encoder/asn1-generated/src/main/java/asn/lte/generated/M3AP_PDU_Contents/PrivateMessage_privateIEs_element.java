...
import asn.lte.generated.M3AP_CommonDataTypes.PrivateIE_ID;
...
public class PrivateMessage_privateIEs_element extends Asn1Seq {
   ...
   {
      /* check id */
      asn.lte.generated.M3AP_Containers.M3AP_PRIVATE_IES _index = null;
      for(int i=0; i < _M3AP_PDU_ContentsValues.PrivateMessage_IEs.length; i++) {
         if(_M3AP_PDU_ContentsValues.PrivateMessage_IEs[i].id.equals(id)) {
            _index = _M3AP_PDU_ContentsValues.PrivateMessage_IEs[i];
            break;
         }
      }
      if (null == _index) {
