...
public class ResultRSRP_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public ResultRSRP_Item_iE_Extensions_element[] elements;

   public ResultRSRP_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResultRSRP_Item_iE_Extensions (int numRecords) {
      elements = new ResultRSRP_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ResultRSRP_Item_iE_Extensions (ResultRSRP_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResultRSRP_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResultRSRP_Item_iE_Extensions_element();
