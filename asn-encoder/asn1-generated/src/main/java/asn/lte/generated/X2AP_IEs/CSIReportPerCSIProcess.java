...
public class CSIReportPerCSIProcess extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSIReportPerCSIProcess";
   }

   public CSIReportPerCSIProcess_element[] elements;

   public CSIReportPerCSIProcess () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSIReportPerCSIProcess (int numRecords) {
      elements = new CSIReportPerCSIProcess_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CSIReportPerCSIProcess (CSIReportPerCSIProcess_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSIReportPerCSIProcess_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSIReportPerCSIProcess_element();
