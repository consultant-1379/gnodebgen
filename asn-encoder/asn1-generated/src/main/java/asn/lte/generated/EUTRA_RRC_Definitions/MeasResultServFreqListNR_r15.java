...
public class MeasResultServFreqListNR_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultServFreqListNR-r15";
   }

   public MeasResultServFreqNR_r15[] elements;

   public MeasResultServFreqListNR_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultServFreqListNR_r15 (int numRecords) {
      elements = new MeasResultServFreqNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultServFreqListNR_r15 (MeasResultServFreqNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultServFreqNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultServFreqNR_r15();
