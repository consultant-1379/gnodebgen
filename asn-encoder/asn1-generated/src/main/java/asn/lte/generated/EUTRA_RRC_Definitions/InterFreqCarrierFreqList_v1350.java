...
public class InterFreqCarrierFreqList_v1350 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqList-v1350";
   }

   public InterFreqCarrierFreqInfo_v1350[] elements;

   public InterFreqCarrierFreqList_v1350 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqList_v1350 (int numRecords) {
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqList_v1350 (InterFreqCarrierFreqInfo_v1350[] elements_) {
      elements = elements_;
   }
