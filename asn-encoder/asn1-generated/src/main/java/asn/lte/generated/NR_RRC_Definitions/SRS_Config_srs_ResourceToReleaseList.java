...
public class SRS_Config_srs_ResourceToReleaseList extends Asn1SeqOf {
   ...
   public SRS_Config_srs_ResourceToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRS_Config_srs_ResourceToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public SRS_Config_srs_ResourceToReleaseList (SRS_ResourceId[] elements_) {
      elements = elements_;
   }
