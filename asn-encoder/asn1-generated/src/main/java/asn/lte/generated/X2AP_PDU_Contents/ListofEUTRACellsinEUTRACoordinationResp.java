...
public class ListofEUTRACellsinEUTRACoordinationResp extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ListofEUTRACellsinEUTRACoordinationResp";
   }

   public ECGI[] elements;

   public ListofEUTRACellsinEUTRACoordinationResp () {
      elements = null;
   }
    ...
    * populated.
    */
   public ListofEUTRACellsinEUTRACoordinationResp (int numRecords) {
    ...
    * given the array.  
    */
   public ListofEUTRACellsinEUTRACoordinationResp (ECGI[] elements_) {
      elements = elements_;
   }
