...
public class CarrierFreqListUTRA_TDD_Ext_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CarrierFreqListUTRA-TDD-Ext-r12";
   }

   public CarrierFreqUTRA_TDD_r12[] elements;

   public CarrierFreqListUTRA_TDD_Ext_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CarrierFreqListUTRA_TDD_Ext_r12 (int numRecords) {
      elements = new CarrierFreqUTRA_TDD_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public CarrierFreqListUTRA_TDD_Ext_r12 (CarrierFreqUTRA_TDD_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CarrierFreqUTRA_TDD_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CarrierFreqUTRA_TDD_r12();
