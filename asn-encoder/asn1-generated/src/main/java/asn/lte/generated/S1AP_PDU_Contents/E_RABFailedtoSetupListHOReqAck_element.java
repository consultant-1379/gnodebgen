...
public class E_RABFailedtoSetupListHOReqAck_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABFailedToSetupItemHOReqAck
    * Java type: E_RABFailedToSetupItemHOReqAck
    */
   public Asn1Type value;

   public E_RABFailedtoSetupListHOReqAck_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABFailedtoSetupListHOReqAck_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABFailedtoSetupItemHOReqAck
    */
   public void setUsing_id_E_RABFailedtoSetupItemHOReqAck(E_RABFailedToSetupItemHOReqAck value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABFailedtoSetupItemHOReqAck);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABFailedtoSetupItemHOReqAck
    */
   public E_RABFailedToSetupItemHOReqAck getValueFor_id_E_RABFailedtoSetupItemHOReqAck() {
      return (E_RABFailedToSetupItemHOReqAck) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABFailedtoSetupItemHOReqAckIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABFailedtoSetupItemHOReqAckIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABFailedtoSetupItemHOReqAckIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 21) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABFailedtoSetupItemHOReqAck\n");
      }
