...
public class BandCombinationList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandCombinationList-r14";
   }

   public BandCombination_r14[] elements;

   public BandCombinationList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationList_r14 (int numRecords) {
      elements = new BandCombination_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationList_r14 (BandCombination_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandCombination_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandCombination_r14();
