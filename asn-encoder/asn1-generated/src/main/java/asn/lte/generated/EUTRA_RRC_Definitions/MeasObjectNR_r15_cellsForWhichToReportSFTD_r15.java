...
public class MeasObjectNR_r15_cellsForWhichToReportSFTD_r15 extends Asn1SeqOf {
   ...
   public PhysCellIdNR_r15[] elements;

   public MeasObjectNR_r15_cellsForWhichToReportSFTD_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasObjectNR_r15_cellsForWhichToReportSFTD_r15 (int numRecords) {
      elements = new PhysCellIdNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasObjectNR_r15_cellsForWhichToReportSFTD_r15 (PhysCellIdNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PhysCellIdNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PhysCellIdNR_r15();
