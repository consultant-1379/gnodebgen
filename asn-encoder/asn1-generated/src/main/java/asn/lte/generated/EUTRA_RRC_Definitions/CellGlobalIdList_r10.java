...
public class CellGlobalIdList_r10 extends Asn1SeqOf {
   ...
   public CellGlobalIdEUTRA[] elements;

   public CellGlobalIdList_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellGlobalIdList_r10 (int numRecords) {
      elements = new CellGlobalIdEUTRA [numRecords];
   }
    ...
    * given the array.  
    */
   public CellGlobalIdList_r10 (CellGlobalIdEUTRA[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellGlobalIdEUTRA [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellGlobalIdEUTRA();
