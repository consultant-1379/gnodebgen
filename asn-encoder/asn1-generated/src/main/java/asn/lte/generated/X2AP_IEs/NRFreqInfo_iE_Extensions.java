...
public class NRFreqInfo_iE_Extensions extends Asn1SeqOf {
   ...
   public NRFreqInfo_iE_Extensions_element[] elements;

   public NRFreqInfo_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public NRFreqInfo_iE_Extensions (int numRecords) {
      elements = new NRFreqInfo_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public NRFreqInfo_iE_Extensions (NRFreqInfo_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NRFreqInfo_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NRFreqInfo_iE_Extensions_element();
