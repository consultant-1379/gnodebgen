...
public class SCellToAddModListExt_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCellToAddModListExt-r13";
   }

   public SCellToAddModExt_r13[] elements;

   public SCellToAddModListExt_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCellToAddModListExt_r13 (int numRecords) {
      elements = new SCellToAddModExt_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCellToAddModListExt_r13 (SCellToAddModExt_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCellToAddModExt_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SCellToAddModExt_r13();
