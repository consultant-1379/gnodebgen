...
public class SecurityKey extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public SecurityKey (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public SecurityKey (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public SecurityKey (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public SecurityKey (java.util.BitSet bitSet) {
      super (bitSet);
   }
