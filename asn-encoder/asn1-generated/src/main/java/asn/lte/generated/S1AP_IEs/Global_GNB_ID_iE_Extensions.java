...
public class Global_GNB_ID_iE_Extensions extends Asn1SeqOf {
   ...
   public Global_GNB_ID_iE_Extensions_element[] elements;

   public Global_GNB_ID_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public Global_GNB_ID_iE_Extensions (int numRecords) {
      elements = new Global_GNB_ID_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public Global_GNB_ID_iE_Extensions (Global_GNB_ID_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Global_GNB_ID_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Global_GNB_ID_iE_Extensions_element();
