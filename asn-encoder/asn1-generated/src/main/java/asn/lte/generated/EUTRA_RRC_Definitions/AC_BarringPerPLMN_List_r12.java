...
public class AC_BarringPerPLMN_List_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AC-BarringPerPLMN-List-r12";
   }

   public AC_BarringPerPLMN_r12[] elements;

   public AC_BarringPerPLMN_List_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AC_BarringPerPLMN_List_r12 (int numRecords) {
      elements = new AC_BarringPerPLMN_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public AC_BarringPerPLMN_List_r12 (AC_BarringPerPLMN_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AC_BarringPerPLMN_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AC_BarringPerPLMN_r12();
