...
public class ENSA_E6_MGMTServicetoModifyList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ENSA-E6-MGMTServicetoModifyList";
   }

   public ENSA_E6_MGMTServicetoModify_Item[] elements;

   public ENSA_E6_MGMTServicetoModifyList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENSA_E6_MGMTServicetoModifyList (int numRecords) {
      elements = new ENSA_E6_MGMTServicetoModify_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ENSA_E6_MGMTServicetoModifyList (ENSA_E6_MGMTServicetoModify_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENSA_E6_MGMTServicetoModify_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENSA_E6_MGMTServicetoModify_Item();
