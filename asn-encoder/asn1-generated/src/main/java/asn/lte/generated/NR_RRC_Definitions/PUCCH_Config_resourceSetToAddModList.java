...
public class PUCCH_Config_resourceSetToAddModList extends Asn1SeqOf {
   ...
   public PUCCH_ResourceSet[] elements;

   public PUCCH_Config_resourceSetToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_resourceSetToAddModList (int numRecords) {
      elements = new PUCCH_ResourceSet [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_Config_resourceSetToAddModList (PUCCH_ResourceSet[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUCCH_ResourceSet [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUCCH_ResourceSet();
