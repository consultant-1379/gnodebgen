...
public class RRC_Context extends Asn1OctetString {
    ...
    */
   public RRC_Context (byte[] data, int offset, int nbytes) {
    ...
    */
   public RRC_Context (String value_) throws Asn1ValueParseException {
      super (value_);
   }
