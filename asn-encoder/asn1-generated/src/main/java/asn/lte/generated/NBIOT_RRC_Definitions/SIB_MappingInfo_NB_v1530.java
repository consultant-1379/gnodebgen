...
public class SIB_MappingInfo_NB_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SIB-MappingInfo-NB-v1530";
   }

   public SIB_Type_NB_v1530[] elements;

   public SIB_MappingInfo_NB_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SIB_MappingInfo_NB_v1530 (int numRecords) {
      elements = new SIB_Type_NB_v1530 [numRecords];
   }
    ...
    * given the array.  
    */
   public SIB_MappingInfo_NB_v1530 (SIB_Type_NB_v1530[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SIB_Type_NB_v1530 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         {
            int tval = SIB_Type_NB_v1530.decodeEnumValue (buffer);
            elements[i] = SIB_Type_NB_v1530.valueOf (tval);
         }
