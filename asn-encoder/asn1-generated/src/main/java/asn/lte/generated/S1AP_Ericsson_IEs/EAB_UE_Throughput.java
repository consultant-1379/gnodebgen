...
public class EAB_UE_Throughput extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "EAB-UE-Throughput";
   }

   public EAB_UE_Throughput () {
      super();
   }
    ...
    *              in binary form.
    */
   public EAB_UE_Throughput (byte[] data) {
      super (data);
   }
    ...
    */
   public EAB_UE_Throughput (byte[] data, int offset, int nbytes) {
    ...
    */
   public EAB_UE_Throughput (String value_) throws Asn1ValueParseException {
      super (value_);
   }
