...
public class SRS_Config_srs_PosResourceToAddModList_r16 extends Asn1SeqOf {
   ...
   public SRS_PosResource_r16[] elements;

   public SRS_Config_srs_PosResourceToAddModList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRS_Config_srs_PosResourceToAddModList_r16 (int numRecords) {
      elements = new SRS_PosResource_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SRS_Config_srs_PosResourceToAddModList_r16 (SRS_PosResource_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRS_PosResource_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRS_PosResource_r16();
