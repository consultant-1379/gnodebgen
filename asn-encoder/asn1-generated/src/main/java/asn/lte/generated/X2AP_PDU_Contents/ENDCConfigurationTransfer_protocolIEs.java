...
public class ENDCConfigurationTransfer_protocolIEs extends Asn1SeqOf {
   ...
   public ENDCConfigurationTransfer_protocolIEs_element[] elements;

   public ENDCConfigurationTransfer_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENDCConfigurationTransfer_protocolIEs (int numRecords) {
      elements = new ENDCConfigurationTransfer_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENDCConfigurationTransfer_protocolIEs (ENDCConfigurationTransfer_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENDCConfigurationTransfer_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENDCConfigurationTransfer_protocolIEs_element();
