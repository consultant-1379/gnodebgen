...
public class SupportedBandListUTRA_TDD384 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandListUTRA-TDD384";
   }

   public SupportedBandUTRA_TDD384[] elements;

   public SupportedBandListUTRA_TDD384 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandListUTRA_TDD384 (int numRecords) {
      elements = new SupportedBandUTRA_TDD384 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandListUTRA_TDD384 (SupportedBandUTRA_TDD384[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBandUTRA_TDD384 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         {
            int tval = SupportedBandUTRA_TDD384.decodeEnumValue (buffer);
            elements[i] = SupportedBandUTRA_TDD384.valueOf (tval);
         }
