...
public class ShortI_RNTI_r15 extends Asn1BitString {
    ...
    */
   public ShortI_RNTI_r15 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public ShortI_RNTI_r15 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public ShortI_RNTI_r15 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public ShortI_RNTI_r15 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public ShortI_RNTI_r15 (java.util.BitSet bitSet) {
      super (bitSet);
   }
