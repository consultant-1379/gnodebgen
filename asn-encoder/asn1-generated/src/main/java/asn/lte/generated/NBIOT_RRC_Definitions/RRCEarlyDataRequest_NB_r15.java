...
public class RRCEarlyDataRequest_NB_r15 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCEarlyDataRequest-NB-r15";
   }

   public RRCEarlyDataRequest_NB_r15_criticalExtensions criticalExtensions;

   public RRCEarlyDataRequest_NB_r15 () {
      super();
      init();
   }
    ...
    */
   public RRCEarlyDataRequest_NB_r15 (
      RRCEarlyDataRequest_NB_r15_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCEarlyDataRequest_NB_r15_criticalExtensions();
