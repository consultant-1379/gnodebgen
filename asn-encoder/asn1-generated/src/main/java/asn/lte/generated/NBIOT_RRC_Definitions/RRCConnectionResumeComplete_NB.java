...
public class RRCConnectionResumeComplete_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionResumeComplete-NB";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier;
   public RRCConnectionResumeComplete_NB_criticalExtensions criticalExtensions;

   public RRCConnectionResumeComplete_NB () {
      super();
      init();
   }
   ...
   public RRCConnectionResumeComplete_NB (
      ...
      RRCConnectionResumeComplete_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public RRCConnectionResumeComplete_NB (long rrc_TransactionIdentifier_,
      RRCConnectionResumeComplete_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionResumeComplete_NB_criticalExtensions();
