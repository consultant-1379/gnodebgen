...
public class MeasResultFreqList extends Asn1SeqOf {
    ...
    * populated.
    */
   public MeasResultFreqList (int numRecords) {
    ...
    * given the array.  
    */
   public MeasResultFreqList (MeasResult2NR[] elements_) {
      elements = elements_;
   }
