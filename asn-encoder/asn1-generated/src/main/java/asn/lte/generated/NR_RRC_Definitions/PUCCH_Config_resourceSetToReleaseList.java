...
public class PUCCH_Config_resourceSetToReleaseList extends Asn1SeqOf {
   ...
   public PUCCH_ResourceSetId[] elements;

   public PUCCH_Config_resourceSetToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_resourceSetToReleaseList (int numRecords) {
      elements = new PUCCH_ResourceSetId [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_Config_resourceSetToReleaseList (PUCCH_ResourceSetId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUCCH_ResourceSetId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUCCH_ResourceSetId();
