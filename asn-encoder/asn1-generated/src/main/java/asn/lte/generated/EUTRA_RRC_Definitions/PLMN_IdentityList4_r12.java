...
public class PLMN_IdentityList4_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PLMN-IdentityList4-r12";
   }

   public PLMN_IdentityInfo2_r12[] elements;

   public PLMN_IdentityList4_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_IdentityList4_r12 (int numRecords) {
      elements = new PLMN_IdentityInfo2_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMN_IdentityList4_r12 (PLMN_IdentityInfo2_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PLMN_IdentityInfo2_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PLMN_IdentityInfo2_r12();
