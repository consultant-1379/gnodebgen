...
public class PUCCH_Config_spatialRelationInfoToAddModList extends Asn1SeqOf {
   ...
   public PUCCH_Config_spatialRelationInfoToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_spatialRelationInfoToAddModList (int numRecords) {
    ...
    * given the array.  
    */
   public PUCCH_Config_spatialRelationInfoToAddModList (PUCCH_SpatialRelationInfo[] elements_) {
      elements = elements_;
   }
