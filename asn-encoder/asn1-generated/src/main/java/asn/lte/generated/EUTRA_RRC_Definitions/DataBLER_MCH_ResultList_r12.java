...
public class DataBLER_MCH_ResultList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "DataBLER-MCH-ResultList-r12";
   }

   public DataBLER_MCH_Result_r12[] elements;

   public DataBLER_MCH_ResultList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public DataBLER_MCH_ResultList_r12 (int numRecords) {
      elements = new DataBLER_MCH_Result_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public DataBLER_MCH_ResultList_r12 (DataBLER_MCH_Result_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DataBLER_MCH_Result_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DataBLER_MCH_Result_r12();
