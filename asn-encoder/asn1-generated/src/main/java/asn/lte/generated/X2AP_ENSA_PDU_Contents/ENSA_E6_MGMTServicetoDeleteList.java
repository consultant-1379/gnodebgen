...
public class ENSA_E6_MGMTServicetoDeleteList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ENSA-E6-MGMTServicetoDeleteList";
   }

   public ENSA_E6_MGMTServicetoDelete_Item[] elements;

   public ENSA_E6_MGMTServicetoDeleteList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENSA_E6_MGMTServicetoDeleteList (int numRecords) {
      elements = new ENSA_E6_MGMTServicetoDelete_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ENSA_E6_MGMTServicetoDeleteList (ENSA_E6_MGMTServicetoDelete_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENSA_E6_MGMTServicetoDelete_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENSA_E6_MGMTServicetoDelete_Item();
