...
public class SourceBSS_ToTargetBSS_TransparentContainer extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "SourceBSS-ToTargetBSS-TransparentContainer";
   }

   public SourceBSS_ToTargetBSS_TransparentContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public SourceBSS_ToTargetBSS_TransparentContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public SourceBSS_ToTargetBSS_TransparentContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public SourceBSS_ToTargetBSS_TransparentContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
