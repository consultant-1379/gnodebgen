...
public class EmergencyAreaIDList extends Asn1SeqOf {
    ...
    * populated.
    */
   public EmergencyAreaIDList (int numRecords) {
    ...
    * given the array.  
    */
   public EmergencyAreaIDList (EmergencyAreaID[] elements_) {
      elements = elements_;
   }
