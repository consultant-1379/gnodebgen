...
public class DRB_CountInfoListExt_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "DRB-CountInfoListExt-r15";
   }

   public DRB_CountInfo[] elements;

   public DRB_CountInfoListExt_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public DRB_CountInfoListExt_r15 (int numRecords) {
    ...
    * given the array.  
    */
   public DRB_CountInfoListExt_r15 (DRB_CountInfo[] elements_) {
      elements = elements_;
   }
