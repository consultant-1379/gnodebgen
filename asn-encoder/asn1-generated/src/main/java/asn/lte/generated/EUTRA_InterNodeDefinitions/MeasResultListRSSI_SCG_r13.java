...
public class MeasResultListRSSI_SCG_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultListRSSI-SCG-r13";
   }

   public MeasResultRSSI_SCG_r13[] elements;

   public MeasResultListRSSI_SCG_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListRSSI_SCG_r13 (int numRecords) {
      elements = new MeasResultRSSI_SCG_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListRSSI_SCG_r13 (MeasResultRSSI_SCG_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultRSSI_SCG_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultRSSI_SCG_r13();
