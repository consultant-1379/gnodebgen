...
public class CellMeasurementResult_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellMeasurementResult-List";
   }

   public CellMeasurementResult_List_element[] elements;

   public CellMeasurementResult_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellMeasurementResult_List (int numRecords) {
      elements = new CellMeasurementResult_List_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellMeasurementResult_List (CellMeasurementResult_List_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellMeasurementResult_List_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellMeasurementResult_List_element();
