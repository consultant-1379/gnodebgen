...
public class CauseMisc extends Asn1Enumerated {
   ...
   public static final int _NOT_ENOUGH_USER_PLANE_PROCESSING_RESOURCES = 1;
   public static final int _HARDWARE_FAILURE = 2;
   public static final int _OM_INTERVENTION = 3;
   public static final int _UNSPECIFIED = 4;
   public static final int _UNKNOWN_PLMN = 5;

   // Singleton instances of CauseMisc
   protected static final CauseMisc _control_processing_overload = new CauseMisc(0);
   protected static final CauseMisc _not_enough_user_plane_processing_resources = new CauseMisc(1);
   protected static final CauseMisc _hardware_failure = new CauseMisc(2);
   protected static final CauseMisc _om_intervention = new CauseMisc(3);
   protected static final CauseMisc _unspecified = new CauseMisc(4);
   protected static final CauseMisc _unknown_PLMN = new CauseMisc(5);
   ...
   /**
    * Singleton accessor method for unknown_PLMN.
    */
   public static CauseMisc unknown_PLMN() {
      return _unknown_PLMN;
   }
   ...
   public static CauseMisc valueOf (int _value)
   {
      switch ((int)_value) {
         ...
         case 1: return not_enough_user_plane_processing_resources();
         case 2: return hardware_failure();
         case 3: return om_intervention();
         case 4: return unspecified();
         case 5: return unknown_PLMN();
   ...
   public String toString () {
      switch ((int)value) {
         ...
         case 1: return ("not-enough-user-plane-processing-resources");
         case 2: return ("hardware-failure");
         case 3: return ("om-intervention");
         case 4: return ("unspecified");
         case 5: return ("unknown-PLMN");
