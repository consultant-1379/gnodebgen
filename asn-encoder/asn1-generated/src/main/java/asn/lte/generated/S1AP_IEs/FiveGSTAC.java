...
public class FiveGSTAC extends Asn1OctetString {
    ...
    */
   public FiveGSTAC (byte[] data, int offset, int nbytes) {
    ...
    */
   public FiveGSTAC (String value_) throws Asn1ValueParseException {
      super (value_);
   }
