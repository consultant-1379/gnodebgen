...
public class PRACH_ParametersListCE_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PRACH-ParametersListCE-r13";
   }

   public PRACH_ParametersCE_r13[] elements;

   public PRACH_ParametersListCE_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PRACH_ParametersListCE_r13 (int numRecords) {
      elements = new PRACH_ParametersCE_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public PRACH_ParametersListCE_r13 (PRACH_ParametersCE_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PRACH_ParametersCE_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PRACH_ParametersCE_r13();
