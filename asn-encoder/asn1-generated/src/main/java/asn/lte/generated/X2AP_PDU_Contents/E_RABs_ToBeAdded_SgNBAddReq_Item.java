...
public class E_RABs_ToBeAdded_SgNBAddReq_Item extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeAdded-SgNBAddReq-Item";
   }

   public E_RAB_ID e_RAB_ID;
   public DRB_ID drb_ID;
   public EN_DC_ResourceConfiguration en_DC_ResourceConfiguration;
   public E_RABs_ToBeAdded_SgNBAddReq_Item_resource_configuration resource_configuration;
   public E_RABs_ToBeAdded_SgNBAddReq_Item_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public E_RABs_ToBeAdded_SgNBAddReq_Item () {
      super();
      init();
   }
   ...
   public E_RABs_ToBeAdded_SgNBAddReq_Item (
      ...
      E_RABs_ToBeAdded_SgNBAddReq_Item_resource_configuration resource_configuration_,
      E_RABs_ToBeAdded_SgNBAddReq_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      e_RAB_ID = e_RAB_ID_;
      drb_ID = drb_ID_;
    ...
    * the given objects 
    */
   public E_RABs_ToBeAdded_SgNBAddReq_Item (long e_RAB_ID_,
      long drb_ID_,
      EN_DC_ResourceConfiguration en_DC_ResourceConfiguration_,
      E_RABs_ToBeAdded_SgNBAddReq_Item_resource_configuration resource_configuration_,
      E_RABs_ToBeAdded_SgNBAddReq_Item_iE_Extensions iE_Extensions_
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 2: return en_DC_ResourceConfiguration;
         case 3: return resource_configuration;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 2: return "en-DC-ResourceConfiguration";
         case 3: return "resource-configuration";
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      resource_configuration = new E_RABs_ToBeAdded_SgNBAddReq_Item_resource_configuration();
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new E_RABs_ToBeAdded_SgNBAddReq_Item_iE_Extensions();
