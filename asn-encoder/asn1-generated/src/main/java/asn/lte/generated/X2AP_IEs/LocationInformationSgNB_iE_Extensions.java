...
public class LocationInformationSgNB_iE_Extensions extends Asn1SeqOf {
   ...
   public LocationInformationSgNB_iE_Extensions_element[] elements;

   public LocationInformationSgNB_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public LocationInformationSgNB_iE_Extensions (int numRecords) {
      elements = new LocationInformationSgNB_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public LocationInformationSgNB_iE_Extensions (LocationInformationSgNB_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LocationInformationSgNB_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LocationInformationSgNB_iE_Extensions_element();
