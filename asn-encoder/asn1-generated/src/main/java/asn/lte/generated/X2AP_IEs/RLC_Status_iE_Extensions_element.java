...
public class RLC_Status_iE_Extensions_element extends Asn1Seq {
   ...
   public RLC_Status_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public RLC_Status_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.RLC_Status_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.RLC_Status_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.RLC_Status_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
