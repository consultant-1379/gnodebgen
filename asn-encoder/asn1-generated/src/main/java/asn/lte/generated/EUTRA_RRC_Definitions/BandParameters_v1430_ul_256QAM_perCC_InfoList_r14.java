...
public class BandParameters_v1430_ul_256QAM_perCC_InfoList_r14 extends Asn1SeqOf {
   ...
   public UL_256QAM_perCC_Info_r14[] elements;

   public BandParameters_v1430_ul_256QAM_perCC_InfoList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandParameters_v1430_ul_256QAM_perCC_InfoList_r14 (int numRecords) {
      elements = new UL_256QAM_perCC_Info_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandParameters_v1430_ul_256QAM_perCC_InfoList_r14 (UL_256QAM_perCC_Info_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (2, 32);
      int numElements = (int) buffer.decodeLength();

      elements = new UL_256QAM_perCC_Info_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UL_256QAM_perCC_Info_r14();
