...
public class SL_CBR_PPPP_TxConfigList_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-CBR-PPPP-TxConfigList-v1530";
   }

   public SL_PPPP_TxConfigIndex_v1530[] elements;

   public SL_CBR_PPPP_TxConfigList_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_CBR_PPPP_TxConfigList_v1530 (int numRecords) {
      elements = new SL_PPPP_TxConfigIndex_v1530 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_CBR_PPPP_TxConfigList_v1530 (SL_PPPP_TxConfigIndex_v1530[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_PPPP_TxConfigIndex_v1530 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_PPPP_TxConfigIndex_v1530();
