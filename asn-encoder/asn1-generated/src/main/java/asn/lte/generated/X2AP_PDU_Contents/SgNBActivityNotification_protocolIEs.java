...
public class SgNBActivityNotification_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBActivityNotification_protocolIEs_element[] elements;

   public SgNBActivityNotification_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBActivityNotification_protocolIEs (int numRecords) {
      elements = new SgNBActivityNotification_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBActivityNotification_protocolIEs (SgNBActivityNotification_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBActivityNotification_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBActivityNotification_protocolIEs_element();
