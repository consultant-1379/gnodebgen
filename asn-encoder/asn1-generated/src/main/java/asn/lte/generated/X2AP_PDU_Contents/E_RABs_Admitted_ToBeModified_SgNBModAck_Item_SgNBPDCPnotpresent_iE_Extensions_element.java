...
public class E_RABs_Admitted_ToBeModified_SgNBModAck_Item_SgNBPDCPnotpresent_iE_Extensions_element extends Asn1Seq {
   ...
   /**
    * id: id-secondarysgNBDLGTPTEIDatPDCP
   ...
   public E_RABs_Admitted_ToBeModified_SgNBModAck_Item_SgNBPDCPnotpresent_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABs_Admitted_ToBeModified_SgNBModAck_Item_SgNBPDCPnotpresent_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-secondarysgNBDLGTPTEIDatPDCP
    */
   public void setUsing_id_secondarysgNBDLGTPTEIDatPDCP(asn.lte.generated.X2AP_IEs.GTPtunnelEndpoint extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_secondarysgNBDLGTPTEIDatPDCP);
   ...
   /**
    * Get value of extensionValue with type set according to information object having key id-secondarysgNBDLGTPTEIDatPDCP
    */
   public asn.lte.generated.X2AP_IEs.GTPtunnelEndpoint getExtensionValueFor_id_secondarysgNBDLGTPTEIDatPDCP() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.E_RABs_Admitted_ToBeModified_SgNBModAck_Item_SgNBPDCPnotpresentExtIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.E_RABs_Admitted_ToBeModified_SgNBModAck_Item_SgNBPDCPnotpresentExtIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.E_RABs_Admitted_ToBeModified_SgNBModAck_Item_SgNBPDCPnotpresentExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 312) {
         indent (_sb, _level+1);
         _sb.append("id = id-secondarysgNBDLGTPTEIDatPDCP\n");
      }
      else if (id.value == 300) {
         indent (_sb, _level+1);
