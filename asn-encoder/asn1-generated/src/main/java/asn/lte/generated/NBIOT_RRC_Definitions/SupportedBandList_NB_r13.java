...
public class SupportedBandList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandList-NB-r13";
   }

   public SupportedBand_NB_r13[] elements;

   public SupportedBandList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandList_NB_r13 (int numRecords) {
      elements = new SupportedBand_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandList_NB_r13 (SupportedBand_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBand_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedBand_NB_r13();
