...
public class UL_PDCP_DelayResultList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "UL-PDCP-DelayResultList-r13";
   }

   public UL_PDCP_DelayResult_r13[] elements;

   public UL_PDCP_DelayResultList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UL_PDCP_DelayResultList_r13 (int numRecords) {
      elements = new UL_PDCP_DelayResult_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public UL_PDCP_DelayResultList_r13 (UL_PDCP_DelayResult_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UL_PDCP_DelayResult_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UL_PDCP_DelayResult_r13();
