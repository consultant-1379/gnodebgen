...
public class CompleteFailureCauseInformation_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CompleteFailureCauseInformation-List";
   }

   public CompleteFailureCauseInformation_List_element[] elements;

   public CompleteFailureCauseInformation_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public CompleteFailureCauseInformation_List (int numRecords) {
      elements = new CompleteFailureCauseInformation_List_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CompleteFailureCauseInformation_List (CompleteFailureCauseInformation_List_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CompleteFailureCauseInformation_List_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CompleteFailureCauseInformation_List_element();
