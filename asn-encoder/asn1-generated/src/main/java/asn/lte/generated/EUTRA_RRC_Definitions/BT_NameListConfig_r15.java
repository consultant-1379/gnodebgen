...
public class BT_NameListConfig_r15 extends Asn1Choice {
   ...
   public BT_NameListConfig_r15 () {
      super();
   }

   public BT_NameListConfig_r15 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (BT_NameList_r15 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            BT_NameList_r15 setup;
            element = setup = new BT_NameList_r15();
            setup.decode (buffer);
            break;
         }
