...
public class MMEConfigurationUpdateFailure_protocolIEs_element extends Asn1Seq {
   ...
   public MMEConfigurationUpdateFailure_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MMEConfigurationUpdateFailure_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
    ...
    */
   public void setUsing_id_TimeToWait(asn.lte.generated.S1AP_IEs.TimeToWait value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_TimeToWait);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
    ...
    */
   public asn.lte.generated.S1AP_IEs.TimeToWait getValueFor_id_TimeToWait() {
      return (asn.lte.generated.S1AP_IEs.TimeToWait) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.MMEConfigurationUpdateFailureIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.MMEConfigurationUpdateFailureIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.MMEConfigurationUpdateFailureIEs[i];
            break;
         }
      }
      if (null == _index) {
