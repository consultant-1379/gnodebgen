...
public class SeNBReconfigurationComplete_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBReconfigurationComplete_protocolIEs_element[] elements;

   public SeNBReconfigurationComplete_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBReconfigurationComplete_protocolIEs (int numRecords) {
      elements = new SeNBReconfigurationComplete_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBReconfigurationComplete_protocolIEs (SeNBReconfigurationComplete_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBReconfigurationComplete_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBReconfigurationComplete_protocolIEs_element();
