...
public class SubbandCQIList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SubbandCQIList";
   }

   public SubbandCQIItem[] elements;

   public SubbandCQIList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SubbandCQIList (int numRecords) {
      elements = new SubbandCQIItem [numRecords];
   }
    ...
    * given the array.  
    */
   public SubbandCQIList (SubbandCQIItem[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 14);
      int numElements = (int) buffer.decodeLength();

      elements = new SubbandCQIItem [numElements];
