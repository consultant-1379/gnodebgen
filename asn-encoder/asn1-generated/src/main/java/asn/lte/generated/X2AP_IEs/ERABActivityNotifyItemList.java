...
public class ERABActivityNotifyItemList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ERABActivityNotifyItemList";
   }

   public ERABActivityNotifyItem[] elements;

   public ERABActivityNotifyItemList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ERABActivityNotifyItemList (int numRecords) {
      elements = new ERABActivityNotifyItem [numRecords];
   }
    ...
    * given the array.  
    */
   public ERABActivityNotifyItemList (ERABActivityNotifyItem[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ERABActivityNotifyItem [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ERABActivityNotifyItem();
