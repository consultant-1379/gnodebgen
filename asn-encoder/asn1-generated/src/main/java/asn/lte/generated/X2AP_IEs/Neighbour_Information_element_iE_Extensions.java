...
public class Neighbour_Information_element_iE_Extensions extends Asn1SeqOf {
   ...
   public Neighbour_Information_element_iE_Extensions_element[] elements;

   public Neighbour_Information_element_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public Neighbour_Information_element_iE_Extensions (int numRecords) {
      elements = new Neighbour_Information_element_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public Neighbour_Information_element_iE_Extensions (Neighbour_Information_element_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Neighbour_Information_element_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Neighbour_Information_element_iE_Extensions_element();
