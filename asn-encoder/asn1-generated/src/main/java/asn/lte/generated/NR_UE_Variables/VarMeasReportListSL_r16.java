...
public class VarMeasReportListSL_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "VarMeasReportListSL-r16";
   }

   public VarMeasReportSL_r16[] elements;

   public VarMeasReportListSL_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public VarMeasReportListSL_r16 (int numRecords) {
      elements = new VarMeasReportSL_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public VarMeasReportListSL_r16 (VarMeasReportSL_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new VarMeasReportSL_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new VarMeasReportSL_r16();
