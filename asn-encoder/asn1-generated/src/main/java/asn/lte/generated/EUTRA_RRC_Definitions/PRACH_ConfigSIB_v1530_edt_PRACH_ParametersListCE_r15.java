...
public class PRACH_ConfigSIB_v1530_edt_PRACH_ParametersListCE_r15 extends Asn1SeqOf {
   ...
   public EDT_PRACH_ParametersCE_r15[] elements;

   public PRACH_ConfigSIB_v1530_edt_PRACH_ParametersListCE_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PRACH_ConfigSIB_v1530_edt_PRACH_ParametersListCE_r15 (int numRecords) {
      elements = new EDT_PRACH_ParametersCE_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public PRACH_ConfigSIB_v1530_edt_PRACH_ParametersListCE_r15 (EDT_PRACH_ParametersCE_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EDT_PRACH_ParametersCE_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EDT_PRACH_ParametersCE_r15();
