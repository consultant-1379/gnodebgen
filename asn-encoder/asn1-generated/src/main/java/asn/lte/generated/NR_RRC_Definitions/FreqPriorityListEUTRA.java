...
public class FreqPriorityListEUTRA extends Asn1SeqOf {
   ...
   public FreqPriorityEUTRA[] elements;

   public FreqPriorityListEUTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public FreqPriorityListEUTRA (int numRecords) {
      elements = new FreqPriorityEUTRA [numRecords];
   }
    ...
    * given the array.  
    */
   public FreqPriorityListEUTRA (FreqPriorityEUTRA[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqPriorityEUTRA [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqPriorityEUTRA();
