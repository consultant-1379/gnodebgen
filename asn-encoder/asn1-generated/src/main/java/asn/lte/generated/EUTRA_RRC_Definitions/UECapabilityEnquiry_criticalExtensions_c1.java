...
public class UECapabilityEnquiry_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _UECAPABILITYENQUIRY_R8 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public UECapabilityEnquiry_criticalExtensions_c1 () {
      super();
   }

   public UECapabilityEnquiry_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _UECAPABILITYENQUIRY_R8: return "ueCapabilityEnquiry_r8";
   ...
   public void set_ueCapabilityEnquiry_r8 (UECapabilityEnquiry_r8_IEs value) {
      setElement (_UECAPABILITYENQUIRY_R8, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            UECapabilityEnquiry_r8_IEs ueCapabilityEnquiry_r8;
            element = ueCapabilityEnquiry_r8 = new UECapabilityEnquiry_r8_IEs();
            ueCapabilityEnquiry_r8.decode (buffer);
            break;
         }
