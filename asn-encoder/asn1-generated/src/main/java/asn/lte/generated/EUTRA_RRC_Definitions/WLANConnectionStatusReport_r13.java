...
public class WLANConnectionStatusReport_r13 extends Asn1Seq {
   ...
   public WLANConnectionStatusReport_r13_criticalExtensions criticalExtensions;

   public WLANConnectionStatusReport_r13 () {
      super();
      init();
   }
    ...
    */
   public WLANConnectionStatusReport_r13 (
      WLANConnectionStatusReport_r13_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new WLANConnectionStatusReport_r13_criticalExtensions();
