...
public class WLAN_NameList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "WLAN-NameList-r15";
   }

   public WLAN_Name_r15[] elements;

   public WLAN_NameList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public WLAN_NameList_r15 (int numRecords) {
      elements = new WLAN_Name_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public WLAN_NameList_r15 (WLAN_Name_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WLAN_Name_r15 [numElements];
