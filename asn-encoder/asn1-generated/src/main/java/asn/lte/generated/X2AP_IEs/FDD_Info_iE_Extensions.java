...
public class FDD_Info_iE_Extensions extends Asn1SeqOf {
   ...
   public FDD_Info_iE_Extensions_element[] elements;

   public FDD_Info_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public FDD_Info_iE_Extensions (int numRecords) {
      elements = new FDD_Info_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public FDD_Info_iE_Extensions (FDD_Info_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FDD_Info_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FDD_Info_iE_Extensions_element();
