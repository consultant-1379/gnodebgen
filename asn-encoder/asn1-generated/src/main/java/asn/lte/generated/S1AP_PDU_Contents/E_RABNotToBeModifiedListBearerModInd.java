...
public class E_RABNotToBeModifiedListBearerModInd extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABNotToBeModifiedListBearerModInd";
   }

   public E_RABNotToBeModifiedListBearerModInd_element[] elements;

   public E_RABNotToBeModifiedListBearerModInd () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABNotToBeModifiedListBearerModInd (int numRecords) {
      elements = new E_RABNotToBeModifiedListBearerModInd_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABNotToBeModifiedListBearerModInd (E_RABNotToBeModifiedListBearerModInd_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABNotToBeModifiedListBearerModInd_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABNotToBeModifiedListBearerModInd_element();
