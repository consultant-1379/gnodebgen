...
public class CellTrafficTrace_protocolIEs extends Asn1SeqOf {
   ...
   public CellTrafficTrace_protocolIEs_element[] elements;

   public CellTrafficTrace_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellTrafficTrace_protocolIEs (int numRecords) {
      elements = new CellTrafficTrace_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellTrafficTrace_protocolIEs (CellTrafficTrace_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellTrafficTrace_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellTrafficTrace_protocolIEs_element();
