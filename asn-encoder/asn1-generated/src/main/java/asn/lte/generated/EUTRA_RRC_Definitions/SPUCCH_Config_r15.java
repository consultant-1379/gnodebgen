...
public class SPUCCH_Config_r15 extends Asn1Choice {
   ...
   public SPUCCH_Config_r15 () {
      super();
   }

   public SPUCCH_Config_r15 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SPUCCH_Config_r15_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            SPUCCH_Config_r15_setup setup;
            element = setup = new SPUCCH_Config_r15_setup();
            setup.decode (buffer);
            break;
         }
