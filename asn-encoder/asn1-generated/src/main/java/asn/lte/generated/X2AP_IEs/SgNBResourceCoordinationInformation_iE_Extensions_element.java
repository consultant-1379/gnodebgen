...
public class SgNBResourceCoordinationInformation_iE_Extensions_element extends Asn1Seq {
    ...
    * Java type: ECGI
    *
    * id: id-SgNBCoordinationAssistanceInformation
    * criticality: Criticality.reject
    * presence: Presence.optional
    * ASN.1 type: SgNBCoordinationAssistanceInformation
    * Java type: SgNBCoordinationAssistanceInformation
    */
   public Asn1Type extensionValue;

   public SgNBResourceCoordinationInformation_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBResourceCoordinationInformation_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-ECGI
    */
   public void setUsing_id_ECGI(ECGI extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ECGI);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-SgNBCoordinationAssistanceInformation
    */
   public void setUsing_id_SgNBCoordinationAssistanceInformation(SgNBCoordinationAssistanceInformation extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_SgNBCoordinationAssistanceInformation);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-ECGI
    */
   public ECGI getExtensionValueFor_id_ECGI() {
      return (ECGI) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-SgNBCoordinationAssistanceInformation
    */
   public SgNBCoordinationAssistanceInformation getExtensionValueFor_id_SgNBCoordinationAssistanceInformation() {
      return (SgNBCoordinationAssistanceInformation) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.SgNBResourceCoordinationInformationExtIEs.length; i++) {
         if(_X2AP_IEsValues.SgNBResourceCoordinationInformationExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.SgNBResourceCoordinationInformationExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 316) {
         indent (_sb, _level+1);
         _sb.append("id = id-ECGI\n");
      }
      else if (id.value == 324) {
         indent (_sb, _level+1);
         _sb.append("id = id-SgNBCoordinationAssistanceInformation\n");
      }
