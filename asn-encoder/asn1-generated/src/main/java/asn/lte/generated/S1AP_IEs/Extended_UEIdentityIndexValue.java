...
public class Extended_UEIdentityIndexValue extends Asn1BitString {
   ...
   public String getAsn1TypeName()  {
      return "Extended-UEIdentityIndexValue";
   }
    ...
    */
   public Extended_UEIdentityIndexValue () {
      super();
      value = new byte [2];
   }
    ...
    */
   public Extended_UEIdentityIndexValue (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public Extended_UEIdentityIndexValue (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public Extended_UEIdentityIndexValue (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public Extended_UEIdentityIndexValue (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public Extended_UEIdentityIndexValue (java.util.BitSet bitSet) {
      super (bitSet);
   }
