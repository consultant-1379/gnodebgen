...
public class SupportedBandCombination_v1090 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-v1090";
   }

   public BandCombinationParameters_v1090[] elements;

   public SupportedBandCombination_v1090 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_v1090 (int numRecords) {
      elements = new BandCombinationParameters_v1090 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandCombination_v1090 (BandCombinationParameters_v1090[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandCombinationParameters_v1090 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandCombinationParameters_v1090();
