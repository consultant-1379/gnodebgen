...
public class HWLoadIndicator_iE_Extensions extends Asn1SeqOf {
   ...
   public HWLoadIndicator_iE_Extensions_element[] elements;

   public HWLoadIndicator_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public HWLoadIndicator_iE_Extensions (int numRecords) {
      elements = new HWLoadIndicator_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public HWLoadIndicator_iE_Extensions (HWLoadIndicator_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HWLoadIndicator_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new HWLoadIndicator_iE_Extensions_element();
