...
public class MME_Code extends Asn1OctetString {
    ...
    */
   public MME_Code (byte[] data, int offset, int nbytes) {
    ...
    */
   public MME_Code (String value_) throws Asn1ValueParseException {
      super (value_);
   }
