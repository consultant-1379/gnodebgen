...
public class GBR_QosInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public GBR_QosInformation_iE_Extensions_element[] elements;

   public GBR_QosInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public GBR_QosInformation_iE_Extensions (int numRecords) {
      elements = new GBR_QosInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public GBR_QosInformation_iE_Extensions (GBR_QosInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GBR_QosInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GBR_QosInformation_iE_Extensions_element();
