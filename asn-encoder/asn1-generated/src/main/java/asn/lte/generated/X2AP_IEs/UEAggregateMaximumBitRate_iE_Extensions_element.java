...
public class UEAggregateMaximumBitRate_iE_Extensions_element extends Asn1Seq {
   ...
   /**
    * id: id-extended-uEaggregateMaximumBitRateDownlink
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: ExtendedBitRate
    * Java type: ExtendedBitRate
    *
    * id: id-extended-uEaggregateMaximumBitRateUplink
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: ExtendedBitRate
    * Java type: ExtendedBitRate
   ...
   public UEAggregateMaximumBitRate_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UEAggregateMaximumBitRate_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-extended-uEaggregateMaximumBitRateDownlink
    */
   public void setUsing_id_extended_uEaggregateMaximumBitRateDownlink(ExtendedBitRate extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_extended_uEaggregateMaximumBitRateDownlink);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-extended-uEaggregateMaximumBitRateUplink
    */
   public void setUsing_id_extended_uEaggregateMaximumBitRateUplink(ExtendedBitRate extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_extended_uEaggregateMaximumBitRateUplink);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-extended-uEaggregateMaximumBitRateDownlink
    */
   public ExtendedBitRate getExtensionValueFor_id_extended_uEaggregateMaximumBitRateDownlink() {
      return (ExtendedBitRate) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-extended-uEaggregateMaximumBitRateUplink
    */
   public ExtendedBitRate getExtensionValueFor_id_extended_uEaggregateMaximumBitRateUplink() {
      return (ExtendedBitRate) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.UEAggregate_MaximumBitrate_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.UEAggregate_MaximumBitrate_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.UEAggregate_MaximumBitrate_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 200) {
         indent (_sb, _level+1);
         _sb.append("id = id-extended-uEaggregateMaximumBitRateDownlink\n");
      }
      else if (id.value == 201) {
         indent (_sb, _level+1);
         _sb.append("id = id-extended-uEaggregateMaximumBitRateUplink\n");
      }
