...
public class MCEConfigurationUpdateFailure_protocolIEs_element extends Asn1Seq {
   ...
   public MCEConfigurationUpdateFailure_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MCEConfigurationUpdateFailure_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-TimeToWait
    */
   public void setUsing_id_TimeToWait(asn.lte.generated.M3AP_IEs.TimeToWait value) {
      this.id = new asn.lte.generated.M3AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.M3AP_Constants._M3AP_ConstantsValues.id_TimeToWait);
      this.criticality = asn.lte.generated.M3AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-TimeToWait
    */
   public asn.lte.generated.M3AP_IEs.TimeToWait getValueFor_id_TimeToWait() {
      return (asn.lte.generated.M3AP_IEs.TimeToWait) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _M3AP_PDU_ContentsValues.MCEConfigurationUpdateFailureIEs.length; i++) {
         if(_M3AP_PDU_ContentsValues.MCEConfigurationUpdateFailureIEs[i].id.equals(id)) {
            _index = _M3AP_PDU_ContentsValues.MCEConfigurationUpdateFailureIEs[i];
            break;
         }
      }
      if (null == _index) {
