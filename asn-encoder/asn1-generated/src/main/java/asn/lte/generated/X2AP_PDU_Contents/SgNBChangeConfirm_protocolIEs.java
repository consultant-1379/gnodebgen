...
public class SgNBChangeConfirm_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBChangeConfirm_protocolIEs_element[] elements;

   public SgNBChangeConfirm_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBChangeConfirm_protocolIEs (int numRecords) {
      elements = new SgNBChangeConfirm_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBChangeConfirm_protocolIEs (SgNBChangeConfirm_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBChangeConfirm_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBChangeConfirm_protocolIEs_element();
