...
public class ProSeAuthorized_iE_Extensions extends Asn1SeqOf {
   ...
   public ProSeAuthorized_iE_Extensions_element[] elements;

   public ProSeAuthorized_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ProSeAuthorized_iE_Extensions (int numRecords) {
      elements = new ProSeAuthorized_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ProSeAuthorized_iE_Extensions (ProSeAuthorized_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ProSeAuthorized_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ProSeAuthorized_iE_Extensions_element();
