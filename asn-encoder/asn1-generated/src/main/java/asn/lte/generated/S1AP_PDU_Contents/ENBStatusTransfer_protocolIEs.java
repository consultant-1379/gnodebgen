...
public class ENBStatusTransfer_protocolIEs extends Asn1SeqOf {
   ...
   public ENBStatusTransfer_protocolIEs_element[] elements;

   public ENBStatusTransfer_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENBStatusTransfer_protocolIEs (int numRecords) {
      elements = new ENBStatusTransfer_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENBStatusTransfer_protocolIEs (ENBStatusTransfer_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENBStatusTransfer_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENBStatusTransfer_protocolIEs_element();
