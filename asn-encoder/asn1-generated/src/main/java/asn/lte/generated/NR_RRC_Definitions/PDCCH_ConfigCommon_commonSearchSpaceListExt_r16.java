...
public class PDCCH_ConfigCommon_commonSearchSpaceListExt_r16 extends Asn1SeqOf {
   ...
   public SearchSpaceExt_r16[] elements;

   public PDCCH_ConfigCommon_commonSearchSpaceListExt_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDCCH_ConfigCommon_commonSearchSpaceListExt_r16 (int numRecords) {
      elements = new SearchSpaceExt_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PDCCH_ConfigCommon_commonSearchSpaceListExt_r16 (SearchSpaceExt_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SearchSpaceExt_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SearchSpaceExt_r16();
