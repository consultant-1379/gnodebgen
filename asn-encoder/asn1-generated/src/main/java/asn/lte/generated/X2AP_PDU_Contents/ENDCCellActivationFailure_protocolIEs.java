...
public class ENDCCellActivationFailure_protocolIEs extends Asn1SeqOf {
   ...
   public ENDCCellActivationFailure_protocolIEs_element[] elements;

   public ENDCCellActivationFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENDCCellActivationFailure_protocolIEs (int numRecords) {
      elements = new ENDCCellActivationFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENDCCellActivationFailure_protocolIEs (ENDCCellActivationFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENDCCellActivationFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENDCCellActivationFailure_protocolIEs_element();
