...
public class AdditionalSpecialSubframe_Info_iE_Extensions extends Asn1SeqOf {
   ...
   public AdditionalSpecialSubframe_Info_iE_Extensions_element[] elements;

   public AdditionalSpecialSubframe_Info_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public AdditionalSpecialSubframe_Info_iE_Extensions (int numRecords) {
      elements = new AdditionalSpecialSubframe_Info_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public AdditionalSpecialSubframe_Info_iE_Extensions (AdditionalSpecialSubframe_Info_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AdditionalSpecialSubframe_Info_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AdditionalSpecialSubframe_Info_iE_Extensions_element();
