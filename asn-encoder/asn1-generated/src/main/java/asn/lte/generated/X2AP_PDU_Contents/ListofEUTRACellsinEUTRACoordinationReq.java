...
public class ListofEUTRACellsinEUTRACoordinationReq extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ListofEUTRACellsinEUTRACoordinationReq";
   }

   public ECGI[] elements;

   public ListofEUTRACellsinEUTRACoordinationReq () {
      elements = null;
   }
    ...
    * populated.
    */
   public ListofEUTRACellsinEUTRACoordinationReq (int numRecords) {
    ...
    * given the array.  
    */
   public ListofEUTRACellsinEUTRACoordinationReq (ECGI[] elements_) {
      elements = elements_;
   }
