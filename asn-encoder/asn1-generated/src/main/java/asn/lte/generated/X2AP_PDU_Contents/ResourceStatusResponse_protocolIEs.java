...
public class ResourceStatusResponse_protocolIEs extends Asn1SeqOf {
   ...
   public ResourceStatusResponse_protocolIEs_element[] elements;

   public ResourceStatusResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResourceStatusResponse_protocolIEs (int numRecords) {
      elements = new ResourceStatusResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ResourceStatusResponse_protocolIEs (ResourceStatusResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResourceStatusResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResourceStatusResponse_protocolIEs_element();
