...
public class NeighCellsPerBandclassListCDMA2000_v920 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NeighCellsPerBandclassListCDMA2000-v920";
   }

   public NeighCellsPerBandclassCDMA2000_v920[] elements;

   public NeighCellsPerBandclassListCDMA2000_v920 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NeighCellsPerBandclassListCDMA2000_v920 (int numRecords) {
      elements = new NeighCellsPerBandclassCDMA2000_v920 [numRecords];
   }
    ...
    * given the array.  
    */
   public NeighCellsPerBandclassListCDMA2000_v920 (NeighCellsPerBandclassCDMA2000_v920[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NeighCellsPerBandclassCDMA2000_v920 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NeighCellsPerBandclassCDMA2000_v920();
