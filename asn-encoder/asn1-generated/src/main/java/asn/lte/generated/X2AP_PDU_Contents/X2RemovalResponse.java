...
public class X2RemovalResponse extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "X2RemovalResponse";
   }

   public X2RemovalResponse_protocolIEs protocolIEs;
   public Asn1OpenExt extElem1;

   public X2RemovalResponse () {
      super();
      init();
   }
    ...
    */
   public X2RemovalResponse (
      X2RemovalResponse_protocolIEs protocolIEs_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      protocolIEs = new X2RemovalResponse_protocolIEs();
