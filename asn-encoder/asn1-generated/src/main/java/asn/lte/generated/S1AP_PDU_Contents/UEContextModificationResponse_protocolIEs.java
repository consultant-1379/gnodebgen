...
public class UEContextModificationResponse_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextModificationResponse_protocolIEs_element[] elements;

   public UEContextModificationResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextModificationResponse_protocolIEs (int numRecords) {
      elements = new UEContextModificationResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextModificationResponse_protocolIEs (UEContextModificationResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextModificationResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextModificationResponse_protocolIEs_element();
