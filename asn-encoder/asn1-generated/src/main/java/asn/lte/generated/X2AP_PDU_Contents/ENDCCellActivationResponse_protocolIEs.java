...
public class ENDCCellActivationResponse_protocolIEs extends Asn1SeqOf {
   ...
   public ENDCCellActivationResponse_protocolIEs_element[] elements;

   public ENDCCellActivationResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENDCCellActivationResponse_protocolIEs (int numRecords) {
      elements = new ENDCCellActivationResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENDCCellActivationResponse_protocolIEs (ENDCCellActivationResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENDCCellActivationResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENDCCellActivationResponse_protocolIEs_element();
