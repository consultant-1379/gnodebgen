...
public class LAI_iE_Extensions extends Asn1SeqOf {
   ...
   public LAI_iE_Extensions_element[] elements;

   public LAI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public LAI_iE_Extensions (int numRecords) {
      elements = new LAI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public LAI_iE_Extensions (LAI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LAI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LAI_iE_Extensions_element();
