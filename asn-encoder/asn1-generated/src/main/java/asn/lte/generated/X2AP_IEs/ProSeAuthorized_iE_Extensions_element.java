...
public class ProSeAuthorized_iE_Extensions_element extends Asn1Seq {
   ...
   public void setUsing_id_ProSeUEtoNetworkRelaying(ProSeUEtoNetworkRelaying extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ProSeUEtoNetworkRelaying);
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.ProSeAuthorized_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.ProSeAuthorized_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.ProSeAuthorized_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
