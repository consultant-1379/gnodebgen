...
public class L3_Information extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "L3-Information";
   }

   public L3_Information () {
      super();
   }
    ...
    *              in binary form.
    */
   public L3_Information (byte[] data) {
      super (data);
   }
    ...
    */
   public L3_Information (byte[] data, int offset, int nbytes) {
    ...
    */
   public L3_Information (String value_) throws Asn1ValueParseException {
      super (value_);
   }
