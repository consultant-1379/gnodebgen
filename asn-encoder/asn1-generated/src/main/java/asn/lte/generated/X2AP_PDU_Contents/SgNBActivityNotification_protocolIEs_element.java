...
public class SgNBActivityNotification_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-UEContextLevelUserPlaneActivity
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: UserPlaneTrafficActivityReport
    * Java type: UserPlaneTrafficActivityReport
    *
    * id: id-ERABActivityNotifyItemList
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: ERABActivityNotifyItemList
    * Java type: ERABActivityNotifyItemList
    *
   ...
   public SgNBActivityNotification_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBActivityNotification_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-UEContextLevelUserPlaneActivity
    */
   public void setUsing_id_UEContextLevelUserPlaneActivity(asn.lte.generated.X2AP_IEs.UserPlaneTrafficActivityReport value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_UEContextLevelUserPlaneActivity);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-ERABActivityNotifyItemList
    */
   public void setUsing_id_ERABActivityNotifyItemList(asn.lte.generated.X2AP_IEs.ERABActivityNotifyItemList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ERABActivityNotifyItemList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-UEContextLevelUserPlaneActivity
    */
   public asn.lte.generated.X2AP_IEs.UserPlaneTrafficActivityReport getValueFor_id_UEContextLevelUserPlaneActivity() {
      return (asn.lte.generated.X2AP_IEs.UserPlaneTrafficActivityReport) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-ERABActivityNotifyItemList
    */
   public asn.lte.generated.X2AP_IEs.ERABActivityNotifyItemList getValueFor_id_ERABActivityNotifyItemList() {
      return (asn.lte.generated.X2AP_IEs.ERABActivityNotifyItemList) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SgNBActivityNotification_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SgNBActivityNotification_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SgNBActivityNotification_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 296) {
         indent (_sb, _level+1);
         _sb.append("id = id-UEContextLevelUserPlaneActivity\n");
      }
      else if (id.value == 297) {
         indent (_sb, _level+1);
         _sb.append("id = id-ERABActivityNotifyItemList\n");
      }
