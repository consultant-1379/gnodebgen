...
public class ENBCPRelocationIndication_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: UL-CP-SecurityInformation
    * Java type: UL_CP_SecurityInformation
    */
   public Asn1Type value;

   public ENBCPRelocationIndication_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENBCPRelocationIndication_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-UL-CP-SecurityInformation
    */
   public void setUsing_id_UL_CP_SecurityInformation(asn.lte.generated.S1AP_IEs.UL_CP_SecurityInformation value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_UL_CP_SecurityInformation);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-UL-CP-SecurityInformation
    */
   public asn.lte.generated.S1AP_IEs.UL_CP_SecurityInformation getValueFor_id_UL_CP_SecurityInformation() {
      return (asn.lte.generated.S1AP_IEs.UL_CP_SecurityInformation) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.ENBCPRelocationIndicationIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.ENBCPRelocationIndicationIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.ENBCPRelocationIndicationIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 8) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-UL-CP-SecurityInformation\n");
      }
