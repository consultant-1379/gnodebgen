...
public class CSI_RS_ConfigNonPrecoded_r13_csi_IM_ConfigIdList_r13 extends Asn1SeqOf {
   ...
   public CSI_IM_ConfigId_r13[] elements;

   public CSI_RS_ConfigNonPrecoded_r13_csi_IM_ConfigIdList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_ConfigNonPrecoded_r13_csi_IM_ConfigIdList_r13 (int numRecords) {
      elements = new CSI_IM_ConfigId_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_RS_ConfigNonPrecoded_r13_csi_IM_ConfigIdList_r13 (CSI_IM_ConfigId_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_IM_ConfigId_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_IM_ConfigId_r13();
