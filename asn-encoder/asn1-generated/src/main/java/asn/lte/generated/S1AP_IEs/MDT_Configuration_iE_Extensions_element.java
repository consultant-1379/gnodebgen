...
public class MDT_Configuration_iE_Extensions_element extends Asn1Seq {
   ...
   public void setUsing_id_SignallingBasedMDTPLMNList(MDTPLMNList extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_SignallingBasedMDTPLMNList);
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.MDT_Configuration_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.MDT_Configuration_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.MDT_Configuration_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
