...
public class AUL_Config_r15 extends Asn1Choice {
   ...
   public AUL_Config_r15 () {
      super();
   }

   public AUL_Config_r15 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (AUL_Config_r15_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            AUL_Config_r15_setup setup;
            element = setup = new AUL_Config_r15_setup();
            setup.decode (buffer);
            break;
         }
