...
public class LastVisitedUTRANCellInformation extends Asn1OctetString {
   ...
   public LastVisitedUTRANCellInformation () {
      super();
   }
    ...
    *              in binary form.
    */
   public LastVisitedUTRANCellInformation (byte[] data) {
      super (data);
   }
    ...
    */
   public LastVisitedUTRANCellInformation (byte[] data, int offset, int nbytes) {
    ...
    */
   public LastVisitedUTRANCellInformation (String value_) throws Asn1ValueParseException {
      super (value_);
   }
