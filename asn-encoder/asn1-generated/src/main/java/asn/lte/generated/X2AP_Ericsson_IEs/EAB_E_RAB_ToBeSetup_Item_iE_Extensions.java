...
public class EAB_E_RAB_ToBeSetup_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public EAB_E_RAB_ToBeSetup_Item_iE_Extensions_element[] elements;

   public EAB_E_RAB_ToBeSetup_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_E_RAB_ToBeSetup_Item_iE_Extensions (int numRecords) {
      elements = new EAB_E_RAB_ToBeSetup_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_E_RAB_ToBeSetup_Item_iE_Extensions (EAB_E_RAB_ToBeSetup_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_E_RAB_ToBeSetup_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_E_RAB_ToBeSetup_Item_iE_Extensions_element();
