...
public class PathSwitchRequestAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public PathSwitchRequestAcknowledge_protocolIEs_element[] elements;

   public PathSwitchRequestAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public PathSwitchRequestAcknowledge_protocolIEs (int numRecords) {
      elements = new PathSwitchRequestAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PathSwitchRequestAcknowledge_protocolIEs (PathSwitchRequestAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PathSwitchRequestAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PathSwitchRequestAcknowledge_protocolIEs_element();
