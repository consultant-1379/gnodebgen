...
public class BluetoothName extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public BluetoothName (byte[] data) {
      super (data);
   }
    ...
    */
   public BluetoothName (byte[] data, int offset, int nbytes) {
    ...
    */
   public BluetoothName (String value_) throws Asn1ValueParseException {
      super (value_);
   }
