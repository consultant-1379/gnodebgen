...
public class LogMeasResultListWLAN_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "LogMeasResultListWLAN-r16";
   }

   public LogMeasResultWLAN_r16[] elements;

   public LogMeasResultListWLAN_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public LogMeasResultListWLAN_r16 (int numRecords) {
      elements = new LogMeasResultWLAN_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public LogMeasResultListWLAN_r16 (LogMeasResultWLAN_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LogMeasResultWLAN_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LogMeasResultWLAN_r16();
