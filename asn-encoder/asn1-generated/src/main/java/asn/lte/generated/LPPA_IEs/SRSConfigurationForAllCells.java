...
public class SRSConfigurationForAllCells extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SRSConfigurationForAllCells";
   }

   public SRSConfigurationForOneCell[] elements;

   public SRSConfigurationForAllCells () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRSConfigurationForAllCells (int numRecords) {
      elements = new SRSConfigurationForOneCell [numRecords];
   }
    ...
    * given the array.  
    */
   public SRSConfigurationForAllCells (SRSConfigurationForOneCell[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRSConfigurationForOneCell [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRSConfigurationForOneCell();
