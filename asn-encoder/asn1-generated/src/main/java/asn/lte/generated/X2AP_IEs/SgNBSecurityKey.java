...
public class SgNBSecurityKey extends Asn1BitString {
    ...
    */
   public SgNBSecurityKey (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public SgNBSecurityKey (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public SgNBSecurityKey (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public SgNBSecurityKey (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public SgNBSecurityKey (java.util.BitSet bitSet) {
      super (bitSet);
   }
