...
public class InterFreqTargetInfo_r16_cellList extends Asn1SeqOf {
   ...
   public InterFreqTargetInfo_r16_cellList () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqTargetInfo_r16_cellList (int numRecords) {
    ...
    * given the array.  
    */
   public InterFreqTargetInfo_r16_cellList (PhysCellId[] elements_) {
      elements = elements_;
   }
