...
public class ENDCCellActivationRequest_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-ServedNRCellsToActivate
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: ServedNRCellsToActivate
    * Java type: ServedNRCellsToActivate
    *
    * id: id-ActivationID
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: ActivationID
    * Java type: ActivationID
    *
   ...
   public ENDCCellActivationRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCCellActivationRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-ServedNRCellsToActivate
    */
   public void setUsing_id_ServedNRCellsToActivate(ServedNRCellsToActivate value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ServedNRCellsToActivate);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-ActivationID
    */
   public void setUsing_id_ActivationID(asn.lte.generated.X2AP_IEs.ActivationID value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ActivationID);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-ServedNRCellsToActivate
    */
   public ServedNRCellsToActivate getValueFor_id_ServedNRCellsToActivate() {
      return (ServedNRCellsToActivate) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-ActivationID
    */
   public asn.lte.generated.X2AP_IEs.ActivationID getValueFor_id_ActivationID() {
      return (asn.lte.generated.X2AP_IEs.ActivationID) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCCellActivationRequest_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCCellActivationRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCCellActivationRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 267) {
         indent (_sb, _level+1);
         _sb.append("id = id-ServedNRCellsToActivate\n");
      }
      else if (id.value == 256) {
         indent (_sb, _level+1);
         _sb.append("id = id-ActivationID\n");
      }
