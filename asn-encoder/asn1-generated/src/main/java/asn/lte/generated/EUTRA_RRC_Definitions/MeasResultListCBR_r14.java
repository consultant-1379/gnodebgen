...
public class MeasResultListCBR_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultListCBR-r14";
   }

   public MeasResultCBR_r14[] elements;

   public MeasResultListCBR_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListCBR_r14 (int numRecords) {
      elements = new MeasResultCBR_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListCBR_r14 (MeasResultCBR_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultCBR_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultCBR_r14();
