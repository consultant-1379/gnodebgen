...
public class CellsToAddModUTRA_FDD extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "CellsToAddModUTRA-FDD";
   }

   public Asn1Integer cellIndex;
   public PhysCellIdUTRA_FDD physCellId;

   public CellsToAddModUTRA_FDD () {
      super();
      init();
   }
   ...
   public CellsToAddModUTRA_FDD (
      ...
      PhysCellIdUTRA_FDD physCellId_
   ) {
      super();
    ...
    * the given objects 
    */
   public CellsToAddModUTRA_FDD (long cellIndex_,
      long physCellId_
   ) {
      super();
      cellIndex = new Asn1Integer (cellIndex_);
      physCellId = new PhysCellIdUTRA_FDD (physCellId_);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      physCellId = new PhysCellIdUTRA_FDD();
