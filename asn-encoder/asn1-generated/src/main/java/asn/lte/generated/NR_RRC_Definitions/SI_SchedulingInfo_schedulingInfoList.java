...
public class SI_SchedulingInfo_schedulingInfoList extends Asn1SeqOf {
   ...
   public SchedulingInfo[] elements;

   public SI_SchedulingInfo_schedulingInfoList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SI_SchedulingInfo_schedulingInfoList (int numRecords) {
      elements = new SchedulingInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public SI_SchedulingInfo_schedulingInfoList (SchedulingInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SchedulingInfo [numElements];
