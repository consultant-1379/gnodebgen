...
public class UEPagingCoverageInformation_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UEPagingCoverageInformation-NB";
   }

   public UEPagingCoverageInformation_NB_criticalExtensions criticalExtensions;

   public UEPagingCoverageInformation_NB () {
      super();
      init();
   }
    ...
    */
   public UEPagingCoverageInformation_NB (
      UEPagingCoverageInformation_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new UEPagingCoverageInformation_NB_criticalExtensions();
