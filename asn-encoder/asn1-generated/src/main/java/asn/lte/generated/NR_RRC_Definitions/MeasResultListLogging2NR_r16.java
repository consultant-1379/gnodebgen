...
public class MeasResultListLogging2NR_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultListLogging2NR-r16";
   }

   public MeasResultLogging2NR_r16[] elements;

   public MeasResultListLogging2NR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListLogging2NR_r16 (int numRecords) {
      elements = new MeasResultLogging2NR_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListLogging2NR_r16 (MeasResultLogging2NR_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultLogging2NR_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultLogging2NR_r16();
