...
public class MobilityFromEUTRACommand_v930_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "MobilityFromEUTRACommand-v930-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public MobilityFromEUTRACommand_v960_IEs nonCriticalExtension;  // optional

   public MobilityFromEUTRACommand_v930_IEs () {
      super();
      init();
   }
   ...
   public MobilityFromEUTRACommand_v930_IEs (
      ...
      MobilityFromEUTRACommand_v960_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public MobilityFromEUTRACommand_v930_IEs (byte[] lateNonCriticalExtension_,
      MobilityFromEUTRACommand_v960_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new MobilityFromEUTRACommand_v960_IEs();
