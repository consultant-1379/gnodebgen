...
public class SRS_Config_srs_ResourceSetToReleaseListDCI_0_2_r16 extends Asn1SeqOf {
   ...
   public SRS_ResourceSetId[] elements;

   public SRS_Config_srs_ResourceSetToReleaseListDCI_0_2_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRS_Config_srs_ResourceSetToReleaseListDCI_0_2_r16 (int numRecords) {
      elements = new SRS_ResourceSetId [numRecords];
   }
    ...
    * given the array.  
    */
   public SRS_Config_srs_ResourceSetToReleaseListDCI_0_2_r16 (SRS_ResourceSetId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRS_ResourceSetId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRS_ResourceSetId();
