...
public class NASSecurityParametersfromE_UTRAN extends Asn1OctetString {
   ...
   public NASSecurityParametersfromE_UTRAN () {
      super();
   }
    ...
    *              in binary form.
    */
   public NASSecurityParametersfromE_UTRAN (byte[] data) {
      super (data);
   }
    ...
    */
   public NASSecurityParametersfromE_UTRAN (byte[] data, int offset, int nbytes) {
    ...
    */
   public NASSecurityParametersfromE_UTRAN (String value_) throws Asn1ValueParseException {
      super (value_);
   }
