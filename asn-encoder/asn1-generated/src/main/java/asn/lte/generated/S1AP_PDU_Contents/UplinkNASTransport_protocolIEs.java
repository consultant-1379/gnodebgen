...
public class UplinkNASTransport_protocolIEs extends Asn1SeqOf {
   ...
   public UplinkNASTransport_protocolIEs_element[] elements;

   public UplinkNASTransport_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UplinkNASTransport_protocolIEs (int numRecords) {
      elements = new UplinkNASTransport_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UplinkNASTransport_protocolIEs (UplinkNASTransport_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UplinkNASTransport_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UplinkNASTransport_protocolIEs_element();
