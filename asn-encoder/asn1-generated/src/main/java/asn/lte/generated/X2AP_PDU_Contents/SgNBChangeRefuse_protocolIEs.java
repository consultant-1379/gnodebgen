...
public class SgNBChangeRefuse_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBChangeRefuse_protocolIEs_element[] elements;

   public SgNBChangeRefuse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBChangeRefuse_protocolIEs (int numRecords) {
      elements = new SgNBChangeRefuse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBChangeRefuse_protocolIEs (SgNBChangeRefuse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBChangeRefuse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBChangeRefuse_protocolIEs_element();
