...
public class E_RABSetupItemBearerSURes extends Asn1Seq {
   ...
   public E_RABSetupItemBearerSURes_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public E_RABSetupItemBearerSURes () {
      super();
      init();
   }
   ...
   public E_RABSetupItemBearerSURes (
      ...
      GTP_TEID gTP_TEID_,
      E_RABSetupItemBearerSURes_iE_Extensions iE_Extensions_
   ) {
      super();
      e_RAB_ID = e_RAB_ID_;
      transportLayerAddress = transportLayerAddress_;
    ...
    * the given objects 
    */
   public E_RABSetupItemBearerSURes (long e_RAB_ID_,
      TransportLayerAddress transportLayerAddress_,
      byte[] gTP_TEID_,
      E_RABSetupItemBearerSURes_iE_Extensions iE_Extensions_
   ) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new E_RABSetupItemBearerSURes_iE_Extensions();
