...
public class UL_DelayConfig_r13 extends Asn1Choice {
   ...
   public UL_DelayConfig_r13 () {
      super();
   }

   public UL_DelayConfig_r13 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (UL_DelayConfig_r13_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            UL_DelayConfig_r13_setup setup;
            element = setup = new UL_DelayConfig_r13_setup();
            setup.decode (buffer);
            break;
         }
