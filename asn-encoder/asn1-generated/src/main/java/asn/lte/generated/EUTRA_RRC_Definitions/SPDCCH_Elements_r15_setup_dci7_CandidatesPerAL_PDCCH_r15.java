...
public class SPDCCH_Elements_r15_setup_dci7_CandidatesPerAL_PDCCH_r15 extends Asn1SeqOf {
   ...
   public DCI7_Candidates_r15[] elements;

   public SPDCCH_Elements_r15_setup_dci7_CandidatesPerAL_PDCCH_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPDCCH_Elements_r15_setup_dci7_CandidatesPerAL_PDCCH_r15 (int numRecords) {
      elements = new DCI7_Candidates_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public SPDCCH_Elements_r15_setup_dci7_CandidatesPerAL_PDCCH_r15 (DCI7_Candidates_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DCI7_Candidates_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DCI7_Candidates_r15();
