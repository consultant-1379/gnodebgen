...
public class EPDCCH_SetConfigToReleaseList_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EPDCCH-SetConfigToReleaseList-r11";
   }

   public EPDCCH_SetConfigId_r11[] elements;

   public EPDCCH_SetConfigToReleaseList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public EPDCCH_SetConfigToReleaseList_r11 (int numRecords) {
      elements = new EPDCCH_SetConfigId_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public EPDCCH_SetConfigToReleaseList_r11 (EPDCCH_SetConfigId_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EPDCCH_SetConfigId_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EPDCCH_SetConfigId_r11();
