...
public class ReservedSubframePattern_iE_Extensions extends Asn1SeqOf {
   ...
   public ReservedSubframePattern_iE_Extensions_element[] elements;

   public ReservedSubframePattern_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ReservedSubframePattern_iE_Extensions (int numRecords) {
      elements = new ReservedSubframePattern_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ReservedSubframePattern_iE_Extensions (ReservedSubframePattern_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ReservedSubframePattern_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ReservedSubframePattern_iE_Extensions_element();
