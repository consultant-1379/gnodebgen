...
public class TransportLayerAddress extends Asn1BitString {
    ...
    */
   public TransportLayerAddress (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public TransportLayerAddress (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public TransportLayerAddress (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public TransportLayerAddress (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public TransportLayerAddress (java.util.BitSet bitSet) {
      super (bitSet);
   }
