...
public class Cdma2000OneXPilot extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "Cdma2000OneXPilot";
   }

   public Cdma2000OneXPilot () {
      super();
   }
    ...
    *              in binary form.
    */
   public Cdma2000OneXPilot (byte[] data) {
      super (data);
   }
    ...
    */
   public Cdma2000OneXPilot (byte[] data, int offset, int nbytes) {
    ...
    */
   public Cdma2000OneXPilot (String value_) throws Asn1ValueParseException {
      super (value_);
   }
