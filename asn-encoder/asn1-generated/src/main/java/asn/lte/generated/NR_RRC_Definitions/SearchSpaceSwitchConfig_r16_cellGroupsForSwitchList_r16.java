...
public class SearchSpaceSwitchConfig_r16_cellGroupsForSwitchList_r16 extends Asn1SeqOf {
   ...
   public CellGroupForSwitch_r16[] elements;

   public SearchSpaceSwitchConfig_r16_cellGroupsForSwitchList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SearchSpaceSwitchConfig_r16_cellGroupsForSwitchList_r16 (int numRecords) {
      elements = new CellGroupForSwitch_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SearchSpaceSwitchConfig_r16_cellGroupsForSwitchList_r16 (CellGroupForSwitch_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellGroupForSwitch_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellGroupForSwitch_r16();
