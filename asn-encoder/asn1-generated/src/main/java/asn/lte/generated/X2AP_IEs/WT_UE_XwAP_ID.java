...
public class WT_UE_XwAP_ID extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "WT-UE-XwAP-ID";
   }

   public WT_UE_XwAP_ID () {
      super();
   }
    ...
    *              in binary form.
    */
   public WT_UE_XwAP_ID (byte[] data) {
      super (data);
   }
    ...
    */
   public WT_UE_XwAP_ID (byte[] data, int offset, int nbytes) {
    ...
    */
   public WT_UE_XwAP_ID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
