...
public class SCellToAddModListExt_v1370 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCellToAddModListExt-v1370";
   }

   public SCellToAddModExt_v1370[] elements;

   public SCellToAddModListExt_v1370 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCellToAddModListExt_v1370 (int numRecords) {
      elements = new SCellToAddModExt_v1370 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCellToAddModListExt_v1370 (SCellToAddModExt_v1370[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCellToAddModExt_v1370 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SCellToAddModExt_v1370();
