...
public class SecurityModeFailure_v8a0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SecurityModeFailure-v8a0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public SecurityModeFailure_v8a0_IEs_nonCriticalExtension nonCriticalExtension;  // optional

   public SecurityModeFailure_v8a0_IEs () {
      super();
      init();
   }
   ...
   public SecurityModeFailure_v8a0_IEs (
      ...
      SecurityModeFailure_v8a0_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public SecurityModeFailure_v8a0_IEs (byte[] lateNonCriticalExtension_,
      SecurityModeFailure_v8a0_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new SecurityModeFailure_v8a0_IEs_nonCriticalExtension();
