...
public class MobilityFromEUTRACommand_r9_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "MobilityFromEUTRACommand-r9-IEs";
   }

   public Asn1Boolean cs_FallbackIndicator;
   public MobilityFromEUTRACommand_r9_IEs_purpose purpose;
   public MobilityFromEUTRACommand_v930_IEs nonCriticalExtension;  // optional

   public MobilityFromEUTRACommand_r9_IEs () {
      super();
      init();
   }
   ...
   public MobilityFromEUTRACommand_r9_IEs (
      ...
      MobilityFromEUTRACommand_r9_IEs_purpose purpose_,
      MobilityFromEUTRACommand_v930_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public MobilityFromEUTRACommand_r9_IEs (boolean cs_FallbackIndicator_,
      MobilityFromEUTRACommand_r9_IEs_purpose purpose_,
      MobilityFromEUTRACommand_v930_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      purpose = new MobilityFromEUTRACommand_r9_IEs_purpose();
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new MobilityFromEUTRACommand_v930_IEs();
