...
public class SchedulingInfoList_BR_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SchedulingInfoList-BR-r13";
   }

   public SchedulingInfo_BR_r13[] elements;

   public SchedulingInfoList_BR_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SchedulingInfoList_BR_r13 (int numRecords) {
      elements = new SchedulingInfo_BR_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SchedulingInfoList_BR_r13 (SchedulingInfo_BR_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SchedulingInfo_BR_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SchedulingInfo_BR_r13();
