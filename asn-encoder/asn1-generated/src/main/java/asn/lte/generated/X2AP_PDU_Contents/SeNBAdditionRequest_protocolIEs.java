...
public class SeNBAdditionRequest_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBAdditionRequest_protocolIEs_element[] elements;

   public SeNBAdditionRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBAdditionRequest_protocolIEs (int numRecords) {
      elements = new SeNBAdditionRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBAdditionRequest_protocolIEs (SeNBAdditionRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBAdditionRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBAdditionRequest_protocolIEs_element();
