...
public class TraceActivation_iE_Extensions extends Asn1SeqOf {
   ...
   public TraceActivation_iE_Extensions_element[] elements;

   public TraceActivation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TraceActivation_iE_Extensions (int numRecords) {
      elements = new TraceActivation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TraceActivation_iE_Extensions (TraceActivation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TraceActivation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TraceActivation_iE_Extensions_element();
