...
public class ENDCX2SetupFailure_protocolIEs_element extends Asn1Seq {
   ...
   public ENDCX2SetupFailure_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCX2SetupFailure_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCX2SetupFailure_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCX2SetupFailure_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCX2SetupFailure_IEs[i];
            break;
         }
      }
      if (null == _index) {
