...
public class RadioLinkMonitoringRS_detectionResource extends Asn1Choice {
   ...
   public RadioLinkMonitoringRS_detectionResource () {
      super();
   }

   public RadioLinkMonitoringRS_detectionResource (byte choiceId_, Asn1Type element_) {
      super();
