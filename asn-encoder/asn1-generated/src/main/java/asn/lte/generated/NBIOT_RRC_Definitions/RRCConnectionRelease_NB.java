...
public class RRCConnectionRelease_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionRelease-NB";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier;
   public RRCConnectionRelease_NB_criticalExtensions criticalExtensions;

   public RRCConnectionRelease_NB () {
      super();
      init();
   }
   ...
   public RRCConnectionRelease_NB (
      ...
      RRCConnectionRelease_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public RRCConnectionRelease_NB (long rrc_TransactionIdentifier_,
      RRCConnectionRelease_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionRelease_NB_criticalExtensions();
