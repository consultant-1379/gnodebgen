...
public class MobilityChangeRequest_protocolIEs extends Asn1SeqOf {
   ...
   public MobilityChangeRequest_protocolIEs_element[] elements;

   public MobilityChangeRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MobilityChangeRequest_protocolIEs (int numRecords) {
      elements = new MobilityChangeRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MobilityChangeRequest_protocolIEs (MobilityChangeRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MobilityChangeRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MobilityChangeRequest_protocolIEs_element();
