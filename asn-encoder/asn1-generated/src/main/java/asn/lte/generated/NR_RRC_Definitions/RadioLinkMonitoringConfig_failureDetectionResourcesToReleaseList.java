...
public class RadioLinkMonitoringConfig_failureDetectionResourcesToReleaseList extends Asn1SeqOf {
   ...
   public RadioLinkMonitoringRS_Id[] elements;

   public RadioLinkMonitoringConfig_failureDetectionResourcesToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public RadioLinkMonitoringConfig_failureDetectionResourcesToReleaseList (int numRecords) {
      elements = new RadioLinkMonitoringRS_Id [numRecords];
   }
    ...
    * given the array.  
    */
   public RadioLinkMonitoringConfig_failureDetectionResourcesToReleaseList (RadioLinkMonitoringRS_Id[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RadioLinkMonitoringRS_Id [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RadioLinkMonitoringRS_Id();
