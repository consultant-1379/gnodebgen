...
public class IntraFreqNeighCellList extends Asn1SeqOf {
   ...
   public IntraFreqNeighCellInfo[] elements;

   public IntraFreqNeighCellList () {
      elements = null;
   }
    ...
    * populated.
    */
   public IntraFreqNeighCellList (int numRecords) {
      elements = new IntraFreqNeighCellInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public IntraFreqNeighCellList (IntraFreqNeighCellInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new IntraFreqNeighCellInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new IntraFreqNeighCellInfo();
