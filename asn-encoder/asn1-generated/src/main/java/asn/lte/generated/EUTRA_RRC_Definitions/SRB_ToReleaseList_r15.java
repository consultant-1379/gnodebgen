...
public class SRB_ToReleaseList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SRB-ToReleaseList-r15";
   }

   public Asn1Integer[] elements;

   public SRB_ToReleaseList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRB_ToReleaseList_r15 (int numRecords) {
    ...
    * given the array.  
    */
   public SRB_ToReleaseList_r15 (Asn1Integer[] elements_) {
      elements = elements_;
   }
