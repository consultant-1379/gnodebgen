...
public class CounterCheck_v8a0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "CounterCheck-v8a0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public CounterCheck_v1530_IEs nonCriticalExtension;  // optional

   public CounterCheck_v8a0_IEs () {
      super();
      init();
   }
   ...
   public CounterCheck_v8a0_IEs (
      ...
      CounterCheck_v1530_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public CounterCheck_v8a0_IEs (byte[] lateNonCriticalExtension_,
      CounterCheck_v1530_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new CounterCheck_v1530_IEs();
