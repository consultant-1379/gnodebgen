...
public class ActivatedNRCellList_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public ActivatedNRCellList_Item_iE_Extensions_element[] elements;

   public ActivatedNRCellList_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ActivatedNRCellList_Item_iE_Extensions (int numRecords) {
      elements = new ActivatedNRCellList_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ActivatedNRCellList_Item_iE_Extensions (ActivatedNRCellList_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ActivatedNRCellList_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ActivatedNRCellList_Item_iE_Extensions_element();
