...
public class DownlinkS1cdma2000tunnelling_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: Cdma2000HOStatus
    * Java type: Cdma2000HOStatus
    *
   ...
   public DownlinkS1cdma2000tunnelling_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public DownlinkS1cdma2000tunnelling_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-cdma2000HOStatus
    */
   public void setUsing_id_cdma2000HOStatus(asn.lte.generated.S1AP_IEs.Cdma2000HOStatus value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_cdma2000HOStatus);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-cdma2000HOStatus
    */
   public asn.lte.generated.S1AP_IEs.Cdma2000HOStatus getValueFor_id_cdma2000HOStatus() {
      return (asn.lte.generated.S1AP_IEs.Cdma2000HOStatus) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.DownlinkS1cdma2000tunnellingIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.DownlinkS1cdma2000tunnellingIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.DownlinkS1cdma2000tunnellingIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-cdma2000HOStatus\n");
      }
      else if (id.value == 71) {
         indent (_sb, _level+1);
