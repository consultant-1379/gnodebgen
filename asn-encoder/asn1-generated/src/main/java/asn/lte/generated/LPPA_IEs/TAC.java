...
public class TAC extends Asn1OctetString {
    ...
    */
   public TAC (byte[] data, int offset, int nbytes) {
    ...
    */
   public TAC (String value_) throws Asn1ValueParseException {
      super (value_);
   }
