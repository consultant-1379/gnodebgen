...
public class SIB_MappingInfo_MBMS_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SIB-MappingInfo-MBMS-r14";
   }

   public SIB_Type_MBMS_r14[] elements;

   public SIB_MappingInfo_MBMS_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SIB_MappingInfo_MBMS_r14 (int numRecords) {
      elements = new SIB_Type_MBMS_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public SIB_MappingInfo_MBMS_r14 (SIB_Type_MBMS_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SIB_Type_MBMS_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         {
            int tval = SIB_Type_MBMS_r14.decodeEnumValue (buffer);
            elements[i] = SIB_Type_MBMS_r14.valueOf (tval);
         }
