...
public class MBSFN_SubframeConfigList_v1430 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MBSFN-SubframeConfigList-v1430";
   }

   public MBSFN_SubframeConfig_v1430[] elements;

   public MBSFN_SubframeConfigList_v1430 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBSFN_SubframeConfigList_v1430 (int numRecords) {
      elements = new MBSFN_SubframeConfig_v1430 [numRecords];
   }
    ...
    * given the array.  
    */
   public MBSFN_SubframeConfigList_v1430 (MBSFN_SubframeConfig_v1430[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBSFN_SubframeConfig_v1430 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBSFN_SubframeConfig_v1430();
