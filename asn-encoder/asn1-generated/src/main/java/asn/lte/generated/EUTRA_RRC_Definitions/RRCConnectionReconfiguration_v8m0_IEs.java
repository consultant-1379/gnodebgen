...
public class RRCConnectionReconfiguration_v8m0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionReconfiguration-v8m0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public RRCConnectionReconfiguration_v10i0_IEs nonCriticalExtension;  // optional

   public RRCConnectionReconfiguration_v8m0_IEs () {
      super();
      init();
   }
   ...
   public RRCConnectionReconfiguration_v8m0_IEs (
      ...
      RRCConnectionReconfiguration_v10i0_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public RRCConnectionReconfiguration_v8m0_IEs (byte[] lateNonCriticalExtension_,
      RRCConnectionReconfiguration_v10i0_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new RRCConnectionReconfiguration_v10i0_IEs();
