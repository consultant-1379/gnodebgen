...
public class SupportedBandListHRPD extends Asn1SeqOf {
    ...
    * populated.
    */
   public SupportedBandListHRPD (int numRecords) {
    ...
    * given the array.  
    */
   public SupportedBandListHRPD (BandclassCDMA2000[] elements_) {
      elements = elements_;
   }
