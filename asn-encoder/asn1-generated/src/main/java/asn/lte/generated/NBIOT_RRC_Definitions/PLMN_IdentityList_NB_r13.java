...
public class PLMN_IdentityList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PLMN-IdentityList-NB-r13";
   }

   public PLMN_IdentityInfo_NB_r13[] elements;

   public PLMN_IdentityList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_IdentityList_NB_r13 (int numRecords) {
      elements = new PLMN_IdentityInfo_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMN_IdentityList_NB_r13 (PLMN_IdentityInfo_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PLMN_IdentityInfo_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PLMN_IdentityInfo_NB_r13();
