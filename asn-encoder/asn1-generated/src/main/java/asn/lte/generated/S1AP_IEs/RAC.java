...
public class RAC extends Asn1OctetString {
    ...
    */
   public RAC (byte[] data, int offset, int nbytes) {
    ...
    */
   public RAC (String value_) throws Asn1ValueParseException {
      super (value_);
   }
