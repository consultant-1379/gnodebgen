...
public class ServedNRCellsToModify_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public ServedNRCellsToModify_Item_iE_Extensions_element[] elements;

   public ServedNRCellsToModify_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedNRCellsToModify_Item_iE_Extensions (int numRecords) {
      elements = new ServedNRCellsToModify_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedNRCellsToModify_Item_iE_Extensions (ServedNRCellsToModify_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedNRCellsToModify_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedNRCellsToModify_Item_iE_Extensions_element();
