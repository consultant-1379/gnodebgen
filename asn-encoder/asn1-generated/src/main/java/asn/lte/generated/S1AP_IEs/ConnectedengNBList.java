...
public class ConnectedengNBList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ConnectedengNBList";
   }

   public ConnectedengNBItem[] elements;

   public ConnectedengNBList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ConnectedengNBList (int numRecords) {
      elements = new ConnectedengNBItem [numRecords];
   }
    ...
    * given the array.  
    */
   public ConnectedengNBList (ConnectedengNBItem[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ConnectedengNBItem [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ConnectedengNBItem();
