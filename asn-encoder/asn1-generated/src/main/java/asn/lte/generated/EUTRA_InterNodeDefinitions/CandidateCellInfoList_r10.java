...
public class CandidateCellInfoList_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CandidateCellInfoList-r10";
   }

   public CandidateCellInfo_r10[] elements;

   public CandidateCellInfoList_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CandidateCellInfoList_r10 (int numRecords) {
      elements = new CandidateCellInfo_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public CandidateCellInfoList_r10 (CandidateCellInfo_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CandidateCellInfo_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CandidateCellInfo_r10();
