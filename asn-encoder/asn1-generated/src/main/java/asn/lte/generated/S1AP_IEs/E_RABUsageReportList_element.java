...
public class E_RABUsageReportList_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABUsageReportItem
    * Java type: E_RABUsageReportItem
    */
   ...
   /**
    * Assign fields according to information object having key id-E-RABUsageReportItem
    */
   public void setUsing_id_E_RABUsageReportItem(E_RABUsageReportItem value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABUsageReportItem);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABUsageReportItem
    */
   public E_RABUsageReportItem getValueFor_id_E_RABUsageReportItem() {
      return (E_RABUsageReportItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.E_RABUsageReportItemIEs.length; i++) {
         if(_S1AP_IEsValues.E_RABUsageReportItemIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.E_RABUsageReportItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 267) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABUsageReportItem\n");
      }
