...
public class EAB_HandoverReport_ExtConveyor_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: eid-E-RAB-EstablishedWithQCI1
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-E-RAB-EstablishedWithQCI1
    * Java type: EAB_E_RAB_EstablishedWithQCI1
    */
   public Asn1Type value;

   public EAB_HandoverReport_ExtConveyor_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_HandoverReport_ExtConveyor_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-E-RAB-EstablishedWithQCI1
    */
   public void setUsing_eid_E_RAB_EstablishedWithQCI1(EAB_E_RAB_EstablishedWithQCI1 value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_E_RAB_EstablishedWithQCI1);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key eid-E-RAB-EstablishedWithQCI1
    */
   public EAB_E_RAB_EstablishedWithQCI1 getValueFor_eid_E_RAB_EstablishedWithQCI1() {
      return (EAB_E_RAB_EstablishedWithQCI1) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_HandoverReport_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_HandoverReport_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_HandoverReport_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 4163) {
         indent (_sb, _level+1);
         _sb.append("id = eid-E-RAB-EstablishedWithQCI1\n");
      }
