...
public class MBMSCountingResponse_r10_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _COUNTINGRESPONSE_R10 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public MBMSCountingResponse_r10_criticalExtensions_c1 () {
      super();
   }

   public MBMSCountingResponse_r10_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _COUNTINGRESPONSE_R10: return "countingResponse_r10";
   ...
   public void set_countingResponse_r10 (MBMSCountingResponse_r10_IEs value) {
      setElement (_COUNTINGRESPONSE_R10, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            MBMSCountingResponse_r10_IEs countingResponse_r10;
            element = countingResponse_r10 = new MBMSCountingResponse_r10_IEs();
            countingResponse_r10.decode (buffer);
            break;
         }
