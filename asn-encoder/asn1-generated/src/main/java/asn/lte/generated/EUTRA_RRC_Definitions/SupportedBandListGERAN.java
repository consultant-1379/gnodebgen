...
public class SupportedBandListGERAN extends Asn1SeqOf {
   ...
   public SupportedBandGERAN[] elements;

   public SupportedBandListGERAN () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandListGERAN (int numRecords) {
      elements = new SupportedBandGERAN [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandListGERAN (SupportedBandGERAN[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBandGERAN [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         {
            int tval = SupportedBandGERAN.decodeEnumValue (buffer);
            elements[i] = SupportedBandGERAN.valueOf (tval);
         }
