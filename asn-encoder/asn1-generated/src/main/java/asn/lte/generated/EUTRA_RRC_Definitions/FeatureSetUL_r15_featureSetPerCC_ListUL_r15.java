...
public class FeatureSetUL_r15_featureSetPerCC_ListUL_r15 extends Asn1SeqOf {
   ...
   public FeatureSetUL_PerCC_Id_r15[] elements;

   public FeatureSetUL_r15_featureSetPerCC_ListUL_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSetUL_r15_featureSetPerCC_ListUL_r15 (int numRecords) {
      elements = new FeatureSetUL_PerCC_Id_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSetUL_r15_featureSetPerCC_ListUL_r15 (FeatureSetUL_PerCC_Id_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetUL_PerCC_Id_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetUL_PerCC_Id_r15();
