...
public class RRCConnectionSetup_v8a0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionSetup-v8a0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public RRCConnectionSetup_v8a0_IEs_nonCriticalExtension nonCriticalExtension;  // optional

   public RRCConnectionSetup_v8a0_IEs () {
      super();
      init();
   }
   ...
   public RRCConnectionSetup_v8a0_IEs (
      ...
      RRCConnectionSetup_v8a0_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public RRCConnectionSetup_v8a0_IEs (byte[] lateNonCriticalExtension_,
      RRCConnectionSetup_v8a0_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new RRCConnectionSetup_v8a0_IEs_nonCriticalExtension();
