...
public class NRDC_Parameters_v15c0 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "NRDC-Parameters-v15c0";
   }

   public NRDC_Parameters_v15c0_pdcp_DuplicationSplitSRB pdcp_DuplicationSplitSRB = null;  // optional
   public NRDC_Parameters_v15c0_pdcp_DuplicationSplitDRB pdcp_DuplicationSplitDRB = null;  // optional

   public NRDC_Parameters_v15c0 () {
      super();
      init();
   }
    ...
    */
   public NRDC_Parameters_v15c0 (
      NRDC_Parameters_v15c0_pdcp_DuplicationSplitSRB pdcp_DuplicationSplitSRB_,
      NRDC_Parameters_v15c0_pdcp_DuplicationSplitDRB pdcp_DuplicationSplitDRB_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (pdcp_DuplicationSplitSRBPresent) {
         ...
         int tval = NRDC_Parameters_v15c0_pdcp_DuplicationSplitSRB.decodeEnumValue (buffer);
         pdcp_DuplicationSplitSRB = NRDC_Parameters_v15c0_pdcp_DuplicationSplitSRB.valueOf (tval);
      ...
      if (pdcp_DuplicationSplitDRBPresent) {
         ...
         int tval = NRDC_Parameters_v15c0_pdcp_DuplicationSplitDRB.decodeEnumValue (buffer);
         pdcp_DuplicationSplitDRB = NRDC_Parameters_v15c0_pdcp_DuplicationSplitDRB.valueOf (tval);
