...
public class WLAN_Name_r15 extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "WLAN-Name-r15";
   }

   public WLAN_Name_r15 () {
      super();
   }
    ...
    *              in binary form.
    */
   public WLAN_Name_r15 (byte[] data) {
      super (data);
   }
    ...
    */
   public WLAN_Name_r15 (byte[] data, int offset, int nbytes) {
    ...
    */
   public WLAN_Name_r15 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
