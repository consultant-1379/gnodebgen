...
public class TargetRNC_ID_iE_Extensions extends Asn1SeqOf {
   ...
   public TargetRNC_ID_iE_Extensions_element[] elements;

   public TargetRNC_ID_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TargetRNC_ID_iE_Extensions (int numRecords) {
      elements = new TargetRNC_ID_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TargetRNC_ID_iE_Extensions (TargetRNC_ID_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TargetRNC_ID_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TargetRNC_ID_iE_Extensions_element();
