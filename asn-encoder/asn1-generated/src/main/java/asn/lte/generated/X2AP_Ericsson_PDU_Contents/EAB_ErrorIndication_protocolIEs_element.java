...
public class EAB_ErrorIndication_protocolIEs_element extends Asn1Seq {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_PDU_ContentsValues.EAB_ErrorIndication_IEs.length; i++) {
         if(_X2AP_Ericsson_PDU_ContentsValues.EAB_ErrorIndication_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_PDU_ContentsValues.EAB_ErrorIndication_IEs[i];
            break;
         }
      }
      if (null == _index) {
