...
public class RLC_Status_iE_Extensions extends Asn1SeqOf {
   ...
   public RLC_Status_iE_Extensions_element[] elements;

   public RLC_Status_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RLC_Status_iE_Extensions (int numRecords) {
      elements = new RLC_Status_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RLC_Status_iE_Extensions (RLC_Status_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RLC_Status_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RLC_Status_iE_Extensions_element();
