...
public class MDTMode_Extension extends Asn1Seq {
   ...
   /**
    * id: id-LoggedMBSFNMDT
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: LoggedMBSFNMDT
    * Java type: LoggedMBSFNMDT
    */
   public Asn1Type value;

   public MDTMode_Extension () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MDTMode_Extension (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-LoggedMBSFNMDT
    */
   public void setUsing_id_LoggedMBSFNMDT(LoggedMBSFNMDT value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_LoggedMBSFNMDT);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-LoggedMBSFNMDT
    */
   public LoggedMBSFNMDT getValueFor_id_LoggedMBSFNMDT() {
      return (LoggedMBSFNMDT) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.MDTMode_ExtensionIE.length; i++) {
         if(_S1AP_IEsValues.MDTMode_ExtensionIE[i].id.equals(id)) {
            _index = _S1AP_IEsValues.MDTMode_ExtensionIE[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 197) {
         indent (_sb, _level+1);
         _sb.append("id = id-LoggedMBSFNMDT\n");
      }
