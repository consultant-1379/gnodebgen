...
public class COUNTvalue_iE_Extensions extends Asn1SeqOf {
   ...
   public COUNTvalue_iE_Extensions_element[] elements;

   public COUNTvalue_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public COUNTvalue_iE_Extensions (int numRecords) {
      elements = new COUNTvalue_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public COUNTvalue_iE_Extensions (COUNTvalue_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new COUNTvalue_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new COUNTvalue_iE_Extensions_element();
