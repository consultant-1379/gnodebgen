...
public class HandoverNotify_protocolIEs extends Asn1SeqOf {
   ...
   public HandoverNotify_protocolIEs_element[] elements;

   public HandoverNotify_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public HandoverNotify_protocolIEs (int numRecords) {
      elements = new HandoverNotify_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public HandoverNotify_protocolIEs (HandoverNotify_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HandoverNotify_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new HandoverNotify_protocolIEs_element();
