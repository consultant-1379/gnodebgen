...
public class MeasurementInitiationResult_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasurementInitiationResult-List";
   }

   public MeasurementInitiationResult_List_element[] elements;

   public MeasurementInitiationResult_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasurementInitiationResult_List (int numRecords) {
      elements = new MeasurementInitiationResult_List_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasurementInitiationResult_List (MeasurementInitiationResult_List_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasurementInitiationResult_List_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasurementInitiationResult_List_element();
