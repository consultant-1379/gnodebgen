...
public class HandoverCommand_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _HANDOVERCOMMAND_R8 = 1;
   ...
   public String getElemName () {
      switch (choiceID) {
      case _HANDOVERCOMMAND_R8: return "handoverCommand_r8";
   ...
   public void set_handoverCommand_r8 (HandoverCommand_r8_IEs value) {
      setElement (_HANDOVERCOMMAND_R8, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         // handoverCommand_r8
         case 0: { 
            HandoverCommand_r8_IEs handoverCommand_r8;
            element = handoverCommand_r8 = new HandoverCommand_r8_IEs();
            handoverCommand_r8.decode (buffer);
            break;
         }
