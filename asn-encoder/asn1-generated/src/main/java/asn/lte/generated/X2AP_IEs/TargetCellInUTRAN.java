...
public class TargetCellInUTRAN extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "TargetCellInUTRAN";
   }

   public TargetCellInUTRAN () {
      super();
   }
    ...
    *              in binary form.
    */
   public TargetCellInUTRAN (byte[] data) {
      super (data);
   }
    ...
    */
   public TargetCellInUTRAN (byte[] data, int offset, int nbytes) {
    ...
    */
   public TargetCellInUTRAN (String value_) throws Asn1ValueParseException {
      super (value_);
   }
