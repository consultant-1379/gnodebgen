...
public class HandoverRequired_protocolIEs extends Asn1SeqOf {
   ...
   public HandoverRequired_protocolIEs_element[] elements;

   public HandoverRequired_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public HandoverRequired_protocolIEs (int numRecords) {
      elements = new HandoverRequired_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public HandoverRequired_protocolIEs (HandoverRequired_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HandoverRequired_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new HandoverRequired_protocolIEs_element();
