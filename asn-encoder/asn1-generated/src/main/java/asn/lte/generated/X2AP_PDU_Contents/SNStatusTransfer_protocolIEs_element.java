...
public class SNStatusTransfer_protocolIEs_element extends Asn1Seq {
    ...
    * Java type: UE_X2AP_ID
    *
    * id: id-E-RABs-SubjectToStatusTransfer-List
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABs-SubjectToStatusTransfer-List
    * Java type: E_RABs_SubjectToStatusTransfer_List
    *
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-SNStatusTransfer-ExtConveyor
    * Java type: EAB_SNStatusTransfer_ExtConveyor
    */
   public Asn1Type value;

   public SNStatusTransfer_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SNStatusTransfer_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-SubjectToStatusTransfer-List
    */
   public void setUsing_id_E_RABs_SubjectToStatusTransfer_List(E_RABs_SubjectToStatusTransfer_List value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_SubjectToStatusTransfer_List);
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_SNStatusTransfer_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-SubjectToStatusTransfer-List
    */
   public E_RABs_SubjectToStatusTransfer_List getValueFor_id_E_RABs_SubjectToStatusTransfer_List() {
      return (E_RABs_SubjectToStatusTransfer_List) this.value;
   }
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_SNStatusTransfer_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_SNStatusTransfer_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SNStatusTransfer_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SNStatusTransfer_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SNStatusTransfer_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 10) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-SubjectToStatusTransfer-List\n");
      }
