...
public class InterFreqCarrierFreqList_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqList-v1530";
   }

   public InterFreqCarrierFreqInfo_v1530[] elements;

   public InterFreqCarrierFreqList_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqList_v1530 (int numRecords) {
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqList_v1530 (InterFreqCarrierFreqInfo_v1530[] elements_) {
      elements = elements_;
   }
