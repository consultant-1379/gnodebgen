...
public class UEID extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public UEID (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    *
    */
   public UEID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public UEID (java.util.BitSet bitSet) {
      super (bitSet);
   }
