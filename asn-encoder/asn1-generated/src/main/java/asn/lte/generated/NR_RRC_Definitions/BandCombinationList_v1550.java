...
public class BandCombinationList_v1550 extends Asn1SeqOf {
   ...
   public BandCombination_v1550[] elements;

   public BandCombinationList_v1550 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationList_v1550 (int numRecords) {
      elements = new BandCombination_v1550 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationList_v1550 (BandCombination_v1550[] elements_) {
      elements = elements_;
   }
   ...
   {
      int fraglen = 0;
      java.util.LinkedList<BandCombination_v1550> tmplist = 
         new java.util.LinkedList<BandCombination_v1550>();
      BandCombination_v1550 value;
      ...
      for (;;) {
         ...
         for (int i = 0; i < fraglen; i++) {
            ...
            value = new BandCombination_v1550();
            value.decode (buffer);
      ...
      elements = new BandCombination_v1550 [tmplist.size()];
