...
public class TAIList_element extends Asn1Seq {
    ...
    * the given objects 
    */
   public TAIList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-TAIItem
    */
   public void setUsing_id_TAIItem(TAIItem value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_TAIItem);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-TAIItem
    */
   public TAIItem getValueFor_id_TAIItem() {
      return (TAIItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.TAIItemIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.TAIItemIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.TAIItemIEs[i];
            break;
         }
      }
      if (null == _index) {
