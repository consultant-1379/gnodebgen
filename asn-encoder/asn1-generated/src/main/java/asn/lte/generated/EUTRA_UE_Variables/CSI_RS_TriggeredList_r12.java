...
import asn.lte.generated.EUTRA_RRC_Definitions.MeasCSI_RS_Id_r12;

public class CSI_RS_TriggeredList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSI-RS-TriggeredList-r12";
   }

   public MeasCSI_RS_Id_r12[] elements;

   public CSI_RS_TriggeredList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_TriggeredList_r12 (int numRecords) {
      elements = new MeasCSI_RS_Id_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_RS_TriggeredList_r12 (MeasCSI_RS_Id_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasCSI_RS_Id_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasCSI_RS_Id_r12();
