...
public class RSTD_InterFreqInfoList_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RSTD-InterFreqInfoList-r10";
   }

   public RSTD_InterFreqInfo_r10[] elements;

   public RSTD_InterFreqInfoList_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RSTD_InterFreqInfoList_r10 (int numRecords) {
      elements = new RSTD_InterFreqInfo_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public RSTD_InterFreqInfoList_r10 (RSTD_InterFreqInfo_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RSTD_InterFreqInfo_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RSTD_InterFreqInfo_r10();
