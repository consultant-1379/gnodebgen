...
public class MeasIdToAddModListExt_v1310 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasIdToAddModListExt-v1310";
   }

   public MeasIdToAddMod_v1310[] elements;

   public MeasIdToAddModListExt_v1310 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasIdToAddModListExt_v1310 (int numRecords) {
      elements = new MeasIdToAddMod_v1310 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasIdToAddModListExt_v1310 (MeasIdToAddMod_v1310[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasIdToAddMod_v1310 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasIdToAddMod_v1310();
