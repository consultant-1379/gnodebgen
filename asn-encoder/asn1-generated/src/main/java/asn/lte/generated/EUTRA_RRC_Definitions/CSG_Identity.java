...
public class CSG_Identity extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public CSG_Identity (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public CSG_Identity (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public CSG_Identity (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public CSG_Identity (java.util.BitSet bitSet) {
      super (bitSet);
   }
