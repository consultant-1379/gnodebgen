...
public class SgNBModificationConfirm_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBModificationConfirm_protocolIEs_element[] elements;

   public SgNBModificationConfirm_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBModificationConfirm_protocolIEs (int numRecords) {
      elements = new SgNBModificationConfirm_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBModificationConfirm_protocolIEs (SgNBModificationConfirm_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBModificationConfirm_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBModificationConfirm_protocolIEs_element();
