...
public class SeNBSecurityKey extends Asn1BitString {
    ...
    */
   public SeNBSecurityKey (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public SeNBSecurityKey (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public SeNBSecurityKey (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public SeNBSecurityKey (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public SeNBSecurityKey (java.util.BitSet bitSet) {
      super (bitSet);
   }
