...
public class SeNBModificationRequest_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-UE-ContextInformationSeNBModReq
    * criticality: Criticality.reject
    * presence: Presence.optional
    * ASN.1 type: UE-ContextInformationSeNBModReq
    * Java type: UE_ContextInformationSeNBModReq
    *
   ...
   public SeNBModificationRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SeNBModificationRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-UE-ContextInformationSeNBModReq
    */
   public void setUsing_id_UE_ContextInformationSeNBModReq(UE_ContextInformationSeNBModReq value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_UE_ContextInformationSeNBModReq);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-UE-ContextInformationSeNBModReq
    */
   public UE_ContextInformationSeNBModReq getValueFor_id_UE_ContextInformationSeNBModReq() {
      return (UE_ContextInformationSeNBModReq) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SeNBModificationRequest_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SeNBModificationRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SeNBModificationRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-UE-ContextInformationSeNBModReq\n");
      }
