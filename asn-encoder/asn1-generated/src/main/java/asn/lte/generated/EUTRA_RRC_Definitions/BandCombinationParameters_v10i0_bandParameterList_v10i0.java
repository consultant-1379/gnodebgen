...
public class BandCombinationParameters_v10i0_bandParameterList_v10i0 extends Asn1SeqOf {
   ...
   public BandParameters_v10i0[] elements;

   public BandCombinationParameters_v10i0_bandParameterList_v10i0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_v10i0_bandParameterList_v10i0 (int numRecords) {
      elements = new BandParameters_v10i0 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_v10i0_bandParameterList_v10i0 (BandParameters_v10i0[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_v10i0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_v10i0();
