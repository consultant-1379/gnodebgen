...
public class S_TMSI extends Asn1Seq {
   ...
   public MME_Code mMEC;
   public M_TMSI m_TMSI;
   public S_TMSI_iE_Extensions iE_Extensions;  // optional
   ...
   public S_TMSI (
      MME_Code mMEC_,
      M_TMSI m_TMSI_,
      S_TMSI_iE_Extensions iE_Extensions_
   ) {
      super();
      mMEC = mMEC_;
      m_TMSI = m_TMSI_;
    ...
    * the given objects 
    */
   public S_TMSI (byte[] mMEC_,
      byte[] m_TMSI_,
      S_TMSI_iE_Extensions iE_Extensions_
   ) {
      super();
      mMEC = new MME_Code (mMEC_);
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new S_TMSI_iE_Extensions();
