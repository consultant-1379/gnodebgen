...
public class NonContiguousUL_RA_WithinCC_List_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NonContiguousUL-RA-WithinCC-List-r10";
   }

   public NonContiguousUL_RA_WithinCC_r10[] elements;

   public NonContiguousUL_RA_WithinCC_List_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NonContiguousUL_RA_WithinCC_List_r10 (int numRecords) {
      elements = new NonContiguousUL_RA_WithinCC_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public NonContiguousUL_RA_WithinCC_List_r10 (NonContiguousUL_RA_WithinCC_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NonContiguousUL_RA_WithinCC_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NonContiguousUL_RA_WithinCC_r10();
