...
public class EnhancedRNTPStartTime_iE_Extensions extends Asn1SeqOf {
   ...
   public EnhancedRNTPStartTime_iE_Extensions_element[] elements;

   public EnhancedRNTPStartTime_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public EnhancedRNTPStartTime_iE_Extensions (int numRecords) {
      elements = new EnhancedRNTPStartTime_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EnhancedRNTPStartTime_iE_Extensions (EnhancedRNTPStartTime_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EnhancedRNTPStartTime_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EnhancedRNTPStartTime_iE_Extensions_element();
