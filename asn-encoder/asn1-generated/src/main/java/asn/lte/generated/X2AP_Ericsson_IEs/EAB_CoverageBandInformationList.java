...
public class EAB_CoverageBandInformationList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-CoverageBandInformationList";
   }

   public EAB_CoverageBandInfo_Item[] elements;

   public EAB_CoverageBandInformationList () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_CoverageBandInformationList (int numRecords) {
      elements = new EAB_CoverageBandInfo_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_CoverageBandInformationList (EAB_CoverageBandInfo_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_CoverageBandInfo_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_CoverageBandInfo_Item();
