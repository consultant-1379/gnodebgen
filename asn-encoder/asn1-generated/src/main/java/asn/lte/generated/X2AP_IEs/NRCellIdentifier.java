...
public class NRCellIdentifier extends Asn1BitString {
    ...
    */
   public NRCellIdentifier (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public NRCellIdentifier (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public NRCellIdentifier (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public NRCellIdentifier (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public NRCellIdentifier (java.util.BitSet bitSet) {
      super (bitSet);
   }
