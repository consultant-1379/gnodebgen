...
public class MeasObjectToAddModList_v9e0 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasObjectToAddModList-v9e0";
   }

   public MeasObjectToAddMod_v9e0[] elements;

   public MeasObjectToAddModList_v9e0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasObjectToAddModList_v9e0 (int numRecords) {
      elements = new MeasObjectToAddMod_v9e0 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasObjectToAddModList_v9e0 (MeasObjectToAddMod_v9e0[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasObjectToAddMod_v9e0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasObjectToAddMod_v9e0();
