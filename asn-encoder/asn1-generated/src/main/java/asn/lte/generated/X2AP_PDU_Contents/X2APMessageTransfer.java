...
public class X2APMessageTransfer extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "X2APMessageTransfer";
   }

   public X2APMessageTransfer_protocolIEs protocolIEs;
   public Asn1OpenExt extElem1;

   public X2APMessageTransfer () {
      super();
      init();
   }
    ...
    */
   public X2APMessageTransfer (
      X2APMessageTransfer_protocolIEs protocolIEs_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      protocolIEs = new X2APMessageTransfer_protocolIEs();
