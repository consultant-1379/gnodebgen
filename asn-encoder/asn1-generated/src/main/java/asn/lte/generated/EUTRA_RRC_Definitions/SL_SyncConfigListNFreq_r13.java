...
public class SL_SyncConfigListNFreq_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-SyncConfigListNFreq-r13";
   }

   public SL_SyncConfigNFreq_r13[] elements;

   public SL_SyncConfigListNFreq_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_SyncConfigListNFreq_r13 (int numRecords) {
    ...
    * given the array.  
    */
   public SL_SyncConfigListNFreq_r13 (SL_SyncConfigNFreq_r13[] elements_) {
      elements = elements_;
   }
