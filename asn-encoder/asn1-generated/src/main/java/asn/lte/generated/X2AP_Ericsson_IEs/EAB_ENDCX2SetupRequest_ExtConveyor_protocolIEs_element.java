...
public class EAB_ENDCX2SetupRequest_ExtConveyor_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: eid-EAB-InitiatingNodeType-EndcX2SetupRequest
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: EAB-InitiatingNodeType-EndcX2SetupRequest
    * Java type: EAB_InitiatingNodeType_EndcX2SetupRequest
    */
   public Asn1Type value;

   public EAB_ENDCX2SetupRequest_ExtConveyor_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_ENDCX2SetupRequest_ExtConveyor_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-EAB-InitiatingNodeType-EndcX2SetupRequest
    */
   public void setUsing_eid_EAB_InitiatingNodeType_EndcX2SetupRequest(EAB_InitiatingNodeType_EndcX2SetupRequest value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_EAB_InitiatingNodeType_EndcX2SetupRequest);
   ...
   /**
    * Get value of value with type set according to information object having key eid-EAB-InitiatingNodeType-EndcX2SetupRequest
    */
   public EAB_InitiatingNodeType_EndcX2SetupRequest getValueFor_eid_EAB_InitiatingNodeType_EndcX2SetupRequest() {
      return (EAB_InitiatingNodeType_EndcX2SetupRequest) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_ENDCX2SetupRequest_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_ENDCX2SetupRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_ENDCX2SetupRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 4190) {
         indent (_sb, _level+1);
         _sb.append("id = eid-EAB-InitiatingNodeType-EndcX2SetupRequest\n");
      }
