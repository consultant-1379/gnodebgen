...
public class Fourframes extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public Fourframes (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public Fourframes (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public Fourframes (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public Fourframes (java.util.BitSet bitSet) {
      super (bitSet);
   }
