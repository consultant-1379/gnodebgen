...
public class RMTC_Config_r13 extends Asn1Choice {
   ...
   public RMTC_Config_r13 () {
      super();
   }

   public RMTC_Config_r13 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (RMTC_Config_r13_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            RMTC_Config_r13_setup setup;
            element = setup = new RMTC_Config_r13_setup();
            setup.decode (buffer);
            break;
         }
