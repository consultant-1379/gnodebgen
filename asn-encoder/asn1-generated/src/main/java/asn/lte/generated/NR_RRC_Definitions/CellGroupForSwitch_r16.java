...
public class CellGroupForSwitch_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellGroupForSwitch-r16";
   }

   public ServCellIndex[] elements;

   public CellGroupForSwitch_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellGroupForSwitch_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public CellGroupForSwitch_r16 (ServCellIndex[] elements_) {
      elements = elements_;
   }
