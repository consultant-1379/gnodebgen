...
public class AffectedCarrierFreqList_v1310 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AffectedCarrierFreqList-v1310";
   }

   public AffectedCarrierFreq_v1310[] elements;

   public AffectedCarrierFreqList_v1310 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AffectedCarrierFreqList_v1310 (int numRecords) {
      elements = new AffectedCarrierFreq_v1310 [numRecords];
   }
    ...
    * given the array.  
    */
   public AffectedCarrierFreqList_v1310 (AffectedCarrierFreq_v1310[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AffectedCarrierFreq_v1310 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AffectedCarrierFreq_v1310();
