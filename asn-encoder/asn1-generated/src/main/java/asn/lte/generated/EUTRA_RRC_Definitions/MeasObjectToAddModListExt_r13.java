...
public class MeasObjectToAddModListExt_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasObjectToAddModListExt-r13";
   }

   public MeasObjectToAddModExt_r13[] elements;

   public MeasObjectToAddModListExt_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasObjectToAddModListExt_r13 (int numRecords) {
      elements = new MeasObjectToAddModExt_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasObjectToAddModListExt_r13 (MeasObjectToAddModExt_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasObjectToAddModExt_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasObjectToAddModExt_r13();
