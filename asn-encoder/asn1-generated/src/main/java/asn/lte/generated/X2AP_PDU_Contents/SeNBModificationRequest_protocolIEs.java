...
public class SeNBModificationRequest_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBModificationRequest_protocolIEs_element[] elements;

   public SeNBModificationRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBModificationRequest_protocolIEs (int numRecords) {
      elements = new SeNBModificationRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBModificationRequest_protocolIEs (SeNBModificationRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBModificationRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBModificationRequest_protocolIEs_element();
