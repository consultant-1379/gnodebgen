...
public class ResourceStatusFailure_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-CompleteFailureCauseInformation-List
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: CompleteFailureCauseInformation-List
    * Java type: CompleteFailureCauseInformation_List
    */
   public Asn1Type value;

   public ResourceStatusFailure_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ResourceStatusFailure_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-CompleteFailureCauseInformation-List
    */
   public void setUsing_id_CompleteFailureCauseInformation_List(CompleteFailureCauseInformation_List value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_CompleteFailureCauseInformation_List);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-CompleteFailureCauseInformation-List
    */
   public CompleteFailureCauseInformation_List getValueFor_id_CompleteFailureCauseInformation_List() {
      return (CompleteFailureCauseInformation_List) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ResourceStatusFailure_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ResourceStatusFailure_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ResourceStatusFailure_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 39) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-CompleteFailureCauseInformation-List\n");
      }
