...
public class E_RABs_ToBeReleased_ModReqd extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeReleased-ModReqd";
   }

   public E_RABs_ToBeReleased_ModReqd_element[] elements;

   public E_RABs_ToBeReleased_ModReqd () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeReleased_ModReqd (int numRecords) {
      elements = new E_RABs_ToBeReleased_ModReqd_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeReleased_ModReqd (E_RABs_ToBeReleased_ModReqd_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeReleased_ModReqd_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeReleased_ModReqd_element();
