...
public class E_RABs_Admitted_ToBeAdded_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-Admitted-ToBeAdded-List";
   }

   public E_RABs_Admitted_ToBeAdded_List_element[] elements;

   public E_RABs_Admitted_ToBeAdded_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_Admitted_ToBeAdded_List (int numRecords) {
      elements = new E_RABs_Admitted_ToBeAdded_List_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_Admitted_ToBeAdded_List (E_RABs_Admitted_ToBeAdded_List_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_Admitted_ToBeAdded_List_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_Admitted_ToBeAdded_List_element();
