...
public class PLMN_RAN_AreaCell_ran_AreaCells extends Asn1SeqOf {
   ...
   public PLMN_RAN_AreaCell_ran_AreaCells () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_RAN_AreaCell_ran_AreaCells (int numRecords) {
    ...
    * given the array.  
    */
   public PLMN_RAN_AreaCell_ran_AreaCells (CellIdentity[] elements_) {
      elements = elements_;
   }
