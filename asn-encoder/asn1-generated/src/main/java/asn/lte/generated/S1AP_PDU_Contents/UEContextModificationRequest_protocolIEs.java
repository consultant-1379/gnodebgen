...
public class UEContextModificationRequest_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextModificationRequest_protocolIEs_element[] elements;

   public UEContextModificationRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextModificationRequest_protocolIEs (int numRecords) {
      elements = new UEContextModificationRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextModificationRequest_protocolIEs (UEContextModificationRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextModificationRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextModificationRequest_protocolIEs_element();
