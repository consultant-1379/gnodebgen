...
public class DynamicNAICSInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public DynamicNAICSInformation_iE_Extensions_element[] elements;

   public DynamicNAICSInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public DynamicNAICSInformation_iE_Extensions (int numRecords) {
      elements = new DynamicNAICSInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public DynamicNAICSInformation_iE_Extensions (DynamicNAICSInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DynamicNAICSInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DynamicNAICSInformation_iE_Extensions_element();
