...
public class SupportedBandCombination_v1450 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-v1450";
   }

   public BandCombinationParameters_v1450[] elements;

   public SupportedBandCombination_v1450 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_v1450 (int numRecords) {
    ...
    * given the array.  
    */
   public SupportedBandCombination_v1450 (BandCombinationParameters_v1450[] elements_) {
      elements = elements_;
   }
