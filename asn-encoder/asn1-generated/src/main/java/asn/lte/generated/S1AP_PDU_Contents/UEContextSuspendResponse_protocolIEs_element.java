...
public class UEContextSuspendResponse_protocolIEs_element extends Asn1Seq {
   ...
   public UEContextSuspendResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UEContextSuspendResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.UEContextSuspendResponseIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.UEContextSuspendResponseIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.UEContextSuspendResponseIEs[i];
            break;
         }
      }
      if (null == _index) {
