...
public class MBMSSessionStartFailure_protocolIEs extends Asn1SeqOf {
   ...
   public MBMSSessionStartFailure_protocolIEs_element[] elements;

   public MBMSSessionStartFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMSSessionStartFailure_protocolIEs (int numRecords) {
      elements = new MBMSSessionStartFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMSSessionStartFailure_protocolIEs (MBMSSessionStartFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMSSessionStartFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMSSessionStartFailure_protocolIEs_element();
