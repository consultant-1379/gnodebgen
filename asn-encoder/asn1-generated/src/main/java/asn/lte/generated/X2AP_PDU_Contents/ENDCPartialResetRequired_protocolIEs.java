...
public class ENDCPartialResetRequired_protocolIEs extends Asn1SeqOf {
   ...
   public ENDCPartialResetRequired_protocolIEs_element[] elements;

   public ENDCPartialResetRequired_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENDCPartialResetRequired_protocolIEs (int numRecords) {
      elements = new ENDCPartialResetRequired_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENDCPartialResetRequired_protocolIEs (ENDCPartialResetRequired_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENDCPartialResetRequired_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENDCPartialResetRequired_protocolIEs_element();
