...
public class Additional_GUTI_iE_Extensions extends Asn1SeqOf {
   ...
   public Additional_GUTI_iE_Extensions_element[] elements;

   public Additional_GUTI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public Additional_GUTI_iE_Extensions (int numRecords) {
      elements = new Additional_GUTI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public Additional_GUTI_iE_Extensions (Additional_GUTI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Additional_GUTI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Additional_GUTI_iE_Extensions_element();
