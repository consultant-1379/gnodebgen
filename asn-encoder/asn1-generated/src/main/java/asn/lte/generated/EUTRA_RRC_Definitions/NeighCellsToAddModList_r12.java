...
public class NeighCellsToAddModList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NeighCellsToAddModList-r12";
   }

   public NeighCellsInfo_r12[] elements;

   public NeighCellsToAddModList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NeighCellsToAddModList_r12 (int numRecords) {
      elements = new NeighCellsInfo_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public NeighCellsToAddModList_r12 (NeighCellsInfo_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NeighCellsInfo_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NeighCellsInfo_r12();
