...
public class WriteReplaceWarningRequest_protocolIEs extends Asn1SeqOf {
   ...
   public WriteReplaceWarningRequest_protocolIEs_element[] elements;

   public WriteReplaceWarningRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public WriteReplaceWarningRequest_protocolIEs (int numRecords) {
      elements = new WriteReplaceWarningRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public WriteReplaceWarningRequest_protocolIEs (WriteReplaceWarningRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WriteReplaceWarningRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new WriteReplaceWarningRequest_protocolIEs_element();
