...
public class UplinkUEAssociatedLPPaTransport_protocolIEs extends Asn1SeqOf {
   ...
   public UplinkUEAssociatedLPPaTransport_protocolIEs_element[] elements;

   public UplinkUEAssociatedLPPaTransport_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UplinkUEAssociatedLPPaTransport_protocolIEs (int numRecords) {
      elements = new UplinkUEAssociatedLPPaTransport_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UplinkUEAssociatedLPPaTransport_protocolIEs (UplinkUEAssociatedLPPaTransport_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UplinkUEAssociatedLPPaTransport_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UplinkUEAssociatedLPPaTransport_protocolIEs_element();
