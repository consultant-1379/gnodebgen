...
public class EAB_SgNBAdditionRequestAcknowledge_ExtConveyor_protocolIEs_element extends Asn1Seq {
   ...
   public EAB_SgNBAdditionRequestAcknowledge_ExtConveyor_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_SgNBAdditionRequestAcknowledge_ExtConveyor_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_SgNBAdditionRequestAcknowledge_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_SgNBAdditionRequestAcknowledge_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_SgNBAdditionRequestAcknowledge_IEs[i];
            break;
         }
      }
      if (null == _index) {
