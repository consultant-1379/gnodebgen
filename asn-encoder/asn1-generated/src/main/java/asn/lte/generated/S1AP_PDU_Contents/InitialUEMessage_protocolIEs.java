...
public class InitialUEMessage_protocolIEs extends Asn1SeqOf {
   ...
   public InitialUEMessage_protocolIEs_element[] elements;

   public InitialUEMessage_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public InitialUEMessage_protocolIEs (int numRecords) {
      elements = new InitialUEMessage_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public InitialUEMessage_protocolIEs (InitialUEMessage_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InitialUEMessage_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InitialUEMessage_protocolIEs_element();
