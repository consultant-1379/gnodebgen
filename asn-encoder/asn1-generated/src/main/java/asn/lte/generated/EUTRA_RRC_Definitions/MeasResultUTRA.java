...
public class MeasResultUTRA extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultUTRA";
   }

   public MeasResultUTRA_physCellId physCellId;
   public MeasResultUTRA_cgi_Info cgi_Info;  // optional
   public MeasResultUTRA_measResult measResult;

   public MeasResultUTRA () {
      super();
      init();
   }
    ...
    */
   public MeasResultUTRA (
      MeasResultUTRA_physCellId physCellId_,
      MeasResultUTRA_cgi_Info cgi_Info_,
      MeasResultUTRA_measResult measResult_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      physCellId = new MeasResultUTRA_physCellId();
      ...
      if (cgi_InfoPresent) {
         ...
         cgi_Info = new MeasResultUTRA_cgi_Info();
      ...
      measResult = new MeasResultUTRA_measResult();
