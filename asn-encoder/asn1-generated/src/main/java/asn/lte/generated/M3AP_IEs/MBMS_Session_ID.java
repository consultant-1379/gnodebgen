...
public class MBMS_Session_ID extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "MBMS-Session-ID";
   }

   public MBMS_Session_ID () {
      super();
   }
    ...
    *              in binary form.
    */
   public MBMS_Session_ID (byte[] data) {
      super (data);
   }
    ...
    */
   public MBMS_Session_ID (byte[] data, int offset, int nbytes) {
    ...
    */
   public MBMS_Session_ID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
