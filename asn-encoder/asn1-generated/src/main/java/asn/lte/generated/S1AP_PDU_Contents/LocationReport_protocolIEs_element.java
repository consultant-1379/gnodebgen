...
public class LocationReport_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: PSCellInformation
    * Java type: PSCellInformation
    */
   public Asn1Type value;

   public LocationReport_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public LocationReport_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-PSCellInformation
    */
   public void setUsing_id_PSCellInformation(asn.lte.generated.S1AP_IEs.PSCellInformation value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_PSCellInformation);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-PSCellInformation
    */
   public asn.lte.generated.S1AP_IEs.PSCellInformation getValueFor_id_PSCellInformation() {
      return (asn.lte.generated.S1AP_IEs.PSCellInformation) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.LocationReportIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.LocationReportIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.LocationReportIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-PSCellInformation\n");
      }
