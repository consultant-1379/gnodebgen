...
public class PosSIB_MappingInfo_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PosSIB-MappingInfo-r16";
   }

   public PosSIB_Type_r16[] elements;

   public PosSIB_MappingInfo_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PosSIB_MappingInfo_r16 (int numRecords) {
      elements = new PosSIB_Type_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PosSIB_MappingInfo_r16 (PosSIB_Type_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PosSIB_Type_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PosSIB_Type_r16();
