...
public class IntraFreqBlackCellList extends Asn1SeqOf {
    ...
    * populated.
    */
   public IntraFreqBlackCellList (int numRecords) {
    ...
    * given the array.  
    */
   public IntraFreqBlackCellList (PhysCellIdRange[] elements_) {
      elements = elements_;
   }
