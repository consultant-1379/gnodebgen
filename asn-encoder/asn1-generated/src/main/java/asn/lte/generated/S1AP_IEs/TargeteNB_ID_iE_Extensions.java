...
public class TargeteNB_ID_iE_Extensions extends Asn1SeqOf {
   ...
   public TargeteNB_ID_iE_Extensions_element[] elements;

   public TargeteNB_ID_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TargeteNB_ID_iE_Extensions (int numRecords) {
      elements = new TargeteNB_ID_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TargeteNB_ID_iE_Extensions (TargeteNB_ID_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TargeteNB_ID_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TargeteNB_ID_iE_Extensions_element();
