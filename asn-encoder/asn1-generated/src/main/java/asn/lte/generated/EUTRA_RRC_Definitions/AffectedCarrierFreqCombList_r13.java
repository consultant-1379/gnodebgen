...
public class AffectedCarrierFreqCombList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AffectedCarrierFreqCombList-r13";
   }

   public AffectedCarrierFreqComb_r13[] elements;

   public AffectedCarrierFreqCombList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AffectedCarrierFreqCombList_r13 (int numRecords) {
      elements = new AffectedCarrierFreqComb_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public AffectedCarrierFreqCombList_r13 (AffectedCarrierFreqComb_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AffectedCarrierFreqComb_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AffectedCarrierFreqComb_r13();
