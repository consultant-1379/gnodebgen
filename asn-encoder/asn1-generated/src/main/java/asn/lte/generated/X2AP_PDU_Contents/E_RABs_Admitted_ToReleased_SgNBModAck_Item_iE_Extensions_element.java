...
public class E_RABs_Admitted_ToReleased_SgNBModAck_Item_iE_Extensions_element extends Asn1Seq {
   ...
   public E_RABs_Admitted_ToReleased_SgNBModAck_Item_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABs_Admitted_ToReleased_SgNBModAck_Item_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.E_RABs_ToBeReleased_SgNBModAck_ItemExtIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.E_RABs_ToBeReleased_SgNBModAck_ItemExtIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.E_RABs_ToBeReleased_SgNBModAck_ItemExtIEs[i];
            break;
         }
      }
      if (null == _index) {
