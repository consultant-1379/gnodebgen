...
public class CarrierFreqInfoUTRA_FDD_v8h0_multiBandInfoList extends Asn1SeqOf {
   ...
   public CarrierFreqInfoUTRA_FDD_v8h0_multiBandInfoList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CarrierFreqInfoUTRA_FDD_v8h0_multiBandInfoList (int numRecords) {
    ...
    * given the array.  
    */
   public CarrierFreqInfoUTRA_FDD_v8h0_multiBandInfoList (FreqBandIndicator_UTRA_FDD[] elements_) {
      elements = elements_;
   }
