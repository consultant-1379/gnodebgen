...
public class WriteReplaceWarningResponse_protocolIEs extends Asn1SeqOf {
   ...
   public WriteReplaceWarningResponse_protocolIEs_element[] elements;

   public WriteReplaceWarningResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public WriteReplaceWarningResponse_protocolIEs (int numRecords) {
      elements = new WriteReplaceWarningResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public WriteReplaceWarningResponse_protocolIEs (WriteReplaceWarningResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WriteReplaceWarningResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new WriteReplaceWarningResponse_protocolIEs_element();
