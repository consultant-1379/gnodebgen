...
public class AbsoluteTimeInfo_r10 extends Asn1BitString {
    ...
    */
   public AbsoluteTimeInfo_r10 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public AbsoluteTimeInfo_r10 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public AbsoluteTimeInfo_r10 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public AbsoluteTimeInfo_r10 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public AbsoluteTimeInfo_r10 (java.util.BitSet bitSet) {
      super (bitSet);
   }
