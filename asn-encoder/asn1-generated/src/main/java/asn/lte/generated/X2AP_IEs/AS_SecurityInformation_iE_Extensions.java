...
public class AS_SecurityInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public AS_SecurityInformation_iE_Extensions_element[] elements;

   public AS_SecurityInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public AS_SecurityInformation_iE_Extensions (int numRecords) {
      elements = new AS_SecurityInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public AS_SecurityInformation_iE_Extensions (AS_SecurityInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AS_SecurityInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AS_SecurityInformation_iE_Extensions_element();
