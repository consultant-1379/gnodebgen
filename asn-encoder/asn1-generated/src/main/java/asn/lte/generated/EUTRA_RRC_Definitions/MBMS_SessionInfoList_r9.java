...
public class MBMS_SessionInfoList_r9 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MBMS-SessionInfoList-r9";
   }

   public MBMS_SessionInfo_r9[] elements;

   public MBMS_SessionInfoList_r9 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMS_SessionInfoList_r9 (int numRecords) {
      elements = new MBMS_SessionInfo_r9 [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMS_SessionInfoList_r9 (MBMS_SessionInfo_r9[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (0, 29);
      int numElements = (int) buffer.decodeLength();

      elements = new MBMS_SessionInfo_r9 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMS_SessionInfo_r9();
