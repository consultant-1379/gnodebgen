...
public class TrafficPatternInfoList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "TrafficPatternInfoList-r14";
   }

   public TrafficPatternInfo_r14[] elements;

   public TrafficPatternInfoList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public TrafficPatternInfoList_r14 (int numRecords) {
      elements = new TrafficPatternInfo_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public TrafficPatternInfoList_r14 (TrafficPatternInfo_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TrafficPatternInfo_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TrafficPatternInfo_r14();
