...
public class ForbiddenLACs extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ForbiddenLACs";
   }

   public LAC[] elements;

   public ForbiddenLACs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ForbiddenLACs (int numRecords) {
      elements = new LAC [numRecords];
   }
    ...
    * given the array.  
    */
   public ForbiddenLACs (LAC[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 4096);
      int numElements = (int) buffer.decodeLength();

      elements = new LAC [numElements];
