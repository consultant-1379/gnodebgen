...
public class SCellToReleaseListExt_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCellToReleaseListExt-r13";
   }

   public SCellIndex_r13[] elements;

   public SCellToReleaseListExt_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCellToReleaseListExt_r13 (int numRecords) {
      elements = new SCellIndex_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCellToReleaseListExt_r13 (SCellIndex_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCellIndex_r13 [numElements];
