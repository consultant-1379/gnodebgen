...
public class MBSFN_Subframe_Infolist extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MBSFN-Subframe-Infolist";
   }

   public MBSFN_Subframe_Info[] elements;

   public MBSFN_Subframe_Infolist () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBSFN_Subframe_Infolist (int numRecords) {
      elements = new MBSFN_Subframe_Info [numRecords];
   }
    ...
    * given the array.  
    */
   public MBSFN_Subframe_Infolist (MBSFN_Subframe_Info[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBSFN_Subframe_Info [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBSFN_Subframe_Info();
