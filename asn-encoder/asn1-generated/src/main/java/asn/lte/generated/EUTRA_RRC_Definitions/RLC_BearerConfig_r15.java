...
public class RLC_BearerConfig_r15 extends Asn1Choice {
   ...
   public RLC_BearerConfig_r15 () {
      super();
   }

   public RLC_BearerConfig_r15 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (RLC_BearerConfig_r15_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            RLC_BearerConfig_r15_setup setup;
            element = setup = new RLC_BearerConfig_r15_setup();
            setup.decode (buffer);
            break;
         }
