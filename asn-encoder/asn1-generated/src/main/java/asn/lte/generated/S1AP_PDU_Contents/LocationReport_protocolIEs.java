...
public class LocationReport_protocolIEs extends Asn1SeqOf {
   ...
   public LocationReport_protocolIEs_element[] elements;

   public LocationReport_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public LocationReport_protocolIEs (int numRecords) {
      elements = new LocationReport_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public LocationReport_protocolIEs (LocationReport_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LocationReport_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LocationReport_protocolIEs_element();
