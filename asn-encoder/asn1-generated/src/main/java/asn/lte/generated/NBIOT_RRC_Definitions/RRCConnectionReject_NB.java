...
public class RRCConnectionReject_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionReject-NB";
   }

   public RRCConnectionReject_NB_criticalExtensions criticalExtensions;

   public RRCConnectionReject_NB () {
      super();
      init();
   }
    ...
    */
   public RRCConnectionReject_NB (
      RRCConnectionReject_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionReject_NB_criticalExtensions();
