...
public class CellsToAddModList extends Asn1SeqOf {
   ...
   public CellsToAddMod[] elements;

   public CellsToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellsToAddModList (int numRecords) {
      elements = new CellsToAddMod [numRecords];
   }
    ...
    * given the array.  
    */
   public CellsToAddModList (CellsToAddMod[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellsToAddMod [numElements];
