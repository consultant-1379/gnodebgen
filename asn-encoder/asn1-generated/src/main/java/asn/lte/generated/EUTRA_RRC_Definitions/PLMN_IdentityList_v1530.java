...
public class PLMN_IdentityList_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PLMN-IdentityList-v1530";
   }

   public PLMN_IdentityInfo_v1530[] elements;

   public PLMN_IdentityList_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_IdentityList_v1530 (int numRecords) {
      elements = new PLMN_IdentityInfo_v1530 [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMN_IdentityList_v1530 (PLMN_IdentityInfo_v1530[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PLMN_IdentityInfo_v1530 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PLMN_IdentityInfo_v1530();
