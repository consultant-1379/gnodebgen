...
public class UL_ConfigCommonList_NB_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "UL-ConfigCommonList-NB-v1530";
   }

   public UL_ConfigCommon_NB_v1530[] elements;

   public UL_ConfigCommonList_NB_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UL_ConfigCommonList_NB_v1530 (int numRecords) {
      elements = new UL_ConfigCommon_NB_v1530 [numRecords];
   }
    ...
    * given the array.  
    */
   public UL_ConfigCommonList_NB_v1530 (UL_ConfigCommon_NB_v1530[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UL_ConfigCommon_NB_v1530 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UL_ConfigCommon_NB_v1530();
