...
public class Reset_protocolIEs_element extends Asn1Seq {
   ...
   public void setUsing_id_ResetType(ResetType value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_ResetType);
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.ResetIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.ResetIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.ResetIEs[i];
            break;
         }
      }
      if (null == _index) {
