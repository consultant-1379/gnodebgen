...
public class EAB_UE_S1AP_PDU_Transfer_protocolIEs extends Asn1SeqOf {
   ...
   public EAB_UE_S1AP_PDU_Transfer_protocolIEs_element[] elements;

   public EAB_UE_S1AP_PDU_Transfer_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_UE_S1AP_PDU_Transfer_protocolIEs (int numRecords) {
      elements = new EAB_UE_S1AP_PDU_Transfer_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_UE_S1AP_PDU_Transfer_protocolIEs (EAB_UE_S1AP_PDU_Transfer_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_UE_S1AP_PDU_Transfer_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_UE_S1AP_PDU_Transfer_protocolIEs_element();
