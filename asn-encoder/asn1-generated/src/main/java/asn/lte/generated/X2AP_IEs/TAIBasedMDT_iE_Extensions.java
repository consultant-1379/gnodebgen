...
public class TAIBasedMDT_iE_Extensions extends Asn1SeqOf {
   ...
   public TAIBasedMDT_iE_Extensions_element[] elements;

   public TAIBasedMDT_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TAIBasedMDT_iE_Extensions (int numRecords) {
      elements = new TAIBasedMDT_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TAIBasedMDT_iE_Extensions (TAIBasedMDT_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TAIBasedMDT_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TAIBasedMDT_iE_Extensions_element();
