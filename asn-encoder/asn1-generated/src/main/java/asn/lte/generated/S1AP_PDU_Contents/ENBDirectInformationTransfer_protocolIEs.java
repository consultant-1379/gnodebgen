...
public class ENBDirectInformationTransfer_protocolIEs extends Asn1SeqOf {
   ...
   public ENBDirectInformationTransfer_protocolIEs_element[] elements;

   public ENBDirectInformationTransfer_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENBDirectInformationTransfer_protocolIEs (int numRecords) {
      elements = new ENBDirectInformationTransfer_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENBDirectInformationTransfer_protocolIEs (ENBDirectInformationTransfer_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENBDirectInformationTransfer_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENBDirectInformationTransfer_protocolIEs_element();
