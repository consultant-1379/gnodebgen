...
public class OTDOA_Information_Type_Item_iE_Extensions_element extends Asn1Seq {
   ...
   public OTDOA_Information_Type_Item_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public OTDOA_Information_Type_Item_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   {
      /* check id */
      asn.lte.generated.LPPA_Containers.LPPA_PROTOCOL_EXTENSION _index = null;
      for(int i=0; i < _LPPA_PDU_ContentsValues.OTDOA_Information_Type_ItemExtIEs.length; i++) {
         if(_LPPA_PDU_ContentsValues.OTDOA_Information_Type_ItemExtIEs[i].id.equals(id)) {
            _index = _LPPA_PDU_ContentsValues.OTDOA_Information_Type_ItemExtIEs[i];
            break;
         }
      }
      if (null == _index) {
