...
public class MeasResultList2EUTRA_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultList2EUTRA-r16";
   }

   public MeasResult2EUTRA_r16[] elements;

   public MeasResultList2EUTRA_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultList2EUTRA_r16 (int numRecords) {
      elements = new MeasResult2EUTRA_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultList2EUTRA_r16 (MeasResult2EUTRA_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResult2EUTRA_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResult2EUTRA_r16();
