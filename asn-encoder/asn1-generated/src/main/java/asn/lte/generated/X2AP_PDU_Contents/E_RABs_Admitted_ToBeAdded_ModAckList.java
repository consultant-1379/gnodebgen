...
public class E_RABs_Admitted_ToBeAdded_ModAckList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-Admitted-ToBeAdded-ModAckList";
   }

   public E_RABs_Admitted_ToBeAdded_ModAckList_element[] elements;

   public E_RABs_Admitted_ToBeAdded_ModAckList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_Admitted_ToBeAdded_ModAckList (int numRecords) {
      elements = new E_RABs_Admitted_ToBeAdded_ModAckList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_Admitted_ToBeAdded_ModAckList (E_RABs_Admitted_ToBeAdded_ModAckList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_Admitted_ToBeAdded_ModAckList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_Admitted_ToBeAdded_ModAckList_element();
