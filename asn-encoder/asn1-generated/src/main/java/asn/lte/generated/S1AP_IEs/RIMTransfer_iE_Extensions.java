...
public class RIMTransfer_iE_Extensions extends Asn1SeqOf {
   ...
   public RIMTransfer_iE_Extensions_element[] elements;

   public RIMTransfer_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RIMTransfer_iE_Extensions (int numRecords) {
      elements = new RIMTransfer_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RIMTransfer_iE_Extensions (RIMTransfer_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RIMTransfer_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RIMTransfer_iE_Extensions_element();
