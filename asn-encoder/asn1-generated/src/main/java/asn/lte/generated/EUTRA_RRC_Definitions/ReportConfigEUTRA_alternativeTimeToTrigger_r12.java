...
public class ReportConfigEUTRA_alternativeTimeToTrigger_r12 extends Asn1Choice {
   ...
   public ReportConfigEUTRA_alternativeTimeToTrigger_r12 () {
      super();
   }

   public ReportConfigEUTRA_alternativeTimeToTrigger_r12 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (TimeToTrigger value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 1: { 
            ...
            element = setup = TimeToTrigger.valueOf (tval);
            break;
         }
