...
public class SgNBCounterCheckRequest_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBCounterCheckRequest_protocolIEs_element[] elements;

   public SgNBCounterCheckRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBCounterCheckRequest_protocolIEs (int numRecords) {
      elements = new SgNBCounterCheckRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBCounterCheckRequest_protocolIEs (SgNBCounterCheckRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBCounterCheckRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBCounterCheckRequest_protocolIEs_element();
