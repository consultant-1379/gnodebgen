...
public class ServedCellsToModify_Item_iE_Extensions_element extends Asn1Seq {
   ...
   /**
    * id: id-DeactivationIndication
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: DeactivationIndication
    * Java type: DeactivationIndication
    *
    * id: id-NRNeighbourInfoToModify
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: NRNeighbour-Information
    * Java type: NRNeighbour_Information
    */
   public Asn1Type extensionValue;

   public ServedCellsToModify_Item_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ServedCellsToModify_Item_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-DeactivationIndication
    */
   public void setUsing_id_DeactivationIndication(asn.lte.generated.X2AP_IEs.DeactivationIndication extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_DeactivationIndication);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-NRNeighbourInfoToModify
    */
   public void setUsing_id_NRNeighbourInfoToModify(asn.lte.generated.X2AP_IEs.NRNeighbour_Information extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_NRNeighbourInfoToModify);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-DeactivationIndication
    */
   public asn.lte.generated.X2AP_IEs.DeactivationIndication getExtensionValueFor_id_DeactivationIndication() {
      return (asn.lte.generated.X2AP_IEs.DeactivationIndication) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-NRNeighbourInfoToModify
    */
   public asn.lte.generated.X2AP_IEs.NRNeighbour_Information getExtensionValueFor_id_NRNeighbourInfoToModify() {
      return (asn.lte.generated.X2AP_IEs.NRNeighbour_Information) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ServedCellsToModify_Item_ExtIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ServedCellsToModify_Item_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ServedCellsToModify_Item_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 59) {
         indent (_sb, _level+1);
         _sb.append("id = id-DeactivationIndication\n");
      }
      else if (id.value == 328) {
         indent (_sb, _level+1);
         _sb.append("id = id-NRNeighbourInfoToModify\n");
      }
