...
public class X2AP_ENSA_PDU extends Asn1Choice {
   ...
   public X2AP_ENSA_PDU () {
      super();
   }

   public X2AP_ENSA_PDU (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_initiatingMessage (ENSA_InitiatingMessage value) {
      setElement (_INITIATINGMESSAGE, value);
   }

   public void set_successfulOutcome (ENSA_SuccessfulOutcome value) {
      setElement (_SUCCESSFULOUTCOME, value);
   }

   public void set_unsuccessfulOutcome (ENSA_UnsuccessfulOutcome value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (!extbit) {
         ...
         switch (idx) {
            // initiatingMessage
            case 0: { 
               ENSA_InitiatingMessage initiatingMessage;
               element = initiatingMessage = new ENSA_InitiatingMessage();
            ...
            // successfulOutcome
            case 1: { 
               ENSA_SuccessfulOutcome successfulOutcome;
               element = successfulOutcome = new ENSA_SuccessfulOutcome();
            ...
            // unsuccessfulOutcome
            case 2: { 
               ENSA_UnsuccessfulOutcome unsuccessfulOutcome;
               element = unsuccessfulOutcome = new ENSA_UnsuccessfulOutcome();
