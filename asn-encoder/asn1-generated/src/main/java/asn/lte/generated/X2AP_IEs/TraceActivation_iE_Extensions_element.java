...
public class TraceActivation_iE_Extensions_element extends Asn1Seq {
   ...
   public void setUsing_id_MDTConfiguration(MDT_Configuration extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_MDTConfiguration);
   ...
   public void setUsing_id_UEAppLayerMeasConfig(UEAppLayerMeasConfig extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_UEAppLayerMeasConfig);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.TraceActivation_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.TraceActivation_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.TraceActivation_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
