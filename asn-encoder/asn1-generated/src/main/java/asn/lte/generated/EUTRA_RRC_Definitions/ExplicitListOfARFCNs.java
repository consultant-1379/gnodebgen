...
public class ExplicitListOfARFCNs extends Asn1SeqOf {
   ...
   public ARFCN_ValueGERAN[] elements;
    ...
    * populated.
    */
   public ExplicitListOfARFCNs (int numRecords) {
      elements = new ARFCN_ValueGERAN [numRecords];
   }
    ...
    * given the array.  
    */
   public ExplicitListOfARFCNs (ARFCN_ValueGERAN[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ARFCN_ValueGERAN [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ARFCN_ValueGERAN();
