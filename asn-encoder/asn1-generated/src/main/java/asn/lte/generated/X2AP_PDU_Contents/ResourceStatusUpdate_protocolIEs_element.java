...
public class ResourceStatusUpdate_protocolIEs_element extends Asn1Seq {
    ...
    * presence: Presence.mandatory
    * ASN.1 type: CellMeasurementResult-List
    * Java type: CellMeasurementResult_List
    */
   public Asn1Type value;

   public ResourceStatusUpdate_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ResourceStatusUpdate_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-CellMeasurementResult
    */
   public void setUsing_id_CellMeasurementResult(CellMeasurementResult_List value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_CellMeasurementResult);
   ...
   /**
    * Get value of value with type set according to information object having key id-CellMeasurementResult
    */
   public CellMeasurementResult_List getValueFor_id_CellMeasurementResult() {
      return (CellMeasurementResult_List) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ResourceStatusUpdate_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ResourceStatusUpdate_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ResourceStatusUpdate_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 39) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-CellMeasurementResult\n");
      }
