...
public class RACH_InfoList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RACH-InfoList-NB-r13";
   }

   public RACH_Info_NB_r13[] elements;

   public RACH_InfoList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RACH_InfoList_NB_r13 (int numRecords) {
      elements = new RACH_Info_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public RACH_InfoList_NB_r13 (RACH_Info_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RACH_Info_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RACH_Info_NB_r13();
