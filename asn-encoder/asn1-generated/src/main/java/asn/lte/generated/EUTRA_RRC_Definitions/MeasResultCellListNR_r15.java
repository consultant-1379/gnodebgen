...
public class MeasResultCellListNR_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultCellListNR-r15";
   }

   public MeasResultCellNR_r15[] elements;

   public MeasResultCellListNR_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultCellListNR_r15 (int numRecords) {
      elements = new MeasResultCellNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultCellListNR_r15 (MeasResultCellNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultCellNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultCellNR_r15();
