...
public class SPS_ConfigUL_ToReleaseList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPS-ConfigUL-ToReleaseList-r15";
   }

   public SPS_ConfigIndex_r15[] elements;

   public SPS_ConfigUL_ToReleaseList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPS_ConfigUL_ToReleaseList_r15 (int numRecords) {
    ...
    * given the array.  
    */
   public SPS_ConfigUL_ToReleaseList_r15 (SPS_ConfigIndex_r15[] elements_) {
      elements = elements_;
   }
