...
public class NAICS_Capability_List_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NAICS-Capability-List-r12";
   }

   public NAICS_Capability_Entry_r12[] elements;

   public NAICS_Capability_List_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NAICS_Capability_List_r12 (int numRecords) {
      elements = new NAICS_Capability_Entry_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public NAICS_Capability_List_r12 (NAICS_Capability_Entry_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NAICS_Capability_Entry_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NAICS_Capability_Entry_r12();
