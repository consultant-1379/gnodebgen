...
public class SL_PPPR_Dest_CarrierFreqList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-PPPR-Dest-CarrierFreqList-r15";
   }

   public SL_PPPR_Dest_CarrierFreq[] elements;

   public SL_PPPR_Dest_CarrierFreqList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_PPPR_Dest_CarrierFreqList_r15 (int numRecords) {
      elements = new SL_PPPR_Dest_CarrierFreq [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_PPPR_Dest_CarrierFreqList_r15 (SL_PPPR_Dest_CarrierFreq[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_PPPR_Dest_CarrierFreq [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_PPPR_Dest_CarrierFreq();
