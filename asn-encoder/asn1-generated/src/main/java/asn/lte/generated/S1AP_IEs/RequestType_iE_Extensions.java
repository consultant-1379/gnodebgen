...
public class RequestType_iE_Extensions extends Asn1SeqOf {
   ...
   public RequestType_iE_Extensions_element[] elements;

   public RequestType_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RequestType_iE_Extensions (int numRecords) {
      elements = new RequestType_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RequestType_iE_Extensions (RequestType_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RequestType_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RequestType_iE_Extensions_element();
