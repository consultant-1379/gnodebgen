...
public class NB_IoT_Paging_eDRXInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public NB_IoT_Paging_eDRXInformation_iE_Extensions_element[] elements;

   public NB_IoT_Paging_eDRXInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public NB_IoT_Paging_eDRXInformation_iE_Extensions (int numRecords) {
      elements = new NB_IoT_Paging_eDRXInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public NB_IoT_Paging_eDRXInformation_iE_Extensions (NB_IoT_Paging_eDRXInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NB_IoT_Paging_eDRXInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NB_IoT_Paging_eDRXInformation_iE_Extensions_element();
