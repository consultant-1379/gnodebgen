...
public class CSI_IM_ConfigToReleaseList_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSI-IM-ConfigToReleaseList-r11";
   }

   public CSI_IM_ConfigId_r11[] elements;

   public CSI_IM_ConfigToReleaseList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_IM_ConfigToReleaseList_r11 (int numRecords) {
      elements = new CSI_IM_ConfigId_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_IM_ConfigToReleaseList_r11 (CSI_IM_ConfigId_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_IM_ConfigId_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_IM_ConfigId_r11();
