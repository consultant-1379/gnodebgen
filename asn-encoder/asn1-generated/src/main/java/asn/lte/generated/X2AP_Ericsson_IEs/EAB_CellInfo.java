...
public class EAB_CellInfo extends Asn1OctetString {
    ...
    */
   public EAB_CellInfo (byte[] data, int offset, int nbytes) {
    ...
    */
   public EAB_CellInfo (String value_) throws Asn1ValueParseException {
      super (value_);
   }
