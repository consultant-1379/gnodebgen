...
public class ActivatedCellList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ActivatedCellList";
   }

   public ActivatedCellList_Item[] elements;

   public ActivatedCellList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ActivatedCellList (int numRecords) {
      elements = new ActivatedCellList_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ActivatedCellList (ActivatedCellList_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ActivatedCellList_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ActivatedCellList_Item();
