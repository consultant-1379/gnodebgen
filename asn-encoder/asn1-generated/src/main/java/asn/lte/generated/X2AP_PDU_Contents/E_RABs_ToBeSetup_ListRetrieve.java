...
public class E_RABs_ToBeSetup_ListRetrieve extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeSetup-ListRetrieve";
   }

   public E_RABs_ToBeSetup_ListRetrieve_element[] elements;

   public E_RABs_ToBeSetup_ListRetrieve () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeSetup_ListRetrieve (int numRecords) {
      elements = new E_RABs_ToBeSetup_ListRetrieve_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeSetup_ListRetrieve (E_RABs_ToBeSetup_ListRetrieve_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeSetup_ListRetrieve_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeSetup_ListRetrieve_element();
