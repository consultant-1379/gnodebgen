...
public class E_RABToBeSwitchedDLList extends Asn1SeqOf {
   ...
   public E_RABToBeSwitchedDLList_element[] elements;

   public E_RABToBeSwitchedDLList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABToBeSwitchedDLList (int numRecords) {
      elements = new E_RABToBeSwitchedDLList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABToBeSwitchedDLList (E_RABToBeSwitchedDLList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABToBeSwitchedDLList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABToBeSwitchedDLList_element();
