...
public class NG_5G_S_TMSI_r15 extends Asn1BitString {
    ...
    */
   public NG_5G_S_TMSI_r15 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public NG_5G_S_TMSI_r15 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public NG_5G_S_TMSI_r15 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public NG_5G_S_TMSI_r15 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public NG_5G_S_TMSI_r15 (java.util.BitSet bitSet) {
      super (bitSet);
   }
