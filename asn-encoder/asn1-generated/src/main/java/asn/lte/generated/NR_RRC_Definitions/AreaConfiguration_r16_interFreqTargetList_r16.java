...
public class AreaConfiguration_r16_interFreqTargetList_r16 extends Asn1SeqOf {
   ...
   public InterFreqTargetInfo_r16[] elements;

   public AreaConfiguration_r16_interFreqTargetList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AreaConfiguration_r16_interFreqTargetList_r16 (int numRecords) {
      elements = new InterFreqTargetInfo_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public AreaConfiguration_r16_interFreqTargetList_r16 (InterFreqTargetInfo_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqTargetInfo_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqTargetInfo_r16();
