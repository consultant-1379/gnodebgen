...
public class CancelledCellinEAI_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public CancelledCellinEAI_Item_iE_Extensions_element[] elements;

   public CancelledCellinEAI_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CancelledCellinEAI_Item_iE_Extensions (int numRecords) {
      elements = new CancelledCellinEAI_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CancelledCellinEAI_Item_iE_Extensions (CancelledCellinEAI_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CancelledCellinEAI_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CancelledCellinEAI_Item_iE_Extensions_element();
