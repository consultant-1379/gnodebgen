...
public class SgNBReleaseRequest_protocolIEs_element extends Asn1Seq {
    ...
    * Java type: Cause
    *
    * id: id-E-RABs-ToBeReleased-SgNBRelReqList
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: E-RABs-ToBeReleased-SgNBRelReqList
    * Java type: E_RABs_ToBeReleased_SgNBRelReqList
    *
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-SgNBReleaseRequest-ExtConveyor
    * Java type: EAB_SgNBReleaseRequest_ExtConveyor
    */
   public Asn1Type value;

   public SgNBReleaseRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBReleaseRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-ToBeReleased-SgNBRelReqList
    */
   public void setUsing_id_E_RABs_ToBeReleased_SgNBRelReqList(E_RABs_ToBeReleased_SgNBRelReqList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_ToBeReleased_SgNBRelReqList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBReleaseRequest_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-ToBeReleased-SgNBRelReqList
    */
   public E_RABs_ToBeReleased_SgNBRelReqList getValueFor_id_E_RABs_ToBeReleased_SgNBRelReqList() {
      return (E_RABs_ToBeReleased_SgNBRelReqList) this.value;
   }
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBReleaseRequest_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBReleaseRequest_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SgNBReleaseRequest_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SgNBReleaseRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SgNBReleaseRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-ToBeReleased-SgNBRelReqList\n");
      }
