...
public class MCEConfigurationUpdate_protocolIEs extends Asn1SeqOf {
   ...
   public MCEConfigurationUpdate_protocolIEs_element[] elements;

   public MCEConfigurationUpdate_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MCEConfigurationUpdate_protocolIEs (int numRecords) {
      elements = new MCEConfigurationUpdate_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MCEConfigurationUpdate_protocolIEs (MCEConfigurationUpdate_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MCEConfigurationUpdate_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MCEConfigurationUpdate_protocolIEs_element();
