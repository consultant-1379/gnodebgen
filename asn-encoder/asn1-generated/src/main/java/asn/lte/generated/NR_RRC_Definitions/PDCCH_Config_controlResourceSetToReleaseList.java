...
public class PDCCH_Config_controlResourceSetToReleaseList extends Asn1SeqOf {
   ...
   public ControlResourceSetId[] elements;

   public PDCCH_Config_controlResourceSetToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDCCH_Config_controlResourceSetToReleaseList (int numRecords) {
      elements = new ControlResourceSetId [numRecords];
   }
    ...
    * given the array.  
    */
   public PDCCH_Config_controlResourceSetToReleaseList (ControlResourceSetId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ControlResourceSetId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ControlResourceSetId();
