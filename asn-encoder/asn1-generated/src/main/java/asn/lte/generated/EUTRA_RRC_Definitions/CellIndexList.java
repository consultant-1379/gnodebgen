...
public class CellIndexList extends Asn1SeqOf {
   ...
   public CellIndex[] elements;

   public CellIndexList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellIndexList (int numRecords) {
      elements = new CellIndex [numRecords];
   }
    ...
    * given the array.  
    */
   public CellIndexList (CellIndex[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellIndex [numElements];
