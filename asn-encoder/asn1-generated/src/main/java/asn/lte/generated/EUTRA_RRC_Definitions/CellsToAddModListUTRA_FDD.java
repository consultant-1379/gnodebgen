...
public class CellsToAddModListUTRA_FDD extends Asn1SeqOf {
   ...
   public CellsToAddModUTRA_FDD[] elements;

   public CellsToAddModListUTRA_FDD () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellsToAddModListUTRA_FDD (int numRecords) {
      elements = new CellsToAddModUTRA_FDD [numRecords];
   }
    ...
    * given the array.  
    */
   public CellsToAddModListUTRA_FDD (CellsToAddModUTRA_FDD[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellsToAddModUTRA_FDD [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellsToAddModUTRA_FDD();
