...
public class SIB_MappingInfo extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SIB-MappingInfo";
   }

   public SIB_Type[] elements;

   public SIB_MappingInfo () {
      elements = null;
   }
    ...
    * populated.
    */
   public SIB_MappingInfo (int numRecords) {
      elements = new SIB_Type [numRecords];
   }
    ...
    * given the array.  
    */
   public SIB_MappingInfo (SIB_Type[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SIB_Type [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         {
            int tval = SIB_Type.decodeEnumValue (buffer);
            elements[i] = SIB_Type.valueOf (tval);
         }
