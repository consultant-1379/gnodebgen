...
public class CoMPInformationItem_element_iE_Extensions extends Asn1SeqOf {
   ...
   public CoMPInformationItem_element_iE_Extensions_element[] elements;

   public CoMPInformationItem_element_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CoMPInformationItem_element_iE_Extensions (int numRecords) {
      elements = new CoMPInformationItem_element_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CoMPInformationItem_element_iE_Extensions (CoMPInformationItem_element_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CoMPInformationItem_element_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CoMPInformationItem_element_iE_Extensions_element();
