...
public class EmergencyAreaID_Cancelled extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EmergencyAreaID-Cancelled";
   }

   public EmergencyAreaID_Cancelled_Item[] elements;

   public EmergencyAreaID_Cancelled () {
      elements = null;
   }
    ...
    * populated.
    */
   public EmergencyAreaID_Cancelled (int numRecords) {
      elements = new EmergencyAreaID_Cancelled_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EmergencyAreaID_Cancelled (EmergencyAreaID_Cancelled_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EmergencyAreaID_Cancelled_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EmergencyAreaID_Cancelled_Item();
