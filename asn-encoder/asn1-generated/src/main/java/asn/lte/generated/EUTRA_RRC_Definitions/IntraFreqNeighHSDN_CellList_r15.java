...
public class IntraFreqNeighHSDN_CellList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "IntraFreqNeighHSDN-CellList-r15";
   }

   public PhysCellIdRange[] elements;

   public IntraFreqNeighHSDN_CellList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public IntraFreqNeighHSDN_CellList_r15 (int numRecords) {
    ...
    * given the array.  
    */
   public IntraFreqNeighHSDN_CellList_r15 (PhysCellIdRange[] elements_) {
      elements = elements_;
   }
