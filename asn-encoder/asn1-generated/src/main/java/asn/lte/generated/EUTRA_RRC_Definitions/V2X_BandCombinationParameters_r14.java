...
public class V2X_BandCombinationParameters_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "V2X-BandCombinationParameters-r14";
   }

   public V2X_BandParameters_r14[] elements;

   public V2X_BandCombinationParameters_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public V2X_BandCombinationParameters_r14 (int numRecords) {
      elements = new V2X_BandParameters_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public V2X_BandCombinationParameters_r14 (V2X_BandParameters_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new V2X_BandParameters_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new V2X_BandParameters_r14();
