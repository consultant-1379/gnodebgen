...
public class SystemInformation_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SystemInformation-NB";
   }

   public SystemInformation_NB_criticalExtensions criticalExtensions;

   public SystemInformation_NB () {
      super();
      init();
   }
    ...
    */
   public SystemInformation_NB (
      SystemInformation_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new SystemInformation_NB_criticalExtensions();
