...
public class PrivateMessage_privateIEs extends Asn1SeqOf {
   ...
   public PrivateMessage_privateIEs_element[] elements;

   public PrivateMessage_privateIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public PrivateMessage_privateIEs (int numRecords) {
      elements = new PrivateMessage_privateIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PrivateMessage_privateIEs (PrivateMessage_privateIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PrivateMessage_privateIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PrivateMessage_privateIEs_element();
