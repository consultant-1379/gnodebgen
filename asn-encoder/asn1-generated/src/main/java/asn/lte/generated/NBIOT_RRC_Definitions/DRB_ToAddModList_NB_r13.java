...
public class DRB_ToAddModList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "DRB-ToAddModList-NB-r13";
   }

   public DRB_ToAddMod_NB_r13[] elements;

   public DRB_ToAddModList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public DRB_ToAddModList_NB_r13 (int numRecords) {
      elements = new DRB_ToAddMod_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public DRB_ToAddModList_NB_r13 (DRB_ToAddMod_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DRB_ToAddMod_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DRB_ToAddMod_NB_r13();
