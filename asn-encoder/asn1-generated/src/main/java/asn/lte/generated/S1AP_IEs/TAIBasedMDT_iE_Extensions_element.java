...
public class TAIBasedMDT_iE_Extensions_element extends Asn1Seq {
   ...
   public TAIBasedMDT_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public TAIBasedMDT_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.TAIBasedMDT_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.TAIBasedMDT_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.TAIBasedMDT_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
