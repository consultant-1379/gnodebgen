...
public class SgNBModificationRequestReject_protocolIEs_element extends Asn1Seq {
   ...
   public SgNBModificationRequestReject_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBModificationRequestReject_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SgNBModificationRequestReject_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SgNBModificationRequestReject_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SgNBModificationRequestReject_IEs[i];
            break;
         }
      }
      if (null == _index) {
