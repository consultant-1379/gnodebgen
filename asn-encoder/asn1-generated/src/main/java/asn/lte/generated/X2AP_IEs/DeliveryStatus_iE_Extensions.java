...
public class DeliveryStatus_iE_Extensions extends Asn1SeqOf {
   ...
   public DeliveryStatus_iE_Extensions_element[] elements;

   public DeliveryStatus_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public DeliveryStatus_iE_Extensions (int numRecords) {
      elements = new DeliveryStatus_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public DeliveryStatus_iE_Extensions (DeliveryStatus_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DeliveryStatus_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DeliveryStatus_iE_Extensions_element();
