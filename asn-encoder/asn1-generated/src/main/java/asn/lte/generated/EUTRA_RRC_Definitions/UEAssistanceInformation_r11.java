...
public class UEAssistanceInformation_r11 extends Asn1Seq {
   ...
   public UEAssistanceInformation_r11_criticalExtensions criticalExtensions;

   public UEAssistanceInformation_r11 () {
      super();
      init();
   }
    ...
    */
   public UEAssistanceInformation_r11 (
      UEAssistanceInformation_r11_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new UEAssistanceInformation_r11_criticalExtensions();
