...
public class Cdma2000OneXRAND extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public Cdma2000OneXRAND (byte[] data) {
      super (data);
   }
    ...
    */
   public Cdma2000OneXRAND (byte[] data, int offset, int nbytes) {
    ...
    */
   public Cdma2000OneXRAND (String value_) throws Asn1ValueParseException {
      super (value_);
   }
