...
public class PH_TypeListMCG extends Asn1SeqOf {
   ...
   public PH_InfoMCG[] elements;

   public PH_TypeListMCG () {
      elements = null;
   }
    ...
    * populated.
    */
   public PH_TypeListMCG (int numRecords) {
      elements = new PH_InfoMCG [numRecords];
   }
    ...
    * given the array.  
    */
   public PH_TypeListMCG (PH_InfoMCG[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PH_InfoMCG [numElements];
