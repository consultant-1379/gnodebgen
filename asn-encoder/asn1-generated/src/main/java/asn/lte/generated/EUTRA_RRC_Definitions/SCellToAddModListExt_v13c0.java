...
public class SCellToAddModListExt_v13c0 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCellToAddModListExt-v13c0";
   }

   public SCellToAddMod_v13c0[] elements;

   public SCellToAddModListExt_v13c0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCellToAddModListExt_v13c0 (int numRecords) {
      elements = new SCellToAddMod_v13c0 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCellToAddModListExt_v13c0 (SCellToAddMod_v13c0[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCellToAddMod_v13c0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SCellToAddMod_v13c0();
