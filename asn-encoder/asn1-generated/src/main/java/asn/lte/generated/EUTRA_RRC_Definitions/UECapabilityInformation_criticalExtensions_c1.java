...
public class UECapabilityInformation_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _UECAPABILITYINFORMATION_R8 = 1;
   ...
   public UECapabilityInformation_criticalExtensions_c1 () {
      super();
   }

   public UECapabilityInformation_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _UECAPABILITYINFORMATION_R8: return "ueCapabilityInformation_r8";
   ...
   public void set_ueCapabilityInformation_r8 (UECapabilityInformation_r8_IEs value) {
      setElement (_UECAPABILITYINFORMATION_R8, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            UECapabilityInformation_r8_IEs ueCapabilityInformation_r8;
            element = ueCapabilityInformation_r8 = new UECapabilityInformation_r8_IEs();
            ueCapabilityInformation_r8.decode (buffer);
            break;
         }
