...
public class MeasResultListUTRA_FDD_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultListUTRA-FDD-r16";
   }

   public MeasResultUTRA_FDD_r16[] elements;

   public MeasResultListUTRA_FDD_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListUTRA_FDD_r16 (int numRecords) {
      elements = new MeasResultUTRA_FDD_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListUTRA_FDD_r16 (MeasResultUTRA_FDD_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultUTRA_FDD_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultUTRA_FDD_r16();
