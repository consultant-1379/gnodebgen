...
public class Cdma2000PDU extends Asn1OctetString {
    ...
    */
   public Cdma2000PDU (byte[] data, int offset, int nbytes) {
    ...
    */
   public Cdma2000PDU (String value_) throws Asn1ValueParseException {
      super (value_);
   }
