...
public class SourceeNB_ToTargeteNB_TransparentContainer_iE_Extensions_element extends Asn1Seq {
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-SourceeNB-ToTargeteNB-TransparentContainer-ExtConveyor
    * Java type: EAB_SourceeNB_ToTargeteNB_TransparentContainer_ExtConveyor
    */
   public Asn1Type extensionValue;

   public SourceeNB_ToTargeteNB_TransparentContainer_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SourceeNB_ToTargeteNB_TransparentContainer_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
    ...
    */
   public void setUsing_id_MobilityInformation(MobilityInformation extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_MobilityInformation);
    ...
    */
   public void setUsing_id_uE_HistoryInformationFromTheUE(UE_HistoryInformationFromTheUE extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_uE_HistoryInformationFromTheUE);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.S1AP_Ericsson_IEs.EAB_SourceeNB_ToTargeteNB_TransparentContainer_ExtConveyor extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Ericsson_Conveyor._S1AP_Ericsson_ConveyorValues.id_Ericsson_ExtConveyor);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-MobilityInformation
    */
   public MobilityInformation getExtensionValueFor_id_MobilityInformation() {
      return (MobilityInformation) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-uE-HistoryInformationFromTheUE
    */
   public UE_HistoryInformationFromTheUE getExtensionValueFor_id_uE_HistoryInformationFromTheUE() {
      return (UE_HistoryInformationFromTheUE) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-Ericsson-ExtConveyor
    */
   public asn.lte.generated.S1AP_Ericsson_IEs.EAB_SourceeNB_ToTargeteNB_TransparentContainer_ExtConveyor getExtensionValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.S1AP_Ericsson_IEs.EAB_SourceeNB_ToTargeteNB_TransparentContainer_ExtConveyor) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.SourceeNB_ToTargeteNB_TransparentContainer_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.SourceeNB_ToTargeteNB_TransparentContainer_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.SourceeNB_ToTargeteNB_TransparentContainer_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
