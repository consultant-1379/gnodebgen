...
public class CSI_RS_ConfigZPToReleaseList_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSI-RS-ConfigZPToReleaseList-r11";
   }

   public CSI_RS_ConfigZPId_r11[] elements;

   public CSI_RS_ConfigZPToReleaseList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_ConfigZPToReleaseList_r11 (int numRecords) {
      elements = new CSI_RS_ConfigZPId_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_RS_ConfigZPToReleaseList_r11 (CSI_RS_ConfigZPId_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_RS_ConfigZPId_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_RS_ConfigZPId_r11();
