...
public class E_RABToBeModifiedListBearerModReq_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABToBeModifiedItemBearerModReq
    * Java type: E_RABToBeModifiedItemBearerModReq
    */
   public Asn1Type value;

   public E_RABToBeModifiedListBearerModReq_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABToBeModifiedListBearerModReq_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABToBeModifiedItemBearerModReq
    */
   public void setUsing_id_E_RABToBeModifiedItemBearerModReq(E_RABToBeModifiedItemBearerModReq value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABToBeModifiedItemBearerModReq);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABToBeModifiedItemBearerModReq
    */
   public E_RABToBeModifiedItemBearerModReq getValueFor_id_E_RABToBeModifiedItemBearerModReq() {
      return (E_RABToBeModifiedItemBearerModReq) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABToBeModifiedItemBearerModReqIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABToBeModifiedItemBearerModReqIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABToBeModifiedItemBearerModReqIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 36) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABToBeModifiedItemBearerModReq\n");
      }
