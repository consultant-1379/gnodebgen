...
public class CELevel extends Asn1OctetString {
    ...
    */
   public CELevel (byte[] data, int offset, int nbytes) {
    ...
    */
   public CELevel (String value_) throws Asn1ValueParseException {
      super (value_);
   }
