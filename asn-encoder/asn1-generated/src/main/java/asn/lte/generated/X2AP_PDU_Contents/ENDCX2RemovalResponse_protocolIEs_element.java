...
public class ENDCX2RemovalResponse_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-RespondingNodeType-EndcX2Removal
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: RespondingNodeType-EndcX2Removal
    * Java type: RespondingNodeType_EndcX2Removal
    *
   ...
   public ENDCX2RemovalResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCX2RemovalResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-RespondingNodeType-EndcX2Removal
    */
   public void setUsing_id_RespondingNodeType_EndcX2Removal(RespondingNodeType_EndcX2Removal value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_RespondingNodeType_EndcX2Removal);
   ...
   /**
    * Get value of value with type set according to information object having key id-RespondingNodeType-EndcX2Removal
    */
   public RespondingNodeType_EndcX2Removal getValueFor_id_RespondingNodeType_EndcX2Removal() {
      return (RespondingNodeType_EndcX2Removal) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCX2RemovalResponse_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCX2RemovalResponse_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCX2RemovalResponse_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 299) {
         indent (_sb, _level+1);
         _sb.append("id = id-RespondingNodeType-EndcX2Removal\n");
      }
