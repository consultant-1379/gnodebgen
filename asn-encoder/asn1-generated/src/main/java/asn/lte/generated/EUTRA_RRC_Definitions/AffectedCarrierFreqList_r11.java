...
public class AffectedCarrierFreqList_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AffectedCarrierFreqList-r11";
   }

   public AffectedCarrierFreq_r11[] elements;

   public AffectedCarrierFreqList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AffectedCarrierFreqList_r11 (int numRecords) {
      elements = new AffectedCarrierFreq_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public AffectedCarrierFreqList_r11 (AffectedCarrierFreq_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AffectedCarrierFreq_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AffectedCarrierFreq_r11();
