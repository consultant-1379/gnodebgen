...
public class PDSCH_Config_zp_CSI_RS_ResourceToAddModList extends Asn1SeqOf {
   ...
   public ZP_CSI_RS_Resource[] elements;

   public PDSCH_Config_zp_CSI_RS_ResourceToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDSCH_Config_zp_CSI_RS_ResourceToAddModList (int numRecords) {
      elements = new ZP_CSI_RS_Resource [numRecords];
   }
    ...
    * given the array.  
    */
   public PDSCH_Config_zp_CSI_RS_ResourceToAddModList (ZP_CSI_RS_Resource[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ZP_CSI_RS_Resource [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ZP_CSI_RS_Resource();
