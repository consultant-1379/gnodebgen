...
public class OTDOAInformationFailure_protocolIEs_element extends Asn1Seq {
   ...
   public OTDOAInformationFailure_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public OTDOAInformationFailure_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _LPPA_PDU_ContentsValues.OTDOAInformationFailure_IEs.length; i++) {
         if(_LPPA_PDU_ContentsValues.OTDOAInformationFailure_IEs[i].id.equals(id)) {
            _index = _LPPA_PDU_ContentsValues.OTDOAInformationFailure_IEs[i];
            break;
         }
      }
      if (null == _index) {
