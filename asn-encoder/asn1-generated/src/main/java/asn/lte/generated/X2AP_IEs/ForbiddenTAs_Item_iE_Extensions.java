...
public class ForbiddenTAs_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public ForbiddenTAs_Item_iE_Extensions_element[] elements;

   public ForbiddenTAs_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ForbiddenTAs_Item_iE_Extensions (int numRecords) {
      elements = new ForbiddenTAs_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ForbiddenTAs_Item_iE_Extensions (ForbiddenTAs_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ForbiddenTAs_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ForbiddenTAs_Item_iE_Extensions_element();
