...
public class UERadioCapabilityForPaging extends Asn1OctetString {
   ...
   public UERadioCapabilityForPaging () {
      super();
   }
    ...
    *              in binary form.
    */
   public UERadioCapabilityForPaging (byte[] data) {
      super (data);
   }
    ...
    */
   public UERadioCapabilityForPaging (byte[] data, int offset, int nbytes) {
    ...
    */
   public UERadioCapabilityForPaging (String value_) throws Asn1ValueParseException {
      super (value_);
   }
