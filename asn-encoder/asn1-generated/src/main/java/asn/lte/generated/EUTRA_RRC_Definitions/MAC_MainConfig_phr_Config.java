...
public class MAC_MainConfig_phr_Config extends Asn1Choice {
   ...
   public MAC_MainConfig_phr_Config () {
      super();
   }

   public MAC_MainConfig_phr_Config (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (MAC_MainConfig_phr_Config_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            MAC_MainConfig_phr_Config_setup setup;
            element = setup = new MAC_MainConfig_phr_Config_setup();
            setup.decode (buffer);
            break;
         }
