...
public class UEContextModificationResponse_protocolIEs_element extends Asn1Seq {
   ...
   public UEContextModificationResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UEContextModificationResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.UEContextModificationResponseIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.UEContextModificationResponseIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.UEContextModificationResponseIEs[i];
            break;
         }
      }
      if (null == _index) {
