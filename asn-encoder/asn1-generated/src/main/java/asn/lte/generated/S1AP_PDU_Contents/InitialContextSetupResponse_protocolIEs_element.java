...
public class InitialContextSetupResponse_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABSetupListCtxtSURes
    * Java type: E_RABSetupListCtxtSURes
    *
   ...
   public InitialContextSetupResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public InitialContextSetupResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABSetupListCtxtSURes
    */
   public void setUsing_id_E_RABSetupListCtxtSURes(E_RABSetupListCtxtSURes value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABSetupListCtxtSURes);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-E-RABFailedToSetupListCtxtSURes
    */
   public void setUsing_id_E_RABFailedToSetupListCtxtSURes(asn.lte.generated.S1AP_IEs.E_RABList value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABFailedToSetupListCtxtSURes);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABSetupListCtxtSURes
    */
   public E_RABSetupListCtxtSURes getValueFor_id_E_RABSetupListCtxtSURes() {
      return (E_RABSetupListCtxtSURes) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABFailedToSetupListCtxtSURes
    */
   public asn.lte.generated.S1AP_IEs.E_RABList getValueFor_id_E_RABFailedToSetupListCtxtSURes() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.InitialContextSetupResponseIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.InitialContextSetupResponseIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.InitialContextSetupResponseIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABSetupListCtxtSURes\n");
      }
      else if (id.value == 48) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABFailedToSetupListCtxtSURes\n");
      }
      else if (id.value == 58) {
         indent (_sb, _level+1);
