...
public class NAS_PDU extends Asn1OctetString {
    ...
    */
   public NAS_PDU (byte[] data, int offset, int nbytes) {
    ...
    */
   public NAS_PDU (String value_) throws Asn1ValueParseException {
      super (value_);
   }
