...
public class HandoverPreparationFailure_protocolIEs_element extends Asn1Seq {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.HandoverPreparationFailureIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.HandoverPreparationFailureIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.HandoverPreparationFailureIEs[i];
            break;
         }
      }
      if (null == _index) {
