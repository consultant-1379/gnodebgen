...
public class BandCombinationParameters_v1430_bandParameterList_v1430 extends Asn1SeqOf {
   ...
   public BandParameters_v1430[] elements;

   public BandCombinationParameters_v1430_bandParameterList_v1430 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_v1430_bandParameterList_v1430 (int numRecords) {
      elements = new BandParameters_v1430 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_v1430_bandParameterList_v1430 (BandParameters_v1430[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_v1430 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_v1430();
