...
public class NR_CGI_iE_Extensions extends Asn1SeqOf {
   ...
   public NR_CGI_iE_Extensions_element[] elements;

   public NR_CGI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public NR_CGI_iE_Extensions (int numRecords) {
      elements = new NR_CGI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public NR_CGI_iE_Extensions (NR_CGI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NR_CGI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NR_CGI_iE_Extensions_element();
