...
public class SourceNgRanNode_ToTargetNgRanNode_TransparentContainer extends Asn1OctetString {
   ...
   public SourceNgRanNode_ToTargetNgRanNode_TransparentContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public SourceNgRanNode_ToTargetNgRanNode_TransparentContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public SourceNgRanNode_ToTargetNgRanNode_TransparentContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public SourceNgRanNode_ToTargetNgRanNode_TransparentContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
