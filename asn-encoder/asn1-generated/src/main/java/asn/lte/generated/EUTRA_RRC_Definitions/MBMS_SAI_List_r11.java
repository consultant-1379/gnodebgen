...
public class MBMS_SAI_List_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MBMS-SAI-List-r11";
   }

   public MBMS_SAI_r11[] elements;

   public MBMS_SAI_List_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMS_SAI_List_r11 (int numRecords) {
      elements = new MBMS_SAI_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMS_SAI_List_r11 (MBMS_SAI_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMS_SAI_r11 [numElements];
