...
public class SNStatusTransfer_protocolIEs extends Asn1SeqOf {
   ...
   public SNStatusTransfer_protocolIEs_element[] elements;

   public SNStatusTransfer_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SNStatusTransfer_protocolIEs (int numRecords) {
      elements = new SNStatusTransfer_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SNStatusTransfer_protocolIEs (SNStatusTransfer_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SNStatusTransfer_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SNStatusTransfer_protocolIEs_element();
