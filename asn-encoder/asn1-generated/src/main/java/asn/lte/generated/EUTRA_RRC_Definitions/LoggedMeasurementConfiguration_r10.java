...
public class LoggedMeasurementConfiguration_r10 extends Asn1Seq {
   ...
   public LoggedMeasurementConfiguration_r10_criticalExtensions criticalExtensions;

   public LoggedMeasurementConfiguration_r10 () {
      super();
      init();
   }
    ...
    */
   public LoggedMeasurementConfiguration_r10 (
      LoggedMeasurementConfiguration_r10_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new LoggedMeasurementConfiguration_r10_criticalExtensions();
