...
public class MeasDS_Config_r12 extends Asn1Choice {
   ...
   public MeasDS_Config_r12 () {
      super();
   }

   public MeasDS_Config_r12 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (MeasDS_Config_r12_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            MeasDS_Config_r12_setup setup;
            element = setup = new MeasDS_Config_r12_setup();
            setup.decode (buffer);
            break;
         }
