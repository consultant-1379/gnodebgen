...
public class PosSchedulingInfoList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PosSchedulingInfoList-r15";
   }

   public PosSchedulingInfo_r15[] elements;

   public PosSchedulingInfoList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PosSchedulingInfoList_r15 (int numRecords) {
      elements = new PosSchedulingInfo_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public PosSchedulingInfoList_r15 (PosSchedulingInfo_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PosSchedulingInfo_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PosSchedulingInfo_r15();
