...
public class ServedEUTRAcellsENDCX2ManagementList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServedEUTRAcellsENDCX2ManagementList";
   }

   public ServedEUTRAcellsENDCX2ManagementList_element[] elements;

   public ServedEUTRAcellsENDCX2ManagementList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedEUTRAcellsENDCX2ManagementList (int numRecords) {
      elements = new ServedEUTRAcellsENDCX2ManagementList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedEUTRAcellsENDCX2ManagementList (ServedEUTRAcellsENDCX2ManagementList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedEUTRAcellsENDCX2ManagementList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedEUTRAcellsENDCX2ManagementList_element();
