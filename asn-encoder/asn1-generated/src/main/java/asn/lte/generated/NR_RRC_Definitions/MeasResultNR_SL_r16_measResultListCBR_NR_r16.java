...
public class MeasResultNR_SL_r16_measResultListCBR_NR_r16 extends Asn1SeqOf {
   ...
   public MeasResultCBR_NR_r16[] elements;

   public MeasResultNR_SL_r16_measResultListCBR_NR_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultNR_SL_r16_measResultListCBR_NR_r16 (int numRecords) {
      elements = new MeasResultCBR_NR_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultNR_SL_r16_measResultListCBR_NR_r16 (MeasResultCBR_NR_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultCBR_NR_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultCBR_NR_r16();
