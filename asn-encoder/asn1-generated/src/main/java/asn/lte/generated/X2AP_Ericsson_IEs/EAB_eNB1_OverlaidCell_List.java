...
public class EAB_eNB1_OverlaidCell_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-eNB1-OverlaidCell-List";
   }

   public EAB_eNB1_OverlaidCell_Item[] elements;

   public EAB_eNB1_OverlaidCell_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_eNB1_OverlaidCell_List (int numRecords) {
      elements = new EAB_eNB1_OverlaidCell_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_eNB1_OverlaidCell_List (EAB_eNB1_OverlaidCell_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_eNB1_OverlaidCell_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_eNB1_OverlaidCell_Item();
