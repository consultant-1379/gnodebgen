...
public class E_RABSetupListBearerSURes_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABSetupItemBearerSURes
    * Java type: E_RABSetupItemBearerSURes
    */
   public Asn1Type value;

   public E_RABSetupListBearerSURes_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABSetupListBearerSURes_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABSetupItemBearerSURes
    */
   public void setUsing_id_E_RABSetupItemBearerSURes(E_RABSetupItemBearerSURes value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABSetupItemBearerSURes);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABSetupItemBearerSURes
    */
   public E_RABSetupItemBearerSURes getValueFor_id_E_RABSetupItemBearerSURes() {
      return (E_RABSetupItemBearerSURes) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABSetupItemBearerSUResIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABSetupItemBearerSUResIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABSetupItemBearerSUResIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 39) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABSetupItemBearerSURes\n");
      }
