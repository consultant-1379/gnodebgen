...
public class QuantityConfigNRList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "QuantityConfigNRList-r15";
   }

   public QuantityConfigNR_r15[] elements;

   public QuantityConfigNRList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public QuantityConfigNRList_r15 (int numRecords) {
      elements = new QuantityConfigNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public QuantityConfigNRList_r15 (QuantityConfigNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new QuantityConfigNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new QuantityConfigNR_r15();
