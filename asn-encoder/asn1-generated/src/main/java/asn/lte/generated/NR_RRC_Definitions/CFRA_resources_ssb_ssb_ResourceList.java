...
public class CFRA_resources_ssb_ssb_ResourceList extends Asn1SeqOf {
   ...
   public CFRA_resources_ssb_ssb_ResourceList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CFRA_resources_ssb_ssb_ResourceList (int numRecords) {
    ...
    * given the array.  
    */
   public CFRA_resources_ssb_ssb_ResourceList (CFRA_SSB_Resource[] elements_) {
      elements = elements_;
   }
