...
public class SecurityConfigHO_v1530_handoverType_v1530_intra5GC_r15 extends Asn1Seq {
   ...
   public SecurityAlgorithmConfig securityAlgorithmConfig_r15;  // optional
   public Asn1Boolean keyChangeIndicator_r15;
   public NextHopChainingCount nextHopChainingCount_r15;
   public Asn1OctetString nas_Container_r15;  // optional

   public SecurityConfigHO_v1530_handoverType_v1530_intra5GC_r15 () {
      super();
      init();
   }
   ...
   public SecurityConfigHO_v1530_handoverType_v1530_intra5GC_r15 (
      ...
      Asn1Boolean keyChangeIndicator_r15_,
      ...
      keyChangeIndicator_r15 = keyChangeIndicator_r15_;
    ...
    * the given objects 
    */
   public SecurityConfigHO_v1530_handoverType_v1530_intra5GC_r15 (SecurityAlgorithmConfig securityAlgorithmConfig_r15_,
      boolean keyChangeIndicator_r15_,
      long nextHopChainingCount_r15_,
      byte[] nas_Container_r15_
   ) {
      super();
      securityAlgorithmConfig_r15 = securityAlgorithmConfig_r15_;
      keyChangeIndicator_r15 = new Asn1Boolean (keyChangeIndicator_r15_);
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 1: return keyChangeIndicator_r15;
         case 2: return nextHopChainingCount_r15;
         case 3: return nas_Container_r15;
         default: return null;
      }
   }
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 1: return "keyChangeIndicator-r15";
         case 2: return "nextHopChainingCount-r15";
         case 3: return "nas-Container-r15";
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      boolean securityAlgorithmConfig_r15Present = buffer.decodeBit ("securityAlgorithmConfig_r15Present");
      boolean nas_Container_r15Present = buffer.decodeBit ("nas_Container_r15Present");

      // decode securityAlgorithmConfig_r15

      if (securityAlgorithmConfig_r15Present) {
      ...
      // decode keyChangeIndicator_r15

      buffer.getContext().eventDispatcher.startElement("keyChangeIndicator_r15", -1);

      keyChangeIndicator_r15 = new Asn1Boolean();
      keyChangeIndicator_r15.decode (buffer);

      buffer.invokeCharacters(keyChangeIndicator_r15.toString());
      buffer.getContext().eventDispatcher.endElement("keyChangeIndicator_r15", -1);
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (keyChangeIndicator_r15 != null) keyChangeIndicator_r15.print (_sb, "keyChangeIndicator_r15", _level+1);
