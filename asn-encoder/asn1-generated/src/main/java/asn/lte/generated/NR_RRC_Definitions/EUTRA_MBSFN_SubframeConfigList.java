...
public class EUTRA_MBSFN_SubframeConfigList extends Asn1SeqOf {
   ...
   public EUTRA_MBSFN_SubframeConfig[] elements;

   public EUTRA_MBSFN_SubframeConfigList () {
      elements = null;
   }
    ...
    * populated.
    */
   public EUTRA_MBSFN_SubframeConfigList (int numRecords) {
      elements = new EUTRA_MBSFN_SubframeConfig [numRecords];
   }
    ...
    * given the array.  
    */
   public EUTRA_MBSFN_SubframeConfigList (EUTRA_MBSFN_SubframeConfig[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EUTRA_MBSFN_SubframeConfig [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EUTRA_MBSFN_SubframeConfig();
