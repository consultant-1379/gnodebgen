...
public class MCEConfigurationUpdateAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public MCEConfigurationUpdateAcknowledge_protocolIEs_element[] elements;

   public MCEConfigurationUpdateAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MCEConfigurationUpdateAcknowledge_protocolIEs (int numRecords) {
      elements = new MCEConfigurationUpdateAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MCEConfigurationUpdateAcknowledge_protocolIEs (MCEConfigurationUpdateAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MCEConfigurationUpdateAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MCEConfigurationUpdateAcknowledge_protocolIEs_element();
