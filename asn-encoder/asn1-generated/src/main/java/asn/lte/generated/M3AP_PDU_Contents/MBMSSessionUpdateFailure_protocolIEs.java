...
public class MBMSSessionUpdateFailure_protocolIEs extends Asn1SeqOf {
   ...
   public MBMSSessionUpdateFailure_protocolIEs_element[] elements;

   public MBMSSessionUpdateFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMSSessionUpdateFailure_protocolIEs (int numRecords) {
      elements = new MBMSSessionUpdateFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMSSessionUpdateFailure_protocolIEs (MBMSSessionUpdateFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMSSessionUpdateFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMSSessionUpdateFailure_protocolIEs_element();
