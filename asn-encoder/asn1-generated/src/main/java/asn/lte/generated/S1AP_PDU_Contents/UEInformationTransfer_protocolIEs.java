...
public class UEInformationTransfer_protocolIEs extends Asn1SeqOf {
   ...
   public UEInformationTransfer_protocolIEs_element[] elements;

   public UEInformationTransfer_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEInformationTransfer_protocolIEs (int numRecords) {
      elements = new UEInformationTransfer_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEInformationTransfer_protocolIEs (UEInformationTransfer_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEInformationTransfer_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEInformationTransfer_protocolIEs_element();
