...
public class OTDOACell_Information extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "OTDOACell-Information";
   }

   public OTDOACell_Information_Item[] elements;

   public OTDOACell_Information () {
      elements = null;
   }
    ...
    * populated.
    */
   public OTDOACell_Information (int numRecords) {
      elements = new OTDOACell_Information_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public OTDOACell_Information (OTDOACell_Information_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new OTDOACell_Information_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new OTDOACell_Information_Item();
