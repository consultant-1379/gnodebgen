...
public class E_RABToBeSwitchedDLList_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABToBeSwitchedDLItem
    * Java type: E_RABToBeSwitchedDLItem
    */
   public Asn1Type value;

   public E_RABToBeSwitchedDLList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABToBeSwitchedDLList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABToBeSwitchedDLItem
    */
   public void setUsing_id_E_RABToBeSwitchedDLItem(E_RABToBeSwitchedDLItem value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABToBeSwitchedDLItem);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABToBeSwitchedDLItem
    */
   public E_RABToBeSwitchedDLItem getValueFor_id_E_RABToBeSwitchedDLItem() {
      return (E_RABToBeSwitchedDLItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABToBeSwitchedDLItemIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABToBeSwitchedDLItemIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABToBeSwitchedDLItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 23) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABToBeSwitchedDLItem\n");
      }
