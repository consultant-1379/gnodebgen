...
public class UECapabilityEnquiry_v8a0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UECapabilityEnquiry-v8a0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public UECapabilityEnquiry_v1180_IEs nonCriticalExtension;  // optional

   public UECapabilityEnquiry_v8a0_IEs () {
      super();
      init();
   }
   ...
   public UECapabilityEnquiry_v8a0_IEs (
      ...
      UECapabilityEnquiry_v1180_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public UECapabilityEnquiry_v8a0_IEs (byte[] lateNonCriticalExtension_,
      UECapabilityEnquiry_v1180_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new UECapabilityEnquiry_v1180_IEs();
