...
public class MBMSServiceArea1 extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "MBMSServiceArea1";
   }

   public MBMSServiceArea1 () {
      super();
   }
    ...
    *              in binary form.
    */
   public MBMSServiceArea1 (byte[] data) {
      super (data);
   }
    ...
    */
   public MBMSServiceArea1 (byte[] data, int offset, int nbytes) {
    ...
    */
   public MBMSServiceArea1 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
