...
public class ENSA_E_RABs_ToBeAdded_SgNBAddReqList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ENSA-E-RABs-ToBeAdded-SgNBAddReqList";
   }

   public ENSA_E_RABs_ToBeAdded_SgNBAddReqList_element[] elements;

   public ENSA_E_RABs_ToBeAdded_SgNBAddReqList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENSA_E_RABs_ToBeAdded_SgNBAddReqList (int numRecords) {
      elements = new ENSA_E_RABs_ToBeAdded_SgNBAddReqList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENSA_E_RABs_ToBeAdded_SgNBAddReqList (ENSA_E_RABs_ToBeAdded_SgNBAddReqList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENSA_E_RABs_ToBeAdded_SgNBAddReqList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENSA_E_RABs_ToBeAdded_SgNBAddReqList_element();
