...
public class MeasResultList2GERAN_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultList2GERAN-r10";
   }

   public MeasResultListGERAN[] elements;

   public MeasResultList2GERAN_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultList2GERAN_r10 (int numRecords) {
      elements = new MeasResultListGERAN [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultList2GERAN_r10 (MeasResultListGERAN[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultListGERAN [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultListGERAN();
