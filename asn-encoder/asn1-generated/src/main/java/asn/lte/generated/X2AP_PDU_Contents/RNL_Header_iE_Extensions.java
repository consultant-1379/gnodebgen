...
public class RNL_Header_iE_Extensions extends Asn1SeqOf {
   ...
   public RNL_Header_iE_Extensions_element[] elements;

   public RNL_Header_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RNL_Header_iE_Extensions (int numRecords) {
      elements = new RNL_Header_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RNL_Header_iE_Extensions (RNL_Header_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RNL_Header_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RNL_Header_iE_Extensions_element();
