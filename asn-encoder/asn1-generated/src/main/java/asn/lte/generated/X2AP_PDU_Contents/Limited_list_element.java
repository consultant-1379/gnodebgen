...
public class Limited_list_element extends Asn1Seq {
   ...
   public Limited_list_element_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public Limited_list_element () {
      super();
      init();
   }
   ...
   public Limited_list_element (
      NRCGI nrCellID_,
      Limited_list_element_iE_Extensions iE_Extensions_
   ) {
      super();
      nrCellID = nrCellID_;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new Limited_list_element_iE_Extensions();
