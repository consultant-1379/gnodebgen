...
public class MME_Group_ID extends Asn1OctetString {
    ...
    */
   public MME_Group_ID (byte[] data, int offset, int nbytes) {
    ...
    */
   public MME_Group_ID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
