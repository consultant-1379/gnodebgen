...
public class CSI_RS_ConfigNZPToReleaseList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSI-RS-ConfigNZPToReleaseList-r15";
   }

   public CSI_RS_ConfigNZPId_r13[] elements;

   public CSI_RS_ConfigNZPToReleaseList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_RS_ConfigNZPToReleaseList_r15 (int numRecords) {
    ...
    * given the array.  
    */
   public CSI_RS_ConfigNZPToReleaseList_r15 (CSI_RS_ConfigNZPId_r13[] elements_) {
      elements = elements_;
   }
