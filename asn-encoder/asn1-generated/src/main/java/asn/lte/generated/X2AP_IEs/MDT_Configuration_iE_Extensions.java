...
public class MDT_Configuration_iE_Extensions extends Asn1SeqOf {
   ...
   public MDT_Configuration_iE_Extensions_element[] elements;

   public MDT_Configuration_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public MDT_Configuration_iE_Extensions (int numRecords) {
      elements = new MDT_Configuration_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MDT_Configuration_iE_Extensions (MDT_Configuration_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MDT_Configuration_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MDT_Configuration_iE_Extensions_element();
