...
public class ExpectedUEBehaviour_iE_Extensions extends Asn1SeqOf {
   ...
   public ExpectedUEBehaviour_iE_Extensions_element[] elements;

   public ExpectedUEBehaviour_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ExpectedUEBehaviour_iE_Extensions (int numRecords) {
      elements = new ExpectedUEBehaviour_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ExpectedUEBehaviour_iE_Extensions (ExpectedUEBehaviour_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ExpectedUEBehaviour_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ExpectedUEBehaviour_iE_Extensions_element();
