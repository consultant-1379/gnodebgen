...
public class DynamicNAICSInformation_pA_list extends Asn1SeqOf {
   ...
   public PA_Values[] elements;

   public DynamicNAICSInformation_pA_list () {
      elements = null;
   }
    ...
    * populated.
    */
   public DynamicNAICSInformation_pA_list (int numRecords) {
      elements = new PA_Values [numRecords];
   }
    ...
    * given the array.  
    */
   public DynamicNAICSInformation_pA_list (PA_Values[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (0, 3);
      int numElements = (int) buffer.decodeLength();

      elements = new PA_Values [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         {
            int tval = PA_Values.decodeEnumValue (buffer);
            elements[i] = PA_Values.valueOf (tval);
         }
