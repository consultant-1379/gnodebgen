...
public class TDD_InfoServedNRCell_Information_iE_Extensions extends Asn1SeqOf {
   ...
   public TDD_InfoServedNRCell_Information_iE_Extensions_element[] elements;

   public TDD_InfoServedNRCell_Information_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TDD_InfoServedNRCell_Information_iE_Extensions (int numRecords) {
      elements = new TDD_InfoServedNRCell_Information_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TDD_InfoServedNRCell_Information_iE_Extensions (TDD_InfoServedNRCell_Information_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TDD_InfoServedNRCell_Information_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TDD_InfoServedNRCell_Information_iE_Extensions_element();
