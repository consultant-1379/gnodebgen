...
public class CellInfoListUTRA_TDD_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellInfoListUTRA-TDD-r10";
   }

   public CellInfoUTRA_TDD_r10[] elements;

   public CellInfoListUTRA_TDD_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellInfoListUTRA_TDD_r10 (int numRecords) {
      elements = new CellInfoUTRA_TDD_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public CellInfoListUTRA_TDD_r10 (CellInfoUTRA_TDD_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellInfoUTRA_TDD_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellInfoUTRA_TDD_r10();
