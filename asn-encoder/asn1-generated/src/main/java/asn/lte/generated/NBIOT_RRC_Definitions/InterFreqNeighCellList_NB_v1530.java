...
public class InterFreqNeighCellList_NB_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqNeighCellList-NB-v1530";
   }

   public InterFreqNeighCellInfo_NB_v1530[] elements;

   public InterFreqNeighCellList_NB_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqNeighCellList_NB_v1530 (int numRecords) {
      elements = new InterFreqNeighCellInfo_NB_v1530 [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqNeighCellList_NB_v1530 (InterFreqNeighCellInfo_NB_v1530[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqNeighCellInfo_NB_v1530 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqNeighCellInfo_NB_v1530();
