...
public class MeasResultCellListSFTD_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultCellListSFTD-r15";
   }

   public MeasResultCellSFTD_r15[] elements;

   public MeasResultCellListSFTD_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultCellListSFTD_r15 (int numRecords) {
      elements = new MeasResultCellSFTD_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultCellListSFTD_r15 (MeasResultCellSFTD_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultCellSFTD_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultCellSFTD_r15();
