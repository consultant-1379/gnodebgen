...
public class UEInformationRequest_r9_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _UEINFORMATIONREQUEST_R9 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public UEInformationRequest_r9_criticalExtensions_c1 () {
      super();
   }

   public UEInformationRequest_r9_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_ueInformationRequest_r9 (UEInformationRequest_r9_IEs value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            element = ueInformationRequest_r9 = new UEInformationRequest_r9_IEs();
