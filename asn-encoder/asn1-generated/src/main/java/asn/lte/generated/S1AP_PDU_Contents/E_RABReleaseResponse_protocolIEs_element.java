...
public class E_RABReleaseResponse_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABReleaseListBearerRelComp
    * Java type: E_RABReleaseListBearerRelComp
    *
   ...
   public E_RABReleaseResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABReleaseResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABReleaseListBearerRelComp
    */
   public void setUsing_id_E_RABReleaseListBearerRelComp(E_RABReleaseListBearerRelComp value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABReleaseListBearerRelComp);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-E-RABFailedToReleaseList
    */
   public void setUsing_id_E_RABFailedToReleaseList(asn.lte.generated.S1AP_IEs.E_RABList value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABFailedToReleaseList);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABReleaseListBearerRelComp
    */
   public E_RABReleaseListBearerRelComp getValueFor_id_E_RABReleaseListBearerRelComp() {
      return (E_RABReleaseListBearerRelComp) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABFailedToReleaseList
    */
   public asn.lte.generated.S1AP_IEs.E_RABList getValueFor_id_E_RABFailedToReleaseList() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABReleaseResponseIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABReleaseResponseIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABReleaseResponseIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABReleaseListBearerRelComp\n");
      }
      else if (id.value == 34) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABFailedToReleaseList\n");
      }
      else if (id.value == 58) {
         indent (_sb, _level+1);
