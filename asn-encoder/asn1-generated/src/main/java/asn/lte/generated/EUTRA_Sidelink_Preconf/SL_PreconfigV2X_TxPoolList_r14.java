...
public class SL_PreconfigV2X_TxPoolList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-PreconfigV2X-TxPoolList-r14";
   }

   public SL_V2X_PreconfigCommPool_r14[] elements;

   public SL_PreconfigV2X_TxPoolList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_PreconfigV2X_TxPoolList_r14 (int numRecords) {
    ...
    * given the array.  
    */
   public SL_PreconfigV2X_TxPoolList_r14 (SL_V2X_PreconfigCommPool_r14[] elements_) {
      elements = elements_;
   }
