...
public class SONConfigurationTransfer_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: X2TNLConfigurationInfo
    * Java type: X2TNLConfigurationInfo
    *
    * id: id-Synchronisation-Information
    * criticality: Criticality.ignore
    * presence: Presence.conditional
    * ASN.1 type: SynchronisationInformation
    * Java type: SynchronisationInformation
    */
   public Asn1Type extensionValue;

   public SONConfigurationTransfer_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SONConfigurationTransfer_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-x2TNLConfigurationInfo
    */
   public void setUsing_id_x2TNLConfigurationInfo(X2TNLConfigurationInfo extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_x2TNLConfigurationInfo);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-Synchronisation-Information
    */
   public void setUsing_id_Synchronisation_Information(SynchronisationInformation extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_Synchronisation_Information);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-x2TNLConfigurationInfo
    */
   public X2TNLConfigurationInfo getExtensionValueFor_id_x2TNLConfigurationInfo() {
      return (X2TNLConfigurationInfo) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-Synchronisation-Information
    */
   public SynchronisationInformation getExtensionValueFor_id_Synchronisation_Information() {
      return (SynchronisationInformation) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.SONConfigurationTransfer_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.SONConfigurationTransfer_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.SONConfigurationTransfer_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 152) {
         indent (_sb, _level+1);
         _sb.append("id = id-x2TNLConfigurationInfo\n");
      }
      else if (id.value == 209) {
         indent (_sb, _level+1);
         _sb.append("id = id-Synchronisation-Information\n");
      }
