...
public class E_RABModificationConfirm_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABModifyListBearerModConf
    * Java type: E_RABModifyListBearerModConf
    *
   ...
   public E_RABModificationConfirm_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABModificationConfirm_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABModifyListBearerModConf
    */
   public void setUsing_id_E_RABModifyListBearerModConf(E_RABModifyListBearerModConf value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABModifyListBearerModConf);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-E-RABFailedToModifyListBearerModConf
    */
   public void setUsing_id_E_RABFailedToModifyListBearerModConf(asn.lte.generated.S1AP_IEs.E_RABList value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABFailedToModifyListBearerModConf);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-E-RABToBeReleasedListBearerModConf
    */
   public void setUsing_id_E_RABToBeReleasedListBearerModConf(asn.lte.generated.S1AP_IEs.E_RABList value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABToBeReleasedListBearerModConf);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABModifyListBearerModConf
    */
   public E_RABModifyListBearerModConf getValueFor_id_E_RABModifyListBearerModConf() {
      return (E_RABModifyListBearerModConf) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABFailedToModifyListBearerModConf
    */
   public asn.lte.generated.S1AP_IEs.E_RABList getValueFor_id_E_RABFailedToModifyListBearerModConf() {
      return (asn.lte.generated.S1AP_IEs.E_RABList) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABToBeReleasedListBearerModConf
    */
   public asn.lte.generated.S1AP_IEs.E_RABList getValueFor_id_E_RABToBeReleasedListBearerModConf() {
      return (asn.lte.generated.S1AP_IEs.E_RABList) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABModificationConfirmIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABModificationConfirmIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABModificationConfirmIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABModifyListBearerModConf\n");
      }
      else if (id.value == 205) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABFailedToModifyListBearerModConf\n");
      }
      else if (id.value == 210) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABToBeReleasedListBearerModConf\n");
      }
      else if (id.value == 58) {
         indent (_sb, _level+1);
