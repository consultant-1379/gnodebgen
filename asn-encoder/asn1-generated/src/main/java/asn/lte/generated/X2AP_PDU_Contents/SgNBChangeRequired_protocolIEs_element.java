...
public class SgNBChangeRequired_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-SgNBChangeRequired-ExtConveyor
    * Java type: EAB_SgNBChangeRequired_ExtConveyor
    */
   public Asn1Type value;

   public SgNBChangeRequired_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBChangeRequired_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-Target-SgNB-ID
    */
   public void setUsing_id_Target_SgNB_ID(asn.lte.generated.X2AP_IEs.GlobalGNB_ID value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_Target_SgNB_ID);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBChangeRequired_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-Target-SgNB-ID
    */
   public asn.lte.generated.X2AP_IEs.GlobalGNB_ID getValueFor_id_Target_SgNB_ID() {
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBChangeRequired_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBChangeRequired_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SgNBChangeRequired_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SgNBChangeRequired_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SgNBChangeRequired_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-Target-SgNB-ID\n");
      }
      else if (id.value == 5) {
         indent (_sb, _level+1);
