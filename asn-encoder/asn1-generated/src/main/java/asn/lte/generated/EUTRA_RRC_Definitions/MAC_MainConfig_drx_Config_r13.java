...
public class MAC_MainConfig_drx_Config_r13 extends Asn1Choice {
   ...
   public MAC_MainConfig_drx_Config_r13 () {
      super();
   }

   public MAC_MainConfig_drx_Config_r13 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (DRX_Config_r13 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 1: { 
            ...
            element = setup = new DRX_Config_r13();
            setup.decode (buffer);
            break;
         }
