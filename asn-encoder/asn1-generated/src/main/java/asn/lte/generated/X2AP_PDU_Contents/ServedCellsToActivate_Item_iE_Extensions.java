...
public class ServedCellsToActivate_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public ServedCellsToActivate_Item_iE_Extensions_element[] elements;

   public ServedCellsToActivate_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedCellsToActivate_Item_iE_Extensions (int numRecords) {
      elements = new ServedCellsToActivate_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedCellsToActivate_Item_iE_Extensions (ServedCellsToActivate_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedCellsToActivate_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedCellsToActivate_Item_iE_Extensions_element();
