...
public class RerouteNASRequest_protocolIEs extends Asn1SeqOf {
   ...
   public RerouteNASRequest_protocolIEs_element[] elements;

   public RerouteNASRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public RerouteNASRequest_protocolIEs (int numRecords) {
      elements = new RerouteNASRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RerouteNASRequest_protocolIEs (RerouteNASRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RerouteNASRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RerouteNASRequest_protocolIEs_element();
