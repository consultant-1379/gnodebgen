...
public class EAB_UEContextFetchResponseAccept_protocolIEs_element extends Asn1Seq {
    ...
    * Java type: UE_X2AP_ID
    *
    * id: eid-E-RAB-Admitted-List
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: EAB-E-RAB-Admitted-List
    * Java type: EAB_E_RAB_Admitted_List
    *
    * id: eid-E-RAB-NotAdmitted-List
    * criticality: Criticality.ignore
   ...
   public EAB_UEContextFetchResponseAccept_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_UEContextFetchResponseAccept_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-E-RAB-Admitted-List
    */
   public void setUsing_eid_E_RAB_Admitted_List(asn.lte.generated.X2AP_Ericsson_IEs.EAB_E_RAB_Admitted_List value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_E_RAB_Admitted_List);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key eid-E-RAB-NotAdmitted-List
    */
   public void setUsing_eid_E_RAB_NotAdmitted_List(asn.lte.generated.X2AP_IEs.E_RAB_List value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_E_RAB_NotAdmitted_List);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
    ...
    */
   public void setUsing_eid_PPEReuse(asn.lte.generated.X2AP_Ericsson_IEs.EAB_PPEReuse value) {
   ...
   /**
    * Get value of value with type set according to information object having key eid-E-RAB-Admitted-List
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_E_RAB_Admitted_List getValueFor_eid_E_RAB_Admitted_List() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_E_RAB_Admitted_List) this.value;
   }

   /**
    * Get value of value with type set according to information object having key eid-E-RAB-NotAdmitted-List
    */
   public asn.lte.generated.X2AP_IEs.E_RAB_List getValueFor_eid_E_RAB_NotAdmitted_List() {
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_PPEReuse getValueFor_eid_PPEReuse() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_PPEReuse) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_PDU_ContentsValues.EAB_UEContextFetchResponseAccept_IEs.length; i++) {
         if(_X2AP_Ericsson_PDU_ContentsValues.EAB_UEContextFetchResponseAccept_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_PDU_ContentsValues.EAB_UEContextFetchResponseAccept_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 31) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = eid-E-RAB-Admitted-List\n");
      }
      else if (id.value == 23) {
         indent (_sb, _level+1);
         _sb.append("id = eid-E-RAB-NotAdmitted-List\n");
      }
