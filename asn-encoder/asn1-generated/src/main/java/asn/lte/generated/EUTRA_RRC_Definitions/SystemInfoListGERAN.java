...
public class SystemInfoListGERAN extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SystemInfoListGERAN";
   }

   public Asn1OctetString[] elements;

   public SystemInfoListGERAN () {
      elements = null;
   }
    ...
    * populated.
    */
   public SystemInfoListGERAN (int numRecords) {
    ...
    * given the array.  
    */
   public SystemInfoListGERAN (Asn1OctetString[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Asn1OctetString [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Asn1OctetString();
         elements[i].decode (buffer, 1, 23);
