...
public class RecommendedENBItem_iE_Extensions extends Asn1SeqOf {
   ...
   public RecommendedENBItem_iE_Extensions_element[] elements;

   public RecommendedENBItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RecommendedENBItem_iE_Extensions (int numRecords) {
      elements = new RecommendedENBItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RecommendedENBItem_iE_Extensions (RecommendedENBItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RecommendedENBItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RecommendedENBItem_iE_Extensions_element();
