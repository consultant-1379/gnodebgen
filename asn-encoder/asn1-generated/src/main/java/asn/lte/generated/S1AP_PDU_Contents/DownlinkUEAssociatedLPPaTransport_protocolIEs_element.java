...
public class DownlinkUEAssociatedLPPaTransport_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: Routing-ID
    * Java type: Routing_ID
    *
    * id: id-LPPa-PDU
    * criticality: Criticality.reject
    * presence: Presence.mandatory
   ...
   public DownlinkUEAssociatedLPPaTransport_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public DownlinkUEAssociatedLPPaTransport_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-Routing-ID
    */
   public void setUsing_id_Routing_ID(asn.lte.generated.S1AP_IEs.Routing_ID value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_Routing_ID);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-LPPa-PDU
    */
   public void setUsing_id_LPPa_PDU(asn.lte.generated.S1AP_IEs.LPPa_PDU value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_LPPa_PDU);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-Routing-ID
    */
   public asn.lte.generated.S1AP_IEs.Routing_ID getValueFor_id_Routing_ID() {
      return (asn.lte.generated.S1AP_IEs.Routing_ID) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-LPPa-PDU
    */
   public asn.lte.generated.S1AP_IEs.LPPa_PDU getValueFor_id_LPPa_PDU() {
      return (asn.lte.generated.S1AP_IEs.LPPa_PDU) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.DownlinkUEAssociatedLPPaTransport_IEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.DownlinkUEAssociatedLPPaTransport_IEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.DownlinkUEAssociatedLPPaTransport_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 148) {
         indent (_sb, _level+1);
         _sb.append("id = id-Routing-ID\n");
      }
      else if (id.value == 147) {
         indent (_sb, _level+1);
         _sb.append("id = id-LPPa-PDU\n");
      }
