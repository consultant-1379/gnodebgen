...
public class Source_ToTarget_TransparentContainer extends Asn1OctetString {
   ...
   public Source_ToTarget_TransparentContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public Source_ToTarget_TransparentContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public Source_ToTarget_TransparentContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public Source_ToTarget_TransparentContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
