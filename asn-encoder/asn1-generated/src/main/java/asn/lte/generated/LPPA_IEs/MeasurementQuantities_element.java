...
public class MeasurementQuantities_element extends Asn1Seq {
   ...
   /**
    * id: id-MeasurementQuantities-Item
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: MeasurementQuantities-Item
    * Java type: MeasurementQuantities_Item
    */
   public Asn1Type value;

   public MeasurementQuantities_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MeasurementQuantities_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-MeasurementQuantities-Item
    */
   public void setUsing_id_MeasurementQuantities_Item(MeasurementQuantities_Item value) {
      this.id = new asn.lte.generated.LPPA_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.LPPA_Constants._LPPA_ConstantsValues.id_MeasurementQuantities_Item);
      this.criticality = asn.lte.generated.LPPA_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-MeasurementQuantities-Item
    */
   public MeasurementQuantities_Item getValueFor_id_MeasurementQuantities_Item() {
      return (MeasurementQuantities_Item) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _LPPA_IEsValues.MeasurementQuantities_ItemIEs.length; i++) {
         if(_LPPA_IEsValues.MeasurementQuantities_ItemIEs[i].id.equals(id)) {
            _index = _LPPA_IEsValues.MeasurementQuantities_ItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 11) {
         indent (_sb, _level+1);
         _sb.append("id = id-MeasurementQuantities-Item\n");
      }
