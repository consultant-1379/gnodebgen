...
public class UE_EUTRA_Capability_v11x0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UE-EUTRA-Capability-v11x0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public UE_EUTRA_Capability_v12b0_IEs nonCriticalExtension;  // optional

   public UE_EUTRA_Capability_v11x0_IEs () {
      super();
      init();
   }
   ...
   public UE_EUTRA_Capability_v11x0_IEs (
      ...
      UE_EUTRA_Capability_v12b0_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public UE_EUTRA_Capability_v11x0_IEs (byte[] lateNonCriticalExtension_,
      UE_EUTRA_Capability_v12b0_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new UE_EUTRA_Capability_v12b0_IEs();
