...
public class PropertyValue extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public PropertyValue (byte[] data) {
      super (data);
   }
    ...
    */
   public PropertyValue (byte[] data, int offset, int nbytes) {
    ...
    */
   public PropertyValue (String value_) throws Asn1ValueParseException {
      super (value_);
   }
