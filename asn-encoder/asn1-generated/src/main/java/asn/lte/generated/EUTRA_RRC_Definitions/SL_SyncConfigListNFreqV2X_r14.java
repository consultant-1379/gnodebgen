...
public class SL_SyncConfigListNFreqV2X_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-SyncConfigListNFreqV2X-r14";
   }

   public SL_SyncConfigNFreq_r13[] elements;

   public SL_SyncConfigListNFreqV2X_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_SyncConfigListNFreqV2X_r14 (int numRecords) {
      elements = new SL_SyncConfigNFreq_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_SyncConfigListNFreqV2X_r14 (SL_SyncConfigNFreq_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_SyncConfigNFreq_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_SyncConfigNFreq_r13();
