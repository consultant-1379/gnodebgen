...
public class ENDCX2SetupRequest_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-InitiatingNodeType-EndcX2Setup
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: InitiatingNodeType-EndcX2Setup
    * Java type: InitiatingNodeType_EndcX2Setup
    *
    * id: id-Ericsson-ExtConveyor
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-ENDCX2SetupRequest-ExtConveyor
    * Java type: EAB_ENDCX2SetupRequest_ExtConveyor
    */
   public Asn1Type value;

   public ENDCX2SetupRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCX2SetupRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-InitiatingNodeType-EndcX2Setup
    */
   public void setUsing_id_InitiatingNodeType_EndcX2Setup(InitiatingNodeType_EndcX2Setup value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_InitiatingNodeType_EndcX2Setup);
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_ENDCX2SetupRequest_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-InitiatingNodeType-EndcX2Setup
    */
   public InitiatingNodeType_EndcX2Setup getValueFor_id_InitiatingNodeType_EndcX2Setup() {
      return (InitiatingNodeType_EndcX2Setup) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-Ericsson-ExtConveyor
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_ENDCX2SetupRequest_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_ENDCX2SetupRequest_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCX2SetupRequest_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCX2SetupRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCX2SetupRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 244) {
         indent (_sb, _level+1);
         _sb.append("id = id-InitiatingNodeType-EndcX2Setup\n");
      }
