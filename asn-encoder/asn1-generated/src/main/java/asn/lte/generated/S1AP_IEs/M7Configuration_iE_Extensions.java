...
public class M7Configuration_iE_Extensions extends Asn1SeqOf {
   ...
   public M7Configuration_iE_Extensions_element[] elements;

   public M7Configuration_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public M7Configuration_iE_Extensions (int numRecords) {
      elements = new M7Configuration_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public M7Configuration_iE_Extensions (M7Configuration_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new M7Configuration_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new M7Configuration_iE_Extensions_element();
