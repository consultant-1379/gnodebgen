...
public class InterFreqNeighCellList_v1610 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqNeighCellList-v1610";
   }

   public InterFreqNeighCellInfo_v1610[] elements;

   public InterFreqNeighCellList_v1610 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqNeighCellList_v1610 (int numRecords) {
      elements = new InterFreqNeighCellInfo_v1610 [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqNeighCellList_v1610 (InterFreqNeighCellInfo_v1610[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqNeighCellInfo_v1610 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqNeighCellInfo_v1610();
