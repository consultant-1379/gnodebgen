...
public class EAB_ErrorIndication extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "EAB-ErrorIndication";
   }

   public EAB_ErrorIndication_protocolIEs protocolIEs;
   public Asn1OpenExt extElem1;

   public EAB_ErrorIndication () {
      super();
      init();
   }
    ...
    */
   public EAB_ErrorIndication (
      EAB_ErrorIndication_protocolIEs protocolIEs_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      protocolIEs = new EAB_ErrorIndication_protocolIEs();
