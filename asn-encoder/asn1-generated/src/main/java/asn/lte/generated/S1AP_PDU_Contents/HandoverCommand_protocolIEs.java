...
public class HandoverCommand_protocolIEs extends Asn1SeqOf {
   ...
   public HandoverCommand_protocolIEs_element[] elements;

   public HandoverCommand_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public HandoverCommand_protocolIEs (int numRecords) {
      elements = new HandoverCommand_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public HandoverCommand_protocolIEs (HandoverCommand_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HandoverCommand_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new HandoverCommand_protocolIEs_element();
