...
public class CNTypeRestrictions extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CNTypeRestrictions";
   }

   public CNTypeRestrictions_Item[] elements;

   public CNTypeRestrictions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CNTypeRestrictions (int numRecords) {
      elements = new CNTypeRestrictions_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public CNTypeRestrictions (CNTypeRestrictions_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CNTypeRestrictions_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CNTypeRestrictions_Item();
