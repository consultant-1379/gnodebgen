...
public class SupportedBandListNR_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandListNR-r15";
   }

   public SupportedBandNR_r15[] elements;

   public SupportedBandListNR_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandListNR_r15 (int numRecords) {
      elements = new SupportedBandNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandListNR_r15 (SupportedBandNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBandNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedBandNR_r15();
