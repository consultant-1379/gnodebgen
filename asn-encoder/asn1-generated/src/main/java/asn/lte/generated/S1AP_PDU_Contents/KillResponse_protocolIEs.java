...
public class KillResponse_protocolIEs extends Asn1SeqOf {
   ...
   public KillResponse_protocolIEs_element[] elements;

   public KillResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public KillResponse_protocolIEs (int numRecords) {
      elements = new KillResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public KillResponse_protocolIEs (KillResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new KillResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new KillResponse_protocolIEs_element();
