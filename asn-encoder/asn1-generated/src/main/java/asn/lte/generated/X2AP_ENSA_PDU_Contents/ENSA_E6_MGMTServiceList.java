...
public class ENSA_E6_MGMTServiceList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ENSA-E6-MGMTServiceList";
   }

   public ENSA_E6_MGMTService_Item[] elements;

   public ENSA_E6_MGMTServiceList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENSA_E6_MGMTServiceList (int numRecords) {
      elements = new ENSA_E6_MGMTService_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ENSA_E6_MGMTServiceList (ENSA_E6_MGMTService_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENSA_E6_MGMTService_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENSA_E6_MGMTService_Item();
