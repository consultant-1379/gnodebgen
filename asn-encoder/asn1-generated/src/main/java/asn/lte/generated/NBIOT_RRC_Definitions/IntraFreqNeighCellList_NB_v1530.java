...
public class IntraFreqNeighCellList_NB_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "IntraFreqNeighCellList-NB-v1530";
   }

   public IntraFreqNeighCellInfo_NB_v1530[] elements;

   public IntraFreqNeighCellList_NB_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public IntraFreqNeighCellList_NB_v1530 (int numRecords) {
      elements = new IntraFreqNeighCellInfo_NB_v1530 [numRecords];
   }
    ...
    * given the array.  
    */
   public IntraFreqNeighCellList_NB_v1530 (IntraFreqNeighCellInfo_NB_v1530[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new IntraFreqNeighCellInfo_NB_v1530 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new IntraFreqNeighCellInfo_NB_v1530();
