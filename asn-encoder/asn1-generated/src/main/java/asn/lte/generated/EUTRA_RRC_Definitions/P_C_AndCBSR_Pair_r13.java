...
public class P_C_AndCBSR_Pair_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "P-C-AndCBSR-Pair-r13";
   }

   public P_C_AndCBSR_r13[] elements;

   public P_C_AndCBSR_Pair_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public P_C_AndCBSR_Pair_r13 (int numRecords) {
      elements = new P_C_AndCBSR_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public P_C_AndCBSR_Pair_r13 (P_C_AndCBSR_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new P_C_AndCBSR_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new P_C_AndCBSR_r13();
