...
public class E_RABToBeModifiedListBearerModInd extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABToBeModifiedListBearerModInd";
   }

   public E_RABToBeModifiedListBearerModInd_element[] elements;

   public E_RABToBeModifiedListBearerModInd () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABToBeModifiedListBearerModInd (int numRecords) {
      elements = new E_RABToBeModifiedListBearerModInd_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABToBeModifiedListBearerModInd (E_RABToBeModifiedListBearerModInd_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABToBeModifiedListBearerModInd_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABToBeModifiedListBearerModInd_element();
