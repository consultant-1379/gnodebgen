...
public class SupportedBandListEUTRA_v9e0 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandListEUTRA-v9e0";
   }

   public SupportedBandEUTRA_v9e0[] elements;

   public SupportedBandListEUTRA_v9e0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandListEUTRA_v9e0 (int numRecords) {
      elements = new SupportedBandEUTRA_v9e0 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandListEUTRA_v9e0 (SupportedBandEUTRA_v9e0[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBandEUTRA_v9e0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedBandEUTRA_v9e0();
