...
public class PLMN_InfoList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PLMN-InfoList-r15";
   }

   public PLMN_Info_r15[] elements;

   public PLMN_InfoList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_InfoList_r15 (int numRecords) {
      elements = new PLMN_Info_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMN_InfoList_r15 (PLMN_Info_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PLMN_Info_r15 [numElements];
