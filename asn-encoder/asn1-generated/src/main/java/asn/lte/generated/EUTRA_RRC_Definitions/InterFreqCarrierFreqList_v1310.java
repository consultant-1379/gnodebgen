...
public class InterFreqCarrierFreqList_v1310 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqList-v1310";
   }

   public InterFreqCarrierFreqInfo_v1310[] elements;

   public InterFreqCarrierFreqList_v1310 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqList_v1310 (int numRecords) {
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqList_v1310 (InterFreqCarrierFreqInfo_v1310[] elements_) {
      elements = elements_;
   }
