...
public class SeNBCounterCheckRequest_protocolIEs_element extends Asn1Seq {
    ...
    * Java type: UE_X2AP_ID
    *
    * id: id-E-RABs-SubjectToCounterCheck-List
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABs-SubjectToCounterCheck-List
    * Java type: E_RABs_SubjectToCounterCheck_List
    *
   ...
   public SeNBCounterCheckRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SeNBCounterCheckRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-SubjectToCounterCheck-List
    */
   public void setUsing_id_E_RABs_SubjectToCounterCheck_List(E_RABs_SubjectToCounterCheck_List value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_SubjectToCounterCheck_List);
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-SubjectToCounterCheck-List
    */
   public E_RABs_SubjectToCounterCheck_List getValueFor_id_E_RABs_SubjectToCounterCheck_List() {
      return (E_RABs_SubjectToCounterCheck_List) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SeNBCounterCheckRequest_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SeNBCounterCheckRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SeNBCounterCheckRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-SubjectToCounterCheck-List\n");
      }
