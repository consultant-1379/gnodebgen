...
public class ActivatedNRCellList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ActivatedNRCellList";
   }

   public ActivatedNRCellList_Item[] elements;

   public ActivatedNRCellList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ActivatedNRCellList (int numRecords) {
      elements = new ActivatedNRCellList_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ActivatedNRCellList (ActivatedNRCellList_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ActivatedNRCellList_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ActivatedNRCellList_Item();
