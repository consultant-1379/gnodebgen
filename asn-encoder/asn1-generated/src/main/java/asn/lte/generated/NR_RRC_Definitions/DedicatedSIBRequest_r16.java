...
public class DedicatedSIBRequest_r16 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "DedicatedSIBRequest-r16";
   }

   public DedicatedSIBRequest_r16_criticalExtensions criticalExtensions;

   public DedicatedSIBRequest_r16 () {
      super();
      init();
   }
    ...
    */
   public DedicatedSIBRequest_r16 (
      DedicatedSIBRequest_r16_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new DedicatedSIBRequest_r16_criticalExtensions();
