...
public class TraceStart_protocolIEs extends Asn1SeqOf {
   ...
   public TraceStart_protocolIEs_element[] elements;

   public TraceStart_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public TraceStart_protocolIEs (int numRecords) {
      elements = new TraceStart_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TraceStart_protocolIEs (TraceStart_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TraceStart_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TraceStart_protocolIEs_element();
