...
public class ActivatedNRCellList_Item extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "ActivatedNRCellList-Item";
   }

   public NRCGI nrCellID;
   public ActivatedNRCellList_Item_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public ActivatedNRCellList_Item () {
      super();
      init();
   }
   ...
   public ActivatedNRCellList_Item (
      NRCGI nrCellID_,
      ActivatedNRCellList_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      nrCellID = nrCellID_;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new ActivatedNRCellList_Item_iE_Extensions();
