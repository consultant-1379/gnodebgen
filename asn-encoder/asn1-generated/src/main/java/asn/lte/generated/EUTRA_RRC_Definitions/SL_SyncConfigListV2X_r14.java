...
public class SL_SyncConfigListV2X_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-SyncConfigListV2X-r14";
   }

   public SL_SyncConfig_r12[] elements;

   public SL_SyncConfigListV2X_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_SyncConfigListV2X_r14 (int numRecords) {
      elements = new SL_SyncConfig_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_SyncConfigListV2X_r14 (SL_SyncConfig_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_SyncConfig_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_SyncConfig_r12();
