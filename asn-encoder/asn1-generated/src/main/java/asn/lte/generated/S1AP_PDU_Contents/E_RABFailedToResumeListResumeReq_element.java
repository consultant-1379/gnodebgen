...
public class E_RABFailedToResumeListResumeReq_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABFailedToResumeItemResumeReq
    * Java type: E_RABFailedToResumeItemResumeReq
    */
   public Asn1Type value;

   public E_RABFailedToResumeListResumeReq_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABFailedToResumeListResumeReq_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABFailedToResumeItemResumeReq
    */
   public void setUsing_id_E_RABFailedToResumeItemResumeReq(E_RABFailedToResumeItemResumeReq value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABFailedToResumeItemResumeReq);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABFailedToResumeItemResumeReq
    */
   public E_RABFailedToResumeItemResumeReq getValueFor_id_E_RABFailedToResumeItemResumeReq() {
      return (E_RABFailedToResumeItemResumeReq) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABFailedToResumeItemResumeReqIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABFailedToResumeItemResumeReqIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABFailedToResumeItemResumeReqIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 236) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABFailedToResumeItemResumeReq\n");
      }
