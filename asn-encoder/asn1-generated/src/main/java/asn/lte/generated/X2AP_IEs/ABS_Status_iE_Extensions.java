...
public class ABS_Status_iE_Extensions extends Asn1SeqOf {
   ...
   public ABS_Status_iE_Extensions_element[] elements;

   public ABS_Status_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ABS_Status_iE_Extensions (int numRecords) {
      elements = new ABS_Status_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ABS_Status_iE_Extensions (ABS_Status_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ABS_Status_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ABS_Status_iE_Extensions_element();
