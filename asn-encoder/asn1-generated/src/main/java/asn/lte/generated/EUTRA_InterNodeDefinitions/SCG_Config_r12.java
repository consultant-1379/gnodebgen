...
public class SCG_Config_r12 extends Asn1Seq {
   ...
   public SCG_Config_r12_criticalExtensions criticalExtensions;

   public SCG_Config_r12 () {
      super();
      init();
   }
    ...
    */
   public SCG_Config_r12 (
      SCG_Config_r12_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new SCG_Config_r12_criticalExtensions();
