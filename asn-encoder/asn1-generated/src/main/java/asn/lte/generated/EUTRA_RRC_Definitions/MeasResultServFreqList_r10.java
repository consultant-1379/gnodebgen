...
public class MeasResultServFreqList_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultServFreqList-r10";
   }

   public MeasResultServFreq_r10[] elements;

   public MeasResultServFreqList_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultServFreqList_r10 (int numRecords) {
      elements = new MeasResultServFreq_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultServFreqList_r10 (MeasResultServFreq_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultServFreq_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultServFreq_r10();
