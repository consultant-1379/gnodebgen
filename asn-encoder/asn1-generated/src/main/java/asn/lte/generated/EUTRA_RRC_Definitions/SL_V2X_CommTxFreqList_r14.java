...
public class SL_V2X_CommTxFreqList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-V2X-CommTxFreqList-r14";
   }

   public SL_V2X_CommTxResourceReq_r14[] elements;

   public SL_V2X_CommTxFreqList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_V2X_CommTxFreqList_r14 (int numRecords) {
      elements = new SL_V2X_CommTxResourceReq_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_V2X_CommTxFreqList_r14 (SL_V2X_CommTxResourceReq_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_V2X_CommTxResourceReq_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_V2X_CommTxResourceReq_r14();
