...
public class EAB_BasebandResetIndication_protocolIEs_element extends Asn1Seq {
   ...
   public EAB_BasebandResetIndication_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_BasebandResetIndication_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-LBM-ID
    */
   public void setUsing_eid_LBM_ID(asn.lte.generated.X2AP_Ericsson_IEs.EAB_LBM_ID value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_LBM_ID);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key eid-LBM-ID
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_LBM_ID getValueFor_eid_LBM_ID() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_PDU_ContentsValues.EAB_BasebandResetIndication_IEs.length; i++) {
         if(_X2AP_Ericsson_PDU_ContentsValues.EAB_BasebandResetIndication_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_PDU_ContentsValues.EAB_BasebandResetIndication_IEs[i];
            break;
         }
      }
      if (null == _index) {
