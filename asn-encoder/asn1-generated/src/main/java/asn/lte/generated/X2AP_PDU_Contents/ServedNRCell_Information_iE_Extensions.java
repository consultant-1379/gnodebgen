...
public class ServedNRCell_Information_iE_Extensions extends Asn1SeqOf {
   ...
   public ServedNRCell_Information_iE_Extensions_element[] elements;

   public ServedNRCell_Information_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedNRCell_Information_iE_Extensions (int numRecords) {
      elements = new ServedNRCell_Information_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedNRCell_Information_iE_Extensions (ServedNRCell_Information_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedNRCell_Information_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedNRCell_Information_iE_Extensions_element();
