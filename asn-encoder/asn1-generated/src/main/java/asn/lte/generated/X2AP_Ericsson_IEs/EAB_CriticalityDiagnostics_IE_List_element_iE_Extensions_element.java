...
public class EAB_CriticalityDiagnostics_IE_List_element_iE_Extensions_element extends Asn1Seq {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_CriticalityDiagnostics_IE_List_ExtIEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_CriticalityDiagnostics_IE_List_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_CriticalityDiagnostics_IE_List_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
