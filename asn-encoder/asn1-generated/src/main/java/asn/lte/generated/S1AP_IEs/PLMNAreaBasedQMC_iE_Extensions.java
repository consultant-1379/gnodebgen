...
public class PLMNAreaBasedQMC_iE_Extensions extends Asn1SeqOf {
   ...
   public PLMNAreaBasedQMC_iE_Extensions_element[] elements;

   public PLMNAreaBasedQMC_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMNAreaBasedQMC_iE_Extensions (int numRecords) {
      elements = new PLMNAreaBasedQMC_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMNAreaBasedQMC_iE_Extensions (PLMNAreaBasedQMC_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PLMNAreaBasedQMC_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PLMNAreaBasedQMC_iE_Extensions_element();
