...
public class SgNBChangeConfirm_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-E-RABs-ToBeReleased-SgNBChaConfList
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: E-RABs-ToBeReleased-SgNBChaConfList
    * Java type: E_RABs_ToBeReleased_SgNBChaConfList
    *
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-SgNBChangeConfirm-ExtConveyor
    * Java type: EAB_SgNBChangeConfirm_ExtConveyor
    */
   public Asn1Type value;

   public SgNBChangeConfirm_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBChangeConfirm_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-ToBeReleased-SgNBChaConfList
    */
   public void setUsing_id_E_RABs_ToBeReleased_SgNBChaConfList(E_RABs_ToBeReleased_SgNBChaConfList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_ToBeReleased_SgNBChaConfList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBChangeConfirm_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-ToBeReleased-SgNBChaConfList
    */
   public E_RABs_ToBeReleased_SgNBChaConfList getValueFor_id_E_RABs_ToBeReleased_SgNBChaConfList() {
      return (E_RABs_ToBeReleased_SgNBChaConfList) this.value;
   }
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBChangeConfirm_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBChangeConfirm_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SgNBChangeConfirm_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SgNBChangeConfirm_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SgNBChangeConfirm_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 229) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-ToBeReleased-SgNBChaConfList\n");
      }
      else if (id.value == 17) {
         indent (_sb, _level+1);
