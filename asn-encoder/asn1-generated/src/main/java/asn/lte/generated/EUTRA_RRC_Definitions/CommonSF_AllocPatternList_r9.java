...
public class CommonSF_AllocPatternList_r9 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CommonSF-AllocPatternList-r9";
   }

   public MBSFN_SubframeConfig[] elements;

   public CommonSF_AllocPatternList_r9 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CommonSF_AllocPatternList_r9 (int numRecords) {
      elements = new MBSFN_SubframeConfig [numRecords];
   }
    ...
    * given the array.  
    */
   public CommonSF_AllocPatternList_r9 (MBSFN_SubframeConfig[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBSFN_SubframeConfig [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBSFN_SubframeConfig();
