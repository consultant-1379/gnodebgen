...
public class COUNTValueExtended_iE_Extensions extends Asn1SeqOf {
   ...
   public COUNTValueExtended_iE_Extensions_element[] elements;

   public COUNTValueExtended_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public COUNTValueExtended_iE_Extensions (int numRecords) {
      elements = new COUNTValueExtended_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public COUNTValueExtended_iE_Extensions (COUNTValueExtended_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new COUNTValueExtended_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new COUNTValueExtended_iE_Extensions_element();
