...
public class CompositeAvailableCapacity_iE_Extensions extends Asn1SeqOf {
   ...
   public CompositeAvailableCapacity_iE_Extensions_element[] elements;

   public CompositeAvailableCapacity_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CompositeAvailableCapacity_iE_Extensions (int numRecords) {
      elements = new CompositeAvailableCapacity_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CompositeAvailableCapacity_iE_Extensions (CompositeAvailableCapacity_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CompositeAvailableCapacity_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CompositeAvailableCapacity_iE_Extensions_element();
