...
public class SecondaryPreRegistrationZoneIdListHRPD extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SecondaryPreRegistrationZoneIdListHRPD";
   }

   public PreRegistrationZoneIdHRPD[] elements;

   public SecondaryPreRegistrationZoneIdListHRPD () {
      elements = null;
   }
    ...
    * populated.
    */
   public SecondaryPreRegistrationZoneIdListHRPD (int numRecords) {
      elements = new PreRegistrationZoneIdHRPD [numRecords];
   }
    ...
    * given the array.  
    */
   public SecondaryPreRegistrationZoneIdListHRPD (PreRegistrationZoneIdHRPD[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PreRegistrationZoneIdHRPD [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PreRegistrationZoneIdHRPD();
