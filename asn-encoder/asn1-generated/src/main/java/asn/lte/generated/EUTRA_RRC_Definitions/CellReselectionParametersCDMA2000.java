...
public class CellReselectionParametersCDMA2000 extends Asn1Seq {
    ...
    * the given objects 
    */
   public CellReselectionParametersCDMA2000 (BandClassListCDMA2000 bandClassList_,
      NeighCellListCDMA2000 neighCellList_,
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.getContext().eventDispatcher.startElement("neighCellList", -1);

      neighCellList = new NeighCellListCDMA2000();
      neighCellList.decode (buffer);
      buffer.getContext().eventDispatcher.endElement("neighCellList", -1);
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (neighCellList != null) neighCellList.print (_sb, "neighCellList", _level+1);
