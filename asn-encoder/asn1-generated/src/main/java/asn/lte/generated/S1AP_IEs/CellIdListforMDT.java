...
public class CellIdListforMDT extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellIdListforMDT";
   }

   public EUTRAN_CGI[] elements;

   public CellIdListforMDT () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellIdListforMDT (int numRecords) {
    ...
    * given the array.  
    */
   public CellIdListforMDT (EUTRAN_CGI[] elements_) {
      elements = elements_;
   }
