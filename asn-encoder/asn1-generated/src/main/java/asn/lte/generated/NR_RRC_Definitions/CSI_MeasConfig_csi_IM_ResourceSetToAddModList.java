...
public class CSI_MeasConfig_csi_IM_ResourceSetToAddModList extends Asn1SeqOf {
   ...
   public CSI_IM_ResourceSet[] elements;

   public CSI_MeasConfig_csi_IM_ResourceSetToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_csi_IM_ResourceSetToAddModList (int numRecords) {
      elements = new CSI_IM_ResourceSet [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_MeasConfig_csi_IM_ResourceSetToAddModList (CSI_IM_ResourceSet[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_IM_ResourceSet [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_IM_ResourceSet();
