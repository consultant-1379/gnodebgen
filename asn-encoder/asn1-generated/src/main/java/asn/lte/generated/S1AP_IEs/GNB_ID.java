...
public class GNB_ID extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public GNB_ID (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public GNB_ID (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public GNB_ID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public GNB_ID (java.util.BitSet bitSet) {
      super (bitSet);
   }
