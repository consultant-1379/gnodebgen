...
public class FeatureSetsEUTRA_r15_featureSetsUL_r15 extends Asn1SeqOf {
   ...
   public FeatureSetUL_r15[] elements;

   public FeatureSetsEUTRA_r15_featureSetsUL_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSetsEUTRA_r15_featureSetsUL_r15 (int numRecords) {
      elements = new FeatureSetUL_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSetsEUTRA_r15_featureSetsUL_r15 (FeatureSetUL_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetUL_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetUL_r15();
