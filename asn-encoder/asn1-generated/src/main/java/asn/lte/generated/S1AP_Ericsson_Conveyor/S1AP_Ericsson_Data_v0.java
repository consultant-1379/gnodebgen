...
public class S1AP_Ericsson_Data_v0 extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "S1AP-Ericsson-Data-v0";
   }

   public S1AP_Ericsson_Data_v0 () {
      super();
   }
    ...
    *              in binary form.
    */
   public S1AP_Ericsson_Data_v0 (byte[] data) {
      super (data);
   }
    ...
    */
   public S1AP_Ericsson_Data_v0 (byte[] data, int offset, int nbytes) {
    ...
    */
   public S1AP_Ericsson_Data_v0 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
