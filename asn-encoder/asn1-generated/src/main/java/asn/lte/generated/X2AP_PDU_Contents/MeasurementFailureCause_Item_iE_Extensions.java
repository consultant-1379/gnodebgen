...
public class MeasurementFailureCause_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public MeasurementFailureCause_Item_iE_Extensions_element[] elements;

   public MeasurementFailureCause_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasurementFailureCause_Item_iE_Extensions (int numRecords) {
      elements = new MeasurementFailureCause_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasurementFailureCause_Item_iE_Extensions (MeasurementFailureCause_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasurementFailureCause_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasurementFailureCause_Item_iE_Extensions_element();
