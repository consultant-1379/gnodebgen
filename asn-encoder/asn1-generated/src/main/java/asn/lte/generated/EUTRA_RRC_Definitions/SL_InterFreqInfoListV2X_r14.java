...
public class SL_InterFreqInfoListV2X_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-InterFreqInfoListV2X-r14";
   }

   public SL_InterFreqInfoV2X_r14[] elements;

   public SL_InterFreqInfoListV2X_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_InterFreqInfoListV2X_r14 (int numRecords) {
      elements = new SL_InterFreqInfoV2X_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_InterFreqInfoListV2X_r14 (SL_InterFreqInfoV2X_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_InterFreqInfoV2X_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_InterFreqInfoV2X_r14();
