...
public class RN_SubframeConfig_r10_rpdcch_Config_r10_pucch_Config_r10_tdd_channelSelectionMultiplexingBundling_n1PUCCH_AN_List_r10 extends Asn1SeqOf {
   ...
   public RN_SubframeConfig_r10_rpdcch_Config_r10_pucch_Config_r10_tdd_channelSelectionMultiplexingBundling_n1PUCCH_AN_List_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RN_SubframeConfig_r10_rpdcch_Config_r10_pucch_Config_r10_tdd_channelSelectionMultiplexingBundling_n1PUCCH_AN_List_r10 (int numRecords) {
    ...
    * given the array.  
    */
   public RN_SubframeConfig_r10_rpdcch_Config_r10_pucch_Config_r10_tdd_channelSelectionMultiplexingBundling_n1PUCCH_AN_List_r10 (Asn1Integer[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i].decode (buffer, 0, 2047);
