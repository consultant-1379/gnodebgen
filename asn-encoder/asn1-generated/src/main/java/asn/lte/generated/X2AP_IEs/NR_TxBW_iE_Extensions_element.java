...
public class NR_TxBW_iE_Extensions_element extends Asn1Seq {
   ...
   public NR_TxBW_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public NR_TxBW_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.NR_TxBW_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.NR_TxBW_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.NR_TxBW_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
