...
public class ENSA_ErrorIndication_protocolIEs_element extends Asn1Seq {
   ...
   public ENSA_ErrorIndication_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENSA_ErrorIndication_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key xid-Old-eNB-UE-X2AP-ID
    */
   public void setUsing_xid_Old_eNB_UE_X2AP_ID(asn.lte.generated.X2AP_IEs.UE_X2AP_ID value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_ENSA_Constants._X2AP_ENSA_ConstantsValues.xid_Old_eNB_UE_X2AP_ID);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key xid-New-eNB-UE-X2AP-ID
    */
   public void setUsing_xid_New_eNB_UE_X2AP_ID(asn.lte.generated.X2AP_IEs.UE_X2AP_ID value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_ENSA_Constants._X2AP_ENSA_ConstantsValues.xid_New_eNB_UE_X2AP_ID);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key xid-Old-eNB-UE-X2AP-ID
    */
   public asn.lte.generated.X2AP_IEs.UE_X2AP_ID getValueFor_xid_Old_eNB_UE_X2AP_ID() {
      return (asn.lte.generated.X2AP_IEs.UE_X2AP_ID) this.value;
   }

   /**
    * Get value of value with type set according to information object having key xid-New-eNB-UE-X2AP-ID
    */
   public asn.lte.generated.X2AP_IEs.UE_X2AP_ID getValueFor_xid_New_eNB_UE_X2AP_ID() {
      return (asn.lte.generated.X2AP_IEs.UE_X2AP_ID) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_ENSA_PDU_ContentsValues.ENSA_ErrorIndication_IEs.length; i++) {
         if(_X2AP_ENSA_PDU_ContentsValues.ENSA_ErrorIndication_IEs[i].id.equals(id)) {
            _index = _X2AP_ENSA_PDU_ContentsValues.ENSA_ErrorIndication_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 5125) {
         indent (_sb, _level+1);
         _sb.append("id = xid-Old-eNB-UE-X2AP-ID\n");
      }
      else if (id.value == 5124) {
         indent (_sb, _level+1);
         _sb.append("id = xid-New-eNB-UE-X2AP-ID\n");
      }
