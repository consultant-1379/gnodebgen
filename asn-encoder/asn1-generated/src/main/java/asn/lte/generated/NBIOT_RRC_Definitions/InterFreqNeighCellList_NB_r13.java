...
public class InterFreqNeighCellList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqNeighCellList-NB-r13";
   }

   public PhysCellId[] elements;

   public InterFreqNeighCellList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqNeighCellList_NB_r13 (int numRecords) {
    ...
    * given the array.  
    */
   public InterFreqNeighCellList_NB_r13 (PhysCellId[] elements_) {
      elements = elements_;
   }
