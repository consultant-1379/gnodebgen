...
public class CancelledCellinTAI_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public CancelledCellinTAI_Item_iE_Extensions_element[] elements;

   public CancelledCellinTAI_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CancelledCellinTAI_Item_iE_Extensions (int numRecords) {
      elements = new CancelledCellinTAI_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CancelledCellinTAI_Item_iE_Extensions (CancelledCellinTAI_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CancelledCellinTAI_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CancelledCellinTAI_Item_iE_Extensions_element();
