...
public class UEContextRelease_protocolIEs_element extends Asn1Seq {
    ...
    * Java type: UE_X2AP_ID_Extension
    *
    * id: id-SIPTO-BearerDeactivationIndication
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: SIPTOBearerDeactivationIndication
    * Java type: SIPTOBearerDeactivationIndication
    *
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-UEContextRelease-ExtConveyor
    * Java type: EAB_UEContextRelease_ExtConveyor
    */
   public Asn1Type value;

   public UEContextRelease_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UEContextRelease_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-SIPTO-BearerDeactivationIndication
    */
   public void setUsing_id_SIPTO_BearerDeactivationIndication(asn.lte.generated.X2AP_IEs.SIPTOBearerDeactivationIndication value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_SIPTO_BearerDeactivationIndication);
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_UEContextRelease_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-SIPTO-BearerDeactivationIndication
    */
   public asn.lte.generated.X2AP_IEs.SIPTOBearerDeactivationIndication getValueFor_id_SIPTO_BearerDeactivationIndication() {
      return (asn.lte.generated.X2AP_IEs.SIPTOBearerDeactivationIndication) this.value;
   }
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_UEContextRelease_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_UEContextRelease_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.UEContextRelease_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.UEContextRelease_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.UEContextRelease_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 164) {
         indent (_sb, _level+1);
         _sb.append("id = id-SIPTO-BearerDeactivationIndication\n");
      }
