...
public class ForbiddenLAs_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public ForbiddenLAs_Item_iE_Extensions_element[] elements;

   public ForbiddenLAs_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ForbiddenLAs_Item_iE_Extensions (int numRecords) {
      elements = new ForbiddenLAs_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ForbiddenLAs_Item_iE_Extensions (ForbiddenLAs_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ForbiddenLAs_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ForbiddenLAs_Item_iE_Extensions_element();
