...
public class N1PUCCH_AN_PersistentList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "N1PUCCH-AN-PersistentList";
   }

   public Asn1Integer[] elements;

   public N1PUCCH_AN_PersistentList () {
      elements = null;
   }
    ...
    * populated.
    */
   public N1PUCCH_AN_PersistentList (int numRecords) {
    ...
    * given the array.  
    */
   public N1PUCCH_AN_PersistentList (Asn1Integer[] elements_) {
      elements = elements_;
   }
