...
public class RetrieveUEContextFailure_protocolIEs extends Asn1SeqOf {
   ...
   public RetrieveUEContextFailure_protocolIEs_element[] elements;

   public RetrieveUEContextFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public RetrieveUEContextFailure_protocolIEs (int numRecords) {
      elements = new RetrieveUEContextFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RetrieveUEContextFailure_protocolIEs (RetrieveUEContextFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RetrieveUEContextFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RetrieveUEContextFailure_protocolIEs_element();
