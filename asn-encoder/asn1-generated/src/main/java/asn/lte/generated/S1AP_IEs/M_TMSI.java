...
public class M_TMSI extends Asn1OctetString {
    ...
    */
   public M_TMSI (byte[] data, int offset, int nbytes) {
    ...
    */
   public M_TMSI (String value_) throws Asn1ValueParseException {
      super (value_);
   }
