...
public class TPC_PDCCH_Config extends Asn1Choice {
   ...
   public TPC_PDCCH_Config () {
      super();
   }

   public TPC_PDCCH_Config (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (TPC_PDCCH_Config_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            TPC_PDCCH_Config_setup setup;
            element = setup = new TPC_PDCCH_Config_setup();
            setup.decode (buffer);
            break;
         }
