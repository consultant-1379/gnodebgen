...
public class RespondingNodeType_EndcX2Setup_respond_en_gNB extends Asn1SeqOf {
   ...
   public RespondingNodeType_EndcX2Setup_respond_en_gNB_element[] elements;

   public RespondingNodeType_EndcX2Setup_respond_en_gNB () {
      elements = null;
   }
    ...
    * populated.
    */
   public RespondingNodeType_EndcX2Setup_respond_en_gNB (int numRecords) {
      elements = new RespondingNodeType_EndcX2Setup_respond_en_gNB_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RespondingNodeType_EndcX2Setup_respond_en_gNB (RespondingNodeType_EndcX2Setup_respond_en_gNB_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RespondingNodeType_EndcX2Setup_respond_en_gNB_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RespondingNodeType_EndcX2Setup_respond_en_gNB_element();
