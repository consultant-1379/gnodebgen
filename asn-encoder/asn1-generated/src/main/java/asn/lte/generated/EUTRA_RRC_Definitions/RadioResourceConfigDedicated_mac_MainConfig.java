...
public class RadioResourceConfigDedicated_mac_MainConfig extends Asn1Choice {
   ...
   public RadioResourceConfigDedicated_mac_MainConfig () {
      super();
   }

   public RadioResourceConfigDedicated_mac_MainConfig (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_explicitValue (MAC_MainConfig value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            element = explicitValue = new MAC_MainConfig();
