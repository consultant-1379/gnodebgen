...
public class MultiFrequencyBandListNR extends Asn1SeqOf {
   ...
   public MultiFrequencyBandListNR () {
      elements = null;
   }
    ...
    * populated.
    */
   public MultiFrequencyBandListNR (int numRecords) {
    ...
    * given the array.  
    */
   public MultiFrequencyBandListNR (FreqBandIndicatorNR[] elements_) {
      elements = elements_;
   }
