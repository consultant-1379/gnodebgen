...
public class PropertyList_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public PropertyList_Item_iE_Extensions_element[] elements;

   public PropertyList_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public PropertyList_Item_iE_Extensions (int numRecords) {
      elements = new PropertyList_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PropertyList_Item_iE_Extensions (PropertyList_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PropertyList_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PropertyList_Item_iE_Extensions_element();
