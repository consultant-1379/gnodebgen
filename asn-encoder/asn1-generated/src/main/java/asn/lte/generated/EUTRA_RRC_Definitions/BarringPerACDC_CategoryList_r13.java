...
public class BarringPerACDC_CategoryList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BarringPerACDC-CategoryList-r13";
   }

   public BarringPerACDC_Category_r13[] elements;

   public BarringPerACDC_CategoryList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BarringPerACDC_CategoryList_r13 (int numRecords) {
      elements = new BarringPerACDC_Category_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public BarringPerACDC_CategoryList_r13 (BarringPerACDC_Category_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BarringPerACDC_Category_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BarringPerACDC_Category_r13();
