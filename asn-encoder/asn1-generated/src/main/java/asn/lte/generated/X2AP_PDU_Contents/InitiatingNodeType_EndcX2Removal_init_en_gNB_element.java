...
public class InitiatingNodeType_EndcX2Removal_init_en_gNB_element extends Asn1Seq {
   ...
   public InitiatingNodeType_EndcX2Removal_init_en_gNB_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public InitiatingNodeType_EndcX2Removal_init_en_gNB_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.En_gNB_ENDCX2RemovalReqIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.En_gNB_ENDCX2RemovalReqIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.En_gNB_ENDCX2RemovalReqIEs[i];
            break;
         }
      }
      if (null == _index) {
