...
public class BroadcastPLMNs_Item extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BroadcastPLMNs-Item";
   }

   public PLMN_Identity[] elements;

   public BroadcastPLMNs_Item () {
      elements = null;
   }
    ...
    * populated.
    */
   public BroadcastPLMNs_Item (int numRecords) {
    ...
    * given the array.  
    */
   public BroadcastPLMNs_Item (PLMN_Identity[] elements_) {
      elements = elements_;
   }
