...
public class EIMTA_MainConfig_r12 extends Asn1Choice {
   ...
   public EIMTA_MainConfig_r12 () {
      super();
   }

   public EIMTA_MainConfig_r12 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (EIMTA_MainConfig_r12_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            EIMTA_MainConfig_r12_setup setup;
            element = setup = new EIMTA_MainConfig_r12_setup();
            setup.decode (buffer);
            break;
         }
