...
public class ServedDCNsItem_iE_Extensions extends Asn1SeqOf {
   ...
   public ServedDCNsItem_iE_Extensions_element[] elements;

   public ServedDCNsItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedDCNsItem_iE_Extensions (int numRecords) {
      elements = new ServedDCNsItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedDCNsItem_iE_Extensions (ServedDCNsItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedDCNsItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedDCNsItem_iE_Extensions_element();
