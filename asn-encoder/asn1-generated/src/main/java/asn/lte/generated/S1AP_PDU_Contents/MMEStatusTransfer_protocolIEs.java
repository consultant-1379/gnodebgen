...
public class MMEStatusTransfer_protocolIEs extends Asn1SeqOf {
   ...
   public MMEStatusTransfer_protocolIEs_element[] elements;

   public MMEStatusTransfer_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MMEStatusTransfer_protocolIEs (int numRecords) {
      elements = new MMEStatusTransfer_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MMEStatusTransfer_protocolIEs (MMEStatusTransfer_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MMEStatusTransfer_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MMEStatusTransfer_protocolIEs_element();
