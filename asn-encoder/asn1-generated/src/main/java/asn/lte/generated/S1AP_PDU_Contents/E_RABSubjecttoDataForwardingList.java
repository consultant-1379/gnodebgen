...
public class E_RABSubjecttoDataForwardingList extends Asn1SeqOf {
   ...
   public E_RABSubjecttoDataForwardingList_element[] elements;

   public E_RABSubjecttoDataForwardingList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABSubjecttoDataForwardingList (int numRecords) {
      elements = new E_RABSubjecttoDataForwardingList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABSubjecttoDataForwardingList (E_RABSubjecttoDataForwardingList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABSubjecttoDataForwardingList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABSubjecttoDataForwardingList_element();
