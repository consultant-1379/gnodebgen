...
public class EAB_ENDCAllowedPLMNList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-ENDCAllowedPLMNList";
   }

   public EAB_PLMNIdentity[] elements;

   public EAB_ENDCAllowedPLMNList () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_ENDCAllowedPLMNList (int numRecords) {
      elements = new EAB_PLMNIdentity [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_ENDCAllowedPLMNList (EAB_PLMNIdentity[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_PLMNIdentity [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_PLMNIdentity();
