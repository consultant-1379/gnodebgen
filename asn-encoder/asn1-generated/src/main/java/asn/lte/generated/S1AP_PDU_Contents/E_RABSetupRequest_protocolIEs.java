...
public class E_RABSetupRequest_protocolIEs extends Asn1SeqOf {
   ...
   public E_RABSetupRequest_protocolIEs_element[] elements;

   public E_RABSetupRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABSetupRequest_protocolIEs (int numRecords) {
      elements = new E_RABSetupRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABSetupRequest_protocolIEs (E_RABSetupRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABSetupRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABSetupRequest_protocolIEs_element();
