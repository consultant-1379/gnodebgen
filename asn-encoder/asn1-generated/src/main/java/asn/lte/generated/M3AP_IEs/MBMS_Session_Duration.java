...
public class MBMS_Session_Duration extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public MBMS_Session_Duration (byte[] data) {
      super (data);
   }
    ...
    */
   public MBMS_Session_Duration (byte[] data, int offset, int nbytes) {
    ...
    */
   public MBMS_Session_Duration (String value_) throws Asn1ValueParseException {
      super (value_);
   }
