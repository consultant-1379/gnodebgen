...
public class EAB_ElasticRAN_ULCoMPProperties_element extends Asn1Seq {
   ...
   /**
    * id: eid-ElasticRAN-ULCoMP
    * criticality: EAB_CriticalityIgnore.ignore
    * presence: EAB_PresenceOptional.optional
    * ASN.1 type: EAB-ElasticRAN-ULCoMP
    * Java type: EAB_ElasticRAN_ULCoMP
    */
   public Asn1Type value;

   public EAB_ElasticRAN_ULCoMPProperties_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_ElasticRAN_ULCoMPProperties_element (long id_,
      EAB_CriticalityIgnore criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-ElasticRAN-ULCoMP
    */
   public void setUsing_eid_ElasticRAN_ULCoMP(EAB_ElasticRAN_ULCoMP value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_ElasticRAN_ULCoMP);
      this.criticality = asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_CriticalityIgnore.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key eid-ElasticRAN-ULCoMP
    */
   public EAB_ElasticRAN_ULCoMP getValueFor_eid_ElasticRAN_ULCoMP() {
      return (EAB_ElasticRAN_ULCoMP) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_ElasticRAN_ULCoMPProperties_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_ElasticRAN_ULCoMPProperties_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_ElasticRAN_ULCoMPProperties_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 4156) {
         indent (_sb, _level+1);
         _sb.append("id = eid-ElasticRAN-ULCoMP\n");
      }
