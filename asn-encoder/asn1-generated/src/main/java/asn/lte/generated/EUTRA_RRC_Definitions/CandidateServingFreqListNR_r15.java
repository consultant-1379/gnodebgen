...
public class CandidateServingFreqListNR_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CandidateServingFreqListNR-r15";
   }

   public ARFCN_ValueNR_r15[] elements;

   public CandidateServingFreqListNR_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CandidateServingFreqListNR_r15 (int numRecords) {
      elements = new ARFCN_ValueNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public CandidateServingFreqListNR_r15 (ARFCN_ValueNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ARFCN_ValueNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ARFCN_ValueNR_r15();
