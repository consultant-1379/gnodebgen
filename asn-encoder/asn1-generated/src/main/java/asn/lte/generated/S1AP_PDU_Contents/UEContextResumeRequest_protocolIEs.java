...
public class UEContextResumeRequest_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextResumeRequest_protocolIEs_element[] elements;

   public UEContextResumeRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextResumeRequest_protocolIEs (int numRecords) {
      elements = new UEContextResumeRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextResumeRequest_protocolIEs (UEContextResumeRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextResumeRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextResumeRequest_protocolIEs_element();
