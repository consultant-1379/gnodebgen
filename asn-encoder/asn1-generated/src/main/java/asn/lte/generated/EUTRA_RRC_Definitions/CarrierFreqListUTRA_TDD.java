...
public class CarrierFreqListUTRA_TDD extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CarrierFreqListUTRA-TDD";
   }

   public CarrierFreqUTRA_TDD[] elements;

   public CarrierFreqListUTRA_TDD () {
      elements = null;
   }
    ...
    * populated.
    */
   public CarrierFreqListUTRA_TDD (int numRecords) {
      elements = new CarrierFreqUTRA_TDD [numRecords];
   }
    ...
    * given the array.  
    */
   public CarrierFreqListUTRA_TDD (CarrierFreqUTRA_TDD[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CarrierFreqUTRA_TDD [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CarrierFreqUTRA_TDD();
