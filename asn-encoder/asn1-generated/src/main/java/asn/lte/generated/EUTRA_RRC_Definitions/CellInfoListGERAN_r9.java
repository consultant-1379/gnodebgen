...
public class CellInfoListGERAN_r9 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellInfoListGERAN-r9";
   }

   public CellInfoGERAN_r9[] elements;

   public CellInfoListGERAN_r9 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellInfoListGERAN_r9 (int numRecords) {
      elements = new CellInfoGERAN_r9 [numRecords];
   }
    ...
    * given the array.  
    */
   public CellInfoListGERAN_r9 (CellInfoGERAN_r9[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellInfoGERAN_r9 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellInfoGERAN_r9();
