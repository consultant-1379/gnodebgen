...
public class ENBDirectInformationTransfer_protocolIEs_element extends Asn1Seq {
   ...
   public ENBDirectInformationTransfer_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENBDirectInformationTransfer_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-Inter-SystemInformationTransferTypeEDT
    */
   public void setUsing_id_Inter_SystemInformationTransferTypeEDT(Inter_SystemInformationTransferType value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_Inter_SystemInformationTransferTypeEDT);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-Inter-SystemInformationTransferTypeEDT
    */
   public Inter_SystemInformationTransferType getValueFor_id_Inter_SystemInformationTransferTypeEDT() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.ENBDirectInformationTransferIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.ENBDirectInformationTransferIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.ENBDirectInformationTransferIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 121) {
         indent (_sb, _level+1);
         _sb.append("id = id-Inter-SystemInformationTransferTypeEDT\n");
      }
