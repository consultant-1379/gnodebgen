...
public class Limited_list_element_iE_Extensions extends Asn1SeqOf {
   ...
   public Limited_list_element_iE_Extensions_element[] elements;

   public Limited_list_element_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public Limited_list_element_iE_Extensions (int numRecords) {
      elements = new Limited_list_element_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public Limited_list_element_iE_Extensions (Limited_list_element_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Limited_list_element_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Limited_list_element_iE_Extensions_element();
