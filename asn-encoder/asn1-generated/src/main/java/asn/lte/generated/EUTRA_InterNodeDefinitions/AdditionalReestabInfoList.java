...
public class AdditionalReestabInfoList extends Asn1SeqOf {
   ...
   public AdditionalReestabInfo[] elements;

   public AdditionalReestabInfoList () {
      elements = null;
   }
    ...
    * populated.
    */
   public AdditionalReestabInfoList (int numRecords) {
      elements = new AdditionalReestabInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public AdditionalReestabInfoList (AdditionalReestabInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AdditionalReestabInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AdditionalReestabInfo();
