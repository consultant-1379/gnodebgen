...
public class UL_HighInterferenceIndication extends Asn1BitString {
   ...
   public String getAsn1TypeName()  {
      return "UL-HighInterferenceIndication";
   }
    ...
    */
   public UL_HighInterferenceIndication () {
      super();
   }
    ...
    */
   public UL_HighInterferenceIndication (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public UL_HighInterferenceIndication (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public UL_HighInterferenceIndication (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public UL_HighInterferenceIndication (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public UL_HighInterferenceIndication (java.util.BitSet bitSet) {
      super (bitSet);
   }
