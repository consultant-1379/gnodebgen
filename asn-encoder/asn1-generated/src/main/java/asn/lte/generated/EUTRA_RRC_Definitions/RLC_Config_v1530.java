...
public class RLC_Config_v1530 extends Asn1Choice {
   ...
   public RLC_Config_v1530 () {
      super();
   }

   public RLC_Config_v1530 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (RLC_Config_v1530_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            RLC_Config_v1530_setup setup;
            element = setup = new RLC_Config_v1530_setup();
            setup.decode (buffer);
            break;
         }
