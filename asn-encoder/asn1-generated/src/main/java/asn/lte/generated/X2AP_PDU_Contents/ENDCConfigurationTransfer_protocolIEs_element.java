...
public class ENDCConfigurationTransfer_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-endcSONConfigurationTransfer
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EndcSONConfigurationTransfer
    * Java type: EndcSONConfigurationTransfer
    *
   ...
   public ENDCConfigurationTransfer_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCConfigurationTransfer_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-endcSONConfigurationTransfer
    */
   public void setUsing_id_endcSONConfigurationTransfer(asn.lte.generated.X2AP_IEs.EndcSONConfigurationTransfer value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_endcSONConfigurationTransfer);
   ...
   /**
    * Get value of value with type set according to information object having key id-endcSONConfigurationTransfer
    */
   public asn.lte.generated.X2AP_IEs.EndcSONConfigurationTransfer getValueFor_id_endcSONConfigurationTransfer() {
      return (asn.lte.generated.X2AP_IEs.EndcSONConfigurationTransfer) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCConfigurationTransfer_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCConfigurationTransfer_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCConfigurationTransfer_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 326) {
         indent (_sb, _level+1);
         _sb.append("id = id-endcSONConfigurationTransfer\n");
      }
