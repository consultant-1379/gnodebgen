...
public class MBMS_Service_associatedLogicalM3_ConnectionItem_iE_Extensions_element extends Asn1Seq {
   ...
   public MBMS_Service_associatedLogicalM3_ConnectionItem_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MBMS_Service_associatedLogicalM3_ConnectionItem_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _M3AP_IEsValues.MBMS_Service_associatedLogicalM3_ConnectionItemExtIEs.length; i++) {
         if(_M3AP_IEsValues.MBMS_Service_associatedLogicalM3_ConnectionItemExtIEs[i].id.equals(id)) {
            _index = _M3AP_IEsValues.MBMS_Service_associatedLogicalM3_ConnectionItemExtIEs[i];
            break;
         }
      }
      if (null == _index) {
