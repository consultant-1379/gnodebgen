...
public class SPDCCH_Set_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPDCCH-Set-r15";
   }

   public SPDCCH_Elements_r15[] elements;

   public SPDCCH_Set_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPDCCH_Set_r15 (int numRecords) {
      elements = new SPDCCH_Elements_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public SPDCCH_Set_r15 (SPDCCH_Elements_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SPDCCH_Elements_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SPDCCH_Elements_r15();
