...
public class MobilityInformation extends Asn1BitString {
    ...
    */
   public MobilityInformation (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public MobilityInformation (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public MobilityInformation (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public MobilityInformation (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public MobilityInformation (java.util.BitSet bitSet) {
      super (bitSet);
   }
