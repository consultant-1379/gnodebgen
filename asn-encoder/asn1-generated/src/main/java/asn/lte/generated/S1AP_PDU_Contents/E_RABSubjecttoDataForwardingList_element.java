...
public class E_RABSubjecttoDataForwardingList_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABDataForwardingItem
    * Java type: E_RABDataForwardingItem
    */
   public Asn1Type value;

   public E_RABSubjecttoDataForwardingList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABSubjecttoDataForwardingList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABDataForwardingItem
    */
   public void setUsing_id_E_RABDataForwardingItem(E_RABDataForwardingItem value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABDataForwardingItem);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABDataForwardingItem
    */
   public E_RABDataForwardingItem getValueFor_id_E_RABDataForwardingItem() {
      return (E_RABDataForwardingItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABDataForwardingItemIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABDataForwardingItemIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABDataForwardingItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 14) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABDataForwardingItem\n");
      }
