...
public class EmergencyAreaID extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public EmergencyAreaID (byte[] data) {
      super (data);
   }
    ...
    */
   public EmergencyAreaID (byte[] data, int offset, int nbytes) {
    ...
    */
   public EmergencyAreaID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
