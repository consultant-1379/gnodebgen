...
public class SCGFailureInformationEUTRA extends Asn1Seq {
   ...
   public SCGFailureInformationEUTRA_criticalExtensions criticalExtensions;

   public SCGFailureInformationEUTRA () {
      super();
      init();
   }
    ...
    */
   public SCGFailureInformationEUTRA (
      SCGFailureInformationEUTRA_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new SCGFailureInformationEUTRA_criticalExtensions();
