...
public class MobilityParametersCDMA2000 extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "MobilityParametersCDMA2000";
   }

   public MobilityParametersCDMA2000 () {
      super();
   }
    ...
    *              in binary form.
    */
   public MobilityParametersCDMA2000 (byte[] data) {
      super (data);
   }
    ...
    */
   public MobilityParametersCDMA2000 (byte[] data, int offset, int nbytes) {
    ...
    */
   public MobilityParametersCDMA2000 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
