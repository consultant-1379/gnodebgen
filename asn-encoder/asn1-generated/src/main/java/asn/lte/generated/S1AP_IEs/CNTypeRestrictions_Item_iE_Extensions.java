...
public class CNTypeRestrictions_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public CNTypeRestrictions_Item_iE_Extensions_element[] elements;

   public CNTypeRestrictions_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CNTypeRestrictions_Item_iE_Extensions (int numRecords) {
      elements = new CNTypeRestrictions_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CNTypeRestrictions_Item_iE_Extensions (CNTypeRestrictions_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CNTypeRestrictions_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CNTypeRestrictions_Item_iE_Extensions_element();
