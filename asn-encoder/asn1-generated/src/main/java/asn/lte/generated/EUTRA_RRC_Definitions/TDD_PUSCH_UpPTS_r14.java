...
public class TDD_PUSCH_UpPTS_r14 extends Asn1Choice {
   ...
   public TDD_PUSCH_UpPTS_r14 () {
      super();
   }

   public TDD_PUSCH_UpPTS_r14 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (TDD_PUSCH_UpPTS_r14_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            TDD_PUSCH_UpPTS_r14_setup setup;
            element = setup = new TDD_PUSCH_UpPTS_r14_setup();
            setup.decode (buffer);
            break;
         }
