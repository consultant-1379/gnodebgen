...
public class SL_DestinationIdentity_r12 extends Asn1BitString {
   ...
   public String getAsn1TypeName()  {
      return "SL-DestinationIdentity-r12";
   }
    ...
    */
   public SL_DestinationIdentity_r12 () {
      super();
      value = new byte [3];
   }
    ...
    */
   public SL_DestinationIdentity_r12 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public SL_DestinationIdentity_r12 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public SL_DestinationIdentity_r12 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public SL_DestinationIdentity_r12 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public SL_DestinationIdentity_r12 (java.util.BitSet bitSet) {
      super (bitSet);
   }
