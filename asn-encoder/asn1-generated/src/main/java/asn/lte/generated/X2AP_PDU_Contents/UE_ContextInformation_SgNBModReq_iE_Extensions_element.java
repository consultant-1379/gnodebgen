...
public class UE_ContextInformation_SgNBModReq_iE_Extensions_element extends Asn1Seq {
   ...
   public UE_ContextInformation_SgNBModReq_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UE_ContextInformation_SgNBModReq_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
    ...
    */
   public void setUsing_id_SubscriberProfileIDforRFP(asn.lte.generated.X2AP_IEs.SubscriberProfileIDforRFP extensionValue) {
   ...
   /**
    * Get value of extensionValue with type set according to information object having key id-SubscriberProfileIDforRFP
    */
   public asn.lte.generated.X2AP_IEs.SubscriberProfileIDforRFP getExtensionValueFor_id_SubscriberProfileIDforRFP() {
      return (asn.lte.generated.X2AP_IEs.SubscriberProfileIDforRFP) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.UE_ContextInformationSgNBModReqExtIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.UE_ContextInformationSgNBModReqExtIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.UE_ContextInformationSgNBModReqExtIEs[i];
            break;
         }
      }
      if (null == _index) {
