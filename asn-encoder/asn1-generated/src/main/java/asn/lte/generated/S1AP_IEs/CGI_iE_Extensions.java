...
public class CGI_iE_Extensions extends Asn1SeqOf {
   ...
   public CGI_iE_Extensions_element[] elements;

   public CGI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CGI_iE_Extensions (int numRecords) {
      elements = new CGI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CGI_iE_Extensions (CGI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CGI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CGI_iE_Extensions_element();
