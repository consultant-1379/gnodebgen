...
public class ServingCellConfigCommon_rateMatchPatternToReleaseList extends Asn1SeqOf {
   ...
   public RateMatchPatternId[] elements;

   public ServingCellConfigCommon_rateMatchPatternToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServingCellConfigCommon_rateMatchPatternToReleaseList (int numRecords) {
      elements = new RateMatchPatternId [numRecords];
   }
    ...
    * given the array.  
    */
   public ServingCellConfigCommon_rateMatchPatternToReleaseList (RateMatchPatternId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RateMatchPatternId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RateMatchPatternId();
