...
public class MBMS_Service_Area extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public MBMS_Service_Area (byte[] data) {
      super (data);
   }
    ...
    */
   public MBMS_Service_Area (byte[] data, int offset, int nbytes) {
    ...
    */
   public MBMS_Service_Area (String value_) throws Asn1ValueParseException {
      super (value_);
   }
