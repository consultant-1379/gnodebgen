...
public class NPRACH_ParametersListFmt2_NB_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NPRACH-ParametersListFmt2-NB-r15";
   }

   public NPRACH_ParametersFmt2_NB_r15[] elements;

   public NPRACH_ParametersListFmt2_NB_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NPRACH_ParametersListFmt2_NB_r15 (int numRecords) {
      elements = new NPRACH_ParametersFmt2_NB_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public NPRACH_ParametersListFmt2_NB_r15 (NPRACH_ParametersFmt2_NB_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NPRACH_ParametersFmt2_NB_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NPRACH_ParametersFmt2_NB_r15();
