...
public class UEInformationResponse_v930_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UEInformationResponse-v930-IEs";
   }

   public UEInformationResponse_v9e0_IEs lateNonCriticalExtension;  // optional
   public UEInformationResponse_v1020_IEs nonCriticalExtension;  // optional

   public UEInformationResponse_v930_IEs () {
      super();
      init();
   }
    ...
    */
   public UEInformationResponse_v930_IEs (
      UEInformationResponse_v9e0_IEs lateNonCriticalExtension_,
      UEInformationResponse_v1020_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (lateNonCriticalExtensionPresent) {
         ...
         lateNonCriticalExtension = new UEInformationResponse_v9e0_IEs();
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new UEInformationResponse_v1020_IEs();
