...
public class ServedNRCellsToActivate extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServedNRCellsToActivate";
   }

   public ServedNRCellsToActivate_Item[] elements;

   public ServedNRCellsToActivate () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedNRCellsToActivate (int numRecords) {
      elements = new ServedNRCellsToActivate_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedNRCellsToActivate (ServedNRCellsToActivate_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedNRCellsToActivate_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedNRCellsToActivate_Item();
