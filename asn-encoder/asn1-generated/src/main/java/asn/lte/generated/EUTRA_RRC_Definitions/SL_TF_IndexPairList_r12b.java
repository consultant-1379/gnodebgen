...
public class SL_TF_IndexPairList_r12b extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-TF-IndexPairList-r12b";
   }

   public SL_TF_IndexPair_r12b[] elements;

   public SL_TF_IndexPairList_r12b () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_TF_IndexPairList_r12b (int numRecords) {
      elements = new SL_TF_IndexPair_r12b [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_TF_IndexPairList_r12b (SL_TF_IndexPair_r12b[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_TF_IndexPair_r12b [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_TF_IndexPair_r12b();
