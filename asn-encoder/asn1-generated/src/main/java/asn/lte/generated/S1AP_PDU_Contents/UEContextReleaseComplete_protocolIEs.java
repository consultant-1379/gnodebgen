...
public class UEContextReleaseComplete_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextReleaseComplete_protocolIEs_element[] elements;

   public UEContextReleaseComplete_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextReleaseComplete_protocolIEs (int numRecords) {
      elements = new UEContextReleaseComplete_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextReleaseComplete_protocolIEs (UEContextReleaseComplete_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextReleaseComplete_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextReleaseComplete_protocolIEs_element();
