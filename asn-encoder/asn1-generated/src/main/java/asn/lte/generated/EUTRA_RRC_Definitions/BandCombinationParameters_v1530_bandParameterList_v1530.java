...
public class BandCombinationParameters_v1530_bandParameterList_v1530 extends Asn1SeqOf {
   ...
   public BandParameters_v1530[] elements;

   public BandCombinationParameters_v1530_bandParameterList_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_v1530_bandParameterList_v1530 (int numRecords) {
      elements = new BandParameters_v1530 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_v1530_bandParameterList_v1530 (BandParameters_v1530[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_v1530 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_v1530();
