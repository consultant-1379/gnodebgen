...
public class TargetBSS_ToSourceBSS_TransparentContainer extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "TargetBSS-ToSourceBSS-TransparentContainer";
   }

   public TargetBSS_ToSourceBSS_TransparentContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public TargetBSS_ToSourceBSS_TransparentContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public TargetBSS_ToSourceBSS_TransparentContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public TargetBSS_ToSourceBSS_TransparentContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
