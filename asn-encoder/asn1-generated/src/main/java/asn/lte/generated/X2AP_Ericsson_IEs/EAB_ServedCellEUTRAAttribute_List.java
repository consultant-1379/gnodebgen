...
public class EAB_ServedCellEUTRAAttribute_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-ServedCellEUTRAAttribute-List";
   }

   public EAB_ServedCellEUTRAAttribute_Item[] elements;

   public EAB_ServedCellEUTRAAttribute_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_ServedCellEUTRAAttribute_List (int numRecords) {
      elements = new EAB_ServedCellEUTRAAttribute_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_ServedCellEUTRAAttribute_List (EAB_ServedCellEUTRAAttribute_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_ServedCellEUTRAAttribute_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_ServedCellEUTRAAttribute_Item();
