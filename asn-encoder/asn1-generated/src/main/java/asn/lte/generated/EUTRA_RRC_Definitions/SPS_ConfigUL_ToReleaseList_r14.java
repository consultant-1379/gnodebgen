...
public class SPS_ConfigUL_ToReleaseList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPS-ConfigUL-ToReleaseList-r14";
   }

   public SPS_ConfigIndex_r14[] elements;

   public SPS_ConfigUL_ToReleaseList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPS_ConfigUL_ToReleaseList_r14 (int numRecords) {
      elements = new SPS_ConfigIndex_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public SPS_ConfigUL_ToReleaseList_r14 (SPS_ConfigIndex_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SPS_ConfigIndex_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SPS_ConfigIndex_r14();
