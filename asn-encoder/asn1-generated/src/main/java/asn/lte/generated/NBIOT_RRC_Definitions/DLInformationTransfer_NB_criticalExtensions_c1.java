...
public class DLInformationTransfer_NB_criticalExtensions_c1 extends Asn1Choice {
   ...
   public DLInformationTransfer_NB_criticalExtensions_c1 () {
      super();
   }

   public DLInformationTransfer_NB_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_dlInformationTransfer_r13 (DLInformationTransfer_NB_r13_IEs value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            DLInformationTransfer_NB_r13_IEs dlInformationTransfer_r13;
            element = dlInformationTransfer_r13 = new DLInformationTransfer_NB_r13_IEs();
