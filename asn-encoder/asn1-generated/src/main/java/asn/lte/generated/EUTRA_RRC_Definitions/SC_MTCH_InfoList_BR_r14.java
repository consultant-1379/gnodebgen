...
public class SC_MTCH_InfoList_BR_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SC-MTCH-InfoList-BR-r14";
   }

   public SC_MTCH_Info_BR_r14[] elements;

   public SC_MTCH_InfoList_BR_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SC_MTCH_InfoList_BR_r14 (int numRecords) {
      elements = new SC_MTCH_Info_BR_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public SC_MTCH_InfoList_BR_r14 (SC_MTCH_Info_BR_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (0, 128);
      int numElements = (int) buffer.decodeLength();

      elements = new SC_MTCH_Info_BR_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SC_MTCH_Info_BR_r14();
