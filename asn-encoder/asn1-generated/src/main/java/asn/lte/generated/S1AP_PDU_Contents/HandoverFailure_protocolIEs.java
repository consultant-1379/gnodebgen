...
public class HandoverFailure_protocolIEs extends Asn1SeqOf {
   ...
   public HandoverFailure_protocolIEs_element[] elements;

   public HandoverFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public HandoverFailure_protocolIEs (int numRecords) {
      elements = new HandoverFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public HandoverFailure_protocolIEs (HandoverFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HandoverFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new HandoverFailure_protocolIEs_element();
