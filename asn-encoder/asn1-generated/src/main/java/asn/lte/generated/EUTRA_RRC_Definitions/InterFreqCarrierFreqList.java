...
public class InterFreqCarrierFreqList extends Asn1SeqOf {
   ...
   public InterFreqCarrierFreqInfo[] elements;

   public InterFreqCarrierFreqList () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqList (int numRecords) {
      elements = new InterFreqCarrierFreqInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqList (InterFreqCarrierFreqInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqCarrierFreqInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqCarrierFreqInfo();
