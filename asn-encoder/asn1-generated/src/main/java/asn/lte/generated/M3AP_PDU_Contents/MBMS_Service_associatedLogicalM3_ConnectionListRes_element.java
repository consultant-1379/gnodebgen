...
public class MBMS_Service_associatedLogicalM3_ConnectionListRes_element extends Asn1Seq {
   ...
   public MBMS_Service_associatedLogicalM3_ConnectionListRes_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MBMS_Service_associatedLogicalM3_ConnectionListRes_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _M3AP_PDU_ContentsValues.MBMS_Service_associatedLogicalM3_ConnectionItemRes.length; i++) {
         if(_M3AP_PDU_ContentsValues.MBMS_Service_associatedLogicalM3_ConnectionItemRes[i].id.equals(id)) {
            _index = _M3AP_PDU_ContentsValues.MBMS_Service_associatedLogicalM3_ConnectionItemRes[i];
            break;
         }
      }
      if (null == _index) {
