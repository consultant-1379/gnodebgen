...
public class CarrierFreqListUTRA_FDD extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CarrierFreqListUTRA-FDD";
   }

   public CarrierFreqUTRA_FDD[] elements;

   public CarrierFreqListUTRA_FDD () {
      elements = null;
   }
    ...
    * populated.
    */
   public CarrierFreqListUTRA_FDD (int numRecords) {
      elements = new CarrierFreqUTRA_FDD [numRecords];
   }
    ...
    * given the array.  
    */
   public CarrierFreqListUTRA_FDD (CarrierFreqUTRA_FDD[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CarrierFreqUTRA_FDD [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CarrierFreqUTRA_FDD();
