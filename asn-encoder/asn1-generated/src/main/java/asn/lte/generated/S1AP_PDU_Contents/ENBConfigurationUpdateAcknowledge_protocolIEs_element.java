...
public class ENBConfigurationUpdateAcknowledge_protocolIEs_element extends Asn1Seq {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.ENBConfigurationUpdateAcknowledgeIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.ENBConfigurationUpdateAcknowledgeIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.ENBConfigurationUpdateAcknowledgeIEs[i];
            break;
         }
      }
      if (null == _index) {
