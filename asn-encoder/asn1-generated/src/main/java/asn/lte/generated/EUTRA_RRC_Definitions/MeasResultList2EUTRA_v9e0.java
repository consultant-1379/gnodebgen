...
public class MeasResultList2EUTRA_v9e0 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultList2EUTRA-v9e0";
   }

   public MeasResult2EUTRA_v9e0[] elements;

   public MeasResultList2EUTRA_v9e0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultList2EUTRA_v9e0 (int numRecords) {
      elements = new MeasResult2EUTRA_v9e0 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultList2EUTRA_v9e0 (MeasResult2EUTRA_v9e0[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResult2EUTRA_v9e0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResult2EUTRA_v9e0();
