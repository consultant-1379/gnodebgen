...
public class ABSInformationFDD_iE_Extensions extends Asn1SeqOf {
   ...
   public ABSInformationFDD_iE_Extensions_element[] elements;

   public ABSInformationFDD_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ABSInformationFDD_iE_Extensions (int numRecords) {
      elements = new ABSInformationFDD_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ABSInformationFDD_iE_Extensions (ABSInformationFDD_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ABSInformationFDD_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ABSInformationFDD_iE_Extensions_element();
