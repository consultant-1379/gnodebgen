...
public class ENDCConfigurationUpdate_protocolIEs extends Asn1SeqOf {
   ...
   public ENDCConfigurationUpdate_protocolIEs_element[] elements;

   public ENDCConfigurationUpdate_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENDCConfigurationUpdate_protocolIEs (int numRecords) {
      elements = new ENDCConfigurationUpdate_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENDCConfigurationUpdate_protocolIEs (ENDCConfigurationUpdate_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENDCConfigurationUpdate_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENDCConfigurationUpdate_protocolIEs_element();
