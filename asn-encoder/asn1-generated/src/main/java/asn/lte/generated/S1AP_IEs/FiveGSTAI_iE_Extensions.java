...
public class FiveGSTAI_iE_Extensions extends Asn1SeqOf {
   ...
   public FiveGSTAI_iE_Extensions_element[] elements;

   public FiveGSTAI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public FiveGSTAI_iE_Extensions (int numRecords) {
      elements = new FiveGSTAI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public FiveGSTAI_iE_Extensions (FiveGSTAI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FiveGSTAI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FiveGSTAI_iE_Extensions_element();
