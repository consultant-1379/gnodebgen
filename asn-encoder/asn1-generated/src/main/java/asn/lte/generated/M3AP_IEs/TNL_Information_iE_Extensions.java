...
public class TNL_Information_iE_Extensions extends Asn1SeqOf {
   ...
   public TNL_Information_iE_Extensions_element[] elements;

   public TNL_Information_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TNL_Information_iE_Extensions (int numRecords) {
      elements = new TNL_Information_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TNL_Information_iE_Extensions (TNL_Information_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TNL_Information_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TNL_Information_iE_Extensions_element();
