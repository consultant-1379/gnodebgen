...
public class MeasurementInitiationResult_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public MeasurementInitiationResult_Item_iE_Extensions_element[] elements;

   public MeasurementInitiationResult_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasurementInitiationResult_Item_iE_Extensions (int numRecords) {
      elements = new MeasurementInitiationResult_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasurementInitiationResult_Item_iE_Extensions (MeasurementInitiationResult_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasurementInitiationResult_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasurementInitiationResult_Item_iE_Extensions_element();
