...
public class MeasIdToRemoveList extends Asn1SeqOf {
    ...
    * populated.
    */
   public MeasIdToRemoveList (int numRecords) {
    ...
    * given the array.  
    */
   public MeasIdToRemoveList (MeasId[] elements_) {
      elements = elements_;
   }
