...
public class DRB_ToAddModListSCG_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "DRB-ToAddModListSCG-r15";
   }

   public DRB_ToAddModSCG_r12[] elements;

   public DRB_ToAddModListSCG_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public DRB_ToAddModListSCG_r15 (int numRecords) {
      elements = new DRB_ToAddModSCG_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public DRB_ToAddModListSCG_r15 (DRB_ToAddModSCG_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DRB_ToAddModSCG_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DRB_ToAddModSCG_r12();
