...
public class SL_DiscTxInfoInterFreqListAdd_r13_discTxFreqToReleaseList_r13 extends Asn1SeqOf {
   ...
   public ARFCN_ValueEUTRA_r9[] elements;

   public SL_DiscTxInfoInterFreqListAdd_r13_discTxFreqToReleaseList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_DiscTxInfoInterFreqListAdd_r13_discTxFreqToReleaseList_r13 (int numRecords) {
      elements = new ARFCN_ValueEUTRA_r9 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_DiscTxInfoInterFreqListAdd_r13_discTxFreqToReleaseList_r13 (ARFCN_ValueEUTRA_r9[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ARFCN_ValueEUTRA_r9 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ARFCN_ValueEUTRA_r9();
