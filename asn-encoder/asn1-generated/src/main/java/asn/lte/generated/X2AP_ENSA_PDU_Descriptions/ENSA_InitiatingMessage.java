...
public class ENSA_InitiatingMessage extends Asn1Seq {
    ...
    * ASN.1 type: ENSA-X2SetupRequest
    * Java type: ENSA_X2SetupRequest
    *
    * procedureCode: xid-ConfigurationUpdate
    * criticality: Criticality.reject
    * ASN.1 type: ENSA-ConfigurationUpdate
    * Java type: ENSA_ConfigurationUpdate
    *
    * procedureCode: xid-sgNBAdditionPreparation
    * criticality: Criticality.reject
    * ASN.1 type: ENSA-SgNBAdditionRequest
    * Java type: ENSA_SgNBAdditionRequest
    *
    * procedureCode: xid-ErrorIndication
    * criticality: Criticality.ignore
    * ASN.1 type: ENSA-ErrorIndication
    * Java type: ENSA_ErrorIndication
    *
    * procedureCode: xid-sgNBReconfigurationCompletion
    * criticality: Criticality.ignore
    * ASN.1 type: ENSA-SgNBReconfigurationComplete
    * Java type: ENSA_SgNBReconfigurationComplete
    */
   public Asn1Type value;

   public ENSA_InitiatingMessage () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENSA_InitiatingMessage (long procedureCode_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
    ...
    */
   public void setUsing_ensa_X2Setup(asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_X2SetupRequest value) {
    ...
    */
   public void setUsing_ensa_ConfigurationUpdate(asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_ConfigurationUpdate value) {
    ...
    */
   public void setUsing_ensa_sgNBAdditionPreparation(asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_SgNBAdditionRequest value) {
    ...
    */
   public void setUsing_ensa_ErrorIndication(asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_ErrorIndication value) {
    ...
    */
   public void setUsing_ensa_sgNBReconfigurationCompletion(asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_SgNBReconfigurationComplete value) {
    ...
    */
   public asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_X2SetupRequest getValueFor_ensa_X2Setup() {
      return (asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_X2SetupRequest) this.value;
   }

   /**
    * Get value of value with type set according to information object ensa-ConfigurationUpdate
    */
   public asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_ConfigurationUpdate getValueFor_ensa_ConfigurationUpdate() {
      return (asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_ConfigurationUpdate) this.value;
   }

   /**
    * Get value of value with type set according to information object ensa-sgNBAdditionPreparation
    */
   public asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_SgNBAdditionRequest getValueFor_ensa_sgNBAdditionPreparation() {
      return (asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_SgNBAdditionRequest) this.value;
   }

   /**
    * Get value of value with type set according to information object ensa-ErrorIndication
    */
   public asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_ErrorIndication getValueFor_ensa_ErrorIndication() {
      return (asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_ErrorIndication) this.value;
   }

   /**
    * Get value of value with type set according to information object ensa-sgNBReconfigurationCompletion
    */
   public asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_SgNBReconfigurationComplete getValueFor_ensa_sgNBReconfigurationCompletion() {
      return (asn.lte.generated.X2AP_ENSA_PDU_Contents.ENSA_SgNBReconfigurationComplete) this.value;
   }
