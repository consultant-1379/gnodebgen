...
public class SPUCCH_Elements_r15_setup_n1SubslotSPUCCH_AN_List_r15 extends Asn1SeqOf {
   ...
   public SPUCCH_Elements_r15_setup_n1SubslotSPUCCH_AN_List_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPUCCH_Elements_r15_setup_n1SubslotSPUCCH_AN_List_r15 (int numRecords) {
    ...
    * given the array.  
    */
   public SPUCCH_Elements_r15_setup_n1SubslotSPUCCH_AN_List_r15 (Asn1Integer[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i].decode (buffer, 0, 1319);
