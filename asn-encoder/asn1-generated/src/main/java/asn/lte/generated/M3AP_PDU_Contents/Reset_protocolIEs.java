...
public class Reset_protocolIEs extends Asn1SeqOf {
   ...
   public Reset_protocolIEs_element[] elements;

   public Reset_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public Reset_protocolIEs (int numRecords) {
      elements = new Reset_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public Reset_protocolIEs (Reset_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Reset_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Reset_protocolIEs_element();
