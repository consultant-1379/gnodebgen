...
public class TABasedQMC_iE_Extensions extends Asn1SeqOf {
   ...
   public TABasedQMC_iE_Extensions_element[] elements;

   public TABasedQMC_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TABasedQMC_iE_Extensions (int numRecords) {
      elements = new TABasedQMC_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TABasedQMC_iE_Extensions (TABasedQMC_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TABasedQMC_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TABasedQMC_iE_Extensions_element();
