...
public class IAB_IP_AddressConfigurationList_r16_iab_IP_AddressToReleaseList_r16 extends Asn1SeqOf {
   ...
   public IAB_IP_AddressIndex_r16[] elements;

   public IAB_IP_AddressConfigurationList_r16_iab_IP_AddressToReleaseList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public IAB_IP_AddressConfigurationList_r16_iab_IP_AddressToReleaseList_r16 (int numRecords) {
      elements = new IAB_IP_AddressIndex_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public IAB_IP_AddressConfigurationList_r16_iab_IP_AddressToReleaseList_r16 (IAB_IP_AddressIndex_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new IAB_IP_AddressIndex_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new IAB_IP_AddressIndex_r16();
