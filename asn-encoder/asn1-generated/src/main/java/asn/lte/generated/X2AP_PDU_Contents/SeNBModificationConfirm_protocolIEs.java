...
public class SeNBModificationConfirm_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBModificationConfirm_protocolIEs_element[] elements;

   public SeNBModificationConfirm_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBModificationConfirm_protocolIEs (int numRecords) {
      elements = new SeNBModificationConfirm_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBModificationConfirm_protocolIEs (SeNBModificationConfirm_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBModificationConfirm_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBModificationConfirm_protocolIEs_element();
