...
public class NASSecurityParameterstoE_UTRAN extends Asn1OctetString {
   ...
   public NASSecurityParameterstoE_UTRAN () {
      super();
   }
    ...
    *              in binary form.
    */
   public NASSecurityParameterstoE_UTRAN (byte[] data) {
      super (data);
   }
    ...
    */
   public NASSecurityParameterstoE_UTRAN (byte[] data, int offset, int nbytes) {
    ...
    */
   public NASSecurityParameterstoE_UTRAN (String value_) throws Asn1ValueParseException {
      super (value_);
   }
