...
public class NeighCellsPerBandclassListCDMA2000 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NeighCellsPerBandclassListCDMA2000";
   }

   public NeighCellsPerBandclassCDMA2000[] elements;

   public NeighCellsPerBandclassListCDMA2000 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NeighCellsPerBandclassListCDMA2000 (int numRecords) {
      elements = new NeighCellsPerBandclassCDMA2000 [numRecords];
   }
    ...
    * given the array.  
    */
   public NeighCellsPerBandclassListCDMA2000 (NeighCellsPerBandclassCDMA2000[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NeighCellsPerBandclassCDMA2000 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NeighCellsPerBandclassCDMA2000();
