...
public class ServedNRcellsToModifyENDCConfUpdList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServedNRcellsToModifyENDCConfUpdList";
   }

   public ServedNRCellsToModify_Item[] elements;

   public ServedNRcellsToModifyENDCConfUpdList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedNRcellsToModifyENDCConfUpdList (int numRecords) {
      elements = new ServedNRCellsToModify_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedNRcellsToModifyENDCConfUpdList (ServedNRCellsToModify_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedNRCellsToModify_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedNRCellsToModify_Item();
