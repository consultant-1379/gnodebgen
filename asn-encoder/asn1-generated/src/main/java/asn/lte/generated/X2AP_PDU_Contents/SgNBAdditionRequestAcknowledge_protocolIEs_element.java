...
public class SgNBAdditionRequestAcknowledge_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-E-RABs-Admitted-ToBeAdded-SgNBAddReqAckList
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABs-Admitted-ToBeAdded-SgNBAddReqAckList
    * Java type: E_RABs_Admitted_ToBeAdded_SgNBAddReqAckList
    *
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-SgNBAdditionRequestAcknowledge-ExtConveyor
    * Java type: EAB_SgNBAdditionRequestAcknowledge_ExtConveyor
    */
   public Asn1Type value;

   public SgNBAdditionRequestAcknowledge_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBAdditionRequestAcknowledge_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-Admitted-ToBeAdded-SgNBAddReqAckList
    */
   public void setUsing_id_E_RABs_Admitted_ToBeAdded_SgNBAddReqAckList(E_RABs_Admitted_ToBeAdded_SgNBAddReqAckList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_Admitted_ToBeAdded_SgNBAddReqAckList);
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBAdditionRequestAcknowledge_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-Admitted-ToBeAdded-SgNBAddReqAckList
    */
   public E_RABs_Admitted_ToBeAdded_SgNBAddReqAckList getValueFor_id_E_RABs_Admitted_ToBeAdded_SgNBAddReqAckList() {
      return (E_RABs_Admitted_ToBeAdded_SgNBAddReqAckList) this.value;
   }
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBAdditionRequestAcknowledge_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBAdditionRequestAcknowledge_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SgNBAdditionRequestAcknowledge_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SgNBAdditionRequestAcknowledge_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SgNBAdditionRequestAcknowledge_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 210) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-Admitted-ToBeAdded-SgNBAddReqAckList\n");
      }
      else if (id.value == 3) {
         indent (_sb, _level+1);
