...
public class MBMSInterestIndication_v1540_IEs_mbms_ROM_InfoList_r15 extends Asn1SeqOf {
   ...
   public MBMS_ROM_Info_r15[] elements;

   public MBMSInterestIndication_v1540_IEs_mbms_ROM_InfoList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMSInterestIndication_v1540_IEs_mbms_ROM_InfoList_r15 (int numRecords) {
      elements = new MBMS_ROM_Info_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMSInterestIndication_v1540_IEs_mbms_ROM_InfoList_r15 (MBMS_ROM_Info_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMS_ROM_Info_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMS_ROM_Info_r15();
