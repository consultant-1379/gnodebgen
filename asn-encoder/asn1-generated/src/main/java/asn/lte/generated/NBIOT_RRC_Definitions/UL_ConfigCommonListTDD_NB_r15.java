...
public class UL_ConfigCommonListTDD_NB_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "UL-ConfigCommonListTDD-NB-r15";
   }

   public UL_ConfigCommonTDD_NB_r15[] elements;

   public UL_ConfigCommonListTDD_NB_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UL_ConfigCommonListTDD_NB_r15 (int numRecords) {
      elements = new UL_ConfigCommonTDD_NB_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public UL_ConfigCommonListTDD_NB_r15 (UL_ConfigCommonTDD_NB_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UL_ConfigCommonTDD_NB_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UL_ConfigCommonTDD_NB_r15();
