...
public class ProtectedResourceList extends Asn1SeqOf {
   ...
   public ProtectedResourceList_Item[] elements;
    ...
    * populated.
    */
   public ProtectedResourceList (int numRecords) {
      elements = new ProtectedResourceList_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ProtectedResourceList (ProtectedResourceList_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ProtectedResourceList_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ProtectedResourceList_Item();
