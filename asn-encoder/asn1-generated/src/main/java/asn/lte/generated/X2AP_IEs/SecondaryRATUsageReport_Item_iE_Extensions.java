...
public class SecondaryRATUsageReport_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public SecondaryRATUsageReport_Item_iE_Extensions_element[] elements;

   public SecondaryRATUsageReport_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SecondaryRATUsageReport_Item_iE_Extensions (int numRecords) {
      elements = new SecondaryRATUsageReport_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SecondaryRATUsageReport_Item_iE_Extensions (SecondaryRATUsageReport_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SecondaryRATUsageReport_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SecondaryRATUsageReport_Item_iE_Extensions_element();
