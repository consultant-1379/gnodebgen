...
public class CSI_RS_Config_r15 extends Asn1Choice {
   ...
   public CSI_RS_Config_r15 () {
      super();
   }

   public CSI_RS_Config_r15 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (CSI_RS_Config_r15_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            CSI_RS_Config_r15_setup setup;
            element = setup = new CSI_RS_Config_r15_setup();
            setup.decode (buffer);
            break;
         }
