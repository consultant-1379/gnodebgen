...
public class SupportedBandInfoList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandInfoList-r12";
   }

   public SupportedBandInfo_r12[] elements;

   public SupportedBandInfoList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandInfoList_r12 (int numRecords) {
      elements = new SupportedBandInfo_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandInfoList_r12 (SupportedBandInfo_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBandInfo_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedBandInfo_r12();
