...
public class RecommendedCellItem_iE_Extensions extends Asn1SeqOf {
   ...
   public RecommendedCellItem_iE_Extensions_element[] elements;

   public RecommendedCellItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RecommendedCellItem_iE_Extensions (int numRecords) {
      elements = new RecommendedCellItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RecommendedCellItem_iE_Extensions (RecommendedCellItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RecommendedCellItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RecommendedCellItem_iE_Extensions_element();
