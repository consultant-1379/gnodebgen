...
public class V2X_BandCombinationParameters_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "V2X-BandCombinationParameters-v1530";
   }

   public V2X_BandParameters_v1530[] elements;

   public V2X_BandCombinationParameters_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public V2X_BandCombinationParameters_v1530 (int numRecords) {
      elements = new V2X_BandParameters_v1530 [numRecords];
   }
    ...
    * given the array.  
    */
   public V2X_BandCombinationParameters_v1530 (V2X_BandParameters_v1530[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new V2X_BandParameters_v1530 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new V2X_BandParameters_v1530();
