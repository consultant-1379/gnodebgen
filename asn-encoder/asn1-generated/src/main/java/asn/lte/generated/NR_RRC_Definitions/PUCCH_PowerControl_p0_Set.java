...
public class PUCCH_PowerControl_p0_Set extends Asn1SeqOf {
   ...
   public P0_PUCCH[] elements;

   public PUCCH_PowerControl_p0_Set () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_PowerControl_p0_Set (int numRecords) {
      elements = new P0_PUCCH [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_PowerControl_p0_Set (P0_PUCCH[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new P0_PUCCH [numElements];
