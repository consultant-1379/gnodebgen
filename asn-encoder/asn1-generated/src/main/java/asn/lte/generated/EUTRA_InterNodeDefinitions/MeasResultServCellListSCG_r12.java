...
public class MeasResultServCellListSCG_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultServCellListSCG-r12";
   }

   public MeasResultServCellSCG_r12[] elements;

   public MeasResultServCellListSCG_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultServCellListSCG_r12 (int numRecords) {
    ...
    * given the array.  
    */
   public MeasResultServCellListSCG_r12 (MeasResultServCellSCG_r12[] elements_) {
      elements = elements_;
   }
