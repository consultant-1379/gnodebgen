...
public class PLMN_IdentityList_MBMS_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PLMN-IdentityList-MBMS-r14";
   }

   public PLMN_Identity[] elements;

   public PLMN_IdentityList_MBMS_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_IdentityList_MBMS_r14 (int numRecords) {
    ...
    * given the array.  
    */
   public PLMN_IdentityList_MBMS_r14 (PLMN_Identity[] elements_) {
      elements = elements_;
   }
