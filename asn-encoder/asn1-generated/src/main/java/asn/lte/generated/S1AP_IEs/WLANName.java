...
public class WLANName extends Asn1OctetString {
    ...
    */
   public WLANName (byte[] data, int offset, int nbytes) {
    ...
    */
   public WLANName (String value_) throws Asn1ValueParseException {
      super (value_);
   }
