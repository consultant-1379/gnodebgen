...
public class RRCTransfer_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.reject
    * presence: Presence.optional
    * ASN.1 type: NRUeReport
    * Java type: NRUeReport
    *
    ...
    * presence: Presence.optional
    * ASN.1 type: EAB-RRCTransfer-ExtConveyor
    * Java type: EAB_RRCTransfer_ExtConveyor
    */
   public Asn1Type value;

   public RRCTransfer_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public RRCTransfer_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-SplitSRB
    */
   public void setUsing_id_SplitSRB(asn.lte.generated.X2AP_IEs.SplitSRB value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_SplitSRB);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-NRUeReport
    */
   public void setUsing_id_NRUeReport(asn.lte.generated.X2AP_IEs.NRUeReport value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_NRUeReport);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_RRCTransfer_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-SplitSRB
    */
   public asn.lte.generated.X2AP_IEs.SplitSRB getValueFor_id_SplitSRB() {
      return (asn.lte.generated.X2AP_IEs.SplitSRB) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-NRUeReport
    */
   public asn.lte.generated.X2AP_IEs.NRUeReport getValueFor_id_NRUeReport() {
      return (asn.lte.generated.X2AP_IEs.NRUeReport) this.value;
   }
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_RRCTransfer_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_RRCTransfer_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.RRCTransfer_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.RRCTransfer_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.RRCTransfer_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-SplitSRB\n");
      }
      else if (id.value == 243) {
         indent (_sb, _level+1);
         _sb.append("id = id-NRUeReport\n");
      }
