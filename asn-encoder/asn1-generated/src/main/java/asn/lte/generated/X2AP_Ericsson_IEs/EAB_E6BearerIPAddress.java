...
public class EAB_E6BearerIPAddress extends Asn1BitString {
    ...
    */
   public EAB_E6BearerIPAddress (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public EAB_E6BearerIPAddress (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public EAB_E6BearerIPAddress (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public EAB_E6BearerIPAddress (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public EAB_E6BearerIPAddress (java.util.BitSet bitSet) {
      super (bitSet);
   }
