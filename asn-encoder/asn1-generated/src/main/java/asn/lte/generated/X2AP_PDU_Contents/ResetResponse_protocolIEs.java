...
public class ResetResponse_protocolIEs extends Asn1SeqOf {
   ...
   public ResetResponse_protocolIEs_element[] elements;

   public ResetResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResetResponse_protocolIEs (int numRecords) {
      elements = new ResetResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ResetResponse_protocolIEs (ResetResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResetResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResetResponse_protocolIEs_element();
