...
public class PagingRecordList extends Asn1SeqOf {
   ...
   public PagingRecord[] elements;

   public PagingRecordList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PagingRecordList (int numRecords) {
      elements = new PagingRecord [numRecords];
   }
    ...
    * given the array.  
    */
   public PagingRecordList (PagingRecord[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PagingRecord [numElements];
