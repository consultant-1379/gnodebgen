...
public class MultiBandInfoList_v9e0 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MultiBandInfoList-v9e0";
   }

   public MultiBandInfo_v9e0[] elements;

   public MultiBandInfoList_v9e0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MultiBandInfoList_v9e0 (int numRecords) {
      elements = new MultiBandInfo_v9e0 [numRecords];
   }
    ...
    * given the array.  
    */
   public MultiBandInfoList_v9e0 (MultiBandInfo_v9e0[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MultiBandInfo_v9e0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MultiBandInfo_v9e0();
