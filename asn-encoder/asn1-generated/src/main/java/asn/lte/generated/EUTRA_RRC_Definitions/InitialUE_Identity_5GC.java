...
public class InitialUE_Identity_5GC extends Asn1Choice {
   ...
   public InitialUE_Identity_5GC () {
      super();
   }

   public InitialUE_Identity_5GC (byte choiceId_, Asn1Type element_) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            ng_5G_S_TMSI_Part1.decode (buffer, 40, 40);
         ...
         case 1: { 
            ...
            randomValue.decode (buffer, 40, 40);
