...
public class EmergencyAreaID_Broadcast extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EmergencyAreaID-Broadcast";
   }

   public EmergencyAreaID_Broadcast_Item[] elements;

   public EmergencyAreaID_Broadcast () {
      elements = null;
   }
    ...
    * populated.
    */
   public EmergencyAreaID_Broadcast (int numRecords) {
      elements = new EmergencyAreaID_Broadcast_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EmergencyAreaID_Broadcast (EmergencyAreaID_Broadcast_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EmergencyAreaID_Broadcast_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EmergencyAreaID_Broadcast_Item();
