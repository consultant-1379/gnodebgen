...
public class ProtectedFootprintTimePattern_iE_Extensions extends Asn1SeqOf {
   ...
   public ProtectedFootprintTimePattern_iE_Extensions_element[] elements;

   public ProtectedFootprintTimePattern_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ProtectedFootprintTimePattern_iE_Extensions (int numRecords) {
      elements = new ProtectedFootprintTimePattern_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ProtectedFootprintTimePattern_iE_Extensions (ProtectedFootprintTimePattern_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ProtectedFootprintTimePattern_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ProtectedFootprintTimePattern_iE_Extensions_element();
