...
public class SystemInformation_v8a0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SystemInformation-v8a0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public SystemInformation_v8a0_IEs_nonCriticalExtension nonCriticalExtension;  // optional

   public SystemInformation_v8a0_IEs () {
      super();
      init();
   }
   ...
   public SystemInformation_v8a0_IEs (
      ...
      SystemInformation_v8a0_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public SystemInformation_v8a0_IEs (byte[] lateNonCriticalExtension_,
      SystemInformation_v8a0_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new SystemInformation_v8a0_IEs_nonCriticalExtension();
