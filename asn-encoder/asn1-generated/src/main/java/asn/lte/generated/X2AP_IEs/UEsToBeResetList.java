...
public class UEsToBeResetList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "UEsToBeResetList";
   }

   public UEsToBeResetList_Item[] elements;

   public UEsToBeResetList () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEsToBeResetList (int numRecords) {
      elements = new UEsToBeResetList_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public UEsToBeResetList (UEsToBeResetList_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 8192);
      int numElements = (int) buffer.decodeLength();

      elements = new UEsToBeResetList_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEsToBeResetList_Item();
