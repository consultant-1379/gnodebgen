...
public class TimeSynchronisationInfo_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: MutingAvailabilityIndication
    * Java type: MutingAvailabilityIndication
    */
   public Asn1Type extensionValue;

   public TimeSynchronisationInfo_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public TimeSynchronisationInfo_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-Muting-Availability-Indication
    */
   public void setUsing_id_Muting_Availability_Indication(MutingAvailabilityIndication extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_Muting_Availability_Indication);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-Muting-Availability-Indication
    */
   public MutingAvailabilityIndication getExtensionValueFor_id_Muting_Availability_Indication() {
      return (MutingAvailabilityIndication) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.TimeSynchronisationInfo_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.TimeSynchronisationInfo_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.TimeSynchronisationInfo_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 207) {
         indent (_sb, _level+1);
         _sb.append("id = id-Muting-Availability-Indication\n");
      }
