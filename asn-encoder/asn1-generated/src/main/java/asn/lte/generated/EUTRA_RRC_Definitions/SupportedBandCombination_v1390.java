...
public class SupportedBandCombination_v1390 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-v1390";
   }

   public BandCombinationParameters_v1390[] elements;

   public SupportedBandCombination_v1390 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_v1390 (int numRecords) {
    ...
    * given the array.  
    */
   public SupportedBandCombination_v1390 (BandCombinationParameters_v1390[] elements_) {
      elements = elements_;
   }
