...
public class SeNBReleaseConfirm_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBReleaseConfirm_protocolIEs_element[] elements;

   public SeNBReleaseConfirm_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBReleaseConfirm_protocolIEs (int numRecords) {
      elements = new SeNBReleaseConfirm_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBReleaseConfirm_protocolIEs (SeNBReleaseConfirm_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBReleaseConfirm_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBReleaseConfirm_protocolIEs_element();
