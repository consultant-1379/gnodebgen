...
public class BandParametersUL_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandParametersUL-r10";
   }

   public CA_MIMO_ParametersUL_r10[] elements;

   public BandParametersUL_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandParametersUL_r10 (int numRecords) {
      elements = new CA_MIMO_ParametersUL_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandParametersUL_r10 (CA_MIMO_ParametersUL_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CA_MIMO_ParametersUL_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CA_MIMO_ParametersUL_r10();
