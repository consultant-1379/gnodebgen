...
public class VisitedCellInfoList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "VisitedCellInfoList-r12";
   }

   public VisitedCellInfo_r12[] elements;

   public VisitedCellInfoList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public VisitedCellInfoList_r12 (int numRecords) {
      elements = new VisitedCellInfo_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public VisitedCellInfoList_r12 (VisitedCellInfo_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new VisitedCellInfo_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new VisitedCellInfo_r12();
