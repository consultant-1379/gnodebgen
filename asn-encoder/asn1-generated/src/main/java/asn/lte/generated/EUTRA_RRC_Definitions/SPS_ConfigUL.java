...
public class SPS_ConfigUL extends Asn1Choice {
   ...
   public SPS_ConfigUL (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SPS_ConfigUL_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            SPS_ConfigUL_setup setup;
            element = setup = new SPS_ConfigUL_setup();
            setup.decode (buffer);
            break;
         }
