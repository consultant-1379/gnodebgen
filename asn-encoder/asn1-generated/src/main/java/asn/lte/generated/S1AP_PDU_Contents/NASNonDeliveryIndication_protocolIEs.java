...
public class NASNonDeliveryIndication_protocolIEs extends Asn1SeqOf {
   ...
   public NASNonDeliveryIndication_protocolIEs_element[] elements;

   public NASNonDeliveryIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public NASNonDeliveryIndication_protocolIEs (int numRecords) {
      elements = new NASNonDeliveryIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public NASNonDeliveryIndication_protocolIEs (NASNonDeliveryIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NASNonDeliveryIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NASNonDeliveryIndication_protocolIEs_element();
