...
public class ErrorIndication_protocolIEs_element extends Asn1Seq {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _LPPA_PDU_ContentsValues.ErrorIndication_IEs.length; i++) {
         if(_LPPA_PDU_ContentsValues.ErrorIndication_IEs[i].id.equals(id)) {
            _index = _LPPA_PDU_ContentsValues.ErrorIndication_IEs[i];
            break;
         }
      }
      if (null == _index) {
