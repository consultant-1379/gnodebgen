...
public class Paging_eDRXInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public Paging_eDRXInformation_iE_Extensions_element[] elements;

   public Paging_eDRXInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public Paging_eDRXInformation_iE_Extensions (int numRecords) {
      elements = new Paging_eDRXInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public Paging_eDRXInformation_iE_Extensions (Paging_eDRXInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Paging_eDRXInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Paging_eDRXInformation_iE_Extensions_element();
