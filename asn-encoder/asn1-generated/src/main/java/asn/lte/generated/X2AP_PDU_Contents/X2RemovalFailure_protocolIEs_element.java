...
public class X2RemovalFailure_protocolIEs_element extends Asn1Seq {
   ...
   public X2RemovalFailure_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public X2RemovalFailure_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.X2RemovalFailure_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.X2RemovalFailure_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.X2RemovalFailure_IEs[i];
            break;
         }
      }
      if (null == _index) {
