...
public class DeactivateTrace_protocolIEs_element extends Asn1Seq {
    ...
    * presence: Presence.mandatory
    * ASN.1 type: EUTRANTraceID
    * Java type: EUTRANTraceID
    */
   ...
   /**
    * Assign fields according to information object having key id-EUTRANTraceID
    */
   public void setUsing_id_EUTRANTraceID(asn.lte.generated.X2AP_IEs.EUTRANTraceID value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_EUTRANTraceID);
   ...
   /**
    * Get value of value with type set according to information object having key id-EUTRANTraceID
    */
   public asn.lte.generated.X2AP_IEs.EUTRANTraceID getValueFor_id_EUTRANTraceID() {
      return (asn.lte.generated.X2AP_IEs.EUTRANTraceID) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.DeactivateTraceIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.DeactivateTraceIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.DeactivateTraceIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 333) {
         indent (_sb, _level+1);
         _sb.append("id = id-EUTRANTraceID\n");
      }
