...
public class FreqPriorityListExtEUTRA_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "FreqPriorityListExtEUTRA-r12";
   }

   public FreqPriorityEUTRA_r12[] elements;

   public FreqPriorityListExtEUTRA_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FreqPriorityListExtEUTRA_r12 (int numRecords) {
      elements = new FreqPriorityEUTRA_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public FreqPriorityListExtEUTRA_r12 (FreqPriorityEUTRA_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqPriorityEUTRA_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqPriorityEUTRA_r12();
