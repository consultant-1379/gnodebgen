...
public class PMCH_InfoListExt_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PMCH-InfoListExt-r12";
   }

   public PMCH_InfoExt_r12[] elements;

   public PMCH_InfoListExt_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PMCH_InfoListExt_r12 (int numRecords) {
      elements = new PMCH_InfoExt_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public PMCH_InfoListExt_r12 (PMCH_InfoExt_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PMCH_InfoExt_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PMCH_InfoExt_r12();
