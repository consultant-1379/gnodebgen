...
public class SPS_ConfigToReleaseList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPS-ConfigToReleaseList-r16";
   }

   public SPS_ConfigIndex_r16[] elements;

   public SPS_ConfigToReleaseList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPS_ConfigToReleaseList_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public SPS_ConfigToReleaseList_r16 (SPS_ConfigIndex_r16[] elements_) {
      elements = elements_;
   }
