...
public class LocationReportingInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public LocationReportingInformation_iE_Extensions_element[] elements;

   public LocationReportingInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public LocationReportingInformation_iE_Extensions (int numRecords) {
      elements = new LocationReportingInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public LocationReportingInformation_iE_Extensions (LocationReportingInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LocationReportingInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LocationReportingInformation_iE_Extensions_element();
