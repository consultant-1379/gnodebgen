...
public class Cdma2000OneXMSI extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "Cdma2000OneXMSI";
   }

   public Cdma2000OneXMSI () {
      super();
   }
    ...
    *              in binary form.
    */
   public Cdma2000OneXMSI (byte[] data) {
      super (data);
   }
    ...
    */
   public Cdma2000OneXMSI (byte[] data, int offset, int nbytes) {
    ...
    */
   public Cdma2000OneXMSI (String value_) throws Asn1ValueParseException {
      super (value_);
   }
