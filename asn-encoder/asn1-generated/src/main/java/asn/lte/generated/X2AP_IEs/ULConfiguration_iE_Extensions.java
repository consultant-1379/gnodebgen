...
public class ULConfiguration_iE_Extensions extends Asn1SeqOf {
   ...
   public ULConfiguration_iE_Extensions_element[] elements;

   public ULConfiguration_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ULConfiguration_iE_Extensions (int numRecords) {
      elements = new ULConfiguration_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ULConfiguration_iE_Extensions (ULConfiguration_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ULConfiguration_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ULConfiguration_iE_Extensions_element();
