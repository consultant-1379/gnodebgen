...
public class IdleModeMobilityControlInfo_v9e0_freqPriorityListEUTRA_v9e0 extends Asn1SeqOf {
   ...
   public FreqPriorityEUTRA_v9e0[] elements;

   public IdleModeMobilityControlInfo_v9e0_freqPriorityListEUTRA_v9e0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public IdleModeMobilityControlInfo_v9e0_freqPriorityListEUTRA_v9e0 (int numRecords) {
      elements = new FreqPriorityEUTRA_v9e0 [numRecords];
   }
    ...
    * given the array.  
    */
   public IdleModeMobilityControlInfo_v9e0_freqPriorityListEUTRA_v9e0 (FreqPriorityEUTRA_v9e0[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqPriorityEUTRA_v9e0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqPriorityEUTRA_v9e0();
