...
public class ReplacingCellsList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ReplacingCellsList";
   }

   public ReplacingCellsList_Item[] elements;

   public ReplacingCellsList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ReplacingCellsList (int numRecords) {
      elements = new ReplacingCellsList_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ReplacingCellsList (ReplacingCellsList_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ReplacingCellsList_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ReplacingCellsList_Item();
