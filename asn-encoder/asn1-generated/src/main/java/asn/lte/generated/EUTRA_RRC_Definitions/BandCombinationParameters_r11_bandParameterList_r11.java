...
public class BandCombinationParameters_r11_bandParameterList_r11 extends Asn1SeqOf {
   ...
   public BandParameters_r11[] elements;

   public BandCombinationParameters_r11_bandParameterList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_r11_bandParameterList_r11 (int numRecords) {
      elements = new BandParameters_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_r11_bandParameterList_r11 (BandParameters_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_r11();
