...
public class TargetRNC_ToSourceRNC_TransparentContainer extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "TargetRNC-ToSourceRNC-TransparentContainer";
   }

   public TargetRNC_ToSourceRNC_TransparentContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public TargetRNC_ToSourceRNC_TransparentContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public TargetRNC_ToSourceRNC_TransparentContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public TargetRNC_ToSourceRNC_TransparentContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
