...
public class RecommendedENBList_element extends Asn1Seq {
    ...
    * ASN.1 type: RecommendedENBItem
    * Java type: RecommendedENBItem
    */
   public Asn1Type value;

   public RecommendedENBList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public RecommendedENBList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-RecommendedENBItem
    */
   public void setUsing_id_RecommendedENBItem(RecommendedENBItem value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_RecommendedENBItem);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-RecommendedENBItem
    */
   public RecommendedENBItem getValueFor_id_RecommendedENBItem() {
      return (RecommendedENBItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.RecommendedENBItemIEs.length; i++) {
         if(_S1AP_IEsValues.RecommendedENBItemIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.RecommendedENBItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 215) {
         indent (_sb, _level+1);
         _sb.append("id = id-RecommendedENBItem\n");
      }
