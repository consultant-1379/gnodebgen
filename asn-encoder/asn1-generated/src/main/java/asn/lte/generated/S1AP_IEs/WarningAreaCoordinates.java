...
public class WarningAreaCoordinates extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public WarningAreaCoordinates (byte[] data) {
      super (data);
   }
    ...
    */
   public WarningAreaCoordinates (byte[] data, int offset, int nbytes) {
    ...
    */
   public WarningAreaCoordinates (String value_) throws Asn1ValueParseException {
      super (value_);
   }
