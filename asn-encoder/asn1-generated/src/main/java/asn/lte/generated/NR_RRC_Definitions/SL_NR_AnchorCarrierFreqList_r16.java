...
public class SL_NR_AnchorCarrierFreqList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-NR-AnchorCarrierFreqList-r16";
   }

   public ARFCN_ValueNR[] elements;

   public SL_NR_AnchorCarrierFreqList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_NR_AnchorCarrierFreqList_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public SL_NR_AnchorCarrierFreqList_r16 (ARFCN_ValueNR[] elements_) {
      elements = elements_;
   }
