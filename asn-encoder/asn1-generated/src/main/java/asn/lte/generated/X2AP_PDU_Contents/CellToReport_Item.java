...
public class CellToReport_Item extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "CellToReport-Item";
   }

   public ECGI cell_ID;
   public CellToReport_Item_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public CellToReport_Item () {
      super();
      init();
   }
   ...
   public CellToReport_Item (
      ECGI cell_ID_,
      CellToReport_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      cell_ID = cell_ID_;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new CellToReport_Item_iE_Extensions();
