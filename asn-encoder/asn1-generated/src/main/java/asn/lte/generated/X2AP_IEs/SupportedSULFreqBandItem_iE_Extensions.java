...
public class SupportedSULFreqBandItem_iE_Extensions extends Asn1SeqOf {
   ...
   public SupportedSULFreqBandItem_iE_Extensions_element[] elements;

   public SupportedSULFreqBandItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedSULFreqBandItem_iE_Extensions (int numRecords) {
      elements = new SupportedSULFreqBandItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedSULFreqBandItem_iE_Extensions (SupportedSULFreqBandItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedSULFreqBandItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedSULFreqBandItem_iE_Extensions_element();
