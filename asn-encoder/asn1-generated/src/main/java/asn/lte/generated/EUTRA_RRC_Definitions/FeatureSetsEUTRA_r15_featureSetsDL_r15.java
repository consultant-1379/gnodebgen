...
public class FeatureSetsEUTRA_r15_featureSetsDL_r15 extends Asn1SeqOf {
   ...
   public FeatureSetDL_r15[] elements;

   public FeatureSetsEUTRA_r15_featureSetsDL_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSetsEUTRA_r15_featureSetsDL_r15 (int numRecords) {
      elements = new FeatureSetDL_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSetsEUTRA_r15_featureSetsDL_r15 (FeatureSetDL_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetDL_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetDL_r15();
