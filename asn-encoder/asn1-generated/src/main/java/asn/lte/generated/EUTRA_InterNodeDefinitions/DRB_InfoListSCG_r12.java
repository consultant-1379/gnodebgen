...
public class DRB_InfoListSCG_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "DRB-InfoListSCG-r12";
   }

   public DRB_InfoSCG_r12[] elements;

   public DRB_InfoListSCG_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public DRB_InfoListSCG_r12 (int numRecords) {
      elements = new DRB_InfoSCG_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public DRB_InfoListSCG_r12 (DRB_InfoSCG_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DRB_InfoSCG_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DRB_InfoSCG_r12();
