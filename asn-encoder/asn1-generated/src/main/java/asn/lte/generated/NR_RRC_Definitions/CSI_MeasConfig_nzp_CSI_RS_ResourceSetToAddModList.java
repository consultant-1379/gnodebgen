...
public class CSI_MeasConfig_nzp_CSI_RS_ResourceSetToAddModList extends Asn1SeqOf {
   ...
   public NZP_CSI_RS_ResourceSet[] elements;

   public CSI_MeasConfig_nzp_CSI_RS_ResourceSetToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_MeasConfig_nzp_CSI_RS_ResourceSetToAddModList (int numRecords) {
      elements = new NZP_CSI_RS_ResourceSet [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_MeasConfig_nzp_CSI_RS_ResourceSetToAddModList (NZP_CSI_RS_ResourceSet[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NZP_CSI_RS_ResourceSet [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NZP_CSI_RS_ResourceSet();
