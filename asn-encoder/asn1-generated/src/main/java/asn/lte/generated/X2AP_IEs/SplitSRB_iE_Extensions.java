...
public class SplitSRB_iE_Extensions extends Asn1SeqOf {
   ...
   public SplitSRB_iE_Extensions_element[] elements;

   public SplitSRB_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SplitSRB_iE_Extensions (int numRecords) {
      elements = new SplitSRB_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SplitSRB_iE_Extensions (SplitSRB_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SplitSRB_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SplitSRB_iE_Extensions_element();
