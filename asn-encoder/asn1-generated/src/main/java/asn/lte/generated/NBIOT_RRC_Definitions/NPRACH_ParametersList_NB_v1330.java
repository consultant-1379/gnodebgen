...
public class NPRACH_ParametersList_NB_v1330 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NPRACH-ParametersList-NB-v1330";
   }

   public NPRACH_Parameters_NB_v1330[] elements;

   public NPRACH_ParametersList_NB_v1330 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NPRACH_ParametersList_NB_v1330 (int numRecords) {
      elements = new NPRACH_Parameters_NB_v1330 [numRecords];
   }
    ...
    * given the array.  
    */
   public NPRACH_ParametersList_NB_v1330 (NPRACH_Parameters_NB_v1330[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NPRACH_Parameters_NB_v1330 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NPRACH_Parameters_NB_v1330();
