...
public class SL_CommTxPoolList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-CommTxPoolList-r12";
   }

   public SL_CommResourcePool_r12[] elements;

   public SL_CommTxPoolList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_CommTxPoolList_r12 (int numRecords) {
    ...
    * given the array.  
    */
   public SL_CommTxPoolList_r12 (SL_CommResourcePool_r12[] elements_) {
      elements = elements_;
   }
