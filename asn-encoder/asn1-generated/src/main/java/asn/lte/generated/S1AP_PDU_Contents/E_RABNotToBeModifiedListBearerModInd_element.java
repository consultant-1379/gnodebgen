...
public class E_RABNotToBeModifiedListBearerModInd_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABNotToBeModifiedItemBearerModInd
    * Java type: E_RABNotToBeModifiedItemBearerModInd
    */
   public Asn1Type value;

   public E_RABNotToBeModifiedListBearerModInd_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABNotToBeModifiedListBearerModInd_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABNotToBeModifiedItemBearerModInd
    */
   public void setUsing_id_E_RABNotToBeModifiedItemBearerModInd(E_RABNotToBeModifiedItemBearerModInd value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABNotToBeModifiedItemBearerModInd);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABNotToBeModifiedItemBearerModInd
    */
   public E_RABNotToBeModifiedItemBearerModInd getValueFor_id_E_RABNotToBeModifiedItemBearerModInd() {
      return (E_RABNotToBeModifiedItemBearerModInd) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABNotToBeModifiedItemBearerModIndIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABNotToBeModifiedItemBearerModIndIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABNotToBeModifiedItemBearerModIndIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 202) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABNotToBeModifiedItemBearerModInd\n");
      }
