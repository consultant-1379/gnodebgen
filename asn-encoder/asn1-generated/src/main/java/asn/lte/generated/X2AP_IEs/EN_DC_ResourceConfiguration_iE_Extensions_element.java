...
public class EN_DC_ResourceConfiguration_iE_Extensions_element extends Asn1Seq {
   ...
   public EN_DC_ResourceConfiguration_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EN_DC_ResourceConfiguration_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.EN_DC_ResourceConfigurationExtIEs.length; i++) {
         if(_X2AP_IEsValues.EN_DC_ResourceConfigurationExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.EN_DC_ResourceConfigurationExtIEs[i];
            break;
         }
      }
      if (null == _index) {
