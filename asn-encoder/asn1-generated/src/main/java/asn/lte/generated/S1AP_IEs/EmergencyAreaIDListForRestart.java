...
public class EmergencyAreaIDListForRestart extends Asn1SeqOf {
   ...
   public EmergencyAreaID[] elements;

   public EmergencyAreaIDListForRestart () {
      elements = null;
   }
    ...
    * populated.
    */
   public EmergencyAreaIDListForRestart (int numRecords) {
      elements = new EmergencyAreaID [numRecords];
   }
    ...
    * given the array.  
    */
   public EmergencyAreaIDListForRestart (EmergencyAreaID[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EmergencyAreaID [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EmergencyAreaID();
