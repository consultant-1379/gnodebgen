...
public class SecondaryRATUsageReportList_element extends Asn1Seq {
   ...
   /**
    * id: id-SecondaryRATUsageReport-Item
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: SecondaryRATUsageReport-Item
    * Java type: SecondaryRATUsageReport_Item
    */
   public Asn1Type value;

   public SecondaryRATUsageReportList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SecondaryRATUsageReportList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-SecondaryRATUsageReport-Item
    */
   public void setUsing_id_SecondaryRATUsageReport_Item(SecondaryRATUsageReport_Item value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_SecondaryRATUsageReport_Item);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-SecondaryRATUsageReport-Item
    */
   public SecondaryRATUsageReport_Item getValueFor_id_SecondaryRATUsageReport_Item() {
      return (SecondaryRATUsageReport_Item) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.SecondaryRATUsageReport_ItemIEs.length; i++) {
         if(_X2AP_IEsValues.SecondaryRATUsageReport_ItemIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.SecondaryRATUsageReport_ItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 266) {
         indent (_sb, _level+1);
         _sb.append("id = id-SecondaryRATUsageReport-Item\n");
      }
