...
public class UE_RLF_Report_Container extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "UE-RLF-Report-Container";
   }

   public UE_RLF_Report_Container () {
      super();
   }
    ...
    *              in binary form.
    */
   public UE_RLF_Report_Container (byte[] data) {
      super (data);
   }
    ...
    */
   public UE_RLF_Report_Container (byte[] data, int offset, int nbytes) {
    ...
    */
   public UE_RLF_Report_Container (String value_) throws Asn1ValueParseException {
      super (value_);
   }
