...
public class BandCombinationParameters_v1380_bandParameterList_v1380 extends Asn1SeqOf {
   ...
   public BandParameters_v1380[] elements;

   public BandCombinationParameters_v1380_bandParameterList_v1380 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_v1380_bandParameterList_v1380 (int numRecords) {
      elements = new BandParameters_v1380 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_v1380_bandParameterList_v1380 (BandParameters_v1380[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_v1380 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_v1380();
