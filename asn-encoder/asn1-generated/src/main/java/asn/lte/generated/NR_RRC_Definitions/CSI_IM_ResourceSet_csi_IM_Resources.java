...
public class CSI_IM_ResourceSet_csi_IM_Resources extends Asn1SeqOf {
   ...
   public CSI_IM_ResourceSet_csi_IM_Resources () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_IM_ResourceSet_csi_IM_Resources (int numRecords) {
    ...
    * given the array.  
    */
   public CSI_IM_ResourceSet_csi_IM_Resources (CSI_IM_ResourceId[] elements_) {
      elements = elements_;
   }
