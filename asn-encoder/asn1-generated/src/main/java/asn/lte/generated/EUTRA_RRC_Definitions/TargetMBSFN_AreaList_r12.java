...
public class TargetMBSFN_AreaList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "TargetMBSFN-AreaList-r12";
   }

   public TargetMBSFN_Area_r12[] elements;

   public TargetMBSFN_AreaList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public TargetMBSFN_AreaList_r12 (int numRecords) {
      elements = new TargetMBSFN_Area_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public TargetMBSFN_AreaList_r12 (TargetMBSFN_Area_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TargetMBSFN_Area_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TargetMBSFN_Area_r12();
