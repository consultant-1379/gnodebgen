...
public class ENSA_ServedNRCellList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ENSA-ServedNRCellList";
   }

   public ENSA_ServedNRCellList_element[] elements;

   public ENSA_ServedNRCellList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENSA_ServedNRCellList (int numRecords) {
      elements = new ENSA_ServedNRCellList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENSA_ServedNRCellList (ENSA_ServedNRCellList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (0, 256);
      int numElements = (int) buffer.decodeLength();

      elements = new ENSA_ServedNRCellList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENSA_ServedNRCellList_element();
