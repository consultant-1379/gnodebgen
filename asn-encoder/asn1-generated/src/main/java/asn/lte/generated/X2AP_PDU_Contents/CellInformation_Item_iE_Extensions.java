...
public class CellInformation_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public CellInformation_Item_iE_Extensions_element[] elements;

   public CellInformation_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellInformation_Item_iE_Extensions (int numRecords) {
      elements = new CellInformation_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellInformation_Item_iE_Extensions (CellInformation_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellInformation_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellInformation_Item_iE_Extensions_element();
