...
public class ServedCells_element_iE_Extensions_element extends Asn1Seq {
   ...
   public ServedCells_element_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ServedCells_element_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-NRNeighbourInfoToAdd
    */
   public void setUsing_id_NRNeighbourInfoToAdd(NRNeighbour_Information extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_NRNeighbourInfoToAdd);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-NRNeighbourInfoToAdd
    */
   public NRNeighbour_Information getExtensionValueFor_id_NRNeighbourInfoToAdd() {
      return (NRNeighbour_Information) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.ServedCell_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.ServedCell_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.ServedCell_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 327) {
         indent (_sb, _level+1);
         _sb.append("id = id-NRNeighbourInfoToAdd\n");
      }
