...
public class PSCellInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public PSCellInformation_iE_Extensions_element[] elements;

   public PSCellInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public PSCellInformation_iE_Extensions (int numRecords) {
      elements = new PSCellInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PSCellInformation_iE_Extensions (PSCellInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PSCellInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PSCellInformation_iE_Extensions_element();
