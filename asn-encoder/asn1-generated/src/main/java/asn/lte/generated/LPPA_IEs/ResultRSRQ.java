...
public class ResultRSRQ extends Asn1SeqOf {
   ...
   public ResultRSRQ_Item[] elements;
    ...
    * populated.
    */
   public ResultRSRQ (int numRecords) {
      elements = new ResultRSRQ_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ResultRSRQ (ResultRSRQ_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResultRSRQ_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResultRSRQ_Item();
