...
public class E_RABs_SubjectToCounterCheck_List_element extends Asn1Seq {
   ...
   /**
    * id: id-E-RABs-SubjectToCounterCheckItem
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABs-SubjectToCounterCheckItem
    * Java type: E_RABs_SubjectToCounterCheckItem
    */
   public Asn1Type value;

   public E_RABs_SubjectToCounterCheck_List_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABs_SubjectToCounterCheck_List_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-SubjectToCounterCheckItem
    */
   public void setUsing_id_E_RABs_SubjectToCounterCheckItem(E_RABs_SubjectToCounterCheckItem value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_SubjectToCounterCheckItem);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABs-SubjectToCounterCheckItem
    */
   public E_RABs_SubjectToCounterCheckItem getValueFor_id_E_RABs_SubjectToCounterCheckItem() {
      return (E_RABs_SubjectToCounterCheckItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.E_RABs_SubjectToCounterCheckItemIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.E_RABs_SubjectToCounterCheckItemIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.E_RABs_SubjectToCounterCheckItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 142) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-SubjectToCounterCheckItem\n");
      }
