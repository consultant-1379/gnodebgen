...
public class MultiBandInfoList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MultiBandInfoList-NB-r13";
   }

   public MultiBandInfo_NB_r13[] elements;

   public MultiBandInfoList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MultiBandInfoList_NB_r13 (int numRecords) {
      elements = new MultiBandInfo_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public MultiBandInfoList_NB_r13 (MultiBandInfo_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MultiBandInfo_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MultiBandInfo_NB_r13();
