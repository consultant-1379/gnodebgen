...
public class ReportCharacteristics extends Asn1BitString {
    ...
    */
   public ReportCharacteristics (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public ReportCharacteristics (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public ReportCharacteristics (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public ReportCharacteristics (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public ReportCharacteristics (java.util.BitSet bitSet) {
      super (bitSet);
   }
