...
public class DLResourceBitmapULandDLSharing extends DataTrafficResources {
   ...
   public String getAsn1TypeName()  {
      return "DLResourceBitmapULandDLSharing";
   }
    ...
    */
   public DLResourceBitmapULandDLSharing () {
      super();
      value = new byte [2200];
   }
    ...
    */
   public DLResourceBitmapULandDLSharing (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public DLResourceBitmapULandDLSharing (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public DLResourceBitmapULandDLSharing (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public DLResourceBitmapULandDLSharing (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public DLResourceBitmapULandDLSharing (java.util.BitSet bitSet) {
      super (bitSet);
   }
