...
public class VarMeasConfig_speedStatePars extends Asn1Choice {
   ...
   public VarMeasConfig_speedStatePars () {
      super();
   }

   public VarMeasConfig_speedStatePars (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (VarMeasConfig_speedStatePars_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            VarMeasConfig_speedStatePars_setup setup;
            element = setup = new VarMeasConfig_speedStatePars_setup();
            setup.decode (buffer);
            break;
         }
