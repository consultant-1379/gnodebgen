...
public class CellID_Cancelled extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellID-Cancelled";
   }

   public CellID_Cancelled_Item[] elements;

   public CellID_Cancelled () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellID_Cancelled (int numRecords) {
      elements = new CellID_Cancelled_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public CellID_Cancelled (CellID_Cancelled_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellID_Cancelled_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellID_Cancelled_Item();
