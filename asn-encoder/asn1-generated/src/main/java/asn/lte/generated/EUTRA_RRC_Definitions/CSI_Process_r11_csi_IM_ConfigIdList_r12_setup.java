...
public class CSI_Process_r11_csi_IM_ConfigIdList_r12_setup extends Asn1SeqOf {
   ...
   public CSI_IM_ConfigId_r12[] elements;

   public CSI_Process_r11_csi_IM_ConfigIdList_r12_setup () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_Process_r11_csi_IM_ConfigIdList_r12_setup (int numRecords) {
      elements = new CSI_IM_ConfigId_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_Process_r11_csi_IM_ConfigIdList_r12_setup (CSI_IM_ConfigId_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_IM_ConfigId_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_IM_ConfigId_r12();
