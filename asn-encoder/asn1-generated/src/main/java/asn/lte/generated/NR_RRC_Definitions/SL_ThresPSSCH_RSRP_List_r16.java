...
public class SL_ThresPSSCH_RSRP_List_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-ThresPSSCH-RSRP-List-r16";
   }

   public SL_ThresPSSCH_RSRP_r16[] elements;

   public SL_ThresPSSCH_RSRP_List_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_ThresPSSCH_RSRP_List_r16 (int numRecords) {
      elements = new SL_ThresPSSCH_RSRP_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_ThresPSSCH_RSRP_List_r16 (SL_ThresPSSCH_RSRP_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (64, 64);
      int numElements = (int) buffer.decodeLength();

      elements = new SL_ThresPSSCH_RSRP_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_ThresPSSCH_RSRP_r16();
