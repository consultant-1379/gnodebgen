...
public class BandCombinationList extends Asn1SeqOf {
   ...
   public BandCombination[] elements;

   public BandCombinationList () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationList (int numRecords) {
      elements = new BandCombination [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationList (BandCombination[] elements_) {
      elements = elements_;
   }
   ...
   {
      int fraglen = 0;
      java.util.LinkedList<BandCombination> tmplist = 
         new java.util.LinkedList<BandCombination>();
      BandCombination value;
      ...
      elements = new BandCombination [tmplist.size()];
