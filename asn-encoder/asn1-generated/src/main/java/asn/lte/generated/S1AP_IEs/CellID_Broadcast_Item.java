...
public class CellID_Broadcast_Item extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "CellID-Broadcast-Item";
   }

   public EUTRAN_CGI eCGI;
   public CellID_Broadcast_Item_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public CellID_Broadcast_Item () {
      super();
      init();
   }
   ...
   public CellID_Broadcast_Item (
      EUTRAN_CGI eCGI_,
      CellID_Broadcast_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      eCGI = eCGI_;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new CellID_Broadcast_Item_iE_Extensions();
