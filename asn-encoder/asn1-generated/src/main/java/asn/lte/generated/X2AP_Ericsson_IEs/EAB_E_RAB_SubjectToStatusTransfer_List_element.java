...
public class EAB_E_RAB_SubjectToStatusTransfer_List_element extends Asn1Seq {
   ...
   /**
    * id: eid-E-RAB-SubjectToStatusTransfer-Item
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: EAB-E-RAB-SubjectToStatusTransfer-Item
    * Java type: EAB_E_RAB_SubjectToStatusTransfer_Item
    */
   public Asn1Type value;

   public EAB_E_RAB_SubjectToStatusTransfer_List_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_E_RAB_SubjectToStatusTransfer_List_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-E-RAB-SubjectToStatusTransfer-Item
    */
   public void setUsing_eid_E_RAB_SubjectToStatusTransfer_Item(EAB_E_RAB_SubjectToStatusTransfer_Item value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_E_RAB_SubjectToStatusTransfer_Item);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key eid-E-RAB-SubjectToStatusTransfer-Item
    */
   public EAB_E_RAB_SubjectToStatusTransfer_Item getValueFor_eid_E_RAB_SubjectToStatusTransfer_Item() {
      return (EAB_E_RAB_SubjectToStatusTransfer_Item) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_E_RAB_SubjectToStatusTransfer_ItemIEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_E_RAB_SubjectToStatusTransfer_ItemIEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_E_RAB_SubjectToStatusTransfer_ItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 24) {
         indent (_sb, _level+1);
         _sb.append("id = eid-E-RAB-SubjectToStatusTransfer-Item\n");
      }
