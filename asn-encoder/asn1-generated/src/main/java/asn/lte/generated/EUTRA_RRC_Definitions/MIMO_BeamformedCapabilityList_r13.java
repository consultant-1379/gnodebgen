...
public class MIMO_BeamformedCapabilityList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MIMO-BeamformedCapabilityList-r13";
   }

   public MIMO_BeamformedCapabilities_r13[] elements;

   public MIMO_BeamformedCapabilityList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MIMO_BeamformedCapabilityList_r13 (int numRecords) {
      elements = new MIMO_BeamformedCapabilities_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public MIMO_BeamformedCapabilityList_r13 (MIMO_BeamformedCapabilities_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MIMO_BeamformedCapabilities_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MIMO_BeamformedCapabilities_r13();
