...
public class X2TNLConfigurationInfo_iE_Extensions extends Asn1SeqOf {
   ...
   public X2TNLConfigurationInfo_iE_Extensions_element[] elements;

   public X2TNLConfigurationInfo_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public X2TNLConfigurationInfo_iE_Extensions (int numRecords) {
      elements = new X2TNLConfigurationInfo_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public X2TNLConfigurationInfo_iE_Extensions (X2TNLConfigurationInfo_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new X2TNLConfigurationInfo_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new X2TNLConfigurationInfo_iE_Extensions_element();
