...
public class Global_ENB_ID extends Asn1Seq {
   ...
   public ENB_ID eNB_ID;
   public Global_ENB_ID_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public Global_ENB_ID () {
      super();
      init();
   }
   ...
   public Global_ENB_ID (
      ...
      ENB_ID eNB_ID_,
      Global_ENB_ID_iE_Extensions iE_Extensions_
   ) {
      super();
      pLMNidentity = pLMNidentity_;
      eNB_ID = eNB_ID_;
    ...
    * the given objects 
    */
   public Global_ENB_ID (byte[] pLMNidentity_,
      ENB_ID eNB_ID_,
      Global_ENB_ID_iE_Extensions iE_Extensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.getContext().eventDispatcher.startElement("eNB_ID", -1);

      eNB_ID = new ENB_ID();
      eNB_ID.decode (buffer);
      buffer.getContext().eventDispatcher.endElement("eNB_ID", -1);
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new Global_ENB_ID_iE_Extensions();
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (eNB_ID != null) eNB_ID.print (_sb, "eNB_ID", _level+1);
