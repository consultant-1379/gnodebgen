...
public class E_RABs_ToBeAdded_SgNBAddReq_Item_SgNBPDCPpresent extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeAdded-SgNBAddReq-Item-SgNBPDCPpresent";
   }

   public E_RAB_Level_QoS_Parameters full_E_RAB_Level_QoS_Parameters;
   public GBR_QosInformation max_MCG_admit_E_RAB_Level_QoS_Parameters;  // optional
   ...
   public E_RABs_ToBeAdded_SgNBAddReq_Item_SgNBPDCPpresent_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public E_RABs_ToBeAdded_SgNBAddReq_Item_SgNBPDCPpresent () {
      super();
      init();
   }
   ...
   public E_RABs_ToBeAdded_SgNBAddReq_Item_SgNBPDCPpresent (
      ...
      GBR_QosInformation max_MCG_admit_E_RAB_Level_QoS_Parameters_,
      DL_Forwarding dL_Forwarding_,
      GTPtunnelEndpoint meNB_DL_GTP_TEIDatMCG_,
      GTPtunnelEndpoint s1_UL_GTPtunnelEndpoint_,
      E_RABs_ToBeAdded_SgNBAddReq_Item_SgNBPDCPpresent_iE_Extensions iE_Extensions_
   ) {
      super();
      full_E_RAB_Level_QoS_Parameters = full_E_RAB_Level_QoS_Parameters_;
      max_MCG_admit_E_RAB_Level_QoS_Parameters = max_MCG_admit_E_RAB_Level_QoS_Parameters_;
      dL_Forwarding = dL_Forwarding_;
   ...
   public void init () {
      ...
      max_MCG_admit_E_RAB_Level_QoS_Parameters = null;
      dL_Forwarding = null;
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 1: return max_MCG_admit_E_RAB_Level_QoS_Parameters;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 1: return "max-MCG-admit-E-RAB-Level-QoS-Parameters";
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      boolean max_MCG_admit_E_RAB_Level_QoS_ParametersPresent = buffer.decodeBit ("max_MCG_admit_E_RAB_Level_QoS_ParametersPresent");
      ...
      // decode max_MCG_admit_E_RAB_Level_QoS_Parameters

      if (max_MCG_admit_E_RAB_Level_QoS_ParametersPresent) {
         buffer.getContext().eventDispatcher.startElement("max_MCG_admit_E_RAB_Level_QoS_Parameters", -1);

         max_MCG_admit_E_RAB_Level_QoS_Parameters = new GBR_QosInformation();
         max_MCG_admit_E_RAB_Level_QoS_Parameters.decode (buffer);
         buffer.getContext().eventDispatcher.endElement("max_MCG_admit_E_RAB_Level_QoS_Parameters", -1);
      }
      else {
         max_MCG_admit_E_RAB_Level_QoS_Parameters = null;
      }
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new E_RABs_ToBeAdded_SgNBAddReq_Item_SgNBPDCPpresent_iE_Extensions();
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (max_MCG_admit_E_RAB_Level_QoS_Parameters != null) max_MCG_admit_E_RAB_Level_QoS_Parameters.print (_sb, "max_MCG_admit_E_RAB_Level_QoS_Parameters", _level+1);
