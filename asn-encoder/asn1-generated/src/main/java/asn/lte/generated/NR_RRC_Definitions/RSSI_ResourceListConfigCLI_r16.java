...
public class RSSI_ResourceListConfigCLI_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RSSI-ResourceListConfigCLI-r16";
   }

   public RSSI_ResourceConfigCLI_r16[] elements;

   public RSSI_ResourceListConfigCLI_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RSSI_ResourceListConfigCLI_r16 (int numRecords) {
      elements = new RSSI_ResourceConfigCLI_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public RSSI_ResourceListConfigCLI_r16 (RSSI_ResourceConfigCLI_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RSSI_ResourceConfigCLI_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RSSI_ResourceConfigCLI_r16();
