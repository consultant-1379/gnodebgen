...
public class SRB_ToAddMod_rlc_Config extends Asn1Choice {
   ...
   public SRB_ToAddMod_rlc_Config () {
      super();
   }

   public SRB_ToAddMod_rlc_Config (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_explicitValue (RLC_Config value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            element = explicitValue = new RLC_Config();
