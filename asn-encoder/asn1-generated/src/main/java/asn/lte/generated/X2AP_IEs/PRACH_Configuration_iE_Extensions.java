...
public class PRACH_Configuration_iE_Extensions extends Asn1SeqOf {
   ...
   public PRACH_Configuration_iE_Extensions_element[] elements;

   public PRACH_Configuration_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public PRACH_Configuration_iE_Extensions (int numRecords) {
      elements = new PRACH_Configuration_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PRACH_Configuration_iE_Extensions (PRACH_Configuration_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PRACH_Configuration_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PRACH_Configuration_iE_Extensions_element();
