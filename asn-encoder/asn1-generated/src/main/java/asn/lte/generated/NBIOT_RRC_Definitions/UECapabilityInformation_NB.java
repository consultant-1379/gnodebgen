...
public class UECapabilityInformation_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UECapabilityInformation-NB";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier;
   public UECapabilityInformation_NB_criticalExtensions criticalExtensions;

   public UECapabilityInformation_NB () {
      super();
      init();
   }
   ...
   public UECapabilityInformation_NB (
      ...
      UECapabilityInformation_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public UECapabilityInformation_NB (long rrc_TransactionIdentifier_,
      UECapabilityInformation_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new UECapabilityInformation_NB_criticalExtensions();
