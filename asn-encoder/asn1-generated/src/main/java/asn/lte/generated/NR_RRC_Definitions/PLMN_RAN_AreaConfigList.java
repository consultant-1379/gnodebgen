...
public class PLMN_RAN_AreaConfigList extends Asn1SeqOf {
   ...
   public PLMN_RAN_AreaConfig[] elements;

   public PLMN_RAN_AreaConfigList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_RAN_AreaConfigList (int numRecords) {
      elements = new PLMN_RAN_AreaConfig [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMN_RAN_AreaConfigList (PLMN_RAN_AreaConfig[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PLMN_RAN_AreaConfig [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PLMN_RAN_AreaConfig();
