...
public class UserLocationInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public UserLocationInformation_iE_Extensions_element[] elements;

   public UserLocationInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public UserLocationInformation_iE_Extensions (int numRecords) {
      elements = new UserLocationInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UserLocationInformation_iE_Extensions (UserLocationInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UserLocationInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UserLocationInformation_iE_Extensions_element();
