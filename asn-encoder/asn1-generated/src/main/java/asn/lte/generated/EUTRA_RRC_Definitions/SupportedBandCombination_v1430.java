...
public class SupportedBandCombination_v1430 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-v1430";
   }

   public BandCombinationParameters_v1430[] elements;

   public SupportedBandCombination_v1430 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_v1430 (int numRecords) {
    ...
    * given the array.  
    */
   public SupportedBandCombination_v1430 (BandCombinationParameters_v1430[] elements_) {
      elements = elements_;
   }
