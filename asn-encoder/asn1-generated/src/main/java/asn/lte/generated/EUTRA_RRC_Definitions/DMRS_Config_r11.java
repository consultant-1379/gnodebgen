...
public class DMRS_Config_r11 extends Asn1Choice {
   ...
   public DMRS_Config_r11 () {
      super();
   }

   public DMRS_Config_r11 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (DMRS_Config_r11_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            DMRS_Config_r11_setup setup;
            element = setup = new DMRS_Config_r11_setup();
            setup.decode (buffer);
            break;
         }
