...
public class OTDOACells extends Asn1SeqOf {
   ...
   public OTDOACells_element[] elements;
    ...
    * populated.
    */
   public OTDOACells (int numRecords) {
      elements = new OTDOACells_element [numRecords];
   }
    ...
    * given the array.  
    */
   public OTDOACells (OTDOACells_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new OTDOACells_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new OTDOACells_element();
