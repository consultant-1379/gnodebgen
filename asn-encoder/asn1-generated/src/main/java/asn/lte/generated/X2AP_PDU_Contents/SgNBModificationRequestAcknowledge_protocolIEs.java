...
public class SgNBModificationRequestAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBModificationRequestAcknowledge_protocolIEs_element[] elements;

   public SgNBModificationRequestAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBModificationRequestAcknowledge_protocolIEs (int numRecords) {
      elements = new SgNBModificationRequestAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBModificationRequestAcknowledge_protocolIEs (SgNBModificationRequestAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBModificationRequestAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBModificationRequestAcknowledge_protocolIEs_element();
