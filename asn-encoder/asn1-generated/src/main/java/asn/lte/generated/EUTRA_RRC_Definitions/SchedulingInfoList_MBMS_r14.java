...
public class SchedulingInfoList_MBMS_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SchedulingInfoList-MBMS-r14";
   }

   public SchedulingInfo_MBMS_r14[] elements;

   public SchedulingInfoList_MBMS_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SchedulingInfoList_MBMS_r14 (int numRecords) {
      elements = new SchedulingInfo_MBMS_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public SchedulingInfoList_MBMS_r14 (SchedulingInfo_MBMS_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SchedulingInfo_MBMS_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SchedulingInfo_MBMS_r14();
