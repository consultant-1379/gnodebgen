...
public class LogMeasResultListWLAN_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "LogMeasResultListWLAN-r15";
   }

   public LogMeasResultWLAN_r15[] elements;

   public LogMeasResultListWLAN_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public LogMeasResultListWLAN_r15 (int numRecords) {
      elements = new LogMeasResultWLAN_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public LogMeasResultListWLAN_r15 (LogMeasResultWLAN_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LogMeasResultWLAN_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LogMeasResultWLAN_r15();
