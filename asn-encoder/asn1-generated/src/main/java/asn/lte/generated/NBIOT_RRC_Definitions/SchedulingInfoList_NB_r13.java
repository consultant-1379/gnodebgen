...
public class SchedulingInfoList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SchedulingInfoList-NB-r13";
   }

   public SchedulingInfo_NB_r13[] elements;

   public SchedulingInfoList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SchedulingInfoList_NB_r13 (int numRecords) {
      elements = new SchedulingInfo_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SchedulingInfoList_NB_r13 (SchedulingInfo_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SchedulingInfo_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SchedulingInfo_NB_r13();
