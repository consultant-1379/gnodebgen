...
public class E_RABs_ToBeReleased_SgNBModReqdList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeReleased-SgNBModReqdList";
   }

   public E_RABs_ToBeReleased_SgNBModReqdList_element[] elements;

   public E_RABs_ToBeReleased_SgNBModReqdList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeReleased_SgNBModReqdList (int numRecords) {
      elements = new E_RABs_ToBeReleased_SgNBModReqdList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeReleased_SgNBModReqdList (E_RABs_ToBeReleased_SgNBModReqdList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeReleased_SgNBModReqdList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeReleased_SgNBModReqdList_element();
