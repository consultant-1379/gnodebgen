...
public class NG_eNB_iE_Extensions extends Asn1SeqOf {
   ...
   public NG_eNB_iE_Extensions_element[] elements;

   public NG_eNB_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public NG_eNB_iE_Extensions (int numRecords) {
      elements = new NG_eNB_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public NG_eNB_iE_Extensions (NG_eNB_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NG_eNB_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NG_eNB_iE_Extensions_element();
