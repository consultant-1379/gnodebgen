...
public class EAB_ThroughputEstimationRequest_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: eid-CoveringCell-List
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: EAB-CoveringCell-List
    * Java type: EAB_CoveringCell_List
    */
   public Asn1Type value;

   public EAB_ThroughputEstimationRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_ThroughputEstimationRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-CoveringCell-List
    */
   public void setUsing_eid_CoveringCell_List(EAB_CoveringCell_List value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Ericsson_Constants._S1AP_Ericsson_ConstantsValues.eid_CoveringCell_List);
   ...
   /**
    * Get value of value with type set according to information object having key eid-CoveringCell-List
    */
   public EAB_CoveringCell_List getValueFor_eid_CoveringCell_List() {
      return (EAB_CoveringCell_List) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_Ericsson_PDU_ContentsValues.EAB_ThroughputEstimationRequest_IEs.length; i++) {
         if(_S1AP_Ericsson_PDU_ContentsValues.EAB_ThroughputEstimationRequest_IEs[i].id.equals(id)) {
            _index = _S1AP_Ericsson_PDU_ContentsValues.EAB_ThroughputEstimationRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 4104) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = eid-CoveringCell-List\n");
      }
