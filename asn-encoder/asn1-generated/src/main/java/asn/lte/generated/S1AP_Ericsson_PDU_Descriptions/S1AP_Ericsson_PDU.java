...
public class S1AP_Ericsson_PDU extends Asn1Choice {
   ...
   public S1AP_Ericsson_PDU () {
      super();
   }

   public S1AP_Ericsson_PDU (byte choiceId_, Asn1Type element_) {
      super();
