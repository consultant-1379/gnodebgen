...
public class RRCEarlyDataRequest_NB_r15_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCEarlyDataRequest-NB-r15-IEs";
   }

   public S_TMSI s_TMSI_r15;
   public RRCEarlyDataRequest_NB_r15_IEs_establishmentCause_r15 establishmentCause_r15 = null;
   public CQI_NPDCCH_NB_r14 cqi_NPDCCH_r15 = null;  // optional
   public DedicatedInfoNAS dedicatedInfoNAS_r15;
   public RRCEarlyDataRequest_NB_r15_IEs_nonCriticalExtension nonCriticalExtension;  // optional

   public RRCEarlyDataRequest_NB_r15_IEs () {
      super();
      init();
   }
   ...
   public RRCEarlyDataRequest_NB_r15_IEs (
      S_TMSI s_TMSI_r15_,
      RRCEarlyDataRequest_NB_r15_IEs_establishmentCause_r15 establishmentCause_r15_,
      CQI_NPDCCH_NB_r14 cqi_NPDCCH_r15_,
      DedicatedInfoNAS dedicatedInfoNAS_r15_,
      RRCEarlyDataRequest_NB_r15_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
      s_TMSI_r15 = s_TMSI_r15_;
      establishmentCause_r15 = establishmentCause_r15_;
      cqi_NPDCCH_r15 = cqi_NPDCCH_r15_;
    ...
    * the given objects 
    */
   public RRCEarlyDataRequest_NB_r15_IEs (S_TMSI s_TMSI_r15_,
      RRCEarlyDataRequest_NB_r15_IEs_establishmentCause_r15 establishmentCause_r15_,
      CQI_NPDCCH_NB_r14 cqi_NPDCCH_r15_,
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 2: return cqi_NPDCCH_r15;
         case 3: return dedicatedInfoNAS_r15;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 2: return "cqi-NPDCCH-r15";
         case 3: return "dedicatedInfoNAS-r15";
         case 4: return "nonCriticalExtension";
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      boolean cqi_NPDCCH_r15Present = buffer.decodeBit ("cqi_NPDCCH_r15Present");
      ...
      {
         int tval = RRCEarlyDataRequest_NB_r15_IEs_establishmentCause_r15.decodeEnumValue (buffer);
         establishmentCause_r15 = RRCEarlyDataRequest_NB_r15_IEs_establishmentCause_r15.valueOf (tval);
      }
      buffer.getContext().eventDispatcher.endElement("establishmentCause_r15", -1);

      // decode cqi_NPDCCH_r15

      if (cqi_NPDCCH_r15Present) {
         buffer.getContext().eventDispatcher.startElement("cqi_NPDCCH_r15", -1);

         int tval = CQI_NPDCCH_NB_r14.decodeEnumValue (buffer);
         cqi_NPDCCH_r15 = CQI_NPDCCH_NB_r14.valueOf (tval);
         buffer.getContext().eventDispatcher.endElement("cqi_NPDCCH_r15", -1);
      }
      else {
         cqi_NPDCCH_r15 = null;
      }
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new RRCEarlyDataRequest_NB_r15_IEs_nonCriticalExtension();
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (cqi_NPDCCH_r15 != null) cqi_NPDCCH_r15.print (_sb, "cqi_NPDCCH_r15", _level+1);
