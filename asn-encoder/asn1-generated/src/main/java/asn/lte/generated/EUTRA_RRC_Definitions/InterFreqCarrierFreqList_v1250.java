...
public class InterFreqCarrierFreqList_v1250 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqList-v1250";
   }

   public InterFreqCarrierFreqInfo_v1250[] elements;

   public InterFreqCarrierFreqList_v1250 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqList_v1250 (int numRecords) {
      elements = new InterFreqCarrierFreqInfo_v1250 [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqList_v1250 (InterFreqCarrierFreqInfo_v1250[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqCarrierFreqInfo_v1250 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqCarrierFreqInfo_v1250();
