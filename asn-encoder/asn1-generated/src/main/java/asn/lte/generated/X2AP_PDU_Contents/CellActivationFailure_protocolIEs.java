...
public class CellActivationFailure_protocolIEs extends Asn1SeqOf {
   ...
   public CellActivationFailure_protocolIEs_element[] elements;

   public CellActivationFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellActivationFailure_protocolIEs (int numRecords) {
      elements = new CellActivationFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellActivationFailure_protocolIEs (CellActivationFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellActivationFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellActivationFailure_protocolIEs_element();
