...
public class CellType_iE_Extensions extends Asn1SeqOf {
   ...
   public CellType_iE_Extensions_element[] elements;

   public CellType_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellType_iE_Extensions (int numRecords) {
      elements = new CellType_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellType_iE_Extensions (CellType_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellType_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellType_iE_Extensions_element();
