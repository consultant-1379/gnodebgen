...
public class MeasResultListEUTRA extends Asn1SeqOf {
   ...
   public MeasResultEUTRA[] elements;
    ...
    * populated.
    */
   public MeasResultListEUTRA (int numRecords) {
      elements = new MeasResultEUTRA [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListEUTRA (MeasResultEUTRA[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultEUTRA [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultEUTRA();
