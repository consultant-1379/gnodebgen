...
public class CancelledCellinEAI extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CancelledCellinEAI";
   }

   public CancelledCellinEAI_Item[] elements;

   public CancelledCellinEAI () {
      elements = null;
   }
    ...
    * populated.
    */
   public CancelledCellinEAI (int numRecords) {
      elements = new CancelledCellinEAI_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public CancelledCellinEAI (CancelledCellinEAI_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CancelledCellinEAI_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CancelledCellinEAI_Item();
