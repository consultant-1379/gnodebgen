...
public class RRCConnectionSetup_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionSetup-NB";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier;
   public RRCConnectionSetup_NB_criticalExtensions criticalExtensions;

   public RRCConnectionSetup_NB () {
      super();
      init();
   }
   ...
   public RRCConnectionSetup_NB (
      ...
      RRCConnectionSetup_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public RRCConnectionSetup_NB (long rrc_TransactionIdentifier_,
      RRCConnectionSetup_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionSetup_NB_criticalExtensions();
