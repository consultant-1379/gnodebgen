...
public class VarMeasReportList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "VarMeasReportList-r12";
   }

   public VarMeasReport[] elements;

   public VarMeasReportList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public VarMeasReportList_r12 (int numRecords) {
      elements = new VarMeasReport [numRecords];
   }
    ...
    * given the array.  
    */
   public VarMeasReportList_r12 (VarMeasReport[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new VarMeasReport [numElements];
