...
public class CountingRequestList_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CountingRequestList-r10";
   }

   public CountingRequestInfo_r10[] elements;

   public CountingRequestList_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CountingRequestList_r10 (int numRecords) {
      elements = new CountingRequestInfo_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public CountingRequestList_r10 (CountingRequestInfo_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CountingRequestInfo_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CountingRequestInfo_r10();
