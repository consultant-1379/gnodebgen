...
public class MeNBResourceCoordinationInformation_iE_Extensions_element extends Asn1Seq {
    ...
    * Java type: NRCGI
    *
    * id: id-MeNBCoordinationAssistanceInformation
    * criticality: Criticality.reject
    * presence: Presence.optional
    * ASN.1 type: MeNBCoordinationAssistanceInformation
    * Java type: MeNBCoordinationAssistanceInformation
    */
   public Asn1Type extensionValue;

   public MeNBResourceCoordinationInformation_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MeNBResourceCoordinationInformation_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-NRCGI
    */
   public void setUsing_id_NRCGI(NRCGI extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_NRCGI);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-MeNBCoordinationAssistanceInformation
    */
   public void setUsing_id_MeNBCoordinationAssistanceInformation(MeNBCoordinationAssistanceInformation extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_MeNBCoordinationAssistanceInformation);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-NRCGI
    */
   public NRCGI getExtensionValueFor_id_NRCGI() {
      return (NRCGI) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-MeNBCoordinationAssistanceInformation
    */
   public MeNBCoordinationAssistanceInformation getExtensionValueFor_id_MeNBCoordinationAssistanceInformation() {
      return (MeNBCoordinationAssistanceInformation) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.MeNBResourceCoordinationInformationExtIEs.length; i++) {
         if(_X2AP_IEsValues.MeNBResourceCoordinationInformationExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.MeNBResourceCoordinationInformationExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 322) {
         indent (_sb, _level+1);
         _sb.append("id = id-NRCGI\n");
      }
      else if (id.value == 323) {
         indent (_sb, _level+1);
         _sb.append("id = id-MeNBCoordinationAssistanceInformation\n");
      }
