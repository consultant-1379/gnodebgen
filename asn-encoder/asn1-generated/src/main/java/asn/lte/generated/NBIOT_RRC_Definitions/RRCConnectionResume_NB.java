...
public class RRCConnectionResume_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionResume-NB";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier;
   public RRCConnectionResume_NB_criticalExtensions criticalExtensions;

   public RRCConnectionResume_NB () {
      super();
      init();
   }
   ...
   public RRCConnectionResume_NB (
      ...
      RRCConnectionResume_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public RRCConnectionResume_NB (long rrc_TransactionIdentifier_,
      RRCConnectionResume_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionResume_NB_criticalExtensions();
