...
public class EAB_RAN_UeTraceID extends Asn1BitString {
    ...
    */
   public EAB_RAN_UeTraceID (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public EAB_RAN_UeTraceID (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public EAB_RAN_UeTraceID (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public EAB_RAN_UeTraceID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public EAB_RAN_UeTraceID (java.util.BitSet bitSet) {
      super (bitSet);
   }
