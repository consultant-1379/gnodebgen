...
public class FeatureSetUplink_featureSetListPerUplinkCC extends Asn1SeqOf {
   ...
   public FeatureSetUplinkPerCC_Id[] elements;

   public FeatureSetUplink_featureSetListPerUplinkCC () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSetUplink_featureSetListPerUplinkCC (int numRecords) {
      elements = new FeatureSetUplinkPerCC_Id [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSetUplink_featureSetListPerUplinkCC (FeatureSetUplinkPerCC_Id[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FeatureSetUplinkPerCC_Id [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FeatureSetUplinkPerCC_Id();
