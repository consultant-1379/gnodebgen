...
public class CSIReportList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CSIReportList";
   }

   public CSIReportList_element[] elements;

   public CSIReportList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSIReportList (int numRecords) {
      elements = new CSIReportList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CSIReportList (CSIReportList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSIReportList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSIReportList_element();
