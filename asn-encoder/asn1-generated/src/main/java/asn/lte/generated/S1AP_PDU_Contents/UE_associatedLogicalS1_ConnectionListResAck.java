...
public class UE_associatedLogicalS1_ConnectionListResAck extends Asn1SeqOf {
   ...
   public UE_associatedLogicalS1_ConnectionListResAck_element[] elements;

   public UE_associatedLogicalS1_ConnectionListResAck () {
      elements = null;
   }
    ...
    * populated.
    */
   public UE_associatedLogicalS1_ConnectionListResAck (int numRecords) {
      elements = new UE_associatedLogicalS1_ConnectionListResAck_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UE_associatedLogicalS1_ConnectionListResAck (UE_associatedLogicalS1_ConnectionListResAck_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UE_associatedLogicalS1_ConnectionListResAck_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UE_associatedLogicalS1_ConnectionListResAck_element();
