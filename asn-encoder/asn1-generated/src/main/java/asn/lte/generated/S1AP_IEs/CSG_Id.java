...
public class CSG_Id extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public CSG_Id (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public CSG_Id (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public CSG_Id (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public CSG_Id (java.util.BitSet bitSet) {
      super (bitSet);
   }
