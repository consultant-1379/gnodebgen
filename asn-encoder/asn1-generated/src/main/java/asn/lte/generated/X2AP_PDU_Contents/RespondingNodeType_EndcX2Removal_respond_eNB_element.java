...
public class RespondingNodeType_EndcX2Removal_respond_eNB_element extends Asn1Seq {
   ...
   public RespondingNodeType_EndcX2Removal_respond_eNB_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public RespondingNodeType_EndcX2Removal_respond_eNB_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENB_ENDCX2RemovalReqAckIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENB_ENDCX2RemovalReqAckIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENB_ENDCX2RemovalReqAckIEs[i];
            break;
         }
      }
      if (null == _index) {
