...
public class E_RABToBeModifiedListBearerModReq extends Asn1SeqOf {
   ...
   public E_RABToBeModifiedListBearerModReq_element[] elements;

   public E_RABToBeModifiedListBearerModReq () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABToBeModifiedListBearerModReq (int numRecords) {
      elements = new E_RABToBeModifiedListBearerModReq_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABToBeModifiedListBearerModReq (E_RABToBeModifiedListBearerModReq_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABToBeModifiedListBearerModReq_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABToBeModifiedListBearerModReq_element();
