...
public class SL_V2X_SyncFreqList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-V2X-SyncFreqList-r15";
   }

   public ARFCN_ValueEUTRA_r9[] elements;

   public SL_V2X_SyncFreqList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_V2X_SyncFreqList_r15 (int numRecords) {
    ...
    * given the array.  
    */
   public SL_V2X_SyncFreqList_r15 (ARFCN_ValueEUTRA_r9[] elements_) {
      elements = elements_;
   }
