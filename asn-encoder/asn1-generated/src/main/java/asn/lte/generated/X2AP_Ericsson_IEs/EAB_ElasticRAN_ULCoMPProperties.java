...
public class EAB_ElasticRAN_ULCoMPProperties extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-ElasticRAN-ULCoMPProperties";
   }

   public EAB_ElasticRAN_ULCoMPProperties_element[] elements;

   public EAB_ElasticRAN_ULCoMPProperties () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_ElasticRAN_ULCoMPProperties (int numRecords) {
      elements = new EAB_ElasticRAN_ULCoMPProperties_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_ElasticRAN_ULCoMPProperties (EAB_ElasticRAN_ULCoMPProperties_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_ElasticRAN_ULCoMPProperties_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_ElasticRAN_ULCoMPProperties_element();
