...
public class SourceRNC_ToTargetRNC_TransparentContainer extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "SourceRNC-ToTargetRNC-TransparentContainer";
   }

   public SourceRNC_ToTargetRNC_TransparentContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public SourceRNC_ToTargetRNC_TransparentContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public SourceRNC_ToTargetRNC_TransparentContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public SourceRNC_ToTargetRNC_TransparentContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
