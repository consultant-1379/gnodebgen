...
public class SgNBReleaseConfirm_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-E-RABs-ToBeReleased-SgNBRelConfList
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: E-RABs-ToBeReleased-SgNBRelConfList
    * Java type: E_RABs_ToBeReleased_SgNBRelConfList
    *
   ...
   public SgNBReleaseConfirm_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBReleaseConfirm_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-ToBeReleased-SgNBRelConfList
    */
   public void setUsing_id_E_RABs_ToBeReleased_SgNBRelConfList(E_RABs_ToBeReleased_SgNBRelConfList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_ToBeReleased_SgNBRelConfList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-ToBeReleased-SgNBRelConfList
    */
   public E_RABs_ToBeReleased_SgNBRelConfList getValueFor_id_E_RABs_ToBeReleased_SgNBRelConfList() {
      return (E_RABs_ToBeReleased_SgNBRelConfList) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SgNBReleaseConfirm_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SgNBReleaseConfirm_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SgNBReleaseConfirm_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-ToBeReleased-SgNBRelConfList\n");
      }
      else if (id.value == 17) {
         indent (_sb, _level+1);
