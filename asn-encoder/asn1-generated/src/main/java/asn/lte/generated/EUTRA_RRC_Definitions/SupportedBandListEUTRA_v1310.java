...
public class SupportedBandListEUTRA_v1310 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandListEUTRA-v1310";
   }

   public SupportedBandEUTRA_v1310[] elements;

   public SupportedBandListEUTRA_v1310 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandListEUTRA_v1310 (int numRecords) {
      elements = new SupportedBandEUTRA_v1310 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandListEUTRA_v1310 (SupportedBandEUTRA_v1310[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBandEUTRA_v1310 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedBandEUTRA_v1310();
