...
public class BandCombination_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandCombination-r14";
   }

   public BandIndication_r14[] elements;

   public BandCombination_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombination_r14 (int numRecords) {
      elements = new BandIndication_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombination_r14 (BandIndication_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandIndication_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandIndication_r14();
