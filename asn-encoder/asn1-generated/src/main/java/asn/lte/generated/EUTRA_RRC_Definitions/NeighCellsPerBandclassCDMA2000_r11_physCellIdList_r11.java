...
public class NeighCellsPerBandclassCDMA2000_r11_physCellIdList_r11 extends Asn1SeqOf {
   ...
   public PhysCellIdCDMA2000[] elements;

   public NeighCellsPerBandclassCDMA2000_r11_physCellIdList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NeighCellsPerBandclassCDMA2000_r11_physCellIdList_r11 (int numRecords) {
      elements = new PhysCellIdCDMA2000 [numRecords];
   }
    ...
    * given the array.  
    */
   public NeighCellsPerBandclassCDMA2000_r11_physCellIdList_r11 (PhysCellIdCDMA2000[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 40);
      int numElements = (int) buffer.decodeLength();

      elements = new PhysCellIdCDMA2000 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PhysCellIdCDMA2000();
