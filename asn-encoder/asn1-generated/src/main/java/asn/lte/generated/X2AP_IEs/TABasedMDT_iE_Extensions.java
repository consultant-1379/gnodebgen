...
public class TABasedMDT_iE_Extensions extends Asn1SeqOf {
   ...
   public TABasedMDT_iE_Extensions_element[] elements;

   public TABasedMDT_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TABasedMDT_iE_Extensions (int numRecords) {
      elements = new TABasedMDT_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TABasedMDT_iE_Extensions (TABasedMDT_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TABasedMDT_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TABasedMDT_iE_Extensions_element();
