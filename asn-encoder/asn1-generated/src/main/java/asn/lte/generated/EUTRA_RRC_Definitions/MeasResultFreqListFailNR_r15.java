...
public class MeasResultFreqListFailNR_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultFreqListFailNR-r15";
   }

   public MeasResultFreqFailNR_r15[] elements;

   public MeasResultFreqListFailNR_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultFreqListFailNR_r15 (int numRecords) {
      elements = new MeasResultFreqFailNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultFreqListFailNR_r15 (MeasResultFreqFailNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultFreqFailNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultFreqFailNR_r15();
