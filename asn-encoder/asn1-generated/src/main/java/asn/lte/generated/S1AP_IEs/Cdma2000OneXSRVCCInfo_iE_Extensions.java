...
public class Cdma2000OneXSRVCCInfo_iE_Extensions extends Asn1SeqOf {
   ...
   public Cdma2000OneXSRVCCInfo_iE_Extensions_element[] elements;

   public Cdma2000OneXSRVCCInfo_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public Cdma2000OneXSRVCCInfo_iE_Extensions (int numRecords) {
      elements = new Cdma2000OneXSRVCCInfo_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public Cdma2000OneXSRVCCInfo_iE_Extensions (Cdma2000OneXSRVCCInfo_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Cdma2000OneXSRVCCInfo_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Cdma2000OneXSRVCCInfo_iE_Extensions_element();
