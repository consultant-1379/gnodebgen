...
public class E_RABFailedtoSetupListHOReqAck extends Asn1SeqOf {
   ...
   public E_RABFailedtoSetupListHOReqAck_element[] elements;

   public E_RABFailedtoSetupListHOReqAck () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABFailedtoSetupListHOReqAck (int numRecords) {
      elements = new E_RABFailedtoSetupListHOReqAck_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABFailedtoSetupListHOReqAck (E_RABFailedtoSetupListHOReqAck_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABFailedtoSetupListHOReqAck_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABFailedtoSetupListHOReqAck_element();
