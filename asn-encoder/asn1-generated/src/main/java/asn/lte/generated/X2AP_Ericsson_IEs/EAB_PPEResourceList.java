...
public class EAB_PPEResourceList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-PPEResourceList";
   }

   public EAB_PPEResourceList_element[] elements;

   public EAB_PPEResourceList () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_PPEResourceList (int numRecords) {
      elements = new EAB_PPEResourceList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_PPEResourceList (EAB_PPEResourceList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_PPEResourceList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_PPEResourceList_element();
