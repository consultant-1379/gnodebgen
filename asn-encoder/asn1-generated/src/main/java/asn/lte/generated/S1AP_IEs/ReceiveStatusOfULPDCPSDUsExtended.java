...
public class ReceiveStatusOfULPDCPSDUsExtended extends Asn1BitString {
   ...
   public String getAsn1TypeName()  {
      return "ReceiveStatusOfULPDCPSDUsExtended";
   }
    ...
    */
   public ReceiveStatusOfULPDCPSDUsExtended () {
      super();
      value = new byte [2048];
   }
    ...
    */
   public ReceiveStatusOfULPDCPSDUsExtended (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public ReceiveStatusOfULPDCPSDUsExtended (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public ReceiveStatusOfULPDCPSDUsExtended (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public ReceiveStatusOfULPDCPSDUsExtended (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public ReceiveStatusOfULPDCPSDUsExtended (java.util.BitSet bitSet) {
      super (bitSet);
   }
