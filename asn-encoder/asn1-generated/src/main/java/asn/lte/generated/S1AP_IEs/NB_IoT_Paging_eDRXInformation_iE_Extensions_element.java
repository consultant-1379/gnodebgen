...
public class NB_IoT_Paging_eDRXInformation_iE_Extensions_element extends Asn1Seq {
   ...
   public NB_IoT_Paging_eDRXInformation_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public NB_IoT_Paging_eDRXInformation_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.NB_IoT_Paging_eDRXInformation_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.NB_IoT_Paging_eDRXInformation_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.NB_IoT_Paging_eDRXInformation_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
