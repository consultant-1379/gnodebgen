...
public class EAB_CoveringCell_Item extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "EAB-CoveringCell-Item";
   }

   public EUTRAN_CGI eCGI;
   public EAB_CoveringCell_Item_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public EAB_CoveringCell_Item () {
      super();
      init();
   }
   ...
   public EAB_CoveringCell_Item (
      EUTRAN_CGI eCGI_,
      EAB_CoveringCell_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      eCGI = eCGI_;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new EAB_CoveringCell_Item_iE_Extensions();
