...
public class ServedNRCell_Information_iE_Extensions_element extends Asn1Seq {
   ...
   /**
    * id: id-additionalPLMNs-Item
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: AdditionalPLMNs-Item
    * Java type: AdditionalPLMNs_Item
    *
    * id: id-BPLMN-ID-Info-NR
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: BPLMN-ID-Info-NR
    * Java type: BPLMN_ID_Info_NR
    */
   public Asn1Type extensionValue;

   public ServedNRCell_Information_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ServedNRCell_Information_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-additionalPLMNs-Item
    */
   public void setUsing_id_additionalPLMNs_Item(asn.lte.generated.X2AP_IEs.AdditionalPLMNs_Item extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_additionalPLMNs_Item);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-BPLMN-ID-Info-NR
    */
   public void setUsing_id_BPLMN_ID_Info_NR(asn.lte.generated.X2AP_IEs.BPLMN_ID_Info_NR extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_BPLMN_ID_Info_NR);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-additionalPLMNs-Item
    */
   public asn.lte.generated.X2AP_IEs.AdditionalPLMNs_Item getExtensionValueFor_id_additionalPLMNs_Item() {
      return (asn.lte.generated.X2AP_IEs.AdditionalPLMNs_Item) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-BPLMN-ID-Info-NR
    */
   public asn.lte.generated.X2AP_IEs.BPLMN_ID_Info_NR getExtensionValueFor_id_BPLMN_ID_Info_NR() {
      return (asn.lte.generated.X2AP_IEs.BPLMN_ID_Info_NR) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ServedNRCell_Information_ExtIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ServedNRCell_Information_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ServedNRCell_Information_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 334) {
         indent (_sb, _level+1);
         _sb.append("id = id-additionalPLMNs-Item\n");
      }
      else if (id.value == 337) {
         indent (_sb, _level+1);
         _sb.append("id = id-BPLMN-ID-Info-NR\n");
      }
