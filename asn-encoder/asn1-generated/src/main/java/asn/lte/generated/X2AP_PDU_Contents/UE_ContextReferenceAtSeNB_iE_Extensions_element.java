...
public class UE_ContextReferenceAtSeNB_iE_Extensions_element extends Asn1Seq {
   ...
   public UE_ContextReferenceAtSeNB_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UE_ContextReferenceAtSeNB_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.UE_ContextReferenceAtSeNB_ItemExtIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.UE_ContextReferenceAtSeNB_ItemExtIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.UE_ContextReferenceAtSeNB_ItemExtIEs[i];
            break;
         }
      }
      if (null == _index) {
