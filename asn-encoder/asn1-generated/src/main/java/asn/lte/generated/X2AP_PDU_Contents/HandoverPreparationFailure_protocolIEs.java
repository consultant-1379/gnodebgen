...
public class HandoverPreparationFailure_protocolIEs extends Asn1SeqOf {
   ...
   public HandoverPreparationFailure_protocolIEs_element[] elements;

   public HandoverPreparationFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public HandoverPreparationFailure_protocolIEs (int numRecords) {
      elements = new HandoverPreparationFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public HandoverPreparationFailure_protocolIEs (HandoverPreparationFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HandoverPreparationFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new HandoverPreparationFailure_protocolIEs_element();
