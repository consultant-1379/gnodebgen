...
public class SeNBReconfigurationComplete_protocolIEs_element extends Asn1Seq {
    ...
    * Java type: UE_X2AP_ID
    *
    * id: id-ResponseInformationSeNBReconfComp
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: ResponseInformationSeNBReconfComp
    * Java type: ResponseInformationSeNBReconfComp
    *
   ...
   public SeNBReconfigurationComplete_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SeNBReconfigurationComplete_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-ResponseInformationSeNBReconfComp
    */
   public void setUsing_id_ResponseInformationSeNBReconfComp(ResponseInformationSeNBReconfComp value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ResponseInformationSeNBReconfComp);
   ...
   /**
    * Get value of value with type set according to information object having key id-ResponseInformationSeNBReconfComp
    */
   public ResponseInformationSeNBReconfComp getValueFor_id_ResponseInformationSeNBReconfComp() {
      return (ResponseInformationSeNBReconfComp) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SeNBReconfigurationComplete_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SeNBReconfigurationComplete_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SeNBReconfigurationComplete_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-ResponseInformationSeNBReconfComp\n");
      }
