...
public class GERAN_Cell_ID_iE_Extensions extends Asn1SeqOf {
   ...
   public GERAN_Cell_ID_iE_Extensions_element[] elements;

   public GERAN_Cell_ID_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public GERAN_Cell_ID_iE_Extensions (int numRecords) {
      elements = new GERAN_Cell_ID_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public GERAN_Cell_ID_iE_Extensions (GERAN_Cell_ID_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GERAN_Cell_ID_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GERAN_Cell_ID_iE_Extensions_element();
