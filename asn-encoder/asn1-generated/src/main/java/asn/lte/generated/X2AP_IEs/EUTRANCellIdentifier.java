...
public class EUTRANCellIdentifier extends Asn1BitString {
    ...
    */
   public EUTRANCellIdentifier (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public EUTRANCellIdentifier (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public EUTRANCellIdentifier (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public EUTRANCellIdentifier (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public EUTRANCellIdentifier (java.util.BitSet bitSet) {
      super (bitSet);
   }
