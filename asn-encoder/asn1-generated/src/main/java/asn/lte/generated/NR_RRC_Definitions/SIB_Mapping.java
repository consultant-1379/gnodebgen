...
public class SIB_Mapping extends Asn1SeqOf {
    ...
    * populated.
    */
   public SIB_Mapping (int numRecords) {
      elements = new SIB_TypeInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public SIB_Mapping (SIB_TypeInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SIB_TypeInfo [numElements];
