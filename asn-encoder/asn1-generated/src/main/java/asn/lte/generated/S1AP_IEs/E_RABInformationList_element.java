...
public class E_RABInformationList_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABInformationListItem
    * Java type: E_RABInformationListItem
    */
   public Asn1Type value;

   public E_RABInformationList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABInformationList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABInformationListItem
    */
   public void setUsing_id_E_RABInformationListItem(E_RABInformationListItem value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABInformationListItem);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABInformationListItem
    */
   public E_RABInformationListItem getValueFor_id_E_RABInformationListItem() {
      return (E_RABInformationListItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.E_RABInformationListIEs.length; i++) {
         if(_S1AP_IEsValues.E_RABInformationListIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.E_RABInformationListIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 78) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABInformationListItem\n");
      }
