...
public class EndcSONConfigurationTransfer extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "EndcSONConfigurationTransfer";
   }

   public EndcSONConfigurationTransfer () {
      super();
   }
    ...
    *              in binary form.
    */
   public EndcSONConfigurationTransfer (byte[] data) {
      super (data);
   }
    ...
    */
   public EndcSONConfigurationTransfer (byte[] data, int offset, int nbytes) {
    ...
    */
   public EndcSONConfigurationTransfer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
