...
public class MeasIdToAddModListExt_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasIdToAddModListExt-r12";
   }

   public MeasIdToAddModExt_r12[] elements;

   public MeasIdToAddModListExt_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasIdToAddModListExt_r12 (int numRecords) {
      elements = new MeasIdToAddModExt_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasIdToAddModListExt_r12 (MeasIdToAddModExt_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasIdToAddModExt_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasIdToAddModExt_r12();
