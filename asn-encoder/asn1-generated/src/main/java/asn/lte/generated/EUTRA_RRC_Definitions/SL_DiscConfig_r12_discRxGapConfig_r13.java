...
public class SL_DiscConfig_r12_discRxGapConfig_r13 extends Asn1Choice {
   ...
   public SL_DiscConfig_r12_discRxGapConfig_r13 () {
      super();
   }

   public SL_DiscConfig_r12_discRxGapConfig_r13 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SL_GapConfig_r13 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            SL_GapConfig_r13 setup;
            element = setup = new SL_GapConfig_r13();
            setup.decode (buffer);
            break;
         }
