...
public class UEContextResumeResponse_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABFailedToResumeListResumeRes
    * Java type: E_RABFailedToResumeListResumeRes
    *
   ...
   public UEContextResumeResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UEContextResumeResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABFailedToResumeListResumeRes
    */
   public void setUsing_id_E_RABFailedToResumeListResumeRes(E_RABFailedToResumeListResumeRes value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABFailedToResumeListResumeRes);
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABFailedToResumeListResumeRes
    */
   public E_RABFailedToResumeListResumeRes getValueFor_id_E_RABFailedToResumeListResumeRes() {
      return (E_RABFailedToResumeListResumeRes) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.UEContextResumeResponseIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.UEContextResumeResponseIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.UEContextResumeResponseIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 237) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABFailedToResumeListResumeRes\n");
      }
      else if (id.value == 58) {
         indent (_sb, _level+1);
