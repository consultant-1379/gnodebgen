...
public class STAG_ToReleaseList_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "STAG-ToReleaseList-r11";
   }

   public STAG_Id_r11[] elements;

   public STAG_ToReleaseList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public STAG_ToReleaseList_r11 (int numRecords) {
      elements = new STAG_Id_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public STAG_ToReleaseList_r11 (STAG_Id_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new STAG_Id_r11 [numElements];
