...
public class CQI_ReportConfig_r15 extends Asn1Choice {
   ...
   public CQI_ReportConfig_r15 () {
      super();
   }

   public CQI_ReportConfig_r15 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (CQI_ReportConfig_r15_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            CQI_ReportConfig_r15_setup setup;
            element = setup = new CQI_ReportConfig_r15_setup();
            setup.decode (buffer);
            break;
         }
