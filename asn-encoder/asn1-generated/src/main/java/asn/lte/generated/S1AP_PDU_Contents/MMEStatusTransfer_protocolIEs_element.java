...
public class MMEStatusTransfer_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: ENB-StatusTransfer-TransparentContainer
    * Java type: ENB_StatusTransfer_TransparentContainer
    */
   public Asn1Type value;

   public MMEStatusTransfer_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MMEStatusTransfer_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-eNB-StatusTransfer-TransparentContainer
    */
   public void setUsing_id_eNB_StatusTransfer_TransparentContainer(asn.lte.generated.S1AP_IEs.ENB_StatusTransfer_TransparentContainer value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_eNB_StatusTransfer_TransparentContainer);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-eNB-StatusTransfer-TransparentContainer
    */
   public asn.lte.generated.S1AP_IEs.ENB_StatusTransfer_TransparentContainer getValueFor_id_eNB_StatusTransfer_TransparentContainer() {
      return (asn.lte.generated.S1AP_IEs.ENB_StatusTransfer_TransparentContainer) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.MMEStatusTransferIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.MMEStatusTransferIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.MMEStatusTransferIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-eNB-StatusTransfer-TransparentContainer\n");
      }
