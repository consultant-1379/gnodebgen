...
public class MeasResultServFreqListExt_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultServFreqListExt-r13";
   }

   public MeasResultServFreq_r13[] elements;

   public MeasResultServFreqListExt_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultServFreqListExt_r13 (int numRecords) {
      elements = new MeasResultServFreq_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultServFreqListExt_r13 (MeasResultServFreq_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultServFreq_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultServFreq_r13();
