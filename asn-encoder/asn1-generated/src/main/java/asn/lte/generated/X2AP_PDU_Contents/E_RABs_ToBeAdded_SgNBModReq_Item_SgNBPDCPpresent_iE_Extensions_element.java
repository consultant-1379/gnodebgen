...
public class E_RABs_ToBeAdded_SgNBModReq_Item_SgNBPDCPpresent_iE_Extensions_element extends Asn1Seq {
   ...
   public E_RABs_ToBeAdded_SgNBModReq_Item_SgNBPDCPpresent_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABs_ToBeAdded_SgNBModReq_Item_SgNBPDCPpresent_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-RLCMode-transferred
    */
   public void setUsing_id_RLCMode_transferred(asn.lte.generated.X2AP_IEs.RLCMode extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_RLCMode_transferred);
   ...
   /**
    * Get value of extensionValue with type set according to information object having key id-RLCMode-transferred
    */
   public asn.lte.generated.X2AP_IEs.RLCMode getExtensionValueFor_id_RLCMode_transferred() {
      return (asn.lte.generated.X2AP_IEs.RLCMode) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.E_RABs_ToBeAdded_SgNBModReq_Item_SgNBPDCPpresentExtIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.E_RABs_ToBeAdded_SgNBModReq_Item_SgNBPDCPpresentExtIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.E_RABs_ToBeAdded_SgNBModReq_Item_SgNBPDCPpresentExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 317) {
         indent (_sb, _level+1);
         _sb.append("id = id-RLCMode-transferred\n");
      }
