...
public class SRB_ToAddModExtList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SRB-ToAddModExtList-r15";
   }

   public SRB_ToAddMod[] elements;

   public SRB_ToAddModExtList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRB_ToAddModExtList_r15 (int numRecords) {
      elements = new SRB_ToAddMod [numRecords];
   }
    ...
    * given the array.  
    */
   public SRB_ToAddModExtList_r15 (SRB_ToAddMod[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRB_ToAddMod [numElements];
