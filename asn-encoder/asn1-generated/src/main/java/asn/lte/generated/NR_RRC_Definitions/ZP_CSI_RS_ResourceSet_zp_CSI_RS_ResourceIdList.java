...
public class ZP_CSI_RS_ResourceSet_zp_CSI_RS_ResourceIdList extends Asn1SeqOf {
   ...
   public ZP_CSI_RS_ResourceId[] elements;

   public ZP_CSI_RS_ResourceSet_zp_CSI_RS_ResourceIdList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ZP_CSI_RS_ResourceSet_zp_CSI_RS_ResourceIdList (int numRecords) {
      elements = new ZP_CSI_RS_ResourceId [numRecords];
   }
    ...
    * given the array.  
    */
   public ZP_CSI_RS_ResourceSet_zp_CSI_RS_ResourceIdList (ZP_CSI_RS_ResourceId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ZP_CSI_RS_ResourceId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ZP_CSI_RS_ResourceId();
