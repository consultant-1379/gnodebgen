...
public class PWSRestartIndication_protocolIEs extends Asn1SeqOf {
   ...
   public PWSRestartIndication_protocolIEs_element[] elements;

   public PWSRestartIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public PWSRestartIndication_protocolIEs (int numRecords) {
      elements = new PWSRestartIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PWSRestartIndication_protocolIEs (PWSRestartIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PWSRestartIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PWSRestartIndication_protocolIEs_element();
