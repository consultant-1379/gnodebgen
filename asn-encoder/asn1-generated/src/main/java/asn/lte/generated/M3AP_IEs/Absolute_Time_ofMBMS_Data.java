...
public class Absolute_Time_ofMBMS_Data extends Asn1BitString {
   ...
   public String getAsn1TypeName()  {
      return "Absolute-Time-ofMBMS-Data";
   }
    ...
    */
   public Absolute_Time_ofMBMS_Data () {
      super();
      value = new byte [8];
   }
    ...
    */
   public Absolute_Time_ofMBMS_Data (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public Absolute_Time_ofMBMS_Data (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public Absolute_Time_ofMBMS_Data (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public Absolute_Time_ofMBMS_Data (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public Absolute_Time_ofMBMS_Data (java.util.BitSet bitSet) {
      super (bitSet);
   }
