...
public class E_RABToBeSetupListBearerSUReq extends Asn1SeqOf {
   ...
   public E_RABToBeSetupListBearerSUReq_element[] elements;

   public E_RABToBeSetupListBearerSUReq () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABToBeSetupListBearerSUReq (int numRecords) {
      elements = new E_RABToBeSetupListBearerSUReq_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABToBeSetupListBearerSUReq (E_RABToBeSetupListBearerSUReq_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABToBeSetupListBearerSUReq_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABToBeSetupListBearerSUReq_element();
