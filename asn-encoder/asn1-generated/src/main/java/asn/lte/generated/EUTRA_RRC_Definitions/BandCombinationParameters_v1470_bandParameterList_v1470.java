...
public class BandCombinationParameters_v1470_bandParameterList_v1470 extends Asn1SeqOf {
   ...
   public BandParameters_v1470[] elements;

   public BandCombinationParameters_v1470_bandParameterList_v1470 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_v1470_bandParameterList_v1470 (int numRecords) {
      elements = new BandParameters_v1470 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_v1470_bandParameterList_v1470 (BandParameters_v1470[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_v1470 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_v1470();
