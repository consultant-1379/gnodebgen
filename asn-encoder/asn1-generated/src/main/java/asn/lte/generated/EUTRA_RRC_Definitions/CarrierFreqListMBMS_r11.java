...
public class CarrierFreqListMBMS_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CarrierFreqListMBMS-r11";
   }

   public ARFCN_ValueEUTRA_r9[] elements;

   public CarrierFreqListMBMS_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CarrierFreqListMBMS_r11 (int numRecords) {
    ...
    * given the array.  
    */
   public CarrierFreqListMBMS_r11 (ARFCN_ValueEUTRA_r9[] elements_) {
      elements = elements_;
   }
