...
public class RadioResourceConfigDedicated_dummy extends Asn1SeqOf {
   ...
   public RadioResourceConfigDedicated_dummy () {
      elements = null;
   }
    ...
    * populated.
    */
   public RadioResourceConfigDedicated_dummy (int numRecords) {
    ...
    * given the array.  
    */
   public RadioResourceConfigDedicated_dummy (Asn1Integer[] elements_) {
      elements = elements_;
   }
