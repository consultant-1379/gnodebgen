...
public class MBMS_Service_associatedLogicalM3_ConnectionListResAck_element extends Asn1Seq {
   ...
   /**
    * id: id-MBMS-Service-associatedLogicalM3-ConnectionItem
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: MBMS-Service-associatedLogicalM3-ConnectionItem
    * Java type: MBMS_Service_associatedLogicalM3_ConnectionItem
    */
   public Asn1Type value;

   public MBMS_Service_associatedLogicalM3_ConnectionListResAck_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MBMS_Service_associatedLogicalM3_ConnectionListResAck_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-MBMS-Service-associatedLogicalM3-ConnectionItem
    */
   public void setUsing_id_MBMS_Service_associatedLogicalM3_ConnectionItem(asn.lte.generated.M3AP_IEs.MBMS_Service_associatedLogicalM3_ConnectionItem value) {
      this.id = new asn.lte.generated.M3AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.M3AP_Constants._M3AP_ConstantsValues.id_MBMS_Service_associatedLogicalM3_ConnectionItem);
      this.criticality = asn.lte.generated.M3AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-MBMS-Service-associatedLogicalM3-ConnectionItem
    */
   public asn.lte.generated.M3AP_IEs.MBMS_Service_associatedLogicalM3_ConnectionItem getValueFor_id_MBMS_Service_associatedLogicalM3_ConnectionItem() {
      return (asn.lte.generated.M3AP_IEs.MBMS_Service_associatedLogicalM3_ConnectionItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _M3AP_PDU_ContentsValues.MBMS_Service_associatedLogicalM3_ConnectionItemResAck.length; i++) {
         if(_M3AP_PDU_ContentsValues.MBMS_Service_associatedLogicalM3_ConnectionItemResAck[i].id.equals(id)) {
            _index = _M3AP_PDU_ContentsValues.MBMS_Service_associatedLogicalM3_ConnectionItemResAck[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 14) {
         indent (_sb, _level+1);
         _sb.append("id = id-MBMS-Service-associatedLogicalM3-ConnectionItem\n");
      }
