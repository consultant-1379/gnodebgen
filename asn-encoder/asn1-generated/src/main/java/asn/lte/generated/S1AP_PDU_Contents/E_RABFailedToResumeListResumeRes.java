...
public class E_RABFailedToResumeListResumeRes extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABFailedToResumeListResumeRes";
   }

   public E_RABFailedToResumeListResumeRes_element[] elements;

   public E_RABFailedToResumeListResumeRes () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABFailedToResumeListResumeRes (int numRecords) {
      elements = new E_RABFailedToResumeListResumeRes_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABFailedToResumeListResumeRes (E_RABFailedToResumeListResumeRes_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABFailedToResumeListResumeRes_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABFailedToResumeListResumeRes_element();
