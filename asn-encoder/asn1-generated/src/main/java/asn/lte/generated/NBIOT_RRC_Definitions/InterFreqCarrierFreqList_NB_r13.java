...
public class InterFreqCarrierFreqList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqList-NB-r13";
   }

   public InterFreqCarrierFreqInfo_NB_r13[] elements;

   public InterFreqCarrierFreqList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqList_NB_r13 (int numRecords) {
      elements = new InterFreqCarrierFreqInfo_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqList_NB_r13 (InterFreqCarrierFreqInfo_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqCarrierFreqInfo_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqCarrierFreqInfo_NB_r13();
