...
public class E_RABs_ToBeSetup_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeSetup-List";
   }

   public E_RABs_ToBeSetup_List_element[] elements;

   public E_RABs_ToBeSetup_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeSetup_List (int numRecords) {
      elements = new E_RABs_ToBeSetup_List_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeSetup_List (E_RABs_ToBeSetup_List_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeSetup_List_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeSetup_List_element();
