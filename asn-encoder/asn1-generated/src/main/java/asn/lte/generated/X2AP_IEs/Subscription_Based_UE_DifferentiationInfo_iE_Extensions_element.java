...
public class Subscription_Based_UE_DifferentiationInfo_iE_Extensions_element extends Asn1Seq {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.Subscription_Based_UE_DifferentiationInfo_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.Subscription_Based_UE_DifferentiationInfo_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.Subscription_Based_UE_DifferentiationInfo_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
