...
public class MeasurementReport_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _MEASUREMENTREPORT_R8 = 1;
   ...
   public MeasurementReport_criticalExtensions_c1 () {
      super();
   }

   public MeasurementReport_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _MEASUREMENTREPORT_R8: return "measurementReport_r8";
   ...
   public void set_measurementReport_r8 (MeasurementReport_r8_IEs value) {
      setElement (_MEASUREMENTREPORT_R8, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            MeasurementReport_r8_IEs measurementReport_r8;
            element = measurementReport_r8 = new MeasurementReport_r8_IEs();
            measurementReport_r8.decode (buffer);
            break;
         }
