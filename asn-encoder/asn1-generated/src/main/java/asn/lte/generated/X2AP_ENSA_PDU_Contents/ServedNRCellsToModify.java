...
public class ServedNRCellsToModify extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServedNRCellsToModify";
   }

   public ENSA_ServedNRCellsToModify_Item[] elements;

   public ServedNRCellsToModify () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedNRCellsToModify (int numRecords) {
      elements = new ENSA_ServedNRCellsToModify_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedNRCellsToModify (ENSA_ServedNRCellsToModify_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENSA_ServedNRCellsToModify_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENSA_ServedNRCellsToModify_Item();
