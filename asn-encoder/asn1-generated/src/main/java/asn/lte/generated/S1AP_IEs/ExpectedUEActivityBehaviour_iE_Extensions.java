...
public class ExpectedUEActivityBehaviour_iE_Extensions extends Asn1SeqOf {
   ...
   public ExpectedUEActivityBehaviour_iE_Extensions_element[] elements;

   public ExpectedUEActivityBehaviour_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ExpectedUEActivityBehaviour_iE_Extensions (int numRecords) {
      elements = new ExpectedUEActivityBehaviour_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ExpectedUEActivityBehaviour_iE_Extensions (ExpectedUEActivityBehaviour_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ExpectedUEActivityBehaviour_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ExpectedUEActivityBehaviour_iE_Extensions_element();
