...
public class LocationReportingControl_protocolIEs extends Asn1SeqOf {
   ...
   public LocationReportingControl_protocolIEs_element[] elements;

   public LocationReportingControl_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public LocationReportingControl_protocolIEs (int numRecords) {
      elements = new LocationReportingControl_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public LocationReportingControl_protocolIEs (LocationReportingControl_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LocationReportingControl_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LocationReportingControl_protocolIEs_element();
