...
public class MultiBandInfoList_r11 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MultiBandInfoList-r11";
   }

   public FreqBandIndicator_r11[] elements;

   public MultiBandInfoList_r11 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MultiBandInfoList_r11 (int numRecords) {
    ...
    * given the array.  
    */
   public MultiBandInfoList_r11 (FreqBandIndicator_r11[] elements_) {
      elements = elements_;
   }
