...
public class RecommendedENBsForPaging_iE_Extensions extends Asn1SeqOf {
   ...
   public RecommendedENBsForPaging_iE_Extensions_element[] elements;

   public RecommendedENBsForPaging_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RecommendedENBsForPaging_iE_Extensions (int numRecords) {
      elements = new RecommendedENBsForPaging_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RecommendedENBsForPaging_iE_Extensions (RecommendedENBsForPaging_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RecommendedENBsForPaging_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RecommendedENBsForPaging_iE_Extensions_element();
