...
public class EUTRANTraceID extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "EUTRANTraceID";
   }

   public EUTRANTraceID () {
      super();
   }
    ...
    *              in binary form.
    */
   public EUTRANTraceID (byte[] data) {
      super (data);
   }
    ...
    */
   public EUTRANTraceID (byte[] data, int offset, int nbytes) {
    ...
    */
   public EUTRANTraceID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
