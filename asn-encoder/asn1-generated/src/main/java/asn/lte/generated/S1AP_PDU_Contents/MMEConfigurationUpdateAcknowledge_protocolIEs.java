...
public class MMEConfigurationUpdateAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public MMEConfigurationUpdateAcknowledge_protocolIEs_element[] elements;

   public MMEConfigurationUpdateAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MMEConfigurationUpdateAcknowledge_protocolIEs (int numRecords) {
      elements = new MMEConfigurationUpdateAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MMEConfigurationUpdateAcknowledge_protocolIEs (MMEConfigurationUpdateAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MMEConfigurationUpdateAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MMEConfigurationUpdateAcknowledge_protocolIEs_element();
