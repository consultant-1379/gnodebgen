...
public class InitialContextSetupResponse_protocolIEs extends Asn1SeqOf {
   ...
   public InitialContextSetupResponse_protocolIEs_element[] elements;

   public InitialContextSetupResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public InitialContextSetupResponse_protocolIEs (int numRecords) {
      elements = new InitialContextSetupResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public InitialContextSetupResponse_protocolIEs (InitialContextSetupResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InitialContextSetupResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InitialContextSetupResponse_protocolIEs_element();
