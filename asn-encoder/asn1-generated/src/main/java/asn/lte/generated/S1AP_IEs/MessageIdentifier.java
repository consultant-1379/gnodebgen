...
public class MessageIdentifier extends Asn1BitString {
    ...
    */
   public MessageIdentifier (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public MessageIdentifier (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public MessageIdentifier (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public MessageIdentifier (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public MessageIdentifier (java.util.BitSet bitSet) {
      super (bitSet);
   }
