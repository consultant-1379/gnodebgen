...
public class CarrierFreqInfoUTRA_FDD_v8h0 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "CarrierFreqInfoUTRA-FDD-v8h0";
   }

   public CarrierFreqInfoUTRA_FDD_v8h0_multiBandInfoList multiBandInfoList;  // optional
    ...
    */
   public CarrierFreqInfoUTRA_FDD_v8h0 (
      CarrierFreqInfoUTRA_FDD_v8h0_multiBandInfoList multiBandInfoList_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (multiBandInfoListPresent) {
         ...
         multiBandInfoList = new CarrierFreqInfoUTRA_FDD_v8h0_multiBandInfoList();
