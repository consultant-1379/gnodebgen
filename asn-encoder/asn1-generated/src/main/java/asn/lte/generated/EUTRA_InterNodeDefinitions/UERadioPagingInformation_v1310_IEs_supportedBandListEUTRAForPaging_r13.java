...
import asn.lte.generated.EUTRA_RRC_Definitions.FreqBandIndicator_r11;

public class UERadioPagingInformation_v1310_IEs_supportedBandListEUTRAForPaging_r13 extends Asn1SeqOf {
   ...
   public FreqBandIndicator_r11[] elements;

   public UERadioPagingInformation_v1310_IEs_supportedBandListEUTRAForPaging_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UERadioPagingInformation_v1310_IEs_supportedBandListEUTRAForPaging_r13 (int numRecords) {
      elements = new FreqBandIndicator_r11 [numRecords];
   }
    ...
    * given the array.  
    */
   public UERadioPagingInformation_v1310_IEs_supportedBandListEUTRAForPaging_r13 (FreqBandIndicator_r11[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqBandIndicator_r11 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqBandIndicator_r11();
