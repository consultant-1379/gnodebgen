...
public class ServedCells_element_iE_Extensions extends Asn1SeqOf {
   ...
   public ServedCells_element_iE_Extensions_element[] elements;

   public ServedCells_element_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedCells_element_iE_Extensions (int numRecords) {
      elements = new ServedCells_element_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedCells_element_iE_Extensions (ServedCells_element_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedCells_element_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedCells_element_iE_Extensions_element();
