...
public class LastVisitedEUTRANCellInformation_iE_Extensions_element extends Asn1Seq {
   ...
   public void setUsing_id_Time_UE_StayedInCell_EnhancedGranularity(Time_UE_StayedInCell_EnhancedGranularity extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_Time_UE_StayedInCell_EnhancedGranularity);
   ...
   public void setUsing_id_HO_cause(Cause extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_HO_cause);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.LastVisitedEUTRANCellInformation_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.LastVisitedEUTRANCellInformation_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.LastVisitedEUTRANCellInformation_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
