...
public class UEsToBeResetList_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public UEsToBeResetList_Item_iE_Extensions_element[] elements;

   public UEsToBeResetList_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEsToBeResetList_Item_iE_Extensions (int numRecords) {
      elements = new UEsToBeResetList_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEsToBeResetList_Item_iE_Extensions (UEsToBeResetList_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEsToBeResetList_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEsToBeResetList_Item_iE_Extensions_element();
