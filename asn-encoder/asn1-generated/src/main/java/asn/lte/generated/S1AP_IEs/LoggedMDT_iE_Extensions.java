...
public class LoggedMDT_iE_Extensions extends Asn1SeqOf {
   ...
   public LoggedMDT_iE_Extensions_element[] elements;

   public LoggedMDT_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public LoggedMDT_iE_Extensions (int numRecords) {
      elements = new LoggedMDT_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public LoggedMDT_iE_Extensions (LoggedMDT_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LoggedMDT_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LoggedMDT_iE_Extensions_element();
