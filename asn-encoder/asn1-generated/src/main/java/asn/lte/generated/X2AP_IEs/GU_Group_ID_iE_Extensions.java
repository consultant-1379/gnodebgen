...
public class GU_Group_ID_iE_Extensions extends Asn1SeqOf {
   ...
   public GU_Group_ID_iE_Extensions_element[] elements;

   public GU_Group_ID_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public GU_Group_ID_iE_Extensions (int numRecords) {
      elements = new GU_Group_ID_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public GU_Group_ID_iE_Extensions (GU_Group_ID_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GU_Group_ID_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GU_Group_ID_iE_Extensions_element();
