...
public class InterFreqNeighHSDN_CellList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqNeighHSDN-CellList-r15";
   }

   public PhysCellIdRange[] elements;

   public InterFreqNeighHSDN_CellList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqNeighHSDN_CellList_r15 (int numRecords) {
      elements = new PhysCellIdRange [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqNeighHSDN_CellList_r15 (PhysCellIdRange[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PhysCellIdRange [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PhysCellIdRange();
