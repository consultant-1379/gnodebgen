...
public class CompletedCellinEAI extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CompletedCellinEAI";
   }

   public CompletedCellinEAI_Item[] elements;

   public CompletedCellinEAI () {
      elements = null;
   }
    ...
    * populated.
    */
   public CompletedCellinEAI (int numRecords) {
      elements = new CompletedCellinEAI_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public CompletedCellinEAI (CompletedCellinEAI_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CompletedCellinEAI_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CompletedCellinEAI_Item();
