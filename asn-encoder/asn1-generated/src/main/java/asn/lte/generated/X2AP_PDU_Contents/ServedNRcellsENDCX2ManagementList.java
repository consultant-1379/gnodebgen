...
public class ServedNRcellsENDCX2ManagementList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServedNRcellsENDCX2ManagementList";
   }

   public ServedNRcellsENDCX2ManagementList_element[] elements;

   public ServedNRcellsENDCX2ManagementList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedNRcellsENDCX2ManagementList (int numRecords) {
      elements = new ServedNRcellsENDCX2ManagementList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedNRcellsENDCX2ManagementList (ServedNRcellsENDCX2ManagementList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 16384);
      int numElements = (int) buffer.decodeLength();

      elements = new ServedNRcellsENDCX2ManagementList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedNRcellsENDCX2ManagementList_element();
