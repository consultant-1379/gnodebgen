...
public class EAB_E5_TransparentContainer extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "EAB-E5-TransparentContainer";
   }

   public EAB_E5_TransparentContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public EAB_E5_TransparentContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public EAB_E5_TransparentContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public EAB_E5_TransparentContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
