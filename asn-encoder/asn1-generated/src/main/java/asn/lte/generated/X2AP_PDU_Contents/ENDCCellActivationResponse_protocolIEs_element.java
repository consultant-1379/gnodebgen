...
public class ENDCCellActivationResponse_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-ActivatedNRCellList
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: ActivatedNRCellList
    * Java type: ActivatedNRCellList
    *
    * id: id-ActivationID
   ...
   public ENDCCellActivationResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCCellActivationResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-ActivatedNRCellList
    */
   public void setUsing_id_ActivatedNRCellList(ActivatedNRCellList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ActivatedNRCellList);
   ...
   /**
    * Get value of value with type set according to information object having key id-ActivatedNRCellList
    */
   public ActivatedNRCellList getValueFor_id_ActivatedNRCellList() {
      return (ActivatedNRCellList) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCCellActivationResponse_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCCellActivationResponse_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCCellActivationResponse_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 268) {
         indent (_sb, _level+1);
         _sb.append("id = id-ActivatedNRCellList\n");
      }
