...
public class MeasObjectToAddModList extends Asn1SeqOf {
   ...
   public MeasObjectToAddMod[] elements;

   public MeasObjectToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasObjectToAddModList (int numRecords) {
      elements = new MeasObjectToAddMod [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasObjectToAddModList (MeasObjectToAddMod[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasObjectToAddMod [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasObjectToAddMod();
