...
public class ServedDCNs extends Asn1SeqOf {
   ...
   public ServedDCNsItem[] elements;
    ...
    * populated.
    */
   public ServedDCNs (int numRecords) {
      elements = new ServedDCNsItem [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedDCNs (ServedDCNsItem[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedDCNsItem [numElements];
