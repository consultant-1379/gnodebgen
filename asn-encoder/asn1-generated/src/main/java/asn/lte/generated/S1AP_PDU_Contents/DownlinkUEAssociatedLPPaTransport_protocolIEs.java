...
public class DownlinkUEAssociatedLPPaTransport_protocolIEs extends Asn1SeqOf {
   ...
   public DownlinkUEAssociatedLPPaTransport_protocolIEs_element[] elements;

   public DownlinkUEAssociatedLPPaTransport_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public DownlinkUEAssociatedLPPaTransport_protocolIEs (int numRecords) {
      elements = new DownlinkUEAssociatedLPPaTransport_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public DownlinkUEAssociatedLPPaTransport_protocolIEs (DownlinkUEAssociatedLPPaTransport_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DownlinkUEAssociatedLPPaTransport_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DownlinkUEAssociatedLPPaTransport_protocolIEs_element();
