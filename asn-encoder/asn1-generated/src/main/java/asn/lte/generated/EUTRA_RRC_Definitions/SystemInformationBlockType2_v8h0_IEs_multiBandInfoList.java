...
public class SystemInformationBlockType2_v8h0_IEs_multiBandInfoList extends Asn1SeqOf {
   ...
   public SystemInformationBlockType2_v8h0_IEs_multiBandInfoList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SystemInformationBlockType2_v8h0_IEs_multiBandInfoList (int numRecords) {
    ...
    * given the array.  
    */
   public SystemInformationBlockType2_v8h0_IEs_multiBandInfoList (AdditionalSpectrumEmission[] elements_) {
      elements = elements_;
   }
