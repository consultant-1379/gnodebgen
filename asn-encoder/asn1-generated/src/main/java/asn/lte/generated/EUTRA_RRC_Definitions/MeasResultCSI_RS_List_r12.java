...
public class MeasResultCSI_RS_List_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultCSI-RS-List-r12";
   }

   public MeasResultCSI_RS_r12[] elements;

   public MeasResultCSI_RS_List_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultCSI_RS_List_r12 (int numRecords) {
      elements = new MeasResultCSI_RS_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultCSI_RS_List_r12 (MeasResultCSI_RS_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultCSI_RS_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultCSI_RS_r12();
