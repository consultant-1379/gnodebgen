...
public class E_RABs_ToBeReleased_ModReqdItem extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeReleased-ModReqdItem";
   }

   public E_RAB_ID e_RAB_ID;
   public Cause cause;
   public E_RABs_ToBeReleased_ModReqdItem_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public E_RABs_ToBeReleased_ModReqdItem () {
      super();
      init();
   }
   ...
   public E_RABs_ToBeReleased_ModReqdItem (
      E_RAB_ID e_RAB_ID_,
      Cause cause_,
      E_RABs_ToBeReleased_ModReqdItem_iE_Extensions iE_Extensions_
   ) {
      super();
      e_RAB_ID = e_RAB_ID_;
      cause = cause_;
    ...
    * the given objects 
    */
   public E_RABs_ToBeReleased_ModReqdItem (long e_RAB_ID_,
      Cause cause_,
      E_RABs_ToBeReleased_ModReqdItem_iE_Extensions iE_Extensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new E_RABs_ToBeReleased_ModReqdItem_iE_Extensions();
