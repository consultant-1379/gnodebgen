...
public class CO_DurationsPerCell_r16_co_DurationList_r16 extends Asn1SeqOf {
   ...
   public CO_Duration_r16[] elements;

   public CO_DurationsPerCell_r16_co_DurationList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CO_DurationsPerCell_r16_co_DurationList_r16 (int numRecords) {
      elements = new CO_Duration_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public CO_DurationsPerCell_r16_co_DurationList_r16 (CO_Duration_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CO_Duration_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CO_Duration_r16();
