...
public class RACH_InfoList_NB_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RACH-InfoList-NB-v1530";
   }

   public RACH_Info_NB_v1530[] elements;

   public RACH_InfoList_NB_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RACH_InfoList_NB_v1530 (int numRecords) {
      elements = new RACH_Info_NB_v1530 [numRecords];
   }
    ...
    * given the array.  
    */
   public RACH_InfoList_NB_v1530 (RACH_Info_NB_v1530[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RACH_Info_NB_v1530 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RACH_Info_NB_v1530();
