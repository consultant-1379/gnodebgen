...
public class Limited_list extends Asn1SeqOf {
   ...
   public Limited_list_element[] elements;
    ...
    * populated.
    */
   public Limited_list (int numRecords) {
      elements = new Limited_list_element [numRecords];
   }
    ...
    * given the array.  
    */
   public Limited_list (Limited_list_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Limited_list_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Limited_list_element();
