...
public class FreqsPriorityListGERAN extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "FreqsPriorityListGERAN";
   }

   public FreqsPriorityGERAN[] elements;

   public FreqsPriorityListGERAN () {
      elements = null;
   }
    ...
    * populated.
    */
   public FreqsPriorityListGERAN (int numRecords) {
      elements = new FreqsPriorityGERAN [numRecords];
   }
    ...
    * given the array.  
    */
   public FreqsPriorityListGERAN (FreqsPriorityGERAN[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqsPriorityGERAN [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqsPriorityGERAN();
