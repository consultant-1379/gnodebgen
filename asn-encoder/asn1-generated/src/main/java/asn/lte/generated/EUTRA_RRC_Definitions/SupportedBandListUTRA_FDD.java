...
public class SupportedBandListUTRA_FDD extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandListUTRA-FDD";
   }

   public SupportedBandUTRA_FDD[] elements;

   public SupportedBandListUTRA_FDD () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandListUTRA_FDD (int numRecords) {
      elements = new SupportedBandUTRA_FDD [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandListUTRA_FDD (SupportedBandUTRA_FDD[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBandUTRA_FDD [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         {
            int tval = SupportedBandUTRA_FDD.decodeEnumValue (buffer);
            elements[i] = SupportedBandUTRA_FDD.valueOf (tval);
         }
