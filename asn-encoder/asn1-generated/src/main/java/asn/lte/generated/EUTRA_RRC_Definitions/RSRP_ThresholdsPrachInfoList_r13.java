...
public class RSRP_ThresholdsPrachInfoList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RSRP-ThresholdsPrachInfoList-r13";
   }

   public RSRP_Range[] elements;

   public RSRP_ThresholdsPrachInfoList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RSRP_ThresholdsPrachInfoList_r13 (int numRecords) {
    ...
    * given the array.  
    */
   public RSRP_ThresholdsPrachInfoList_r13 (RSRP_Range[] elements_) {
      elements = elements_;
   }
