...
public class SlotFormatIndicator_switchTriggerToAddModList_r16 extends Asn1SeqOf {
   ...
   public SearchSpaceSwitchTrigger_r16[] elements;

   public SlotFormatIndicator_switchTriggerToAddModList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SlotFormatIndicator_switchTriggerToAddModList_r16 (int numRecords) {
      elements = new SearchSpaceSwitchTrigger_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SlotFormatIndicator_switchTriggerToAddModList_r16 (SearchSpaceSwitchTrigger_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SearchSpaceSwitchTrigger_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SearchSpaceSwitchTrigger_r16();
