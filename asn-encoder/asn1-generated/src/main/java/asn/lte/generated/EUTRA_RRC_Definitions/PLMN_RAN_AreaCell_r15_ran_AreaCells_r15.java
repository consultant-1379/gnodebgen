...
public class PLMN_RAN_AreaCell_r15_ran_AreaCells_r15 extends Asn1SeqOf {
   ...
   public CellIdentity[] elements;

   public PLMN_RAN_AreaCell_r15_ran_AreaCells_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_RAN_AreaCell_r15_ran_AreaCells_r15 (int numRecords) {
      elements = new CellIdentity [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMN_RAN_AreaCell_r15_ran_AreaCells_r15 (CellIdentity[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellIdentity [numElements];
