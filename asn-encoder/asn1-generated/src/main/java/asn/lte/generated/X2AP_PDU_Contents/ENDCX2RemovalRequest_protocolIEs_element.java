...
public class ENDCX2RemovalRequest_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-InitiatingNodeType-EndcX2Removal
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: InitiatingNodeType-EndcX2Removal
    * Java type: InitiatingNodeType_EndcX2Removal
    *
   ...
   public ENDCX2RemovalRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCX2RemovalRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-InitiatingNodeType-EndcX2Removal
    */
   public void setUsing_id_InitiatingNodeType_EndcX2Removal(InitiatingNodeType_EndcX2Removal value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_InitiatingNodeType_EndcX2Removal);
   ...
   /**
    * Get value of value with type set according to information object having key id-InitiatingNodeType-EndcX2Removal
    */
   public InitiatingNodeType_EndcX2Removal getValueFor_id_InitiatingNodeType_EndcX2Removal() {
      return (InitiatingNodeType_EndcX2Removal) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCX2RemovalRequest_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCX2RemovalRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCX2RemovalRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 298) {
         indent (_sb, _level+1);
         _sb.append("id = id-InitiatingNodeType-EndcX2Removal\n");
      }
