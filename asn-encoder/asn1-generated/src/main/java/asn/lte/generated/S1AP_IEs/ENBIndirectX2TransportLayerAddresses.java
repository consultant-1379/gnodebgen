...
public class ENBIndirectX2TransportLayerAddresses extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ENBIndirectX2TransportLayerAddresses";
   }

   public TransportLayerAddress[] elements;

   public ENBIndirectX2TransportLayerAddresses () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENBIndirectX2TransportLayerAddresses (int numRecords) {
      elements = new TransportLayerAddress [numRecords];
   }
    ...
    * given the array.  
    */
   public ENBIndirectX2TransportLayerAddresses (TransportLayerAddress[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TransportLayerAddress [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TransportLayerAddress();
