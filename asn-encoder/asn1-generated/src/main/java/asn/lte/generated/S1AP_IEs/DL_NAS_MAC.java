...
public class DL_NAS_MAC extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public DL_NAS_MAC (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public DL_NAS_MAC (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public DL_NAS_MAC (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public DL_NAS_MAC (java.util.BitSet bitSet) {
      super (bitSet);
   }
