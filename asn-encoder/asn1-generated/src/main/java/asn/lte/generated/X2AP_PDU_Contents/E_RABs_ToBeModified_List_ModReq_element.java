...
public class E_RABs_ToBeModified_List_ModReq_element extends Asn1Seq {
   ...
   /**
    * id: id-E-RABs-ToBeModified-ModReqItem
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABs-ToBeModified-ModReqItem
    * Java type: E_RABs_ToBeModified_ModReqItem
    */
   public Asn1Type value;

   public E_RABs_ToBeModified_List_ModReq_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABs_ToBeModified_List_ModReq_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-ToBeModified-ModReqItem
    */
   public void setUsing_id_E_RABs_ToBeModified_ModReqItem(E_RABs_ToBeModified_ModReqItem value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_ToBeModified_ModReqItem);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABs-ToBeModified-ModReqItem
    */
   public E_RABs_ToBeModified_ModReqItem getValueFor_id_E_RABs_ToBeModified_ModReqItem() {
      return (E_RABs_ToBeModified_ModReqItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.E_RABs_ToBeModified_ModReqItemIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.E_RABs_ToBeModified_ModReqItemIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.E_RABs_ToBeModified_ModReqItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 126) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-ToBeModified-ModReqItem\n");
      }
