...
public class BT_Name_r15 extends Asn1OctetString {
    ...
    */
   public BT_Name_r15 (byte[] data, int offset, int nbytes) {
    ...
    */
   public BT_Name_r15 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
