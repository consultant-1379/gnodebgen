...
public class PWSfailedECGIList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PWSfailedECGIList";
   }

   public EUTRAN_CGI[] elements;

   public PWSfailedECGIList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PWSfailedECGIList (int numRecords) {
    ...
    * given the array.  
    */
   public PWSfailedECGIList (EUTRAN_CGI[] elements_) {
      elements = elements_;
   }
