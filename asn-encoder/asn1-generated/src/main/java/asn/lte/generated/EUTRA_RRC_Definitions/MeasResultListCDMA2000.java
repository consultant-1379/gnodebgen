...
public class MeasResultListCDMA2000 extends Asn1SeqOf {
   ...
   public MeasResultCDMA2000[] elements;

   public MeasResultListCDMA2000 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListCDMA2000 (int numRecords) {
      elements = new MeasResultCDMA2000 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListCDMA2000 (MeasResultCDMA2000[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultCDMA2000 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultCDMA2000();
