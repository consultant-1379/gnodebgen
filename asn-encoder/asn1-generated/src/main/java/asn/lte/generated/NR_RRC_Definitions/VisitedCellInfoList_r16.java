...
public class VisitedCellInfoList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "VisitedCellInfoList-r16";
   }

   public VisitedCellInfo_r16[] elements;

   public VisitedCellInfoList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public VisitedCellInfoList_r16 (int numRecords) {
      elements = new VisitedCellInfo_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public VisitedCellInfoList_r16 (VisitedCellInfo_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new VisitedCellInfo_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new VisitedCellInfo_r16();
