...
public class GlobalENB_ID_iE_Extensions extends Asn1SeqOf {
   ...
   public GlobalENB_ID_iE_Extensions_element[] elements;

   public GlobalENB_ID_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public GlobalENB_ID_iE_Extensions (int numRecords) {
      elements = new GlobalENB_ID_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public GlobalENB_ID_iE_Extensions (GlobalENB_ID_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GlobalENB_ID_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GlobalENB_ID_iE_Extensions_element();
