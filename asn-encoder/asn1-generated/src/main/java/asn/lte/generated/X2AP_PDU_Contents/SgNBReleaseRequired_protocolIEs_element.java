...
public class SgNBReleaseRequired_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-E-RABs-ToBeReleased-SgNBRelReqdList
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: E-RABs-ToBeReleased-SgNBRelReqdList
    * Java type: E_RABs_ToBeReleased_SgNBRelReqdList
    */
   public Asn1Type value;

   public SgNBReleaseRequired_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBReleaseRequired_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-ToBeReleased-SgNBRelReqdList
    */
   public void setUsing_id_E_RABs_ToBeReleased_SgNBRelReqdList(E_RABs_ToBeReleased_SgNBRelReqdList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_ToBeReleased_SgNBRelReqdList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-ToBeReleased-SgNBRelReqdList
    */
   public E_RABs_ToBeReleased_SgNBRelReqdList getValueFor_id_E_RABs_ToBeReleased_SgNBRelReqdList() {
      return (E_RABs_ToBeReleased_SgNBRelReqdList) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SgNBReleaseRequired_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SgNBReleaseRequired_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SgNBReleaseRequired_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 320) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-ToBeReleased-SgNBRelReqdList\n");
      }
