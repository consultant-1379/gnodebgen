...
public class PUCCH_Config_resourceGroupToReleaseList_r16 extends Asn1SeqOf {
   ...
   public PUCCH_ResourceGroupId_r16[] elements;

   public PUCCH_Config_resourceGroupToReleaseList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_resourceGroupToReleaseList_r16 (int numRecords) {
      elements = new PUCCH_ResourceGroupId_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_Config_resourceGroupToReleaseList_r16 (PUCCH_ResourceGroupId_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUCCH_ResourceGroupId_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUCCH_ResourceGroupId_r16();
