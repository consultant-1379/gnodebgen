...
public class CSI_SSB_ResourceSet_csi_SSB_ResourceList extends Asn1SeqOf {
   ...
   public SSB_Index[] elements;

   public CSI_SSB_ResourceSet_csi_SSB_ResourceList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_SSB_ResourceSet_csi_SSB_ResourceList (int numRecords) {
      elements = new SSB_Index [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_SSB_ResourceSet_csi_SSB_ResourceList (SSB_Index[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SSB_Index [numElements];
