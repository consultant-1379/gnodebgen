...
public class UERadioAccessCapabilityInformation_NB_v1380_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UERadioAccessCapabilityInformation-NB-v1380-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public UERadioAccessCapabilityInformation_NB_r14_IEs nonCriticalExtension;  // optional

   public UERadioAccessCapabilityInformation_NB_v1380_IEs () {
      super();
      init();
   }
   ...
   public UERadioAccessCapabilityInformation_NB_v1380_IEs (
      ...
      UERadioAccessCapabilityInformation_NB_r14_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public UERadioAccessCapabilityInformation_NB_v1380_IEs (byte[] lateNonCriticalExtension_,
      UERadioAccessCapabilityInformation_NB_r14_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new UERadioAccessCapabilityInformation_NB_r14_IEs();
