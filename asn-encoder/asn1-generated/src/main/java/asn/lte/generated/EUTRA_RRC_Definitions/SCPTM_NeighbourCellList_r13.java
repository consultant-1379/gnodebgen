...
public class SCPTM_NeighbourCellList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCPTM-NeighbourCellList-r13";
   }

   public PCI_ARFCN_r13[] elements;

   public SCPTM_NeighbourCellList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCPTM_NeighbourCellList_r13 (int numRecords) {
      elements = new PCI_ARFCN_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCPTM_NeighbourCellList_r13 (PCI_ARFCN_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PCI_ARFCN_r13 [numElements];
