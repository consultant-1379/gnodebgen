...
public class UTDOAInformationRequest_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: RequestedSRSTransmissionCharacteristics
    * Java type: RequestedSRSTransmissionCharacteristics
    */
   public Asn1Type value;

   public UTDOAInformationRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UTDOAInformationRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-RequestedSRSTransmissionCharacteristics
    */
   public void setUsing_id_RequestedSRSTransmissionCharacteristics(asn.lte.generated.LPPA_IEs.RequestedSRSTransmissionCharacteristics value) {
      this.id = new asn.lte.generated.LPPA_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.LPPA_Constants._LPPA_ConstantsValues.id_RequestedSRSTransmissionCharacteristics);
      this.criticality = asn.lte.generated.LPPA_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-RequestedSRSTransmissionCharacteristics
    */
   public asn.lte.generated.LPPA_IEs.RequestedSRSTransmissionCharacteristics getValueFor_id_RequestedSRSTransmissionCharacteristics() {
      return (asn.lte.generated.LPPA_IEs.RequestedSRSTransmissionCharacteristics) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _LPPA_PDU_ContentsValues.UTDOAInformationRequest_IEs.length; i++) {
         if(_LPPA_PDU_ContentsValues.UTDOAInformationRequest_IEs[i].id.equals(id)) {
            _index = _LPPA_PDU_ContentsValues.UTDOAInformationRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 12) {
         indent (_sb, _level+1);
         _sb.append("id = id-RequestedSRSTransmissionCharacteristics\n");
      }
