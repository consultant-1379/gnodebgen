...
public class MDT_Location_Info extends Asn1BitString {
    ...
    */
   public MDT_Location_Info (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public MDT_Location_Info (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public MDT_Location_Info (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public MDT_Location_Info (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public MDT_Location_Info (java.util.BitSet bitSet) {
      super (bitSet);
   }
