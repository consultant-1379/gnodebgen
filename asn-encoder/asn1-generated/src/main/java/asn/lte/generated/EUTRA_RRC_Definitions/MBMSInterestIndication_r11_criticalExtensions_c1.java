...
public class MBMSInterestIndication_r11_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _INTERESTINDICATION_R11 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public MBMSInterestIndication_r11_criticalExtensions_c1 () {
      super();
   }

   public MBMSInterestIndication_r11_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _INTERESTINDICATION_R11: return "interestIndication_r11";
   ...
   public void set_interestIndication_r11 (MBMSInterestIndication_r11_IEs value) {
      setElement (_INTERESTINDICATION_R11, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         // interestIndication_r11
         case 0: { 
            MBMSInterestIndication_r11_IEs interestIndication_r11;
            element = interestIndication_r11 = new MBMSInterestIndication_r11_IEs();
            interestIndication_r11.decode (buffer);
            break;
         }
