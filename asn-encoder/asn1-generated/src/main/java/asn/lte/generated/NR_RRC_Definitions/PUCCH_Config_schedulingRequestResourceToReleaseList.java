...
public class PUCCH_Config_schedulingRequestResourceToReleaseList extends Asn1SeqOf {
   ...
   public SchedulingRequestResourceId[] elements;

   public PUCCH_Config_schedulingRequestResourceToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_Config_schedulingRequestResourceToReleaseList (int numRecords) {
      elements = new SchedulingRequestResourceId [numRecords];
   }
    ...
    * given the array.  
    */
   public PUCCH_Config_schedulingRequestResourceToReleaseList (SchedulingRequestResourceId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SchedulingRequestResourceId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SchedulingRequestResourceId();
