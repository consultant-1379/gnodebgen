...
public class X2APMessageTransfer_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: RNL-Header
    * Java type: RNL_Header
    *
    * id: id-x2APMessage
    * criticality: Criticality.reject
    * presence: Presence.optional
    * ASN.1 type: X2AP-Message
    * Java type: X2AP_Message
    */
   public Asn1Type value;

   public X2APMessageTransfer_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public X2APMessageTransfer_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-RNL-Header
    */
   public void setUsing_id_RNL_Header(RNL_Header value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_RNL_Header);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-x2APMessage
    */
   public void setUsing_id_x2APMessage(X2AP_Message value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_x2APMessage);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-RNL-Header
    */
   public RNL_Header getValueFor_id_RNL_Header() {
      return (RNL_Header) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-x2APMessage
    */
   public X2AP_Message getValueFor_id_x2APMessage() {
      return (X2AP_Message) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.X2APMessageTransfer_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.X2APMessageTransfer_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.X2APMessageTransfer_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 101) {
         indent (_sb, _level+1);
         _sb.append("id = id-RNL-Header\n");
      }
      else if (id.value == 102) {
         indent (_sb, _level+1);
         _sb.append("id = id-x2APMessage\n");
      }
