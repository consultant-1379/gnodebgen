...
public class CellActivationResponse_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-ActivatedCellList
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: ActivatedCellList
    * Java type: ActivatedCellList
    *
   ...
   public CellActivationResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public CellActivationResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-ActivatedCellList
    */
   public void setUsing_id_ActivatedCellList(ActivatedCellList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ActivatedCellList);
   ...
   /**
    * Get value of value with type set according to information object having key id-ActivatedCellList
    */
   public ActivatedCellList getValueFor_id_ActivatedCellList() {
      return (ActivatedCellList) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.CellActivationResponse_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.CellActivationResponse_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.CellActivationResponse_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 58) {
         indent (_sb, _level+1);
         _sb.append("id = id-ActivatedCellList\n");
      }
      else if (id.value == 17) {
         indent (_sb, _level+1);
