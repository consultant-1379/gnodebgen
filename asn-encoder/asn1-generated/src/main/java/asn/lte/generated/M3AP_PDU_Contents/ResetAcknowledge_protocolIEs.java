...
public class ResetAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public ResetAcknowledge_protocolIEs_element[] elements;

   public ResetAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResetAcknowledge_protocolIEs (int numRecords) {
      elements = new ResetAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ResetAcknowledge_protocolIEs (ResetAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResetAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResetAcknowledge_protocolIEs_element();
