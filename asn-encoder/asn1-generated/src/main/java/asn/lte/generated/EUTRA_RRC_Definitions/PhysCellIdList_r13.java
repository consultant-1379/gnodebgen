...
public class PhysCellIdList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PhysCellIdList-r13";
   }

   public PhysCellId[] elements;

   public PhysCellIdList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PhysCellIdList_r13 (int numRecords) {
    ...
    * given the array.  
    */
   public PhysCellIdList_r13 (PhysCellId[] elements_) {
      elements = elements_;
   }
