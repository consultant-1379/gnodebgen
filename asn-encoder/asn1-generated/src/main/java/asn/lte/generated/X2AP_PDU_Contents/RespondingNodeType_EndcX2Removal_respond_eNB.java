...
public class RespondingNodeType_EndcX2Removal_respond_eNB extends Asn1SeqOf {
   ...
   public RespondingNodeType_EndcX2Removal_respond_eNB_element[] elements;

   public RespondingNodeType_EndcX2Removal_respond_eNB () {
      elements = null;
   }
    ...
    * populated.
    */
   public RespondingNodeType_EndcX2Removal_respond_eNB (int numRecords) {
      elements = new RespondingNodeType_EndcX2Removal_respond_eNB_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RespondingNodeType_EndcX2Removal_respond_eNB (RespondingNodeType_EndcX2Removal_respond_eNB_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RespondingNodeType_EndcX2Removal_respond_eNB_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RespondingNodeType_EndcX2Removal_respond_eNB_element();
