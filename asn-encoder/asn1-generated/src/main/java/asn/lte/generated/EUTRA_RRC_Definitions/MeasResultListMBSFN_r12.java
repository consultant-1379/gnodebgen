...
public class MeasResultListMBSFN_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultListMBSFN-r12";
   }

   public MeasResultMBSFN_r12[] elements;

   public MeasResultListMBSFN_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListMBSFN_r12 (int numRecords) {
      elements = new MeasResultMBSFN_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListMBSFN_r12 (MeasResultMBSFN_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultMBSFN_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultMBSFN_r12();
