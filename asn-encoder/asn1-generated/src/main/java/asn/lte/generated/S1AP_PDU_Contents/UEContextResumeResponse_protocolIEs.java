...
public class UEContextResumeResponse_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextResumeResponse_protocolIEs_element[] elements;

   public UEContextResumeResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextResumeResponse_protocolIEs (int numRecords) {
      elements = new UEContextResumeResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextResumeResponse_protocolIEs (UEContextResumeResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextResumeResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextResumeResponse_protocolIEs_element();
