...
public class E_RABSetupResponse_protocolIEs extends Asn1SeqOf {
   ...
   public E_RABSetupResponse_protocolIEs_element[] elements;

   public E_RABSetupResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABSetupResponse_protocolIEs (int numRecords) {
      elements = new E_RABSetupResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABSetupResponse_protocolIEs (E_RABSetupResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABSetupResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABSetupResponse_protocolIEs_element();
