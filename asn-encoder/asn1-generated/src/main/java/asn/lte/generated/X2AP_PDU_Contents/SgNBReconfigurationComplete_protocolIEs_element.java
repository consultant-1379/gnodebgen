...
public class SgNBReconfigurationComplete_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-ResponseInformationSgNBReconfComp
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-SgNBReconfigurationComplete-ExtConveyor
    * Java type: EAB_SgNBReconfigurationComplete_ExtConveyor
    */
   public Asn1Type value;

   public SgNBReconfigurationComplete_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBReconfigurationComplete_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-ResponseInformationSgNBReconfComp
    */
   public void setUsing_id_ResponseInformationSgNBReconfComp(ResponseInformationSgNBReconfComp value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ResponseInformationSgNBReconfComp);
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBReconfigurationComplete_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-ResponseInformationSgNBReconfComp
    */
   public ResponseInformationSgNBReconfComp getValueFor_id_ResponseInformationSgNBReconfComp() {
      return (ResponseInformationSgNBReconfComp) this.value;
   }
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBReconfigurationComplete_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBReconfigurationComplete_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SgNBReconfigurationComplete_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SgNBReconfigurationComplete_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SgNBReconfigurationComplete_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 214) {
         indent (_sb, _level+1);
         _sb.append("id = id-ResponseInformationSgNBReconfComp\n");
      }
