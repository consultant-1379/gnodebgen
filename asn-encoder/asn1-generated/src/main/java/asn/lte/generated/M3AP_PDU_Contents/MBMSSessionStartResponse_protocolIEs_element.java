...
public class MBMSSessionStartResponse_protocolIEs_element extends Asn1Seq {
   ...
   public MBMSSessionStartResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MBMSSessionStartResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _M3AP_PDU_ContentsValues.MBMSSessionStartResponse_IEs.length; i++) {
         if(_M3AP_PDU_ContentsValues.MBMSSessionStartResponse_IEs[i].id.equals(id)) {
            _index = _M3AP_PDU_ContentsValues.MBMSSessionStartResponse_IEs[i];
            break;
         }
      }
      if (null == _index) {
