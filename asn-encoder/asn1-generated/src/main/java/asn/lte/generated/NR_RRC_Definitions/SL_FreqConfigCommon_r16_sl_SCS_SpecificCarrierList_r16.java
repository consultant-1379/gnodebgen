...
public class SL_FreqConfigCommon_r16_sl_SCS_SpecificCarrierList_r16 extends Asn1SeqOf {
   ...
   public SCS_SpecificCarrier[] elements;

   public SL_FreqConfigCommon_r16_sl_SCS_SpecificCarrierList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_FreqConfigCommon_r16_sl_SCS_SpecificCarrierList_r16 (int numRecords) {
      elements = new SCS_SpecificCarrier [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_FreqConfigCommon_r16_sl_SCS_SpecificCarrierList_r16 (SCS_SpecificCarrier[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCS_SpecificCarrier [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SCS_SpecificCarrier();
