...
public class SL_DiscSysInfoToReportFreqList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-DiscSysInfoToReportFreqList-r13";
   }

   public ARFCN_ValueEUTRA_r9[] elements;

   public SL_DiscSysInfoToReportFreqList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_DiscSysInfoToReportFreqList_r13 (int numRecords) {
    ...
    * given the array.  
    */
   public SL_DiscSysInfoToReportFreqList_r13 (ARFCN_ValueEUTRA_r9[] elements_) {
      elements = elements_;
   }
