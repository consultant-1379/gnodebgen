...
public class PDSCH_Config_rateMatchPatternToAddModList extends Asn1SeqOf {
   ...
   public PDSCH_Config_rateMatchPatternToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDSCH_Config_rateMatchPatternToAddModList (int numRecords) {
    ...
    * given the array.  
    */
   public PDSCH_Config_rateMatchPatternToAddModList (RateMatchPattern[] elements_) {
      elements = elements_;
   }
