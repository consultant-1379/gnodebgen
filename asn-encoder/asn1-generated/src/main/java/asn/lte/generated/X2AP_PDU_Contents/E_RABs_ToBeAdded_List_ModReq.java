...
public class E_RABs_ToBeAdded_List_ModReq extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeAdded-List-ModReq";
   }

   public E_RABs_ToBeAdded_List_ModReq_element[] elements;

   public E_RABs_ToBeAdded_List_ModReq () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeAdded_List_ModReq (int numRecords) {
      elements = new E_RABs_ToBeAdded_List_ModReq_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeAdded_List_ModReq (E_RABs_ToBeAdded_List_ModReq_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeAdded_List_ModReq_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeAdded_List_ModReq_element();
