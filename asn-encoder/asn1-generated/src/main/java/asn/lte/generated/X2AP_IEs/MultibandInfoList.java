...
public class MultibandInfoList extends Asn1SeqOf {
   ...
   public MultibandInfoList (int numRecords) {
      elements = new BandInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public MultibandInfoList (BandInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandInfo [numElements];
