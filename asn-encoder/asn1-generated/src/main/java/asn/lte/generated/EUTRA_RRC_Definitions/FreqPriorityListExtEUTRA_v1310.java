...
public class FreqPriorityListExtEUTRA_v1310 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "FreqPriorityListExtEUTRA-v1310";
   }

   public FreqPriorityEUTRA_v1310[] elements;

   public FreqPriorityListExtEUTRA_v1310 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FreqPriorityListExtEUTRA_v1310 (int numRecords) {
      elements = new FreqPriorityEUTRA_v1310 [numRecords];
   }
    ...
    * given the array.  
    */
   public FreqPriorityListExtEUTRA_v1310 (FreqPriorityEUTRA_v1310[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqPriorityEUTRA_v1310 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqPriorityEUTRA_v1310();
