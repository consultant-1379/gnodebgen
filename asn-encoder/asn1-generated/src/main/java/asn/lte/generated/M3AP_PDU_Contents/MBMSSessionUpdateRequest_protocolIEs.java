...
public class MBMSSessionUpdateRequest_protocolIEs extends Asn1SeqOf {
   ...
   public MBMSSessionUpdateRequest_protocolIEs_element[] elements;

   public MBMSSessionUpdateRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMSSessionUpdateRequest_protocolIEs (int numRecords) {
      elements = new MBMSSessionUpdateRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMSSessionUpdateRequest_protocolIEs (MBMSSessionUpdateRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMSSessionUpdateRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMSSessionUpdateRequest_protocolIEs_element();
