...
public class E_RABReleaseCommand_protocolIEs extends Asn1SeqOf {
   ...
   public E_RABReleaseCommand_protocolIEs_element[] elements;

   public E_RABReleaseCommand_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABReleaseCommand_protocolIEs (int numRecords) {
      elements = new E_RABReleaseCommand_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABReleaseCommand_protocolIEs (E_RABReleaseCommand_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABReleaseCommand_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABReleaseCommand_protocolIEs_element();
