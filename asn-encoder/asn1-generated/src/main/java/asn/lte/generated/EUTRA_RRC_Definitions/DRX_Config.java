...
public class DRX_Config extends Asn1Choice {
   ...
   public DRX_Config (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (DRX_Config_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            DRX_Config_setup setup;
            element = setup = new DRX_Config_setup();
            setup.decode (buffer);
            break;
         }
