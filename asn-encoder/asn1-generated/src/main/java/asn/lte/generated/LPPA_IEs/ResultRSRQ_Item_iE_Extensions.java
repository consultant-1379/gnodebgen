...
public class ResultRSRQ_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public ResultRSRQ_Item_iE_Extensions_element[] elements;

   public ResultRSRQ_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResultRSRQ_Item_iE_Extensions (int numRecords) {
      elements = new ResultRSRQ_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ResultRSRQ_Item_iE_Extensions (ResultRSRQ_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResultRSRQ_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResultRSRQ_Item_iE_Extensions_element();
