...
public class CellGroupConfig_rlc_BearerToAddModList extends Asn1SeqOf {
   ...
   public RLC_BearerConfig[] elements;

   public CellGroupConfig_rlc_BearerToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellGroupConfig_rlc_BearerToAddModList (int numRecords) {
      elements = new RLC_BearerConfig [numRecords];
   }
    ...
    * given the array.  
    */
   public CellGroupConfig_rlc_BearerToAddModList (RLC_BearerConfig[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RLC_BearerConfig [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RLC_BearerConfig();
