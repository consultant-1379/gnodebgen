...
public class SlotFormatIndicator_availableRB_SetsToAddModList_r16 extends Asn1SeqOf {
   ...
   public AvailableRB_SetsPerCell_r16[] elements;

   public SlotFormatIndicator_availableRB_SetsToAddModList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SlotFormatIndicator_availableRB_SetsToAddModList_r16 (int numRecords) {
      elements = new AvailableRB_SetsPerCell_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SlotFormatIndicator_availableRB_SetsToAddModList_r16 (AvailableRB_SetsPerCell_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AvailableRB_SetsPerCell_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AvailableRB_SetsPerCell_r16();
