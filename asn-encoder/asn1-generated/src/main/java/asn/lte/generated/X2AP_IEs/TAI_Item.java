...
public class TAI_Item extends Asn1Seq {
   ...
   public TAI_Item_iE_Extensions iE_Extensions;  // optional
   ...
   public TAI_Item (
      ...
      TAI_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      tAC = tAC_;
      pLMN_Identity = pLMN_Identity_;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new TAI_Item_iE_Extensions();
