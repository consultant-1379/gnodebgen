...
public class SL_CommTxPoolListExt_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-CommTxPoolListExt-r13";
   }

   public SL_CommResourcePool_r12[] elements;

   public SL_CommTxPoolListExt_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_CommTxPoolListExt_r13 (int numRecords) {
      elements = new SL_CommResourcePool_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_CommTxPoolListExt_r13 (SL_CommResourcePool_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_CommResourcePool_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_CommResourcePool_r12();
