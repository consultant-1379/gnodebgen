...
public class ForbiddenTACs extends Asn1SeqOf {
    ...
    * populated.
    */
   public ForbiddenTACs (int numRecords) {
      elements = new TAC [numRecords];
   }
    ...
    * given the array.  
    */
   public ForbiddenTACs (TAC[] elements_) {
      elements = elements_;
   }
