...
public class MBSFN_AreaInfoList_r9 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MBSFN-AreaInfoList-r9";
   }

   public MBSFN_AreaInfo_r9[] elements;

   public MBSFN_AreaInfoList_r9 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBSFN_AreaInfoList_r9 (int numRecords) {
      elements = new MBSFN_AreaInfo_r9 [numRecords];
   }
    ...
    * given the array.  
    */
   public MBSFN_AreaInfoList_r9 (MBSFN_AreaInfo_r9[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBSFN_AreaInfo_r9 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBSFN_AreaInfo_r9();
