...
public class SupportedTAs_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public SupportedTAs_Item_iE_Extensions_element[] elements;

   public SupportedTAs_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedTAs_Item_iE_Extensions (int numRecords) {
      elements = new SupportedTAs_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedTAs_Item_iE_Extensions (SupportedTAs_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedTAs_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedTAs_Item_iE_Extensions_element();
