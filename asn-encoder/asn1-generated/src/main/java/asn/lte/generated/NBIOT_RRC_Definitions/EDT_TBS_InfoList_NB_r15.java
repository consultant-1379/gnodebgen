...
public class EDT_TBS_InfoList_NB_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EDT-TBS-InfoList-NB-r15";
   }

   public EDT_TBS_NB_r15[] elements;

   public EDT_TBS_InfoList_NB_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public EDT_TBS_InfoList_NB_r15 (int numRecords) {
      elements = new EDT_TBS_NB_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public EDT_TBS_InfoList_NB_r15 (EDT_TBS_NB_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EDT_TBS_NB_r15 [numElements];
