...
public class NeighCellListCDMA2000 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NeighCellListCDMA2000";
   }

   public NeighCellCDMA2000[] elements;

   public NeighCellListCDMA2000 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NeighCellListCDMA2000 (int numRecords) {
      elements = new NeighCellCDMA2000 [numRecords];
   }
    ...
    * given the array.  
    */
   public NeighCellListCDMA2000 (NeighCellCDMA2000[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NeighCellCDMA2000 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NeighCellCDMA2000();
