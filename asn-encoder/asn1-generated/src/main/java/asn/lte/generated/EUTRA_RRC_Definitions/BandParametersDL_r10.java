...
public class BandParametersDL_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandParametersDL-r10";
   }

   public CA_MIMO_ParametersDL_r10[] elements;

   public BandParametersDL_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandParametersDL_r10 (int numRecords) {
      elements = new CA_MIMO_ParametersDL_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandParametersDL_r10 (CA_MIMO_ParametersDL_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CA_MIMO_ParametersDL_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CA_MIMO_ParametersDL_r10();
