...
public class ListofEUTRACellsinNRCoordinationReq extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ListofEUTRACellsinNRCoordinationReq";
   }

   public ECGI[] elements;

   public ListofEUTRACellsinNRCoordinationReq () {
      elements = null;
   }
    ...
    * populated.
    */
   public ListofEUTRACellsinNRCoordinationReq (int numRecords) {
    ...
    * given the array.  
    */
   public ListofEUTRACellsinNRCoordinationReq (ECGI[] elements_) {
      elements = elements_;
   }
