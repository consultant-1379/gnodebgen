...
public class PUCCH_ResourceSet_resourceList extends Asn1SeqOf {
   ...
   public PUCCH_ResourceSet_resourceList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUCCH_ResourceSet_resourceList (int numRecords) {
    ...
    * given the array.  
    */
   public PUCCH_ResourceSet_resourceList (PUCCH_ResourceId[] elements_) {
      elements = elements_;
   }
