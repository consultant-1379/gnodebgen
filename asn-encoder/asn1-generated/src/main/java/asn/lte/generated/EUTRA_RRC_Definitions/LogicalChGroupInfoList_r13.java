...
public class LogicalChGroupInfoList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "LogicalChGroupInfoList-r13";
   }

   public SL_PriorityList_r13[] elements;

   public LogicalChGroupInfoList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public LogicalChGroupInfoList_r13 (int numRecords) {
      elements = new SL_PriorityList_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public LogicalChGroupInfoList_r13 (SL_PriorityList_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_PriorityList_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_PriorityList_r13();
