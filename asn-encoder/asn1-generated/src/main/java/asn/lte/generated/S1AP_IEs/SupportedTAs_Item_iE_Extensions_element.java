...
public class SupportedTAs_Item_iE_Extensions_element extends Asn1Seq {
   ...
   public SupportedTAs_Item_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SupportedTAs_Item_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-RAT-Type
    */
   public void setUsing_id_RAT_Type(RAT_Type extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_RAT_Type);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-RAT-Type
    */
   public RAT_Type getExtensionValueFor_id_RAT_Type() {
      return (RAT_Type) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.SupportedTAs_Item_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.SupportedTAs_Item_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.SupportedTAs_Item_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
