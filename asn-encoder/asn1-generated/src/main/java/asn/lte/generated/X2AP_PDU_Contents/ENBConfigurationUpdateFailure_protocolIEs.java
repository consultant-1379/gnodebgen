...
public class ENBConfigurationUpdateFailure_protocolIEs extends Asn1SeqOf {
   ...
   public ENBConfigurationUpdateFailure_protocolIEs_element[] elements;

   public ENBConfigurationUpdateFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENBConfigurationUpdateFailure_protocolIEs (int numRecords) {
      elements = new ENBConfigurationUpdateFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENBConfigurationUpdateFailure_protocolIEs (ENBConfigurationUpdateFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENBConfigurationUpdateFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENBConfigurationUpdateFailure_protocolIEs_element();
