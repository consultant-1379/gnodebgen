...
public class ENBConfigurationUpdateAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public ENBConfigurationUpdateAcknowledge_protocolIEs_element[] elements;

   public ENBConfigurationUpdateAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENBConfigurationUpdateAcknowledge_protocolIEs (int numRecords) {
      elements = new ENBConfigurationUpdateAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENBConfigurationUpdateAcknowledge_protocolIEs (ENBConfigurationUpdateAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENBConfigurationUpdateAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENBConfigurationUpdateAcknowledge_protocolIEs_element();
