...
public class PWSFailureIndication_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: PWSfailedECGIList
    * Java type: PWSfailedECGIList
    *
    * id: id-Global-ENB-ID
    * criticality: Criticality.reject
    * presence: Presence.mandatory
   ...
   public PWSFailureIndication_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public PWSFailureIndication_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-PWSfailedECGIList
    */
   public void setUsing_id_PWSfailedECGIList(asn.lte.generated.S1AP_IEs.PWSfailedECGIList value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_PWSfailedECGIList);
   ...
   /**
    * Get value of value with type set according to information object having key id-PWSfailedECGIList
    */
   public asn.lte.generated.S1AP_IEs.PWSfailedECGIList getValueFor_id_PWSfailedECGIList() {
      return (asn.lte.generated.S1AP_IEs.PWSfailedECGIList) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.PWSFailureIndicationIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.PWSFailureIndicationIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.PWSFailureIndicationIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 222) {
         indent (_sb, _level+1);
         _sb.append("id = id-PWSfailedECGIList\n");
      }
      else if (id.value == 59) {
         indent (_sb, _level+1);
