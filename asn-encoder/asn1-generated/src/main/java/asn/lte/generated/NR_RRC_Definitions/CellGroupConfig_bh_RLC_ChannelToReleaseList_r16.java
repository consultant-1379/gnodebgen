...
public class CellGroupConfig_bh_RLC_ChannelToReleaseList_r16 extends Asn1SeqOf {
   ...
   public BH_RLC_ChannelID_r16[] elements;

   public CellGroupConfig_bh_RLC_ChannelToReleaseList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellGroupConfig_bh_RLC_ChannelToReleaseList_r16 (int numRecords) {
      elements = new BH_RLC_ChannelID_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public CellGroupConfig_bh_RLC_ChannelToReleaseList_r16 (BH_RLC_ChannelID_r16[] elements_) {
      elements = elements_;
   }
   ...
   {
      int fraglen = 0;
      java.util.LinkedList<BH_RLC_ChannelID_r16> tmplist = 
         new java.util.LinkedList<BH_RLC_ChannelID_r16>();
      BH_RLC_ChannelID_r16 value;
      ...
      for (;;) {
         ...
         for (int i = 0; i < fraglen; i++) {
            ...
            value = new BH_RLC_ChannelID_r16();
            value.decode (buffer);
      ...
      elements = new BH_RLC_ChannelID_r16 [tmplist.size()];
