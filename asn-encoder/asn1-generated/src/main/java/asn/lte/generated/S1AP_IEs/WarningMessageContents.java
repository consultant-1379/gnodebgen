...
public class WarningMessageContents extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public WarningMessageContents (byte[] data) {
      super (data);
   }
    ...
    */
   public WarningMessageContents (byte[] data, int offset, int nbytes) {
    ...
    */
   public WarningMessageContents (String value_) throws Asn1ValueParseException {
      super (value_);
   }
