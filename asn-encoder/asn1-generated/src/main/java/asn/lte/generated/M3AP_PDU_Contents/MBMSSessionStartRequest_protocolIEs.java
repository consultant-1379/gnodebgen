...
public class MBMSSessionStartRequest_protocolIEs extends Asn1SeqOf {
   ...
   public MBMSSessionStartRequest_protocolIEs_element[] elements;

   public MBMSSessionStartRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMSSessionStartRequest_protocolIEs (int numRecords) {
      elements = new MBMSSessionStartRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMSSessionStartRequest_protocolIEs (MBMSSessionStartRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMSSessionStartRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMSSessionStartRequest_protocolIEs_element();
