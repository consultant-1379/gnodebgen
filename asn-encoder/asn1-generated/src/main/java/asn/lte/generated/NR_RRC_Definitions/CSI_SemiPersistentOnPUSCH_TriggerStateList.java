...
public class CSI_SemiPersistentOnPUSCH_TriggerStateList extends Asn1SeqOf {
   ...
   public CSI_SemiPersistentOnPUSCH_TriggerState[] elements;

   public CSI_SemiPersistentOnPUSCH_TriggerStateList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSI_SemiPersistentOnPUSCH_TriggerStateList (int numRecords) {
      elements = new CSI_SemiPersistentOnPUSCH_TriggerState [numRecords];
   }
    ...
    * given the array.  
    */
   public CSI_SemiPersistentOnPUSCH_TriggerStateList (CSI_SemiPersistentOnPUSCH_TriggerState[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSI_SemiPersistentOnPUSCH_TriggerState [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSI_SemiPersistentOnPUSCH_TriggerState();
