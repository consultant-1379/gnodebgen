...
public class SupportedBandCombination_v1380 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-v1380";
   }

   public BandCombinationParameters_v1380[] elements;

   public SupportedBandCombination_v1380 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_v1380 (int numRecords) {
    ...
    * given the array.  
    */
   public SupportedBandCombination_v1380 (BandCombinationParameters_v1380[] elements_) {
      elements = elements_;
   }
