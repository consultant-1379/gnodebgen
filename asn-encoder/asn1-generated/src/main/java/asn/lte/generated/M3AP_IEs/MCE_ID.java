...
public class MCE_ID extends Asn1OctetString {
    ...
    */
   public MCE_ID (byte[] data, int offset, int nbytes) {
    ...
    */
   public MCE_ID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
