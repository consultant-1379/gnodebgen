...
public class FreqPriorityListNR_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "FreqPriorityListNR-r15";
   }

   public FreqPriorityNR_r15[] elements;

   public FreqPriorityListNR_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FreqPriorityListNR_r15 (int numRecords) {
      elements = new FreqPriorityNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public FreqPriorityListNR_r15 (FreqPriorityNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqPriorityNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqPriorityNR_r15();
