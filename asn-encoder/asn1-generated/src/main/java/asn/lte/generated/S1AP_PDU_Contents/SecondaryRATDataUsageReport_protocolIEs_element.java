...
public class SecondaryRATDataUsageReport_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: HandoverFlag
    * Java type: HandoverFlag
    */
   ...
   /**
    * Assign fields according to information object having key id-HandoverFlag
    */
   public void setUsing_id_HandoverFlag(asn.lte.generated.S1AP_IEs.HandoverFlag value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_HandoverFlag);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-HandoverFlag
    */
   public asn.lte.generated.S1AP_IEs.HandoverFlag getValueFor_id_HandoverFlag() {
      return (asn.lte.generated.S1AP_IEs.HandoverFlag) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.SecondaryRATDataUsageReportIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.SecondaryRATDataUsageReportIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.SecondaryRATDataUsageReportIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 266) {
         indent (_sb, _level+1);
         _sb.append("id = id-HandoverFlag\n");
      }
