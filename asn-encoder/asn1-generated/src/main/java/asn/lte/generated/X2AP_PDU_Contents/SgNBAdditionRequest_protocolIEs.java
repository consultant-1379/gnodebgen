...
public class SgNBAdditionRequest_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBAdditionRequest_protocolIEs_element[] elements;

   public SgNBAdditionRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBAdditionRequest_protocolIEs (int numRecords) {
      elements = new SgNBAdditionRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBAdditionRequest_protocolIEs (SgNBAdditionRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBAdditionRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBAdditionRequest_protocolIEs_element();
