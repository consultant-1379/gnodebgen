...
public class EUTRA_CellIndexList extends Asn1SeqOf {
   ...
   public EUTRA_CellIndex[] elements;

   public EUTRA_CellIndexList () {
      elements = null;
   }
    ...
    * populated.
    */
   public EUTRA_CellIndexList (int numRecords) {
      elements = new EUTRA_CellIndex [numRecords];
   }
    ...
    * given the array.  
    */
   public EUTRA_CellIndexList (EUTRA_CellIndex[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EUTRA_CellIndex [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EUTRA_CellIndex();
