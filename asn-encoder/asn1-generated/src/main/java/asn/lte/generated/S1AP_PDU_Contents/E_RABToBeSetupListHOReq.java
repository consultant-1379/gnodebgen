...
public class E_RABToBeSetupListHOReq extends Asn1SeqOf {
   ...
   public E_RABToBeSetupListHOReq_element[] elements;

   public E_RABToBeSetupListHOReq () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABToBeSetupListHOReq (int numRecords) {
      elements = new E_RABToBeSetupListHOReq_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABToBeSetupListHOReq (E_RABToBeSetupListHOReq_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABToBeSetupListHOReq_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABToBeSetupListHOReq_element();
