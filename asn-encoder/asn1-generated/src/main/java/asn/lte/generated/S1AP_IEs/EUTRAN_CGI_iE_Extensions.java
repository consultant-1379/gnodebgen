...
public class EUTRAN_CGI_iE_Extensions extends Asn1SeqOf {
   ...
   public EUTRAN_CGI_iE_Extensions_element[] elements;

   public EUTRAN_CGI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public EUTRAN_CGI_iE_Extensions (int numRecords) {
      elements = new EUTRAN_CGI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EUTRAN_CGI_iE_Extensions (EUTRAN_CGI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EUTRAN_CGI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EUTRAN_CGI_iE_Extensions_element();
