...
public class E_RABSetupListCtxtSURes extends Asn1SeqOf {
   ...
   public E_RABSetupListCtxtSURes_element[] elements;

   public E_RABSetupListCtxtSURes () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABSetupListCtxtSURes (int numRecords) {
      elements = new E_RABSetupListCtxtSURes_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABSetupListCtxtSURes (E_RABSetupListCtxtSURes_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABSetupListCtxtSURes_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABSetupListCtxtSURes_element();
