...
public class E_RABFailedToResumeListResumeReq extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABFailedToResumeListResumeReq";
   }

   public E_RABFailedToResumeListResumeReq_element[] elements;

   public E_RABFailedToResumeListResumeReq () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABFailedToResumeListResumeReq (int numRecords) {
      elements = new E_RABFailedToResumeListResumeReq_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABFailedToResumeListResumeReq (E_RABFailedToResumeListResumeReq_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABFailedToResumeListResumeReq_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABFailedToResumeListResumeReq_element();
