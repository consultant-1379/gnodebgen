...
public class DedicatedInfoCDMA2000 extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "DedicatedInfoCDMA2000";
   }

   public DedicatedInfoCDMA2000 () {
      super();
   }
    ...
    *              in binary form.
    */
   public DedicatedInfoCDMA2000 (byte[] data) {
      super (data);
   }
    ...
    */
   public DedicatedInfoCDMA2000 (byte[] data, int offset, int nbytes) {
    ...
    */
   public DedicatedInfoCDMA2000 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
