...
public class E_RABToBeModifiedItemBearerModReq_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: TransportInformation
    * Java type: TransportInformation
    */
   public Asn1Type extensionValue;

   public E_RABToBeModifiedItemBearerModReq_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABToBeModifiedItemBearerModReq_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-TransportInformation
    */
   public void setUsing_id_TransportInformation(asn.lte.generated.S1AP_IEs.TransportInformation extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_TransportInformation);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-TransportInformation
    */
   public asn.lte.generated.S1AP_IEs.TransportInformation getExtensionValueFor_id_TransportInformation() {
      return (asn.lte.generated.S1AP_IEs.TransportInformation) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABToBeModifyItemBearerModReqExtIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABToBeModifyItemBearerModReqExtIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABToBeModifyItemBearerModReqExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 185) {
         indent (_sb, _level+1);
         _sb.append("id = id-TransportInformation\n");
      }
