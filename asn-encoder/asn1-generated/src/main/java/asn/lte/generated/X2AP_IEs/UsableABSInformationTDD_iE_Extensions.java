...
public class UsableABSInformationTDD_iE_Extensions extends Asn1SeqOf {
   ...
   public UsableABSInformationTDD_iE_Extensions_element[] elements;

   public UsableABSInformationTDD_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public UsableABSInformationTDD_iE_Extensions (int numRecords) {
      elements = new UsableABSInformationTDD_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UsableABSInformationTDD_iE_Extensions (UsableABSInformationTDD_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UsableABSInformationTDD_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UsableABSInformationTDD_iE_Extensions_element();
