...
public class OverheatingAssistance_r14_reducedMaxCCs extends Asn1Seq {
   ...
   public OverheatingAssistance_r14_reducedMaxCCs () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public OverheatingAssistance_r14_reducedMaxCCs (long reducedCCsDL_,
      long reducedCCsUL_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.invokeCharacters(reducedCCsDL.toString());
      ...
      buffer.invokeCharacters(reducedCCsUL.toString());
