...
public class TimeSynchronisationInfo_iE_Extensions extends Asn1SeqOf {
   ...
   public TimeSynchronisationInfo_iE_Extensions_element[] elements;

   public TimeSynchronisationInfo_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TimeSynchronisationInfo_iE_Extensions (int numRecords) {
      elements = new TimeSynchronisationInfo_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TimeSynchronisationInfo_iE_Extensions (TimeSynchronisationInfo_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TimeSynchronisationInfo_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TimeSynchronisationInfo_iE_Extensions_element();
