...
public class EAB_ExternalCR_StatusReport_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-ExternalCR-StatusReport-List";
   }

   public EAB_ExternalCR_StatusReport_Item[] elements;

   public EAB_ExternalCR_StatusReport_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_ExternalCR_StatusReport_List (int numRecords) {
      elements = new EAB_ExternalCR_StatusReport_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_ExternalCR_StatusReport_List (EAB_ExternalCR_StatusReport_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_ExternalCR_StatusReport_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_ExternalCR_StatusReport_Item();
