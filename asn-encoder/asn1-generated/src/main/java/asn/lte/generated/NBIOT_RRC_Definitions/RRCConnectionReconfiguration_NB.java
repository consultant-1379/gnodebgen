...
public class RRCConnectionReconfiguration_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionReconfiguration-NB";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier;
   public RRCConnectionReconfiguration_NB_criticalExtensions criticalExtensions;

   public RRCConnectionReconfiguration_NB () {
      super();
      init();
   }
   ...
   public RRCConnectionReconfiguration_NB (
      ...
      RRCConnectionReconfiguration_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public RRCConnectionReconfiguration_NB (long rrc_TransactionIdentifier_,
      RRCConnectionReconfiguration_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionReconfiguration_NB_criticalExtensions();
