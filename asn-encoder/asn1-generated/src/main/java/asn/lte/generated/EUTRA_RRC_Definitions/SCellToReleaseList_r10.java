...
public class SCellToReleaseList_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCellToReleaseList-r10";
   }

   public SCellIndex_r10[] elements;

   public SCellToReleaseList_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCellToReleaseList_r10 (int numRecords) {
      elements = new SCellIndex_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCellToReleaseList_r10 (SCellIndex_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCellIndex_r10 [numElements];
