...
public class ServedGUMMEIs extends Asn1SeqOf {
   ...
   public ServedGUMMEIsItem[] elements;

   public ServedGUMMEIs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedGUMMEIs (int numRecords) {
      elements = new ServedGUMMEIsItem [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedGUMMEIs (ServedGUMMEIsItem[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedGUMMEIsItem [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedGUMMEIsItem();
