...
public class EAB_PCellCA_Capacity_iE_Extensions_element extends Asn1Seq {
   ...
   public EAB_PCellCA_Capacity_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_PCellCA_Capacity_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_PCellCA_Capacity_ExtIEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_PCellCA_Capacity_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_PCellCA_Capacity_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
