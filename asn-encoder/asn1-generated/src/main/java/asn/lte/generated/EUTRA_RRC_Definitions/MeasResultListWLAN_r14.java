...
public class MeasResultListWLAN_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultListWLAN-r14";
   }

   public MeasResultWLAN_r13[] elements;

   public MeasResultListWLAN_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListWLAN_r14 (int numRecords) {
    ...
    * given the array.  
    */
   public MeasResultListWLAN_r14 (MeasResultWLAN_r13[] elements_) {
      elements = elements_;
   }
