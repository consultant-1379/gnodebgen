...
public class KillRequest_protocolIEs extends Asn1SeqOf {
   ...
   public KillRequest_protocolIEs_element[] elements;

   public KillRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public KillRequest_protocolIEs (int numRecords) {
      elements = new KillRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public KillRequest_protocolIEs (KillRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new KillRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new KillRequest_protocolIEs_element();
