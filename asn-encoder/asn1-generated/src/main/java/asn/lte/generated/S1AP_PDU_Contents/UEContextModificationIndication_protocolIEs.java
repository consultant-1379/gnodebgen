...
public class UEContextModificationIndication_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextModificationIndication_protocolIEs_element[] elements;

   public UEContextModificationIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextModificationIndication_protocolIEs (int numRecords) {
      elements = new UEContextModificationIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextModificationIndication_protocolIEs (UEContextModificationIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextModificationIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextModificationIndication_protocolIEs_element();
