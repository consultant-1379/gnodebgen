...
public class OTDOAInformationResponse_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: OTDOACells
    * Java type: OTDOACells
    *
   ...
   public OTDOAInformationResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public OTDOAInformationResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-OTDOACells
    */
   public void setUsing_id_OTDOACells(asn.lte.generated.LPPA_IEs.OTDOACells value) {
      this.id = new asn.lte.generated.LPPA_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.LPPA_Constants._LPPA_ConstantsValues.id_OTDOACells);
   ...
   /**
    * Get value of value with type set according to information object having key id-OTDOACells
    */
   public asn.lte.generated.LPPA_IEs.OTDOACells getValueFor_id_OTDOACells() {
      return (asn.lte.generated.LPPA_IEs.OTDOACells) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _LPPA_PDU_ContentsValues.OTDOAInformationResponse_IEs.length; i++) {
         if(_LPPA_PDU_ContentsValues.OTDOAInformationResponse_IEs[i].id.equals(id)) {
            _index = _LPPA_PDU_ContentsValues.OTDOAInformationResponse_IEs[i];
            break;
         }
      }
      if (null == _index) {
