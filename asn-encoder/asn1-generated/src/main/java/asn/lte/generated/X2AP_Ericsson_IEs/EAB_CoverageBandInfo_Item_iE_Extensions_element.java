...
public class EAB_CoverageBandInfo_Item_iE_Extensions_element extends Asn1Seq {
   ...
   /**
    * id: eid-MultibandInformationList
   ...
   public EAB_CoverageBandInfo_Item_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_CoverageBandInfo_Item_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-MultibandInformationList
    */
   public void setUsing_eid_MultibandInformationList(asn.lte.generated.X2AP_IEs.MultibandInfoList extensionValue) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_MultibandInformationList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key eid-MultibandInformationList
    */
   public asn.lte.generated.X2AP_IEs.MultibandInfoList getExtensionValueFor_eid_MultibandInformationList() {
      return (asn.lte.generated.X2AP_IEs.MultibandInfoList) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_CoverageBandInfo_Item_ExtIEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_CoverageBandInfo_Item_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_CoverageBandInfo_Item_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 4150) {
         indent (_sb, _level+1);
         _sb.append("id = eid-MultibandInformationList\n");
      }
