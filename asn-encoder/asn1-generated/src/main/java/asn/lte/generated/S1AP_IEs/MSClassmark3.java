...
public class MSClassmark3 extends Asn1OctetString {
    ...
    */
   public MSClassmark3 (byte[] data, int offset, int nbytes) {
    ...
    */
   public MSClassmark3 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
