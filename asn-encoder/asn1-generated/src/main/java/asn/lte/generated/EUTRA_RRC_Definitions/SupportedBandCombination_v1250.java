...
public class SupportedBandCombination_v1250 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-v1250";
   }

   public BandCombinationParameters_v1250[] elements;

   public SupportedBandCombination_v1250 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_v1250 (int numRecords) {
    ...
    * given the array.  
    */
   public SupportedBandCombination_v1250 (BandCombinationParameters_v1250[] elements_) {
      elements = elements_;
   }
