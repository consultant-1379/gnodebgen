...
public class SCellGroupToReleaseList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCellGroupToReleaseList-r15";
   }

   public SCellGroupIndex_r15[] elements;

   public SCellGroupToReleaseList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCellGroupToReleaseList_r15 (int numRecords) {
      elements = new SCellGroupIndex_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCellGroupToReleaseList_r15 (SCellGroupIndex_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCellGroupIndex_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SCellGroupIndex_r15();
