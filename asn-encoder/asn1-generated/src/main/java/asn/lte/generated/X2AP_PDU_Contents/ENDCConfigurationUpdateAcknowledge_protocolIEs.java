...
public class ENDCConfigurationUpdateAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public ENDCConfigurationUpdateAcknowledge_protocolIEs_element[] elements;

   public ENDCConfigurationUpdateAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENDCConfigurationUpdateAcknowledge_protocolIEs (int numRecords) {
      elements = new ENDCConfigurationUpdateAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENDCConfigurationUpdateAcknowledge_protocolIEs (ENDCConfigurationUpdateAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENDCConfigurationUpdateAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENDCConfigurationUpdateAcknowledge_protocolIEs_element();
