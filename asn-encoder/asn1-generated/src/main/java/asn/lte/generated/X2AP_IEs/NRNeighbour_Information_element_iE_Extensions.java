...
public class NRNeighbour_Information_element_iE_Extensions extends Asn1SeqOf {
   ...
   public NRNeighbour_Information_element_iE_Extensions_element[] elements;

   public NRNeighbour_Information_element_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public NRNeighbour_Information_element_iE_Extensions (int numRecords) {
      elements = new NRNeighbour_Information_element_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public NRNeighbour_Information_element_iE_Extensions (NRNeighbour_Information_element_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NRNeighbour_Information_element_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NRNeighbour_Information_element_iE_Extensions_element();
