...
public class CompositeAvailableCapacityGroup_iE_Extensions extends Asn1SeqOf {
   ...
   public CompositeAvailableCapacityGroup_iE_Extensions_element[] elements;

   public CompositeAvailableCapacityGroup_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CompositeAvailableCapacityGroup_iE_Extensions (int numRecords) {
      elements = new CompositeAvailableCapacityGroup_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CompositeAvailableCapacityGroup_iE_Extensions (CompositeAvailableCapacityGroup_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CompositeAvailableCapacityGroup_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CompositeAvailableCapacityGroup_iE_Extensions_element();
