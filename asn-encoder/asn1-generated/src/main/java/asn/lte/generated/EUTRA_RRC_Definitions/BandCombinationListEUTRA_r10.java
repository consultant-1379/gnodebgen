...
public class BandCombinationListEUTRA_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandCombinationListEUTRA-r10";
   }

   public BandInfoEUTRA[] elements;

   public BandCombinationListEUTRA_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationListEUTRA_r10 (int numRecords) {
      elements = new BandInfoEUTRA [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationListEUTRA_r10 (BandInfoEUTRA[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandInfoEUTRA [numElements];
