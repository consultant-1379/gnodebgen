...
public class E_RABList_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABItem
    * Java type: E_RABItem
    */
   public Asn1Type value;

   public E_RABList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABItem
    */
   public void setUsing_id_E_RABItem(E_RABItem value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABItem);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABItem
    */
   public E_RABItem getValueFor_id_E_RABItem() {
      return (E_RABItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.E_RABItemIEs.length; i++) {
         if(_S1AP_IEsValues.E_RABItemIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.E_RABItemIEs[i];
            break;
         }
      }
      if (null == _index) {
