...
public class CG_UCI_OnPUSCH_dynamic extends Asn1SeqOf {
    ...
    * populated.
    */
   public CG_UCI_OnPUSCH_dynamic (int numRecords) {
    ...
    * given the array.  
    */
   public CG_UCI_OnPUSCH_dynamic (BetaOffsets[] elements_) {
      elements = elements_;
   }
