...
public class Bearers_SubjectToStatusTransferList_element extends Asn1Seq {
    ...
    * ASN.1 type: Bearers-SubjectToStatusTransfer-Item
    * Java type: Bearers_SubjectToStatusTransfer_Item
    */
   public Asn1Type value;

   public Bearers_SubjectToStatusTransferList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public Bearers_SubjectToStatusTransferList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-Bearers-SubjectToStatusTransfer-Item
    */
   public void setUsing_id_Bearers_SubjectToStatusTransfer_Item(Bearers_SubjectToStatusTransfer_Item value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_Bearers_SubjectToStatusTransfer_Item);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-Bearers-SubjectToStatusTransfer-Item
    */
   public Bearers_SubjectToStatusTransfer_Item getValueFor_id_Bearers_SubjectToStatusTransfer_Item() {
      return (Bearers_SubjectToStatusTransfer_Item) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.Bearers_SubjectToStatusTransfer_ItemIEs.length; i++) {
         if(_S1AP_IEsValues.Bearers_SubjectToStatusTransfer_ItemIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.Bearers_SubjectToStatusTransfer_ItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 89) {
         indent (_sb, _level+1);
         _sb.append("id = id-Bearers-SubjectToStatusTransfer-Item\n");
      }
