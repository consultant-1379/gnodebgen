...
public class SchedulingRequestConfig_schedulingRequestToReleaseList extends Asn1SeqOf {
   ...
   public SchedulingRequestId[] elements;

   public SchedulingRequestConfig_schedulingRequestToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SchedulingRequestConfig_schedulingRequestToReleaseList (int numRecords) {
      elements = new SchedulingRequestId [numRecords];
   }
    ...
    * given the array.  
    */
   public SchedulingRequestConfig_schedulingRequestToReleaseList (SchedulingRequestId[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SchedulingRequestId [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SchedulingRequestId();
