...
public class SupportedBandListEUTRA_v1320 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandListEUTRA-v1320";
   }

   public SupportedBandEUTRA_v1320[] elements;

   public SupportedBandListEUTRA_v1320 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandListEUTRA_v1320 (int numRecords) {
      elements = new SupportedBandEUTRA_v1320 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandListEUTRA_v1320 (SupportedBandEUTRA_v1320[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBandEUTRA_v1320 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedBandEUTRA_v1320();
