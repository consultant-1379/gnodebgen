...
public class M4Configuration_iE_Extensions_element extends Asn1Seq {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.M4Configuration_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.M4Configuration_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.M4Configuration_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
