...
public class CellsToAddModListNR_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellsToAddModListNR-r15";
   }

   public CellsToAddModNR_r15[] elements;

   public CellsToAddModListNR_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellsToAddModListNR_r15 (int numRecords) {
      elements = new CellsToAddModNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public CellsToAddModListNR_r15 (CellsToAddModNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellsToAddModNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellsToAddModNR_r15();
