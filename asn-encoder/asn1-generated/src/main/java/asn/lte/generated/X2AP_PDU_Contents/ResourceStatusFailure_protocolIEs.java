...
public class ResourceStatusFailure_protocolIEs extends Asn1SeqOf {
   ...
   public ResourceStatusFailure_protocolIEs_element[] elements;

   public ResourceStatusFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResourceStatusFailure_protocolIEs (int numRecords) {
      elements = new ResourceStatusFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ResourceStatusFailure_protocolIEs (ResourceStatusFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResourceStatusFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResourceStatusFailure_protocolIEs_element();
