...
public class InitialContextSetupRequest_protocolIEs extends Asn1SeqOf {
   ...
   public InitialContextSetupRequest_protocolIEs_element[] elements;

   public InitialContextSetupRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public InitialContextSetupRequest_protocolIEs (int numRecords) {
      elements = new InitialContextSetupRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public InitialContextSetupRequest_protocolIEs (InitialContextSetupRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InitialContextSetupRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InitialContextSetupRequest_protocolIEs_element();
