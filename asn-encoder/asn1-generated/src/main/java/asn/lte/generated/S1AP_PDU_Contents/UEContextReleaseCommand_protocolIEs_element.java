...
public class UEContextReleaseCommand_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: UE-S1AP-IDs
    * Java type: UE_S1AP_IDs
    *
    * id: id-Cause
   ...
   public UEContextReleaseCommand_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UEContextReleaseCommand_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-UE-S1AP-IDs
    */
   public void setUsing_id_UE_S1AP_IDs(asn.lte.generated.S1AP_IEs.UE_S1AP_IDs value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_UE_S1AP_IDs);
   ...
   /**
    * Get value of value with type set according to information object having key id-UE-S1AP-IDs
    */
   public asn.lte.generated.S1AP_IEs.UE_S1AP_IDs getValueFor_id_UE_S1AP_IDs() {
      return (asn.lte.generated.S1AP_IEs.UE_S1AP_IDs) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.UEContextReleaseCommand_IEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.UEContextReleaseCommand_IEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.UEContextReleaseCommand_IEs[i];
            break;
         }
      }
      if (null == _index) {
