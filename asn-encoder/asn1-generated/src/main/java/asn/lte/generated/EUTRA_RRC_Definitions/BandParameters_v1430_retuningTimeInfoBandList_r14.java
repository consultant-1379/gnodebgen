...
public class BandParameters_v1430_retuningTimeInfoBandList_r14 extends Asn1SeqOf {
   ...
   public RetuningTimeInfo_r14[] elements;

   public BandParameters_v1430_retuningTimeInfoBandList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandParameters_v1430_retuningTimeInfoBandList_r14 (int numRecords) {
      elements = new RetuningTimeInfo_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandParameters_v1430_retuningTimeInfoBandList_r14 (RetuningTimeInfo_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RetuningTimeInfo_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RetuningTimeInfo_r14();
