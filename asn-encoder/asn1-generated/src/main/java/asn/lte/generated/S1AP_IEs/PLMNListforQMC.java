...
public class PLMNListforQMC extends Asn1SeqOf {
   ...
   public PLMNListforQMC (int numRecords) {
      elements = new PLMNidentity [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMNListforQMC (PLMNidentity[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PLMNidentity [numElements];
