...
public class NRintegrityProtectionAlgorithms extends Asn1BitString {
    ...
    */
   public NRintegrityProtectionAlgorithms () {
      super();
   }
    ...
    */
   public NRintegrityProtectionAlgorithms (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public NRintegrityProtectionAlgorithms (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public NRintegrityProtectionAlgorithms (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public NRintegrityProtectionAlgorithms (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public NRintegrityProtectionAlgorithms (java.util.BitSet bitSet) {
      super (bitSet);
   }
