...
public class EUTRA_Mode_Info extends Asn1Choice {
   ...
   public EUTRA_Mode_Info (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_fDD (FDD_Info value) {
      setElement (_FDD, value);
   }

   public void set_tDD (TDD_Info value) {
