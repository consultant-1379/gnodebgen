...
public class MMEConfigurationUpdate_protocolIEs extends Asn1SeqOf {
   ...
   public MMEConfigurationUpdate_protocolIEs_element[] elements;

   public MMEConfigurationUpdate_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MMEConfigurationUpdate_protocolIEs (int numRecords) {
      elements = new MMEConfigurationUpdate_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MMEConfigurationUpdate_protocolIEs (MMEConfigurationUpdate_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MMEConfigurationUpdate_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MMEConfigurationUpdate_protocolIEs_element();
