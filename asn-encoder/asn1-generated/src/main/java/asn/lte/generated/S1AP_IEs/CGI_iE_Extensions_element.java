...
public class CGI_iE_Extensions_element extends Asn1Seq {
   ...
   public CGI_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public CGI_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.CGI_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.CGI_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.CGI_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
