...
public class CNTypeRestrictionsItem_iE_Extensions extends Asn1SeqOf {
   ...
   public CNTypeRestrictionsItem_iE_Extensions_element[] elements;

   public CNTypeRestrictionsItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CNTypeRestrictionsItem_iE_Extensions (int numRecords) {
      elements = new CNTypeRestrictionsItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CNTypeRestrictionsItem_iE_Extensions (CNTypeRestrictionsItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CNTypeRestrictionsItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CNTypeRestrictionsItem_iE_Extensions_element();
