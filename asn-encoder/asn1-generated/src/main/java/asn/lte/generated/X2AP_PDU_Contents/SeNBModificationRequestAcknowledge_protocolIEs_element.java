...
public class SeNBModificationRequestAcknowledge_protocolIEs_element extends Asn1Seq {
    ...
    * Java type: UE_X2AP_ID
    *
    * id: id-E-RABs-Admitted-ToBeAdded-ModAckList
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: E-RABs-Admitted-ToBeAdded-ModAckList
    * Java type: E_RABs_Admitted_ToBeAdded_ModAckList
    *
    * id: id-E-RABs-Admitted-ToBeModified-ModAckList
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: E-RABs-Admitted-ToBeModified-ModAckList
    * Java type: E_RABs_Admitted_ToBeModified_ModAckList
    *
    * id: id-E-RABs-Admitted-ToBeReleased-ModAckList
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: E-RABs-Admitted-ToBeReleased-ModAckList
    * Java type: E_RABs_Admitted_ToBeReleased_ModAckList
    *
   ...
   public SeNBModificationRequestAcknowledge_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SeNBModificationRequestAcknowledge_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-Admitted-ToBeAdded-ModAckList
    */
   public void setUsing_id_E_RABs_Admitted_ToBeAdded_ModAckList(E_RABs_Admitted_ToBeAdded_ModAckList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_Admitted_ToBeAdded_ModAckList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-E-RABs-Admitted-ToBeModified-ModAckList
    */
   public void setUsing_id_E_RABs_Admitted_ToBeModified_ModAckList(E_RABs_Admitted_ToBeModified_ModAckList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_Admitted_ToBeModified_ModAckList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-E-RABs-Admitted-ToBeReleased-ModAckList
    */
   public void setUsing_id_E_RABs_Admitted_ToBeReleased_ModAckList(E_RABs_Admitted_ToBeReleased_ModAckList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_Admitted_ToBeReleased_ModAckList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-Admitted-ToBeAdded-ModAckList
    */
   public E_RABs_Admitted_ToBeAdded_ModAckList getValueFor_id_E_RABs_Admitted_ToBeAdded_ModAckList() {
      return (E_RABs_Admitted_ToBeAdded_ModAckList) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABs-Admitted-ToBeModified-ModAckList
    */
   public E_RABs_Admitted_ToBeModified_ModAckList getValueFor_id_E_RABs_Admitted_ToBeModified_ModAckList() {
      return (E_RABs_Admitted_ToBeModified_ModAckList) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABs-Admitted-ToBeReleased-ModAckList
    */
   public E_RABs_Admitted_ToBeReleased_ModAckList getValueFor_id_E_RABs_Admitted_ToBeReleased_ModAckList() {
      return (E_RABs_Admitted_ToBeReleased_ModAckList) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SeNBModificationRequestAcknowledge_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SeNBModificationRequestAcknowledge_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SeNBModificationRequestAcknowledge_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-Admitted-ToBeAdded-ModAckList\n");
      }
      else if (id.value == 129) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-Admitted-ToBeModified-ModAckList\n");
      }
      else if (id.value == 130) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-Admitted-ToBeReleased-ModAckList\n");
      }
      else if (id.value == 3) {
         indent (_sb, _level+1);
