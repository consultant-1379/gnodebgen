...
public class HandoverFromEUTRAPreparationRequest extends Asn1Seq {
   ...
   public HandoverFromEUTRAPreparationRequest_criticalExtensions criticalExtensions;

   public HandoverFromEUTRAPreparationRequest () {
      super();
      init();
   }
   ...
   public HandoverFromEUTRAPreparationRequest (
      ...
      HandoverFromEUTRAPreparationRequest_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public HandoverFromEUTRAPreparationRequest (long rrc_TransactionIdentifier_,
      HandoverFromEUTRAPreparationRequest_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new HandoverFromEUTRAPreparationRequest_criticalExtensions();
