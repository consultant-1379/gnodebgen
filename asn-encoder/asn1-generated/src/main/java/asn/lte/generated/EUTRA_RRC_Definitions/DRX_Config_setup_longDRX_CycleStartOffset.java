...
public class DRX_Config_setup_longDRX_CycleStartOffset extends Asn1Choice {
   ...
   public final static byte _SF1280 = 14;
   public final static byte _SF2048 = 15;
   public final static byte _SF2560 = 16;

   public DRX_Config_setup_longDRX_CycleStartOffset () {
      super();
   }

   public DRX_Config_setup_longDRX_CycleStartOffset (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      ...
      case _SF1280: return "sf1280";
      case _SF2048: return "sf2048";
      case _SF2560: return "sf2560";
   ...
   public void set_sf1280 (Asn1Integer value) {
      setElement (_SF1280, value);
   }
   ...
   public void set_sf2560 (Asn1Integer value) {
      setElement (_SF2560, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 13: { 
            Asn1Integer sf1280;
            element = sf1280 = new Asn1Integer();
            sf1280.decode (buffer, 0, 1279);

            buffer.invokeCharacters(sf1280.toString());
            break;
         }
         ...
         case 15: { 
            Asn1Integer sf2560;
            element = sf2560 = new Asn1Integer();
            sf2560.decode (buffer, 0, 2559);

            buffer.invokeCharacters(sf2560.toString());
            break;
         }
