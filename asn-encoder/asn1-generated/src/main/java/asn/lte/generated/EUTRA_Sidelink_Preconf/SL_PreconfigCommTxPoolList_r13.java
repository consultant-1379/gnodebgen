...
public class SL_PreconfigCommTxPoolList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-PreconfigCommTxPoolList-r13";
   }

   public SL_PreconfigCommPool_r12[] elements;

   public SL_PreconfigCommTxPoolList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_PreconfigCommTxPoolList_r13 (int numRecords) {
    ...
    * given the array.  
    */
   public SL_PreconfigCommTxPoolList_r13 (SL_PreconfigCommPool_r12[] elements_) {
      elements = elements_;
   }
