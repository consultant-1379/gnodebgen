...
public class ConnectionEstablishmentIndication_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: DL-CP-SecurityInformation
    * Java type: DL_CP_SecurityInformation
    *
   ...
   public ConnectionEstablishmentIndication_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ConnectionEstablishmentIndication_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-DL-CP-SecurityInformation
    */
   public void setUsing_id_DL_CP_SecurityInformation(asn.lte.generated.S1AP_IEs.DL_CP_SecurityInformation value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_DL_CP_SecurityInformation);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-DL-CP-SecurityInformation
    */
   public asn.lte.generated.S1AP_IEs.DL_CP_SecurityInformation getValueFor_id_DL_CP_SecurityInformation() {
      return (asn.lte.generated.S1AP_IEs.DL_CP_SecurityInformation) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.ConnectionEstablishmentIndicationIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.ConnectionEstablishmentIndicationIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.ConnectionEstablishmentIndicationIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-DL-CP-SecurityInformation\n");
      }
