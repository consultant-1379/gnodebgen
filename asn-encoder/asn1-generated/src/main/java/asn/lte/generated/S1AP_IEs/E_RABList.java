...
public class E_RABList extends Asn1SeqOf {
   ...
   public E_RABList_element[] elements;
    ...
    * populated.
    */
   public E_RABList (int numRecords) {
      elements = new E_RABList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABList (E_RABList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABList_element();
