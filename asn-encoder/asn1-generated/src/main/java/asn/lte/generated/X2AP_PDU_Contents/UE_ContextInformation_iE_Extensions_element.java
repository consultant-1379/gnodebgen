...
public class UE_ContextInformation_iE_Extensions_element extends Asn1Seq {
   ...
   public UE_ContextInformation_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UE_ContextInformation_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
    ...
    */
   public void setUsing_id_ManagementBasedMDTallowed(asn.lte.generated.X2AP_IEs.ManagementBasedMDTallowed extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ManagementBasedMDTallowed);
    ...
    */
   public void setUsing_id_ManagementBasedMDTPLMNList(asn.lte.generated.X2AP_IEs.MDTPLMNList extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ManagementBasedMDTPLMNList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }
    ...
    */
   public void setUsing_id_UESidelinkAggregateMaximumBitRate(asn.lte.generated.X2AP_IEs.UESidelinkAggregateMaximumBitRate extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_UESidelinkAggregateMaximumBitRate);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-ManagementBasedMDTallowed
    */
   public asn.lte.generated.X2AP_IEs.ManagementBasedMDTallowed getExtensionValueFor_id_ManagementBasedMDTallowed() {
      return (asn.lte.generated.X2AP_IEs.ManagementBasedMDTallowed) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-ManagementBasedMDTPLMNList
    */
   public asn.lte.generated.X2AP_IEs.MDTPLMNList getExtensionValueFor_id_ManagementBasedMDTPLMNList() {
      return (asn.lte.generated.X2AP_IEs.MDTPLMNList) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-UESidelinkAggregateMaximumBitRate
    */
   public asn.lte.generated.X2AP_IEs.UESidelinkAggregateMaximumBitRate getExtensionValueFor_id_UESidelinkAggregateMaximumBitRate() {
      return (asn.lte.generated.X2AP_IEs.UESidelinkAggregateMaximumBitRate) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.UE_ContextInformation_ExtIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.UE_ContextInformation_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.UE_ContextInformation_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
