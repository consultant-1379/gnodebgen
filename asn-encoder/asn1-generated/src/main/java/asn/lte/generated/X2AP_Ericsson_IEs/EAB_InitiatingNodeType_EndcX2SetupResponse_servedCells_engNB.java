...
public class EAB_InitiatingNodeType_EndcX2SetupResponse_servedCells_engNB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "EAB-InitiatingNodeType-EndcX2SetupResponse-servedCells-engNB";
   }

   public EAB_ServedCellNRAttribute_List servedCells;  // optional
   public Asn1OpenExt extElem1;

   public EAB_InitiatingNodeType_EndcX2SetupResponse_servedCells_engNB () {
      super();
      init();
   }
    ...
    */
   public EAB_InitiatingNodeType_EndcX2SetupResponse_servedCells_engNB (
      EAB_ServedCellNRAttribute_List servedCells_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (servedCellsPresent) {
         ...
         servedCells = new EAB_ServedCellNRAttribute_List();
