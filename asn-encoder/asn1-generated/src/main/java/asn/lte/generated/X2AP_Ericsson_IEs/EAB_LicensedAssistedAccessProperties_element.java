...
public class EAB_LicensedAssistedAccessProperties_element extends Asn1Seq {
   ...
   /**
    * id: eid-LicensedAssistedAccess
    * criticality: EAB_CriticalityIgnore.ignore
    * presence: EAB_PresenceOptional.optional
    * ASN.1 type: EAB-LicensedAssistedAccess
    * Java type: EAB_LicensedAssistedAccess
    */
   public Asn1Type value;

   public EAB_LicensedAssistedAccessProperties_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_LicensedAssistedAccessProperties_element (long id_,
      EAB_CriticalityIgnore criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-LicensedAssistedAccess
    */
   public void setUsing_eid_LicensedAssistedAccess(EAB_LicensedAssistedAccess value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_LicensedAssistedAccess);
      this.criticality = asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_CriticalityIgnore.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key eid-LicensedAssistedAccess
    */
   public EAB_LicensedAssistedAccess getValueFor_eid_LicensedAssistedAccess() {
      return (EAB_LicensedAssistedAccess) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_LicensedAssistedAccessProperties_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_LicensedAssistedAccessProperties_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_LicensedAssistedAccessProperties_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 4170) {
         indent (_sb, _level+1);
         _sb.append("id = eid-LicensedAssistedAccess\n");
      }
