...
public class UE_associatedLogicalS1_ConnectionListResAck_element extends Asn1Seq {
    ...
    * ASN.1 type: UE-associatedLogicalS1-ConnectionItem
    * Java type: UE_associatedLogicalS1_ConnectionItem
    */
   public Asn1Type value;

   public UE_associatedLogicalS1_ConnectionListResAck_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UE_associatedLogicalS1_ConnectionListResAck_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-UE-associatedLogicalS1-ConnectionItem
    */
   public void setUsing_id_UE_associatedLogicalS1_ConnectionItem(asn.lte.generated.S1AP_IEs.UE_associatedLogicalS1_ConnectionItem value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_UE_associatedLogicalS1_ConnectionItem);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-UE-associatedLogicalS1-ConnectionItem
    */
   public asn.lte.generated.S1AP_IEs.UE_associatedLogicalS1_ConnectionItem getValueFor_id_UE_associatedLogicalS1_ConnectionItem() {
      return (asn.lte.generated.S1AP_IEs.UE_associatedLogicalS1_ConnectionItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.UE_associatedLogicalS1_ConnectionItemResAck.length; i++) {
         if(_S1AP_PDU_ContentsValues.UE_associatedLogicalS1_ConnectionItemResAck[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.UE_associatedLogicalS1_ConnectionItemResAck[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 91) {
         indent (_sb, _level+1);
         _sb.append("id = id-UE-associatedLogicalS1-ConnectionItem\n");
      }
