...
public class MBSFN_Subframe_Info_iE_Extensions_element extends Asn1Seq {
   ...
   public MBSFN_Subframe_Info_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MBSFN_Subframe_Info_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.MBSFN_Subframe_Info_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.MBSFN_Subframe_Info_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.MBSFN_Subframe_Info_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
