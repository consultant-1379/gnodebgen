...
public class InterFreqCarrierFreqListExt_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqListExt-v1530";
   }

   public InterFreqCarrierFreqInfo_v1530[] elements;

   public InterFreqCarrierFreqListExt_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqListExt_v1530 (int numRecords) {
      elements = new InterFreqCarrierFreqInfo_v1530 [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqListExt_v1530 (InterFreqCarrierFreqInfo_v1530[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqCarrierFreqInfo_v1530 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqCarrierFreqInfo_v1530();
