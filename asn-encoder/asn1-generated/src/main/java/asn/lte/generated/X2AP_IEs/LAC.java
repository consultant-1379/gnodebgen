...
public class LAC extends Asn1OctetString {
    ...
    */
   public LAC (byte[] data, int offset, int nbytes) {
    ...
    */
   public LAC (String value_) throws Asn1ValueParseException {
      super (value_);
   }
