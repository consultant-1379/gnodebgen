...
public class SynchronisationInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public SynchronisationInformation_iE_Extensions_element[] elements;

   public SynchronisationInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SynchronisationInformation_iE_Extensions (int numRecords) {
      elements = new SynchronisationInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SynchronisationInformation_iE_Extensions (SynchronisationInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SynchronisationInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SynchronisationInformation_iE_Extensions_element();
