...
public class DataCodingScheme extends Asn1BitString {
    ...
    */
   public DataCodingScheme (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public DataCodingScheme (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public DataCodingScheme (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public DataCodingScheme (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public DataCodingScheme (java.util.BitSet bitSet) {
      super (bitSet);
   }
