...
public class SL_MeasObjectToRemoveList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-MeasObjectToRemoveList-r16";
   }

   public SL_MeasObjectId_r16[] elements;

   public SL_MeasObjectToRemoveList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_MeasObjectToRemoveList_r16 (int numRecords) {
      elements = new SL_MeasObjectId_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_MeasObjectToRemoveList_r16 (SL_MeasObjectId_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_MeasObjectId_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_MeasObjectId_r16();
