...
public class SecurityModeCommand_v8a0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SecurityModeCommand-v8a0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public SecurityModeCommand_v8a0_IEs_nonCriticalExtension nonCriticalExtension;  // optional

   public SecurityModeCommand_v8a0_IEs () {
      super();
      init();
   }
   ...
   public SecurityModeCommand_v8a0_IEs (
      ...
      SecurityModeCommand_v8a0_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public SecurityModeCommand_v8a0_IEs (byte[] lateNonCriticalExtension_,
      SecurityModeCommand_v8a0_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new SecurityModeCommand_v8a0_IEs_nonCriticalExtension();
