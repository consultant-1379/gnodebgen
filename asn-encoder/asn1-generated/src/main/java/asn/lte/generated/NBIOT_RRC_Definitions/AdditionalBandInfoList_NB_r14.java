...
public class AdditionalBandInfoList_NB_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AdditionalBandInfoList-NB-r14";
   }

   public FreqBandIndicator_NB_r13[] elements;

   public AdditionalBandInfoList_NB_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AdditionalBandInfoList_NB_r14 (int numRecords) {
      elements = new FreqBandIndicator_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public AdditionalBandInfoList_NB_r14 (FreqBandIndicator_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqBandIndicator_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqBandIndicator_NB_r13();
