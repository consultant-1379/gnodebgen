...
public class RRCConnectionReconfigurationComplete extends Asn1Seq {
   ...
   public RRCConnectionReconfigurationComplete_criticalExtensions criticalExtensions;

   public RRCConnectionReconfigurationComplete () {
      super();
      init();
   }
   ...
   public RRCConnectionReconfigurationComplete (
      ...
      RRCConnectionReconfigurationComplete_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public RRCConnectionReconfigurationComplete (long rrc_TransactionIdentifier_,
      RRCConnectionReconfigurationComplete_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionReconfigurationComplete_criticalExtensions();
