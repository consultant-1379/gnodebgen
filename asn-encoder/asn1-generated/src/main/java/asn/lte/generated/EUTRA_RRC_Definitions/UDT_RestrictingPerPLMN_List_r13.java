...
public class UDT_RestrictingPerPLMN_List_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "UDT-RestrictingPerPLMN-List-r13";
   }

   public UDT_RestrictingPerPLMN_r13[] elements;

   public UDT_RestrictingPerPLMN_List_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UDT_RestrictingPerPLMN_List_r13 (int numRecords) {
      elements = new UDT_RestrictingPerPLMN_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public UDT_RestrictingPerPLMN_List_r13 (UDT_RestrictingPerPLMN_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UDT_RestrictingPerPLMN_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UDT_RestrictingPerPLMN_r13();
