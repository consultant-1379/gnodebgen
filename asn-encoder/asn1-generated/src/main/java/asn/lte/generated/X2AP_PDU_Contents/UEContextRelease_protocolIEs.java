...
public class UEContextRelease_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextRelease_protocolIEs_element[] elements;

   public UEContextRelease_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextRelease_protocolIEs (int numRecords) {
      elements = new UEContextRelease_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextRelease_protocolIEs (UEContextRelease_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextRelease_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextRelease_protocolIEs_element();
