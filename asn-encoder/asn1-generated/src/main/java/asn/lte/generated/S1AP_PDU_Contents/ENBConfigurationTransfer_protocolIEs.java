...
public class ENBConfigurationTransfer_protocolIEs extends Asn1SeqOf {
   ...
   public ENBConfigurationTransfer_protocolIEs_element[] elements;

   public ENBConfigurationTransfer_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENBConfigurationTransfer_protocolIEs (int numRecords) {
      elements = new ENBConfigurationTransfer_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENBConfigurationTransfer_protocolIEs (ENBConfigurationTransfer_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENBConfigurationTransfer_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENBConfigurationTransfer_protocolIEs_element();
