...
public class ENBConfigurationUpdateFailure_protocolIEs_element extends Asn1Seq {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENBConfigurationUpdateFailure_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENBConfigurationUpdateFailure_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENBConfigurationUpdateFailure_IEs[i];
            break;
         }
      }
      if (null == _index) {
