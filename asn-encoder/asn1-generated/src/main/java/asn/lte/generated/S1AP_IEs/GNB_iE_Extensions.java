...
public class GNB_iE_Extensions extends Asn1SeqOf {
   ...
   public GNB_iE_Extensions_element[] elements;

   public GNB_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public GNB_iE_Extensions (int numRecords) {
      elements = new GNB_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public GNB_iE_Extensions (GNB_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNB_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNB_iE_Extensions_element();
