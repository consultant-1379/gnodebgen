...
import asn.lte.generated.EUTRA_RRC_Definitions.LogMeasInfo_r10;

public class LogMeasInfoList2_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "LogMeasInfoList2-r10";
   }

   public LogMeasInfo_r10[] elements;

   public LogMeasInfoList2_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public LogMeasInfoList2_r10 (int numRecords) {
      elements = new LogMeasInfo_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public LogMeasInfoList2_r10 (LogMeasInfo_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 4060);
      int numElements = (int) buffer.decodeLength();

      elements = new LogMeasInfo_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LogMeasInfo_r10();
