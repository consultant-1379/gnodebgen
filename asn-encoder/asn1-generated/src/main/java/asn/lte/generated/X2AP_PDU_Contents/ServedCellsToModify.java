...
public class ServedCellsToModify extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServedCellsToModify";
   }

   public ServedCellsToModify_Item[] elements;

   public ServedCellsToModify () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedCellsToModify (int numRecords) {
      elements = new ServedCellsToModify_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedCellsToModify (ServedCellsToModify_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedCellsToModify_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedCellsToModify_Item();
