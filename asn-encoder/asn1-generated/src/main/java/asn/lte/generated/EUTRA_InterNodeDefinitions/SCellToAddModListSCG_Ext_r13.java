...
public class SCellToAddModListSCG_Ext_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCellToAddModListSCG-Ext-r13";
   }

   public Cell_ToAddMod_r12[] elements;

   public SCellToAddModListSCG_Ext_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCellToAddModListSCG_Ext_r13 (int numRecords) {
      elements = new Cell_ToAddMod_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCellToAddModListSCG_Ext_r13 (Cell_ToAddMod_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Cell_ToAddMod_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Cell_ToAddMod_r12();
