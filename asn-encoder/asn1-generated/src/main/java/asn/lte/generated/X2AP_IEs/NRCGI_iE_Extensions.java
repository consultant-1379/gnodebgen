...
public class NRCGI_iE_Extensions extends Asn1SeqOf {
   ...
   public NRCGI_iE_Extensions_element[] elements;

   public NRCGI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public NRCGI_iE_Extensions (int numRecords) {
      elements = new NRCGI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public NRCGI_iE_Extensions (NRCGI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NRCGI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NRCGI_iE_Extensions_element();
