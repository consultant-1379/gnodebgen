...
public class MeasResultListNR extends Asn1SeqOf {
   ...
   public MeasResultNR[] elements;

   public MeasResultListNR () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListNR (int numRecords) {
      elements = new MeasResultNR [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListNR (MeasResultNR[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultNR [numElements];
