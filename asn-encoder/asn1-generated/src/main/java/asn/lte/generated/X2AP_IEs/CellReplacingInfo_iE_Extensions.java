...
public class CellReplacingInfo_iE_Extensions extends Asn1SeqOf {
   ...
   public CellReplacingInfo_iE_Extensions_element[] elements;

   public CellReplacingInfo_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellReplacingInfo_iE_Extensions (int numRecords) {
      elements = new CellReplacingInfo_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellReplacingInfo_iE_Extensions (CellReplacingInfo_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellReplacingInfo_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellReplacingInfo_iE_Extensions_element();
