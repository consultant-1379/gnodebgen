...
public class ENBX2ExtTLAs extends Asn1SeqOf {
    ...
    * populated.
    */
   public ENBX2ExtTLAs (int numRecords) {
      elements = new ENBX2ExtTLA [numRecords];
   }
    ...
    * given the array.  
    */
   public ENBX2ExtTLAs (ENBX2ExtTLA[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENBX2ExtTLA [numElements];
