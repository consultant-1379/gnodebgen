...
public class MutingPatternInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public MutingPatternInformation_iE_Extensions_element[] elements;

   public MutingPatternInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public MutingPatternInformation_iE_Extensions (int numRecords) {
      elements = new MutingPatternInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MutingPatternInformation_iE_Extensions (MutingPatternInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MutingPatternInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MutingPatternInformation_iE_Extensions_element();
