...
public class SeNBAdditionRequestAcknowledge_protocolIEs_element extends Asn1Seq {
    ...
    * Java type: UE_X2AP_ID
    *
    * id: id-E-RABs-Admitted-ToBeAdded-List
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABs-Admitted-ToBeAdded-List
    * Java type: E_RABs_Admitted_ToBeAdded_List
    *
   ...
   public SeNBAdditionRequestAcknowledge_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SeNBAdditionRequestAcknowledge_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-Admitted-ToBeAdded-List
    */
   public void setUsing_id_E_RABs_Admitted_ToBeAdded_List(E_RABs_Admitted_ToBeAdded_List value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_Admitted_ToBeAdded_List);
    ...
    */
   public void setUsing_id_GW_TransportLayerAddress(asn.lte.generated.X2AP_IEs.TransportLayerAddress value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_GW_TransportLayerAddress);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
    ...
    */
   public void setUsing_id_SIPTO_L_GW_TransportLayerAddress(asn.lte.generated.X2AP_IEs.TransportLayerAddress value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_SIPTO_L_GW_TransportLayerAddress);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
    ...
    */
   public void setUsing_id_Tunnel_Information_for_BBF(asn.lte.generated.X2AP_IEs.TunnelInformation value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_Tunnel_Information_for_BBF);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-Admitted-ToBeAdded-List
    */
   public E_RABs_Admitted_ToBeAdded_List getValueFor_id_E_RABs_Admitted_ToBeAdded_List() {
      return (E_RABs_Admitted_ToBeAdded_List) this.value;
   }
    ...
    */
   public asn.lte.generated.X2AP_IEs.TransportLayerAddress getValueFor_id_GW_TransportLayerAddress() {
    ...
    */
   public asn.lte.generated.X2AP_IEs.TransportLayerAddress getValueFor_id_SIPTO_L_GW_TransportLayerAddress() {
      return (asn.lte.generated.X2AP_IEs.TransportLayerAddress) this.value;
   }
    ...
    */
   public asn.lte.generated.X2AP_IEs.TunnelInformation getValueFor_id_Tunnel_Information_for_BBF() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SeNBAdditionRequestAcknowledge_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SeNBAdditionRequestAcknowledge_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SeNBAdditionRequestAcknowledge_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-Admitted-ToBeAdded-List\n");
      }
      else if (id.value == 3) {
         indent (_sb, _level+1);
