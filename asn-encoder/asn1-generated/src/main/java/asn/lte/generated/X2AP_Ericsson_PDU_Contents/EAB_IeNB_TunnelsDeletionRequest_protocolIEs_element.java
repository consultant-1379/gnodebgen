...
public class EAB_IeNB_TunnelsDeletionRequest_protocolIEs_element extends Asn1Seq {
   ...
   public EAB_IeNB_TunnelsDeletionRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_IeNB_TunnelsDeletionRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_PDU_ContentsValues.EAB_IeNB_TunnelsDeletionRequest_IEs.length; i++) {
         if(_X2AP_Ericsson_PDU_ContentsValues.EAB_IeNB_TunnelsDeletionRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_PDU_ContentsValues.EAB_IeNB_TunnelsDeletionRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
