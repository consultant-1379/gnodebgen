...
public class SgNBAdditionRequestReject_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBAdditionRequestReject_protocolIEs_element[] elements;

   public SgNBAdditionRequestReject_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBAdditionRequestReject_protocolIEs (int numRecords) {
      elements = new SgNBAdditionRequestReject_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBAdditionRequestReject_protocolIEs (SgNBAdditionRequestReject_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBAdditionRequestReject_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBAdditionRequestReject_protocolIEs_element();
