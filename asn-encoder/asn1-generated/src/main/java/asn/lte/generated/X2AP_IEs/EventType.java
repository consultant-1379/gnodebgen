...
public class EventType extends Asn1Enumerated {
   ...
   public static final int _CHANGE_OF_SERVING_CELL = 0;

   // Singleton instances of EventType
   protected static final EventType _change_of_serving_cell = new EventType(0);
   ...
   /**
    * Singleton accessor method for change_of_serving_cell.
    */
   public static EventType change_of_serving_cell() {
      return _change_of_serving_cell;
   }
   ...
   {
      switch ((int)_value) {
         case 0: return change_of_serving_cell();
   ...
   public String toString () {
      switch ((int)value) {
         case 0: return ("change-of-serving-cell");
