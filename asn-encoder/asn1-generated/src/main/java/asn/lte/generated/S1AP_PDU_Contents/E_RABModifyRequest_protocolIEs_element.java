...
public class E_RABModifyRequest_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: E-RABToBeModifiedListBearerModReq
    * Java type: E_RABToBeModifiedListBearerModReq
    *
    * id: id-SecondaryRATDataUsageRequest
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: SecondaryRATDataUsageRequest
    * Java type: SecondaryRATDataUsageRequest
    */
   public Asn1Type value;

   public E_RABModifyRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABModifyRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABToBeModifiedListBearerModReq
    */
   public void setUsing_id_E_RABToBeModifiedListBearerModReq(E_RABToBeModifiedListBearerModReq value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABToBeModifiedListBearerModReq);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-SecondaryRATDataUsageRequest
    */
   public void setUsing_id_SecondaryRATDataUsageRequest(asn.lte.generated.S1AP_IEs.SecondaryRATDataUsageRequest value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_SecondaryRATDataUsageRequest);
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABToBeModifiedListBearerModReq
    */
   public E_RABToBeModifiedListBearerModReq getValueFor_id_E_RABToBeModifiedListBearerModReq() {
      return (E_RABToBeModifiedListBearerModReq) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-SecondaryRATDataUsageRequest
    */
   public asn.lte.generated.S1AP_IEs.SecondaryRATDataUsageRequest getValueFor_id_SecondaryRATDataUsageRequest() {
      return (asn.lte.generated.S1AP_IEs.SecondaryRATDataUsageRequest) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABModifyRequestIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABModifyRequestIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABModifyRequestIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABToBeModifiedListBearerModReq\n");
      }
      else if (id.value == 268) {
         indent (_sb, _level+1);
         _sb.append("id = id-SecondaryRATDataUsageRequest\n");
      }
