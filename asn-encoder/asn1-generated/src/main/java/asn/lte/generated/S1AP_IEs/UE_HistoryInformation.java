...
public class UE_HistoryInformation extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "UE-HistoryInformation";
   }

   public LastVisitedCell_Item[] elements;
    ...
    * populated.
    */
   public UE_HistoryInformation (int numRecords) {
      elements = new LastVisitedCell_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public UE_HistoryInformation (LastVisitedCell_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LastVisitedCell_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LastVisitedCell_Item();
