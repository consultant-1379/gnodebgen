...
public class EAB_MMEConfigurationUpdate_ExtConveyor_protocolIEs_element extends Asn1Seq {
   ...
   public EAB_MMEConfigurationUpdate_ExtConveyor_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_MMEConfigurationUpdate_ExtConveyor_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_Ericsson_IEsValues.EAB_MMEConfigurationUpdate_IEs.length; i++) {
         if(_S1AP_Ericsson_IEsValues.EAB_MMEConfigurationUpdate_IEs[i].id.equals(id)) {
            _index = _S1AP_Ericsson_IEsValues.EAB_MMEConfigurationUpdate_IEs[i];
            break;
         }
      }
      if (null == _index) {
