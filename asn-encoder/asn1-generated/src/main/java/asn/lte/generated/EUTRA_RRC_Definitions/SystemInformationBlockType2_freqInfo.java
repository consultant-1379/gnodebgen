...
public class SystemInformationBlockType2_freqInfo extends Asn1Seq {
   ...
   public SystemInformationBlockType2_freqInfo_ul_Bandwidth ul_Bandwidth = null;  // optional
   public AdditionalSpectrumEmission additionalSpectrumEmission;

   public SystemInformationBlockType2_freqInfo () {
      super();
      init();
   }
   ...
   public SystemInformationBlockType2_freqInfo (
      ...
      SystemInformationBlockType2_freqInfo_ul_Bandwidth ul_Bandwidth_,
    ...
    * the given objects 
    */
   public SystemInformationBlockType2_freqInfo (long ul_CarrierFreq_,
      SystemInformationBlockType2_freqInfo_ul_Bandwidth ul_Bandwidth_,
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (ul_BandwidthPresent) {
         ...
         int tval = SystemInformationBlockType2_freqInfo_ul_Bandwidth.decodeEnumValue (buffer);
         ul_Bandwidth = SystemInformationBlockType2_freqInfo_ul_Bandwidth.valueOf (tval);
