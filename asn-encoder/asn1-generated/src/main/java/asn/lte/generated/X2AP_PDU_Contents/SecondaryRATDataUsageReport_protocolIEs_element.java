...
public class SecondaryRATDataUsageReport_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-SecondaryRATUsageReportList
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: SecondaryRATUsageReportList
    * Java type: SecondaryRATUsageReportList
    *
    ...
    * presence: Presence.optional
    * ASN.1 type: EAB-SecondaryRATDataUsageReport-ExtConveyor
    * Java type: EAB_SecondaryRATDataUsageReport_ExtConveyor
    */
   public Asn1Type value;

   public SecondaryRATDataUsageReport_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SecondaryRATDataUsageReport_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-SecondaryRATUsageReportList
    */
   public void setUsing_id_SecondaryRATUsageReportList(asn.lte.generated.X2AP_IEs.SecondaryRATUsageReportList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_SecondaryRATUsageReportList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_SecondaryRATDataUsageReport_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-SecondaryRATUsageReportList
    */
   public asn.lte.generated.X2AP_IEs.SecondaryRATUsageReportList getValueFor_id_SecondaryRATUsageReportList() {
      return (asn.lte.generated.X2AP_IEs.SecondaryRATUsageReportList) this.value;
   }
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_SecondaryRATDataUsageReport_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_SecondaryRATDataUsageReport_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SecondaryRATDataUsageReport_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SecondaryRATDataUsageReport_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SecondaryRATDataUsageReport_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 265) {
         indent (_sb, _level+1);
         _sb.append("id = id-SecondaryRATUsageReportList\n");
      }
