...
public class SgNBChangeRequired_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBChangeRequired_protocolIEs_element[] elements;

   public SgNBChangeRequired_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBChangeRequired_protocolIEs (int numRecords) {
      elements = new SgNBChangeRequired_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBChangeRequired_protocolIEs (SgNBChangeRequired_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBChangeRequired_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBChangeRequired_protocolIEs_element();
