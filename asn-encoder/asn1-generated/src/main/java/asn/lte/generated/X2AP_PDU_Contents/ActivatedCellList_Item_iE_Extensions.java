...
public class ActivatedCellList_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public ActivatedCellList_Item_iE_Extensions_element[] elements;

   public ActivatedCellList_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ActivatedCellList_Item_iE_Extensions (int numRecords) {
      elements = new ActivatedCellList_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ActivatedCellList_Item_iE_Extensions (ActivatedCellList_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ActivatedCellList_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ActivatedCellList_Item_iE_Extensions_element();
