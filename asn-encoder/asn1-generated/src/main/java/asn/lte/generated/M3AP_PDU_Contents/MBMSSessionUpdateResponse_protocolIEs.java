...
public class MBMSSessionUpdateResponse_protocolIEs extends Asn1SeqOf {
   ...
   public MBMSSessionUpdateResponse_protocolIEs_element[] elements;

   public MBMSSessionUpdateResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMSSessionUpdateResponse_protocolIEs (int numRecords) {
      elements = new MBMSSessionUpdateResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMSSessionUpdateResponse_protocolIEs (MBMSSessionUpdateResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMSSessionUpdateResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMSSessionUpdateResponse_protocolIEs_element();
