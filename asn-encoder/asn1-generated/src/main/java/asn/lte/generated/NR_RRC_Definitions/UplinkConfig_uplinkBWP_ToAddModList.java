...
public class UplinkConfig_uplinkBWP_ToAddModList extends Asn1SeqOf {
   ...
   public BWP_Uplink[] elements;

   public UplinkConfig_uplinkBWP_ToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public UplinkConfig_uplinkBWP_ToAddModList (int numRecords) {
      elements = new BWP_Uplink [numRecords];
   }
    ...
    * given the array.  
    */
   public UplinkConfig_uplinkBWP_ToAddModList (BWP_Uplink[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BWP_Uplink [numElements];
