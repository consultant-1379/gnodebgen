...
public class SL_CBR_Levels_Config_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-CBR-Levels-Config-r14";
   }

   public SL_CBR_r14[] elements;

   public SL_CBR_Levels_Config_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_CBR_Levels_Config_r14 (int numRecords) {
      elements = new SL_CBR_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_CBR_Levels_Config_r14 (SL_CBR_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_CBR_r14 [numElements];
