...
public class LoadInformation_protocolIEs extends Asn1SeqOf {
   ...
   public LoadInformation_protocolIEs_element[] elements;

   public LoadInformation_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public LoadInformation_protocolIEs (int numRecords) {
      elements = new LoadInformation_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public LoadInformation_protocolIEs (LoadInformation_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LoadInformation_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LoadInformation_protocolIEs_element();
