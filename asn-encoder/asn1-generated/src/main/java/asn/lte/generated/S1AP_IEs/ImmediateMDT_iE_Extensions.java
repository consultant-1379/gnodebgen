...
public class ImmediateMDT_iE_Extensions extends Asn1SeqOf {
   ...
   public ImmediateMDT_iE_Extensions_element[] elements;

   public ImmediateMDT_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ImmediateMDT_iE_Extensions (int numRecords) {
      elements = new ImmediateMDT_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ImmediateMDT_iE_Extensions (ImmediateMDT_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ImmediateMDT_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ImmediateMDT_iE_Extensions_element();
