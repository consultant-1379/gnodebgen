...
public class MeasResultSensing_r15_sensingResult_r15 extends Asn1SeqOf {
   ...
   public SensingResult_r15[] elements;

   public MeasResultSensing_r15_sensingResult_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultSensing_r15_sensingResult_r15 (int numRecords) {
      elements = new SensingResult_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultSensing_r15_sensingResult_r15 (SensingResult_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (0, 400);
      int numElements = (int) buffer.decodeLength();

      elements = new SensingResult_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SensingResult_r15();
