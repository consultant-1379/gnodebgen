...
public class Neighbour_Information_element_iE_Extensions_element extends Asn1Seq {
   ...
   public Neighbour_Information_element_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public Neighbour_Information_element_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-NeighbourTAC
    */
   public void setUsing_id_NeighbourTAC(TAC extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_NeighbourTAC);
   ...
   /**
    * Get value of extensionValue with type set according to information object having key id-NeighbourTAC
    */
   public TAC getExtensionValueFor_id_NeighbourTAC() {
      return (TAC) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.Neighbour_Information_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.Neighbour_Information_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.Neighbour_Information_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
