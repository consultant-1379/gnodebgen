...
public class SeNBReleaseRequired_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBReleaseRequired_protocolIEs_element[] elements;

   public SeNBReleaseRequired_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBReleaseRequired_protocolIEs (int numRecords) {
      elements = new SeNBReleaseRequired_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBReleaseRequired_protocolIEs (SeNBReleaseRequired_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBReleaseRequired_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBReleaseRequired_protocolIEs_element();
