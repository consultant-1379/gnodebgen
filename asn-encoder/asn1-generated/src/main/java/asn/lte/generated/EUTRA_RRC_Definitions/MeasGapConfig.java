...
public class MeasGapConfig extends Asn1Choice {
   ...
   public MeasGapConfig (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (MeasGapConfig_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            MeasGapConfig_setup setup;
            element = setup = new MeasGapConfig_setup();
            setup.decode (buffer);
            break;
         }
