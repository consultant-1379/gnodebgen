...
public class SPS_ConfigSL_ToReleaseList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPS-ConfigSL-ToReleaseList-r14";
   }

   public SPS_ConfigIndex_r14[] elements;

   public SPS_ConfigSL_ToReleaseList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPS_ConfigSL_ToReleaseList_r14 (int numRecords) {
    ...
    * given the array.  
    */
   public SPS_ConfigSL_ToReleaseList_r14 (SPS_ConfigIndex_r14[] elements_) {
      elements = elements_;
   }
