...
public class MeasGapConfigToRemoveList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasGapConfigToRemoveList-r14";
   }

   public ServCellIndex_r13[] elements;

   public MeasGapConfigToRemoveList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasGapConfigToRemoveList_r14 (int numRecords) {
      elements = new ServCellIndex_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasGapConfigToRemoveList_r14 (ServCellIndex_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServCellIndex_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServCellIndex_r13();
