...
public class InterFreqCarrierFreqListExt_v1360 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqListExt-v1360";
   }

   public InterFreqCarrierFreqInfo_v1360[] elements;

   public InterFreqCarrierFreqListExt_v1360 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqListExt_v1360 (int numRecords) {
      elements = new InterFreqCarrierFreqInfo_v1360 [numRecords];
   }
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqListExt_v1360 (InterFreqCarrierFreqInfo_v1360[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterFreqCarrierFreqInfo_v1360 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterFreqCarrierFreqInfo_v1360();
