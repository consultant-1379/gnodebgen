...
public class ENDCConfigurationUpdateFailure_protocolIEs_element extends Asn1Seq {
   ...
   public ENDCConfigurationUpdateFailure_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCConfigurationUpdateFailure_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
    ...
    */
   public void setUsing_id_TimeToWait(asn.lte.generated.X2AP_IEs.TimeToWait value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_TimeToWait);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
    ...
    */
   public asn.lte.generated.X2AP_IEs.TimeToWait getValueFor_id_TimeToWait() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCConfigurationUpdateFailure_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCConfigurationUpdateFailure_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCConfigurationUpdateFailure_IEs[i];
            break;
         }
      }
      if (null == _index) {
