...
public class PDSCH_Config_sp_ZP_CSI_RS_ResourceSetsToReleaseList extends Asn1SeqOf {
   ...
   public PDSCH_Config_sp_ZP_CSI_RS_ResourceSetsToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDSCH_Config_sp_ZP_CSI_RS_ResourceSetsToReleaseList (int numRecords) {
    ...
    * given the array.  
    */
   public PDSCH_Config_sp_ZP_CSI_RS_ResourceSetsToReleaseList (ZP_CSI_RS_ResourceSetId[] elements_) {
      elements = elements_;
   }
