...
public class UE_Application_Layer_Measurement_Capability extends Asn1BitString {
   ...
   public String getAsn1TypeName()  {
      return "UE-Application-Layer-Measurement-Capability";
   }
    ...
    */
   public UE_Application_Layer_Measurement_Capability () {
      super();
      value = new byte [1];
   }
    ...
    */
   public UE_Application_Layer_Measurement_Capability (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public UE_Application_Layer_Measurement_Capability (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public UE_Application_Layer_Measurement_Capability (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public UE_Application_Layer_Measurement_Capability (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public UE_Application_Layer_Measurement_Capability (java.util.BitSet bitSet) {
      super (bitSet);
   }
