...
public class SL_AnchorCarrierFreqList_V2X_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-AnchorCarrierFreqList-V2X-r14";
   }

   public ARFCN_ValueEUTRA_r9[] elements;

   public SL_AnchorCarrierFreqList_V2X_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_AnchorCarrierFreqList_V2X_r14 (int numRecords) {
    ...
    * given the array.  
    */
   public SL_AnchorCarrierFreqList_V2X_r14 (ARFCN_ValueEUTRA_r9[] elements_) {
      elements = elements_;
   }
