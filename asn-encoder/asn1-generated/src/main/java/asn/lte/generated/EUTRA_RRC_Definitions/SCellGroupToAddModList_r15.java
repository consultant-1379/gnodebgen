...
public class SCellGroupToAddModList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCellGroupToAddModList-r15";
   }

   public SCellGroupToAddMod_r15[] elements;

   public SCellGroupToAddModList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCellGroupToAddModList_r15 (int numRecords) {
      elements = new SCellGroupToAddMod_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCellGroupToAddModList_r15 (SCellGroupToAddMod_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCellGroupToAddMod_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SCellGroupToAddMod_r15();
