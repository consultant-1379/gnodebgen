...
public class OverloadStop_protocolIEs extends Asn1SeqOf {
   ...
   public OverloadStop_protocolIEs_element[] elements;

   public OverloadStop_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public OverloadStop_protocolIEs (int numRecords) {
      elements = new OverloadStop_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public OverloadStop_protocolIEs (OverloadStop_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new OverloadStop_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new OverloadStop_protocolIEs_element();
