...
public class CommonSF_AllocPatternList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CommonSF-AllocPatternList-r14";
   }

   public MBSFN_SubframeConfig_v1430[] elements;

   public CommonSF_AllocPatternList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CommonSF_AllocPatternList_r14 (int numRecords) {
    ...
    * given the array.  
    */
   public CommonSF_AllocPatternList_r14 (MBSFN_SubframeConfig_v1430[] elements_) {
      elements = elements_;
   }
