...
public class MeasConfigMN_measuredFrequenciesMN extends Asn1SeqOf {
   ...
   public NR_FreqInfo[] elements;

   public MeasConfigMN_measuredFrequenciesMN () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasConfigMN_measuredFrequenciesMN (int numRecords) {
      elements = new NR_FreqInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasConfigMN_measuredFrequenciesMN (NR_FreqInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NR_FreqInfo [numElements];
