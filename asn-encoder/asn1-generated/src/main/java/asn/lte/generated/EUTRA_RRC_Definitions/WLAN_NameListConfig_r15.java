...
public class WLAN_NameListConfig_r15 extends Asn1Choice {
   ...
   public String getAsn1TypeName()  {
      return "WLAN-NameListConfig-r15";
   }
   ...
   public WLAN_NameListConfig_r15 () {
      super();
   }

   public WLAN_NameListConfig_r15 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (WLAN_NameList_r15 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            WLAN_NameList_r15 setup;
            element = setup = new WLAN_NameList_r15();
            setup.decode (buffer);
            break;
         }
