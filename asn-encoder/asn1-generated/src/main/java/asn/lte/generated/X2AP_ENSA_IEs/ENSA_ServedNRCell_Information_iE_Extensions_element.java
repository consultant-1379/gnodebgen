...
public class ENSA_ServedNRCell_Information_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: ENSA-NR-SSB-SCS
    * Java type: ENSA_NR_SSB_SCS
    */
   public Asn1Type extensionValue;

   public ENSA_ServedNRCell_Information_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENSA_ServedNRCell_Information_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key xid-nrSSBSCS
    */
   public void setUsing_xid_nrSSBSCS(ENSA_NR_SSB_SCS extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_ENSA_Constants._X2AP_ENSA_ConstantsValues.xid_nrSSBSCS);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key xid-nrSSBSCS
    */
   public ENSA_NR_SSB_SCS getExtensionValueFor_xid_nrSSBSCS() {
      return (ENSA_NR_SSB_SCS) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_ENSA_IEsValues.ENSA_ServedCell_Information_ExtIEs.length; i++) {
         if(_X2AP_ENSA_IEsValues.ENSA_ServedCell_Information_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_ENSA_IEsValues.ENSA_ServedCell_Information_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
