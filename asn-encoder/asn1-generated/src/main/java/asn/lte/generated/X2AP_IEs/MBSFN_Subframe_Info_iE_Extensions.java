...
public class MBSFN_Subframe_Info_iE_Extensions extends Asn1SeqOf {
   ...
   public MBSFN_Subframe_Info_iE_Extensions_element[] elements;

   public MBSFN_Subframe_Info_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBSFN_Subframe_Info_iE_Extensions (int numRecords) {
      elements = new MBSFN_Subframe_Info_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MBSFN_Subframe_Info_iE_Extensions (MBSFN_Subframe_Info_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBSFN_Subframe_Info_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBSFN_Subframe_Info_iE_Extensions_element();
