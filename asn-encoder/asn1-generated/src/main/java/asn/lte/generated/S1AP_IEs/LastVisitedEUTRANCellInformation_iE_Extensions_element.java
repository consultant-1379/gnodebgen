...
public class LastVisitedEUTRANCellInformation_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: Time-UE-StayedInCell-EnhancedGranularity
    * Java type: Time_UE_StayedInCell_EnhancedGranularity
    *
    * id: id-HO-Cause
    * criticality: Criticality.ignore
    * presence: Presence.optional
   ...
   public LastVisitedEUTRANCellInformation_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public LastVisitedEUTRANCellInformation_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-Time-UE-StayedInCell-EnhancedGranularity
    */
   public void setUsing_id_Time_UE_StayedInCell_EnhancedGranularity(Time_UE_StayedInCell_EnhancedGranularity extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_Time_UE_StayedInCell_EnhancedGranularity);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-HO-Cause
    */
   public void setUsing_id_HO_Cause(Cause extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_HO_Cause);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-Time-UE-StayedInCell-EnhancedGranularity
    */
   public Time_UE_StayedInCell_EnhancedGranularity getExtensionValueFor_id_Time_UE_StayedInCell_EnhancedGranularity() {
      return (Time_UE_StayedInCell_EnhancedGranularity) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-HO-Cause
    */
   public Cause getExtensionValueFor_id_HO_Cause() {
      return (Cause) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.LastVisitedEUTRANCellInformation_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.LastVisitedEUTRANCellInformation_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.LastVisitedEUTRANCellInformation_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 167) {
         indent (_sb, _level+1);
         _sb.append("id = id-Time-UE-StayedInCell-EnhancedGranularity\n");
      }
      else if (id.value == 168) {
         indent (_sb, _level+1);
         _sb.append("id = id-HO-Cause\n");
      }
