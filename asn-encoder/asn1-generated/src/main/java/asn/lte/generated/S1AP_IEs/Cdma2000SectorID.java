...
public class Cdma2000SectorID extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public Cdma2000SectorID (byte[] data) {
      super (data);
   }
    ...
    */
   public Cdma2000SectorID (byte[] data, int offset, int nbytes) {
    ...
    */
   public Cdma2000SectorID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
