...
public class CSG_IdList extends Asn1SeqOf {
   ...
   public CSG_IdList_Item[] elements;
    ...
    * populated.
    */
   public CSG_IdList (int numRecords) {
      elements = new CSG_IdList_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public CSG_IdList (CSG_IdList_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSG_IdList_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSG_IdList_Item();
