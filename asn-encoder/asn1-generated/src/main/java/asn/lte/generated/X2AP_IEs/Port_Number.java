...
public class Port_Number extends Asn1OctetString {
    ...
    */
   public Port_Number (byte[] data, int offset, int nbytes) {
    ...
    */
   public Port_Number (String value_) throws Asn1ValueParseException {
      super (value_);
   }
