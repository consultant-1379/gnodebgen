...
public class FreqBandNrItem_iE_Extensions extends Asn1SeqOf {
   ...
   public FreqBandNrItem_iE_Extensions_element[] elements;

   public FreqBandNrItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public FreqBandNrItem_iE_Extensions (int numRecords) {
      elements = new FreqBandNrItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public FreqBandNrItem_iE_Extensions (FreqBandNrItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqBandNrItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqBandNrItem_iE_Extensions_element();
