...
public class SgNBModificationConfirm_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-E-RABs-AdmittedToBeModified-SgNBModConfList
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: E-RABs-AdmittedToBeModified-SgNBModConfList
    * Java type: E_RABs_AdmittedToBeModified_SgNBModConfList
    *
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-SgNBModificationConfirm-ExtConveyor
    * Java type: EAB_SgNBModificationConfirm_ExtConveyor
    */
   public Asn1Type value;

   public SgNBModificationConfirm_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBModificationConfirm_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-AdmittedToBeModified-SgNBModConfList
    */
   public void setUsing_id_E_RABs_AdmittedToBeModified_SgNBModConfList(E_RABs_AdmittedToBeModified_SgNBModConfList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_AdmittedToBeModified_SgNBModConfList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBModificationConfirm_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-AdmittedToBeModified-SgNBModConfList
    */
   public E_RABs_AdmittedToBeModified_SgNBModConfList getValueFor_id_E_RABs_AdmittedToBeModified_SgNBModConfList() {
      return (E_RABs_AdmittedToBeModified_SgNBModConfList) this.value;
   }
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBModificationConfirm_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBModificationConfirm_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SgNBModificationConfirm_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SgNBModificationConfirm_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SgNBModificationConfirm_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-AdmittedToBeModified-SgNBModConfList\n");
      }
