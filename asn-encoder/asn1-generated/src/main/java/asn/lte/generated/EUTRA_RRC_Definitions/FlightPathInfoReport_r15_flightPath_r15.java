...
public class FlightPathInfoReport_r15_flightPath_r15 extends Asn1SeqOf {
   ...
   public WayPointLocation_r15[] elements;

   public FlightPathInfoReport_r15_flightPath_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FlightPathInfoReport_r15_flightPath_r15 (int numRecords) {
      elements = new WayPointLocation_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public FlightPathInfoReport_r15_flightPath_r15 (WayPointLocation_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WayPointLocation_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new WayPointLocation_r15();
