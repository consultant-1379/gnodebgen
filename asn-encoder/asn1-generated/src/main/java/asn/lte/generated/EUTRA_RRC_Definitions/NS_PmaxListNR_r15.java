...
public class NS_PmaxListNR_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NS-PmaxListNR-r15";
   }

   public NS_PmaxValueNR_r15[] elements;

   public NS_PmaxListNR_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public NS_PmaxListNR_r15 (int numRecords) {
      elements = new NS_PmaxValueNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public NS_PmaxListNR_r15 (NS_PmaxValueNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NS_PmaxValueNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NS_PmaxValueNR_r15();
