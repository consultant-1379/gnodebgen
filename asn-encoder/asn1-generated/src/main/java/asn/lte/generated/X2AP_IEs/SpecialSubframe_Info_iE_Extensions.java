...
public class SpecialSubframe_Info_iE_Extensions extends Asn1SeqOf {
   ...
   public SpecialSubframe_Info_iE_Extensions_element[] elements;

   public SpecialSubframe_Info_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SpecialSubframe_Info_iE_Extensions (int numRecords) {
      elements = new SpecialSubframe_Info_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SpecialSubframe_Info_iE_Extensions (SpecialSubframe_Info_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SpecialSubframe_Info_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SpecialSubframe_Info_iE_Extensions_element();
