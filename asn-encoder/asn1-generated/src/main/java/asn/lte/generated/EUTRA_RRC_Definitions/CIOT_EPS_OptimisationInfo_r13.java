...
public class CIOT_EPS_OptimisationInfo_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CIOT-EPS-OptimisationInfo-r13";
   }

   public CIOT_OptimisationPLMN_r13[] elements;

   public CIOT_EPS_OptimisationInfo_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CIOT_EPS_OptimisationInfo_r13 (int numRecords) {
      elements = new CIOT_OptimisationPLMN_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public CIOT_EPS_OptimisationInfo_r13 (CIOT_OptimisationPLMN_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CIOT_OptimisationPLMN_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CIOT_OptimisationPLMN_r13();
