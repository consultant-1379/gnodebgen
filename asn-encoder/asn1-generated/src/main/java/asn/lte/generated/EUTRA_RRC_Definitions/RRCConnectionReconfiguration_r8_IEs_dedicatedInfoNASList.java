...
public class RRCConnectionReconfiguration_r8_IEs_dedicatedInfoNASList extends Asn1SeqOf {
   ...
   public RRCConnectionReconfiguration_r8_IEs_dedicatedInfoNASList () {
      elements = null;
   }
    ...
    * populated.
    */
   public RRCConnectionReconfiguration_r8_IEs_dedicatedInfoNASList (int numRecords) {
    ...
    * given the array.  
    */
   public RRCConnectionReconfiguration_r8_IEs_dedicatedInfoNASList (DedicatedInfoNAS[] elements_) {
      elements = elements_;
   }
