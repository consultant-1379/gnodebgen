...
public class E_RABs_ToBeAdded_List_ModReq_element extends Asn1Seq {
   ...
   /**
    * id: id-E-RABs-ToBeAdded-ModReqItem
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABs-ToBeAdded-ModReqItem
    * Java type: E_RABs_ToBeAdded_ModReqItem
    */
   public Asn1Type value;

   public E_RABs_ToBeAdded_List_ModReq_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABs_ToBeAdded_List_ModReq_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-ToBeAdded-ModReqItem
    */
   public void setUsing_id_E_RABs_ToBeAdded_ModReqItem(E_RABs_ToBeAdded_ModReqItem value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_ToBeAdded_ModReqItem);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABs-ToBeAdded-ModReqItem
    */
   public E_RABs_ToBeAdded_ModReqItem getValueFor_id_E_RABs_ToBeAdded_ModReqItem() {
      return (E_RABs_ToBeAdded_ModReqItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.E_RABs_ToBeAdded_ModReqItemIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.E_RABs_ToBeAdded_ModReqItemIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.E_RABs_ToBeAdded_ModReqItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 125) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-ToBeAdded-ModReqItem\n");
      }
