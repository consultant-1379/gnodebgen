...
public class TAI_Broadcast extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "TAI-Broadcast";
   }

   public TAI_Broadcast_Item[] elements;

   public TAI_Broadcast () {
      elements = null;
   }
    ...
    * populated.
    */
   public TAI_Broadcast (int numRecords) {
      elements = new TAI_Broadcast_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public TAI_Broadcast (TAI_Broadcast_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TAI_Broadcast_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TAI_Broadcast_Item();
