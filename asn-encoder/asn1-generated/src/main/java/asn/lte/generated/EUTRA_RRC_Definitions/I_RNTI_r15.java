...
public class I_RNTI_r15 extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public I_RNTI_r15 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public I_RNTI_r15 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public I_RNTI_r15 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public I_RNTI_r15 (java.util.BitSet bitSet) {
      super (bitSet);
   }
