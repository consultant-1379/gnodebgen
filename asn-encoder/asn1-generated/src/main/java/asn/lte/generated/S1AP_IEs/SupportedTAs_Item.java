...
public class SupportedTAs_Item extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SupportedTAs-Item";
   }

   public TAC tAC;
   public BPLMNs broadcastPLMNs;
   public SupportedTAs_Item_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public SupportedTAs_Item () {
      super();
      init();
   }
   ...
   public SupportedTAs_Item (
      TAC tAC_,
      BPLMNs broadcastPLMNs_,
      SupportedTAs_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      tAC = tAC_;
    ...
    * the given objects 
    */
   public SupportedTAs_Item (byte[] tAC_,
      BPLMNs broadcastPLMNs_,
      SupportedTAs_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new SupportedTAs_Item_iE_Extensions();
