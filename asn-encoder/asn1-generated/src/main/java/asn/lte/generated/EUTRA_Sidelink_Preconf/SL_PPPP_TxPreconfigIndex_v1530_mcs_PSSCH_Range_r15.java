...
import asn.lte.generated.EUTRA_RRC_Definitions.MCS_PSSCH_Range_r15;

public class SL_PPPP_TxPreconfigIndex_v1530_mcs_PSSCH_Range_r15 extends Asn1SeqOf {
   ...
   public MCS_PSSCH_Range_r15[] elements;

   public SL_PPPP_TxPreconfigIndex_v1530_mcs_PSSCH_Range_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_PPPP_TxPreconfigIndex_v1530_mcs_PSSCH_Range_r15 (int numRecords) {
      elements = new MCS_PSSCH_Range_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_PPPP_TxPreconfigIndex_v1530_mcs_PSSCH_Range_r15 (MCS_PSSCH_Range_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MCS_PSSCH_Range_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MCS_PSSCH_Range_r15();
