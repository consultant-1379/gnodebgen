...
public class MeasResultList2EUTRA_v1250 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultList2EUTRA-v1250";
   }

   public MeasResult2EUTRA_v1250[] elements;

   public MeasResultList2EUTRA_v1250 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultList2EUTRA_v1250 (int numRecords) {
      elements = new MeasResult2EUTRA_v1250 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultList2EUTRA_v1250 (MeasResult2EUTRA_v1250[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResult2EUTRA_v1250 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResult2EUTRA_v1250();
