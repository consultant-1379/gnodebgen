...
public class RSRPMeasurementResult extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RSRPMeasurementResult";
   }

   public RSRPMeasurementResult_element[] elements;

   public RSRPMeasurementResult () {
      elements = null;
   }
    ...
    * populated.
    */
   public RSRPMeasurementResult (int numRecords) {
      elements = new RSRPMeasurementResult_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RSRPMeasurementResult (RSRPMeasurementResult_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 9);
      int numElements = (int) buffer.decodeLength();

      elements = new RSRPMeasurementResult_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RSRPMeasurementResult_element();
