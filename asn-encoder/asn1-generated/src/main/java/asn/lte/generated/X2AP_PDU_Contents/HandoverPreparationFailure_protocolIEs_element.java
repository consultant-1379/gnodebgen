...
public class HandoverPreparationFailure_protocolIEs_element extends Asn1Seq {
    ...
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-HandoverPreparationFailure-ExtConveyor
    * Java type: EAB_HandoverPreparationFailure_ExtConveyor
    */
   public Asn1Type value;

   public HandoverPreparationFailure_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public HandoverPreparationFailure_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_HandoverPreparationFailure_ExtConveyor value) {
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_HandoverPreparationFailure_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_HandoverPreparationFailure_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.HandoverPreparationFailure_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.HandoverPreparationFailure_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.HandoverPreparationFailure_IEs[i];
            break;
         }
      }
      if (null == _index) {
