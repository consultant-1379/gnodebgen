...
public class SRB_ToAddModList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SRB-ToAddModList-NB-r13";
   }

   public SRB_ToAddMod_NB_r13[] elements;

   public SRB_ToAddModList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRB_ToAddModList_NB_r13 (int numRecords) {
      elements = new SRB_ToAddMod_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SRB_ToAddModList_NB_r13 (SRB_ToAddMod_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRB_ToAddMod_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SRB_ToAddMod_NB_r13();
