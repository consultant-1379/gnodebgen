...
public class UERadioCapability extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public UERadioCapability (byte[] data) {
      super (data);
   }
    ...
    */
   public UERadioCapability (byte[] data, int offset, int nbytes) {
    ...
    */
   public UERadioCapability (String value_) throws Asn1ValueParseException {
      super (value_);
   }
