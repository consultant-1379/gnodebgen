...
public class MeasResultList2EUTRA extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultList2EUTRA";
   }

   public MeasResult2EUTRA_r16[] elements;

   public MeasResultList2EUTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultList2EUTRA (int numRecords) {
    ...
    * given the array.  
    */
   public MeasResultList2EUTRA (MeasResult2EUTRA_r16[] elements_) {
      elements = elements_;
   }
