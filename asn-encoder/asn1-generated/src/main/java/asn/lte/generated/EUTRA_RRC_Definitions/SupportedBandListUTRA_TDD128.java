...
public class SupportedBandListUTRA_TDD128 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandListUTRA-TDD128";
   }

   public SupportedBandUTRA_TDD128[] elements;

   public SupportedBandListUTRA_TDD128 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandListUTRA_TDD128 (int numRecords) {
      elements = new SupportedBandUTRA_TDD128 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandListUTRA_TDD128 (SupportedBandUTRA_TDD128[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBandUTRA_TDD128 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         {
            int tval = SupportedBandUTRA_TDD128.decodeEnumValue (buffer);
            elements[i] = SupportedBandUTRA_TDD128.valueOf (tval);
         }
