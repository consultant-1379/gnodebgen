...
public class VarLogMeasReport_r11 extends Asn1Seq {
    ...
    * the given objects 
    */
   public VarLogMeasReport_r11 (TraceReference_r10 traceReference_r10_,
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 3: return plmn_IdentityList_r11;
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 3: return "plmn-IdentityList-r11";
