...
public class RSRP_ThresholdsNPRACH_InfoList_NB_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "RSRP-ThresholdsNPRACH-InfoList-NB-r13";
   }

   public RSRP_Range[] elements;

   public RSRP_ThresholdsNPRACH_InfoList_NB_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public RSRP_ThresholdsNPRACH_InfoList_NB_r13 (int numRecords) {
      elements = new RSRP_Range [numRecords];
   }
    ...
    * given the array.  
    */
   public RSRP_ThresholdsNPRACH_InfoList_NB_r13 (RSRP_Range[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RSRP_Range [numElements];
