...
public class CellID_Broadcast_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public CellID_Broadcast_Item_iE_Extensions_element[] elements;

   public CellID_Broadcast_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellID_Broadcast_Item_iE_Extensions (int numRecords) {
      elements = new CellID_Broadcast_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellID_Broadcast_Item_iE_Extensions (CellID_Broadcast_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellID_Broadcast_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellID_Broadcast_Item_iE_Extensions_element();
