...
public class EncryptionAlgorithms extends Asn1BitString {
    ...
    */
   public EncryptionAlgorithms (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public EncryptionAlgorithms (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public EncryptionAlgorithms (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public EncryptionAlgorithms (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public EncryptionAlgorithms (java.util.BitSet bitSet) {
      super (bitSet);
   }
