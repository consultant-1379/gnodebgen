...
public class MBMS_ServiceList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MBMS-ServiceList-r13";
   }

   public MBMS_ServiceInfo_r13[] elements;

   public MBMS_ServiceList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMS_ServiceList_r13 (int numRecords) {
      elements = new MBMS_ServiceInfo_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMS_ServiceList_r13 (MBMS_ServiceInfo_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (0, 15);
      int numElements = (int) buffer.decodeLength();

      elements = new MBMS_ServiceInfo_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMS_ServiceInfo_r13();
