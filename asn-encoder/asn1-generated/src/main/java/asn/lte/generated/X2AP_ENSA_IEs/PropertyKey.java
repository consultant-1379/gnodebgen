...
public class PropertyKey extends Asn1OctetString {
    ...
    */
   public PropertyKey (byte[] data, int offset, int nbytes) {
    ...
    */
   public PropertyKey (String value_) throws Asn1ValueParseException {
      super (value_);
   }
