...
public class SerialNumber extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public SerialNumber (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public SerialNumber (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public SerialNumber (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public SerialNumber (java.util.BitSet bitSet) {
      super (bitSet);
   }
