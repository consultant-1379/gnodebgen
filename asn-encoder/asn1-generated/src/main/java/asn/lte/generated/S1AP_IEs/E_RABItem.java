...
public class E_RABItem extends Asn1Seq {
   ...
   public Cause cause;
   public E_RABItem_iE_Extensions iE_Extensions;  // optional
   ...
   public E_RABItem (
      E_RAB_ID e_RAB_ID_,
      Cause cause_,
      E_RABItem_iE_Extensions iE_Extensions_
   ) {
      super();
      e_RAB_ID = e_RAB_ID_;
      cause = cause_;
    ...
    * the given objects 
    */
   public E_RABItem (long e_RAB_ID_,
      Cause cause_,
      E_RABItem_iE_Extensions iE_Extensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new E_RABItem_iE_Extensions();
