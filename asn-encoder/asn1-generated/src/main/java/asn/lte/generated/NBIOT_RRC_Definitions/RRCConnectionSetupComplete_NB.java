...
public class RRCConnectionSetupComplete_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionSetupComplete-NB";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier;
   public RRCConnectionSetupComplete_NB_criticalExtensions criticalExtensions;

   public RRCConnectionSetupComplete_NB () {
      super();
      init();
   }
   ...
   public RRCConnectionSetupComplete_NB (
      ...
      RRCConnectionSetupComplete_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public RRCConnectionSetupComplete_NB (long rrc_TransactionIdentifier_,
      RRCConnectionSetupComplete_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionSetupComplete_NB_criticalExtensions();
