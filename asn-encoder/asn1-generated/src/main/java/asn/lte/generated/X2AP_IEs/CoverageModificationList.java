...
public class CoverageModificationList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CoverageModificationList";
   }

   public CoverageModification_Item[] elements;

   public CoverageModificationList () {
      elements = null;
   }
    ...
    * populated.
    */
   public CoverageModificationList (int numRecords) {
      elements = new CoverageModification_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public CoverageModificationList (CoverageModification_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CoverageModification_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CoverageModification_Item();
