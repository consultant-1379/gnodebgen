...
public class Tx_PoolMeasList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "Tx-PoolMeasList-r16";
   }

   public SL_ResourcePoolID_r16[] elements;

   public Tx_PoolMeasList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public Tx_PoolMeasList_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public Tx_PoolMeasList_r16 (SL_ResourcePoolID_r16[] elements_) {
      elements = elements_;
   }
