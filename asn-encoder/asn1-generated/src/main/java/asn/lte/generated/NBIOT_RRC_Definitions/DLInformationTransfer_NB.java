...
public class DLInformationTransfer_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "DLInformationTransfer-NB";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier;
   public DLInformationTransfer_NB_criticalExtensions criticalExtensions;

   public DLInformationTransfer_NB () {
      super();
      init();
   }
   ...
   public DLInformationTransfer_NB (
      ...
      DLInformationTransfer_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public DLInformationTransfer_NB (long rrc_TransactionIdentifier_,
      DLInformationTransfer_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new DLInformationTransfer_NB_criticalExtensions();
