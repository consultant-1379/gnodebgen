...
public class ABSInformationTDD_iE_Extensions extends Asn1SeqOf {
   ...
   public ABSInformationTDD_iE_Extensions_element[] elements;

   public ABSInformationTDD_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ABSInformationTDD_iE_Extensions (int numRecords) {
      elements = new ABSInformationTDD_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ABSInformationTDD_iE_Extensions (ABSInformationTDD_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ABSInformationTDD_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ABSInformationTDD_iE_Extensions_element();
