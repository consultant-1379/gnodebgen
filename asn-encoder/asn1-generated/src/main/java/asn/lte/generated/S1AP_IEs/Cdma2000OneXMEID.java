...
public class Cdma2000OneXMEID extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "Cdma2000OneXMEID";
   }

   public Cdma2000OneXMEID () {
      super();
   }
    ...
    *              in binary form.
    */
   public Cdma2000OneXMEID (byte[] data) {
      super (data);
   }
    ...
    */
   public Cdma2000OneXMEID (byte[] data, int offset, int nbytes) {
    ...
    */
   public Cdma2000OneXMEID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
