...
public class HandoverReport_protocolIEs extends Asn1SeqOf {
   ...
   public HandoverReport_protocolIEs_element[] elements;

   public HandoverReport_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public HandoverReport_protocolIEs (int numRecords) {
      elements = new HandoverReport_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public HandoverReport_protocolIEs (HandoverReport_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HandoverReport_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new HandoverReport_protocolIEs_element();
