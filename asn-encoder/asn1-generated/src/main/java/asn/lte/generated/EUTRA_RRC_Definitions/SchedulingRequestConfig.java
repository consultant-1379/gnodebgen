...
public class SchedulingRequestConfig extends Asn1Choice {
   ...
   public SchedulingRequestConfig (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SchedulingRequestConfig_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            SchedulingRequestConfig_setup setup;
            element = setup = new SchedulingRequestConfig_setup();
            setup.decode (buffer);
            break;
         }
