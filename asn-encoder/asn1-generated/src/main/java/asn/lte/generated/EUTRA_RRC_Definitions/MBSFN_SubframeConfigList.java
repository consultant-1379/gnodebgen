...
public class MBSFN_SubframeConfigList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MBSFN-SubframeConfigList";
   }

   public MBSFN_SubframeConfig[] elements;

   public MBSFN_SubframeConfigList () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBSFN_SubframeConfigList (int numRecords) {
    ...
    * given the array.  
    */
   public MBSFN_SubframeConfigList (MBSFN_SubframeConfig[] elements_) {
      elements = elements_;
   }
