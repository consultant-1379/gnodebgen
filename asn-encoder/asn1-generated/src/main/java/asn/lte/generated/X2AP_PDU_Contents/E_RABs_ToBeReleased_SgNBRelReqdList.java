...
public class E_RABs_ToBeReleased_SgNBRelReqdList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeReleased-SgNBRelReqdList";
   }

   public E_RABs_ToBeReleased_SgNBRelReqdList_element[] elements;

   public E_RABs_ToBeReleased_SgNBRelReqdList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeReleased_SgNBRelReqdList (int numRecords) {
      elements = new E_RABs_ToBeReleased_SgNBRelReqdList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeReleased_SgNBRelReqdList (E_RABs_ToBeReleased_SgNBRelReqdList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeReleased_SgNBRelReqdList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeReleased_SgNBRelReqdList_element();
