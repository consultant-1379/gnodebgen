...
public class SecurityContext_iE_Extensions extends Asn1SeqOf {
   ...
   public SecurityContext_iE_Extensions_element[] elements;

   public SecurityContext_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SecurityContext_iE_Extensions (int numRecords) {
      elements = new SecurityContext_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SecurityContext_iE_Extensions (SecurityContext_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SecurityContext_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SecurityContext_iE_Extensions_element();
