...
public class SPS_ConfigUL_STTI_ToAddModList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPS-ConfigUL-STTI-ToAddModList-r15";
   }

   public SPS_ConfigUL_STTI_r15[] elements;

   public SPS_ConfigUL_STTI_ToAddModList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPS_ConfigUL_STTI_ToAddModList_r15 (int numRecords) {
      elements = new SPS_ConfigUL_STTI_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public SPS_ConfigUL_STTI_ToAddModList_r15 (SPS_ConfigUL_STTI_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SPS_ConfigUL_STTI_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SPS_ConfigUL_STTI_r15();
