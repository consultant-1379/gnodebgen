...
public class ServedGroupIDs extends Asn1SeqOf {
   ...
   public MME_Group_ID[] elements;

   public ServedGroupIDs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedGroupIDs (int numRecords) {
      elements = new MME_Group_ID [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedGroupIDs (MME_Group_ID[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MME_Group_ID [numElements];
