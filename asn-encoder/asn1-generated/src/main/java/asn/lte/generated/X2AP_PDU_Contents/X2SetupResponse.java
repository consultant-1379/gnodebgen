...
public class X2SetupResponse extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "X2SetupResponse";
   }

   public X2SetupResponse_protocolIEs protocolIEs;
   public Asn1OpenExt extElem1;

   public X2SetupResponse () {
      super();
      init();
   }
    ...
    */
   public X2SetupResponse (
      X2SetupResponse_protocolIEs protocolIEs_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      protocolIEs = new X2SetupResponse_protocolIEs();
