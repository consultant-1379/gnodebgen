...
public class SC_MTCH_InfoList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SC-MTCH-InfoList-r13";
   }

   public SC_MTCH_Info_r13[] elements;

   public SC_MTCH_InfoList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SC_MTCH_InfoList_r13 (int numRecords) {
      elements = new SC_MTCH_Info_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SC_MTCH_InfoList_r13 (SC_MTCH_Info_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (0, 1023);
      int numElements = (int) buffer.decodeLength();

      elements = new SC_MTCH_Info_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SC_MTCH_Info_r13();
