...
public class SRS_ResourceSet_srs_ResourceIdList extends Asn1SeqOf {
   ...
   public SRS_ResourceSet_srs_ResourceIdList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRS_ResourceSet_srs_ResourceIdList (int numRecords) {
    ...
    * given the array.  
    */
   public SRS_ResourceSet_srs_ResourceIdList (SRS_ResourceId[] elements_) {
      elements = elements_;
   }
