...
public class PWSFailureIndication_protocolIEs extends Asn1SeqOf {
   ...
   public PWSFailureIndication_protocolIEs_element[] elements;

   public PWSFailureIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public PWSFailureIndication_protocolIEs (int numRecords) {
      elements = new PWSFailureIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PWSFailureIndication_protocolIEs (PWSFailureIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PWSFailureIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PWSFailureIndication_protocolIEs_element();
