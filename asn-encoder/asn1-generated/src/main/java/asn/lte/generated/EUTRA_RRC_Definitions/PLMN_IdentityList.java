...
public class PLMN_IdentityList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PLMN-IdentityList";
   }

   public PLMN_IdentityInfo[] elements;

   public PLMN_IdentityList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_IdentityList (int numRecords) {
    ...
    * given the array.  
    */
   public PLMN_IdentityList (PLMN_IdentityInfo[] elements_) {
      elements = elements_;
   }
