...
public class MeasSubframeCellList_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasSubframeCellList-r10";
   }

   public PhysCellIdRange[] elements;

   public MeasSubframeCellList_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasSubframeCellList_r10 (int numRecords) {
    ...
    * given the array.  
    */
   public MeasSubframeCellList_r10 (PhysCellIdRange[] elements_) {
      elements = elements_;
   }
