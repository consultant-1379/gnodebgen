...
public class EAB_CarrierAggregationProperties_element extends Asn1Seq {
   ...
   /**
    * id: eid-eNB-DL-CA-Capability
    * criticality: EAB_CriticalityIgnore.ignore
    * presence: EAB_PresenceOptional.optional
    * ASN.1 type: EAB-eNB-DL-CA-Capability
    * Java type: EAB_eNB_DL_CA_Capability
    */
   public Asn1Type value;

   public EAB_CarrierAggregationProperties_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_CarrierAggregationProperties_element (long id_,
      EAB_CriticalityIgnore criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-eNB-DL-CA-Capability
    */
   public void setUsing_eid_eNB_DL_CA_Capability(EAB_eNB_DL_CA_Capability value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_eNB_DL_CA_Capability);
      this.criticality = asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_CriticalityIgnore.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key eid-eNB-DL-CA-Capability
    */
   public EAB_eNB_DL_CA_Capability getValueFor_eid_eNB_DL_CA_Capability() {
      return (EAB_eNB_DL_CA_Capability) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_CarrierAggregationProperties_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_CarrierAggregationProperties_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_CarrierAggregationProperties_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 4104) {
         indent (_sb, _level+1);
         _sb.append("id = eid-eNB-DL-CA-Capability\n");
      }
