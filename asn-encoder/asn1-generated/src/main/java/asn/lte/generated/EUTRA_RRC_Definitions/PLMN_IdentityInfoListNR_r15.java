...
public class PLMN_IdentityInfoListNR_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PLMN-IdentityInfoListNR-r15";
   }

   public PLMN_IdentityInfoNR_r15[] elements;

   public PLMN_IdentityInfoListNR_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMN_IdentityInfoListNR_r15 (int numRecords) {
      elements = new PLMN_IdentityInfoNR_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public PLMN_IdentityInfoListNR_r15 (PLMN_IdentityInfoNR_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PLMN_IdentityInfoNR_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PLMN_IdentityInfoNR_r15();
