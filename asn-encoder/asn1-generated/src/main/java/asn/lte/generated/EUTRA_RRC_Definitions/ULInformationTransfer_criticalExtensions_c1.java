...
public class ULInformationTransfer_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _ULINFORMATIONTRANSFER_R8 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public ULInformationTransfer_criticalExtensions_c1 () {
      super();
   }

   public ULInformationTransfer_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _ULINFORMATIONTRANSFER_R8: return "ulInformationTransfer_r8";
   ...
   public void set_ulInformationTransfer_r8 (ULInformationTransfer_r8_IEs value) {
      setElement (_ULINFORMATIONTRANSFER_R8, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ...
            element = ulInformationTransfer_r8 = new ULInformationTransfer_r8_IEs();
            ulInformationTransfer_r8.decode (buffer);
            break;
         }
