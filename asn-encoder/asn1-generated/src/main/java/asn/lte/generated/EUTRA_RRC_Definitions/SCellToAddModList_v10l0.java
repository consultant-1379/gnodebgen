...
public class SCellToAddModList_v10l0 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCellToAddModList-v10l0";
   }

   public SCellToAddMod_v10l0[] elements;

   public SCellToAddModList_v10l0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCellToAddModList_v10l0 (int numRecords) {
      elements = new SCellToAddMod_v10l0 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCellToAddModList_v10l0 (SCellToAddMod_v10l0[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCellToAddMod_v10l0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SCellToAddMod_v10l0();
