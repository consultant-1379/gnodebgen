...
public class DedicatedInfoNAS extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public DedicatedInfoNAS (byte[] data) {
      super (data);
   }
    ...
    */
   public DedicatedInfoNAS (byte[] data, int offset, int nbytes) {
    ...
    */
   public DedicatedInfoNAS (String value_) throws Asn1ValueParseException {
      super (value_);
   }
