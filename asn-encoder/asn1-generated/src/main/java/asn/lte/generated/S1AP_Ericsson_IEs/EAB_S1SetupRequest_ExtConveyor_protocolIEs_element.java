...
public class EAB_S1SetupRequest_ExtConveyor_protocolIEs_element extends Asn1Seq {
   ...
   public EAB_S1SetupRequest_ExtConveyor_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_S1SetupRequest_ExtConveyor_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   public void setUsing_eid_eNB_FeatureList(EAB_eNB_FeatureList value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Ericsson_Constants._S1AP_Ericsson_ConstantsValues.eid_eNB_FeatureList);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_Ericsson_IEsValues.EAB_S1SetupRequest_IEs.length; i++) {
         if(_S1AP_Ericsson_IEsValues.EAB_S1SetupRequest_IEs[i].id.equals(id)) {
            _index = _S1AP_Ericsson_IEsValues.EAB_S1SetupRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
