...
public class UEInformationRequest_r9 extends Asn1Seq {
   ...
   public UEInformationRequest_r9_criticalExtensions criticalExtensions;

   public UEInformationRequest_r9 () {
      super();
      init();
   }
   ...
   public UEInformationRequest_r9 (
      ...
      UEInformationRequest_r9_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public UEInformationRequest_r9 (long rrc_TransactionIdentifier_,
      UEInformationRequest_r9_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new UEInformationRequest_r9_criticalExtensions();
