...
public class CellTrafficTrace_protocolIEs_element extends Asn1Seq {
    ...
    * presence: Presence.mandatory
    * ASN.1 type: E-UTRAN-Trace-ID
    * Java type: E_UTRAN_Trace_ID
    *
    * id: id-EUTRAN-CGI
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    ...
    * ASN.1 type: PrivacyIndicator
    * Java type: PrivacyIndicator
    */
   public Asn1Type value;

   public CellTrafficTrace_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public CellTrafficTrace_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-UTRAN-Trace-ID
    */
   public void setUsing_id_E_UTRAN_Trace_ID(asn.lte.generated.S1AP_IEs.E_UTRAN_Trace_ID value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_UTRAN_Trace_ID);
   ...
   /**
    * Assign fields according to information object having key id-TraceCollectionEntityIPAddress
    */
   public void setUsing_id_TraceCollectionEntityIPAddress(asn.lte.generated.S1AP_IEs.TransportLayerAddress value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_TraceCollectionEntityIPAddress);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Assign fields according to information object having key id-PrivacyIndicator
    */
   public void setUsing_id_PrivacyIndicator(asn.lte.generated.S1AP_IEs.PrivacyIndicator value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_PrivacyIndicator);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-UTRAN-Trace-ID
    */
   public asn.lte.generated.S1AP_IEs.E_UTRAN_Trace_ID getValueFor_id_E_UTRAN_Trace_ID() {
      return (asn.lte.generated.S1AP_IEs.E_UTRAN_Trace_ID) this.value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-TraceCollectionEntityIPAddress
    */
   public asn.lte.generated.S1AP_IEs.TransportLayerAddress getValueFor_id_TraceCollectionEntityIPAddress() {
      return (asn.lte.generated.S1AP_IEs.TransportLayerAddress) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-PrivacyIndicator
    */
   public asn.lte.generated.S1AP_IEs.PrivacyIndicator getValueFor_id_PrivacyIndicator() {
      return (asn.lte.generated.S1AP_IEs.PrivacyIndicator) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.CellTrafficTraceIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.CellTrafficTraceIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.CellTrafficTraceIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-UTRAN-Trace-ID\n");
      }
      else if (id.value == 100) {
         indent (_sb, _level+1);
         _sb.append("id = id-EUTRAN-CGI\n");
      }
      else if (id.value == 131) {
         indent (_sb, _level+1);
         _sb.append("id = id-TraceCollectionEntityIPAddress\n");
      }
      else if (id.value == 166) {
         indent (_sb, _level+1);
         _sb.append("id = id-PrivacyIndicator\n");
      }
