...
public class ULHandoverPreparationTransfer extends Asn1Seq {
   ...
   public ULHandoverPreparationTransfer_criticalExtensions criticalExtensions;

   public ULHandoverPreparationTransfer () {
      super();
      init();
   }
    ...
    */
   public ULHandoverPreparationTransfer (
      ULHandoverPreparationTransfer_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new ULHandoverPreparationTransfer_criticalExtensions();
