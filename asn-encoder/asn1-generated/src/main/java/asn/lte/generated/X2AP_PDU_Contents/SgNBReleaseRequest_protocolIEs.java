...
public class SgNBReleaseRequest_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBReleaseRequest_protocolIEs_element[] elements;

   public SgNBReleaseRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBReleaseRequest_protocolIEs (int numRecords) {
      elements = new SgNBReleaseRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBReleaseRequest_protocolIEs (SgNBReleaseRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBReleaseRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBReleaseRequest_protocolIEs_element();
