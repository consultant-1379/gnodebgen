...
public class E_RABUsageReportList_element extends Asn1Seq {
   ...
   /**
    * id: id-E-RABUsageReport-Item
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABUsageReport-Item
    * Java type: E_RABUsageReport_Item
    */
   public Asn1Type value;

   public E_RABUsageReportList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABUsageReportList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABUsageReport-Item
    */
   public void setUsing_id_E_RABUsageReport_Item(E_RABUsageReport_Item value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABUsageReport_Item);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABUsageReport-Item
    */
   public E_RABUsageReport_Item getValueFor_id_E_RABUsageReport_Item() {
      return (E_RABUsageReport_Item) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.E_RABUsageReport_ItemIEs.length; i++) {
         if(_X2AP_IEsValues.E_RABUsageReport_ItemIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.E_RABUsageReport_ItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 263) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABUsageReport-Item\n");
      }
