...
public class SeNBtoMeNBContainer extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "SeNBtoMeNBContainer";
   }

   public SeNBtoMeNBContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public SeNBtoMeNBContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public SeNBtoMeNBContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public SeNBtoMeNBContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
