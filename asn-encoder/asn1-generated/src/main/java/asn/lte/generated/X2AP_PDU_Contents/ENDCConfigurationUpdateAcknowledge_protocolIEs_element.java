...
public class ENDCConfigurationUpdateAcknowledge_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-RespondingNodeType-EndcConfigUpdate
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: RespondingNodeType-EndcConfigUpdate
    * Java type: RespondingNodeType_EndcConfigUpdate
    *
   ...
   public ENDCConfigurationUpdateAcknowledge_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCConfigurationUpdateAcknowledge_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-RespondingNodeType-EndcConfigUpdate
    */
   public void setUsing_id_RespondingNodeType_EndcConfigUpdate(RespondingNodeType_EndcConfigUpdate value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_RespondingNodeType_EndcConfigUpdate);
   ...
   /**
    * Get value of value with type set according to information object having key id-RespondingNodeType-EndcConfigUpdate
    */
   public RespondingNodeType_EndcConfigUpdate getValueFor_id_RespondingNodeType_EndcConfigUpdate() {
      return (RespondingNodeType_EndcConfigUpdate) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCConfigurationUpdateAcknowledge_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCConfigurationUpdateAcknowledge_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCConfigurationUpdateAcknowledge_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 247) {
         indent (_sb, _level+1);
         _sb.append("id = id-RespondingNodeType-EndcConfigUpdate\n");
      }
