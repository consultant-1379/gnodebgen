...
public class NeighCellsCRS_Info_r11 extends Asn1Choice {
   ...
   public NeighCellsCRS_Info_r11 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (CRS_AssistanceInfoList_r11 value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            CRS_AssistanceInfoList_r11 setup;
            element = setup = new CRS_AssistanceInfoList_r11();
            setup.decode (buffer);
            break;
         }
