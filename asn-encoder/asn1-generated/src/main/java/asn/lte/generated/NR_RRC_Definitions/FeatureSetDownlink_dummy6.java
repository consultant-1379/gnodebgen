...
public class FeatureSetDownlink_dummy6 extends Asn1SeqOf {
   ...
   public DummyD[] elements;

   public FeatureSetDownlink_dummy6 () {
      elements = null;
   }
    ...
    * populated.
    */
   public FeatureSetDownlink_dummy6 (int numRecords) {
      elements = new DummyD [numRecords];
   }
    ...
    * given the array.  
    */
   public FeatureSetDownlink_dummy6 (DummyD[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DummyD [numElements];
