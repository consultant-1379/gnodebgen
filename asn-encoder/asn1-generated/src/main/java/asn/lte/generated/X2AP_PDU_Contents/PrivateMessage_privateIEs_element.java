...
public class PrivateMessage_privateIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-X2AP-Ericsson-Data
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: X2AP-Ericsson-Data
    * Java type: X2AP_Ericsson_Data
    *
    * id: id-X2AP-ENSA-Data
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: X2AP-ENSA-Data
    * Java type: X2AP_ENSA_Data
    */
   public Asn1Type value;

   public PrivateMessage_privateIEs_element () {
      super();
      init();
   }
   ...
   {
      /* check id */
      asn.lte.generated.X2AP_Containers.X2AP_PRIVATE_IES _index = null;
      for(int i=0; i < _X2AP_PDU_ContentsValues.PrivateMessage_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.PrivateMessage_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.PrivateMessage_IEs[i];
            break;
         }
      }
      if (null == _index) {
