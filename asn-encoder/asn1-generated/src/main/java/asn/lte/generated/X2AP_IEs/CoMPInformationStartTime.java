...
public class CoMPInformationStartTime extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CoMPInformationStartTime";
   }

   public CoMPInformationStartTime_element[] elements;

   public CoMPInformationStartTime () {
      elements = null;
   }
    ...
    * populated.
    */
   public CoMPInformationStartTime (int numRecords) {
      elements = new CoMPInformationStartTime_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CoMPInformationStartTime (CoMPInformationStartTime_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (0, 1);
      int numElements = (int) buffer.decodeLength();

      elements = new CoMPInformationStartTime_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CoMPInformationStartTime_element();
