...
public class HandoverRequest_protocolIEs extends Asn1SeqOf {
   ...
   public HandoverRequest_protocolIEs_element[] elements;

   public HandoverRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public HandoverRequest_protocolIEs (int numRecords) {
      elements = new HandoverRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public HandoverRequest_protocolIEs (HandoverRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HandoverRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new HandoverRequest_protocolIEs_element();
