...
public class NRUeReport_iE_Extensions extends Asn1SeqOf {
   ...
   public NRUeReport_iE_Extensions_element[] elements;

   public NRUeReport_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public NRUeReport_iE_Extensions (int numRecords) {
      elements = new NRUeReport_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public NRUeReport_iE_Extensions (NRUeReport_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NRUeReport_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NRUeReport_iE_Extensions_element();
