...
public class InterRAT_BandList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterRAT-BandList";
   }

   public InterRAT_BandInfo[] elements;

   public InterRAT_BandList () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterRAT_BandList (int numRecords) {
      elements = new InterRAT_BandInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public InterRAT_BandList (InterRAT_BandInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new InterRAT_BandInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new InterRAT_BandInfo();
