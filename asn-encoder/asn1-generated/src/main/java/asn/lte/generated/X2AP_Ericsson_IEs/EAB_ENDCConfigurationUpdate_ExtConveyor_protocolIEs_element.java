...
public class EAB_ENDCConfigurationUpdate_ExtConveyor_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: eid-EAB-InitiatingNodeType-EndcConfigUpdate
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: EAB-InitiatingNodeType-EndcConfigUpdate
    * Java type: EAB_InitiatingNodeType_EndcConfigUpdate
    */
   public Asn1Type value;

   public EAB_ENDCConfigurationUpdate_ExtConveyor_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_ENDCConfigurationUpdate_ExtConveyor_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-EAB-InitiatingNodeType-EndcConfigUpdate
    */
   public void setUsing_eid_EAB_InitiatingNodeType_EndcConfigUpdate(EAB_InitiatingNodeType_EndcConfigUpdate value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_EAB_InitiatingNodeType_EndcConfigUpdate);
   ...
   /**
    * Get value of value with type set according to information object having key eid-EAB-InitiatingNodeType-EndcConfigUpdate
    */
   public EAB_InitiatingNodeType_EndcConfigUpdate getValueFor_eid_EAB_InitiatingNodeType_EndcConfigUpdate() {
      return (EAB_InitiatingNodeType_EndcConfigUpdate) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_ENDCConfigurationUpdate_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_ENDCConfigurationUpdate_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_ENDCConfigurationUpdate_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 4189) {
         indent (_sb, _level+1);
         _sb.append("id = eid-EAB-InitiatingNodeType-EndcConfigUpdate\n");
      }
