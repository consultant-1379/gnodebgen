...
public class SeNBReleaseConfirm_protocolIEs_element extends Asn1Seq {
    ...
    * Java type: UE_X2AP_ID
    *
    * id: id-E-RABs-ToBeReleased-List-RelConf
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: E-RABs-ToBeReleased-List-RelConf
    * Java type: E_RABs_ToBeReleased_List_RelConf
    *
   ...
   public SeNBReleaseConfirm_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SeNBReleaseConfirm_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-ToBeReleased-List-RelConf
    */
   public void setUsing_id_E_RABs_ToBeReleased_List_RelConf(E_RABs_ToBeReleased_List_RelConf value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_ToBeReleased_List_RelConf);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-ToBeReleased-List-RelConf
    */
   public E_RABs_ToBeReleased_List_RelConf getValueFor_id_E_RABs_ToBeReleased_List_RelConf() {
      return (E_RABs_ToBeReleased_List_RelConf) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SeNBReleaseConfirm_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SeNBReleaseConfirm_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SeNBReleaseConfirm_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-ToBeReleased-List-RelConf\n");
      }
      else if (id.value == 17) {
         indent (_sb, _level+1);
