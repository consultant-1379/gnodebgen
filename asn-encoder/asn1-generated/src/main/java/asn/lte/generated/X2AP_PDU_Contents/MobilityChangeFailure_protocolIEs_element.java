...
public class MobilityChangeFailure_protocolIEs_element extends Asn1Seq {
    ...
    * Java type: Cause
    *
    * id: id-ENB2-Mobility-Parameters-Modification-Range
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: MobilityParametersModificationRange
    * Java type: MobilityParametersModificationRange
    *
   ...
   public MobilityChangeFailure_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MobilityChangeFailure_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-ENB2-Mobility-Parameters-Modification-Range
    */
   public void setUsing_id_ENB2_Mobility_Parameters_Modification_Range(asn.lte.generated.X2AP_IEs.MobilityParametersModificationRange value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_ENB2_Mobility_Parameters_Modification_Range);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-ENB2-Mobility-Parameters-Modification-Range
    */
   public asn.lte.generated.X2AP_IEs.MobilityParametersModificationRange getValueFor_id_ENB2_Mobility_Parameters_Modification_Range() {
      return (asn.lte.generated.X2AP_IEs.MobilityParametersModificationRange) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.MobilityChangeFailure_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.MobilityChangeFailure_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.MobilityChangeFailure_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 43) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-ENB2-Mobility-Parameters-Modification-Range\n");
      }
      else if (id.value == 17) {
         indent (_sb, _level+1);
