...
public class TargetNgRanNode_ToSourceNgRanNode_TransparentContainer extends Asn1OctetString {
   ...
   public TargetNgRanNode_ToSourceNgRanNode_TransparentContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public TargetNgRanNode_ToSourceNgRanNode_TransparentContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public TargetNgRanNode_ToSourceNgRanNode_TransparentContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public TargetNgRanNode_ToSourceNgRanNode_TransparentContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
