...
public class CarrierFreqUTRA_FDD_Ext_r12_multiBandInfoList_r12 extends Asn1SeqOf {
   ...
   public FreqBandIndicator_UTRA_FDD[] elements;

   public CarrierFreqUTRA_FDD_Ext_r12_multiBandInfoList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CarrierFreqUTRA_FDD_Ext_r12_multiBandInfoList_r12 (int numRecords) {
      elements = new FreqBandIndicator_UTRA_FDD [numRecords];
   }
    ...
    * given the array.  
    */
   public CarrierFreqUTRA_FDD_Ext_r12_multiBandInfoList_r12 (FreqBandIndicator_UTRA_FDD[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new FreqBandIndicator_UTRA_FDD [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new FreqBandIndicator_UTRA_FDD();
