...
public class AffectedCarrierFreqCombNR_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AffectedCarrierFreqCombNR-r15";
   }

   public ARFCN_ValueNR_r15[] elements;

   public AffectedCarrierFreqCombNR_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public AffectedCarrierFreqCombNR_r15 (int numRecords) {
    ...
    * given the array.  
    */
   public AffectedCarrierFreqCombNR_r15 (ARFCN_ValueNR_r15[] elements_) {
      elements = elements_;
   }
