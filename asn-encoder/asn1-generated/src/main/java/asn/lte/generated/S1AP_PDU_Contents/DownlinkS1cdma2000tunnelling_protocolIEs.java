...
public class DownlinkS1cdma2000tunnelling_protocolIEs extends Asn1SeqOf {
   ...
   public DownlinkS1cdma2000tunnelling_protocolIEs_element[] elements;

   public DownlinkS1cdma2000tunnelling_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public DownlinkS1cdma2000tunnelling_protocolIEs (int numRecords) {
      elements = new DownlinkS1cdma2000tunnelling_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public DownlinkS1cdma2000tunnelling_protocolIEs (DownlinkS1cdma2000tunnelling_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DownlinkS1cdma2000tunnelling_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DownlinkS1cdma2000tunnelling_protocolIEs_element();
