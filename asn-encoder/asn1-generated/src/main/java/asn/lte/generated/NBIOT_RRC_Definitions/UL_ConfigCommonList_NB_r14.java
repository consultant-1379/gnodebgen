...
public class UL_ConfigCommonList_NB_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "UL-ConfigCommonList-NB-r14";
   }

   public UL_ConfigCommon_NB_r14[] elements;

   public UL_ConfigCommonList_NB_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UL_ConfigCommonList_NB_r14 (int numRecords) {
      elements = new UL_ConfigCommon_NB_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public UL_ConfigCommonList_NB_r14 (UL_ConfigCommon_NB_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UL_ConfigCommon_NB_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UL_ConfigCommon_NB_r14();
