...
public class BandCombinationParameters_v1450_bandParameterList_v1450 extends Asn1SeqOf {
   ...
   public BandParameters_v1450[] elements;

   public BandCombinationParameters_v1450_bandParameterList_v1450 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_v1450_bandParameterList_v1450 (int numRecords) {
      elements = new BandParameters_v1450 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_v1450_bandParameterList_v1450 (BandParameters_v1450[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_v1450 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_v1450();
