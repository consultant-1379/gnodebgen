...
public class RRCContainer extends Asn1OctetString {
    ...
    */
   public RRCContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public RRCContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
