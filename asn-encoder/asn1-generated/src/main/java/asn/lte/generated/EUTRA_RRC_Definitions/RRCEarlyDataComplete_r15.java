...
public class RRCEarlyDataComplete_r15 extends Asn1Seq {
   ...
   public RRCEarlyDataComplete_r15_criticalExtensions criticalExtensions;

   public RRCEarlyDataComplete_r15 () {
      super();
      init();
   }
    ...
    */
   public RRCEarlyDataComplete_r15 (
      RRCEarlyDataComplete_r15_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCEarlyDataComplete_r15_criticalExtensions();
