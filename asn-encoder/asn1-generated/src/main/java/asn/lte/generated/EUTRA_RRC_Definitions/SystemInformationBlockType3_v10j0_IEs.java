...
public class SystemInformationBlockType3_v10j0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SystemInformationBlockType3-v10j0-IEs";
   }

   public NS_PmaxList_r10 freqBandInfo_r10;  // optional
   public MultiBandInfoList_v10j0 multiBandInfoList_v10j0;  // optional
   public SystemInformationBlockType3_v10l0_IEs nonCriticalExtension;  // optional

   public SystemInformationBlockType3_v10j0_IEs () {
      super();
      init();
   }
   ...
   public SystemInformationBlockType3_v10j0_IEs (
      ...
      SystemInformationBlockType3_v10l0_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new SystemInformationBlockType3_v10l0_IEs();
