...
public class EAB_ServedCellNRAttribute_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-ServedCellNRAttribute-List";
   }

   public EAB_ServedCellNRAttribute_Item[] elements;

   public EAB_ServedCellNRAttribute_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_ServedCellNRAttribute_List (int numRecords) {
      elements = new EAB_ServedCellNRAttribute_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_ServedCellNRAttribute_List (EAB_ServedCellNRAttribute_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_ServedCellNRAttribute_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_ServedCellNRAttribute_Item();
