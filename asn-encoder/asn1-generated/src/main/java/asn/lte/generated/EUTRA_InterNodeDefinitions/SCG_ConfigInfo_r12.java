...
public class SCG_ConfigInfo_r12 extends Asn1Seq {
   ...
   public SCG_ConfigInfo_r12_criticalExtensions criticalExtensions;

   public SCG_ConfigInfo_r12 () {
      super();
      init();
   }
    ...
    */
   public SCG_ConfigInfo_r12 (
      SCG_ConfigInfo_r12_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new SCG_ConfigInfo_r12_criticalExtensions();
