...
public class SchedulingInfoList_NB_v1530 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SchedulingInfoList-NB-v1530";
   }

   public SchedulingInfo_NB_v1530[] elements;

   public SchedulingInfoList_NB_v1530 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SchedulingInfoList_NB_v1530 (int numRecords) {
      elements = new SchedulingInfo_NB_v1530 [numRecords];
   }
    ...
    * given the array.  
    */
   public SchedulingInfoList_NB_v1530 (SchedulingInfo_NB_v1530[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SchedulingInfo_NB_v1530 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SchedulingInfo_NB_v1530();
