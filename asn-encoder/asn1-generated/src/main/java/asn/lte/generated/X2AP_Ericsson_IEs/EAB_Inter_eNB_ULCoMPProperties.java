...
public class EAB_Inter_eNB_ULCoMPProperties extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-Inter-eNB-ULCoMPProperties";
   }

   public EAB_Inter_eNB_ULCoMPProperties_element[] elements;

   public EAB_Inter_eNB_ULCoMPProperties () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_Inter_eNB_ULCoMPProperties (int numRecords) {
      elements = new EAB_Inter_eNB_ULCoMPProperties_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_Inter_eNB_ULCoMPProperties (EAB_Inter_eNB_ULCoMPProperties_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_Inter_eNB_ULCoMPProperties_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_Inter_eNB_ULCoMPProperties_element();
