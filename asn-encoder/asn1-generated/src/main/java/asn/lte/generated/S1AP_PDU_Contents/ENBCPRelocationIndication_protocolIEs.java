...
public class ENBCPRelocationIndication_protocolIEs extends Asn1SeqOf {
   ...
   public ENBCPRelocationIndication_protocolIEs_element[] elements;

   public ENBCPRelocationIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENBCPRelocationIndication_protocolIEs (int numRecords) {
      elements = new ENBCPRelocationIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENBCPRelocationIndication_protocolIEs (ENBCPRelocationIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENBCPRelocationIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENBCPRelocationIndication_protocolIEs_element();
