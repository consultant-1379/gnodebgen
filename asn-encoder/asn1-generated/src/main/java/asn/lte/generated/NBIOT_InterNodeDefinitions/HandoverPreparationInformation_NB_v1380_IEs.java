...
public class HandoverPreparationInformation_NB_v1380_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "HandoverPreparationInformation-NB-v1380-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public HandoverPreparationInformation_NB_Ext_r14_IEs nonCriticalExtension;  // optional

   public HandoverPreparationInformation_NB_v1380_IEs () {
      super();
      init();
   }
   ...
   public HandoverPreparationInformation_NB_v1380_IEs (
      ...
      HandoverPreparationInformation_NB_Ext_r14_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public HandoverPreparationInformation_NB_v1380_IEs (byte[] lateNonCriticalExtension_,
      HandoverPreparationInformation_NB_Ext_r14_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new HandoverPreparationInformation_NB_Ext_r14_IEs();
