...
public class MeasResultServCellListSCG_Ext_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasResultServCellListSCG-Ext-r13";
   }

   public MeasResultServCellSCG_r12[] elements;

   public MeasResultServCellListSCG_Ext_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultServCellListSCG_Ext_r13 (int numRecords) {
      elements = new MeasResultServCellSCG_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultServCellListSCG_Ext_r13 (MeasResultServCellSCG_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultServCellSCG_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultServCellSCG_r12();
