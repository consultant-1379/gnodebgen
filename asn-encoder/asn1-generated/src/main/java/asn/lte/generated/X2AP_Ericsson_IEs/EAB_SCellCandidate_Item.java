...
public class EAB_SCellCandidate_Item extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "EAB-SCellCandidate-Item";
   }

   public ECGI cell_ID;
   public EAB_SCellCandidate_Item_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public EAB_SCellCandidate_Item () {
      super();
      init();
   }
   ...
   public EAB_SCellCandidate_Item (
      ECGI cell_ID_,
      EAB_SCellCandidate_Item_iE_Extensions iE_Extensions_
   ) {
      super();
      cell_ID = cell_ID_;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new EAB_SCellCandidate_Item_iE_Extensions();
