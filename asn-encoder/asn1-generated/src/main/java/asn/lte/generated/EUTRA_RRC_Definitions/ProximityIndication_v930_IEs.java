...
public class ProximityIndication_v930_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "ProximityIndication-v930-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public ProximityIndication_v930_IEs_nonCriticalExtension nonCriticalExtension;  // optional

   public ProximityIndication_v930_IEs () {
      super();
      init();
   }
   ...
   public ProximityIndication_v930_IEs (
      ...
      ProximityIndication_v930_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public ProximityIndication_v930_IEs (byte[] lateNonCriticalExtension_,
      ProximityIndication_v930_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new ProximityIndication_v930_IEs_nonCriticalExtension();
