...
public class X2TNLConfigurationInfo_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: ENBX2ExtTLAs
    * Java type: ENBX2ExtTLAs
    *
    * id: id-eNBIndirectX2TransportLayerAddresses
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: ENBIndirectX2TransportLayerAddresses
    * Java type: ENBIndirectX2TransportLayerAddresses
    */
   public Asn1Type extensionValue;

   public X2TNLConfigurationInfo_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public X2TNLConfigurationInfo_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-eNBX2ExtendedTransportLayerAddresses
    */
   public void setUsing_id_eNBX2ExtendedTransportLayerAddresses(ENBX2ExtTLAs extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_eNBX2ExtendedTransportLayerAddresses);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-eNBIndirectX2TransportLayerAddresses
    */
   public void setUsing_id_eNBIndirectX2TransportLayerAddresses(ENBIndirectX2TransportLayerAddresses extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_eNBIndirectX2TransportLayerAddresses);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-eNBX2ExtendedTransportLayerAddresses
    */
   public ENBX2ExtTLAs getExtensionValueFor_id_eNBX2ExtendedTransportLayerAddresses() {
      return (ENBX2ExtTLAs) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-eNBIndirectX2TransportLayerAddresses
    */
   public ENBIndirectX2TransportLayerAddresses getExtensionValueFor_id_eNBIndirectX2TransportLayerAddresses() {
      return (ENBIndirectX2TransportLayerAddresses) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.X2TNLConfigurationInfo_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.X2TNLConfigurationInfo_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.X2TNLConfigurationInfo_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 153) {
         indent (_sb, _level+1);
         _sb.append("id = id-eNBX2ExtendedTransportLayerAddresses\n");
      }
      else if (id.value == 193) {
         indent (_sb, _level+1);
         _sb.append("id = id-eNBIndirectX2TransportLayerAddresses\n");
      }
