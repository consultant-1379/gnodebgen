...
public class ReceiveStatusOfULPDCPSDUsPDCP_SNlength18 extends Asn1BitString {
   ...
   public String getAsn1TypeName()  {
      return "ReceiveStatusOfULPDCPSDUsPDCP-SNlength18";
   }
    ...
    */
   public ReceiveStatusOfULPDCPSDUsPDCP_SNlength18 () {
      super();
   }
    ...
    */
   public ReceiveStatusOfULPDCPSDUsPDCP_SNlength18 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public ReceiveStatusOfULPDCPSDUsPDCP_SNlength18 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public ReceiveStatusOfULPDCPSDUsPDCP_SNlength18 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public ReceiveStatusOfULPDCPSDUsPDCP_SNlength18 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public ReceiveStatusOfULPDCPSDUsPDCP_SNlength18 (java.util.BitSet bitSet) {
      super (bitSet);
   }
