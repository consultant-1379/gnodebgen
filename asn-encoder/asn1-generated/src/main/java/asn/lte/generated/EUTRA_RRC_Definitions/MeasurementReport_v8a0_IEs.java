...
public class MeasurementReport_v8a0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "MeasurementReport-v8a0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public MeasurementReport_v8a0_IEs_nonCriticalExtension nonCriticalExtension;  // optional

   public MeasurementReport_v8a0_IEs () {
      super();
      init();
   }
   ...
   public MeasurementReport_v8a0_IEs (
      ...
      MeasurementReport_v8a0_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public MeasurementReport_v8a0_IEs (byte[] lateNonCriticalExtension_,
      MeasurementReport_v8a0_IEs_nonCriticalExtension nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new MeasurementReport_v8a0_IEs_nonCriticalExtension();
