...
public class SL_TxPoolToReleaseListExt_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-TxPoolToReleaseListExt-r13";
   }

   public SL_TxPoolIdentity_v1310[] elements;

   public SL_TxPoolToReleaseListExt_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_TxPoolToReleaseListExt_r13 (int numRecords) {
      elements = new SL_TxPoolIdentity_v1310 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_TxPoolToReleaseListExt_r13 (SL_TxPoolIdentity_v1310[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_TxPoolIdentity_v1310 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_TxPoolIdentity_v1310();
