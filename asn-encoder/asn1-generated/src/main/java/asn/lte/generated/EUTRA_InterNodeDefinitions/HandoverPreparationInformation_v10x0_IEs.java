...
public class HandoverPreparationInformation_v10x0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "HandoverPreparationInformation-v10x0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public HandoverPreparationInformation_v13c0_IEs nonCriticalExtension;  // optional

   public HandoverPreparationInformation_v10x0_IEs () {
      super();
      init();
   }
   ...
   public HandoverPreparationInformation_v10x0_IEs (
      ...
      HandoverPreparationInformation_v13c0_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public HandoverPreparationInformation_v10x0_IEs (byte[] lateNonCriticalExtension_,
      HandoverPreparationInformation_v13c0_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new HandoverPreparationInformation_v13c0_IEs();
