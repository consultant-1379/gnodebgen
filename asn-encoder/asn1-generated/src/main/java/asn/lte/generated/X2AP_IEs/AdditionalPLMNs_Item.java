...
public class AdditionalPLMNs_Item extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "AdditionalPLMNs-Item";
   }

   public PLMN_Identity[] elements;

   public AdditionalPLMNs_Item () {
      elements = null;
   }
    ...
    * populated.
    */
   public AdditionalPLMNs_Item (int numRecords) {
    ...
    * given the array.  
    */
   public AdditionalPLMNs_Item (PLMN_Identity[] elements_) {
      elements = elements_;
   }
