...
public class SPS_ConfigToAddModList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPS-ConfigToAddModList-r16";
   }

   public SPS_Config[] elements;

   public SPS_ConfigToAddModList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPS_ConfigToAddModList_r16 (int numRecords) {
      elements = new SPS_Config [numRecords];
   }
    ...
    * given the array.  
    */
   public SPS_ConfigToAddModList_r16 (SPS_Config[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SPS_Config [numElements];
