...
public class RRCConnectionReestablishmentComplete_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionReestablishmentComplete-NB";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier;
   public RRCConnectionReestablishmentComplete_NB_criticalExtensions criticalExtensions;

   public RRCConnectionReestablishmentComplete_NB () {
      super();
      init();
   }
   ...
   public RRCConnectionReestablishmentComplete_NB (
      ...
      RRCConnectionReestablishmentComplete_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public RRCConnectionReestablishmentComplete_NB (long rrc_TransactionIdentifier_,
      RRCConnectionReestablishmentComplete_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionReestablishmentComplete_NB_criticalExtensions();
