...
public class SPS_PUCCH_AN_List_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPS-PUCCH-AN-List-r16";
   }

   public SPS_PUCCH_AN_r16[] elements;

   public SPS_PUCCH_AN_List_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPS_PUCCH_AN_List_r16 (int numRecords) {
      elements = new SPS_PUCCH_AN_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SPS_PUCCH_AN_List_r16 (SPS_PUCCH_AN_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SPS_PUCCH_AN_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SPS_PUCCH_AN_r16();
