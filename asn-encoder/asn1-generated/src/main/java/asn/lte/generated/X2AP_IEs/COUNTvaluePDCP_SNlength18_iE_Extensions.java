...
public class COUNTvaluePDCP_SNlength18_iE_Extensions extends Asn1SeqOf {
   ...
   public COUNTvaluePDCP_SNlength18_iE_Extensions_element[] elements;

   public COUNTvaluePDCP_SNlength18_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public COUNTvaluePDCP_SNlength18_iE_Extensions (int numRecords) {
      elements = new COUNTvaluePDCP_SNlength18_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public COUNTvaluePDCP_SNlength18_iE_Extensions (COUNTvaluePDCP_SNlength18_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new COUNTvaluePDCP_SNlength18_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new COUNTvaluePDCP_SNlength18_iE_Extensions_element();
