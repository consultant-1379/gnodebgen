...
public class TDD_InfoNeighbourServedNRCell_Information extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "TDD-InfoNeighbourServedNRCell-Information";
   }

   public NRFreqInfo nRFreqInfo;
   public TDD_InfoNeighbourServedNRCell_Information_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public TDD_InfoNeighbourServedNRCell_Information () {
      super();
      init();
   }
   ...
   public TDD_InfoNeighbourServedNRCell_Information (
      ...
      TDD_InfoNeighbourServedNRCell_Information_iE_Extensions iE_Extensions_
   ) {
      super();
      nRFreqInfo = nRFreqInfo_;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new TDD_InfoNeighbourServedNRCell_Information_iE_Extensions();
