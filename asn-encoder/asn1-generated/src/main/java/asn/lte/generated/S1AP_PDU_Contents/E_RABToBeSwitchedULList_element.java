...
public class E_RABToBeSwitchedULList_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABToBeSwitchedULItem
    * Java type: E_RABToBeSwitchedULItem
    */
   public Asn1Type value;

   public E_RABToBeSwitchedULList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABToBeSwitchedULList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABToBeSwitchedULItem
    */
   public void setUsing_id_E_RABToBeSwitchedULItem(E_RABToBeSwitchedULItem value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABToBeSwitchedULItem);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABToBeSwitchedULItem
    */
   public E_RABToBeSwitchedULItem getValueFor_id_E_RABToBeSwitchedULItem() {
      return (E_RABToBeSwitchedULItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABToBeSwitchedULItemIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABToBeSwitchedULItemIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABToBeSwitchedULItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 94) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABToBeSwitchedULItem\n");
      }
