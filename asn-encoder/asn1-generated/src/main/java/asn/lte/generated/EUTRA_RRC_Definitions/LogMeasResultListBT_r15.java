...
public class LogMeasResultListBT_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "LogMeasResultListBT-r15";
   }

   public LogMeasResultBT_r15[] elements;

   public LogMeasResultListBT_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public LogMeasResultListBT_r15 (int numRecords) {
      elements = new LogMeasResultBT_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public LogMeasResultListBT_r15 (LogMeasResultBT_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LogMeasResultBT_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LogMeasResultBT_r15();
