...
public class InterFreqWhiteCellList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqWhiteCellList-r16";
   }

   public PCI_Range[] elements;

   public InterFreqWhiteCellList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqWhiteCellList_r16 (int numRecords) {
    ...
    * given the array.  
    */
   public InterFreqWhiteCellList_r16 (PCI_Range[] elements_) {
      elements = elements_;
   }
