...
public class CellInfoListUTRA_FDD_r9 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellInfoListUTRA-FDD-r9";
   }

   public CellInfoUTRA_FDD_r9[] elements;

   public CellInfoListUTRA_FDD_r9 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellInfoListUTRA_FDD_r9 (int numRecords) {
      elements = new CellInfoUTRA_FDD_r9 [numRecords];
   }
    ...
    * given the array.  
    */
   public CellInfoListUTRA_FDD_r9 (CellInfoUTRA_FDD_r9[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellInfoUTRA_FDD_r9 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellInfoUTRA_FDD_r9();
