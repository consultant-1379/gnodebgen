...
public class EAB_CellLoadStateInformation_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-CellLoadStateInformation-List";
   }

   public EAB_CellLoadStateInformation_Item[] elements;

   public EAB_CellLoadStateInformation_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_CellLoadStateInformation_List (int numRecords) {
      elements = new EAB_CellLoadStateInformation_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_CellLoadStateInformation_List (EAB_CellLoadStateInformation_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_CellLoadStateInformation_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_CellLoadStateInformation_Item();
