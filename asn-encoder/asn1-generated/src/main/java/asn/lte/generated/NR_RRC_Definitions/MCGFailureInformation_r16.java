...
public class MCGFailureInformation_r16 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "MCGFailureInformation-r16";
   }

   public MCGFailureInformation_r16_criticalExtensions criticalExtensions;

   public MCGFailureInformation_r16 () {
      super();
      init();
   }
    ...
    */
   public MCGFailureInformation_r16 (
      MCGFailureInformation_r16_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new MCGFailureInformation_r16_criticalExtensions();
