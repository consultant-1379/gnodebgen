...
public class DownlinkNASTransport_protocolIEs extends Asn1SeqOf {
   ...
   public DownlinkNASTransport_protocolIEs_element[] elements;

   public DownlinkNASTransport_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public DownlinkNASTransport_protocolIEs (int numRecords) {
      elements = new DownlinkNASTransport_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public DownlinkNASTransport_protocolIEs (DownlinkNASTransport_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DownlinkNASTransport_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DownlinkNASTransport_protocolIEs_element();
