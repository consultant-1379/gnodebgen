...
public class UL_NAS_Count extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public UL_NAS_Count (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public UL_NAS_Count (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public UL_NAS_Count (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public UL_NAS_Count (java.util.BitSet bitSet) {
      super (bitSet);
   }
