...
public class PUSCH_TimeDomainResourceAllocation_r16_puschAllocationList_r16 extends Asn1SeqOf {
   ...
   public PUSCH_Allocation_r16[] elements;

   public PUSCH_TimeDomainResourceAllocation_r16_puschAllocationList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PUSCH_TimeDomainResourceAllocation_r16_puschAllocationList_r16 (int numRecords) {
      elements = new PUSCH_Allocation_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public PUSCH_TimeDomainResourceAllocation_r16_puschAllocationList_r16 (PUSCH_Allocation_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PUSCH_Allocation_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PUSCH_Allocation_r16();
