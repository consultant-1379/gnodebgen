...
public class DataTrafficResources extends Asn1BitString {
    ...
    */
   public DataTrafficResources (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public DataTrafficResources (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public DataTrafficResources (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public DataTrafficResources (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public DataTrafficResources (java.util.BitSet bitSet) {
      super (bitSet);
   }
