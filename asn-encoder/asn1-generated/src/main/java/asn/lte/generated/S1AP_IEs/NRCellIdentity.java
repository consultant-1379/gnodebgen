...
public class NRCellIdentity extends Asn1BitString {
    ...
    */
   public NRCellIdentity (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public NRCellIdentity (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public NRCellIdentity (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public NRCellIdentity (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public NRCellIdentity (java.util.BitSet bitSet) {
      super (bitSet);
   }
