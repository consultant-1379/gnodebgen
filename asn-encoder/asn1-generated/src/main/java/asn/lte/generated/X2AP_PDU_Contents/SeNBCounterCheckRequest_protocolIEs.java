...
public class SeNBCounterCheckRequest_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBCounterCheckRequest_protocolIEs_element[] elements;

   public SeNBCounterCheckRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBCounterCheckRequest_protocolIEs (int numRecords) {
      elements = new SeNBCounterCheckRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBCounterCheckRequest_protocolIEs (SeNBCounterCheckRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBCounterCheckRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBCounterCheckRequest_protocolIEs_element();
