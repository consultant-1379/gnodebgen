...
public class ENDCCellActivationRequest_protocolIEs extends Asn1SeqOf {
   ...
   public ENDCCellActivationRequest_protocolIEs_element[] elements;

   public ENDCCellActivationRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENDCCellActivationRequest_protocolIEs (int numRecords) {
      elements = new ENDCCellActivationRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENDCCellActivationRequest_protocolIEs (ENDCCellActivationRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENDCCellActivationRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENDCCellActivationRequest_protocolIEs_element();
