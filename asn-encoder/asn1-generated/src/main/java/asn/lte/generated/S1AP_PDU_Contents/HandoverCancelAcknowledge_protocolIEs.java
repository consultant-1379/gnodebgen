...
public class HandoverCancelAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public HandoverCancelAcknowledge_protocolIEs_element[] elements;

   public HandoverCancelAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public HandoverCancelAcknowledge_protocolIEs (int numRecords) {
      elements = new HandoverCancelAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public HandoverCancelAcknowledge_protocolIEs (HandoverCancelAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new HandoverCancelAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new HandoverCancelAcknowledge_protocolIEs_element();
