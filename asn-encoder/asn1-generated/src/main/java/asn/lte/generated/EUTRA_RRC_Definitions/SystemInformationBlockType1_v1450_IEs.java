...
public class SystemInformationBlockType1_v1450_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "SystemInformationBlockType1-v1450-IEs";
   }

   public TDD_Config_v1450 tdd_Config_v1450;  // optional
   public SystemInformationBlockType1_v1530_IEs nonCriticalExtension;  // optional

   public SystemInformationBlockType1_v1450_IEs () {
      super();
      init();
   }
   ...
   public SystemInformationBlockType1_v1450_IEs (
      ...
      SystemInformationBlockType1_v1530_IEs nonCriticalExtension_
   ) {
      super();
      tdd_Config_v1450 = tdd_Config_v1450_;
   ...
   public Object getElementValue(int index){
      switch(index)  {
         case 0: return tdd_Config_v1450;
   ...
   public String getElementName(int index){
      switch(index)  {
         case 0: return "tdd-Config-v1450";
         case 1: return "nonCriticalExtension";
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new SystemInformationBlockType1_v1530_IEs();
