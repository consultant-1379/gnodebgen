...
public class CSIReportPerCSIProcess_element_iE_Extensions extends Asn1SeqOf {
   ...
   public CSIReportPerCSIProcess_element_iE_Extensions_element[] elements;

   public CSIReportPerCSIProcess_element_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSIReportPerCSIProcess_element_iE_Extensions (int numRecords) {
      elements = new CSIReportPerCSIProcess_element_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CSIReportPerCSIProcess_element_iE_Extensions (CSIReportPerCSIProcess_element_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSIReportPerCSIProcess_element_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSIReportPerCSIProcess_element_iE_Extensions_element();
