...
public class EAB_CriticalityDiagnostics_IE_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-CriticalityDiagnostics-IE-List";
   }

   public EAB_CriticalityDiagnostics_IE_List_element[] elements;

   public EAB_CriticalityDiagnostics_IE_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_CriticalityDiagnostics_IE_List (int numRecords) {
      elements = new EAB_CriticalityDiagnostics_IE_List_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_CriticalityDiagnostics_IE_List (EAB_CriticalityDiagnostics_IE_List_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_CriticalityDiagnostics_IE_List_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_CriticalityDiagnostics_IE_List_element();
