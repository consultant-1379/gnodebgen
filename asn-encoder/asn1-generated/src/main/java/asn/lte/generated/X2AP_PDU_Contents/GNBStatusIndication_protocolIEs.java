...
public class GNBStatusIndication_protocolIEs extends Asn1SeqOf {
   ...
   public GNBStatusIndication_protocolIEs_element[] elements;

   public GNBStatusIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public GNBStatusIndication_protocolIEs (int numRecords) {
      elements = new GNBStatusIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public GNBStatusIndication_protocolIEs (GNBStatusIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GNBStatusIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GNBStatusIndication_protocolIEs_element();
