...
public class RRCConnectionReestablishment extends Asn1Seq {
   ...
   public RRCConnectionReestablishment_criticalExtensions criticalExtensions;

   public RRCConnectionReestablishment () {
      super();
      init();
   }
   ...
   public RRCConnectionReestablishment (
      ...
      RRCConnectionReestablishment_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public RRCConnectionReestablishment (long rrc_TransactionIdentifier_,
      RRCConnectionReestablishment_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionReestablishment_criticalExtensions();
