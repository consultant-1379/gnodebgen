...
public class ENSA_E6_MGMTServerAddress extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "ENSA-E6-MGMTServerAddress";
   }

   public ENSA_E6_MGMTServerAddress () {
      super();
   }
    ...
    *              in binary form.
    */
   public ENSA_E6_MGMTServerAddress (byte[] data) {
      super (data);
   }
    ...
    */
   public ENSA_E6_MGMTServerAddress (byte[] data, int offset, int nbytes) {
    ...
    */
   public ENSA_E6_MGMTServerAddress (String value_) throws Asn1ValueParseException {
      super (value_);
   }
