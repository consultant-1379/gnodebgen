...
public class SeNBAdditionRequestReject_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBAdditionRequestReject_protocolIEs_element[] elements;

   public SeNBAdditionRequestReject_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBAdditionRequestReject_protocolIEs (int numRecords) {
      elements = new SeNBAdditionRequestReject_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBAdditionRequestReject_protocolIEs (SeNBAdditionRequestReject_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBAdditionRequestReject_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBAdditionRequestReject_protocolIEs_element();
