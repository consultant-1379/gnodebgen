...
public class MeasResultList2NR extends Asn1SeqOf {
    ...
    * populated.
    */
   public MeasResultList2NR (int numRecords) {
    ...
    * given the array.  
    */
   public MeasResultList2NR (MeasResult2NR[] elements_) {
      elements = elements_;
   }
