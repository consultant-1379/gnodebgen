...
public class E_RABToBeSetupListBearerSUReq_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABToBeSetupItemBearerSUReq
    * Java type: E_RABToBeSetupItemBearerSUReq
    */
   public Asn1Type value;

   public E_RABToBeSetupListBearerSUReq_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABToBeSetupListBearerSUReq_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABToBeSetupItemBearerSUReq
    */
   public void setUsing_id_E_RABToBeSetupItemBearerSUReq(E_RABToBeSetupItemBearerSUReq value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABToBeSetupItemBearerSUReq);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABToBeSetupItemBearerSUReq
    */
   public E_RABToBeSetupItemBearerSUReq getValueFor_id_E_RABToBeSetupItemBearerSUReq() {
      return (E_RABToBeSetupItemBearerSUReq) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABToBeSetupItemBearerSUReqIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABToBeSetupItemBearerSUReqIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABToBeSetupItemBearerSUReqIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 17) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABToBeSetupItemBearerSUReq\n");
      }
