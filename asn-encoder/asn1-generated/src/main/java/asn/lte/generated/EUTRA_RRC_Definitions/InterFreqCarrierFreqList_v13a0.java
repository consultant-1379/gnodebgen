...
public class InterFreqCarrierFreqList_v13a0 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqList-v13a0";
   }

   public InterFreqCarrierFreqInfo_v1360[] elements;

   public InterFreqCarrierFreqList_v13a0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqList_v13a0 (int numRecords) {
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqList_v13a0 (InterFreqCarrierFreqInfo_v1360[] elements_) {
      elements = elements_;
   }
