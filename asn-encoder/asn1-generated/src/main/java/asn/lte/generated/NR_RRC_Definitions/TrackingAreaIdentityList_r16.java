...
public class TrackingAreaIdentityList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "TrackingAreaIdentityList-r16";
   }

   public TrackingAreaIdentity_r16[] elements;

   public TrackingAreaIdentityList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public TrackingAreaIdentityList_r16 (int numRecords) {
      elements = new TrackingAreaIdentity_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public TrackingAreaIdentityList_r16 (TrackingAreaIdentity_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TrackingAreaIdentity_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TrackingAreaIdentity_r16();
