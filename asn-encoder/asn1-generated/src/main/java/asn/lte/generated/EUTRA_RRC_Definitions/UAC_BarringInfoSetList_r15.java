...
public class UAC_BarringInfoSetList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "UAC-BarringInfoSetList-r15";
   }

   public UAC_BarringInfoSet_r15[] elements;

   public UAC_BarringInfoSetList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public UAC_BarringInfoSetList_r15 (int numRecords) {
      elements = new UAC_BarringInfoSet_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public UAC_BarringInfoSetList_r15 (UAC_BarringInfoSet_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UAC_BarringInfoSet_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UAC_BarringInfoSet_r15();
