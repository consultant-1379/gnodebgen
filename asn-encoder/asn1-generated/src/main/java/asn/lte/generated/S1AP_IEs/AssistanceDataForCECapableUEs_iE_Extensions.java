...
public class AssistanceDataForCECapableUEs_iE_Extensions extends Asn1SeqOf {
   ...
   public AssistanceDataForCECapableUEs_iE_Extensions_element[] elements;

   public AssistanceDataForCECapableUEs_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public AssistanceDataForCECapableUEs_iE_Extensions (int numRecords) {
      elements = new AssistanceDataForCECapableUEs_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public AssistanceDataForCECapableUEs_iE_Extensions (AssistanceDataForCECapableUEs_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AssistanceDataForCECapableUEs_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AssistanceDataForCECapableUEs_iE_Extensions_element();
