...
public class MeasIdToRemoveListExt_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasIdToRemoveListExt-r12";
   }

   public MeasId_v1250[] elements;

   public MeasIdToRemoveListExt_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasIdToRemoveListExt_r12 (int numRecords) {
      elements = new MeasId_v1250 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasIdToRemoveListExt_r12 (MeasId_v1250[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasId_v1250 [numElements];
