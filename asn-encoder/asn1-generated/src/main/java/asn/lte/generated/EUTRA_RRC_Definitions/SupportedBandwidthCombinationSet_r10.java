...
public class SupportedBandwidthCombinationSet_r10 extends Asn1BitString {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandwidthCombinationSet-r10";
   }
    ...
    */
   public SupportedBandwidthCombinationSet_r10 () {
      super();
      value = new byte [4];
   }
    ...
    */
   public SupportedBandwidthCombinationSet_r10 (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public SupportedBandwidthCombinationSet_r10 (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public SupportedBandwidthCombinationSet_r10 (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public SupportedBandwidthCombinationSet_r10 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public SupportedBandwidthCombinationSet_r10 (java.util.BitSet bitSet) {
      super (bitSet);
   }
