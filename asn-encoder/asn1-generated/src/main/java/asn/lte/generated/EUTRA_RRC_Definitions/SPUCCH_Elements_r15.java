...
public class SPUCCH_Elements_r15 extends Asn1Choice {
   ...
   public SPUCCH_Elements_r15 () {
      super();
   }

   public SPUCCH_Elements_r15 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SPUCCH_Elements_r15_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            SPUCCH_Elements_r15_setup setup;
            element = setup = new SPUCCH_Elements_r15_setup();
            setup.decode (buffer);
            break;
         }
