...
public class ResultsPerSSB_IndexList extends Asn1SeqOf {
   ...
   public ResultsPerSSB_Index[] elements;

   public ResultsPerSSB_IndexList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ResultsPerSSB_IndexList (int numRecords) {
      elements = new ResultsPerSSB_Index [numRecords];
   }
    ...
    * given the array.  
    */
   public ResultsPerSSB_IndexList (ResultsPerSSB_Index[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ResultsPerSSB_Index [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ResultsPerSSB_Index();
