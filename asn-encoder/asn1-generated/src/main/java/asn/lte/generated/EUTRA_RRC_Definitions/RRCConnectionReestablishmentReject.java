...
public class RRCConnectionReestablishmentReject extends Asn1Seq {
   ...
   public RRCConnectionReestablishmentReject_criticalExtensions criticalExtensions;

   public RRCConnectionReestablishmentReject () {
      super();
      init();
   }
    ...
    */
   public RRCConnectionReestablishmentReject (
      RRCConnectionReestablishmentReject_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionReestablishmentReject_criticalExtensions();
