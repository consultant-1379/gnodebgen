...
public class TAI_iE_Extensions extends Asn1SeqOf {
   ...
   public TAI_iE_Extensions_element[] elements;

   public TAI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TAI_iE_Extensions (int numRecords) {
      elements = new TAI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TAI_iE_Extensions (TAI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TAI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TAI_iE_Extensions_element();
