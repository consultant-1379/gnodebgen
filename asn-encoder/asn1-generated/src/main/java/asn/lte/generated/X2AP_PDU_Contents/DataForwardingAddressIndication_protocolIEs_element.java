...
public class DataForwardingAddressIndication_protocolIEs_element extends Asn1Seq {
    ...
    * Java type: UE_X2AP_ID_Extension
    *
    * id: id-E-RABs-DataForwardingAddress-List
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABs-DataForwardingAddress-List
    * Java type: E_RABs_DataForwardingAddress_List
    */
   public Asn1Type value;

   public DataForwardingAddressIndication_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public DataForwardingAddressIndication_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-DataForwardingAddress-List
    */
   public void setUsing_id_E_RABs_DataForwardingAddress_List(E_RABs_DataForwardingAddress_List value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_DataForwardingAddress_List);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-DataForwardingAddress-List
    */
   public E_RABs_DataForwardingAddress_List getValueFor_id_E_RABs_DataForwardingAddress_List() {
      return (E_RABs_DataForwardingAddress_List) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.DataForwardingAddressIndication_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.DataForwardingAddressIndication_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.DataForwardingAddressIndication_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 307) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-DataForwardingAddress-List\n");
      }
