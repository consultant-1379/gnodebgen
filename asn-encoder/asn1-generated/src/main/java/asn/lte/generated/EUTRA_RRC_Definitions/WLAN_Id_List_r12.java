...
public class WLAN_Id_List_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "WLAN-Id-List-r12";
   }

   public WLAN_Identifiers_r12[] elements;

   public WLAN_Id_List_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public WLAN_Id_List_r12 (int numRecords) {
      elements = new WLAN_Identifiers_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public WLAN_Id_List_r12 (WLAN_Identifiers_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WLAN_Identifiers_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new WLAN_Identifiers_r12();
