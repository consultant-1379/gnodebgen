...
public class ULResourceBitmapULandDLSharing extends DataTrafficResources {
   ...
   public String getAsn1TypeName()  {
      return "ULResourceBitmapULandDLSharing";
   }
    ...
    */
   public ULResourceBitmapULandDLSharing () {
      super();
      value = new byte [2200];
   }
    ...
    */
   public ULResourceBitmapULandDLSharing (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public ULResourceBitmapULandDLSharing (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public ULResourceBitmapULandDLSharing (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public ULResourceBitmapULandDLSharing (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public ULResourceBitmapULandDLSharing (java.util.BitSet bitSet) {
      super (bitSet);
   }
