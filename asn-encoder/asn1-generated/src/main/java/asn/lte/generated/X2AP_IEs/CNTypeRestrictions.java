...
public class CNTypeRestrictions extends Asn1SeqOf {
   ...
   public CNTypeRestrictionsItem[] elements;
   ...
   public CNTypeRestrictions (int numRecords) {
      elements = new CNTypeRestrictionsItem [numRecords];
   }
    ...
    * given the array.  
    */
   public CNTypeRestrictions (CNTypeRestrictionsItem[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CNTypeRestrictionsItem [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CNTypeRestrictionsItem();
