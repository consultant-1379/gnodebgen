...
public class VarLogMeasConfig_r10 extends Asn1Seq {
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 1: return loggingDuration_r10;
         case 2: return loggingInterval_r10;
         default: return null;
      }
   }
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 1: return "loggingDuration-r10";
         case 2: return "loggingInterval-r10";
         default: return null;
      }
   }
