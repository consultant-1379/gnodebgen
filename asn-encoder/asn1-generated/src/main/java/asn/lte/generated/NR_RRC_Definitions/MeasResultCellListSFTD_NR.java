...
public class MeasResultCellListSFTD_NR extends Asn1SeqOf {
   ...
   public MeasResultCellSFTD_NR[] elements;

   public MeasResultCellListSFTD_NR () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultCellListSFTD_NR (int numRecords) {
      elements = new MeasResultCellSFTD_NR [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultCellListSFTD_NR (MeasResultCellSFTD_NR[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultCellSFTD_NR [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultCellSFTD_NR();
