...
public class SL_DiscTxPoolList_r12 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-DiscTxPoolList-r12";
   }

   public SL_DiscResourcePool_r12[] elements;

   public SL_DiscTxPoolList_r12 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_DiscTxPoolList_r12 (int numRecords) {
      elements = new SL_DiscResourcePool_r12 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_DiscTxPoolList_r12 (SL_DiscResourcePool_r12[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_DiscResourcePool_r12 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_DiscResourcePool_r12();
