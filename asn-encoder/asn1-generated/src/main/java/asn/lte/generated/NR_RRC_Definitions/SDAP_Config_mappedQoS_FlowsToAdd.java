...
public class SDAP_Config_mappedQoS_FlowsToAdd extends Asn1SeqOf {
   ...
   public SDAP_Config_mappedQoS_FlowsToAdd () {
      elements = null;
   }
    ...
    * populated.
    */
   public SDAP_Config_mappedQoS_FlowsToAdd (int numRecords) {
    ...
    * given the array.  
    */
   public SDAP_Config_mappedQoS_FlowsToAdd (QFI[] elements_) {
      elements = elements_;
   }
