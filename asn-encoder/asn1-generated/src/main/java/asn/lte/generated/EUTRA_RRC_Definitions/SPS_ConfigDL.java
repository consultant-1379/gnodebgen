...
public class SPS_ConfigDL extends Asn1Choice {
   ...
   public SPS_ConfigDL (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SPS_ConfigDL_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            SPS_ConfigDL_setup setup;
            element = setup = new SPS_ConfigDL_setup();
            setup.decode (buffer);
            break;
         }
