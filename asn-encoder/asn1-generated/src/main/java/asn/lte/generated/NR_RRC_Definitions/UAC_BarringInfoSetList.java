...
public class UAC_BarringInfoSetList extends Asn1SeqOf {
   ...
   public UAC_BarringInfoSet[] elements;

   public UAC_BarringInfoSetList () {
      elements = null;
   }
    ...
    * populated.
    */
   public UAC_BarringInfoSetList (int numRecords) {
      elements = new UAC_BarringInfoSet [numRecords];
   }
    ...
    * given the array.  
    */
   public UAC_BarringInfoSetList (UAC_BarringInfoSet[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UAC_BarringInfoSet [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UAC_BarringInfoSet();
