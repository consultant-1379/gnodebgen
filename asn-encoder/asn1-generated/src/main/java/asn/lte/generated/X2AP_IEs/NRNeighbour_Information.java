...
public class NRNeighbour_Information extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "NRNeighbour-Information";
   }

   public NRNeighbour_Information_element[] elements;

   public NRNeighbour_Information () {
      elements = null;
   }
    ...
    * populated.
    */
   public NRNeighbour_Information (int numRecords) {
      elements = new NRNeighbour_Information_element [numRecords];
   }
    ...
    * given the array.  
    */
   public NRNeighbour_Information (NRNeighbour_Information_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NRNeighbour_Information_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NRNeighbour_Information_element();
