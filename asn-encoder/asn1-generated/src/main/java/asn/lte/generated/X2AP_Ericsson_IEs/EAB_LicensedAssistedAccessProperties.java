...
public class EAB_LicensedAssistedAccessProperties extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-LicensedAssistedAccessProperties";
   }

   public EAB_LicensedAssistedAccessProperties_element[] elements;

   public EAB_LicensedAssistedAccessProperties () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_LicensedAssistedAccessProperties (int numRecords) {
      elements = new EAB_LicensedAssistedAccessProperties_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_LicensedAssistedAccessProperties (EAB_LicensedAssistedAccessProperties_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_LicensedAssistedAccessProperties_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_LicensedAssistedAccessProperties_element();
