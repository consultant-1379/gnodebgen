...
public class EAB_eNB_FeatureList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-eNB-FeatureList";
   }

   public EAB_eNB_FeatureList_element[] elements;

   public EAB_eNB_FeatureList () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_eNB_FeatureList (int numRecords) {
      elements = new EAB_eNB_FeatureList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_eNB_FeatureList (EAB_eNB_FeatureList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_eNB_FeatureList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_eNB_FeatureList_element();
