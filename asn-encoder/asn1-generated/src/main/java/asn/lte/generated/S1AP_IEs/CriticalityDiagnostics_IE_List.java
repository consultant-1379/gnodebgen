...
public class CriticalityDiagnostics_IE_List extends Asn1SeqOf {
   ...
   public CriticalityDiagnostics_IE_Item[] elements;
   ...
   public CriticalityDiagnostics_IE_List (int numRecords) {
      elements = new CriticalityDiagnostics_IE_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public CriticalityDiagnostics_IE_List (CriticalityDiagnostics_IE_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CriticalityDiagnostics_IE_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CriticalityDiagnostics_IE_Item();
