...
public class ENDCPartialResetRequired_protocolIEs_element extends Asn1Seq {
   ...
   public ENDCPartialResetRequired_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCPartialResetRequired_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-UEs-ToBeReset
    */
   public void setUsing_id_UEs_ToBeReset(asn.lte.generated.X2AP_IEs.UEsToBeResetList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_UEs_ToBeReset);
   ...
   /**
    * Get value of value with type set according to information object having key id-UEs-ToBeReset
    */
   public asn.lte.generated.X2AP_IEs.UEsToBeResetList getValueFor_id_UEs_ToBeReset() {
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCPartialResetRequired_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCPartialResetRequired_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCPartialResetRequired_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 270) {
         indent (_sb, _level+1);
         _sb.append("id = id-UEs-ToBeReset\n");
      }
      else if (id.value == 5) {
         indent (_sb, _level+1);
