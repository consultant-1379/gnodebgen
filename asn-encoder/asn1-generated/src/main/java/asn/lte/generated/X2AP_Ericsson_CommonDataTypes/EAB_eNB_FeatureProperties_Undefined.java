...
public class EAB_eNB_FeatureProperties_Undefined extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-eNB-FeatureProperties-Undefined";
   }

   public EAB_eNB_FeatureProperties_Undefined_element[] elements;

   public EAB_eNB_FeatureProperties_Undefined () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_eNB_FeatureProperties_Undefined (int numRecords) {
      elements = new EAB_eNB_FeatureProperties_Undefined_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_eNB_FeatureProperties_Undefined (EAB_eNB_FeatureProperties_Undefined_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_eNB_FeatureProperties_Undefined_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_eNB_FeatureProperties_Undefined_element();
