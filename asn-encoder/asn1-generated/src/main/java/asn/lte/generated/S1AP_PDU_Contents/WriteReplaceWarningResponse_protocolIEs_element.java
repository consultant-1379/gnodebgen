...
public class WriteReplaceWarningResponse_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: BroadcastCompletedAreaList
    * Java type: BroadcastCompletedAreaList
    *
   ...
   public WriteReplaceWarningResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public WriteReplaceWarningResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-BroadcastCompletedAreaList
    */
   public void setUsing_id_BroadcastCompletedAreaList(asn.lte.generated.S1AP_IEs.BroadcastCompletedAreaList value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_BroadcastCompletedAreaList);
   ...
   /**
    * Get value of value with type set according to information object having key id-BroadcastCompletedAreaList
    */
   public asn.lte.generated.S1AP_IEs.BroadcastCompletedAreaList getValueFor_id_BroadcastCompletedAreaList() {
      return (asn.lte.generated.S1AP_IEs.BroadcastCompletedAreaList) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.WriteReplaceWarningResponseIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.WriteReplaceWarningResponseIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.WriteReplaceWarningResponseIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-BroadcastCompletedAreaList\n");
      }
      else if (id.value == 58) {
         indent (_sb, _level+1);
