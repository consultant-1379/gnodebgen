...
public class CountingResponseList_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CountingResponseList-r10";
   }

   public CountingResponseInfo_r10[] elements;

   public CountingResponseList_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CountingResponseList_r10 (int numRecords) {
      elements = new CountingResponseInfo_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public CountingResponseList_r10 (CountingResponseInfo_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CountingResponseInfo_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CountingResponseInfo_r10();
