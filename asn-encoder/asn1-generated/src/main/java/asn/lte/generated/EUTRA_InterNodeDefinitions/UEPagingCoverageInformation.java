...
public class UEPagingCoverageInformation extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UEPagingCoverageInformation";
   }

   public UEPagingCoverageInformation_criticalExtensions criticalExtensions;

   public UEPagingCoverageInformation () {
      super();
      init();
   }
    ...
    */
   public UEPagingCoverageInformation (
      UEPagingCoverageInformation_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new UEPagingCoverageInformation_criticalExtensions();
