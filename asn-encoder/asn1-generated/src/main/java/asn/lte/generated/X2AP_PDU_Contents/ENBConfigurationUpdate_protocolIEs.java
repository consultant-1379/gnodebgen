...
public class ENBConfigurationUpdate_protocolIEs extends Asn1SeqOf {
   ...
   public ENBConfigurationUpdate_protocolIEs_element[] elements;

   public ENBConfigurationUpdate_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENBConfigurationUpdate_protocolIEs (int numRecords) {
      elements = new ENBConfigurationUpdate_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENBConfigurationUpdate_protocolIEs (ENBConfigurationUpdate_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENBConfigurationUpdate_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENBConfigurationUpdate_protocolIEs_element();
