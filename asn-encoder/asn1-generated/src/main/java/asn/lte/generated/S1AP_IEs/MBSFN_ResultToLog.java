...
public class MBSFN_ResultToLog extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MBSFN-ResultToLog";
   }

   public MBSFN_ResultToLogInfo[] elements;

   public MBSFN_ResultToLog () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBSFN_ResultToLog (int numRecords) {
      elements = new MBSFN_ResultToLogInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public MBSFN_ResultToLog (MBSFN_ResultToLogInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBSFN_ResultToLogInfo [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBSFN_ResultToLogInfo();
