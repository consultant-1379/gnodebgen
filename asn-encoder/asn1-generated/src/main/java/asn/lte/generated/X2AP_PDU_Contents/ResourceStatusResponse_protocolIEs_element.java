...
public class ResourceStatusResponse_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-MeasurementInitiationResult-List
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: MeasurementInitiationResult-List
    * Java type: MeasurementInitiationResult_List
    */
   public Asn1Type value;

   public ResourceStatusResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ResourceStatusResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-MeasurementInitiationResult-List
    */
   public void setUsing_id_MeasurementInitiationResult_List(MeasurementInitiationResult_List value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_MeasurementInitiationResult_List);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-MeasurementInitiationResult-List
    */
   public MeasurementInitiationResult_List getValueFor_id_MeasurementInitiationResult_List() {
      return (MeasurementInitiationResult_List) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ResourceStatusResponse_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ResourceStatusResponse_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ResourceStatusResponse_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 39) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-MeasurementInitiationResult-List\n");
      }
