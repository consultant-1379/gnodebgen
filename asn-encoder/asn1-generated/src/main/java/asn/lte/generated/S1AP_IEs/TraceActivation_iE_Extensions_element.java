...
public class TraceActivation_iE_Extensions_element extends Asn1Seq {
    ...
    * ASN.1 type: MDT-Configuration
    * Java type: MDT_Configuration
    *
    * id: id-UEAppLayerMeasConfig
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: UEAppLayerMeasConfig
    * Java type: UEAppLayerMeasConfig
    */
   public Asn1Type extensionValue;

   public TraceActivation_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public TraceActivation_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-MDTConfiguration
    */
   public void setUsing_id_MDTConfiguration(MDT_Configuration extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_MDTConfiguration);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Assign fields according to information object having key id-UEAppLayerMeasConfig
    */
   public void setUsing_id_UEAppLayerMeasConfig(UEAppLayerMeasConfig extensionValue) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolExtensionID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_UEAppLayerMeasConfig);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-MDTConfiguration
    */
   public MDT_Configuration getExtensionValueFor_id_MDTConfiguration() {
      return (MDT_Configuration) this.extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-UEAppLayerMeasConfig
    */
   public UEAppLayerMeasConfig getExtensionValueFor_id_UEAppLayerMeasConfig() {
      return (UEAppLayerMeasConfig) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.TraceActivation_ExtIEs.length; i++) {
         if(_S1AP_IEsValues.TraceActivation_ExtIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.TraceActivation_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 162) {
         indent (_sb, _level+1);
         _sb.append("id = id-MDTConfiguration\n");
      }
      else if (id.value == 262) {
         indent (_sb, _level+1);
         _sb.append("id = id-UEAppLayerMeasConfig\n");
      }
