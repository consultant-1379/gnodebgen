...
public class GTP_TEI extends Asn1OctetString {
    ...
    */
   public GTP_TEI (byte[] data, int offset, int nbytes) {
    ...
    */
   public GTP_TEI (String value_) throws Asn1ValueParseException {
      super (value_);
   }
