...
public class E_RABModifyListBearerModConf_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABModifyItemBearerModConf
    * Java type: E_RABModifyItemBearerModConf
    */
   public Asn1Type value;

   public E_RABModifyListBearerModConf_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABModifyListBearerModConf_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABModifyItemBearerModConf
    */
   public void setUsing_id_E_RABModifyItemBearerModConf(E_RABModifyItemBearerModConf value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABModifyItemBearerModConf);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABModifyItemBearerModConf
    */
   public E_RABModifyItemBearerModConf getValueFor_id_E_RABModifyItemBearerModConf() {
      return (E_RABModifyItemBearerModConf) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABModifyItemBearerModConfIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABModifyItemBearerModConfIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABModifyItemBearerModConfIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 204) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABModifyItemBearerModConf\n");
      }
