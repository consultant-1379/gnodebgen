...
public class ENSA_E6_MGMTServicetoAddList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ENSA-E6-MGMTServicetoAddList";
   }

   public ENSA_E6_MGMTServicetoAdd_Item[] elements;

   public ENSA_E6_MGMTServicetoAddList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENSA_E6_MGMTServicetoAddList (int numRecords) {
      elements = new ENSA_E6_MGMTServicetoAdd_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ENSA_E6_MGMTServicetoAddList (ENSA_E6_MGMTServicetoAdd_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENSA_E6_MGMTServicetoAdd_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENSA_E6_MGMTServicetoAdd_Item();
