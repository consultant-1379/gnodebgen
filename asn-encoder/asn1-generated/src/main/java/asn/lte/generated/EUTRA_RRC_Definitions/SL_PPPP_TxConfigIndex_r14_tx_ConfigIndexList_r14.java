...
public class SL_PPPP_TxConfigIndex_r14_tx_ConfigIndexList_r14 extends Asn1SeqOf {
   ...
   public Tx_ConfigIndex_r14[] elements;

   public SL_PPPP_TxConfigIndex_r14_tx_ConfigIndexList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_PPPP_TxConfigIndex_r14_tx_ConfigIndexList_r14 (int numRecords) {
      elements = new Tx_ConfigIndex_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_PPPP_TxConfigIndex_r14_tx_ConfigIndexList_r14 (Tx_ConfigIndex_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new Tx_ConfigIndex_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new Tx_ConfigIndex_r14();
