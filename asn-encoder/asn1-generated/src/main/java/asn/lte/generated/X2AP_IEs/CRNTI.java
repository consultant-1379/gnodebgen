...
public class CRNTI extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public CRNTI (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public CRNTI (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public CRNTI (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public CRNTI (java.util.BitSet bitSet) {
      super (bitSet);
   }
