...
public class ServingCellConfig_downlinkBWP_ToReleaseList extends Asn1SeqOf {
   ...
   public BWP_Id[] elements;

   public ServingCellConfig_downlinkBWP_ToReleaseList () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServingCellConfig_downlinkBWP_ToReleaseList (int numRecords) {
      elements = new BWP_Id [numRecords];
   }
    ...
    * given the array.  
    */
   public ServingCellConfig_downlinkBWP_ToReleaseList (BWP_Id[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BWP_Id [numElements];
