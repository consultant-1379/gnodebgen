...
public class InterFreqCarrierFreqListExt_v1280 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "InterFreqCarrierFreqListExt-v1280";
   }

   public InterFreqCarrierFreqInfo_v10j0[] elements;

   public InterFreqCarrierFreqListExt_v1280 () {
      elements = null;
   }
    ...
    * populated.
    */
   public InterFreqCarrierFreqListExt_v1280 (int numRecords) {
    ...
    * given the array.  
    */
   public InterFreqCarrierFreqListExt_v1280 (InterFreqCarrierFreqInfo_v10j0[] elements_) {
      elements = elements_;
   }
