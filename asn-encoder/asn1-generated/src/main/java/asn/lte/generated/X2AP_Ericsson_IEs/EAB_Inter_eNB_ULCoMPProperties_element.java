...
public class EAB_Inter_eNB_ULCoMPProperties_element extends Asn1Seq {
    ...
    * ASN.1 type: EAB-IeNB-ULCoMP
    * Java type: EAB_IeNB_ULCoMP
    */
   public Asn1Type value;

   public EAB_Inter_eNB_ULCoMPProperties_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_Inter_eNB_ULCoMPProperties_element (long id_,
      EAB_CriticalityIgnore criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-IeNB-ULCoMP
    */
   public void setUsing_eid_IeNB_ULCoMP(EAB_IeNB_ULCoMP value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_IeNB_ULCoMP);
      this.criticality = asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_CriticalityIgnore.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key eid-IeNB-ULCoMP
    */
   public EAB_IeNB_ULCoMP getValueFor_eid_IeNB_ULCoMP() {
      return (EAB_IeNB_ULCoMP) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_Inter_eNB_ULCoMPProperties_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_Inter_eNB_ULCoMPProperties_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_Inter_eNB_ULCoMPProperties_IEs[i];
            break;
         }
      }
      if (null == _index) {
