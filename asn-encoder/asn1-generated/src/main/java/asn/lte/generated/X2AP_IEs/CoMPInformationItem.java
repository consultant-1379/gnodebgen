...
public class CoMPInformationItem extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CoMPInformationItem";
   }

   public CoMPInformationItem_element[] elements;

   public CoMPInformationItem () {
      elements = null;
   }
    ...
    * populated.
    */
   public CoMPInformationItem (int numRecords) {
      elements = new CoMPInformationItem_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CoMPInformationItem (CoMPInformationItem_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CoMPInformationItem_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CoMPInformationItem_element();
