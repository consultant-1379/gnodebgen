...
public class SgNBReleaseConfirm_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBReleaseConfirm_protocolIEs_element[] elements;

   public SgNBReleaseConfirm_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBReleaseConfirm_protocolIEs (int numRecords) {
      elements = new SgNBReleaseConfirm_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBReleaseConfirm_protocolIEs (SgNBReleaseConfirm_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBReleaseConfirm_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBReleaseConfirm_protocolIEs_element();
