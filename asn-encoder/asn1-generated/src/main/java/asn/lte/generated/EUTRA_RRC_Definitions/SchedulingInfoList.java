...
public class SchedulingInfoList extends Asn1SeqOf {
    ...
    * populated.
    */
   public SchedulingInfoList (int numRecords) {
    ...
    * given the array.  
    */
   public SchedulingInfoList (SchedulingInfo[] elements_) {
      elements = elements_;
   }
