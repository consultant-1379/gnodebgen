...
public class UL_CP_SecurityInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public UL_CP_SecurityInformation_iE_Extensions_element[] elements;

   public UL_CP_SecurityInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public UL_CP_SecurityInformation_iE_Extensions (int numRecords) {
      elements = new UL_CP_SecurityInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UL_CP_SecurityInformation_iE_Extensions (UL_CP_SecurityInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UL_CP_SecurityInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UL_CP_SecurityInformation_iE_Extensions_element();
