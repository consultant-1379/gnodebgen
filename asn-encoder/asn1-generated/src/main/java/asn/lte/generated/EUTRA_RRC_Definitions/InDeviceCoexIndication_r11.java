...
public class InDeviceCoexIndication_r11 extends Asn1Seq {
   ...
   public InDeviceCoexIndication_r11_criticalExtensions criticalExtensions;

   public InDeviceCoexIndication_r11 () {
      super();
      init();
   }
    ...
    */
   public InDeviceCoexIndication_r11 (
      InDeviceCoexIndication_r11_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new InDeviceCoexIndication_r11_criticalExtensions();
