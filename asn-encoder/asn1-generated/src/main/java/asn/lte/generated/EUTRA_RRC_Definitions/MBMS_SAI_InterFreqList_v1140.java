...
public class MBMS_SAI_InterFreqList_v1140 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MBMS-SAI-InterFreqList-v1140";
   }

   public MBMS_SAI_InterFreq_v1140[] elements;

   public MBMS_SAI_InterFreqList_v1140 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMS_SAI_InterFreqList_v1140 (int numRecords) {
      elements = new MBMS_SAI_InterFreq_v1140 [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMS_SAI_InterFreqList_v1140 (MBMS_SAI_InterFreq_v1140[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMS_SAI_InterFreq_v1140 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMS_SAI_InterFreq_v1140();
