...
public class SupportedBandCombination_v1130 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-v1130";
   }

   public BandCombinationParameters_v1130[] elements;

   public SupportedBandCombination_v1130 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_v1130 (int numRecords) {
      elements = new BandCombinationParameters_v1130 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandCombination_v1130 (BandCombinationParameters_v1130[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandCombinationParameters_v1130 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandCombinationParameters_v1130();
