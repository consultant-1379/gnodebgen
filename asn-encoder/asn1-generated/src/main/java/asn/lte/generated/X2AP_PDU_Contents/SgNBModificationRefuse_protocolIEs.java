...
public class SgNBModificationRefuse_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBModificationRefuse_protocolIEs_element[] elements;

   public SgNBModificationRefuse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBModificationRefuse_protocolIEs (int numRecords) {
      elements = new SgNBModificationRefuse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBModificationRefuse_protocolIEs (SgNBModificationRefuse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBModificationRefuse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBModificationRefuse_protocolIEs_element();
