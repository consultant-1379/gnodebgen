...
public class Oneframe extends Asn1BitString {
    ...
    * @param data       Binary bit string contents
    */
   public Oneframe (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public Oneframe (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public Oneframe (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public Oneframe (java.util.BitSet bitSet) {
      super (bitSet);
   }
