...
public class ValidityAreaList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ValidityAreaList-r16";
   }

   public ValidityArea_r16[] elements;

   public ValidityAreaList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public ValidityAreaList_r16 (int numRecords) {
      elements = new ValidityArea_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public ValidityAreaList_r16 (ValidityArea_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ValidityArea_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ValidityArea_r16();
