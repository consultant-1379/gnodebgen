...
public class SPDCCH_Elements_r15 extends Asn1Choice {
   ...
   public SPDCCH_Elements_r15 () {
      super();
   }

   public SPDCCH_Elements_r15 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (SPDCCH_Elements_r15_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            SPDCCH_Elements_r15_setup setup;
            element = setup = new SPDCCH_Elements_r15_setup();
            setup.decode (buffer);
            break;
         }
