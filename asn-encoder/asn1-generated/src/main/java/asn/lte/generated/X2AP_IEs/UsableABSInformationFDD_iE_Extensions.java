...
public class UsableABSInformationFDD_iE_Extensions extends Asn1SeqOf {
   ...
   public UsableABSInformationFDD_iE_Extensions_element[] elements;

   public UsableABSInformationFDD_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public UsableABSInformationFDD_iE_Extensions (int numRecords) {
      elements = new UsableABSInformationFDD_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UsableABSInformationFDD_iE_Extensions (UsableABSInformationFDD_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UsableABSInformationFDD_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UsableABSInformationFDD_iE_Extensions_element();
