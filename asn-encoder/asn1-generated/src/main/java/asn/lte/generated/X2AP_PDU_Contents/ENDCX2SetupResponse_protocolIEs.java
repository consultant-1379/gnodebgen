...
public class ENDCX2SetupResponse_protocolIEs extends Asn1SeqOf {
   ...
   public ENDCX2SetupResponse_protocolIEs_element[] elements;

   public ENDCX2SetupResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENDCX2SetupResponse_protocolIEs (int numRecords) {
      elements = new ENDCX2SetupResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENDCX2SetupResponse_protocolIEs (ENDCX2SetupResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENDCX2SetupResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENDCX2SetupResponse_protocolIEs_element();
