...
public class PDCCH_Config_controlResourceSetToAddModList extends Asn1SeqOf {
   ...
   public PDCCH_Config_controlResourceSetToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDCCH_Config_controlResourceSetToAddModList (int numRecords) {
    ...
    * given the array.  
    */
   public PDCCH_Config_controlResourceSetToAddModList (ControlResourceSet[] elements_) {
      elements = elements_;
   }
