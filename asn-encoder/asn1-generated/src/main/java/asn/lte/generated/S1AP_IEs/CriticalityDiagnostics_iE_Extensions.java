...
public class CriticalityDiagnostics_iE_Extensions extends Asn1SeqOf {
   ...
   public CriticalityDiagnostics_iE_Extensions_element[] elements;

   public CriticalityDiagnostics_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CriticalityDiagnostics_iE_Extensions (int numRecords) {
      elements = new CriticalityDiagnostics_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CriticalityDiagnostics_iE_Extensions (CriticalityDiagnostics_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CriticalityDiagnostics_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CriticalityDiagnostics_iE_Extensions_element();
