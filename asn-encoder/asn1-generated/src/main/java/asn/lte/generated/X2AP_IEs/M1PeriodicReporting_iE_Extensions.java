...
public class M1PeriodicReporting_iE_Extensions extends Asn1SeqOf {
   ...
   public M1PeriodicReporting_iE_Extensions_element[] elements;

   public M1PeriodicReporting_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public M1PeriodicReporting_iE_Extensions (int numRecords) {
      elements = new M1PeriodicReporting_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public M1PeriodicReporting_iE_Extensions (M1PeriodicReporting_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new M1PeriodicReporting_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new M1PeriodicReporting_iE_Extensions_element();
