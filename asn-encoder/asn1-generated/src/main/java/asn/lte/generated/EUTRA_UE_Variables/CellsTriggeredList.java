...
public class CellsTriggeredList extends Asn1SeqOf {
   ...
   public CellsTriggeredList_element[] elements;
    ...
    * populated.
    */
   public CellsTriggeredList (int numRecords) {
      elements = new CellsTriggeredList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellsTriggeredList (CellsTriggeredList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellsTriggeredList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellsTriggeredList_element();
