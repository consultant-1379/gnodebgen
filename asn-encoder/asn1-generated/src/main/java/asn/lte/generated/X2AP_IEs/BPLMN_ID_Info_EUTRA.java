...
public class BPLMN_ID_Info_EUTRA extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BPLMN-ID-Info-EUTRA";
   }

   public BPLMN_ID_Info_EUTRA_Item[] elements;

   public BPLMN_ID_Info_EUTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public BPLMN_ID_Info_EUTRA (int numRecords) {
      elements = new BPLMN_ID_Info_EUTRA_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public BPLMN_ID_Info_EUTRA (BPLMN_ID_Info_EUTRA_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BPLMN_ID_Info_EUTRA_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BPLMN_ID_Info_EUTRA_Item();
