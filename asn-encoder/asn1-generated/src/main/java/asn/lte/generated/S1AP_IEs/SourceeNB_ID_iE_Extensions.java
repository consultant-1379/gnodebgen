...
public class SourceeNB_ID_iE_Extensions extends Asn1SeqOf {
   ...
   public SourceeNB_ID_iE_Extensions_element[] elements;

   public SourceeNB_ID_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SourceeNB_ID_iE_Extensions (int numRecords) {
      elements = new SourceeNB_ID_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SourceeNB_ID_iE_Extensions (SourceeNB_ID_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SourceeNB_ID_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SourceeNB_ID_iE_Extensions_element();
