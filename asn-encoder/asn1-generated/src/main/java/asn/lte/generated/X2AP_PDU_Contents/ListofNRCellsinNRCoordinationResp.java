...
public class ListofNRCellsinNRCoordinationResp extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ListofNRCellsinNRCoordinationResp";
   }

   public NRCGI[] elements;

   public ListofNRCellsinNRCoordinationResp () {
      elements = null;
   }
    ...
    * populated.
    */
   public ListofNRCellsinNRCoordinationResp (int numRecords) {
    ...
    * given the array.  
    */
   public ListofNRCellsinNRCoordinationResp (NRCGI[] elements_) {
      elements = elements_;
   }
