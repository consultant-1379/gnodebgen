...
public class E_RABs_ToBeReleased_List_RelConf extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "E-RABs-ToBeReleased-List-RelConf";
   }

   public E_RABs_ToBeReleased_List_RelConf_element[] elements;

   public E_RABs_ToBeReleased_List_RelConf () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABs_ToBeReleased_List_RelConf (int numRecords) {
      elements = new E_RABs_ToBeReleased_List_RelConf_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABs_ToBeReleased_List_RelConf (E_RABs_ToBeReleased_List_RelConf_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABs_ToBeReleased_List_RelConf_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABs_ToBeReleased_List_RelConf_element();
