...
public class PDCCH_ConfigCommon_commonSearchSpaceList extends Asn1SeqOf {
   ...
   public PDCCH_ConfigCommon_commonSearchSpaceList () {
      elements = null;
   }
    ...
    * populated.
    */
   public PDCCH_ConfigCommon_commonSearchSpaceList (int numRecords) {
    ...
    * given the array.  
    */
   public PDCCH_ConfigCommon_commonSearchSpaceList (SearchSpace[] elements_) {
      elements = elements_;
   }
