...
public class CellActivationRequest_protocolIEs extends Asn1SeqOf {
   ...
   public CellActivationRequest_protocolIEs_element[] elements;

   public CellActivationRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellActivationRequest_protocolIEs (int numRecords) {
      elements = new CellActivationRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellActivationRequest_protocolIEs (CellActivationRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellActivationRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellActivationRequest_protocolIEs_element();
