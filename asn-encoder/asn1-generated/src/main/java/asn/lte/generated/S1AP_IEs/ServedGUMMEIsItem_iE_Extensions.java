...
public class ServedGUMMEIsItem_iE_Extensions extends Asn1SeqOf {
   ...
   public ServedGUMMEIsItem_iE_Extensions_element[] elements;

   public ServedGUMMEIsItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedGUMMEIsItem_iE_Extensions (int numRecords) {
      elements = new ServedGUMMEIsItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedGUMMEIsItem_iE_Extensions (ServedGUMMEIsItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedGUMMEIsItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedGUMMEIsItem_iE_Extensions_element();
