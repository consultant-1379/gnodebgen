...
public class LocationReportingFailureIndication_protocolIEs extends Asn1SeqOf {
   ...
   public LocationReportingFailureIndication_protocolIEs_element[] elements;

   public LocationReportingFailureIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public LocationReportingFailureIndication_protocolIEs (int numRecords) {
      elements = new LocationReportingFailureIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public LocationReportingFailureIndication_protocolIEs (LocationReportingFailureIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new LocationReportingFailureIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new LocationReportingFailureIndication_protocolIEs_element();
