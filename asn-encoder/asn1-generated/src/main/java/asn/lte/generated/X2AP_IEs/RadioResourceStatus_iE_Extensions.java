...
public class RadioResourceStatus_iE_Extensions extends Asn1SeqOf {
   ...
   public RadioResourceStatus_iE_Extensions_element[] elements;

   public RadioResourceStatus_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public RadioResourceStatus_iE_Extensions (int numRecords) {
      elements = new RadioResourceStatus_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RadioResourceStatus_iE_Extensions (RadioResourceStatus_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RadioResourceStatus_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RadioResourceStatus_iE_Extensions_element();
