...
public class UEContextResumeFailure_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextResumeFailure_protocolIEs_element[] elements;

   public UEContextResumeFailure_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextResumeFailure_protocolIEs (int numRecords) {
      elements = new UEContextResumeFailure_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextResumeFailure_protocolIEs (UEContextResumeFailure_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextResumeFailure_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextResumeFailure_protocolIEs_element();
