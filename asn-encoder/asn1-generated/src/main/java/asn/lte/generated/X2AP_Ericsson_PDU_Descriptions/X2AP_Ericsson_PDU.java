...
public class X2AP_Ericsson_PDU extends Asn1Choice {
   ...
   public X2AP_Ericsson_PDU () {
      super();
   }

   public X2AP_Ericsson_PDU (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_initiatingMessage (EAB_InitiatingMessage value) {
      setElement (_INITIATINGMESSAGE, value);
   }

   public void set_successfulOutcome (EAB_SuccessfulOutcome value) {
      setElement (_SUCCESSFULOUTCOME, value);
   }

   public void set_unsuccessfulOutcome (EAB_UnsuccessfulOutcome value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (!extbit) {
         ...
         switch (idx) {
            // initiatingMessage
            case 0: { 
               EAB_InitiatingMessage initiatingMessage;
               element = initiatingMessage = new EAB_InitiatingMessage();
            ...
            // successfulOutcome
            case 1: { 
               EAB_SuccessfulOutcome successfulOutcome;
               element = successfulOutcome = new EAB_SuccessfulOutcome();
            ...
            // unsuccessfulOutcome
            case 2: { 
               EAB_UnsuccessfulOutcome unsuccessfulOutcome;
               element = unsuccessfulOutcome = new EAB_UnsuccessfulOutcome();
