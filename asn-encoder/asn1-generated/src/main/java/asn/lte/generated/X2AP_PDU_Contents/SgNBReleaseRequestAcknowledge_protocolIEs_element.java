...
public class SgNBReleaseRequestAcknowledge_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-E-RABs-Admitted-ToBeReleased-SgNBRelReqAckList
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: E-RABs-Admitted-ToBeReleased-SgNBRelReqAckList
    * Java type: E_RABs_Admitted_ToBeReleased_SgNBRelReqAckList
    *
    * id: id-Ericsson-ExtConveyor
    * criticality: Criticality.ignore
    * presence: Presence.optional
    * ASN.1 type: EAB-SgNBReleaseRequestAcknowledge-ExtConveyor
    * Java type: EAB_SgNBReleaseRequestAcknowledge_ExtConveyor
    */
   public Asn1Type value;

   public SgNBReleaseRequestAcknowledge_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBReleaseRequestAcknowledge_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-Admitted-ToBeReleased-SgNBRelReqAckList
    */
   public void setUsing_id_E_RABs_Admitted_ToBeReleased_SgNBRelReqAckList(E_RABs_Admitted_ToBeReleased_SgNBRelReqAckList value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_Admitted_ToBeReleased_SgNBRelReqAckList);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBReleaseRequestAcknowledge_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-Admitted-ToBeReleased-SgNBRelReqAckList
    */
   public E_RABs_Admitted_ToBeReleased_SgNBRelReqAckList getValueFor_id_E_RABs_Admitted_ToBeReleased_SgNBRelReqAckList() {
      return (E_RABs_Admitted_ToBeReleased_SgNBRelReqAckList) this.value;
   }

   /**
    * Get value of value with type set according to information object having key id-Ericsson-ExtConveyor
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBReleaseRequestAcknowledge_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_SgNBReleaseRequestAcknowledge_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SgNBReleaseRequestAcknowledge_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SgNBReleaseRequestAcknowledge_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SgNBReleaseRequestAcknowledge_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      else if (id.value == 318) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-Admitted-ToBeReleased-SgNBRelReqAckList\n");
      }
