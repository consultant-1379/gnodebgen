...
public class CellActivationResponse_protocolIEs extends Asn1SeqOf {
   ...
   public CellActivationResponse_protocolIEs_element[] elements;

   public CellActivationResponse_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellActivationResponse_protocolIEs (int numRecords) {
      elements = new CellActivationResponse_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellActivationResponse_protocolIEs (CellActivationResponse_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellActivationResponse_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellActivationResponse_protocolIEs_element();
