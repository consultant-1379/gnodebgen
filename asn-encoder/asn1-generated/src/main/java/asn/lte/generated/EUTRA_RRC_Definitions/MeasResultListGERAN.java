...
public class MeasResultListGERAN extends Asn1SeqOf {
   ...
   public MeasResultGERAN[] elements;

   public MeasResultListGERAN () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasResultListGERAN (int numRecords) {
      elements = new MeasResultGERAN [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasResultListGERAN (MeasResultGERAN[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasResultGERAN [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasResultGERAN();
