...
public class MeasObjectWLAN_r13_carrierFreq_r13_carrierInfoListWLAN_r13 extends Asn1SeqOf {
   ...
   public WLAN_CarrierInfo_r13[] elements;

   public MeasObjectWLAN_r13_carrierFreq_r13_carrierInfoListWLAN_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasObjectWLAN_r13_carrierFreq_r13_carrierInfoListWLAN_r13 (int numRecords) {
      elements = new WLAN_CarrierInfo_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasObjectWLAN_r13_carrierFreq_r13_carrierInfoListWLAN_r13 (WLAN_CarrierInfo_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WLAN_CarrierInfo_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new WLAN_CarrierInfo_r13();
