...
public class X2RemovalRequest extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "X2RemovalRequest";
   }

   public X2RemovalRequest_protocolIEs protocolIEs;
   public Asn1OpenExt extElem1;

   public X2RemovalRequest () {
      super();
      init();
   }
    ...
    */
   public X2RemovalRequest (
      X2RemovalRequest_protocolIEs protocolIEs_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      protocolIEs = new X2RemovalRequest_protocolIEs();
