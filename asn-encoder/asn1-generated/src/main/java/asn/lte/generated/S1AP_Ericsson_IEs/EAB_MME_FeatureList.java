...
public class EAB_MME_FeatureList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-MME-FeatureList";
   }

   public EAB_MME_FeatureList_element[] elements;

   public EAB_MME_FeatureList () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_MME_FeatureList (int numRecords) {
      elements = new EAB_MME_FeatureList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_MME_FeatureList (EAB_MME_FeatureList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_MME_FeatureList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_MME_FeatureList_element();
