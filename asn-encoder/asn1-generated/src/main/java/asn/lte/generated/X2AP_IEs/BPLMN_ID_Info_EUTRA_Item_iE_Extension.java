...
public class BPLMN_ID_Info_EUTRA_Item_iE_Extension extends Asn1SeqOf {
   ...
   public BPLMN_ID_Info_EUTRA_Item_iE_Extension_element[] elements;

   public BPLMN_ID_Info_EUTRA_Item_iE_Extension () {
      elements = null;
   }
    ...
    * populated.
    */
   public BPLMN_ID_Info_EUTRA_Item_iE_Extension (int numRecords) {
      elements = new BPLMN_ID_Info_EUTRA_Item_iE_Extension_element [numRecords];
   }
    ...
    * given the array.  
    */
   public BPLMN_ID_Info_EUTRA_Item_iE_Extension (BPLMN_ID_Info_EUTRA_Item_iE_Extension_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BPLMN_ID_Info_EUTRA_Item_iE_Extension_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BPLMN_ID_Info_EUTRA_Item_iE_Extension_element();
