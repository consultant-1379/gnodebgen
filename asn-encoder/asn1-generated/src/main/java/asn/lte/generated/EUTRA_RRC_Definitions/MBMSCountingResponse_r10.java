...
public class MBMSCountingResponse_r10 extends Asn1Seq {
   ...
   public MBMSCountingResponse_r10_criticalExtensions criticalExtensions;

   public MBMSCountingResponse_r10 () {
      super();
      init();
   }
    ...
    */
   public MBMSCountingResponse_r10 (
      MBMSCountingResponse_r10_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new MBMSCountingResponse_r10_criticalExtensions();
