...
public class BandCombinationParameters_v1270_bandParameterList_v1270 extends Asn1SeqOf {
   ...
   public BandParameters_v1270[] elements;

   public BandCombinationParameters_v1270_bandParameterList_v1270 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_v1270_bandParameterList_v1270 (int numRecords) {
      elements = new BandParameters_v1270 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_v1270_bandParameterList_v1270 (BandParameters_v1270[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_v1270 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_v1270();
