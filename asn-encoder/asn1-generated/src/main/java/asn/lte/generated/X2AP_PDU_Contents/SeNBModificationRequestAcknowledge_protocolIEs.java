...
public class SeNBModificationRequestAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBModificationRequestAcknowledge_protocolIEs_element[] elements;

   public SeNBModificationRequestAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBModificationRequestAcknowledge_protocolIEs (int numRecords) {
      elements = new SeNBModificationRequestAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBModificationRequestAcknowledge_protocolIEs (SeNBModificationRequestAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBModificationRequestAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBModificationRequestAcknowledge_protocolIEs_element();
