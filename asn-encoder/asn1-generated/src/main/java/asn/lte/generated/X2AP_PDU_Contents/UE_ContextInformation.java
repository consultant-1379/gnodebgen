...
public class UE_ContextInformation extends Asn1Seq {
   ...
   public E_RABs_ToBeSetup_List e_RABs_ToBeSetup_List;
   ...
   public UE_ContextInformation_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public UE_ContextInformation () {
      super();
      init();
   }
   ...
   public UE_ContextInformation (
      ...
      E_RABs_ToBeSetup_List e_RABs_ToBeSetup_List_,
      ...
      UE_ContextInformation_iE_Extensions iE_Extensions_
   ) {
      super();
    ...
    * the given objects 
    */
   public UE_ContextInformation (long mME_UE_S1AP_ID_,
      UESecurityCapabilities uESecurityCapabilities_,
      AS_SecurityInformation aS_SecurityInformation_,
      UEAggregateMaximumBitRate uEaggregateMaximumBitRate_,
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 3: return "uEaggregateMaximumBitRate";
         case 4: return "subscriberProfileIDforRFP";
         case 5: return "e-RABs-ToBeSetup-List";
         case 6: return "rRC-Context";
         case 7: return "handoverRestrictionList";
         case 8: return "locationReportingInformation";
         case 9: return "iE-Extensions";
         case 10: return null;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      // decode e_RABs_ToBeSetup_List

      buffer.getContext().eventDispatcher.startElement("e_RABs_ToBeSetup_List", -1);

      e_RABs_ToBeSetup_List = new E_RABs_ToBeSetup_List();
      e_RABs_ToBeSetup_List.decode (buffer);
      buffer.getContext().eventDispatcher.endElement("e_RABs_ToBeSetup_List", -1);
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new UE_ContextInformation_iE_Extensions();
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (e_RABs_ToBeSetup_List != null) e_RABs_ToBeSetup_List.print (_sb, "e_RABs_ToBeSetup_List", _level+1);
