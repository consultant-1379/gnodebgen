...
public class CompletedCellinTAI_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public CompletedCellinTAI_Item_iE_Extensions_element[] elements;

   public CompletedCellinTAI_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CompletedCellinTAI_Item_iE_Extensions (int numRecords) {
      elements = new CompletedCellinTAI_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CompletedCellinTAI_Item_iE_Extensions (CompletedCellinTAI_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CompletedCellinTAI_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CompletedCellinTAI_Item_iE_Extensions_element();
