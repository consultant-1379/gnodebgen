...
public class SupportedBandCombination_v1320 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandCombination-v1320";
   }

   public BandCombinationParameters_v1320[] elements;

   public SupportedBandCombination_v1320 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandCombination_v1320 (int numRecords) {
    ...
    * given the array.  
    */
   public SupportedBandCombination_v1320 (BandCombinationParameters_v1320[] elements_) {
      elements = elements_;
   }
