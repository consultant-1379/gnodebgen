...
public class SCGFailureInformationNR_r15 extends Asn1Seq {
   ...
   public SCGFailureInformationNR_r15_criticalExtensions criticalExtensions;

   public SCGFailureInformationNR_r15 () {
      super();
      init();
   }
    ...
    */
   public SCGFailureInformationNR_r15 (
      SCGFailureInformationNR_r15_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new SCGFailureInformationNR_r15_criticalExtensions();
