...
public class SupportedBandListEUTRA_v1250 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SupportedBandListEUTRA-v1250";
   }

   public SupportedBandEUTRA_v1250[] elements;

   public SupportedBandListEUTRA_v1250 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandListEUTRA_v1250 (int numRecords) {
      elements = new SupportedBandEUTRA_v1250 [numRecords];
   }
    ...
    * given the array.  
    */
   public SupportedBandListEUTRA_v1250 (SupportedBandEUTRA_v1250[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedBandEUTRA_v1250 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedBandEUTRA_v1250();
