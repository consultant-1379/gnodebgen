...
public class SPS_ConfigUL_ToAddModList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPS-ConfigUL-ToAddModList-r15";
   }

   public SPS_ConfigUL[] elements;

   public SPS_ConfigUL_ToAddModList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPS_ConfigUL_ToAddModList_r15 (int numRecords) {
      elements = new SPS_ConfigUL [numRecords];
   }
    ...
    * given the array.  
    */
   public SPS_ConfigUL_ToAddModList_r15 (SPS_ConfigUL[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SPS_ConfigUL [numElements];
