...
public class CellToReport_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public CellToReport_Item_iE_Extensions_element[] elements;

   public CellToReport_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellToReport_Item_iE_Extensions (int numRecords) {
      elements = new CellToReport_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellToReport_Item_iE_Extensions (CellToReport_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellToReport_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellToReport_Item_iE_Extensions_element();
