...
public class MBMSInterestIndication_r11 extends Asn1Seq {
   ...
   public MBMSInterestIndication_r11_criticalExtensions criticalExtensions;

   public MBMSInterestIndication_r11 () {
      super();
      init();
   }
    ...
    */
   public MBMSInterestIndication_r11 (
      MBMSInterestIndication_r11_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new MBMSInterestIndication_r11_criticalExtensions();
