...
public class ENDCConfigurationUpdate_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-InitiatingNodeType-EndcConfigUpdate
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: InitiatingNodeType-EndcConfigUpdate
    * Java type: InitiatingNodeType_EndcConfigUpdate
    *
    ...
    * presence: Presence.optional
    * ASN.1 type: EAB-ENDCConfigurationUpdate-ExtConveyor
    * Java type: EAB_ENDCConfigurationUpdate_ExtConveyor
    */
   public Asn1Type value;

   public ENDCConfigurationUpdate_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public ENDCConfigurationUpdate_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-InitiatingNodeType-EndcConfigUpdate
    */
   public void setUsing_id_InitiatingNodeType_EndcConfigUpdate(InitiatingNodeType_EndcConfigUpdate value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_InitiatingNodeType_EndcConfigUpdate);
    ...
    */
   public void setUsing_id_Ericsson_ExtConveyor(asn.lte.generated.X2AP_Ericsson_IEs.EAB_ENDCConfigurationUpdate_ExtConveyor value) {
   ...
   /**
    * Get value of value with type set according to information object having key id-InitiatingNodeType-EndcConfigUpdate
    */
   public InitiatingNodeType_EndcConfigUpdate getValueFor_id_InitiatingNodeType_EndcConfigUpdate() {
      return (InitiatingNodeType_EndcConfigUpdate) this.value;
   }
    ...
    */
   public asn.lte.generated.X2AP_Ericsson_IEs.EAB_ENDCConfigurationUpdate_ExtConveyor getValueFor_id_Ericsson_ExtConveyor() {
      return (asn.lte.generated.X2AP_Ericsson_IEs.EAB_ENDCConfigurationUpdate_ExtConveyor) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.ENDCConfigurationUpdate_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.ENDCConfigurationUpdate_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.ENDCConfigurationUpdate_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 245) {
         indent (_sb, _level+1);
         _sb.append("id = id-InitiatingNodeType-EndcConfigUpdate\n");
      }
