...
public class AssociatedCellList extends Asn1SeqOf {
   ...
   public AssociatedCell_Item[] elements;

   public AssociatedCellList () {
      elements = null;
   }
    ...
    * populated.
    */
   public AssociatedCellList (int numRecords) {
      elements = new AssociatedCell_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public AssociatedCellList (AssociatedCell_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AssociatedCell_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AssociatedCell_Item();
