...
public class SRS_Config_srs_ResourceToAddModList extends Asn1SeqOf {
   ...
   public SRS_Resource[] elements;

   public SRS_Config_srs_ResourceToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SRS_Config_srs_ResourceToAddModList (int numRecords) {
      elements = new SRS_Resource [numRecords];
   }
    ...
    * given the array.  
    */
   public SRS_Config_srs_ResourceToAddModList (SRS_Resource[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SRS_Resource [numElements];
