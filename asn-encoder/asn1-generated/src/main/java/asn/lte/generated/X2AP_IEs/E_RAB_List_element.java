...
public class E_RAB_List_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RAB-Item
    * Java type: E_RAB_Item
    */
   public Asn1Type value;

   public E_RAB_List_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RAB_List_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RAB-Item
    */
   public void setUsing_id_E_RAB_Item(E_RAB_Item value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RAB_Item);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RAB-Item
    */
   public E_RAB_Item getValueFor_id_E_RAB_Item() {
      return (E_RAB_Item) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.E_RAB_ItemIEs.length; i++) {
         if(_X2AP_IEsValues.E_RAB_ItemIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.E_RAB_ItemIEs[i];
            break;
         }
      }
      if (null == _index) {
