...
public class TargetNgRanNode_ID_iE_Extensions extends Asn1SeqOf {
   ...
   public TargetNgRanNode_ID_iE_Extensions_element[] elements;

   public TargetNgRanNode_ID_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public TargetNgRanNode_ID_iE_Extensions (int numRecords) {
      elements = new TargetNgRanNode_ID_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TargetNgRanNode_ID_iE_Extensions (TargetNgRanNode_ID_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TargetNgRanNode_ID_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TargetNgRanNode_ID_iE_Extensions_element();
