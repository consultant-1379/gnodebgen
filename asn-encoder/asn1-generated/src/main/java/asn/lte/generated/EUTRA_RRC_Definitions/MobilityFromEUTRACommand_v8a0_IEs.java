...
public class MobilityFromEUTRACommand_v8a0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "MobilityFromEUTRACommand-v8a0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public MobilityFromEUTRACommand_v8d0_IEs nonCriticalExtension;  // optional

   public MobilityFromEUTRACommand_v8a0_IEs () {
      super();
      init();
   }
   ...
   public MobilityFromEUTRACommand_v8a0_IEs (
      ...
      MobilityFromEUTRACommand_v8d0_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public MobilityFromEUTRACommand_v8a0_IEs (byte[] lateNonCriticalExtension_,
      MobilityFromEUTRACommand_v8d0_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new MobilityFromEUTRACommand_v8d0_IEs();
