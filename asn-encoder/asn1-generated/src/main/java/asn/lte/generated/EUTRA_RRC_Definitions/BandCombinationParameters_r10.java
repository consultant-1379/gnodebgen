...
public class BandCombinationParameters_r10 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandCombinationParameters-r10";
   }

   public BandParameters_r10[] elements;

   public BandCombinationParameters_r10 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_r10 (int numRecords) {
      elements = new BandParameters_r10 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_r10 (BandParameters_r10[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_r10 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_r10();
