...
public class UERadioCapabilityMatchRequest_protocolIEs extends Asn1SeqOf {
   ...
   public UERadioCapabilityMatchRequest_protocolIEs_element[] elements;

   public UERadioCapabilityMatchRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UERadioCapabilityMatchRequest_protocolIEs (int numRecords) {
      elements = new UERadioCapabilityMatchRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UERadioCapabilityMatchRequest_protocolIEs (UERadioCapabilityMatchRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UERadioCapabilityMatchRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UERadioCapabilityMatchRequest_protocolIEs_element();
