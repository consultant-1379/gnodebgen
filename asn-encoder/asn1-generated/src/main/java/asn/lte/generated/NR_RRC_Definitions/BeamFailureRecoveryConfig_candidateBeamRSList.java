...
public class BeamFailureRecoveryConfig_candidateBeamRSList extends Asn1SeqOf {
   ...
   public BeamFailureRecoveryConfig_candidateBeamRSList () {
      elements = null;
   }
    ...
    * populated.
    */
   public BeamFailureRecoveryConfig_candidateBeamRSList (int numRecords) {
    ...
    * given the array.  
    */
   public BeamFailureRecoveryConfig_candidateBeamRSList (PRACH_ResourceDedicatedBFR[] elements_) {
      elements = elements_;
   }
