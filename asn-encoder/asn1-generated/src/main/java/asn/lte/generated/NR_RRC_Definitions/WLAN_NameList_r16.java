...
public class WLAN_NameList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "WLAN-NameList-r16";
   }

   public WLAN_Name_r16[] elements;

   public WLAN_NameList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public WLAN_NameList_r16 (int numRecords) {
      elements = new WLAN_Name_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public WLAN_NameList_r16 (WLAN_Name_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WLAN_Name_r16 [numElements];
