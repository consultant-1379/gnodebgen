...
public class CSG_IdList_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public CSG_IdList_Item_iE_Extensions_element[] elements;

   public CSG_IdList_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CSG_IdList_Item_iE_Extensions (int numRecords) {
      elements = new CSG_IdList_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CSG_IdList_Item_iE_Extensions (CSG_IdList_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CSG_IdList_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CSG_IdList_Item_iE_Extensions_element();
