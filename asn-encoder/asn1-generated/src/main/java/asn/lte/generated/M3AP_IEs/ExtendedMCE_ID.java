...
public class ExtendedMCE_ID extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "ExtendedMCE-ID";
   }

   public ExtendedMCE_ID () {
      super();
   }
    ...
    *              in binary form.
    */
   public ExtendedMCE_ID (byte[] data) {
      super (data);
   }
    ...
    */
   public ExtendedMCE_ID (byte[] data, int offset, int nbytes) {
    ...
    */
   public ExtendedMCE_ID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
