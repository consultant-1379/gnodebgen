...
public class RecommendedCellList extends Asn1SeqOf {
   ...
   public RecommendedCellList_element[] elements;

   public RecommendedCellList () {
      elements = null;
   }
    ...
    * populated.
    */
   public RecommendedCellList (int numRecords) {
      elements = new RecommendedCellList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public RecommendedCellList (RecommendedCellList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new RecommendedCellList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new RecommendedCellList_element();
