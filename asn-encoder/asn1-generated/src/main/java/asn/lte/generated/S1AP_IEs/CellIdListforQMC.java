...
public class CellIdListforQMC extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellIdListforQMC";
   }

   public EUTRAN_CGI[] elements;

   public CellIdListforQMC () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellIdListforQMC (int numRecords) {
    ...
    * given the array.  
    */
   public CellIdListforQMC (EUTRAN_CGI[] elements_) {
      elements = elements_;
   }
