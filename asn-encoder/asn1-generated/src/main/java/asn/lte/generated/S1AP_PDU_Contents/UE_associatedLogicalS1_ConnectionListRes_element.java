...
public class UE_associatedLogicalS1_ConnectionListRes_element extends Asn1Seq {
   ...
   public UE_associatedLogicalS1_ConnectionListRes_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UE_associatedLogicalS1_ConnectionListRes_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.UE_associatedLogicalS1_ConnectionItemRes.length; i++) {
         if(_S1AP_PDU_ContentsValues.UE_associatedLogicalS1_ConnectionItemRes[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.UE_associatedLogicalS1_ConnectionItemRes[i];
            break;
         }
      }
      if (null == _index) {
