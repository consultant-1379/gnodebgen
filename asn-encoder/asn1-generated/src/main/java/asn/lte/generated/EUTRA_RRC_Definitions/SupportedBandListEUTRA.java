...
public class SupportedBandListEUTRA extends Asn1SeqOf {
   ...
   public SupportedBandEUTRA[] elements;

   public SupportedBandListEUTRA () {
      elements = null;
   }
    ...
    * populated.
    */
   public SupportedBandListEUTRA (int numRecords) {
    ...
    * given the array.  
    */
   public SupportedBandListEUTRA (SupportedBandEUTRA[] elements_) {
      elements = elements_;
   }
