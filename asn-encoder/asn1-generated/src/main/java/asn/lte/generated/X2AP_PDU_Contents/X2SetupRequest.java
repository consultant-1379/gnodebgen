...
public class X2SetupRequest extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "X2SetupRequest";
   }

   public X2SetupRequest_protocolIEs protocolIEs;
   public Asn1OpenExt extElem1;

   public X2SetupRequest () {
      super();
      init();
   }
    ...
    */
   public X2SetupRequest (
      X2SetupRequest_protocolIEs protocolIEs_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      protocolIEs = new X2SetupRequest_protocolIEs();
