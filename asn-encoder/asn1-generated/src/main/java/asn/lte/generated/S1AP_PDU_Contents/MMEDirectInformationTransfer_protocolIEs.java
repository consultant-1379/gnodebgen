...
public class MMEDirectInformationTransfer_protocolIEs extends Asn1SeqOf {
   ...
   public MMEDirectInformationTransfer_protocolIEs_element[] elements;

   public MMEDirectInformationTransfer_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public MMEDirectInformationTransfer_protocolIEs (int numRecords) {
      elements = new MMEDirectInformationTransfer_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MMEDirectInformationTransfer_protocolIEs (MMEDirectInformationTransfer_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MMEDirectInformationTransfer_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MMEDirectInformationTransfer_protocolIEs_element();
