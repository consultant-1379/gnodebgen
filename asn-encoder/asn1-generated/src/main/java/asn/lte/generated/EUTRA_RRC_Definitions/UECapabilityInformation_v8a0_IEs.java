...
public class UECapabilityInformation_v8a0_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UECapabilityInformation-v8a0-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public UECapabilityInformation_v1250_IEs nonCriticalExtension;  // optional

   public UECapabilityInformation_v8a0_IEs () {
      super();
      init();
   }
   ...
   public UECapabilityInformation_v8a0_IEs (
      ...
      UECapabilityInformation_v1250_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public UECapabilityInformation_v8a0_IEs (byte[] lateNonCriticalExtension_,
      UECapabilityInformation_v1250_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new UECapabilityInformation_v1250_IEs();
