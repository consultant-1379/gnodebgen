...
public class CellInformation_List_element extends Asn1Seq {
   ...
   /**
    * id: id-CellInformation-Item
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: CellInformation-Item
    * Java type: CellInformation_Item
    */
   public Asn1Type value;

   public CellInformation_List_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public CellInformation_List_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-CellInformation-Item
    */
   public void setUsing_id_CellInformation_Item(CellInformation_Item value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_CellInformation_Item);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-CellInformation-Item
    */
   public CellInformation_Item getValueFor_id_CellInformation_Item() {
      return (CellInformation_Item) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.CellInformation_ItemIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.CellInformation_ItemIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.CellInformation_ItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 7) {
         indent (_sb, _level+1);
         _sb.append("id = id-CellInformation-Item\n");
      }
