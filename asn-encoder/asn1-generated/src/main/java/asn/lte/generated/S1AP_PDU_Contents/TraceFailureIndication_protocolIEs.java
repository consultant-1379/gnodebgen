...
public class TraceFailureIndication_protocolIEs extends Asn1SeqOf {
   ...
   public TraceFailureIndication_protocolIEs_element[] elements;

   public TraceFailureIndication_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public TraceFailureIndication_protocolIEs (int numRecords) {
      elements = new TraceFailureIndication_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public TraceFailureIndication_protocolIEs (TraceFailureIndication_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new TraceFailureIndication_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new TraceFailureIndication_protocolIEs_element();
