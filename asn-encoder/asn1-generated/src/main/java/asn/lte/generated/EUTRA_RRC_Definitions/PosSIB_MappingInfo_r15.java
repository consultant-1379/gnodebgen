...
public class PosSIB_MappingInfo_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PosSIB-MappingInfo-r15";
   }

   public PosSIB_Type_r15[] elements;

   public PosSIB_MappingInfo_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public PosSIB_MappingInfo_r15 (int numRecords) {
      elements = new PosSIB_Type_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public PosSIB_MappingInfo_r15 (PosSIB_Type_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PosSIB_Type_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PosSIB_Type_r15();
