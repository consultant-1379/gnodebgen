...
public class UEIdentityIndexValue extends Asn1BitString {
    ...
    */
   public UEIdentityIndexValue (byte[] data) {
    ...
    * @param data       Binary bit string contents
    */
   public UEIdentityIndexValue (int numbits_, byte[] data) {
      super (numbits_, data);
   }
    ...
    */
   public UEIdentityIndexValue (boolean[] bitValues) {
      super (bitValues);
   }
    ...
    *
    */
   public UEIdentityIndexValue (String value_) throws Asn1ValueParseException {
      super (value_);
   }
    ...
    */
   public UEIdentityIndexValue (java.util.BitSet bitSet) {
      super (bitSet);
   }
