...
public class UEContextReleaseRequest_protocolIEs_element extends Asn1Seq {
    ...
    * ASN.1 type: GWContextReleaseIndication
    * Java type: GWContextReleaseIndication
    *
   ...
   public UEContextReleaseRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public UEContextReleaseRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-GWContextReleaseIndication
    */
   public void setUsing_id_GWContextReleaseIndication(asn.lte.generated.S1AP_IEs.GWContextReleaseIndication value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_GWContextReleaseIndication);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-GWContextReleaseIndication
    */
   public asn.lte.generated.S1AP_IEs.GWContextReleaseIndication getValueFor_id_GWContextReleaseIndication() {
      return (asn.lte.generated.S1AP_IEs.GWContextReleaseIndication) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.UEContextReleaseRequest_IEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.UEContextReleaseRequest_IEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.UEContextReleaseRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 0) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-GWContextReleaseIndication\n");
      }
