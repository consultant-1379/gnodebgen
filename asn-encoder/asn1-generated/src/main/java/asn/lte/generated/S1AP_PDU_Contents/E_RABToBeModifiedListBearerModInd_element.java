...
public class E_RABToBeModifiedListBearerModInd_element extends Asn1Seq {
    ...
    * ASN.1 type: E-RABToBeModifiedItemBearerModInd
    * Java type: E_RABToBeModifiedItemBearerModInd
    */
   public Asn1Type value;

   public E_RABToBeModifiedListBearerModInd_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public E_RABToBeModifiedListBearerModInd_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABToBeModifiedItemBearerModInd
    */
   public void setUsing_id_E_RABToBeModifiedItemBearerModInd(E_RABToBeModifiedItemBearerModInd value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_E_RABToBeModifiedItemBearerModInd);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-E-RABToBeModifiedItemBearerModInd
    */
   public E_RABToBeModifiedItemBearerModInd getValueFor_id_E_RABToBeModifiedItemBearerModInd() {
      return (E_RABToBeModifiedItemBearerModInd) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_PDU_ContentsValues.E_RABToBeModifiedItemBearerModIndIEs.length; i++) {
         if(_S1AP_PDU_ContentsValues.E_RABToBeModifiedItemBearerModIndIEs[i].id.equals(id)) {
            _index = _S1AP_PDU_ContentsValues.E_RABToBeModifiedItemBearerModIndIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 200) {
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABToBeModifiedItemBearerModInd\n");
      }
