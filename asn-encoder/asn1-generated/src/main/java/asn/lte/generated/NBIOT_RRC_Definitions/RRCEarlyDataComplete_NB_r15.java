...
public class RRCEarlyDataComplete_NB_r15 extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCEarlyDataComplete-NB-r15";
   }

   public RRCEarlyDataComplete_NB_r15_criticalExtensions criticalExtensions;

   public RRCEarlyDataComplete_NB_r15 () {
      super();
      init();
   }
    ...
    */
   public RRCEarlyDataComplete_NB_r15 (
      RRCEarlyDataComplete_NB_r15_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCEarlyDataComplete_NB_r15_criticalExtensions();
