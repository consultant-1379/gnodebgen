...
public class EAB_LAA_ServedCells_ToMod_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EAB-LAA-ServedCells-ToMod-List";
   }

   public EAB_LAA_ServedCellToMod_Item[] elements;

   public EAB_LAA_ServedCells_ToMod_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public EAB_LAA_ServedCells_ToMod_List (int numRecords) {
      elements = new EAB_LAA_ServedCellToMod_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public EAB_LAA_ServedCells_ToMod_List (EAB_LAA_ServedCellToMod_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new EAB_LAA_ServedCellToMod_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new EAB_LAA_ServedCellToMod_Item();
