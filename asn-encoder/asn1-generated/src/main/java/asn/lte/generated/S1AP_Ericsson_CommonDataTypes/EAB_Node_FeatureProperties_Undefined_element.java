...
public class EAB_Node_FeatureProperties_Undefined_element extends Asn1Seq {
   ...
   public EAB_Node_FeatureProperties_Undefined_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_Node_FeatureProperties_Undefined_element (long id_,
      EAB_CriticalityIgnore criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   {
      /* check id */
      asn.lte.generated.S1AP_Ericsson_Containers.EAB_S1AP_PROPERTY_IES _index = null;
      for(int i=0; i < _S1AP_Ericsson_CommonDataTypesValues.EAB_Node_FeatureProperties_Undefined_IEs.length; i++) {
         if(_S1AP_Ericsson_CommonDataTypesValues.EAB_Node_FeatureProperties_Undefined_IEs[i].id.equals(id)) {
            _index = _S1AP_Ericsson_CommonDataTypesValues.EAB_Node_FeatureProperties_Undefined_IEs[i];
            break;
         }
      }
      if (null == _index) {
