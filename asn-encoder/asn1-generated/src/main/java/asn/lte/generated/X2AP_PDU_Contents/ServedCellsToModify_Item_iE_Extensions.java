...
public class ServedCellsToModify_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public ServedCellsToModify_Item_iE_Extensions_element[] elements;

   public ServedCellsToModify_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedCellsToModify_Item_iE_Extensions (int numRecords) {
      elements = new ServedCellsToModify_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedCellsToModify_Item_iE_Extensions (ServedCellsToModify_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedCellsToModify_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedCellsToModify_Item_iE_Extensions_element();
