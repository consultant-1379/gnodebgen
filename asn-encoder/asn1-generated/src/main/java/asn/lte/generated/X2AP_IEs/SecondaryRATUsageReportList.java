...
public class SecondaryRATUsageReportList extends Asn1SeqOf {
   ...
   public SecondaryRATUsageReportList_element[] elements;

   public SecondaryRATUsageReportList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SecondaryRATUsageReportList (int numRecords) {
      elements = new SecondaryRATUsageReportList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SecondaryRATUsageReportList (SecondaryRATUsageReportList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SecondaryRATUsageReportList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SecondaryRATUsageReportList_element();
