...
public class SSB_PositionQCL_CellsToAddModList_r16 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SSB-PositionQCL-CellsToAddModList-r16";
   }

   public SSB_PositionQCL_CellsToAddMod_r16[] elements;

   public SSB_PositionQCL_CellsToAddModList_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SSB_PositionQCL_CellsToAddModList_r16 (int numRecords) {
      elements = new SSB_PositionQCL_CellsToAddMod_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public SSB_PositionQCL_CellsToAddModList_r16 (SSB_PositionQCL_CellsToAddMod_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SSB_PositionQCL_CellsToAddMod_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SSB_PositionQCL_CellsToAddMod_r16();
