...
public class SgNBtoMeNBContainer extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "SgNBtoMeNBContainer";
   }

   public SgNBtoMeNBContainer () {
      super();
   }
    ...
    *              in binary form.
    */
   public SgNBtoMeNBContainer (byte[] data) {
      super (data);
   }
    ...
    */
   public SgNBtoMeNBContainer (byte[] data, int offset, int nbytes) {
    ...
    */
   public SgNBtoMeNBContainer (String value_) throws Asn1ValueParseException {
      super (value_);
   }
