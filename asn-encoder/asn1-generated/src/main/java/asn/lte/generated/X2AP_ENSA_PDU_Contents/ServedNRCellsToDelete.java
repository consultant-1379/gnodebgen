...
public class ServedNRCellsToDelete extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ServedNRCellsToDelete";
   }

   public ServedNRCellsToDelete_Item[] elements;

   public ServedNRCellsToDelete () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedNRCellsToDelete (int numRecords) {
      elements = new ServedNRCellsToDelete_Item [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedNRCellsToDelete (ServedNRCellsToDelete_Item[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedNRCellsToDelete_Item [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedNRCellsToDelete_Item();
