...
public class CellMeasurementResult_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public CellMeasurementResult_Item_iE_Extensions_element[] elements;

   public CellMeasurementResult_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellMeasurementResult_Item_iE_Extensions (int numRecords) {
      elements = new CellMeasurementResult_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellMeasurementResult_Item_iE_Extensions (CellMeasurementResult_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellMeasurementResult_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellMeasurementResult_Item_iE_Extensions_element();
