...
public class SSB_MTC2_pci_List extends Asn1SeqOf {
    ...
    * populated.
    */
   public SSB_MTC2_pci_List (int numRecords) {
    ...
    * given the array.  
    */
   public SSB_MTC2_pci_List (PhysCellId[] elements_) {
      elements = elements_;
   }
