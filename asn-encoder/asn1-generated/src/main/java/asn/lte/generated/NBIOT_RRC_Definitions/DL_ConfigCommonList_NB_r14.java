...
public class DL_ConfigCommonList_NB_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "DL-ConfigCommonList-NB-r14";
   }

   public DL_ConfigCommon_NB_r14[] elements;

   public DL_ConfigCommonList_NB_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public DL_ConfigCommonList_NB_r14 (int numRecords) {
      elements = new DL_ConfigCommon_NB_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public DL_ConfigCommonList_NB_r14 (DL_ConfigCommon_NB_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new DL_ConfigCommon_NB_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new DL_ConfigCommon_NB_r14();
