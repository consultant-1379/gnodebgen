...
public class EAB_SgNBAdditionRequest_ExtConveyor_protocolIEs_element extends Asn1Seq {
   ...
   public EAB_SgNBAdditionRequest_ExtConveyor_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_SgNBAdditionRequest_ExtConveyor_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_SgNBAdditionRequest_IEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_SgNBAdditionRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_SgNBAdditionRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
