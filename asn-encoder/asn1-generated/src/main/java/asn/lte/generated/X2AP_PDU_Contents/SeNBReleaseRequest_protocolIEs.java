...
public class SeNBReleaseRequest_protocolIEs extends Asn1SeqOf {
   ...
   public SeNBReleaseRequest_protocolIEs_element[] elements;

   public SeNBReleaseRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SeNBReleaseRequest_protocolIEs (int numRecords) {
      elements = new SeNBReleaseRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SeNBReleaseRequest_protocolIEs (SeNBReleaseRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SeNBReleaseRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SeNBReleaseRequest_protocolIEs_element();
