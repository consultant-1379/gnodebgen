...
public class FDD_InfoNeighbourServedNRCell_Information extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "FDD-InfoNeighbourServedNRCell-Information";
   }

   public NRFreqInfo ul_NRFreqInfo;
   public NRFreqInfo dl_NRFreqInfo;
   public FDD_InfoNeighbourServedNRCell_Information_iE_Extensions iE_Extensions;  // optional
   public Asn1OpenExt extElem1;

   public FDD_InfoNeighbourServedNRCell_Information () {
      super();
      init();
   }
   ...
   public FDD_InfoNeighbourServedNRCell_Information (
      ...
      FDD_InfoNeighbourServedNRCell_Information_iE_Extensions iE_Extensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (iE_ExtensionsPresent) {
         ...
         iE_Extensions = new FDD_InfoNeighbourServedNRCell_Information_iE_Extensions();
