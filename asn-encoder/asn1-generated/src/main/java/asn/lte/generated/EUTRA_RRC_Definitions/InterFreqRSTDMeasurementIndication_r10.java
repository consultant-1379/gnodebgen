...
public class InterFreqRSTDMeasurementIndication_r10 extends Asn1Seq {
   ...
   public InterFreqRSTDMeasurementIndication_r10_criticalExtensions criticalExtensions;

   public InterFreqRSTDMeasurementIndication_r10 () {
      super();
      init();
   }
    ...
    */
   public InterFreqRSTDMeasurementIndication_r10 (
      InterFreqRSTDMeasurementIndication_r10_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new InterFreqRSTDMeasurementIndication_r10_criticalExtensions();
