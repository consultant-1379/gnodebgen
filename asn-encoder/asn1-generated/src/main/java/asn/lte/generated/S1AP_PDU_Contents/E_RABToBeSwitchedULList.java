...
public class E_RABToBeSwitchedULList extends Asn1SeqOf {
   ...
   public E_RABToBeSwitchedULList_element[] elements;

   public E_RABToBeSwitchedULList () {
      elements = null;
   }
    ...
    * populated.
    */
   public E_RABToBeSwitchedULList (int numRecords) {
      elements = new E_RABToBeSwitchedULList_element [numRecords];
   }
    ...
    * given the array.  
    */
   public E_RABToBeSwitchedULList (E_RABToBeSwitchedULList_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new E_RABToBeSwitchedULList_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new E_RABToBeSwitchedULList_element();
