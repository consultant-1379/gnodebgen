...
public class MeasConfig_speedStatePars extends Asn1Choice {
   ...
   public MeasConfig_speedStatePars () {
      super();
   }

   public MeasConfig_speedStatePars (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_setup (MeasConfig_speedStatePars_setup value) {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         // setup
         case 1: { 
            MeasConfig_speedStatePars_setup setup;
            element = setup = new MeasConfig_speedStatePars_setup();
            setup.decode (buffer);
            break;
         }
