...
public class InterFreqBlackCellList extends Asn1SeqOf {
    ...
    * populated.
    */
   public InterFreqBlackCellList (int numRecords) {
    ...
    * given the array.  
    */
   public InterFreqBlackCellList (PhysCellIdRange[] elements_) {
      elements = elements_;
   }
