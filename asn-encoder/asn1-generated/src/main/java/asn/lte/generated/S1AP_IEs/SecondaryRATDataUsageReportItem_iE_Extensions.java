...
public class SecondaryRATDataUsageReportItem_iE_Extensions extends Asn1SeqOf {
   ...
   public SecondaryRATDataUsageReportItem_iE_Extensions_element[] elements;

   public SecondaryRATDataUsageReportItem_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SecondaryRATDataUsageReportItem_iE_Extensions (int numRecords) {
      elements = new SecondaryRATDataUsageReportItem_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SecondaryRATDataUsageReportItem_iE_Extensions (SecondaryRATDataUsageReportItem_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SecondaryRATDataUsageReportItem_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SecondaryRATDataUsageReportItem_iE_Extensions_element();
