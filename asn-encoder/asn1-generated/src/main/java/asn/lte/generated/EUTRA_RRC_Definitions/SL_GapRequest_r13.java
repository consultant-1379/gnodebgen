...
public class SL_GapRequest_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-GapRequest-r13";
   }

   public SL_GapFreqInfo_r13[] elements;

   public SL_GapRequest_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_GapRequest_r13 (int numRecords) {
      elements = new SL_GapFreqInfo_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SL_GapRequest_r13 (SL_GapFreqInfo_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SL_GapFreqInfo_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_GapFreqInfo_r13();
