...
public class EAB_PPEResourceList_element extends Asn1Seq {
   ...
   /**
    * id: eid-CurrentPPEResources
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: EAB-CurrentPPEResources
    * Java type: EAB_CurrentPPEResources
    */
   public Asn1Type value;

   public EAB_PPEResourceList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EAB_PPEResourceList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key eid-CurrentPPEResources
    */
   public void setUsing_eid_CurrentPPEResources(EAB_CurrentPPEResources value) {
      this.id = new asn.lte.generated.X2AP_Ericsson_CommonDataTypes.EAB_ProtocolIE_ID(asn.lte.generated.X2AP_Ericsson_Constants._X2AP_Ericsson_ConstantsValues.eid_CurrentPPEResources);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key eid-CurrentPPEResources
    */
   public EAB_CurrentPPEResources getValueFor_eid_CurrentPPEResources() {
      return (EAB_CurrentPPEResources) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_Ericsson_IEsValues.EAB_CurrentPPEResourcesIEs.length; i++) {
         if(_X2AP_Ericsson_IEsValues.EAB_CurrentPPEResourcesIEs[i].id.equals(id)) {
            _index = _X2AP_Ericsson_IEsValues.EAB_CurrentPPEResourcesIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 4155) {
         indent (_sb, _level+1);
         _sb.append("id = eid-CurrentPPEResources\n");
      }
