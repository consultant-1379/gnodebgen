...
public class TBCD_STRING extends Asn1OctetString {
    ...
    */
   public TBCD_STRING (byte[] data, int offset, int nbytes) {
    ...
    */
   public TBCD_STRING (String value_) throws Asn1ValueParseException {
      super (value_);
   }
