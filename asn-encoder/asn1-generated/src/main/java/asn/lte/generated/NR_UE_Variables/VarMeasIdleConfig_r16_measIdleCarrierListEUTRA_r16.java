...
import asn.lte.generated.NR_RRC_Definitions.MeasIdleCarrierEUTRA_r16;

public class VarMeasIdleConfig_r16_measIdleCarrierListEUTRA_r16 extends Asn1SeqOf {
   ...
   public MeasIdleCarrierEUTRA_r16[] elements;

   public VarMeasIdleConfig_r16_measIdleCarrierListEUTRA_r16 () {
      elements = null;
   }
    ...
    * populated.
    */
   public VarMeasIdleConfig_r16_measIdleCarrierListEUTRA_r16 (int numRecords) {
      elements = new MeasIdleCarrierEUTRA_r16 [numRecords];
   }
    ...
    * given the array.  
    */
   public VarMeasIdleConfig_r16_measIdleCarrierListEUTRA_r16 (MeasIdleCarrierEUTRA_r16[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasIdleCarrierEUTRA_r16 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasIdleCarrierEUTRA_r16();
