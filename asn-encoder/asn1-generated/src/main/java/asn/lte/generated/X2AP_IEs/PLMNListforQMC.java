...
public class PLMNListforQMC extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "PLMNListforQMC";
   }

   public PLMN_Identity[] elements;

   public PLMNListforQMC () {
      elements = null;
   }
    ...
    * populated.
    */
   public PLMNListforQMC (int numRecords) {
    ...
    * given the array.  
    */
   public PLMNListforQMC (PLMN_Identity[] elements_) {
      elements = elements_;
   }
