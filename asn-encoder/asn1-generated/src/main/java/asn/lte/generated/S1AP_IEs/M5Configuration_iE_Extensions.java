...
public class M5Configuration_iE_Extensions extends Asn1SeqOf {
   ...
   public M5Configuration_iE_Extensions_element[] elements;

   public M5Configuration_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public M5Configuration_iE_Extensions (int numRecords) {
      elements = new M5Configuration_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public M5Configuration_iE_Extensions (M5Configuration_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new M5Configuration_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new M5Configuration_iE_Extensions_element();
