...
public class ULHandoverPreparationTransfer_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _ULHANDOVERPREPARATIONTRANSFER_R8 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public ULHandoverPreparationTransfer_criticalExtensions_c1 () {
      super();
   }

   public ULHandoverPreparationTransfer_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _ULHANDOVERPREPARATIONTRANSFER_R8: return "ulHandoverPreparationTransfer_r8";
   ...
   public void set_ulHandoverPreparationTransfer_r8 (ULHandoverPreparationTransfer_r8_IEs value) {
      setElement (_ULHANDOVERPREPARATIONTRANSFER_R8, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         ...
         case 0: { 
            ULHandoverPreparationTransfer_r8_IEs ulHandoverPreparationTransfer_r8;
            element = ulHandoverPreparationTransfer_r8 = new ULHandoverPreparationTransfer_r8_IEs();
            ulHandoverPreparationTransfer_r8.decode (buffer);
            break;
         }
