...
public class S1SetupRequest_protocolIEs extends Asn1SeqOf {
   ...
   public S1SetupRequest_protocolIEs_element[] elements;

   public S1SetupRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public S1SetupRequest_protocolIEs (int numRecords) {
      elements = new S1SetupRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public S1SetupRequest_protocolIEs (S1SetupRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new S1SetupRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new S1SetupRequest_protocolIEs_element();
