...
public class CellInformation_List extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellInformation-List";
   }

   public CellInformation_List_element[] elements;

   public CellInformation_List () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellInformation_List (int numRecords) {
      elements = new CellInformation_List_element [numRecords];
   }
    ...
    * given the array.  
    */
   public CellInformation_List (CellInformation_List_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellInformation_List_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellInformation_List_element();
