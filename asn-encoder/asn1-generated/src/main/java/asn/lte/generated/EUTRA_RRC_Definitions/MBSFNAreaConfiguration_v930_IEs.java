...
public class MBSFNAreaConfiguration_v930_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "MBSFNAreaConfiguration-v930-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public MBSFNAreaConfiguration_v1250_IEs nonCriticalExtension;  // optional

   public MBSFNAreaConfiguration_v930_IEs () {
      super();
      init();
   }
   ...
   public MBSFNAreaConfiguration_v930_IEs (
      ...
      MBSFNAreaConfiguration_v1250_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public MBSFNAreaConfiguration_v930_IEs (byte[] lateNonCriticalExtension_,
      MBSFNAreaConfiguration_v1250_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new MBSFNAreaConfiguration_v1250_IEs();
