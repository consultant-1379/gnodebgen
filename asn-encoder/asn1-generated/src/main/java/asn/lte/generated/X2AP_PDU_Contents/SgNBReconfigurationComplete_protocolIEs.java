...
public class SgNBReconfigurationComplete_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBReconfigurationComplete_protocolIEs_element[] elements;

   public SgNBReconfigurationComplete_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBReconfigurationComplete_protocolIEs (int numRecords) {
      elements = new SgNBReconfigurationComplete_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBReconfigurationComplete_protocolIEs (SgNBReconfigurationComplete_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBReconfigurationComplete_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBReconfigurationComplete_protocolIEs_element();
