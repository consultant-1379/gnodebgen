...
public class UEInformationRequest_v930_IEs extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UEInformationRequest-v930-IEs";
   }

   public Asn1OctetString lateNonCriticalExtension;  // optional
   public UEInformationRequest_v1020_IEs nonCriticalExtension;  // optional

   public UEInformationRequest_v930_IEs () {
      super();
      init();
   }
   ...
   public UEInformationRequest_v930_IEs (
      ...
      UEInformationRequest_v1020_IEs nonCriticalExtension_
   ) {
      super();
    ...
    * the given objects 
    */
   public UEInformationRequest_v930_IEs (byte[] lateNonCriticalExtension_,
      UEInformationRequest_v1020_IEs nonCriticalExtension_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (nonCriticalExtensionPresent) {
         ...
         nonCriticalExtension = new UEInformationRequest_v1020_IEs();
