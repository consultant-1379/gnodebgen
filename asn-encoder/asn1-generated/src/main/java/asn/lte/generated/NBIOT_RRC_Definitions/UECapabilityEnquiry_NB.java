...
public class UECapabilityEnquiry_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "UECapabilityEnquiry-NB";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier;
   public UECapabilityEnquiry_NB_criticalExtensions criticalExtensions;

   public UECapabilityEnquiry_NB () {
      super();
      init();
   }
   ...
   public UECapabilityEnquiry_NB (
      ...
      UECapabilityEnquiry_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public UECapabilityEnquiry_NB (long rrc_TransactionIdentifier_,
      UECapabilityEnquiry_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new UECapabilityEnquiry_NB_criticalExtensions();
