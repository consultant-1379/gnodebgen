...
public class SR_SubslotSPUCCH_ResourceList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SR-SubslotSPUCCH-ResourceList-r15";
   }

   public Asn1Integer[] elements;

   public SR_SubslotSPUCCH_ResourceList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SR_SubslotSPUCCH_ResourceList_r15 (int numRecords) {
    ...
    * given the array.  
    */
   public SR_SubslotSPUCCH_ResourceList_r15 (Asn1Integer[] elements_) {
      elements = elements_;
   }
