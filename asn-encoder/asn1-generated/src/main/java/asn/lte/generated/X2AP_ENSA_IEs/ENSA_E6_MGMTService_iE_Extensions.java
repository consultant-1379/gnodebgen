...
public class ENSA_E6_MGMTService_iE_Extensions extends Asn1SeqOf {
   ...
   public ENSA_E6_MGMTService_iE_Extensions_element[] elements;

   public ENSA_E6_MGMTService_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENSA_E6_MGMTService_iE_Extensions (int numRecords) {
      elements = new ENSA_E6_MGMTService_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENSA_E6_MGMTService_iE_Extensions (ENSA_E6_MGMTService_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENSA_E6_MGMTService_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENSA_E6_MGMTService_iE_Extensions_element();
