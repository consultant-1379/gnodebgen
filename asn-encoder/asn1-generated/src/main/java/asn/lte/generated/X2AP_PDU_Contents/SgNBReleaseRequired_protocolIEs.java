...
public class SgNBReleaseRequired_protocolIEs extends Asn1SeqOf {
   ...
   public SgNBReleaseRequired_protocolIEs_element[] elements;

   public SgNBReleaseRequired_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SgNBReleaseRequired_protocolIEs (int numRecords) {
      elements = new SgNBReleaseRequired_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SgNBReleaseRequired_protocolIEs (SgNBReleaseRequired_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SgNBReleaseRequired_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SgNBReleaseRequired_protocolIEs_element();
