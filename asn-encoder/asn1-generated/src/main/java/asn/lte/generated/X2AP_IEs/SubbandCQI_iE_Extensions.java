...
public class SubbandCQI_iE_Extensions extends Asn1SeqOf {
   ...
   public SubbandCQI_iE_Extensions_element[] elements;

   public SubbandCQI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public SubbandCQI_iE_Extensions (int numRecords) {
      elements = new SubbandCQI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SubbandCQI_iE_Extensions (SubbandCQI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SubbandCQI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SubbandCQI_iE_Extensions_element();
