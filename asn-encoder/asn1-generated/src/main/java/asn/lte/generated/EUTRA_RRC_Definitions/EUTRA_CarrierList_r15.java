...
public class EUTRA_CarrierList_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "EUTRA-CarrierList-r15";
   }

   public MeasIdleCarrierEUTRA_r15[] elements;

   public EUTRA_CarrierList_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public EUTRA_CarrierList_r15 (int numRecords) {
      elements = new MeasIdleCarrierEUTRA_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public EUTRA_CarrierList_r15 (MeasIdleCarrierEUTRA_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasIdleCarrierEUTRA_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasIdleCarrierEUTRA_r15();
