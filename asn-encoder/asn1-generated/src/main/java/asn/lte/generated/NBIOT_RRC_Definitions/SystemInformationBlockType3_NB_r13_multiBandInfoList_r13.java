...
public class SystemInformationBlockType3_NB_r13_multiBandInfoList_r13 extends Asn1SeqOf {
   ...
   public NS_PmaxList_NB_r13[] elements;

   public SystemInformationBlockType3_NB_r13_multiBandInfoList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SystemInformationBlockType3_NB_r13_multiBandInfoList_r13 (int numRecords) {
      elements = new NS_PmaxList_NB_r13 [numRecords];
   }
    ...
    * given the array.  
    */
   public SystemInformationBlockType3_NB_r13_multiBandInfoList_r13 (NS_PmaxList_NB_r13[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NS_PmaxList_NB_r13 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NS_PmaxList_NB_r13();
