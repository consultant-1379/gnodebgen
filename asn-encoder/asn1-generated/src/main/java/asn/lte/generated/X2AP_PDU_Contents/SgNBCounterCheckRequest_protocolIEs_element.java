...
public class SgNBCounterCheckRequest_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-E-RABs-SubjectToSgNBCounterCheck-List
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: E-RABs-SubjectToSgNBCounterCheck-List
    * Java type: E_RABs_SubjectToSgNBCounterCheck_List
    *
   ...
   public SgNBCounterCheckRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public SgNBCounterCheckRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-E-RABs-SubjectToSgNBCounterCheck-List
    */
   public void setUsing_id_E_RABs_SubjectToSgNBCounterCheck_List(E_RABs_SubjectToSgNBCounterCheck_List value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_E_RABs_SubjectToSgNBCounterCheck_List);
   ...
   /**
    * Get value of value with type set according to information object having key id-E-RABs-SubjectToSgNBCounterCheck-List
    */
   public E_RABs_SubjectToSgNBCounterCheck_List getValueFor_id_E_RABs_SubjectToSgNBCounterCheck_List() {
      return (E_RABs_SubjectToSgNBCounterCheck_List) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.SgNBCounterCheckRequest_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.SgNBCounterCheckRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.SgNBCounterCheckRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 111) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-E-RABs-SubjectToSgNBCounterCheck-List\n");
      }
