...
public class IPAddress extends Asn1OctetString {
    ...
    */
   public IPAddress (byte[] data, int offset, int nbytes) {
    ...
    */
   public IPAddress (String value_) throws Asn1ValueParseException {
      super (value_);
   }
