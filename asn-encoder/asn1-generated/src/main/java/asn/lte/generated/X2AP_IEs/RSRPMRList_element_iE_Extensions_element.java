...
public class RSRPMRList_element_iE_Extensions_element extends Asn1Seq {
   ...
   public RSRPMRList_element_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public RSRPMRList_element_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-UEID
    */
   public void setUsing_id_UEID(UEID extensionValue) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_UEID);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.extensionValue = extensionValue;
   }

   /**
    * Get value of extensionValue with type set according to information object having key id-UEID
    */
   public UEID getExtensionValueFor_id_UEID() {
      return (UEID) this.extensionValue;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_IEsValues.RSRPMRList_ExtIEs.length; i++) {
         if(_X2AP_IEsValues.RSRPMRList_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_IEsValues.RSRPMRList_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
