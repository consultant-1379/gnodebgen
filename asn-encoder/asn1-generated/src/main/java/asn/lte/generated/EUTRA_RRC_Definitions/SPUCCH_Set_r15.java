...
public class SPUCCH_Set_r15 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SPUCCH-Set-r15";
   }

   public SPUCCH_Elements_r15[] elements;

   public SPUCCH_Set_r15 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SPUCCH_Set_r15 (int numRecords) {
      elements = new SPUCCH_Elements_r15 [numRecords];
   }
    ...
    * given the array.  
    */
   public SPUCCH_Set_r15 (SPUCCH_Elements_r15[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SPUCCH_Elements_r15 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SPUCCH_Elements_r15();
