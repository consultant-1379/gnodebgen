...
public class GUMMEI_iE_Extensions extends Asn1SeqOf {
   ...
   public GUMMEI_iE_Extensions_element[] elements;

   public GUMMEI_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public GUMMEI_iE_Extensions (int numRecords) {
      elements = new GUMMEI_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public GUMMEI_iE_Extensions (GUMMEI_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new GUMMEI_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new GUMMEI_iE_Extensions_element();
