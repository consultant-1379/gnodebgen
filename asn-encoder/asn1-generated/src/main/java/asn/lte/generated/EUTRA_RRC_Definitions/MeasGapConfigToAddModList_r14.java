...
public class MeasGapConfigToAddModList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasGapConfigToAddModList-r14";
   }

   public MeasGapConfigPerCC_r14[] elements;

   public MeasGapConfigToAddModList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasGapConfigToAddModList_r14 (int numRecords) {
      elements = new MeasGapConfigPerCC_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasGapConfigToAddModList_r14 (MeasGapConfigPerCC_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasGapConfigPerCC_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasGapConfigPerCC_r14();
