...
public class UE_ContextReferenceAtSgNB_iE_Extensions extends Asn1SeqOf {
   ...
   public UE_ContextReferenceAtSgNB_iE_Extensions_element[] elements;

   public UE_ContextReferenceAtSgNB_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public UE_ContextReferenceAtSgNB_iE_Extensions (int numRecords) {
      elements = new UE_ContextReferenceAtSgNB_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UE_ContextReferenceAtSgNB_iE_Extensions (UE_ContextReferenceAtSgNB_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UE_ContextReferenceAtSgNB_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UE_ContextReferenceAtSgNB_iE_Extensions_element();
