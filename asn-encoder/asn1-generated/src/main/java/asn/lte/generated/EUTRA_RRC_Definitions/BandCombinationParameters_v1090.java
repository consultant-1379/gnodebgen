...
public class BandCombinationParameters_v1090 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "BandCombinationParameters-v1090";
   }

   public BandParameters_v1090[] elements;

   public BandCombinationParameters_v1090 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandCombinationParameters_v1090 (int numRecords) {
      elements = new BandParameters_v1090 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandCombinationParameters_v1090 (BandParameters_v1090[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new BandParameters_v1090 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new BandParameters_v1090();
