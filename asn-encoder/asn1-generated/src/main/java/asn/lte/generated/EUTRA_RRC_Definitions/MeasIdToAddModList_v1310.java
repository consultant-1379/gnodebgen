...
public class MeasIdToAddModList_v1310 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MeasIdToAddModList-v1310";
   }

   public MeasIdToAddMod_v1310[] elements;

   public MeasIdToAddModList_v1310 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasIdToAddModList_v1310 (int numRecords) {
    ...
    * given the array.  
    */
   public MeasIdToAddModList_v1310 (MeasIdToAddMod_v1310[] elements_) {
      elements = elements_;
   }
