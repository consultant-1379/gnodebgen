...
public class SL_PreconfigDiscRxPoolList_r13 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-PreconfigDiscRxPoolList-r13";
   }

   public SL_PreconfigDiscPool_r13[] elements;

   public SL_PreconfigDiscRxPoolList_r13 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_PreconfigDiscRxPoolList_r13 (int numRecords) {
    ...
    * given the array.  
    */
   public SL_PreconfigDiscRxPoolList_r13 (SL_PreconfigDiscPool_r13[] elements_) {
      elements = elements_;
   }
