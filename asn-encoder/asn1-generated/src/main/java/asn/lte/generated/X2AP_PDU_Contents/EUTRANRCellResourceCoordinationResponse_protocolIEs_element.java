...
public class EUTRANRCellResourceCoordinationResponse_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-RespondingNodeType-EutranrCellResourceCoordination
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: RespondingNodeType-EutranrCellResourceCoordination
    * Java type: RespondingNodeType_EutranrCellResourceCoordination
    *
   ...
   public EUTRANRCellResourceCoordinationResponse_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EUTRANRCellResourceCoordinationResponse_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-RespondingNodeType-EutranrCellResourceCoordination
    */
   public void setUsing_id_RespondingNodeType_EutranrCellResourceCoordination(RespondingNodeType_EutranrCellResourceCoordination value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_RespondingNodeType_EutranrCellResourceCoordination);
   ...
   /**
    * Get value of value with type set according to information object having key id-RespondingNodeType-EutranrCellResourceCoordination
    */
   public RespondingNodeType_EutranrCellResourceCoordination getValueFor_id_RespondingNodeType_EutranrCellResourceCoordination() {
      return (RespondingNodeType_EutranrCellResourceCoordination) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.EUTRANRCellResourceCoordinationResponse_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.EUTRANRCellResourceCoordinationResponse_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.EUTRANRCellResourceCoordinationResponse_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 286) {
         indent (_sb, _level+1);
         _sb.append("id = id-RespondingNodeType-EutranrCellResourceCoordination\n");
      }
