...
public class EUTRANRCellResourceCoordinationRequest_protocolIEs_element extends Asn1Seq {
   ...
   /**
    * id: id-InitiatingNodeType-EutranrCellResourceCoordination
    * criticality: Criticality.reject
    * presence: Presence.mandatory
    * ASN.1 type: InitiatingNodeType-EutranrCellResourceCoordination
    * Java type: InitiatingNodeType_EutranrCellResourceCoordination
    *
   ...
   public EUTRANRCellResourceCoordinationRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public EUTRANRCellResourceCoordinationRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-InitiatingNodeType-EutranrCellResourceCoordination
    */
   public void setUsing_id_InitiatingNodeType_EutranrCellResourceCoordination(InitiatingNodeType_EutranrCellResourceCoordination value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_InitiatingNodeType_EutranrCellResourceCoordination);
   ...
   /**
    * Get value of value with type set according to information object having key id-InitiatingNodeType-EutranrCellResourceCoordination
    */
   public InitiatingNodeType_EutranrCellResourceCoordination getValueFor_id_InitiatingNodeType_EutranrCellResourceCoordination() {
      return (InitiatingNodeType_EutranrCellResourceCoordination) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.EUTRANRCellResourceCoordinationRequest_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.EUTRANRCellResourceCoordinationRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.EUTRANRCellResourceCoordinationRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 285) {
         indent (_sb, _level+1);
         _sb.append("id = id-InitiatingNodeType-EutranrCellResourceCoordination\n");
      }
