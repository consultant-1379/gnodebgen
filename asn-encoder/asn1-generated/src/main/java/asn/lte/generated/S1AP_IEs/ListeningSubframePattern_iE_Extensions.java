...
public class ListeningSubframePattern_iE_Extensions extends Asn1SeqOf {
   ...
   public ListeningSubframePattern_iE_Extensions_element[] elements;

   public ListeningSubframePattern_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ListeningSubframePattern_iE_Extensions (int numRecords) {
      elements = new ListeningSubframePattern_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ListeningSubframePattern_iE_Extensions (ListeningSubframePattern_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ListeningSubframePattern_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ListeningSubframePattern_iE_Extensions_element();
