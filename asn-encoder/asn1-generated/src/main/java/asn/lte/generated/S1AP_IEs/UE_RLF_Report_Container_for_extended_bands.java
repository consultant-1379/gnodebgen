...
public class UE_RLF_Report_Container_for_extended_bands extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "UE-RLF-Report-Container-for-extended-bands";
   }

   public UE_RLF_Report_Container_for_extended_bands () {
      super();
   }
    ...
    *              in binary form.
    */
   public UE_RLF_Report_Container_for_extended_bands (byte[] data) {
      super (data);
   }
    ...
    */
   public UE_RLF_Report_Container_for_extended_bands (byte[] data, int offset, int nbytes) {
    ...
    */
   public UE_RLF_Report_Container_for_extended_bands (String value_) throws Asn1ValueParseException {
      super (value_);
   }
