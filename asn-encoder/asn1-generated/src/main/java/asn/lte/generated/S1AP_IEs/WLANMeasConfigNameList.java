...
public class WLANMeasConfigNameList extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "WLANMeasConfigNameList";
   }

   public WLANName[] elements;

   public WLANMeasConfigNameList () {
      elements = null;
   }
    ...
    * populated.
    */
   public WLANMeasConfigNameList (int numRecords) {
      elements = new WLANName [numRecords];
   }
    ...
    * given the array.  
    */
   public WLANMeasConfigNameList (WLANName[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new WLANName [numElements];
