...
public class UEContextReleaseRequest_protocolIEs extends Asn1SeqOf {
   ...
   public UEContextReleaseRequest_protocolIEs_element[] elements;

   public UEContextReleaseRequest_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public UEContextReleaseRequest_protocolIEs (int numRecords) {
      elements = new UEContextReleaseRequest_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public UEContextReleaseRequest_protocolIEs (UEContextReleaseRequest_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new UEContextReleaseRequest_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new UEContextReleaseRequest_protocolIEs_element();
