...
public class SL_V2X_CommFreqList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SL-V2X-CommFreqList-r14";
   }

   public Asn1Integer[] elements;

   public SL_V2X_CommFreqList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SL_V2X_CommFreqList_r14 (int numRecords) {
    ...
    * given the array.  
    */
   public SL_V2X_CommFreqList_r14 (Asn1Integer[] elements_) {
      elements = elements_;
   }
