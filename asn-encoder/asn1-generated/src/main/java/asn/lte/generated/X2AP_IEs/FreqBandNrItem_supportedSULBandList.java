...
public class FreqBandNrItem_supportedSULBandList extends Asn1SeqOf {
   ...
   public SupportedSULFreqBandItem[] elements;

   public FreqBandNrItem_supportedSULBandList () {
      elements = null;
   }
    ...
    * populated.
    */
   public FreqBandNrItem_supportedSULBandList (int numRecords) {
      elements = new SupportedSULFreqBandItem [numRecords];
   }
    ...
    * given the array.  
    */
   public FreqBandNrItem_supportedSULBandList (SupportedSULFreqBandItem[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SupportedSULFreqBandItem [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SupportedSULFreqBandItem();
