...
public class ENSA_ConfigurationUpdateAcknowledge_protocolIEs extends Asn1SeqOf {
   ...
   public ENSA_ConfigurationUpdateAcknowledge_protocolIEs_element[] elements;

   public ENSA_ConfigurationUpdateAcknowledge_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public ENSA_ConfigurationUpdateAcknowledge_protocolIEs (int numRecords) {
      elements = new ENSA_ConfigurationUpdateAcknowledge_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ENSA_ConfigurationUpdateAcknowledge_protocolIEs (ENSA_ConfigurationUpdateAcknowledge_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ENSA_ConfigurationUpdateAcknowledge_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ENSA_ConfigurationUpdateAcknowledge_protocolIEs_element();
