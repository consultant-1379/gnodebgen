...
public class MeasurementFailureCause_List_element extends Asn1Seq {
   ...
   /**
    * id: id-MeasurementFailureCause-Item
    * criticality: Criticality.ignore
    * presence: Presence.mandatory
    * ASN.1 type: MeasurementFailureCause-Item
    * Java type: MeasurementFailureCause_Item
    */
   public Asn1Type value;

   public MeasurementFailureCause_List_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MeasurementFailureCause_List_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-MeasurementFailureCause-Item
    */
   public void setUsing_id_MeasurementFailureCause_Item(MeasurementFailureCause_Item value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_MeasurementFailureCause_Item);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-MeasurementFailureCause-Item
    */
   public MeasurementFailureCause_Item getValueFor_id_MeasurementFailureCause_Item() {
      return (MeasurementFailureCause_Item) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.MeasurementFailureCause_ItemIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.MeasurementFailureCause_ItemIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.MeasurementFailureCause_ItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 67) {
         indent (_sb, _level+1);
         _sb.append("id = id-MeasurementFailureCause-Item\n");
      }
