...
public class OverloadStart_protocolIEs extends Asn1SeqOf {
   ...
   public OverloadStart_protocolIEs_element[] elements;

   public OverloadStart_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public OverloadStart_protocolIEs (int numRecords) {
      elements = new OverloadStart_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public OverloadStart_protocolIEs (OverloadStart_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new OverloadStart_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new OverloadStart_protocolIEs_element();
