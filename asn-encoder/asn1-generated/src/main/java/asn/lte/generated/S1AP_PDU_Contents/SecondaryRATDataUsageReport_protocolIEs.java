...
public class SecondaryRATDataUsageReport_protocolIEs extends Asn1SeqOf {
   ...
   public SecondaryRATDataUsageReport_protocolIEs_element[] elements;

   public SecondaryRATDataUsageReport_protocolIEs () {
      elements = null;
   }
    ...
    * populated.
    */
   public SecondaryRATDataUsageReport_protocolIEs (int numRecords) {
      elements = new SecondaryRATDataUsageReport_protocolIEs_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SecondaryRATDataUsageReport_protocolIEs (SecondaryRATDataUsageReport_protocolIEs_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SecondaryRATDataUsageReport_protocolIEs_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SecondaryRATDataUsageReport_protocolIEs_element();
