...
public class PagingAttemptInformation_iE_Extensions extends Asn1SeqOf {
   ...
   public PagingAttemptInformation_iE_Extensions_element[] elements;

   public PagingAttemptInformation_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public PagingAttemptInformation_iE_Extensions (int numRecords) {
      elements = new PagingAttemptInformation_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PagingAttemptInformation_iE_Extensions (PagingAttemptInformation_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new PagingAttemptInformation_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new PagingAttemptInformation_iE_Extensions_element();
