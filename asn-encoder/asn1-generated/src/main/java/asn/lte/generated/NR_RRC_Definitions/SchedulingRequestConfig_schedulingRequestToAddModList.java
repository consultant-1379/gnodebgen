...
public class SchedulingRequestConfig_schedulingRequestToAddModList extends Asn1SeqOf {
   ...
   public SchedulingRequestToAddMod[] elements;

   public SchedulingRequestConfig_schedulingRequestToAddModList () {
      elements = null;
   }
    ...
    * populated.
    */
   public SchedulingRequestConfig_schedulingRequestToAddModList (int numRecords) {
      elements = new SchedulingRequestToAddMod [numRecords];
   }
    ...
    * given the array.  
    */
   public SchedulingRequestConfig_schedulingRequestToAddModList (SchedulingRequestToAddMod[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SchedulingRequestToAddMod [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SchedulingRequestToAddMod();
