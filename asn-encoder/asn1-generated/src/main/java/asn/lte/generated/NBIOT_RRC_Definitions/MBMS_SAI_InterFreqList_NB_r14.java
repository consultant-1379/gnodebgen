...
public class MBMS_SAI_InterFreqList_NB_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MBMS-SAI-InterFreqList-NB-r14";
   }

   public MBMS_SAI_InterFreq_NB_r14[] elements;

   public MBMS_SAI_InterFreqList_NB_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MBMS_SAI_InterFreqList_NB_r14 (int numRecords) {
      elements = new MBMS_SAI_InterFreq_NB_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public MBMS_SAI_InterFreqList_NB_r14 (MBMS_SAI_InterFreq_NB_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MBMS_SAI_InterFreq_NB_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MBMS_SAI_InterFreq_NB_r14();
