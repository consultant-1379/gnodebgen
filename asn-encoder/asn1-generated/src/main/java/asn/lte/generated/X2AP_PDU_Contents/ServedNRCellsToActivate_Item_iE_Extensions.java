...
public class ServedNRCellsToActivate_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public ServedNRCellsToActivate_Item_iE_Extensions_element[] elements;

   public ServedNRCellsToActivate_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public ServedNRCellsToActivate_Item_iE_Extensions (int numRecords) {
      elements = new ServedNRCellsToActivate_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public ServedNRCellsToActivate_Item_iE_Extensions (ServedNRCellsToActivate_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new ServedNRCellsToActivate_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new ServedNRCellsToActivate_Item_iE_Extensions_element();
