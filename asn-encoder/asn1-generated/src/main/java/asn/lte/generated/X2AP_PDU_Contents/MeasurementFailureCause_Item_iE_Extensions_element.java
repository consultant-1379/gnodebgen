...
public class MeasurementFailureCause_Item_iE_Extensions_element extends Asn1Seq {
   ...
   public MeasurementFailureCause_Item_iE_Extensions_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public MeasurementFailureCause_Item_iE_Extensions_element (long id_,
      Criticality criticality_,
      Asn1Type extensionValue_
   ) {
      super();
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.MeasurementFailureCause_Item_ExtIEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.MeasurementFailureCause_Item_ExtIEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.MeasurementFailureCause_Item_ExtIEs[i];
            break;
         }
      }
      if (null == _index) {
