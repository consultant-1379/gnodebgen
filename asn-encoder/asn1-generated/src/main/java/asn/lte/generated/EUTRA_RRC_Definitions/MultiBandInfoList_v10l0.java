...
public class MultiBandInfoList_v10l0 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "MultiBandInfoList-v10l0";
   }

   public NS_PmaxList_v10l0[] elements;

   public MultiBandInfoList_v10l0 () {
      elements = null;
   }
    ...
    * populated.
    */
   public MultiBandInfoList_v10l0 (int numRecords) {
      elements = new NS_PmaxList_v10l0 [numRecords];
   }
    ...
    * given the array.  
    */
   public MultiBandInfoList_v10l0 (NS_PmaxList_v10l0[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new NS_PmaxList_v10l0 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new NS_PmaxList_v10l0();
