...
public class AllocationAndRetentionPriority_iE_Extensions extends Asn1SeqOf {
   ...
   public AllocationAndRetentionPriority_iE_Extensions_element[] elements;

   public AllocationAndRetentionPriority_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public AllocationAndRetentionPriority_iE_Extensions (int numRecords) {
      elements = new AllocationAndRetentionPriority_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public AllocationAndRetentionPriority_iE_Extensions (AllocationAndRetentionPriority_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new AllocationAndRetentionPriority_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new AllocationAndRetentionPriority_iE_Extensions_element();
