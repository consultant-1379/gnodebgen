...
public class X2RemovalRequest_protocolIEs_element extends Asn1Seq {
    ...
    *
    * id: id-X2RemovalThreshold
    * criticality: Criticality.reject
    * presence: Presence.optional
    * ASN.1 type: X2BenefitValue
    * Java type: X2BenefitValue
    */
   public Asn1Type value;

   public X2RemovalRequest_protocolIEs_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public X2RemovalRequest_protocolIEs_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-X2RemovalThreshold
    */
   public void setUsing_id_X2RemovalThreshold(asn.lte.generated.X2AP_IEs.X2BenefitValue value) {
      this.id = new asn.lte.generated.X2AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.X2AP_Constants._X2AP_ConstantsValues.id_X2RemovalThreshold);
      this.criticality = asn.lte.generated.X2AP_CommonDataTypes.Criticality.reject();
      this.value = value;
   }
   ...
   /**
    * Get value of value with type set according to information object having key id-X2RemovalThreshold
    */
   public asn.lte.generated.X2AP_IEs.X2BenefitValue getValueFor_id_X2RemovalThreshold() {
      return (asn.lte.generated.X2AP_IEs.X2BenefitValue) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _X2AP_PDU_ContentsValues.X2RemovalRequest_IEs.length; i++) {
         if(_X2AP_PDU_ContentsValues.X2RemovalRequest_IEs[i].id.equals(id)) {
            _index = _X2AP_PDU_ContentsValues.X2RemovalRequest_IEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 21) {
         ...
         indent (_sb, _level+1);
         _sb.append("id = id-X2RemovalThreshold\n");
      }
