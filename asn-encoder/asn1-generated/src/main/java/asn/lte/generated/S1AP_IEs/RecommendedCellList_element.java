...
public class RecommendedCellList_element extends Asn1Seq {
    ...
    * ASN.1 type: RecommendedCellItem
    * Java type: RecommendedCellItem
    */
   public Asn1Type value;

   public RecommendedCellList_element () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public RecommendedCellList_element (long id_,
      Criticality criticality_,
      Asn1Type value_
   ) {
      super();
   ...
   /**
    * Assign fields according to information object having key id-RecommendedCellItem
    */
   public void setUsing_id_RecommendedCellItem(RecommendedCellItem value) {
      this.id = new asn.lte.generated.S1AP_CommonDataTypes.ProtocolIE_ID(asn.lte.generated.S1AP_Constants._S1AP_ConstantsValues.id_RecommendedCellItem);
      this.criticality = asn.lte.generated.S1AP_CommonDataTypes.Criticality.ignore();
      this.value = value;
   }

   /**
    * Get value of value with type set according to information object having key id-RecommendedCellItem
    */
   public RecommendedCellItem getValueFor_id_RecommendedCellItem() {
      return (RecommendedCellItem) this.value;
   }
      ...
      throws Asn1Exception
   {
      ...
      for(int i=0; i < _S1AP_IEsValues.RecommendedCellItemIEs.length; i++) {
         if(_S1AP_IEsValues.RecommendedCellItemIEs[i].id.equals(id)) {
            _index = _S1AP_IEsValues.RecommendedCellItemIEs[i];
            break;
         }
      }
      if (null == _index) {
   ...
   public void print (java.lang.StringBuilder _sb, String _varName, int _level)
   {
      ...
      if (id.value == 214) {
         indent (_sb, _level+1);
         _sb.append("id = id-RecommendedCellItem\n");
      }
