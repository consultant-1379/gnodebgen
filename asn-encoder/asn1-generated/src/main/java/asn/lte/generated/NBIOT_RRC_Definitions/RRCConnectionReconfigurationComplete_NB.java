...
import asn.lte.generated.EUTRA_RRC_Definitions.RRC_TransactionIdentifier;

public class RRCConnectionReconfigurationComplete_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionReconfigurationComplete-NB";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier;
   public RRCConnectionReconfigurationComplete_NB_criticalExtensions criticalExtensions;

   public RRCConnectionReconfigurationComplete_NB () {
      super();
      init();
   }
   ...
   public RRCConnectionReconfigurationComplete_NB (
      ...
      RRCConnectionReconfigurationComplete_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public RRCConnectionReconfigurationComplete_NB (long rrc_TransactionIdentifier_,
      RRCConnectionReconfigurationComplete_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionReconfigurationComplete_NB_criticalExtensions();
