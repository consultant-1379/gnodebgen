...
public class Tx_ResourcePoolMeasList_r14 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "Tx-ResourcePoolMeasList-r14";
   }

   public SL_V2X_TxPoolReportIdentity_r14[] elements;

   public Tx_ResourcePoolMeasList_r14 () {
      elements = null;
   }
    ...
    * populated.
    */
   public Tx_ResourcePoolMeasList_r14 (int numRecords) {
      elements = new SL_V2X_TxPoolReportIdentity_r14 [numRecords];
   }
    ...
    * given the array.  
    */
   public Tx_ResourcePoolMeasList_r14 (SL_V2X_TxPoolReportIdentity_r14[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      buffer.setSizeConstraint (1, 72);
      int numElements = (int) buffer.decodeLength();

      elements = new SL_V2X_TxPoolReportIdentity_r14 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SL_V2X_TxPoolReportIdentity_r14();
