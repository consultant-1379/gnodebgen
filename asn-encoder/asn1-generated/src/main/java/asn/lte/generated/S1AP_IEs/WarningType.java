...
public class WarningType extends Asn1OctetString {
    ...
    */
   public WarningType (byte[] data, int offset, int nbytes) {
    ...
    */
   public WarningType (String value_) throws Asn1ValueParseException {
      super (value_);
   }
