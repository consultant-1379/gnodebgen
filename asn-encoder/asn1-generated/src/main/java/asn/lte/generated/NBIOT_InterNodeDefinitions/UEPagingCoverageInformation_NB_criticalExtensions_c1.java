...
public class UEPagingCoverageInformation_NB_criticalExtensions_c1 extends Asn1Choice {
   ...
   public final static byte _UEPAGINGCOVERAGEINFORMATION_R13 = 1;
   public final static byte _SPARE3 = 2;
   public final static byte _SPARE2 = 3;
   public final static byte _SPARE1 = 4;

   public UEPagingCoverageInformation_NB_criticalExtensions_c1 () {
      super();
   }

   public UEPagingCoverageInformation_NB_criticalExtensions_c1 (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public String getElemName () {
      switch (choiceID) {
      case _UEPAGINGCOVERAGEINFORMATION_R13: return "uePagingCoverageInformation_r13";
   ...
   public void set_uePagingCoverageInformation_r13 (UEPagingCoverageInformation_NB_IEs value) {
      setElement (_UEPAGINGCOVERAGEINFORMATION_R13, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      switch (idx) {
         // uePagingCoverageInformation_r13
         case 0: { 
            UEPagingCoverageInformation_NB_IEs uePagingCoverageInformation_r13;
            element = uePagingCoverageInformation_r13 = new UEPagingCoverageInformation_NB_IEs();
            uePagingCoverageInformation_r13.decode (buffer);
            break;
         }
