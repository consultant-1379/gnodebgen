...
public class RRCConnectionReestablishment_NB extends Asn1Seq {
   ...
   public String getAsn1TypeName()  {
      return "RRCConnectionReestablishment-NB";
   }

   public RRC_TransactionIdentifier rrc_TransactionIdentifier;
   public RRCConnectionReestablishment_NB_criticalExtensions criticalExtensions;

   public RRCConnectionReestablishment_NB () {
      super();
      init();
   }
   ...
   public RRCConnectionReestablishment_NB (
      ...
      RRCConnectionReestablishment_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      rrc_TransactionIdentifier = rrc_TransactionIdentifier_;
    ...
    * the given objects 
    */
   public RRCConnectionReestablishment_NB (long rrc_TransactionIdentifier_,
      RRCConnectionReestablishment_NB_criticalExtensions criticalExtensions_
   ) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      criticalExtensions = new RRCConnectionReestablishment_NB_criticalExtensions();
