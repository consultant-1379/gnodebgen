...
public class MeasurementQuantities_Item_iE_Extensions extends Asn1SeqOf {
   ...
   public MeasurementQuantities_Item_iE_Extensions_element[] elements;

   public MeasurementQuantities_Item_iE_Extensions () {
      elements = null;
   }
    ...
    * populated.
    */
   public MeasurementQuantities_Item_iE_Extensions (int numRecords) {
      elements = new MeasurementQuantities_Item_iE_Extensions_element [numRecords];
   }
    ...
    * given the array.  
    */
   public MeasurementQuantities_Item_iE_Extensions (MeasurementQuantities_Item_iE_Extensions_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new MeasurementQuantities_Item_iE_Extensions_element [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new MeasurementQuantities_Item_iE_Extensions_element();
