...
public class SCellToAddModListExt_v1430 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SCellToAddModListExt-v1430";
   }

   public SCellToAddModExt_v1430[] elements;

   public SCellToAddModListExt_v1430 () {
      elements = null;
   }
    ...
    * populated.
    */
   public SCellToAddModListExt_v1430 (int numRecords) {
      elements = new SCellToAddModExt_v1430 [numRecords];
   }
    ...
    * given the array.  
    */
   public SCellToAddModListExt_v1430 (SCellToAddModExt_v1430[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new SCellToAddModExt_v1430 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new SCellToAddModExt_v1430();
