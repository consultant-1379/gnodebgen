...
public class BandParameters_v1270_bandParametersDL_v1270 extends Asn1SeqOf {
   ...
   public CA_MIMO_ParametersDL_v1270[] elements;

   public BandParameters_v1270_bandParametersDL_v1270 () {
      elements = null;
   }
    ...
    * populated.
    */
   public BandParameters_v1270_bandParametersDL_v1270 (int numRecords) {
      elements = new CA_MIMO_ParametersDL_v1270 [numRecords];
   }
    ...
    * given the array.  
    */
   public BandParameters_v1270_bandParametersDL_v1270 (CA_MIMO_ParametersDL_v1270[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CA_MIMO_ParametersDL_v1270 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CA_MIMO_ParametersDL_v1270();
