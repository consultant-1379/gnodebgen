...
public class Correlation_ID extends Asn1OctetString {
    ...
    *              in binary form.
    */
   public Correlation_ID (byte[] data) {
      super (data);
   }
    ...
    */
   public Correlation_ID (byte[] data, int offset, int nbytes) {
    ...
    */
   public Correlation_ID (String value_) throws Asn1ValueParseException {
      super (value_);
   }
