...
public class CellsToAddModListCDMA2000 extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "CellsToAddModListCDMA2000";
   }

   public CellsToAddModCDMA2000[] elements;

   public CellsToAddModListCDMA2000 () {
      elements = null;
   }
    ...
    * populated.
    */
   public CellsToAddModListCDMA2000 (int numRecords) {
      elements = new CellsToAddModCDMA2000 [numRecords];
   }
    ...
    * given the array.  
    */
   public CellsToAddModListCDMA2000 (CellsToAddModCDMA2000[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      elements = new CellsToAddModCDMA2000 [numElements];
      ...
      for (int i = 0; i < elements.length; i++) {
         ...
         elements[i] = new CellsToAddModCDMA2000();
